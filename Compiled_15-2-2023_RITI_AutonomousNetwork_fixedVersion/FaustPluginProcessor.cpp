...
class mydsp : public base_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst7 = 618.8937527571892 / fConst0;
		fConst8 = 411.5486376202629 / fConst0;
		double fConst9 = std::tan(1570.7963267948965 / fConst0);
		fConst10 = fConst9 / (fConst9 + 1.0);
		fConst11 = 2.0 * fConst10;
		iConst12 = int(0.002 * fConst0);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("Interpolations A", &fVslider27, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider28, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Interpolations A", &fVslider12, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider13, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Interpolations A", &fVslider21, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider22, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Interpolations A", &fVslider33, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider34, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow28 = fConst4 * double(fVslider27);
		double fSlow29 = fConst4 * double(fVslider28);
		...
		double fSlow35 = fConst4 * double(fVslider34);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			double fTemp18 = std::max<double>(2.220446049250313e-16, fRec41[0]);
			double fTemp19 = fTemp18 / fRec40[0];
			double fTemp20 = std::tan(fConst7 * fRec40[0]);
			double fTemp21 = fTemp20 * (fTemp20 + 0.005076142131979695 * fTemp19) + 1.0;
			...
			double fTemp23 = 0.51466542 * fRec42[0] + fRec43[0] * (0.51466542 - 1.02933084 * fRec42[0]) + 0.48533458;
			double fRec39 = fTemp22 * fTemp23 / fTemp21;
			double fTemp24 = 115.0 * fRec42[0];
			double fTemp25 = 7.0 * fRec42[0];
			double fTemp26 = fRec40[0] * (fTemp25 + fRec43[0] * (108.0 - fTemp24) + 2096.0);
			double fTemp27 = std::tan(fConst5 * fTemp26);
			double fTemp28 = fTemp27 * (fTemp27 + fTemp18 / fTemp26) + 1.0;
			double fTemp29 = fTemp27 * (fTemp17 - fRec45[1]) + fRec44[1];
			fRec44[0] = 2.0 * (fTemp29 / fTemp28) - fRec44[1];
			fRec45[0] = fRec45[1] + 2.0 * (fTemp27 * fTemp29 / fTemp28);
			double fTemp30 = 0.00492482 * fRec42[0] + fRec43[0] * (0.0035387400000000003 - 0.00846356 * fRec42[0]) + 0.00514822;
			double fRec46 = fTemp29 * fTemp30 / fTemp28;
			double fTemp31 = fRec40[0] * (fTemp25 + fRec43[0] * (106.0 - 113.0 * fRec42[0]) + 1965.0);
			double fTemp32 = std::tan(fConst5 * fTemp31);
			double fTemp33 = fTemp32 * (fTemp32 + fTemp18 / fTemp31) + 1.0;
			double fTemp34 = fTemp32 * (fTemp17 - fRec48[1]) + fRec47[1];
			fRec47[0] = 2.0 * (fTemp34 / fTemp33) - fRec47[1];
			fRec48[0] = fRec48[1] + 2.0 * (fTemp32 * fTemp34 / fTemp33);
			double fTemp35 = 0.003961 * fRec42[0] + fRec43[0] * (0.02133127 - 0.02529227 * fRec42[0]) + 0.00356349;
			double fRec49 = fTemp34 * fTemp35 / fTemp33;
			double fTemp36 = 111.0 * fRec42[0];
			double fTemp37 = 8.0 * fRec42[0];
			double fTemp38 = fRec40[0] * (fTemp37 + fRec43[0] * (103.0 - fTemp36) + 1834.0);
			double fTemp39 = std::tan(fConst5 * fTemp38);
			double fTemp40 = fTemp39 * (fTemp39 + fTemp18 / fTemp38) + 1.0;
			double fTemp41 = fTemp39 * (fTemp17 - fRec51[1]) + fRec50[1];
			fRec50[0] = 2.0 * (fTemp41 / fTemp40) - fRec50[1];
			fRec51[0] = fRec51[1] + 2.0 * (fTemp39 * fTemp41 / fTemp40);
			double fTemp42 = fRec43[0] * (0.00286025 * fRec42[0] + -3.855000000000004e-05) + (0.00511717 - 0.0028217 * fRec42[0]);
			double fRec52 = fTemp41 * fTemp42 / fTemp40;
			double fTemp43 = fRec40[0] * (fTemp25 + fRec43[0] * (101.0 - 108.0 * fRec42[0]) + 1702.0);
			double fTemp44 = std::tan(fConst5 * fTemp43);
			double fTemp45 = fTemp44 * (fTemp44 + fTemp18 / fTemp43) + 1.0;
			double fTemp46 = fTemp44 * (fTemp17 - fRec54[1]) + fRec53[1];
			fRec53[0] = 2.0 * (fTemp46 / fTemp45) - fRec53[1];
			fRec54[0] = fRec54[1] + 2.0 * (fTemp44 * fTemp46 / fTemp45);
			double fTemp47 = 0.015484530000000002 * fRec42[0] + fRec43[0] * (0.00335505 - 0.01883958 * fRec42[0]) + 0.0048918;
			double fRec55 = fTemp46 * fTemp47 / fTemp45;
			double fTemp48 = 6.0 * fRec42[0];
			double fTemp49 = fRec40[0] * (fTemp48 + fRec43[0] * (31.0 - 37.0 * fRec42[0]) + 1572.0);
			double fTemp50 = std::tan(fConst5 * fTemp49);
			double fTemp51 = fTemp50 * (fTemp50 + fTemp18 / fTemp49) + 1.0;
			double fTemp52 = fTemp50 * (fTemp17 - fRec57[1]) + fRec56[1];
			fRec56[0] = 2.0 * (fTemp52 / fTemp51) - fRec56[1];
			fRec57[0] = fRec57[1] + 2.0 * (fTemp50 * fTemp52 / fTemp51);
			double fTemp53 = fRec43[0] * (0.0007354499999999986 * fRec42[0] + -0.0006947099999999977) + (0.02091359 - 4.0740000000000914e-05 * fRec42[0]);
			double fRec58 = fTemp52 * fTemp53 / fTemp51;
			double fTemp54 = 5.0 * fRec42[0];
			double fTemp55 = fRec40[0] * (fTemp54 + fRec43[0] * (28.0 - 33.0 * fRec42[0]) + 1441.0);
			double fTemp56 = std::tan(fConst5 * fTemp55);
			double fTemp57 = fTemp56 * (fTemp56 + fTemp18 / fTemp55) + 1.0;
			double fTemp58 = fTemp56 * (fTemp17 - fRec60[1]) + fRec59[1];
			fRec59[0] = 2.0 * (fTemp58 / fTemp57) - fRec59[1];
			fRec60[0] = fRec60[1] + 2.0 * (fTemp56 * fTemp58 / fTemp57);
			double fTemp59 = 0.00404728 * fRec42[0] + fRec43[0] * (0.00189104 - 0.00593832 * fRec42[0]) + 0.00888014;
			double fRec61 = fTemp58 * fTemp59 / fTemp57;
			double fTemp60 = fRec40[0] * (fTemp54 + fRec43[0] * (26.0 - 31.0 * fRec42[0]) + 1.31e+03);
			double fTemp61 = std::tan(fConst5 * fTemp60);
			double fTemp62 = fTemp61 * (fTemp61 + fTemp18 / fTemp60) + 1.0;
			double fTemp63 = fTemp61 * (fTemp17 - fRec63[1]) + fRec62[1];
			fRec62[0] = 2.0 * (fTemp63 / fTemp62) - fRec62[1];
			fRec63[0] = fRec63[1] + 2.0 * (fTemp61 * fTemp63 / fTemp62);
			double fTemp64 = 0.0227416 * fRec42[0] + fRec43[0] * (0.00469608 - 0.02743768 * fRec42[0]) + 0.01193177;
			double fRec64 = fTemp63 * fTemp64 / fTemp62;
			double fTemp65 = fRec40[0] * (fTemp54 + fRec43[0] * (15.0 - 2e+01 * fRec42[0]) + 1178.0);
			double fTemp66 = std::tan(fConst5 * fTemp65);
			double fTemp67 = fTemp66 * (fTemp66 + fTemp18 / fTemp65) + 1.0;
			double fTemp68 = fTemp66 * (fTemp17 - fRec66[1]) + fRec65[1];
			fRec65[0] = 2.0 * (fTemp68 / fTemp67) - fRec65[1];
			fRec66[0] = fRec66[1] + 2.0 * (fTemp66 * fTemp68 / fTemp67);
			double fTemp69 = fRec43[0] * (0.004585809999999999 - 0.0018878599999999982 * fRec42[0]) + (0.01707981 - 0.002697950000000001 * fRec42[0]);
			double fRec67 = fTemp68 * fTemp69 / fTemp67;
			double fTemp70 = fRec40[0] * (fTemp54 + fRec43[0] * (22.0 - 27.0 * fRec42[0]) + 1047.0);
			double fTemp71 = std::tan(fConst5 * fTemp70);
			double fTemp72 = fTemp71 * (fTemp71 + fTemp18 / fTemp70) + 1.0;
			double fTemp73 = fTemp71 * (fTemp17 - fRec69[1]) + fRec68[1];
			fRec68[0] = 2.0 * (fTemp73 / fTemp72) - fRec68[1];
			fRec69[0] = fRec69[1] + 2.0 * (fTemp71 * fTemp73 / fTemp72);
			double fTemp74 = 0.01049454 * fRec42[0] + fRec43[0] * (0.022906150000000004 - 0.033400690000000004 * fRec42[0]) + 0.02127434;
			double fRec70 = fTemp73 * fTemp74 / fTemp72;
			double fTemp75 = 3.0 * fRec42[0];
			double fTemp76 = fRec40[0] * (fTemp75 + fRec43[0] * (1e+01 - 13.0 * fRec42[0]) + 917.0);
			double fTemp77 = std::tan(fConst5 * fTemp76);
			double fTemp78 = fTemp77 * (fTemp77 + fTemp18 / fTemp76) + 1.0;
			double fTemp79 = fTemp77 * (fTemp17 - fRec72[1]) + fRec71[1];
			fRec71[0] = 2.0 * (fTemp79 / fTemp78) - fRec71[1];
			fRec72[0] = fRec72[1] + 2.0 * (fTemp77 * fTemp79 / fTemp78);
			double fTemp80 = fRec43[0] * (0.11867802000000001 * fRec42[0] + -0.06216229000000001) + (0.08372042 - 0.05651573 * fRec42[0]);
			double fRec73 = fTemp79 * fTemp80 / fTemp78;
			double fTemp81 = fRec40[0] * (fTemp75 + fRec43[0] * (15.0 - 18.0 * fRec42[0]) + 786.0);
			double fTemp82 = std::tan(fConst5 * fTemp81);
			double fTemp83 = fTemp82 * (fTemp82 + fTemp18 / fTemp81) + 1.0;
			double fTemp84 = fTemp82 * (fTemp17 - fRec75[1]) + fRec74[1];
			fRec74[0] = 2.0 * (fTemp84 / fTemp83) - fRec74[1];
			fRec75[0] = fRec75[1] + 2.0 * (fTemp82 * fTemp84 / fTemp83);
			double fTemp85 = 0.007078770000000002 * fRec42[0] + fRec43[0] * (0.0313596 - 0.03843837 * fRec42[0]) + 0.02810959;
			double fRec76 = fTemp84 * fTemp85 / fTemp83;
			double fTemp86 = 2.0 * fRec42[0];
			double fTemp87 = fRec40[0] * (fTemp86 + fRec43[0] * (13.0 - 15.0 * fRec42[0]) + 655.0);
			double fTemp88 = std::tan(fConst5 * fTemp87);
			double fTemp89 = fTemp88 * (fTemp88 + fTemp18 / fTemp87) + 1.0;
			double fTemp90 = fTemp88 * (fTemp17 - fRec78[1]) + fRec77[1];
			fRec77[0] = 2.0 * (fTemp90 / fTemp89) - fRec77[1];
			fRec78[0] = fRec78[1] + 2.0 * (fTemp88 * fTemp90 / fTemp89);
			double fTemp91 = 0.039912470000000005 * fRec42[0] + fRec43[0] * (0.005417789999999992 - 0.04533026 * fRec42[0]) + 0.10262931;
			double fRec79 = fTemp90 * fTemp91 / fTemp89;
			double fTemp92 = fTemp86 + fRec43[0] * (1e+01 - 12.0 * fRec42[0]);
			double fTemp93 = fRec40[0] * (fTemp92 + 524.0);
			double fTemp94 = std::tan(fConst5 * fTemp93);
			double fTemp95 = fTemp94 * (fTemp94 + fTemp18 / fTemp93) + 1.0;
			double fTemp96 = fTemp94 * (fTemp17 - fRec81[1]) + fRec80[1];
			fRec80[0] = 2.0 * (fTemp96 / fTemp95) - fRec80[1];
			fRec81[0] = fRec81[1] + 2.0 * (fTemp94 * fTemp96 / fTemp95);
			double fTemp97 = 0.16088293999999997 * fRec42[0] + fRec43[0] * (-0.06794681000000001 - 0.09293612999999996 * fRec42[0]) + 0.15710983;
			double fRec82 = fTemp96 * fTemp97 / fTemp95;
			double fTemp98 = fRec40[0] * (fRec42[0] + fRec43[0] * (5.0 - fTemp48) + 393.0);
			double fTemp99 = std::tan(fConst5 * fTemp98);
			double fTemp100 = fTemp99 * (fTemp99 + fTemp18 / fTemp98) + 1.0;
			double fTemp101 = fTemp99 * (fTemp17 - fRec84[1]) + fRec83[1];
			fRec83[0] = 2.0 * (fTemp101 / fTemp100) - fRec83[1];
			fRec84[0] = fRec84[1] + 2.0 * (fTemp99 * fTemp101 / fTemp100);
			double fTemp102 = 0.52347231 * fRec42[0] + fRec43[0] * (-0.11388923 - 0.40958308000000004 * fRec42[0]) + 0.20074493;
			double fRec85 = fTemp101 * fTemp102 / fTemp100;
			double fTemp103 = fRec40[0] * (fRec42[0] + fRec43[0] * (4.0 - fTemp54) + 262.0);
			double fTemp104 = std::tan(fConst5 * fTemp103);
			double fTemp105 = fTemp104 * (fTemp104 + fTemp18 / fTemp103) + 1.0;
			double fTemp106 = fTemp104 * (fTemp17 - fRec87[1]) + fRec86[1];
			fRec86[0] = 2.0 * (fTemp106 / fTemp105) - fRec86[1];
			fRec87[0] = fRec87[1] + 2.0 * (fTemp104 * fTemp106 / fTemp105);
			double fTemp107 = 0.02997270000000002 * fRec42[0] + fRec43[0] * (0.13487834999999998 * fRec42[0] + -0.16485105) + 0.29825361;
			double fRec88 = fTemp106 * fTemp107 / fTemp105;
			double fTemp108 = std::tan(fConst8 * fRec40[0]);
			double fTemp109 = fTemp108 * (fTemp108 + 0.007633587786259542 * fTemp19) + 1.0;
			double fTemp110 = fTemp108 * (fTemp17 - fRec90[1]) + fRec89[1];
			fRec89[0] = 2.0 * (fTemp110 / fTemp109) - fRec89[1];
			fRec90[0] = fRec90[1] + 2.0 * (fTemp108 * fTemp110 / fTemp109);
			double fTemp111 = fRec43[0] * (0.6123959999999999 * fRec42[0] + -0.41317138) + (1.0 - 0.19922461999999996 * fRec42[0]);
			double fRec91 = fTemp110 * fTemp111 / fTemp109;
			double fTemp112 = fRec40[0] * (fTemp86 + fRec43[0] * (6.0 - fTemp37) + 327.0);
			double fTemp113 = std::tan(fConst5 * fTemp112);
			double fTemp114 = fTemp113 * (fTemp113 + fTemp18 / fTemp112) + 1.0;
			double fTemp115 = fTemp113 * (fTemp17 - fRec93[1]) + fRec92[1];
			fRec92[0] = 2.0 * (fTemp115 / fTemp114) - fRec92[1];
			fRec93[0] = fRec93[1] + 2.0 * (fTemp113 * fTemp115 / fTemp114);
			double fTemp116 = 0.07501773 * fRec42[0] + fRec43[0] * (-0.04893692999999999 - 0.026080800000000015 * fRec42[0]) + 0.24961559;
			double fRec94 = fTemp115 * fTemp116 / fTemp114;
			double fTemp117 = fRec40[0] * (fTemp92 + 458.0);
			double fTemp118 = std::tan(fConst5 * fTemp117);
			double fTemp119 = fTemp118 * (fTemp118 + fTemp18 / fTemp117) + 1.0;
			double fTemp120 = fTemp118 * (fTemp17 - fRec96[1]) + fRec95[1];
			fRec95[0] = 2.0 * (fTemp120 / fTemp119) - fRec95[1];
			fRec96[0] = fRec96[1] + 2.0 * (fTemp118 * fTemp120 / fTemp119);
			double fTemp121 = 0.031150369999999983 * fRec42[0] + fRec43[0] * (0.03386702 - 0.06501738999999998 * fRec42[0]) + 0.1571452;
			double fRec97 = fTemp120 * fTemp121 / fTemp119;
			double fTemp122 = fRec40[0] * (fTemp86 + fRec43[0] * (12.0 - 14.0 * fRec42[0]) + 589.0);
			double fTemp123 = std::tan(fConst5 * fTemp122);
			double fTemp124 = fTemp123 * (fTemp123 + fTemp18 / fTemp122) + 1.0;
			double fTemp125 = fTemp123 * (fTemp17 - fRec99[1]) + fRec98[1];
			fRec98[0] = 2.0 * (fTemp125 / fTemp124) - fRec98[1];
			fRec99[0] = fRec99[1] + 2.0 * (fTemp123 * fTemp125 / fTemp124);
			double fTemp126 = fRec43[0] * (0.15122519 * fRec42[0] + -0.08735081) + (0.20902308 - 0.06387438000000001 * fRec42[0]);
			double fRec100 = fTemp125 * fTemp126 / fTemp124;
			double fTemp127 = fRec40[0] * (fTemp75 + fRec43[0] * (14.0 - 17.0 * fRec42[0]) + 7.2e+02);
			double fTemp128 = std::tan(fConst5 * fTemp127);
			double fTemp129 = fTemp128 * (fTemp128 + fTemp18 / fTemp127) + 1.0;
			double fTemp130 = fTemp128 * (fTemp17 - fRec102[1]) + fRec101[1];
			fRec101[0] = 2.0 * (fTemp130 / fTemp129) - fRec101[1];
			fRec102[0] = fRec102[1] + 2.0 * (fTemp128 * fTemp130 / fTemp129);
			double fTemp131 = 0.006377540000000001 * fRec42[0] + fRec43[0] * (0.03603802 * fRec42[0] + -0.04241556) + 0.07819993;
			double fRec103 = fTemp130 * fTemp131 / fTemp129;
			double fTemp132 = 4.0 * fRec42[0];
			double fTemp133 = fRec40[0] * (fTemp132 + fRec43[0] * (17.0 - 21.0 * fRec42[0]) + 851.0);
			double fTemp134 = std::tan(fConst5 * fTemp133);
			double fTemp135 = fTemp134 * (fTemp134 + fTemp18 / fTemp133) + 1.0;
			double fTemp136 = fTemp134 * (fTemp17 - fRec105[1]) + fRec104[1];
			fRec104[0] = 2.0 * (fTemp136 / fTemp135) - fRec104[1];
			fRec105[0] = fRec105[1] + 2.0 * (fTemp134 * fTemp136 / fTemp135);
			double fTemp137 = 0.043723639999999994 * fRec42[0] + fRec43[0] * (-0.00032270000000000215 - 0.04340093999999999 * fRec42[0]) + 0.03754288;
			double fRec106 = fTemp136 * fTemp137 / fTemp135;
			double fTemp138 = fRec40[0] * (fTemp132 + fRec43[0] * (19.0 - 23.0 * fRec42[0]) + 982.0);
			double fTemp139 = std::tan(fConst5 * fTemp138);
			double fTemp140 = fTemp139 * (fTemp139 + fTemp18 / fTemp138) + 1.0;
			double fTemp141 = fTemp139 * (fTemp17 - fRec108[1]) + fRec107[1];
			fRec107[0] = 2.0 * (fTemp141 / fTemp140) - fRec107[1];
			fRec108[0] = fRec108[1] + 2.0 * (fTemp139 * fTemp141 / fTemp140);
			double fTemp142 = 0.022372620000000003 * fRec42[0] + fRec43[0] * (0.029409400000000002 - 0.051782020000000005 * fRec42[0]) + 0.00927965;
			double fRec109 = fTemp141 * fTemp142 / fTemp140;
			double fTemp143 = fRec40[0] * (fTemp132 + fRec43[0] * (22.0 - 26.0 * fRec42[0]) + 1113.0);
			double fTemp144 = std::tan(fConst5 * fTemp143);
			double fTemp145 = fTemp144 * (fTemp144 + fTemp18 / fTemp143) + 1.0;
			double fTemp146 = fTemp144 * (fTemp17 - fRec111[1]) + fRec110[1];
			fRec110[0] = 2.0 * (fTemp146 / fTemp145) - fRec110[1];
			fRec111[0] = fRec111[1] + 2.0 * (fTemp144 * fTemp146 / fTemp145);
			double fTemp147 = 0.01651215 * fRec42[0] + fRec43[0] * (0.004918780000000001 - 0.02143093 * fRec42[0]) + 0.02702054;
			double fRec112 = fTemp146 * fTemp147 / fTemp145;
			double fTemp148 = fRec40[0] * (fTemp54 + fRec43[0] * (25.0 - 3e+01 * fRec42[0]) + 1244.0);
			double fTemp149 = std::tan(fConst5 * fTemp148);
			double fTemp150 = fTemp149 * (fTemp149 + fTemp18 / fTemp148) + 1.0;
			double fTemp151 = fTemp149 * (fTemp17 - fRec114[1]) + fRec113[1];
			fRec113[0] = 2.0 * (fTemp151 / fTemp150) - fRec113[1];
			fRec114[0] = fRec114[1] + 2.0 * (fTemp149 * fTemp151 / fTemp150);
			double fTemp152 = fRec43[0] * (0.009495489999999999 - 0.006188469999999999 * fRec42[0]) + (0.01010378 - 0.00330702 * fRec42[0]);
			double fRec115 = fTemp151 * fTemp152 / fTemp150;
			double fTemp153 = fRec40[0] * (fTemp54 + fRec43[0] * (27.0 - 32.0 * fRec42[0]) + 1375.0);
			double fTemp154 = std::tan(fConst5 * fTemp153);
			double fTemp155 = fTemp154 * (fTemp154 + fTemp18 / fTemp153) + 1.0;
			double fTemp156 = fTemp154 * (fTemp17 - fRec117[1]) + fRec116[1];
			fRec116[0] = 2.0 * (fTemp156 / fTemp155) - fRec116[1];
			fRec117[0] = fRec117[1] + 2.0 * (fTemp154 * fTemp156 / fTemp155);
			double fTemp157 = fRec43[0] * (0.0277721 - 0.025426740000000003 * fRec42[0]) + (0.00929211 - 0.0023453599999999995 * fRec42[0]);
			double fRec118 = fTemp156 * fTemp157 / fTemp155;
			double fTemp158 = fRec40[0] * (fTemp48 + fRec43[0] * (3e+01 - 36.0 * fRec42[0]) + 1506.0);
			double fTemp159 = std::tan(fConst5 * fTemp158);
			double fTemp160 = fTemp159 * (fTemp159 + fTemp18 / fTemp158) + 1.0;
			double fTemp161 = fTemp159 * (fTemp17 - fRec120[1]) + fRec119[1];
			fRec119[0] = 2.0 * (fTemp161 / fTemp160) - fRec119[1];
			fRec120[0] = fRec120[1] + 2.0 * (fTemp159 * fTemp161 / fTemp160);
			double fTemp162 = 0.01661545 * fRec42[0] + fRec43[0] * (0.023741299999999996 - 0.04035675 * fRec42[0]) + 0.00940227;
			double fRec121 = fTemp161 * fTemp162 / fTemp160;
			double fTemp163 = fRec40[0] * (fTemp48 + fRec43[0] * (33.0 - 39.0 * fRec42[0]) + 1637.0);
			double fTemp164 = std::tan(fConst5 * fTemp163);
			double fTemp165 = fTemp164 * (fTemp164 + fTemp18 / fTemp163) + 1.0;
			double fTemp166 = fTemp164 * (fTemp17 - fRec123[1]) + fRec122[1];
			fRec122[0] = 2.0 * (fTemp166 / fTemp165) - fRec122[1];
			fRec123[0] = fRec123[1] + 2.0 * (fTemp164 * fTemp166 / fTemp165);
			double fTemp167 = 0.005929820000000001 * fRec42[0] + fRec43[0] * (0.00200935 - 0.00793917 * fRec42[0]) + 0.00459008;
			double fRec124 = fTemp166 * fTemp167 / fTemp165;
			double fTemp168 = fRec40[0] * (fTemp25 + fRec43[0] * (102.0 - 109.0 * fRec42[0]) + 1768.0);
			double fTemp169 = std::tan(fConst5 * fTemp168);
			double fTemp170 = fTemp169 * (fTemp169 + fTemp18 / fTemp168) + 1.0;
			double fTemp171 = fTemp169 * (fTemp17 - fRec126[1]) + fRec125[1];
			fRec125[0] = 2.0 * (fTemp171 / fTemp170) - fRec125[1];
			fRec126[0] = fRec126[1] + 2.0 * (fTemp169 * fTemp171 / fTemp170);
			double fTemp172 = 0.005757190000000001 * fRec42[0] + fRec43[0] * (-0.0044776 - 0.0012795900000000006 * fRec42[0]) + 0.00941733;
			double fRec127 = fTemp171 * fTemp172 / fTemp170;
			double fTemp173 = fRec40[0] * (fTemp25 + fRec43[0] * (104.0 - fTemp36) + 1899.0);
			double fTemp174 = std::tan(fConst5 * fTemp173);
			double fTemp175 = fTemp174 * (fTemp174 + fTemp18 / fTemp173) + 1.0;
			double fTemp176 = fTemp174 * (fTemp17 - fRec129[1]) + fRec128[1];
			fRec128[0] = 2.0 * (fTemp176 / fTemp175) - fRec128[1];
			fRec129[0] = fRec129[1] + 2.0 * (fTemp174 * fTemp176 / fTemp175);
			double fTemp177 = 0.00223778 * fRec42[0] + fRec43[0] * (0.003461960000000001 - 0.005699740000000001 * fRec42[0]) + 0.00503596;
			double fRec130 = fTemp176 * fTemp177 / fTemp175;
			double fTemp178 = fRec40[0] * (fTemp37 + fRec43[0] * (107.0 - fTemp24) + 2.03e+03);
			double fTemp179 = std::tan(fConst5 * fTemp178);
			double fTemp180 = fTemp179 * (fTemp179 + fTemp18 / fTemp178) + 1.0;
			double fTemp181 = fTemp179 * (fTemp17 - fRec132[1]) + fRec131[1];
			fRec131[0] = 2.0 * (fTemp181 / fTemp180) - fRec131[1];
			fRec132[0] = fRec132[1] + 2.0 * (fTemp179 * fTemp181 / fTemp180);
			double fTemp182 = 0.0033720900000000003 * fRec42[0] + fRec43[0] * (0.007210579999999999 - 0.010582669999999999 * fRec42[0]) + 0.00223048;
			double fRec133 = fTemp181 * fTemp182 / fTemp180;
			double fTemp183 = fRec40[0] * (fTemp25 + fRec43[0] * (109.0 - 116.0 * fRec42[0]) + 2162.0);
			double fTemp184 = std::tan(fConst5 * fTemp183);
			double fTemp185 = fTemp184 * (fTemp184 + fTemp18 / fTemp183) + 1.0;
			double fTemp186 = fTemp184 * (fTemp17 - fRec135[1]) + fRec134[1];
			fRec134[0] = 2.0 * (fTemp186 / fTemp185) - fRec134[1];
			fRec135[0] = fRec135[1] + 2.0 * (fTemp184 * fTemp186 / fTemp185);
			double fTemp187 = 0.01214753 * fRec42[0] + fRec43[0] * (0.005874650000000001 - 0.018022180000000002 * fRec42[0]) + 0.00459407;
			double fRec136 = fTemp186 * fTemp187 / fTemp185;
			fRec137[0] = fSlow15 + fConst3 * fRec137[1];
			double fTemp188 = 0.03125 * fRec137[0] * (fRec136 + fRec133 + fRec130 + fRec127 + fRec124 + fRec121 + fRec118 + fRec115 + fRec112 + fRec109 + fRec106 + fRec103 + fRec100 + fRec97 + fRec94 + fRec91 + fRec88 + fRec85 + fRec82 + fRec79 + fRec76 + fRec73 + fRec70 + fRec67 + fRec64 + fRec61 + fRec58 + fRec55 + fRec52 + fRec49 + fRec46 + fRec39) + fRec36[0] * fTemp17;
			fRec21[0] = std::max<double>(fConst1 * fRec21[1], std::fabs(fTemp188));
			fVbargraph4 = FAUSTFLOAT(fRec21[0]);
			fRec18[0] = fTemp188;
			fVec3[0] = 1.3;
			double fTemp189 = 1.3 - fVec3[1];
			double fTemp190 = fRec26[0] * fRec20[1];
			fRec142[0] = std::max<double>(fConst1 * fRec142[1], std::fabs(fTemp190));
			fVbargraph5 = FAUSTFLOAT(fRec142[0]);
			double fTemp191 = fTemp190;
			fRec143[0] = fSlow16 + fConst3 * fRec143[1];
			double fTemp192 = fRec28[0] * (fTemp7 * (fRec143[0] - fTemp191) - fTemp9);
			double fTemp193 = fTemp12 + fRec31[1];
			double fTemp194 = fTemp193 + fTemp9;
			fVec4[0] = fTemp194 + fTemp192 + fTemp189;
			fRec141[0] = fTemp192 + 0.995 * fRec141[1] + fTemp194 + (1.3 - (fVec3[1] + fVec4[1]));
			fRec140[0] = std::max<double>(fConst1 * fRec140[1], std::fabs(fRec141[0]));
			fVbargraph6 = FAUSTFLOAT(fRec140[0]);
			double fTemp195 = fRec17[0] * tanh(fRec141[0] / fTemp4);
			fRec139[0] = std::max<double>(fConst1 * fRec139[1], std::fabs(fTemp195));
			fVbargraph7 = FAUSTFLOAT(fRec139[0]);
			double fTemp196 = fTemp195;
			double fTemp197 = fTemp20 * (fTemp196 - fRec145[1]) + fRec144[1];
			fRec144[0] = 2.0 * (fTemp197 / fTemp21) - fRec144[1];
			fRec145[0] = fRec145[1] + 2.0 * (fTemp20 * fTemp197 / fTemp21);
			double fRec146 = fTemp23 * fTemp197 / fTemp21;
			double fTemp198 = fTemp27 * (fTemp196 - fRec148[1]) + fRec147[1];
			fRec147[0] = 2.0 * (fTemp198 / fTemp28) - fRec147[1];
			fRec148[0] = fRec148[1] + 2.0 * (fTemp27 * fTemp198 / fTemp28);
			double fRec149 = fTemp30 * fTemp198 / fTemp28;
			double fTemp199 = fTemp32 * (fTemp196 - fRec151[1]) + fRec150[1];
			fRec150[0] = 2.0 * (fTemp199 / fTemp33) - fRec150[1];
			fRec151[0] = fRec151[1] + 2.0 * (fTemp32 * fTemp199 / fTemp33);
			double fRec152 = fTemp35 * fTemp199 / fTemp33;
			double fTemp200 = fTemp39 * (fTemp196 - fRec154[1]) + fRec153[1];
			fRec153[0] = 2.0 * (fTemp200 / fTemp40) - fRec153[1];
			fRec154[0] = fRec154[1] + 2.0 * (fTemp39 * fTemp200 / fTemp40);
			double fRec155 = fTemp42 * fTemp200 / fTemp40;
			double fTemp201 = fTemp44 * (fTemp196 - fRec157[1]) + fRec156[1];
			fRec156[0] = 2.0 * (fTemp201 / fTemp45) - fRec156[1];
			fRec157[0] = fRec157[1] + 2.0 * (fTemp44 * fTemp201 / fTemp45);
			double fRec158 = fTemp47 * fTemp201 / fTemp45;
			double fTemp202 = fTemp50 * (fTemp196 - fRec160[1]) + fRec159[1];
			fRec159[0] = 2.0 * (fTemp202 / fTemp51) - fRec159[1];
			fRec160[0] = fRec160[1] + 2.0 * (fTemp50 * fTemp202 / fTemp51);
			double fRec161 = fTemp53 * fTemp202 / fTemp51;
			double fTemp203 = fTemp56 * (fTemp196 - fRec163[1]) + fRec162[1];
			fRec162[0] = 2.0 * (fTemp203 / fTemp57) - fRec162[1];
			fRec163[0] = fRec163[1] + 2.0 * (fTemp56 * fTemp203 / fTemp57);
			double fRec164 = fTemp59 * fTemp203 / fTemp57;
			double fTemp204 = fTemp61 * (fTemp196 - fRec166[1]) + fRec165[1];
			fRec165[0] = 2.0 * (fTemp204 / fTemp62) - fRec165[1];
			fRec166[0] = fRec166[1] + 2.0 * (fTemp61 * fTemp204 / fTemp62);
			double fRec167 = fTemp64 * fTemp204 / fTemp62;
			double fTemp205 = fTemp66 * (fTemp196 - fRec169[1]) + fRec168[1];
			fRec168[0] = 2.0 * (fTemp205 / fTemp67) - fRec168[1];
			fRec169[0] = fRec169[1] + 2.0 * (fTemp66 * fTemp205 / fTemp67);
			double fRec170 = fTemp69 * fTemp205 / fTemp67;
			double fTemp206 = fTemp71 * (fTemp196 - fRec172[1]) + fRec171[1];
			fRec171[0] = 2.0 * (fTemp206 / fTemp72) - fRec171[1];
			fRec172[0] = fRec172[1] + 2.0 * (fTemp71 * fTemp206 / fTemp72);
			double fRec173 = fTemp74 * fTemp206 / fTemp72;
			double fTemp207 = fTemp77 * (fTemp196 - fRec175[1]) + fRec174[1];
			fRec174[0] = 2.0 * (fTemp207 / fTemp78) - fRec174[1];
			fRec175[0] = fRec175[1] + 2.0 * (fTemp77 * fTemp207 / fTemp78);
			double fRec176 = fTemp80 * fTemp207 / fTemp78;
			double fTemp208 = fTemp82 * (fTemp196 - fRec178[1]) + fRec177[1];
			fRec177[0] = 2.0 * (fTemp208 / fTemp83) - fRec177[1];
			fRec178[0] = fRec178[1] + 2.0 * (fTemp82 * fTemp208 / fTemp83);
			double fRec179 = fTemp85 * fTemp208 / fTemp83;
			double fTemp209 = fTemp88 * (fTemp196 - fRec181[1]) + fRec180[1];
			fRec180[0] = 2.0 * (fTemp209 / fTemp89) - fRec180[1];
			fRec181[0] = fRec181[1] + 2.0 * (fTemp88 * fTemp209 / fTemp89);
			double fRec182 = fTemp91 * fTemp209 / fTemp89;
			double fTemp210 = fTemp94 * (fTemp196 - fRec184[1]) + fRec183[1];
			fRec183[0] = 2.0 * (fTemp210 / fTemp95) - fRec183[1];
			fRec184[0] = fRec184[1] + 2.0 * (fTemp94 * fTemp210 / fTemp95);
			double fRec185 = fTemp97 * fTemp210 / fTemp95;
			double fTemp211 = fTemp99 * (fTemp196 - fRec187[1]) + fRec186[1];
			fRec186[0] = 2.0 * (fTemp211 / fTemp100) - fRec186[1];
			fRec187[0] = fRec187[1] + 2.0 * (fTemp99 * fTemp211 / fTemp100);
			double fRec188 = fTemp102 * fTemp211 / fTemp100;
			double fTemp212 = fTemp104 * (fTemp196 - fRec190[1]) + fRec189[1];
			fRec189[0] = 2.0 * (fTemp212 / fTemp105) - fRec189[1];
			fRec190[0] = fRec190[1] + 2.0 * (fTemp104 * fTemp212 / fTemp105);
			double fRec191 = fTemp107 * fTemp212 / fTemp105;
			double fTemp213 = fTemp108 * (fTemp196 - fRec193[1]) + fRec192[1];
			fRec192[0] = 2.0 * (fTemp213 / fTemp109) - fRec192[1];
			fRec193[0] = fRec193[1] + 2.0 * (fTemp108 * fTemp213 / fTemp109);
			double fRec194 = fTemp111 * fTemp213 / fTemp109;
			double fTemp214 = fTemp113 * (fTemp196 - fRec196[1]) + fRec195[1];
			fRec195[0] = 2.0 * (fTemp214 / fTemp114) - fRec195[1];
			fRec196[0] = fRec196[1] + 2.0 * (fTemp113 * fTemp214 / fTemp114);
			double fRec197 = fTemp116 * fTemp214 / fTemp114;
			double fTemp215 = fTemp118 * (fTemp196 - fRec199[1]) + fRec198[1];
			fRec198[0] = 2.0 * (fTemp215 / fTemp119) - fRec198[1];
			fRec199[0] = fRec199[1] + 2.0 * (fTemp118 * fTemp215 / fTemp119);
			double fRec200 = fTemp121 * fTemp215 / fTemp119;
			double fTemp216 = fTemp123 * (fTemp196 - fRec202[1]) + fRec201[1];
			fRec201[0] = 2.0 * (fTemp216 / fTemp124) - fRec201[1];
			fRec202[0] = fRec202[1] + 2.0 * (fTemp123 * fTemp216 / fTemp124);
			double fRec203 = fTemp126 * fTemp216 / fTemp124;
			double fTemp217 = fTemp128 * (fTemp196 - fRec205[1]) + fRec204[1];
			fRec204[0] = 2.0 * (fTemp217 / fTemp129) - fRec204[1];
			fRec205[0] = fRec205[1] + 2.0 * (fTemp128 * fTemp217 / fTemp129);
			double fRec206 = fTemp131 * fTemp217 / fTemp129;
			double fTemp218 = fTemp134 * (fTemp196 - fRec208[1]) + fRec207[1];
			fRec207[0] = 2.0 * (fTemp218 / fTemp135) - fRec207[1];
			fRec208[0] = fRec208[1] + 2.0 * (fTemp134 * fTemp218 / fTemp135);
			double fRec209 = fTemp137 * fTemp218 / fTemp135;
			double fTemp219 = fTemp139 * (fTemp196 - fRec211[1]) + fRec210[1];
			fRec210[0] = 2.0 * (fTemp219 / fTemp140) - fRec210[1];
			fRec211[0] = fRec211[1] + 2.0 * (fTemp139 * fTemp219 / fTemp140);
			double fRec212 = fTemp142 * fTemp219 / fTemp140;
			double fTemp220 = fTemp144 * (fTemp196 - fRec214[1]) + fRec213[1];
			fRec213[0] = 2.0 * (fTemp220 / fTemp145) - fRec213[1];
			fRec214[0] = fRec214[1] + 2.0 * (fTemp144 * fTemp220 / fTemp145);
			double fRec215 = fTemp147 * fTemp220 / fTemp145;
			double fTemp221 = fTemp149 * (fTemp196 - fRec217[1]) + fRec216[1];
			fRec216[0] = 2.0 * (fTemp221 / fTemp150) - fRec216[1];
			fRec217[0] = fRec217[1] + 2.0 * (fTemp149 * fTemp221 / fTemp150);
			double fRec218 = fTemp152 * fTemp221 / fTemp150;
			double fTemp222 = fTemp154 * (fTemp196 - fRec220[1]) + fRec219[1];
			fRec219[0] = 2.0 * (fTemp222 / fTemp155) - fRec219[1];
			fRec220[0] = fRec220[1] + 2.0 * (fTemp154 * fTemp222 / fTemp155);
			double fRec221 = fTemp157 * fTemp222 / fTemp155;
			double fTemp223 = fTemp159 * (fTemp196 - fRec223[1]) + fRec222[1];
			fRec222[0] = 2.0 * (fTemp223 / fTemp160) - fRec222[1];
			fRec223[0] = fRec223[1] + 2.0 * (fTemp159 * fTemp223 / fTemp160);
			double fRec224 = fTemp162 * fTemp223 / fTemp160;
			double fTemp224 = fTemp164 * (fTemp196 - fRec226[1]) + fRec225[1];
			fRec225[0] = 2.0 * (fTemp224 / fTemp165) - fRec225[1];
			fRec226[0] = fRec226[1] + 2.0 * (fTemp164 * fTemp224 / fTemp165);
			double fRec227 = fTemp167 * fTemp224 / fTemp165;
			double fTemp225 = fTemp169 * (fTemp196 - fRec229[1]) + fRec228[1];
			fRec228[0] = 2.0 * (fTemp225 / fTemp170) - fRec228[1];
			fRec229[0] = fRec229[1] + 2.0 * (fTemp169 * fTemp225 / fTemp170);
			double fRec230 = fTemp172 * fTemp225 / fTemp170;
			double fTemp226 = fTemp174 * (fTemp196 - fRec232[1]) + fRec231[1];
			fRec231[0] = 2.0 * (fTemp226 / fTemp175) - fRec231[1];
			fRec232[0] = fRec232[1] + 2.0 * (fTemp174 * fTemp226 / fTemp175);
			double fRec233 = fTemp177 * fTemp226 / fTemp175;
			double fTemp227 = fTemp179 * (fTemp196 - fRec235[1]) + fRec234[1];
			fRec234[0] = 2.0 * (fTemp227 / fTemp180) - fRec234[1];
			fRec235[0] = fRec235[1] + 2.0 * (fTemp179 * fTemp227 / fTemp180);
			double fRec236 = fTemp182 * fTemp227 / fTemp180;
			double fTemp228 = fTemp184 * (fTemp196 - fRec238[1]) + fRec237[1];
			fRec237[0] = 2.0 * (fTemp228 / fTemp185) - fRec237[1];
			fRec238[0] = fRec238[1] + 2.0 * (fTemp184 * fTemp228 / fTemp185);
			double fRec239 = fTemp187 * fTemp228 / fTemp185;
			double fTemp229 = 0.03125 * fRec137[0] * (fRec239 + fRec236 + fRec233 + fRec230 + fRec227 + fRec224 + fRec221 + fRec218 + fRec215 + fRec212 + fRec209 + fRec206 + fRec203 + fRec200 + fRec197 + fRec194 + fRec191 + fRec188 + fRec185 + fRec182 + fRec179 + fRec176 + fRec173 + fRec170 + fRec167 + fRec164 + fRec161 + fRec158 + fRec155 + fRec152 + fRec149 + fRec146) + fRec36[0] * fTemp196;
			fRec138[0] = std::max<double>(fConst1 * fRec138[1], std::fabs(fTemp229));
			fVbargraph8 = FAUSTFLOAT(fRec138[0]);
			fRec19[0] = fTemp229;
			fVec5[0] = 1.6;
			double fTemp230 = 1.6 - fVec5[1];
			fRec244[0] = fSlow17 + fConst3 * fRec244[1];
			double fTemp231 = fRec28[0] * (fTemp7 * fTemp9 - fRec244[0] * fTemp191);
			double fTemp232 = fTemp193 + fTemp191;
			fVec6[0] = fTemp232 + fTemp231 + fTemp230;
			fRec243[0] = fTemp231 + 0.995 * fRec243[1] + fTemp232 + (1.6 - (fVec5[1] + fVec6[1]));
			fRec242[0] = std::max<double>(fConst1 * fRec242[1], std::fabs(fRec243[0]));
			fVbargraph9 = FAUSTFLOAT(fRec242[0]);
			double fTemp233 = fRec17[0] * tanh(fRec243[0] / fTemp4);
			fRec241[0] = std::max<double>(fConst1 * fRec241[1], std::fabs(fTemp233));
			fVbargraph10 = FAUSTFLOAT(fRec241[0]);
			double fTemp234 = fTemp233;
			double fTemp235 = fTemp20 * (fTemp234 - fRec246[1]) + fRec245[1];
			fRec245[0] = 2.0 * (fTemp235 / fTemp21) - fRec245[1];
			fRec246[0] = fRec246[1] + 2.0 * (fTemp20 * fTemp235 / fTemp21);
			double fRec247 = fTemp23 * fTemp235 / fTemp21;
			double fTemp236 = fTemp27 * (fTemp234 - fRec249[1]) + fRec248[1];
			fRec248[0] = 2.0 * (fTemp236 / fTemp28) - fRec248[1];
			fRec249[0] = fRec249[1] + 2.0 * (fTemp27 * fTemp236 / fTemp28);
			double fRec250 = fTemp30 * fTemp236 / fTemp28;
			double fTemp237 = fTemp32 * (fTemp234 - fRec252[1]) + fRec251[1];
			fRec251[0] = 2.0 * (fTemp237 / fTemp33) - fRec251[1];
			fRec252[0] = fRec252[1] + 2.0 * (fTemp32 * fTemp237 / fTemp33);
			double fRec253 = fTemp35 * fTemp237 / fTemp33;
			double fTemp238 = fTemp39 * (fTemp234 - fRec255[1]) + fRec254[1];
			fRec254[0] = 2.0 * (fTemp238 / fTemp40) - fRec254[1];
			fRec255[0] = fRec255[1] + 2.0 * (fTemp39 * fTemp238 / fTemp40);
			double fRec256 = fTemp42 * fTemp238 / fTemp40;
			double fTemp239 = fTemp44 * (fTemp234 - fRec258[1]) + fRec257[1];
			fRec257[0] = 2.0 * (fTemp239 / fTemp45) - fRec257[1];
			fRec258[0] = fRec258[1] + 2.0 * (fTemp44 * fTemp239 / fTemp45);
			double fRec259 = fTemp47 * fTemp239 / fTemp45;
			double fTemp240 = fTemp50 * (fTemp234 - fRec261[1]) + fRec260[1];
			fRec260[0] = 2.0 * (fTemp240 / fTemp51) - fRec260[1];
			fRec261[0] = fRec261[1] + 2.0 * (fTemp50 * fTemp240 / fTemp51);
			double fRec262 = fTemp53 * fTemp240 / fTemp51;
			double fTemp241 = fTemp56 * (fTemp234 - fRec264[1]) + fRec263[1];
			fRec263[0] = 2.0 * (fTemp241 / fTemp57) - fRec263[1];
			fRec264[0] = fRec264[1] + 2.0 * (fTemp56 * fTemp241 / fTemp57);
			double fRec265 = fTemp59 * fTemp241 / fTemp57;
			double fTemp242 = fTemp61 * (fTemp234 - fRec267[1]) + fRec266[1];
			fRec266[0] = 2.0 * (fTemp242 / fTemp62) - fRec266[1];
			fRec267[0] = fRec267[1] + 2.0 * (fTemp61 * fTemp242 / fTemp62);
			double fRec268 = fTemp64 * fTemp242 / fTemp62;
			double fTemp243 = fTemp66 * (fTemp234 - fRec270[1]) + fRec269[1];
			fRec269[0] = 2.0 * (fTemp243 / fTemp67) - fRec269[1];
			fRec270[0] = fRec270[1] + 2.0 * (fTemp66 * fTemp243 / fTemp67);
			double fRec271 = fTemp69 * fTemp243 / fTemp67;
			double fTemp244 = fTemp71 * (fTemp234 - fRec273[1]) + fRec272[1];
			fRec272[0] = 2.0 * (fTemp244 / fTemp72) - fRec272[1];
			fRec273[0] = fRec273[1] + 2.0 * (fTemp71 * fTemp244 / fTemp72);
			double fRec274 = fTemp74 * fTemp244 / fTemp72;
			double fTemp245 = fTemp77 * (fTemp234 - fRec276[1]) + fRec275[1];
			fRec275[0] = 2.0 * (fTemp245 / fTemp78) - fRec275[1];
			fRec276[0] = fRec276[1] + 2.0 * (fTemp77 * fTemp245 / fTemp78);
			double fRec277 = fTemp80 * fTemp245 / fTemp78;
			double fTemp246 = fTemp82 * (fTemp234 - fRec279[1]) + fRec278[1];
			fRec278[0] = 2.0 * (fTemp246 / fTemp83) - fRec278[1];
			fRec279[0] = fRec279[1] + 2.0 * (fTemp82 * fTemp246 / fTemp83);
			double fRec280 = fTemp85 * fTemp246 / fTemp83;
			double fTemp247 = fTemp88 * (fTemp234 - fRec282[1]) + fRec281[1];
			fRec281[0] = 2.0 * (fTemp247 / fTemp89) - fRec281[1];
			fRec282[0] = fRec282[1] + 2.0 * (fTemp88 * fTemp247 / fTemp89);
			double fRec283 = fTemp91 * fTemp247 / fTemp89;
			double fTemp248 = fTemp94 * (fTemp234 - fRec285[1]) + fRec284[1];
			fRec284[0] = 2.0 * (fTemp248 / fTemp95) - fRec284[1];
			fRec285[0] = fRec285[1] + 2.0 * (fTemp94 * fTemp248 / fTemp95);
			double fRec286 = fTemp97 * fTemp248 / fTemp95;
			double fTemp249 = fTemp99 * (fTemp234 - fRec288[1]) + fRec287[1];
			fRec287[0] = 2.0 * (fTemp249 / fTemp100) - fRec287[1];
			fRec288[0] = fRec288[1] + 2.0 * (fTemp99 * fTemp249 / fTemp100);
			double fRec289 = fTemp102 * fTemp249 / fTemp100;
			double fTemp250 = fTemp104 * (fTemp234 - fRec291[1]) + fRec290[1];
			fRec290[0] = 2.0 * (fTemp250 / fTemp105) - fRec290[1];
			fRec291[0] = fRec291[1] + 2.0 * (fTemp104 * fTemp250 / fTemp105);
			double fRec292 = fTemp107 * fTemp250 / fTemp105;
			double fTemp251 = fTemp108 * (fTemp234 - fRec294[1]) + fRec293[1];
			fRec293[0] = 2.0 * (fTemp251 / fTemp109) - fRec293[1];
			fRec294[0] = fRec294[1] + 2.0 * (fTemp108 * fTemp251 / fTemp109);
			double fRec295 = fTemp111 * fTemp251 / fTemp109;
			double fTemp252 = fTemp113 * (fTemp234 - fRec297[1]) + fRec296[1];
			fRec296[0] = 2.0 * (fTemp252 / fTemp114) - fRec296[1];
			fRec297[0] = fRec297[1] + 2.0 * (fTemp113 * fTemp252 / fTemp114);
			double fRec298 = fTemp116 * fTemp252 / fTemp114;
			double fTemp253 = fTemp118 * (fTemp234 - fRec300[1]) + fRec299[1];
			fRec299[0] = 2.0 * (fTemp253 / fTemp119) - fRec299[1];
			fRec300[0] = fRec300[1] + 2.0 * (fTemp118 * fTemp253 / fTemp119);
			double fRec301 = fTemp121 * fTemp253 / fTemp119;
			double fTemp254 = fTemp123 * (fTemp234 - fRec303[1]) + fRec302[1];
			fRec302[0] = 2.0 * (fTemp254 / fTemp124) - fRec302[1];
			fRec303[0] = fRec303[1] + 2.0 * (fTemp123 * fTemp254 / fTemp124);
			double fRec304 = fTemp126 * fTemp254 / fTemp124;
			double fTemp255 = fTemp128 * (fTemp234 - fRec306[1]) + fRec305[1];
			fRec305[0] = 2.0 * (fTemp255 / fTemp129) - fRec305[1];
			fRec306[0] = fRec306[1] + 2.0 * (fTemp128 * fTemp255 / fTemp129);
			double fRec307 = fTemp131 * fTemp255 / fTemp129;
			double fTemp256 = fTemp134 * (fTemp234 - fRec309[1]) + fRec308[1];
			fRec308[0] = 2.0 * (fTemp256 / fTemp135) - fRec308[1];
			fRec309[0] = fRec309[1] + 2.0 * (fTemp134 * fTemp256 / fTemp135);
			double fRec310 = fTemp137 * fTemp256 / fTemp135;
			double fTemp257 = fTemp139 * (fTemp234 - fRec312[1]) + fRec311[1];
			fRec311[0] = 2.0 * (fTemp257 / fTemp140) - fRec311[1];
			fRec312[0] = fRec312[1] + 2.0 * (fTemp139 * fTemp257 / fTemp140);
			double fRec313 = fTemp142 * fTemp257 / fTemp140;
			double fTemp258 = fTemp144 * (fTemp234 - fRec315[1]) + fRec314[1];
			fRec314[0] = 2.0 * (fTemp258 / fTemp145) - fRec314[1];
			fRec315[0] = fRec315[1] + 2.0 * (fTemp144 * fTemp258 / fTemp145);
			double fRec316 = fTemp147 * fTemp258 / fTemp145;
			double fTemp259 = fTemp149 * (fTemp234 - fRec318[1]) + fRec317[1];
			fRec317[0] = 2.0 * (fTemp259 / fTemp150) - fRec317[1];
			fRec318[0] = fRec318[1] + 2.0 * (fTemp149 * fTemp259 / fTemp150);
			double fRec319 = fTemp152 * fTemp259 / fTemp150;
			double fTemp260 = fTemp154 * (fTemp234 - fRec321[1]) + fRec320[1];
			fRec320[0] = 2.0 * (fTemp260 / fTemp155) - fRec320[1];
			fRec321[0] = fRec321[1] + 2.0 * (fTemp154 * fTemp260 / fTemp155);
			double fRec322 = fTemp157 * fTemp260 / fTemp155;
			double fTemp261 = fTemp159 * (fTemp234 - fRec324[1]) + fRec323[1];
			fRec323[0] = 2.0 * (fTemp261 / fTemp160) - fRec323[1];
			fRec324[0] = fRec324[1] + 2.0 * (fTemp159 * fTemp261 / fTemp160);
			double fRec325 = fTemp162 * fTemp261 / fTemp160;
			double fTemp262 = fTemp164 * (fTemp234 - fRec327[1]) + fRec326[1];
			fRec326[0] = 2.0 * (fTemp262 / fTemp165) - fRec326[1];
			fRec327[0] = fRec327[1] + 2.0 * (fTemp164 * fTemp262 / fTemp165);
			double fRec328 = fTemp167 * fTemp262 / fTemp165;
			double fTemp263 = fTemp169 * (fTemp234 - fRec330[1]) + fRec329[1];
			fRec329[0] = 2.0 * (fTemp263 / fTemp170) - fRec329[1];
			fRec330[0] = fRec330[1] + 2.0 * (fTemp169 * fTemp263 / fTemp170);
			double fRec331 = fTemp172 * fTemp263 / fTemp170;
			double fTemp264 = fTemp174 * (fTemp234 - fRec333[1]) + fRec332[1];
			fRec332[0] = 2.0 * (fTemp264 / fTemp175) - fRec332[1];
			fRec333[0] = fRec333[1] + 2.0 * (fTemp174 * fTemp264 / fTemp175);
			double fRec334 = fTemp177 * fTemp264 / fTemp175;
			double fTemp265 = fTemp179 * (fTemp234 - fRec336[1]) + fRec335[1];
			fRec335[0] = 2.0 * (fTemp265 / fTemp180) - fRec335[1];
			fRec336[0] = fRec336[1] + 2.0 * (fTemp179 * fTemp265 / fTemp180);
			double fRec337 = fTemp182 * fTemp265 / fTemp180;
			double fTemp266 = fTemp184 * (fTemp234 - fRec339[1]) + fRec338[1];
			fRec338[0] = 2.0 * (fTemp266 / fTemp185) - fRec338[1];
			fRec339[0] = fRec339[1] + 2.0 * (fTemp184 * fTemp266 / fTemp185);
			double fRec340 = fTemp187 * fTemp266 / fTemp185;
			double fTemp267 = 0.03125 * fRec137[0] * (fRec340 + fRec337 + fRec334 + fRec331 + fRec328 + fRec325 + fRec322 + fRec319 + fRec316 + fRec313 + fRec310 + fRec307 + fRec304 + fRec301 + fRec298 + fRec295 + fRec292 + fRec289 + fRec286 + fRec283 + fRec280 + fRec277 + fRec274 + fRec271 + fRec268 + fRec265 + fRec262 + fRec259 + fRec256 + fRec253 + fRec250 + fRec247) + fRec36[0] * fTemp234;
			fRec240[0] = std::max<double>(fConst1 * fRec240[1], std::fabs(fTemp267));
			fVbargraph11 = FAUSTFLOAT(fRec240[0]);
			fRec20[0] = fTemp267;
			double fTemp268 = (fRec20[0] + fRec18[0] + fRec19[0]) / fTemp4;
			fVec7[IOTA0 & 4194303] = fTemp268;
			double fTemp269 = ((fRec341[1] != 0.0) ? (((fRec342[1] > 0.0) & (fRec342[1] < 1.0)) ? fRec341[1] : 0.0) : (((fRec342[1] == 0.0) & (fSlow18 != fRec343[1])) ? 0.0009765625 : (((fRec342[1] == 1.0) & (fSlow18 != fRec344[1])) ? -0.0009765625 : 0.0)));
			fRec341[0] = fTemp269;
			fRec342[0] = std::max<double>(0.0, std::min<double>(1.0, fRec342[1] + fTemp269));
			fRec343[0] = (((fRec342[1] >= 1.0) & (fRec344[1] != fSlow18)) ? fSlow18 : fRec343[1]);
			fRec344[0] = (((fRec342[1] <= 0.0) & (fRec343[1] != fSlow18)) ? fSlow18 : fRec344[1]);
			double fTemp270 = fVec7[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec343[0])))) & 4194303];
			fRec16[0] = 0.3333333333333333 * fTemp270 + fRec342[0] * (0.0 - 0.3333333333333333 * (fTemp270 - fVec7[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec344[0])))) & 4194303]));
			double fTemp271 = fRec26[0] * fRec346[1];
			fRec353[0] = std::max<double>(fConst1 * fRec353[1], std::fabs(fTemp271));
			fVbargraph12 = FAUSTFLOAT(fRec353[0]);
			double fTemp272 = fTemp271;
			double fTemp273 = fRec26[0] * fRec347[1];
			fRec354[0] = std::max<double>(fConst1 * fRec354[1], std::fabs(fTemp273));
			fVbargraph13 = FAUSTFLOAT(fRec354[0]);
			double fTemp274 = fTemp273;
			double fTemp275 = fTemp10 * (fTemp274 - fTemp272);
			double fTemp276 = fSlow19 * fRec11[1];
			fVec8[IOTA0 & 4194303] = fTemp276;
			double fTemp277 = ((fRec356[1] != 0.0) ? (((fRec357[1] > 0.0) & (fRec357[1] < 1.0)) ? fRec356[1] : 0.0) : (((fRec357[1] == 0.0) & (fSlow20 != fRec358[1])) ? 0.0009765625 : (((fRec357[1] == 1.0) & (fSlow20 != fRec359[1])) ? -0.0009765625 : 0.0)));
			fRec356[0] = fTemp277;
			fRec357[0] = std::max<double>(0.0, std::min<double>(1.0, fRec357[1] + fTemp277));
			fRec358[0] = (((fRec357[1] >= 1.0) & (fRec359[1] != fSlow20)) ? fSlow20 : fRec358[1]);
			fRec359[0] = (((fRec357[1] <= 0.0) & (fRec358[1] != fSlow20)) ? fSlow20 : fRec359[1]);
			double fTemp278 = fVec8[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec358[0])))) & 4194303];
			fRec355[0] = fTemp278 + fRec357[0] * (fVec8[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec359[0])))) & 4194303] - fTemp278);
			fVec9[0] = fRec355[1] + fTemp12 + fTemp272 + fTemp275 + fTemp5;
			fRec352[0] = fTemp275 + fRec355[1] + fTemp272 + fTemp12 + 0.995 * fRec352[1] + (1.2 - (fVec0[1] + fVec9[1]));
			fRec351[0] = std::max<double>(fConst1 * fRec351[1], std::fabs(fRec352[0]));
			fVbargraph14 = FAUSTFLOAT(fRec351[0]);
			double fTemp279 = fRec17[0] * tanh(fRec352[0] / fTemp4);
			fRec350[0] = std::max<double>(fConst1 * fRec350[1], std::fabs(fTemp279));
			fVbargraph15 = FAUSTFLOAT(fRec350[0]);
			double fTemp280 = fTemp279;
			fRec363[0] = fSlow21 + fConst3 * fRec363[1];
			double fTemp281 = fTemp18 / fRec363[0];
			double fTemp282 = std::tan(fConst7 * fRec363[0]);
			double fTemp283 = fTemp282 * (fTemp282 + 0.005076142131979695 * fTemp281) + 1.0;
			double fTemp284 = fTemp282 * (fTemp280 - fRec361[1]) + fRec360[1];
			fRec360[0] = 2.0 * (fTemp284 / fTemp283) - fRec360[1];
			fRec361[0] = fRec361[1] + 2.0 * (fTemp282 * fTemp284 / fTemp283);
			fRec364[0] = fSlow22 + fConst3 * fRec364[1];
			fRec365[0] = fSlow23 + fConst3 * fRec365[1];
			double fTemp285 = 0.51466542 * fRec364[0] + fRec365[0] * (0.51466542 - 1.02933084 * fRec364[0]) + 0.48533458;
			double fRec362 = fTemp284 * fTemp285 / fTemp283;
			double fTemp286 = 115.0 * fRec364[0];
			double fTemp287 = 7.0 * fRec364[0];
			double fTemp288 = fRec363[0] * (fTemp287 + fRec365[0] * (108.0 - fTemp286) + 2096.0);
			double fTemp289 = std::tan(fConst5 * fTemp288);
			double fTemp290 = fTemp289 * (fTemp289 + fTemp18 / fTemp288) + 1.0;
			double fTemp291 = fTemp289 * (fTemp280 - fRec367[1]) + fRec366[1];
			fRec366[0] = 2.0 * (fTemp291 / fTemp290) - fRec366[1];
			fRec367[0] = fRec367[1] + 2.0 * (fTemp289 * fTemp291 / fTemp290);
			double fTemp292 = 0.00492482 * fRec364[0] + fRec365[0] * (0.0035387400000000003 - 0.00846356 * fRec364[0]) + 0.00514822;
			double fRec368 = fTemp291 * fTemp292 / fTemp290;
			double fTemp293 = fRec363[0] * (fTemp287 + fRec365[0] * (106.0 - 113.0 * fRec364[0]) + 1965.0);
			double fTemp294 = std::tan(fConst5 * fTemp293);
			double fTemp295 = fTemp294 * (fTemp294 + fTemp18 / fTemp293) + 1.0;
			double fTemp296 = fTemp294 * (fTemp280 - fRec370[1]) + fRec369[1];
			fRec369[0] = 2.0 * (fTemp296 / fTemp295) - fRec369[1];
			fRec370[0] = fRec370[1] + 2.0 * (fTemp294 * fTemp296 / fTemp295);
			double fTemp297 = 0.003961 * fRec364[0] + fRec365[0] * (0.02133127 - 0.02529227 * fRec364[0]) + 0.00356349;
			double fRec371 = fTemp296 * fTemp297 / fTemp295;
			double fTemp298 = 111.0 * fRec364[0];
			double fTemp299 = 8.0 * fRec364[0];
			double fTemp300 = fRec363[0] * (fTemp299 + fRec365[0] * (103.0 - fTemp298) + 1834.0);
			double fTemp301 = std::tan(fConst5 * fTemp300);
			double fTemp302 = fTemp301 * (fTemp301 + fTemp18 / fTemp300) + 1.0;
			double fTemp303 = fTemp301 * (fTemp280 - fRec373[1]) + fRec372[1];
			fRec372[0] = 2.0 * (fTemp303 / fTemp302) - fRec372[1];
			fRec373[0] = fRec373[1] + 2.0 * (fTemp301 * fTemp303 / fTemp302);
			double fTemp304 = fRec365[0] * (0.00286025 * fRec364[0] + -3.855000000000004e-05) + (0.00511717 - 0.0028217 * fRec364[0]);
			double fRec374 = fTemp303 * fTemp304 / fTemp302;
			double fTemp305 = fRec363[0] * (fTemp287 + fRec365[0] * (101.0 - 108.0 * fRec364[0]) + 1702.0);
			double fTemp306 = std::tan(fConst5 * fTemp305);
			double fTemp307 = fTemp306 * (fTemp306 + fTemp18 / fTemp305) + 1.0;
			double fTemp308 = fTemp306 * (fTemp280 - fRec376[1]) + fRec375[1];
			fRec375[0] = 2.0 * (fTemp308 / fTemp307) - fRec375[1];
			fRec376[0] = fRec376[1] + 2.0 * (fTemp306 * fTemp308 / fTemp307);
			double fTemp309 = 0.015484530000000002 * fRec364[0] + fRec365[0] * (0.00335505 - 0.01883958 * fRec364[0]) + 0.0048918;
			double fRec377 = fTemp308 * fTemp309 / fTemp307;
			double fTemp310 = 6.0 * fRec364[0];
			double fTemp311 = fRec363[0] * (fTemp310 + fRec365[0] * (31.0 - 37.0 * fRec364[0]) + 1572.0);
			double fTemp312 = std::tan(fConst5 * fTemp311);
			double fTemp313 = fTemp312 * (fTemp312 + fTemp18 / fTemp311) + 1.0;
			double fTemp314 = fTemp312 * (fTemp280 - fRec379[1]) + fRec378[1];
			fRec378[0] = 2.0 * (fTemp314 / fTemp313) - fRec378[1];
			fRec379[0] = fRec379[1] + 2.0 * (fTemp312 * fTemp314 / fTemp313);
			double fTemp315 = fRec365[0] * (0.0007354499999999986 * fRec364[0] + -0.0006947099999999977) + (0.02091359 - 4.0740000000000914e-05 * fRec364[0]);
			double fRec380 = fTemp314 * fTemp315 / fTemp313;
			double fTemp316 = 5.0 * fRec364[0];
			double fTemp317 = fRec363[0] * (fTemp316 + fRec365[0] * (28.0 - 33.0 * fRec364[0]) + 1441.0);
			double fTemp318 = std::tan(fConst5 * fTemp317);
			double fTemp319 = fTemp318 * (fTemp318 + fTemp18 / fTemp317) + 1.0;
			double fTemp320 = fTemp318 * (fTemp280 - fRec382[1]) + fRec381[1];
			fRec381[0] = 2.0 * (fTemp320 / fTemp319) - fRec381[1];
			fRec382[0] = fRec382[1] + 2.0 * (fTemp318 * fTemp320 / fTemp319);
			double fTemp321 = 0.00404728 * fRec364[0] + fRec365[0] * (0.00189104 - 0.00593832 * fRec364[0]) + 0.00888014;
			double fRec383 = fTemp320 * fTemp321 / fTemp319;
			double fTemp322 = fRec363[0] * (fTemp316 + fRec365[0] * (26.0 - 31.0 * fRec364[0]) + 1.31e+03);
			double fTemp323 = std::tan(fConst5 * fTemp322);
			double fTemp324 = fTemp323 * (fTemp323 + fTemp18 / fTemp322) + 1.0;
			double fTemp325 = fTemp323 * (fTemp280 - fRec385[1]) + fRec384[1];
			fRec384[0] = 2.0 * (fTemp325 / fTemp324) - fRec384[1];
			fRec385[0] = fRec385[1] + 2.0 * (fTemp323 * fTemp325 / fTemp324);
			double fTemp326 = 0.0227416 * fRec364[0] + fRec365[0] * (0.00469608 - 0.02743768 * fRec364[0]) + 0.01193177;
			double fRec386 = fTemp325 * fTemp326 / fTemp324;
			double fTemp327 = fRec363[0] * (fTemp316 + fRec365[0] * (15.0 - 2e+01 * fRec364[0]) + 1178.0);
			double fTemp328 = std::tan(fConst5 * fTemp327);
			double fTemp329 = fTemp328 * (fTemp328 + fTemp18 / fTemp327) + 1.0;
			double fTemp330 = fTemp328 * (fTemp280 - fRec388[1]) + fRec387[1];
			fRec387[0] = 2.0 * (fTemp330 / fTemp329) - fRec387[1];
			fRec388[0] = fRec388[1] + 2.0 * (fTemp328 * fTemp330 / fTemp329);
			double fTemp331 = fRec365[0] * (0.004585809999999999 - 0.0018878599999999982 * fRec364[0]) + (0.01707981 - 0.002697950000000001 * fRec364[0]);
			double fRec389 = fTemp330 * fTemp331 / fTemp329;
			double fTemp332 = fRec363[0] * (fTemp316 + fRec365[0] * (22.0 - 27.0 * fRec364[0]) + 1047.0);
			double fTemp333 = std::tan(fConst5 * fTemp332);
			double fTemp334 = fTemp333 * (fTemp333 + fTemp18 / fTemp332) + 1.0;
			double fTemp335 = fTemp333 * (fTemp280 - fRec391[1]) + fRec390[1];
			fRec390[0] = 2.0 * (fTemp335 / fTemp334) - fRec390[1];
			fRec391[0] = fRec391[1] + 2.0 * (fTemp333 * fTemp335 / fTemp334);
			double fTemp336 = 0.01049454 * fRec364[0] + fRec365[0] * (0.022906150000000004 - 0.033400690000000004 * fRec364[0]) + 0.02127434;
			double fRec392 = fTemp335 * fTemp336 / fTemp334;
			double fTemp337 = 3.0 * fRec364[0];
			double fTemp338 = fRec363[0] * (fTemp337 + fRec365[0] * (1e+01 - 13.0 * fRec364[0]) + 917.0);
			double fTemp339 = std::tan(fConst5 * fTemp338);
			double fTemp340 = fTemp339 * (fTemp339 + fTemp18 / fTemp338) + 1.0;
			double fTemp341 = fTemp339 * (fTemp280 - fRec394[1]) + fRec393[1];
			fRec393[0] = 2.0 * (fTemp341 / fTemp340) - fRec393[1];
			fRec394[0] = fRec394[1] + 2.0 * (fTemp339 * fTemp341 / fTemp340);
			double fTemp342 = fRec365[0] * (0.11867802000000001 * fRec364[0] + -0.06216229000000001) + (0.08372042 - 0.05651573 * fRec364[0]);
			double fRec395 = fTemp341 * fTemp342 / fTemp340;
			double fTemp343 = fRec363[0] * (fTemp337 + fRec365[0] * (15.0 - 18.0 * fRec364[0]) + 786.0);
			double fTemp344 = std::tan(fConst5 * fTemp343);
			double fTemp345 = fTemp344 * (fTemp344 + fTemp18 / fTemp343) + 1.0;
			double fTemp346 = fTemp344 * (fTemp280 - fRec397[1]) + fRec396[1];
			fRec396[0] = 2.0 * (fTemp346 / fTemp345) - fRec396[1];
			fRec397[0] = fRec397[1] + 2.0 * (fTemp344 * fTemp346 / fTemp345);
			double fTemp347 = 0.007078770000000002 * fRec364[0] + fRec365[0] * (0.0313596 - 0.03843837 * fRec364[0]) + 0.02810959;
			double fRec398 = fTemp346 * fTemp347 / fTemp345;
			double fTemp348 = 2.0 * fRec364[0];
			double fTemp349 = fRec363[0] * (fTemp348 + fRec365[0] * (13.0 - 15.0 * fRec364[0]) + 655.0);
			double fTemp350 = std::tan(fConst5 * fTemp349);
			double fTemp351 = fTemp350 * (fTemp350 + fTemp18 / fTemp349) + 1.0;
			double fTemp352 = fTemp350 * (fTemp280 - fRec400[1]) + fRec399[1];
			fRec399[0] = 2.0 * (fTemp352 / fTemp351) - fRec399[1];
			fRec400[0] = fRec400[1] + 2.0 * (fTemp350 * fTemp352 / fTemp351);
			double fTemp353 = 0.039912470000000005 * fRec364[0] + fRec365[0] * (0.005417789999999992 - 0.04533026 * fRec364[0]) + 0.10262931;
			double fRec401 = fTemp352 * fTemp353 / fTemp351;
			double fTemp354 = fTemp348 + fRec365[0] * (1e+01 - 12.0 * fRec364[0]);
			double fTemp355 = fRec363[0] * (fTemp354 + 524.0);
			double fTemp356 = std::tan(fConst5 * fTemp355);
			double fTemp357 = fTemp356 * (fTemp356 + fTemp18 / fTemp355) + 1.0;
			double fTemp358 = fTemp356 * (fTemp280 - fRec403[1]) + fRec402[1];
			fRec402[0] = 2.0 * (fTemp358 / fTemp357) - fRec402[1];
			fRec403[0] = fRec403[1] + 2.0 * (fTemp356 * fTemp358 / fTemp357);
			double fTemp359 = 0.16088293999999997 * fRec364[0] + fRec365[0] * (-0.06794681000000001 - 0.09293612999999996 * fRec364[0]) + 0.15710983;
			double fRec404 = fTemp358 * fTemp359 / fTemp357;
			double fTemp360 = fRec363[0] * (fRec364[0] + fRec365[0] * (5.0 - fTemp310) + 393.0);
			double fTemp361 = std::tan(fConst5 * fTemp360);
			double fTemp362 = fTemp361 * (fTemp361 + fTemp18 / fTemp360) + 1.0;
			double fTemp363 = fTemp361 * (fTemp280 - fRec406[1]) + fRec405[1];
			fRec405[0] = 2.0 * (fTemp363 / fTemp362) - fRec405[1];
			fRec406[0] = fRec406[1] + 2.0 * (fTemp361 * fTemp363 / fTemp362);
			double fTemp364 = 0.52347231 * fRec364[0] + fRec365[0] * (-0.11388923 - 0.40958308000000004 * fRec364[0]) + 0.20074493;
			double fRec407 = fTemp363 * fTemp364 / fTemp362;
			double fTemp365 = fRec363[0] * (fRec364[0] + fRec365[0] * (4.0 - fTemp316) + 262.0);
			double fTemp366 = std::tan(fConst5 * fTemp365);
			double fTemp367 = fTemp366 * (fTemp366 + fTemp18 / fTemp365) + 1.0;
			double fTemp368 = fTemp366 * (fTemp280 - fRec409[1]) + fRec408[1];
			fRec408[0] = 2.0 * (fTemp368 / fTemp367) - fRec408[1];
			fRec409[0] = fRec409[1] + 2.0 * (fTemp366 * fTemp368 / fTemp367);
			double fTemp369 = 0.02997270000000002 * fRec364[0] + fRec365[0] * (0.13487834999999998 * fRec364[0] + -0.16485105) + 0.29825361;
			double fRec410 = fTemp368 * fTemp369 / fTemp367;
			double fTemp370 = std::tan(fConst8 * fRec363[0]);
			double fTemp371 = fTemp370 * (fTemp370 + 0.007633587786259542 * fTemp281) + 1.0;
			double fTemp372 = fTemp370 * (fTemp280 - fRec412[1]) + fRec411[1];
			fRec411[0] = 2.0 * (fTemp372 / fTemp371) - fRec411[1];
			fRec412[0] = fRec412[1] + 2.0 * (fTemp370 * fTemp372 / fTemp371);
			double fTemp373 = fRec365[0] * (0.6123959999999999 * fRec364[0] + -0.41317138) + (1.0 - 0.19922461999999996 * fRec364[0]);
			double fRec413 = fTemp372 * fTemp373 / fTemp371;
			double fTemp374 = fRec363[0] * (fTemp348 + fRec365[0] * (6.0 - fTemp299) + 327.0);
			double fTemp375 = std::tan(fConst5 * fTemp374);
			double fTemp376 = fTemp375 * (fTemp375 + fTemp18 / fTemp374) + 1.0;
			double fTemp377 = fTemp375 * (fTemp280 - fRec415[1]) + fRec414[1];
			fRec414[0] = 2.0 * (fTemp377 / fTemp376) - fRec414[1];
			fRec415[0] = fRec415[1] + 2.0 * (fTemp375 * fTemp377 / fTemp376);
			double fTemp378 = 0.07501773 * fRec364[0] + fRec365[0] * (-0.04893692999999999 - 0.026080800000000015 * fRec364[0]) + 0.24961559;
			double fRec416 = fTemp377 * fTemp378 / fTemp376;
			double fTemp379 = fRec363[0] * (fTemp354 + 458.0);
			double fTemp380 = std::tan(fConst5 * fTemp379);
			double fTemp381 = fTemp380 * (fTemp380 + fTemp18 / fTemp379) + 1.0;
			double fTemp382 = fTemp380 * (fTemp280 - fRec418[1]) + fRec417[1];
			fRec417[0] = 2.0 * (fTemp382 / fTemp381) - fRec417[1];
			fRec418[0] = fRec418[1] + 2.0 * (fTemp380 * fTemp382 / fTemp381);
			double fTemp383 = 0.031150369999999983 * fRec364[0] + fRec365[0] * (0.03386702 - 0.06501738999999998 * fRec364[0]) + 0.1571452;
			double fRec419 = fTemp382 * fTemp383 / fTemp381;
			double fTemp384 = fRec363[0] * (fTemp348 + fRec365[0] * (12.0 - 14.0 * fRec364[0]) + 589.0);
			double fTemp385 = std::tan(fConst5 * fTemp384);
			double fTemp386 = fTemp385 * (fTemp385 + fTemp18 / fTemp384) + 1.0;
			double fTemp387 = fTemp385 * (fTemp280 - fRec421[1]) + fRec420[1];
			fRec420[0] = 2.0 * (fTemp387 / fTemp386) - fRec420[1];
			fRec421[0] = fRec421[1] + 2.0 * (fTemp385 * fTemp387 / fTemp386);
			double fTemp388 = fRec365[0] * (0.15122519 * fRec364[0] + -0.08735081) + (0.20902308 - 0.06387438000000001 * fRec364[0]);
			double fRec422 = fTemp387 * fTemp388 / fTemp386;
			double fTemp389 = fRec363[0] * (fTemp337 + fRec365[0] * (14.0 - 17.0 * fRec364[0]) + 7.2e+02);
			double fTemp390 = std::tan(fConst5 * fTemp389);
			double fTemp391 = fTemp390 * (fTemp390 + fTemp18 / fTemp389) + 1.0;
			double fTemp392 = fTemp390 * (fTemp280 - fRec424[1]) + fRec423[1];
			fRec423[0] = 2.0 * (fTemp392 / fTemp391) - fRec423[1];
			fRec424[0] = fRec424[1] + 2.0 * (fTemp390 * fTemp392 / fTemp391);
			double fTemp393 = 0.006377540000000001 * fRec364[0] + fRec365[0] * (0.03603802 * fRec364[0] + -0.04241556) + 0.07819993;
			double fRec425 = fTemp392 * fTemp393 / fTemp391;
			double fTemp394 = 4.0 * fRec364[0];
			double fTemp395 = fRec363[0] * (fTemp394 + fRec365[0] * (17.0 - 21.0 * fRec364[0]) + 851.0);
			double fTemp396 = std::tan(fConst5 * fTemp395);
			double fTemp397 = fTemp396 * (fTemp396 + fTemp18 / fTemp395) + 1.0;
			double fTemp398 = fTemp396 * (fTemp280 - fRec427[1]) + fRec426[1];
			fRec426[0] = 2.0 * (fTemp398 / fTemp397) - fRec426[1];
			fRec427[0] = fRec427[1] + 2.0 * (fTemp396 * fTemp398 / fTemp397);
			double fTemp399 = 0.043723639999999994 * fRec364[0] + fRec365[0] * (-0.00032270000000000215 - 0.04340093999999999 * fRec364[0]) + 0.03754288;
			double fRec428 = fTemp398 * fTemp399 / fTemp397;
			double fTemp400 = fRec363[0] * (fTemp394 + fRec365[0] * (19.0 - 23.0 * fRec364[0]) + 982.0);
			double fTemp401 = std::tan(fConst5 * fTemp400);
			double fTemp402 = fTemp401 * (fTemp401 + fTemp18 / fTemp400) + 1.0;
			double fTemp403 = fTemp401 * (fTemp280 - fRec430[1]) + fRec429[1];
			fRec429[0] = 2.0 * (fTemp403 / fTemp402) - fRec429[1];
			fRec430[0] = fRec430[1] + 2.0 * (fTemp401 * fTemp403 / fTemp402);
			double fTemp404 = 0.022372620000000003 * fRec364[0] + fRec365[0] * (0.029409400000000002 - 0.051782020000000005 * fRec364[0]) + 0.00927965;
			double fRec431 = fTemp403 * fTemp404 / fTemp402;
			double fTemp405 = fRec363[0] * (fTemp394 + fRec365[0] * (22.0 - 26.0 * fRec364[0]) + 1113.0);
			double fTemp406 = std::tan(fConst5 * fTemp405);
			double fTemp407 = fTemp406 * (fTemp406 + fTemp18 / fTemp405) + 1.0;
			double fTemp408 = fTemp406 * (fTemp280 - fRec433[1]) + fRec432[1];
			fRec432[0] = 2.0 * (fTemp408 / fTemp407) - fRec432[1];
			fRec433[0] = fRec433[1] + 2.0 * (fTemp406 * fTemp408 / fTemp407);
			double fTemp409 = 0.01651215 * fRec364[0] + fRec365[0] * (0.004918780000000001 - 0.02143093 * fRec364[0]) + 0.02702054;
			double fRec434 = fTemp408 * fTemp409 / fTemp407;
			double fTemp410 = fRec363[0] * (fTemp316 + fRec365[0] * (25.0 - 3e+01 * fRec364[0]) + 1244.0);
			double fTemp411 = std::tan(fConst5 * fTemp410);
			double fTemp412 = fTemp411 * (fTemp411 + fTemp18 / fTemp410) + 1.0;
			double fTemp413 = fTemp411 * (fTemp280 - fRec436[1]) + fRec435[1];
			fRec435[0] = 2.0 * (fTemp413 / fTemp412) - fRec435[1];
			fRec436[0] = fRec436[1] + 2.0 * (fTemp411 * fTemp413 / fTemp412);
			double fTemp414 = fRec365[0] * (0.009495489999999999 - 0.006188469999999999 * fRec364[0]) + (0.01010378 - 0.00330702 * fRec364[0]);
			double fRec437 = fTemp413 * fTemp414 / fTemp412;
			double fTemp415 = fRec363[0] * (fTemp316 + fRec365[0] * (27.0 - 32.0 * fRec364[0]) + 1375.0);
			double fTemp416 = std::tan(fConst5 * fTemp415);
			double fTemp417 = fTemp416 * (fTemp416 + fTemp18 / fTemp415) + 1.0;
			double fTemp418 = fTemp416 * (fTemp280 - fRec439[1]) + fRec438[1];
			fRec438[0] = 2.0 * (fTemp418 / fTemp417) - fRec438[1];
			fRec439[0] = fRec439[1] + 2.0 * (fTemp416 * fTemp418 / fTemp417);
			double fTemp419 = fRec365[0] * (0.0277721 - 0.025426740000000003 * fRec364[0]) + (0.00929211 - 0.0023453599999999995 * fRec364[0]);
			double fRec440 = fTemp418 * fTemp419 / fTemp417;
			double fTemp420 = fRec363[0] * (fTemp310 + fRec365[0] * (3e+01 - 36.0 * fRec364[0]) + 1506.0);
			double fTemp421 = std::tan(fConst5 * fTemp420);
			double fTemp422 = fTemp421 * (fTemp421 + fTemp18 / fTemp420) + 1.0;
			double fTemp423 = fTemp421 * (fTemp280 - fRec442[1]) + fRec441[1];
			fRec441[0] = 2.0 * (fTemp423 / fTemp422) - fRec441[1];
			fRec442[0] = fRec442[1] + 2.0 * (fTemp421 * fTemp423 / fTemp422);
			double fTemp424 = 0.01661545 * fRec364[0] + fRec365[0] * (0.023741299999999996 - 0.04035675 * fRec364[0]) + 0.00940227;
			double fRec443 = fTemp423 * fTemp424 / fTemp422;
			double fTemp425 = fRec363[0] * (fTemp310 + fRec365[0] * (33.0 - 39.0 * fRec364[0]) + 1637.0);
			double fTemp426 = std::tan(fConst5 * fTemp425);
			double fTemp427 = fTemp426 * (fTemp426 + fTemp18 / fTemp425) + 1.0;
			double fTemp428 = fTemp426 * (fTemp280 - fRec445[1]) + fRec444[1];
			fRec444[0] = 2.0 * (fTemp428 / fTemp427) - fRec444[1];
			fRec445[0] = fRec445[1] + 2.0 * (fTemp426 * fTemp428 / fTemp427);
			double fTemp429 = 0.005929820000000001 * fRec364[0] + fRec365[0] * (0.00200935 - 0.00793917 * fRec364[0]) + 0.00459008;
			double fRec446 = fTemp428 * fTemp429 / fTemp427;
			double fTemp430 = fRec363[0] * (fTemp287 + fRec365[0] * (102.0 - 109.0 * fRec364[0]) + 1768.0);
			double fTemp431 = std::tan(fConst5 * fTemp430);
			double fTemp432 = fTemp431 * (fTemp431 + fTemp18 / fTemp430) + 1.0;
			double fTemp433 = fTemp431 * (fTemp280 - fRec448[1]) + fRec447[1];
			fRec447[0] = 2.0 * (fTemp433 / fTemp432) - fRec447[1];
			fRec448[0] = fRec448[1] + 2.0 * (fTemp431 * fTemp433 / fTemp432);
			double fTemp434 = 0.005757190000000001 * fRec364[0] + fRec365[0] * (-0.0044776 - 0.0012795900000000006 * fRec364[0]) + 0.00941733;
			double fRec449 = fTemp433 * fTemp434 / fTemp432;
			double fTemp435 = fRec363[0] * (fTemp287 + fRec365[0] * (104.0 - fTemp298) + 1899.0);
			double fTemp436 = std::tan(fConst5 * fTemp435);
			double fTemp437 = fTemp436 * (fTemp436 + fTemp18 / fTemp435) + 1.0;
			double fTemp438 = fTemp436 * (fTemp280 - fRec451[1]) + fRec450[1];
			fRec450[0] = 2.0 * (fTemp438 / fTemp437) - fRec450[1];
			fRec451[0] = fRec451[1] + 2.0 * (fTemp436 * fTemp438 / fTemp437);
			double fTemp439 = 0.00223778 * fRec364[0] + fRec365[0] * (0.003461960000000001 - 0.005699740000000001 * fRec364[0]) + 0.00503596;
			double fRec452 = fTemp438 * fTemp439 / fTemp437;
			double fTemp440 = fRec363[0] * (fTemp299 + fRec365[0] * (107.0 - fTemp286) + 2.03e+03);
			double fTemp441 = std::tan(fConst5 * fTemp440);
			double fTemp442 = fTemp441 * (fTemp441 + fTemp18 / fTemp440) + 1.0;
			double fTemp443 = fTemp441 * (fTemp280 - fRec454[1]) + fRec453[1];
			fRec453[0] = 2.0 * (fTemp443 / fTemp442) - fRec453[1];
			fRec454[0] = fRec454[1] + 2.0 * (fTemp441 * fTemp443 / fTemp442);
			double fTemp444 = 0.0033720900000000003 * fRec364[0] + fRec365[0] * (0.007210579999999999 - 0.010582669999999999 * fRec364[0]) + 0.00223048;
			double fRec455 = fTemp443 * fTemp444 / fTemp442;
			double fTemp445 = fRec363[0] * (fTemp287 + fRec365[0] * (109.0 - 116.0 * fRec364[0]) + 2162.0);
			double fTemp446 = std::tan(fConst5 * fTemp445);
			double fTemp447 = fTemp446 * (fTemp446 + fTemp18 / fTemp445) + 1.0;
			double fTemp448 = fTemp446 * (fTemp280 - fRec457[1]) + fRec456[1];
			fRec456[0] = 2.0 * (fTemp448 / fTemp447) - fRec456[1];
			fRec457[0] = fRec457[1] + 2.0 * (fTemp446 * fTemp448 / fTemp447);
			double fTemp449 = 0.01214753 * fRec364[0] + fRec365[0] * (0.005874650000000001 - 0.018022180000000002 * fRec364[0]) + 0.00459407;
			double fRec458 = fTemp448 * fTemp449 / fTemp447;
			double fTemp450 = 0.03125 * fRec137[0] * (fRec458 + fRec455 + fRec452 + fRec449 + fRec446 + fRec443 + fRec440 + fRec437 + fRec434 + fRec431 + fRec428 + fRec425 + fRec422 + fRec419 + fRec416 + fRec413 + fRec410 + fRec407 + fRec404 + fRec401 + fRec398 + fRec395 + fRec392 + fRec389 + fRec386 + fRec383 + fRec380 + fRec377 + fRec374 + fRec371 + fRec368 + fRec362) + fRec36[0] * fTemp280;
			fRec349[0] = std::max<double>(fConst1 * fRec349[1], std::fabs(fTemp450));
			fVbargraph16 = FAUSTFLOAT(fRec349[0]);
			fRec346[0] = fTemp450;
			double fTemp451 = fRec26[0] * fRec348[1];
			fRec463[0] = std::max<double>(fConst1 * fRec463[1], std::fabs(fTemp451));
			fVbargraph17 = FAUSTFLOAT(fRec463[0]);
			double fTemp452 = fTemp451;
			double fTemp453 = fRec28[0] * (fTemp272 * (fRec143[0] - fTemp452) - fTemp274);
			double fTemp454 = fTemp12 + fRec355[1];
			double fTemp455 = fTemp454 + fTemp274;
			fVec10[0] = fTemp455 + fTemp453 + fTemp189;
			fRec462[0] = fTemp453 + 0.995 * fRec462[1] + fTemp455 + (1.3 - (fVec3[1] + fVec10[1]));
			fRec461[0] = std::max<double>(fConst1 * fRec461[1], std::fabs(fRec462[0]));
			fVbargraph18 = FAUSTFLOAT(fRec461[0]);
			double fTemp456 = fRec17[0] * tanh(fRec462[0] / fTemp4);
			fRec460[0] = std::max<double>(fConst1 * fRec460[1], std::fabs(fTemp456));
			fVbargraph19 = FAUSTFLOAT(fRec460[0]);
			double fTemp457 = fTemp456;
			double fTemp458 = fTemp282 * (fTemp457 - fRec465[1]) + fRec464[1];
			fRec464[0] = 2.0 * (fTemp458 / fTemp283) - fRec464[1];
			fRec465[0] = fRec465[1] + 2.0 * (fTemp282 * fTemp458 / fTemp283);
			double fRec466 = fTemp285 * fTemp458 / fTemp283;
			double fTemp459 = fTemp289 * (fTemp457 - fRec468[1]) + fRec467[1];
			fRec467[0] = 2.0 * (fTemp459 / fTemp290) - fRec467[1];
			fRec468[0] = fRec468[1] + 2.0 * (fTemp289 * fTemp459 / fTemp290);
			double fRec469 = fTemp292 * fTemp459 / fTemp290;
			double fTemp460 = fTemp294 * (fTemp457 - fRec471[1]) + fRec470[1];
			fRec470[0] = 2.0 * (fTemp460 / fTemp295) - fRec470[1];
			fRec471[0] = fRec471[1] + 2.0 * (fTemp294 * fTemp460 / fTemp295);
			double fRec472 = fTemp297 * fTemp460 / fTemp295;
			double fTemp461 = fTemp301 * (fTemp457 - fRec474[1]) + fRec473[1];
			fRec473[0] = 2.0 * (fTemp461 / fTemp302) - fRec473[1];
			fRec474[0] = fRec474[1] + 2.0 * (fTemp301 * fTemp461 / fTemp302);
			double fRec475 = fTemp304 * fTemp461 / fTemp302;
			double fTemp462 = fTemp306 * (fTemp457 - fRec477[1]) + fRec476[1];
			fRec476[0] = 2.0 * (fTemp462 / fTemp307) - fRec476[1];
			fRec477[0] = fRec477[1] + 2.0 * (fTemp306 * fTemp462 / fTemp307);
			double fRec478 = fTemp309 * fTemp462 / fTemp307;
			double fTemp463 = fTemp312 * (fTemp457 - fRec480[1]) + fRec479[1];
			fRec479[0] = 2.0 * (fTemp463 / fTemp313) - fRec479[1];
			fRec480[0] = fRec480[1] + 2.0 * (fTemp312 * fTemp463 / fTemp313);
			double fRec481 = fTemp315 * fTemp463 / fTemp313;
			double fTemp464 = fTemp318 * (fTemp457 - fRec483[1]) + fRec482[1];
			fRec482[0] = 2.0 * (fTemp464 / fTemp319) - fRec482[1];
			fRec483[0] = fRec483[1] + 2.0 * (fTemp318 * fTemp464 / fTemp319);
			double fRec484 = fTemp321 * fTemp464 / fTemp319;
			double fTemp465 = fTemp323 * (fTemp457 - fRec486[1]) + fRec485[1];
			fRec485[0] = 2.0 * (fTemp465 / fTemp324) - fRec485[1];
			fRec486[0] = fRec486[1] + 2.0 * (fTemp323 * fTemp465 / fTemp324);
			double fRec487 = fTemp326 * fTemp465 / fTemp324;
			double fTemp466 = fTemp328 * (fTemp457 - fRec489[1]) + fRec488[1];
			fRec488[0] = 2.0 * (fTemp466 / fTemp329) - fRec488[1];
			fRec489[0] = fRec489[1] + 2.0 * (fTemp328 * fTemp466 / fTemp329);
			double fRec490 = fTemp331 * fTemp466 / fTemp329;
			double fTemp467 = fTemp333 * (fTemp457 - fRec492[1]) + fRec491[1];
			fRec491[0] = 2.0 * (fTemp467 / fTemp334) - fRec491[1];
			fRec492[0] = fRec492[1] + 2.0 * (fTemp333 * fTemp467 / fTemp334);
			double fRec493 = fTemp336 * fTemp467 / fTemp334;
			double fTemp468 = fTemp339 * (fTemp457 - fRec495[1]) + fRec494[1];
			fRec494[0] = 2.0 * (fTemp468 / fTemp340) - fRec494[1];
			fRec495[0] = fRec495[1] + 2.0 * (fTemp339 * fTemp468 / fTemp340);
			double fRec496 = fTemp342 * fTemp468 / fTemp340;
			double fTemp469 = fTemp344 * (fTemp457 - fRec498[1]) + fRec497[1];
			fRec497[0] = 2.0 * (fTemp469 / fTemp345) - fRec497[1];
			fRec498[0] = fRec498[1] + 2.0 * (fTemp344 * fTemp469 / fTemp345);
			double fRec499 = fTemp347 * fTemp469 / fTemp345;
			double fTemp470 = fTemp350 * (fTemp457 - fRec501[1]) + fRec500[1];
			fRec500[0] = 2.0 * (fTemp470 / fTemp351) - fRec500[1];
			fRec501[0] = fRec501[1] + 2.0 * (fTemp350 * fTemp470 / fTemp351);
			double fRec502 = fTemp353 * fTemp470 / fTemp351;
			double fTemp471 = fTemp356 * (fTemp457 - fRec504[1]) + fRec503[1];
			fRec503[0] = 2.0 * (fTemp471 / fTemp357) - fRec503[1];
			fRec504[0] = fRec504[1] + 2.0 * (fTemp356 * fTemp471 / fTemp357);
			double fRec505 = fTemp359 * fTemp471 / fTemp357;
			double fTemp472 = fTemp361 * (fTemp457 - fRec507[1]) + fRec506[1];
			fRec506[0] = 2.0 * (fTemp472 / fTemp362) - fRec506[1];
			fRec507[0] = fRec507[1] + 2.0 * (fTemp361 * fTemp472 / fTemp362);
			double fRec508 = fTemp364 * fTemp472 / fTemp362;
			double fTemp473 = fTemp366 * (fTemp457 - fRec510[1]) + fRec509[1];
			fRec509[0] = 2.0 * (fTemp473 / fTemp367) - fRec509[1];
			fRec510[0] = fRec510[1] + 2.0 * (fTemp366 * fTemp473 / fTemp367);
			double fRec511 = fTemp369 * fTemp473 / fTemp367;
			double fTemp474 = fTemp370 * (fTemp457 - fRec513[1]) + fRec512[1];
			fRec512[0] = 2.0 * (fTemp474 / fTemp371) - fRec512[1];
			fRec513[0] = fRec513[1] + 2.0 * (fTemp370 * fTemp474 / fTemp371);
			double fRec514 = fTemp373 * fTemp474 / fTemp371;
			double fTemp475 = fTemp375 * (fTemp457 - fRec516[1]) + fRec515[1];
			fRec515[0] = 2.0 * (fTemp475 / fTemp376) - fRec515[1];
			fRec516[0] = fRec516[1] + 2.0 * (fTemp375 * fTemp475 / fTemp376);
			double fRec517 = fTemp378 * fTemp475 / fTemp376;
			double fTemp476 = fTemp380 * (fTemp457 - fRec519[1]) + fRec518[1];
			fRec518[0] = 2.0 * (fTemp476 / fTemp381) - fRec518[1];
			fRec519[0] = fRec519[1] + 2.0 * (fTemp380 * fTemp476 / fTemp381);
			double fRec520 = fTemp383 * fTemp476 / fTemp381;
			double fTemp477 = fTemp385 * (fTemp457 - fRec522[1]) + fRec521[1];
			fRec521[0] = 2.0 * (fTemp477 / fTemp386) - fRec521[1];
			fRec522[0] = fRec522[1] + 2.0 * (fTemp385 * fTemp477 / fTemp386);
			double fRec523 = fTemp388 * fTemp477 / fTemp386;
			double fTemp478 = fTemp390 * (fTemp457 - fRec525[1]) + fRec524[1];
			fRec524[0] = 2.0 * (fTemp478 / fTemp391) - fRec524[1];
			fRec525[0] = fRec525[1] + 2.0 * (fTemp390 * fTemp478 / fTemp391);
			double fRec526 = fTemp393 * fTemp478 / fTemp391;
			double fTemp479 = fTemp396 * (fTemp457 - fRec528[1]) + fRec527[1];
			fRec527[0] = 2.0 * (fTemp479 / fTemp397) - fRec527[1];
			fRec528[0] = fRec528[1] + 2.0 * (fTemp396 * fTemp479 / fTemp397);
			double fRec529 = fTemp399 * fTemp479 / fTemp397;
			double fTemp480 = fTemp401 * (fTemp457 - fRec531[1]) + fRec530[1];
			fRec530[0] = 2.0 * (fTemp480 / fTemp402) - fRec530[1];
			fRec531[0] = fRec531[1] + 2.0 * (fTemp401 * fTemp480 / fTemp402);
			double fRec532 = fTemp404 * fTemp480 / fTemp402;
			double fTemp481 = fTemp406 * (fTemp457 - fRec534[1]) + fRec533[1];
			fRec533[0] = 2.0 * (fTemp481 / fTemp407) - fRec533[1];
			fRec534[0] = fRec534[1] + 2.0 * (fTemp406 * fTemp481 / fTemp407);
			double fRec535 = fTemp409 * fTemp481 / fTemp407;
			double fTemp482 = fTemp411 * (fTemp457 - fRec537[1]) + fRec536[1];
			fRec536[0] = 2.0 * (fTemp482 / fTemp412) - fRec536[1];
			fRec537[0] = fRec537[1] + 2.0 * (fTemp411 * fTemp482 / fTemp412);
			double fRec538 = fTemp414 * fTemp482 / fTemp412;
			double fTemp483 = fTemp416 * (fTemp457 - fRec540[1]) + fRec539[1];
			fRec539[0] = 2.0 * (fTemp483 / fTemp417) - fRec539[1];
			fRec540[0] = fRec540[1] + 2.0 * (fTemp416 * fTemp483 / fTemp417);
			double fRec541 = fTemp419 * fTemp483 / fTemp417;
			double fTemp484 = fTemp421 * (fTemp457 - fRec543[1]) + fRec542[1];
			fRec542[0] = 2.0 * (fTemp484 / fTemp422) - fRec542[1];
			fRec543[0] = fRec543[1] + 2.0 * (fTemp421 * fTemp484 / fTemp422);
			double fRec544 = fTemp424 * fTemp484 / fTemp422;
			double fTemp485 = fTemp426 * (fTemp457 - fRec546[1]) + fRec545[1];
			fRec545[0] = 2.0 * (fTemp485 / fTemp427) - fRec545[1];
			fRec546[0] = fRec546[1] + 2.0 * (fTemp426 * fTemp485 / fTemp427);
			double fRec547 = fTemp429 * fTemp485 / fTemp427;
			double fTemp486 = fTemp431 * (fTemp457 - fRec549[1]) + fRec548[1];
			fRec548[0] = 2.0 * (fTemp486 / fTemp432) - fRec548[1];
			fRec549[0] = fRec549[1] + 2.0 * (fTemp431 * fTemp486 / fTemp432);
			double fRec550 = fTemp434 * fTemp486 / fTemp432;
			double fTemp487 = fTemp436 * (fTemp457 - fRec552[1]) + fRec551[1];
			fRec551[0] = 2.0 * (fTemp487 / fTemp437) - fRec551[1];
			fRec552[0] = fRec552[1] + 2.0 * (fTemp436 * fTemp487 / fTemp437);
			double fRec553 = fTemp439 * fTemp487 / fTemp437;
			double fTemp488 = fTemp441 * (fTemp457 - fRec555[1]) + fRec554[1];
			fRec554[0] = 2.0 * (fTemp488 / fTemp442) - fRec554[1];
			fRec555[0] = fRec555[1] + 2.0 * (fTemp441 * fTemp488 / fTemp442);
			double fRec556 = fTemp444 * fTemp488 / fTemp442;
			double fTemp489 = fTemp446 * (fTemp457 - fRec558[1]) + fRec557[1];
			fRec557[0] = 2.0 * (fTemp489 / fTemp447) - fRec557[1];
			fRec558[0] = fRec558[1] + 2.0 * (fTemp446 * fTemp489 / fTemp447);
			double fRec559 = fTemp449 * fTemp489 / fTemp447;
			double fTemp490 = 0.03125 * fRec137[0] * (fRec559 + fRec556 + fRec553 + fRec550 + fRec547 + fRec544 + fRec541 + fRec538 + fRec535 + fRec532 + fRec529 + fRec526 + fRec523 + fRec520 + fRec517 + fRec514 + fRec511 + fRec508 + fRec505 + fRec502 + fRec499 + fRec496 + fRec493 + fRec490 + fRec487 + fRec484 + fRec481 + fRec478 + fRec475 + fRec472 + fRec469 + fRec466) + fRec36[0] * fTemp457;
			fRec459[0] = std::max<double>(fConst1 * fRec459[1], std::fabs(fTemp490));
			fVbargraph20 = FAUSTFLOAT(fRec459[0]);
			fRec347[0] = fTemp490;
			double fTemp491 = fRec28[0] * (fTemp272 * fTemp274 - fRec244[0] * fTemp452);
			double fTemp492 = fTemp454 + fTemp452;
			fVec11[0] = fTemp492 + fTemp491 + fTemp230;
			fRec563[0] = fTemp491 + 0.995 * fRec563[1] + fTemp492 + (1.6 - (fVec5[1] + fVec11[1]));
			fRec562[0] = std::max<double>(fConst1 * fRec562[1], std::fabs(fRec563[0]));
			fVbargraph21 = FAUSTFLOAT(fRec562[0]);
			double fTemp493 = fRec17[0] * tanh(fRec563[0] / fTemp4);
			fRec561[0] = std::max<double>(fConst1 * fRec561[1], std::fabs(fTemp493));
			fVbargraph22 = FAUSTFLOAT(fRec561[0]);
			double fTemp494 = fTemp493;
			double fTemp495 = fTemp282 * (fTemp494 - fRec565[1]) + fRec564[1];
			fRec564[0] = 2.0 * (fTemp495 / fTemp283) - fRec564[1];
			fRec565[0] = fRec565[1] + 2.0 * (fTemp282 * fTemp495 / fTemp283);
			double fRec566 = fTemp285 * fTemp495 / fTemp283;
			double fTemp496 = fTemp289 * (fTemp494 - fRec568[1]) + fRec567[1];
			fRec567[0] = 2.0 * (fTemp496 / fTemp290) - fRec567[1];
			fRec568[0] = fRec568[1] + 2.0 * (fTemp289 * fTemp496 / fTemp290);
			double fRec569 = fTemp292 * fTemp496 / fTemp290;
			double fTemp497 = fTemp294 * (fTemp494 - fRec571[1]) + fRec570[1];
			fRec570[0] = 2.0 * (fTemp497 / fTemp295) - fRec570[1];
			fRec571[0] = fRec571[1] + 2.0 * (fTemp294 * fTemp497 / fTemp295);
			double fRec572 = fTemp297 * fTemp497 / fTemp295;
			double fTemp498 = fTemp301 * (fTemp494 - fRec574[1]) + fRec573[1];
			fRec573[0] = 2.0 * (fTemp498 / fTemp302) - fRec573[1];
			fRec574[0] = fRec574[1] + 2.0 * (fTemp301 * fTemp498 / fTemp302);
			double fRec575 = fTemp304 * fTemp498 / fTemp302;
			double fTemp499 = fTemp306 * (fTemp494 - fRec577[1]) + fRec576[1];
			fRec576[0] = 2.0 * (fTemp499 / fTemp307) - fRec576[1];
			fRec577[0] = fRec577[1] + 2.0 * (fTemp306 * fTemp499 / fTemp307);
			double fRec578 = fTemp309 * fTemp499 / fTemp307;
			double fTemp500 = fTemp312 * (fTemp494 - fRec580[1]) + fRec579[1];
			fRec579[0] = 2.0 * (fTemp500 / fTemp313) - fRec579[1];
			fRec580[0] = fRec580[1] + 2.0 * (fTemp312 * fTemp500 / fTemp313);
			double fRec581 = fTemp315 * fTemp500 / fTemp313;
			double fTemp501 = fTemp318 * (fTemp494 - fRec583[1]) + fRec582[1];
			fRec582[0] = 2.0 * (fTemp501 / fTemp319) - fRec582[1];
			fRec583[0] = fRec583[1] + 2.0 * (fTemp318 * fTemp501 / fTemp319);
			double fRec584 = fTemp321 * fTemp501 / fTemp319;
			double fTemp502 = fTemp323 * (fTemp494 - fRec586[1]) + fRec585[1];
			fRec585[0] = 2.0 * (fTemp502 / fTemp324) - fRec585[1];
			fRec586[0] = fRec586[1] + 2.0 * (fTemp323 * fTemp502 / fTemp324);
			double fRec587 = fTemp326 * fTemp502 / fTemp324;
			double fTemp503 = fTemp328 * (fTemp494 - fRec589[1]) + fRec588[1];
			fRec588[0] = 2.0 * (fTemp503 / fTemp329) - fRec588[1];
			fRec589[0] = fRec589[1] + 2.0 * (fTemp328 * fTemp503 / fTemp329);
			double fRec590 = fTemp331 * fTemp503 / fTemp329;
			double fTemp504 = fTemp333 * (fTemp494 - fRec592[1]) + fRec591[1];
			fRec591[0] = 2.0 * (fTemp504 / fTemp334) - fRec591[1];
			fRec592[0] = fRec592[1] + 2.0 * (fTemp333 * fTemp504 / fTemp334);
			double fRec593 = fTemp336 * fTemp504 / fTemp334;
			double fTemp505 = fTemp339 * (fTemp494 - fRec595[1]) + fRec594[1];
			fRec594[0] = 2.0 * (fTemp505 / fTemp340) - fRec594[1];
			fRec595[0] = fRec595[1] + 2.0 * (fTemp339 * fTemp505 / fTemp340);
			double fRec596 = fTemp342 * fTemp505 / fTemp340;
			double fTemp506 = fTemp344 * (fTemp494 - fRec598[1]) + fRec597[1];
			fRec597[0] = 2.0 * (fTemp506 / fTemp345) - fRec597[1];
			fRec598[0] = fRec598[1] + 2.0 * (fTemp344 * fTemp506 / fTemp345);
			double fRec599 = fTemp347 * fTemp506 / fTemp345;
			double fTemp507 = fTemp350 * (fTemp494 - fRec601[1]) + fRec600[1];
			fRec600[0] = 2.0 * (fTemp507 / fTemp351) - fRec600[1];
			fRec601[0] = fRec601[1] + 2.0 * (fTemp350 * fTemp507 / fTemp351);
			double fRec602 = fTemp353 * fTemp507 / fTemp351;
			double fTemp508 = fTemp356 * (fTemp494 - fRec604[1]) + fRec603[1];
			fRec603[0] = 2.0 * (fTemp508 / fTemp357) - fRec603[1];
			fRec604[0] = fRec604[1] + 2.0 * (fTemp356 * fTemp508 / fTemp357);
			double fRec605 = fTemp359 * fTemp508 / fTemp357;
			double fTemp509 = fTemp361 * (fTemp494 - fRec607[1]) + fRec606[1];
			fRec606[0] = 2.0 * (fTemp509 / fTemp362) - fRec606[1];
			fRec607[0] = fRec607[1] + 2.0 * (fTemp361 * fTemp509 / fTemp362);
			double fRec608 = fTemp364 * fTemp509 / fTemp362;
			double fTemp510 = fTemp366 * (fTemp494 - fRec610[1]) + fRec609[1];
			fRec609[0] = 2.0 * (fTemp510 / fTemp367) - fRec609[1];
			fRec610[0] = fRec610[1] + 2.0 * (fTemp366 * fTemp510 / fTemp367);
			double fRec611 = fTemp369 * fTemp510 / fTemp367;
			double fTemp511 = fTemp370 * (fTemp494 - fRec613[1]) + fRec612[1];
			fRec612[0] = 2.0 * (fTemp511 / fTemp371) - fRec612[1];
			fRec613[0] = fRec613[1] + 2.0 * (fTemp370 * fTemp511 / fTemp371);
			double fRec614 = fTemp373 * fTemp511 / fTemp371;
			double fTemp512 = fTemp375 * (fTemp494 - fRec616[1]) + fRec615[1];
			fRec615[0] = 2.0 * (fTemp512 / fTemp376) - fRec615[1];
			fRec616[0] = fRec616[1] + 2.0 * (fTemp375 * fTemp512 / fTemp376);
			double fRec617 = fTemp378 * fTemp512 / fTemp376;
			double fTemp513 = fTemp380 * (fTemp494 - fRec619[1]) + fRec618[1];
			fRec618[0] = 2.0 * (fTemp513 / fTemp381) - fRec618[1];
			fRec619[0] = fRec619[1] + 2.0 * (fTemp380 * fTemp513 / fTemp381);
			double fRec620 = fTemp383 * fTemp513 / fTemp381;
			double fTemp514 = fTemp385 * (fTemp494 - fRec622[1]) + fRec621[1];
			fRec621[0] = 2.0 * (fTemp514 / fTemp386) - fRec621[1];
			fRec622[0] = fRec622[1] + 2.0 * (fTemp385 * fTemp514 / fTemp386);
			double fRec623 = fTemp388 * fTemp514 / fTemp386;
			double fTemp515 = fTemp390 * (fTemp494 - fRec625[1]) + fRec624[1];
			fRec624[0] = 2.0 * (fTemp515 / fTemp391) - fRec624[1];
			fRec625[0] = fRec625[1] + 2.0 * (fTemp390 * fTemp515 / fTemp391);
			double fRec626 = fTemp393 * fTemp515 / fTemp391;
			double fTemp516 = fTemp396 * (fTemp494 - fRec628[1]) + fRec627[1];
			fRec627[0] = 2.0 * (fTemp516 / fTemp397) - fRec627[1];
			fRec628[0] = fRec628[1] + 2.0 * (fTemp396 * fTemp516 / fTemp397);
			double fRec629 = fTemp399 * fTemp516 / fTemp397;
			double fTemp517 = fTemp401 * (fTemp494 - fRec631[1]) + fRec630[1];
			fRec630[0] = 2.0 * (fTemp517 / fTemp402) - fRec630[1];
			fRec631[0] = fRec631[1] + 2.0 * (fTemp401 * fTemp517 / fTemp402);
			double fRec632 = fTemp404 * fTemp517 / fTemp402;
			double fTemp518 = fTemp406 * (fTemp494 - fRec634[1]) + fRec633[1];
			fRec633[0] = 2.0 * (fTemp518 / fTemp407) - fRec633[1];
			fRec634[0] = fRec634[1] + 2.0 * (fTemp406 * fTemp518 / fTemp407);
			double fRec635 = fTemp409 * fTemp518 / fTemp407;
			double fTemp519 = fTemp411 * (fTemp494 - fRec637[1]) + fRec636[1];
			fRec636[0] = 2.0 * (fTemp519 / fTemp412) - fRec636[1];
			fRec637[0] = fRec637[1] + 2.0 * (fTemp411 * fTemp519 / fTemp412);
			double fRec638 = fTemp414 * fTemp519 / fTemp412;
			double fTemp520 = fTemp416 * (fTemp494 - fRec640[1]) + fRec639[1];
			fRec639[0] = 2.0 * (fTemp520 / fTemp417) - fRec639[1];
			fRec640[0] = fRec640[1] + 2.0 * (fTemp416 * fTemp520 / fTemp417);
			double fRec641 = fTemp419 * fTemp520 / fTemp417;
			double fTemp521 = fTemp421 * (fTemp494 - fRec643[1]) + fRec642[1];
			fRec642[0] = 2.0 * (fTemp521 / fTemp422) - fRec642[1];
			fRec643[0] = fRec643[1] + 2.0 * (fTemp421 * fTemp521 / fTemp422);
			double fRec644 = fTemp424 * fTemp521 / fTemp422;
			double fTemp522 = fTemp426 * (fTemp494 - fRec646[1]) + fRec645[1];
			fRec645[0] = 2.0 * (fTemp522 / fTemp427) - fRec645[1];
			fRec646[0] = fRec646[1] + 2.0 * (fTemp426 * fTemp522 / fTemp427);
			double fRec647 = fTemp429 * fTemp522 / fTemp427;
			double fTemp523 = fTemp431 * (fTemp494 - fRec649[1]) + fRec648[1];
			fRec648[0] = 2.0 * (fTemp523 / fTemp432) - fRec648[1];
			fRec649[0] = fRec649[1] + 2.0 * (fTemp431 * fTemp523 / fTemp432);
			double fRec650 = fTemp434 * fTemp523 / fTemp432;
			double fTemp524 = fTemp436 * (fTemp494 - fRec652[1]) + fRec651[1];
			fRec651[0] = 2.0 * (fTemp524 / fTemp437) - fRec651[1];
			fRec652[0] = fRec652[1] + 2.0 * (fTemp436 * fTemp524 / fTemp437);
			double fRec653 = fTemp439 * fTemp524 / fTemp437;
			double fTemp525 = fTemp441 * (fTemp494 - fRec655[1]) + fRec654[1];
			fRec654[0] = 2.0 * (fTemp525 / fTemp442) - fRec654[1];
			fRec655[0] = fRec655[1] + 2.0 * (fTemp441 * fTemp525 / fTemp442);
			double fRec656 = fTemp444 * fTemp525 / fTemp442;
			double fTemp526 = fTemp446 * (fTemp494 - fRec658[1]) + fRec657[1];
			fRec657[0] = 2.0 * (fTemp526 / fTemp447) - fRec657[1];
			fRec658[0] = fRec658[1] + 2.0 * (fTemp446 * fTemp526 / fTemp447);
			double fRec659 = fTemp449 * fTemp526 / fTemp447;
			double fTemp527 = 0.03125 * fRec137[0] * (fRec659 + fRec656 + fRec653 + fRec650 + fRec647 + fRec644 + fRec641 + fRec638 + fRec635 + fRec632 + fRec629 + fRec626 + fRec623 + fRec620 + fRec617 + fRec614 + fRec611 + fRec608 + fRec605 + fRec602 + fRec599 + fRec596 + fRec593 + fRec590 + fRec587 + fRec584 + fRec581 + fRec578 + fRec575 + fRec572 + fRec569 + fRec566) + fRec36[0] * fTemp494;
			fRec560[0] = std::max<double>(fConst1 * fRec560[1], std::fabs(fTemp527));
			fVbargraph23 = FAUSTFLOAT(fRec560[0]);
			fRec348[0] = fTemp527;
			double fTemp528 = (fRec348[0] + fRec346[0] + fRec347[0]) / fTemp4;
			fVec12[IOTA0 & 4194303] = fTemp528;
			double fTemp529 = ((fRec660[1] != 0.0) ? (((fRec661[1] > 0.0) & (fRec661[1] < 1.0)) ? fRec660[1] : 0.0) : (((fRec661[1] == 0.0) & (fSlow24 != fRec662[1])) ? 0.0009765625 : (((fRec661[1] == 1.0) & (fSlow24 != fRec663[1])) ? -0.0009765625 : 0.0)));
			fRec660[0] = fTemp529;
			fRec661[0] = std::max<double>(0.0, std::min<double>(1.0, fRec661[1] + fTemp529));
			fRec662[0] = (((fRec661[1] >= 1.0) & (fRec663[1] != fSlow24)) ? fSlow24 : fRec662[1]);
			fRec663[0] = (((fRec661[1] <= 0.0) & (fRec662[1] != fSlow24)) ? fSlow24 : fRec663[1]);
			double fTemp530 = fVec12[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec662[0])))) & 4194303];
			fRec345[0] = 0.3333333333333333 * fTemp530 + fRec661[0] * (0.0 - 0.3333333333333333 * (fTemp530 - fVec12[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec663[0])))) & 4194303]));
			fRec672[0] = fSlow25 + fConst3 * fRec672[1];
			double fTemp531 = fTemp18 / fRec672[0];
			double fTemp532 = std::tan(fConst7 * fRec672[0]);
			double fTemp533 = fTemp532 * (fTemp532 + 0.005076142131979695 * fTemp531) + 1.0;
			double fTemp534 = fRec26[0] * fRec665[1];
			fRec676[0] = std::max<double>(fConst1 * fRec676[1], std::fabs(fTemp534));
			fVbargraph24 = FAUSTFLOAT(fRec676[0]);
			double fTemp535 = fTemp534;
			double fTemp536 = fRec26[0] * fRec666[1];
			fRec677[0] = std::max<double>(fConst1 * fRec677[1], std::fabs(fTemp536));
			fVbargraph25 = FAUSTFLOAT(fRec677[0]);
			double fTemp537 = fTemp536;
			double fTemp538 = fTemp10 * (fTemp537 - fTemp535);
			double fTemp539 = fSlow26 * fRec11[1];
			fVec13[IOTA0 & 4194303] = fTemp539;
			double fTemp540 = ((fRec679[1] != 0.0) ? (((fRec680[1] > 0.0) & (fRec680[1] < 1.0)) ? fRec679[1] : 0.0) : (((fRec680[1] == 0.0) & (fSlow27 != fRec681[1])) ? 0.0009765625 : (((fRec680[1] == 1.0) & (fSlow27 != fRec682[1])) ? -0.0009765625 : 0.0)));
			fRec679[0] = fTemp540;
			fRec680[0] = std::max<double>(0.0, std::min<double>(1.0, fRec680[1] + fTemp540));
			fRec681[0] = (((fRec680[1] >= 1.0) & (fRec682[1] != fSlow27)) ? fSlow27 : fRec681[1]);
			fRec682[0] = (((fRec680[1] <= 0.0) & (fRec681[1] != fSlow27)) ? fSlow27 : fRec682[1]);
			double fTemp541 = fVec13[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec681[0])))) & 4194303];
			fRec678[0] = fTemp541 + fRec680[0] * (fVec13[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec682[0])))) & 4194303] - fTemp541);
			fVec14[0] = fTemp12 + fTemp535 + fRec678[1] + fTemp538 + fTemp5;
			fRec675[0] = fTemp538 + fTemp12 + fRec678[1] + 0.995 * fRec675[1] + fTemp535 + (1.2 - (fVec0[1] + fVec14[1]));
			fRec674[0] = std::max<double>(fConst1 * fRec674[1], std::fabs(fRec675[0]));
			fVbargraph26 = FAUSTFLOAT(fRec674[0]);
			double fTemp542 = fRec17[0] * tanh(fRec675[0] / fTemp4);
			fRec673[0] = std::max<double>(fConst1 * fRec673[1], std::fabs(fTemp542));
			fVbargraph27 = FAUSTFLOAT(fRec673[0]);
			double fTemp543 = fTemp542;
			double fTemp544 = fTemp532 * (fTemp543 - fRec670[1]) + fRec669[1];
			fRec669[0] = 2.0 * (fTemp544 / fTemp533) - fRec669[1];
			fRec670[0] = fRec670[1] + 2.0 * (fTemp532 * fTemp544 / fTemp533);
			fRec683[0] = fSlow28 + fConst3 * fRec683[1];
			fRec684[0] = fSlow29 + fConst3 * fRec684[1];
			double fTemp545 = 0.51466542 * fRec683[0] + fRec684[0] * (0.51466542 - 1.02933084 * fRec683[0]) + 0.48533458;
			double fRec671 = fTemp544 * fTemp545 / fTemp533;
			double fTemp546 = 115.0 * fRec683[0];
			double fTemp547 = 7.0 * fRec683[0];
			double fTemp548 = fRec672[0] * (fTemp547 + fRec684[0] * (108.0 - fTemp546) + 2096.0);
			double fTemp549 = std::tan(fConst5 * fTemp548);
			double fTemp550 = fTemp549 * (fTemp549 + fTemp18 / fTemp548) + 1.0;
			double fTemp551 = fTemp549 * (fTemp543 - fRec686[1]) + fRec685[1];
			fRec685[0] = 2.0 * (fTemp551 / fTemp550) - fRec685[1];
			fRec686[0] = fRec686[1] + 2.0 * (fTemp549 * fTemp551 / fTemp550);
			double fTemp552 = 0.00492482 * fRec683[0] + fRec684[0] * (0.0035387400000000003 - 0.00846356 * fRec683[0]) + 0.00514822;
			double fRec687 = fTemp551 * fTemp552 / fTemp550;
			double fTemp553 = fRec672[0] * (fTemp547 + fRec684[0] * (106.0 - 113.0 * fRec683[0]) + 1965.0);
			double fTemp554 = std::tan(fConst5 * fTemp553);
			double fTemp555 = fTemp554 * (fTemp554 + fTemp18 / fTemp553) + 1.0;
			double fTemp556 = fTemp554 * (fTemp543 - fRec689[1]) + fRec688[1];
			fRec688[0] = 2.0 * (fTemp556 / fTemp555) - fRec688[1];
			fRec689[0] = fRec689[1] + 2.0 * (fTemp554 * fTemp556 / fTemp555);
			double fTemp557 = 0.003961 * fRec683[0] + fRec684[0] * (0.02133127 - 0.02529227 * fRec683[0]) + 0.00356349;
			double fRec690 = fTemp556 * fTemp557 / fTemp555;
			double fTemp558 = 111.0 * fRec683[0];
			double fTemp559 = 8.0 * fRec683[0];
			double fTemp560 = fRec672[0] * (fTemp559 + fRec684[0] * (103.0 - fTemp558) + 1834.0);
			double fTemp561 = std::tan(fConst5 * fTemp560);
			double fTemp562 = fTemp561 * (fTemp561 + fTemp18 / fTemp560) + 1.0;
			double fTemp563 = fTemp561 * (fTemp543 - fRec692[1]) + fRec691[1];
			fRec691[0] = 2.0 * (fTemp563 / fTemp562) - fRec691[1];
			fRec692[0] = fRec692[1] + 2.0 * (fTemp561 * fTemp563 / fTemp562);
			double fTemp564 = fRec684[0] * (0.00286025 * fRec683[0] + -3.855000000000004e-05) + (0.00511717 - 0.0028217 * fRec683[0]);
			double fRec693 = fTemp563 * fTemp564 / fTemp562;
			double fTemp565 = fRec672[0] * (fTemp547 + fRec684[0] * (101.0 - 108.0 * fRec683[0]) + 1702.0);
			double fTemp566 = std::tan(fConst5 * fTemp565);
			double fTemp567 = fTemp566 * (fTemp566 + fTemp18 / fTemp565) + 1.0;
			double fTemp568 = fTemp566 * (fTemp543 - fRec695[1]) + fRec694[1];
			fRec694[0] = 2.0 * (fTemp568 / fTemp567) - fRec694[1];
			fRec695[0] = fRec695[1] + 2.0 * (fTemp566 * fTemp568 / fTemp567);
			double fTemp569 = 0.015484530000000002 * fRec683[0] + fRec684[0] * (0.00335505 - 0.01883958 * fRec683[0]) + 0.0048918;
			double fRec696 = fTemp568 * fTemp569 / fTemp567;
			double fTemp570 = 6.0 * fRec683[0];
			double fTemp571 = fRec672[0] * (fTemp570 + fRec684[0] * (31.0 - 37.0 * fRec683[0]) + 1572.0);
			double fTemp572 = std::tan(fConst5 * fTemp571);
			double fTemp573 = fTemp572 * (fTemp572 + fTemp18 / fTemp571) + 1.0;
			double fTemp574 = fTemp572 * (fTemp543 - fRec698[1]) + fRec697[1];
			fRec697[0] = 2.0 * (fTemp574 / fTemp573) - fRec697[1];
			fRec698[0] = fRec698[1] + 2.0 * (fTemp572 * fTemp574 / fTemp573);
			double fTemp575 = fRec684[0] * (0.0007354499999999986 * fRec683[0] + -0.0006947099999999977) + (0.02091359 - 4.0740000000000914e-05 * fRec683[0]);
			double fRec699 = fTemp574 * fTemp575 / fTemp573;
			double fTemp576 = 5.0 * fRec683[0];
			double fTemp577 = fRec672[0] * (fTemp576 + fRec684[0] * (28.0 - 33.0 * fRec683[0]) + 1441.0);
			double fTemp578 = std::tan(fConst5 * fTemp577);
			double fTemp579 = fTemp578 * (fTemp578 + fTemp18 / fTemp577) + 1.0;
			double fTemp580 = fTemp578 * (fTemp543 - fRec701[1]) + fRec700[1];
			fRec700[0] = 2.0 * (fTemp580 / fTemp579) - fRec700[1];
			fRec701[0] = fRec701[1] + 2.0 * (fTemp578 * fTemp580 / fTemp579);
			double fTemp581 = 0.00404728 * fRec683[0] + fRec684[0] * (0.00189104 - 0.00593832 * fRec683[0]) + 0.00888014;
			double fRec702 = fTemp580 * fTemp581 / fTemp579;
			double fTemp582 = fRec672[0] * (fTemp576 + fRec684[0] * (26.0 - 31.0 * fRec683[0]) + 1.31e+03);
			double fTemp583 = std::tan(fConst5 * fTemp582);
			double fTemp584 = fTemp583 * (fTemp583 + fTemp18 / fTemp582) + 1.0;
			double fTemp585 = fTemp583 * (fTemp543 - fRec704[1]) + fRec703[1];
			fRec703[0] = 2.0 * (fTemp585 / fTemp584) - fRec703[1];
			fRec704[0] = fRec704[1] + 2.0 * (fTemp583 * fTemp585 / fTemp584);
			double fTemp586 = 0.0227416 * fRec683[0] + fRec684[0] * (0.00469608 - 0.02743768 * fRec683[0]) + 0.01193177;
			double fRec705 = fTemp585 * fTemp586 / fTemp584;
			double fTemp587 = fRec672[0] * (fTemp576 + fRec684[0] * (15.0 - 2e+01 * fRec683[0]) + 1178.0);
			double fTemp588 = std::tan(fConst5 * fTemp587);
			double fTemp589 = fTemp588 * (fTemp588 + fTemp18 / fTemp587) + 1.0;
			double fTemp590 = fTemp588 * (fTemp543 - fRec707[1]) + fRec706[1];
			fRec706[0] = 2.0 * (fTemp590 / fTemp589) - fRec706[1];
			fRec707[0] = fRec707[1] + 2.0 * (fTemp588 * fTemp590 / fTemp589);
			double fTemp591 = fRec684[0] * (0.004585809999999999 - 0.0018878599999999982 * fRec683[0]) + (0.01707981 - 0.002697950000000001 * fRec683[0]);
			double fRec708 = fTemp590 * fTemp591 / fTemp589;
			double fTemp592 = fRec672[0] * (fTemp576 + fRec684[0] * (22.0 - 27.0 * fRec683[0]) + 1047.0);
			double fTemp593 = std::tan(fConst5 * fTemp592);
			double fTemp594 = fTemp593 * (fTemp593 + fTemp18 / fTemp592) + 1.0;
			double fTemp595 = fTemp593 * (fTemp543 - fRec710[1]) + fRec709[1];
			fRec709[0] = 2.0 * (fTemp595 / fTemp594) - fRec709[1];
			fRec710[0] = fRec710[1] + 2.0 * (fTemp593 * fTemp595 / fTemp594);
			double fTemp596 = 0.01049454 * fRec683[0] + fRec684[0] * (0.022906150000000004 - 0.033400690000000004 * fRec683[0]) + 0.02127434;
			double fRec711 = fTemp595 * fTemp596 / fTemp594;
			double fTemp597 = 3.0 * fRec683[0];
			double fTemp598 = fRec672[0] * (fTemp597 + fRec684[0] * (1e+01 - 13.0 * fRec683[0]) + 917.0);
			double fTemp599 = std::tan(fConst5 * fTemp598);
			double fTemp600 = fTemp599 * (fTemp599 + fTemp18 / fTemp598) + 1.0;
			double fTemp601 = fTemp599 * (fTemp543 - fRec713[1]) + fRec712[1];
			fRec712[0] = 2.0 * (fTemp601 / fTemp600) - fRec712[1];
			fRec713[0] = fRec713[1] + 2.0 * (fTemp599 * fTemp601 / fTemp600);
			double fTemp602 = fRec684[0] * (0.11867802000000001 * fRec683[0] + -0.06216229000000001) + (0.08372042 - 0.05651573 * fRec683[0]);
			double fRec714 = fTemp601 * fTemp602 / fTemp600;
			double fTemp603 = fRec672[0] * (fTemp597 + fRec684[0] * (15.0 - 18.0 * fRec683[0]) + 786.0);
			double fTemp604 = std::tan(fConst5 * fTemp603);
			double fTemp605 = fTemp604 * (fTemp604 + fTemp18 / fTemp603) + 1.0;
			double fTemp606 = fTemp604 * (fTemp543 - fRec716[1]) + fRec715[1];
			fRec715[0] = 2.0 * (fTemp606 / fTemp605) - fRec715[1];
			fRec716[0] = fRec716[1] + 2.0 * (fTemp604 * fTemp606 / fTemp605);
			double fTemp607 = 0.007078770000000002 * fRec683[0] + fRec684[0] * (0.0313596 - 0.03843837 * fRec683[0]) + 0.02810959;
			double fRec717 = fTemp606 * fTemp607 / fTemp605;
			double fTemp608 = 2.0 * fRec683[0];
			double fTemp609 = fRec672[0] * (fTemp608 + fRec684[0] * (13.0 - 15.0 * fRec683[0]) + 655.0);
			double fTemp610 = std::tan(fConst5 * fTemp609);
			double fTemp611 = fTemp610 * (fTemp610 + fTemp18 / fTemp609) + 1.0;
			double fTemp612 = fTemp610 * (fTemp543 - fRec719[1]) + fRec718[1];
			fRec718[0] = 2.0 * (fTemp612 / fTemp611) - fRec718[1];
			fRec719[0] = fRec719[1] + 2.0 * (fTemp610 * fTemp612 / fTemp611);
			double fTemp613 = 0.039912470000000005 * fRec683[0] + fRec684[0] * (0.005417789999999992 - 0.04533026 * fRec683[0]) + 0.10262931;
			double fRec720 = fTemp612 * fTemp613 / fTemp611;
			double fTemp614 = fTemp608 + fRec684[0] * (1e+01 - 12.0 * fRec683[0]);
			double fTemp615 = fRec672[0] * (fTemp614 + 524.0);
			double fTemp616 = std::tan(fConst5 * fTemp615);
			double fTemp617 = fTemp616 * (fTemp616 + fTemp18 / fTemp615) + 1.0;
			double fTemp618 = fTemp616 * (fTemp543 - fRec722[1]) + fRec721[1];
			fRec721[0] = 2.0 * (fTemp618 / fTemp617) - fRec721[1];
			fRec722[0] = fRec722[1] + 2.0 * (fTemp616 * fTemp618 / fTemp617);
			double fTemp619 = 0.16088293999999997 * fRec683[0] + fRec684[0] * (-0.06794681000000001 - 0.09293612999999996 * fRec683[0]) + 0.15710983;
			double fRec723 = fTemp618 * fTemp619 / fTemp617;
			double fTemp620 = fRec672[0] * (fRec683[0] + fRec684[0] * (5.0 - fTemp570) + 393.0);
			double fTemp621 = std::tan(fConst5 * fTemp620);
			double fTemp622 = fTemp621 * (fTemp621 + fTemp18 / fTemp620) + 1.0;
			double fTemp623 = fTemp621 * (fTemp543 - fRec725[1]) + fRec724[1];
			fRec724[0] = 2.0 * (fTemp623 / fTemp622) - fRec724[1];
			fRec725[0] = fRec725[1] + 2.0 * (fTemp621 * fTemp623 / fTemp622);
			double fTemp624 = 0.52347231 * fRec683[0] + fRec684[0] * (-0.11388923 - 0.40958308000000004 * fRec683[0]) + 0.20074493;
			double fRec726 = fTemp623 * fTemp624 / fTemp622;
			double fTemp625 = fRec672[0] * (fRec683[0] + fRec684[0] * (4.0 - fTemp576) + 262.0);
			double fTemp626 = std::tan(fConst5 * fTemp625);
			double fTemp627 = fTemp626 * (fTemp626 + fTemp18 / fTemp625) + 1.0;
			double fTemp628 = fTemp626 * (fTemp543 - fRec728[1]) + fRec727[1];
			fRec727[0] = 2.0 * (fTemp628 / fTemp627) - fRec727[1];
			fRec728[0] = fRec728[1] + 2.0 * (fTemp626 * fTemp628 / fTemp627);
			double fTemp629 = 0.02997270000000002 * fRec683[0] + fRec684[0] * (0.13487834999999998 * fRec683[0] + -0.16485105) + 0.29825361;
			double fRec729 = fTemp628 * fTemp629 / fTemp627;
			double fTemp630 = std::tan(fConst8 * fRec672[0]);
			double fTemp631 = fTemp630 * (fTemp630 + 0.007633587786259542 * fTemp531) + 1.0;
			double fTemp632 = fTemp630 * (fTemp543 - fRec731[1]) + fRec730[1];
			fRec730[0] = 2.0 * (fTemp632 / fTemp631) - fRec730[1];
			fRec731[0] = fRec731[1] + 2.0 * (fTemp630 * fTemp632 / fTemp631);
			double fTemp633 = fRec684[0] * (0.6123959999999999 * fRec683[0] + -0.41317138) + (1.0 - 0.19922461999999996 * fRec683[0]);
			double fRec732 = fTemp632 * fTemp633 / fTemp631;
			double fTemp634 = fRec672[0] * (fTemp608 + fRec684[0] * (6.0 - fTemp559) + 327.0);
			double fTemp635 = std::tan(fConst5 * fTemp634);
			double fTemp636 = fTemp635 * (fTemp635 + fTemp18 / fTemp634) + 1.0;
			double fTemp637 = fTemp635 * (fTemp543 - fRec734[1]) + fRec733[1];
			fRec733[0] = 2.0 * (fTemp637 / fTemp636) - fRec733[1];
			fRec734[0] = fRec734[1] + 2.0 * (fTemp635 * fTemp637 / fTemp636);
			double fTemp638 = 0.07501773 * fRec683[0] + fRec684[0] * (-0.04893692999999999 - 0.026080800000000015 * fRec683[0]) + 0.24961559;
			double fRec735 = fTemp637 * fTemp638 / fTemp636;
			double fTemp639 = fRec672[0] * (fTemp614 + 458.0);
			double fTemp640 = std::tan(fConst5 * fTemp639);
			double fTemp641 = fTemp640 * (fTemp640 + fTemp18 / fTemp639) + 1.0;
			double fTemp642 = fTemp640 * (fTemp543 - fRec737[1]) + fRec736[1];
			fRec736[0] = 2.0 * (fTemp642 / fTemp641) - fRec736[1];
			fRec737[0] = fRec737[1] + 2.0 * (fTemp640 * fTemp642 / fTemp641);
			double fTemp643 = 0.031150369999999983 * fRec683[0] + fRec684[0] * (0.03386702 - 0.06501738999999998 * fRec683[0]) + 0.1571452;
			double fRec738 = fTemp642 * fTemp643 / fTemp641;
			double fTemp644 = fRec672[0] * (fTemp608 + fRec684[0] * (12.0 - 14.0 * fRec683[0]) + 589.0);
			double fTemp645 = std::tan(fConst5 * fTemp644);
			double fTemp646 = fTemp645 * (fTemp645 + fTemp18 / fTemp644) + 1.0;
			double fTemp647 = fTemp645 * (fTemp543 - fRec740[1]) + fRec739[1];
			fRec739[0] = 2.0 * (fTemp647 / fTemp646) - fRec739[1];
			fRec740[0] = fRec740[1] + 2.0 * (fTemp645 * fTemp647 / fTemp646);
			double fTemp648 = fRec684[0] * (0.15122519 * fRec683[0] + -0.08735081) + (0.20902308 - 0.06387438000000001 * fRec683[0]);
			double fRec741 = fTemp647 * fTemp648 / fTemp646;
			double fTemp649 = fRec672[0] * (fTemp597 + fRec684[0] * (14.0 - 17.0 * fRec683[0]) + 7.2e+02);
			double fTemp650 = std::tan(fConst5 * fTemp649);
			double fTemp651 = fTemp650 * (fTemp650 + fTemp18 / fTemp649) + 1.0;
			double fTemp652 = fTemp650 * (fTemp543 - fRec743[1]) + fRec742[1];
			fRec742[0] = 2.0 * (fTemp652 / fTemp651) - fRec742[1];
			fRec743[0] = fRec743[1] + 2.0 * (fTemp650 * fTemp652 / fTemp651);
			double fTemp653 = 0.006377540000000001 * fRec683[0] + fRec684[0] * (0.03603802 * fRec683[0] + -0.04241556) + 0.07819993;
			double fRec744 = fTemp652 * fTemp653 / fTemp651;
			double fTemp654 = 4.0 * fRec683[0];
			double fTemp655 = fRec672[0] * (fTemp654 + fRec684[0] * (17.0 - 21.0 * fRec683[0]) + 851.0);
			double fTemp656 = std::tan(fConst5 * fTemp655);
			double fTemp657 = fTemp656 * (fTemp656 + fTemp18 / fTemp655) + 1.0;
			double fTemp658 = fTemp656 * (fTemp543 - fRec746[1]) + fRec745[1];
			fRec745[0] = 2.0 * (fTemp658 / fTemp657) - fRec745[1];
			fRec746[0] = fRec746[1] + 2.0 * (fTemp656 * fTemp658 / fTemp657);
			double fTemp659 = 0.043723639999999994 * fRec683[0] + fRec684[0] * (-0.00032270000000000215 - 0.04340093999999999 * fRec683[0]) + 0.03754288;
			double fRec747 = fTemp658 * fTemp659 / fTemp657;
			double fTemp660 = fRec672[0] * (fTemp654 + fRec684[0] * (19.0 - 23.0 * fRec683[0]) + 982.0);
			double fTemp661 = std::tan(fConst5 * fTemp660);
			double fTemp662 = fTemp661 * (fTemp661 + fTemp18 / fTemp660) + 1.0;
			double fTemp663 = fTemp661 * (fTemp543 - fRec749[1]) + fRec748[1];
			fRec748[0] = 2.0 * (fTemp663 / fTemp662) - fRec748[1];
			fRec749[0] = fRec749[1] + 2.0 * (fTemp661 * fTemp663 / fTemp662);
			double fTemp664 = 0.022372620000000003 * fRec683[0] + fRec684[0] * (0.029409400000000002 - 0.051782020000000005 * fRec683[0]) + 0.00927965;
			double fRec750 = fTemp663 * fTemp664 / fTemp662;
			double fTemp665 = fRec672[0] * (fTemp654 + fRec684[0] * (22.0 - 26.0 * fRec683[0]) + 1113.0);
			double fTemp666 = std::tan(fConst5 * fTemp665);
			double fTemp667 = fTemp666 * (fTemp666 + fTemp18 / fTemp665) + 1.0;
			double fTemp668 = fTemp666 * (fTemp543 - fRec752[1]) + fRec751[1];
			fRec751[0] = 2.0 * (fTemp668 / fTemp667) - fRec751[1];
			fRec752[0] = fRec752[1] + 2.0 * (fTemp666 * fTemp668 / fTemp667);
			double fTemp669 = 0.01651215 * fRec683[0] + fRec684[0] * (0.004918780000000001 - 0.02143093 * fRec683[0]) + 0.02702054;
			double fRec753 = fTemp668 * fTemp669 / fTemp667;
			double fTemp670 = fRec672[0] * (fTemp576 + fRec684[0] * (25.0 - 3e+01 * fRec683[0]) + 1244.0);
			double fTemp671 = std::tan(fConst5 * fTemp670);
			double fTemp672 = fTemp671 * (fTemp671 + fTemp18 / fTemp670) + 1.0;
			double fTemp673 = fTemp671 * (fTemp543 - fRec755[1]) + fRec754[1];
			fRec754[0] = 2.0 * (fTemp673 / fTemp672) - fRec754[1];
			fRec755[0] = fRec755[1] + 2.0 * (fTemp671 * fTemp673 / fTemp672);
			double fTemp674 = fRec684[0] * (0.009495489999999999 - 0.006188469999999999 * fRec683[0]) + (0.01010378 - 0.00330702 * fRec683[0]);
			double fRec756 = fTemp673 * fTemp674 / fTemp672;
			double fTemp675 = fRec672[0] * (fTemp576 + fRec684[0] * (27.0 - 32.0 * fRec683[0]) + 1375.0);
			double fTemp676 = std::tan(fConst5 * fTemp675);
			double fTemp677 = fTemp676 * (fTemp676 + fTemp18 / fTemp675) + 1.0;
			double fTemp678 = fTemp676 * (fTemp543 - fRec758[1]) + fRec757[1];
			fRec757[0] = 2.0 * (fTemp678 / fTemp677) - fRec757[1];
			fRec758[0] = fRec758[1] + 2.0 * (fTemp676 * fTemp678 / fTemp677);
			double fTemp679 = fRec684[0] * (0.0277721 - 0.025426740000000003 * fRec683[0]) + (0.00929211 - 0.0023453599999999995 * fRec683[0]);
			double fRec759 = fTemp678 * fTemp679 / fTemp677;
			double fTemp680 = fRec672[0] * (fTemp570 + fRec684[0] * (3e+01 - 36.0 * fRec683[0]) + 1506.0);
			double fTemp681 = std::tan(fConst5 * fTemp680);
			double fTemp682 = fTemp681 * (fTemp681 + fTemp18 / fTemp680) + 1.0;
			double fTemp683 = fTemp681 * (fTemp543 - fRec761[1]) + fRec760[1];
			fRec760[0] = 2.0 * (fTemp683 / fTemp682) - fRec760[1];
			fRec761[0] = fRec761[1] + 2.0 * (fTemp681 * fTemp683 / fTemp682);
			double fTemp684 = 0.01661545 * fRec683[0] + fRec684[0] * (0.023741299999999996 - 0.04035675 * fRec683[0]) + 0.00940227;
			double fRec762 = fTemp683 * fTemp684 / fTemp682;
			double fTemp685 = fRec672[0] * (fTemp570 + fRec684[0] * (33.0 - 39.0 * fRec683[0]) + 1637.0);
			double fTemp686 = std::tan(fConst5 * fTemp685);
			double fTemp687 = fTemp686 * (fTemp686 + fTemp18 / fTemp685) + 1.0;
			double fTemp688 = fTemp686 * (fTemp543 - fRec764[1]) + fRec763[1];
			fRec763[0] = 2.0 * (fTemp688 / fTemp687) - fRec763[1];
			fRec764[0] = fRec764[1] + 2.0 * (fTemp686 * fTemp688 / fTemp687);
			double fTemp689 = 0.005929820000000001 * fRec683[0] + fRec684[0] * (0.00200935 - 0.00793917 * fRec683[0]) + 0.00459008;
			double fRec765 = fTemp688 * fTemp689 / fTemp687;
			double fTemp690 = fRec672[0] * (fTemp547 + fRec684[0] * (102.0 - 109.0 * fRec683[0]) + 1768.0);
			double fTemp691 = std::tan(fConst5 * fTemp690);
			double fTemp692 = fTemp691 * (fTemp691 + fTemp18 / fTemp690) + 1.0;
			double fTemp693 = fTemp691 * (fTemp543 - fRec767[1]) + fRec766[1];
			fRec766[0] = 2.0 * (fTemp693 / fTemp692) - fRec766[1];
			fRec767[0] = fRec767[1] + 2.0 * (fTemp691 * fTemp693 / fTemp692);
			double fTemp694 = 0.005757190000000001 * fRec683[0] + fRec684[0] * (-0.0044776 - 0.0012795900000000006 * fRec683[0]) + 0.00941733;
			double fRec768 = fTemp693 * fTemp694 / fTemp692;
			double fTemp695 = fRec672[0] * (fTemp547 + fRec684[0] * (104.0 - fTemp558) + 1899.0);
			double fTemp696 = std::tan(fConst5 * fTemp695);
			double fTemp697 = fTemp696 * (fTemp696 + fTemp18 / fTemp695) + 1.0;
			double fTemp698 = fTemp696 * (fTemp543 - fRec770[1]) + fRec769[1];
			fRec769[0] = 2.0 * (fTemp698 / fTemp697) - fRec769[1];
			fRec770[0] = fRec770[1] + 2.0 * (fTemp696 * fTemp698 / fTemp697);
			double fTemp699 = 0.00223778 * fRec683[0] + fRec684[0] * (0.003461960000000001 - 0.005699740000000001 * fRec683[0]) + 0.00503596;
			double fRec771 = fTemp698 * fTemp699 / fTemp697;
			double fTemp700 = fRec672[0] * (fTemp559 + fRec684[0] * (107.0 - fTemp546) + 2.03e+03);
			double fTemp701 = std::tan(fConst5 * fTemp700);
			double fTemp702 = fTemp701 * (fTemp701 + fTemp18 / fTemp700) + 1.0;
			double fTemp703 = fTemp701 * (fTemp543 - fRec773[1]) + fRec772[1];
			fRec772[0] = 2.0 * (fTemp703 / fTemp702) - fRec772[1];
			fRec773[0] = fRec773[1] + 2.0 * (fTemp701 * fTemp703 / fTemp702);
			double fTemp704 = 0.0033720900000000003 * fRec683[0] + fRec684[0] * (0.007210579999999999 - 0.010582669999999999 * fRec683[0]) + 0.00223048;
			double fRec774 = fTemp703 * fTemp704 / fTemp702;
			double fTemp705 = fRec672[0] * (fTemp547 + fRec684[0] * (109.0 - 116.0 * fRec683[0]) + 2162.0);
			double fTemp706 = std::tan(fConst5 * fTemp705);
			double fTemp707 = fTemp706 * (fTemp706 + fTemp18 / fTemp705) + 1.0;
			double fTemp708 = fTemp706 * (fTemp543 - fRec776[1]) + fRec775[1];
			fRec775[0] = 2.0 * (fTemp708 / fTemp707) - fRec775[1];
			fRec776[0] = fRec776[1] + 2.0 * (fTemp706 * fTemp708 / fTemp707);
			double fTemp709 = 0.01214753 * fRec683[0] + fRec684[0] * (0.005874650000000001 - 0.018022180000000002 * fRec683[0]) + 0.00459407;
			double fRec777 = fTemp708 * fTemp709 / fTemp707;
			double fTemp710 = fTemp543 * fRec36[0] + 0.03125 * fRec137[0] * (fRec777 + fRec774 + fRec771 + fRec768 + fRec765 + fRec762 + fRec759 + fRec756 + fRec753 + fRec750 + fRec747 + fRec744 + fRec741 + fRec738 + fRec735 + fRec732 + fRec729 + fRec726 + fRec723 + fRec720 + fRec717 + fRec714 + fRec711 + fRec708 + fRec705 + fRec702 + fRec699 + fRec696 + fRec693 + fRec690 + fRec687 + fRec671);
			fRec668[0] = std::max<double>(fConst1 * fRec668[1], std::fabs(fTemp710));
			fVbargraph28 = FAUSTFLOAT(fRec668[0]);
			fRec665[0] = fTemp710;
			double fTemp711 = fRec26[0] * fRec667[1];
			fRec782[0] = std::max<double>(fConst1 * fRec782[1], std::fabs(fTemp711));
			fVbargraph29 = FAUSTFLOAT(fRec782[0]);
			double fTemp712 = fTemp711;
			double fTemp713 = fRec28[0] * (fTemp535 * (fRec143[0] - fTemp712) - fTemp537);
			double fTemp714 = fRec678[1] + fTemp12;
			double fTemp715 = fTemp714 + fTemp537;
			fVec15[0] = fTemp715 + fTemp713 + fTemp189;
			fRec781[0] = fTemp713 + 0.995 * fRec781[1] + fTemp715 + (1.3 - (fVec3[1] + fVec15[1]));
			fRec780[0] = std::max<double>(fConst1 * fRec780[1], std::fabs(fRec781[0]));
			fVbargraph30 = FAUSTFLOAT(fRec780[0]);
			double fTemp716 = fRec17[0] * tanh(fRec781[0] / fTemp4);
			fRec779[0] = std::max<double>(fConst1 * fRec779[1], std::fabs(fTemp716));
			fVbargraph31 = FAUSTFLOAT(fRec779[0]);
			double fTemp717 = fTemp716;
			double fTemp718 = fTemp532 * (fTemp717 - fRec784[1]) + fRec783[1];
			fRec783[0] = 2.0 * (fTemp718 / fTemp533) - fRec783[1];
			fRec784[0] = fRec784[1] + 2.0 * (fTemp532 * fTemp718 / fTemp533);
			double fRec785 = fTemp545 * fTemp718 / fTemp533;
			double fTemp719 = fTemp549 * (fTemp717 - fRec787[1]) + fRec786[1];
			fRec786[0] = 2.0 * (fTemp719 / fTemp550) - fRec786[1];
			fRec787[0] = fRec787[1] + 2.0 * (fTemp549 * fTemp719 / fTemp550);
			double fRec788 = fTemp552 * fTemp719 / fTemp550;
			double fTemp720 = fTemp554 * (fTemp717 - fRec790[1]) + fRec789[1];
			fRec789[0] = 2.0 * (fTemp720 / fTemp555) - fRec789[1];
			fRec790[0] = fRec790[1] + 2.0 * (fTemp554 * fTemp720 / fTemp555);
			double fRec791 = fTemp557 * fTemp720 / fTemp555;
			double fTemp721 = fTemp561 * (fTemp717 - fRec793[1]) + fRec792[1];
			fRec792[0] = 2.0 * (fTemp721 / fTemp562) - fRec792[1];
			fRec793[0] = fRec793[1] + 2.0 * (fTemp561 * fTemp721 / fTemp562);
			double fRec794 = fTemp564 * fTemp721 / fTemp562;
			double fTemp722 = fTemp566 * (fTemp717 - fRec796[1]) + fRec795[1];
			fRec795[0] = 2.0 * (fTemp722 / fTemp567) - fRec795[1];
			fRec796[0] = fRec796[1] + 2.0 * (fTemp566 * fTemp722 / fTemp567);
			double fRec797 = fTemp569 * fTemp722 / fTemp567;
			double fTemp723 = fTemp572 * (fTemp717 - fRec799[1]) + fRec798[1];
			fRec798[0] = 2.0 * (fTemp723 / fTemp573) - fRec798[1];
			fRec799[0] = fRec799[1] + 2.0 * (fTemp572 * fTemp723 / fTemp573);
			double fRec800 = fTemp575 * fTemp723 / fTemp573;
			double fTemp724 = fTemp578 * (fTemp717 - fRec802[1]) + fRec801[1];
			fRec801[0] = 2.0 * (fTemp724 / fTemp579) - fRec801[1];
			fRec802[0] = fRec802[1] + 2.0 * (fTemp578 * fTemp724 / fTemp579);
			double fRec803 = fTemp581 * fTemp724 / fTemp579;
			double fTemp725 = fTemp583 * (fTemp717 - fRec805[1]) + fRec804[1];
			fRec804[0] = 2.0 * (fTemp725 / fTemp584) - fRec804[1];
			fRec805[0] = fRec805[1] + 2.0 * (fTemp583 * fTemp725 / fTemp584);
			double fRec806 = fTemp586 * fTemp725 / fTemp584;
			double fTemp726 = fTemp588 * (fTemp717 - fRec808[1]) + fRec807[1];
			fRec807[0] = 2.0 * (fTemp726 / fTemp589) - fRec807[1];
			fRec808[0] = fRec808[1] + 2.0 * (fTemp588 * fTemp726 / fTemp589);
			double fRec809 = fTemp591 * fTemp726 / fTemp589;
			double fTemp727 = fTemp593 * (fTemp717 - fRec811[1]) + fRec810[1];
			fRec810[0] = 2.0 * (fTemp727 / fTemp594) - fRec810[1];
			fRec811[0] = fRec811[1] + 2.0 * (fTemp593 * fTemp727 / fTemp594);
			double fRec812 = fTemp596 * fTemp727 / fTemp594;
			double fTemp728 = fTemp599 * (fTemp717 - fRec814[1]) + fRec813[1];
			fRec813[0] = 2.0 * (fTemp728 / fTemp600) - fRec813[1];
			fRec814[0] = fRec814[1] + 2.0 * (fTemp599 * fTemp728 / fTemp600);
			double fRec815 = fTemp602 * fTemp728 / fTemp600;
			double fTemp729 = fTemp604 * (fTemp717 - fRec817[1]) + fRec816[1];
			fRec816[0] = 2.0 * (fTemp729 / fTemp605) - fRec816[1];
			fRec817[0] = fRec817[1] + 2.0 * (fTemp604 * fTemp729 / fTemp605);
			double fRec818 = fTemp607 * fTemp729 / fTemp605;
			double fTemp730 = fTemp610 * (fTemp717 - fRec820[1]) + fRec819[1];
			fRec819[0] = 2.0 * (fTemp730 / fTemp611) - fRec819[1];
			fRec820[0] = fRec820[1] + 2.0 * (fTemp610 * fTemp730 / fTemp611);
			double fRec821 = fTemp613 * fTemp730 / fTemp611;
			double fTemp731 = fTemp616 * (fTemp717 - fRec823[1]) + fRec822[1];
			fRec822[0] = 2.0 * (fTemp731 / fTemp617) - fRec822[1];
			fRec823[0] = fRec823[1] + 2.0 * (fTemp616 * fTemp731 / fTemp617);
			double fRec824 = fTemp619 * fTemp731 / fTemp617;
			double fTemp732 = fTemp621 * (fTemp717 - fRec826[1]) + fRec825[1];
			fRec825[0] = 2.0 * (fTemp732 / fTemp622) - fRec825[1];
			fRec826[0] = fRec826[1] + 2.0 * (fTemp621 * fTemp732 / fTemp622);
			double fRec827 = fTemp624 * fTemp732 / fTemp622;
			double fTemp733 = fTemp626 * (fTemp717 - fRec829[1]) + fRec828[1];
			fRec828[0] = 2.0 * (fTemp733 / fTemp627) - fRec828[1];
			fRec829[0] = fRec829[1] + 2.0 * (fTemp626 * fTemp733 / fTemp627);
			double fRec830 = fTemp629 * fTemp733 / fTemp627;
			double fTemp734 = fTemp630 * (fTemp717 - fRec832[1]) + fRec831[1];
			fRec831[0] = 2.0 * (fTemp734 / fTemp631) - fRec831[1];
			fRec832[0] = fRec832[1] + 2.0 * (fTemp630 * fTemp734 / fTemp631);
			double fRec833 = fTemp633 * fTemp734 / fTemp631;
			double fTemp735 = fTemp635 * (fTemp717 - fRec835[1]) + fRec834[1];
			fRec834[0] = 2.0 * (fTemp735 / fTemp636) - fRec834[1];
			fRec835[0] = fRec835[1] + 2.0 * (fTemp635 * fTemp735 / fTemp636);
			double fRec836 = fTemp638 * fTemp735 / fTemp636;
			double fTemp736 = fTemp640 * (fTemp717 - fRec838[1]) + fRec837[1];
			fRec837[0] = 2.0 * (fTemp736 / fTemp641) - fRec837[1];
			fRec838[0] = fRec838[1] + 2.0 * (fTemp640 * fTemp736 / fTemp641);
			double fRec839 = fTemp643 * fTemp736 / fTemp641;
			double fTemp737 = fTemp645 * (fTemp717 - fRec841[1]) + fRec840[1];
			fRec840[0] = 2.0 * (fTemp737 / fTemp646) - fRec840[1];
			fRec841[0] = fRec841[1] + 2.0 * (fTemp645 * fTemp737 / fTemp646);
			double fRec842 = fTemp648 * fTemp737 / fTemp646;
			double fTemp738 = fTemp650 * (fTemp717 - fRec844[1]) + fRec843[1];
			fRec843[0] = 2.0 * (fTemp738 / fTemp651) - fRec843[1];
			fRec844[0] = fRec844[1] + 2.0 * (fTemp650 * fTemp738 / fTemp651);
			double fRec845 = fTemp653 * fTemp738 / fTemp651;
			double fTemp739 = fTemp656 * (fTemp717 - fRec847[1]) + fRec846[1];
			fRec846[0] = 2.0 * (fTemp739 / fTemp657) - fRec846[1];
			fRec847[0] = fRec847[1] + 2.0 * (fTemp656 * fTemp739 / fTemp657);
			double fRec848 = fTemp659 * fTemp739 / fTemp657;
			double fTemp740 = fTemp661 * (fTemp717 - fRec850[1]) + fRec849[1];
			fRec849[0] = 2.0 * (fTemp740 / fTemp662) - fRec849[1];
			fRec850[0] = fRec850[1] + 2.0 * (fTemp661 * fTemp740 / fTemp662);
			double fRec851 = fTemp664 * fTemp740 / fTemp662;
			double fTemp741 = fTemp666 * (fTemp717 - fRec853[1]) + fRec852[1];
			fRec852[0] = 2.0 * (fTemp741 / fTemp667) - fRec852[1];
			fRec853[0] = fRec853[1] + 2.0 * (fTemp666 * fTemp741 / fTemp667);
			double fRec854 = fTemp669 * fTemp741 / fTemp667;
			double fTemp742 = fTemp671 * (fTemp717 - fRec856[1]) + fRec855[1];
			fRec855[0] = 2.0 * (fTemp742 / fTemp672) - fRec855[1];
			fRec856[0] = fRec856[1] + 2.0 * (fTemp671 * fTemp742 / fTemp672);
			double fRec857 = fTemp674 * fTemp742 / fTemp672;
			double fTemp743 = fTemp676 * (fTemp717 - fRec859[1]) + fRec858[1];
			fRec858[0] = 2.0 * (fTemp743 / fTemp677) - fRec858[1];
			fRec859[0] = fRec859[1] + 2.0 * (fTemp676 * fTemp743 / fTemp677);
			double fRec860 = fTemp679 * fTemp743 / fTemp677;
			double fTemp744 = fTemp681 * (fTemp717 - fRec862[1]) + fRec861[1];
			fRec861[0] = 2.0 * (fTemp744 / fTemp682) - fRec861[1];
			fRec862[0] = fRec862[1] + 2.0 * (fTemp681 * fTemp744 / fTemp682);
			double fRec863 = fTemp684 * fTemp744 / fTemp682;
			double fTemp745 = fTemp686 * (fTemp717 - fRec865[1]) + fRec864[1];
			fRec864[0] = 2.0 * (fTemp745 / fTemp687) - fRec864[1];
			fRec865[0] = fRec865[1] + 2.0 * (fTemp686 * fTemp745 / fTemp687);
			double fRec866 = fTemp689 * fTemp745 / fTemp687;
			double fTemp746 = fTemp691 * (fTemp717 - fRec868[1]) + fRec867[1];
			fRec867[0] = 2.0 * (fTemp746 / fTemp692) - fRec867[1];
			fRec868[0] = fRec868[1] + 2.0 * (fTemp691 * fTemp746 / fTemp692);
			double fRec869 = fTemp694 * fTemp746 / fTemp692;
			double fTemp747 = fTemp696 * (fTemp717 - fRec871[1]) + fRec870[1];
			fRec870[0] = 2.0 * (fTemp747 / fTemp697) - fRec870[1];
			fRec871[0] = fRec871[1] + 2.0 * (fTemp696 * fTemp747 / fTemp697);
			double fRec872 = fTemp699 * fTemp747 / fTemp697;
			double fTemp748 = fTemp701 * (fTemp717 - fRec874[1]) + fRec873[1];
			fRec873[0] = 2.0 * (fTemp748 / fTemp702) - fRec873[1];
			fRec874[0] = fRec874[1] + 2.0 * (fTemp701 * fTemp748 / fTemp702);
			double fRec875 = fTemp704 * fTemp748 / fTemp702;
			double fTemp749 = fTemp706 * (fTemp717 - fRec877[1]) + fRec876[1];
			fRec876[0] = 2.0 * (fTemp749 / fTemp707) - fRec876[1];
			fRec877[0] = fRec877[1] + 2.0 * (fTemp706 * fTemp749 / fTemp707);
			double fRec878 = fTemp709 * fTemp749 / fTemp707;
			double fTemp750 = 0.03125 * fRec137[0] * (fRec878 + fRec875 + fRec872 + fRec869 + fRec866 + fRec863 + fRec860 + fRec857 + fRec854 + fRec851 + fRec848 + fRec845 + fRec842 + fRec839 + fRec836 + fRec833 + fRec830 + fRec827 + fRec824 + fRec821 + fRec818 + fRec815 + fRec812 + fRec809 + fRec806 + fRec803 + fRec800 + fRec797 + fRec794 + fRec791 + fRec788 + fRec785) + fRec36[0] * fTemp717;
			fRec778[0] = std::max<double>(fConst1 * fRec778[1], std::fabs(fTemp750));
			fVbargraph32 = FAUSTFLOAT(fRec778[0]);
			fRec666[0] = fTemp750;
			double fTemp751 = fRec28[0] * (fTemp535 * fTemp537 - fRec244[0] * fTemp712);
			double fTemp752 = fTemp714 + fTemp712;
			fVec16[0] = fTemp752 + fTemp751 + fTemp230;
			fRec882[0] = fTemp751 + 0.995 * fRec882[1] + fTemp752 + (1.6 - (fVec5[1] + fVec16[1]));
			fRec881[0] = std::max<double>(fConst1 * fRec881[1], std::fabs(fRec882[0]));
			fVbargraph33 = FAUSTFLOAT(fRec881[0]);
			double fTemp753 = fRec17[0] * tanh(fRec882[0] / fTemp4);
			fRec880[0] = std::max<double>(fConst1 * fRec880[1], std::fabs(fTemp753));
			fVbargraph34 = FAUSTFLOAT(fRec880[0]);
			double fTemp754 = fTemp753;
			double fTemp755 = fTemp532 * (fTemp754 - fRec884[1]) + fRec883[1];
			fRec883[0] = 2.0 * (fTemp755 / fTemp533) - fRec883[1];
			fRec884[0] = fRec884[1] + 2.0 * (fTemp532 * fTemp755 / fTemp533);
			double fRec885 = fTemp545 * fTemp755 / fTemp533;
			double fTemp756 = fTemp549 * (fTemp754 - fRec887[1]) + fRec886[1];
			fRec886[0] = 2.0 * (fTemp756 / fTemp550) - fRec886[1];
			fRec887[0] = fRec887[1] + 2.0 * (fTemp549 * fTemp756 / fTemp550);
			double fRec888 = fTemp552 * fTemp756 / fTemp550;
			double fTemp757 = fTemp554 * (fTemp754 - fRec890[1]) + fRec889[1];
			fRec889[0] = 2.0 * (fTemp757 / fTemp555) - fRec889[1];
			fRec890[0] = fRec890[1] + 2.0 * (fTemp554 * fTemp757 / fTemp555);
			double fRec891 = fTemp557 * fTemp757 / fTemp555;
			double fTemp758 = fTemp561 * (fTemp754 - fRec893[1]) + fRec892[1];
			fRec892[0] = 2.0 * (fTemp758 / fTemp562) - fRec892[1];
			fRec893[0] = fRec893[1] + 2.0 * (fTemp561 * fTemp758 / fTemp562);
			double fRec894 = fTemp564 * fTemp758 / fTemp562;
			double fTemp759 = fTemp566 * (fTemp754 - fRec896[1]) + fRec895[1];
			fRec895[0] = 2.0 * (fTemp759 / fTemp567) - fRec895[1];
			fRec896[0] = fRec896[1] + 2.0 * (fTemp566 * fTemp759 / fTemp567);
			double fRec897 = fTemp569 * fTemp759 / fTemp567;
			double fTemp760 = fTemp572 * (fTemp754 - fRec899[1]) + fRec898[1];
			fRec898[0] = 2.0 * (fTemp760 / fTemp573) - fRec898[1];
			fRec899[0] = fRec899[1] + 2.0 * (fTemp572 * fTemp760 / fTemp573);
			double fRec900 = fTemp575 * fTemp760 / fTemp573;
			double fTemp761 = fTemp578 * (fTemp754 - fRec902[1]) + fRec901[1];
			fRec901[0] = 2.0 * (fTemp761 / fTemp579) - fRec901[1];
			fRec902[0] = fRec902[1] + 2.0 * (fTemp578 * fTemp761 / fTemp579);
			double fRec903 = fTemp581 * fTemp761 / fTemp579;
			double fTemp762 = fTemp583 * (fTemp754 - fRec905[1]) + fRec904[1];
			fRec904[0] = 2.0 * (fTemp762 / fTemp584) - fRec904[1];
			fRec905[0] = fRec905[1] + 2.0 * (fTemp583 * fTemp762 / fTemp584);
			double fRec906 = fTemp586 * fTemp762 / fTemp584;
			double fTemp763 = fTemp588 * (fTemp754 - fRec908[1]) + fRec907[1];
			fRec907[0] = 2.0 * (fTemp763 / fTemp589) - fRec907[1];
			fRec908[0] = fRec908[1] + 2.0 * (fTemp588 * fTemp763 / fTemp589);
			double fRec909 = fTemp591 * fTemp763 / fTemp589;
			double fTemp764 = fTemp593 * (fTemp754 - fRec911[1]) + fRec910[1];
			fRec910[0] = 2.0 * (fTemp764 / fTemp594) - fRec910[1];
			fRec911[0] = fRec911[1] + 2.0 * (fTemp593 * fTemp764 / fTemp594);
			double fRec912 = fTemp596 * fTemp764 / fTemp594;
			double fTemp765 = fTemp599 * (fTemp754 - fRec914[1]) + fRec913[1];
			fRec913[0] = 2.0 * (fTemp765 / fTemp600) - fRec913[1];
			fRec914[0] = fRec914[1] + 2.0 * (fTemp599 * fTemp765 / fTemp600);
			double fRec915 = fTemp602 * fTemp765 / fTemp600;
			double fTemp766 = fTemp604 * (fTemp754 - fRec917[1]) + fRec916[1];
			fRec916[0] = 2.0 * (fTemp766 / fTemp605) - fRec916[1];
			fRec917[0] = fRec917[1] + 2.0 * (fTemp604 * fTemp766 / fTemp605);
			double fRec918 = fTemp607 * fTemp766 / fTemp605;
			double fTemp767 = fTemp610 * (fTemp754 - fRec920[1]) + fRec919[1];
			fRec919[0] = 2.0 * (fTemp767 / fTemp611) - fRec919[1];
			fRec920[0] = fRec920[1] + 2.0 * (fTemp610 * fTemp767 / fTemp611);
			double fRec921 = fTemp613 * fTemp767 / fTemp611;
			double fTemp768 = fTemp616 * (fTemp754 - fRec923[1]) + fRec922[1];
			fRec922[0] = 2.0 * (fTemp768 / fTemp617) - fRec922[1];
			fRec923[0] = fRec923[1] + 2.0 * (fTemp616 * fTemp768 / fTemp617);
			double fRec924 = fTemp619 * fTemp768 / fTemp617;
			double fTemp769 = fTemp621 * (fTemp754 - fRec926[1]) + fRec925[1];
			fRec925[0] = 2.0 * (fTemp769 / fTemp622) - fRec925[1];
			fRec926[0] = fRec926[1] + 2.0 * (fTemp621 * fTemp769 / fTemp622);
			double fRec927 = fTemp624 * fTemp769 / fTemp622;
			double fTemp770 = fTemp626 * (fTemp754 - fRec929[1]) + fRec928[1];
			fRec928[0] = 2.0 * (fTemp770 / fTemp627) - fRec928[1];
			fRec929[0] = fRec929[1] + 2.0 * (fTemp626 * fTemp770 / fTemp627);
			double fRec930 = fTemp629 * fTemp770 / fTemp627;
			double fTemp771 = fTemp630 * (fTemp754 - fRec932[1]) + fRec931[1];
			fRec931[0] = 2.0 * (fTemp771 / fTemp631) - fRec931[1];
			fRec932[0] = fRec932[1] + 2.0 * (fTemp630 * fTemp771 / fTemp631);
			double fRec933 = fTemp633 * fTemp771 / fTemp631;
			double fTemp772 = fTemp635 * (fTemp754 - fRec935[1]) + fRec934[1];
			fRec934[0] = 2.0 * (fTemp772 / fTemp636) - fRec934[1];
			fRec935[0] = fRec935[1] + 2.0 * (fTemp635 * fTemp772 / fTemp636);
			double fRec936 = fTemp638 * fTemp772 / fTemp636;
			double fTemp773 = fTemp640 * (fTemp754 - fRec938[1]) + fRec937[1];
			fRec937[0] = 2.0 * (fTemp773 / fTemp641) - fRec937[1];
			fRec938[0] = fRec938[1] + 2.0 * (fTemp640 * fTemp773 / fTemp641);
			double fRec939 = fTemp643 * fTemp773 / fTemp641;
			double fTemp774 = fTemp645 * (fTemp754 - fRec941[1]) + fRec940[1];
			fRec940[0] = 2.0 * (fTemp774 / fTemp646) - fRec940[1];
			fRec941[0] = fRec941[1] + 2.0 * (fTemp645 * fTemp774 / fTemp646);
			double fRec942 = fTemp648 * fTemp774 / fTemp646;
			double fTemp775 = fTemp650 * (fTemp754 - fRec944[1]) + fRec943[1];
			fRec943[0] = 2.0 * (fTemp775 / fTemp651) - fRec943[1];
			fRec944[0] = fRec944[1] + 2.0 * (fTemp650 * fTemp775 / fTemp651);
			double fRec945 = fTemp653 * fTemp775 / fTemp651;
			double fTemp776 = fTemp656 * (fTemp754 - fRec947[1]) + fRec946[1];
			fRec946[0] = 2.0 * (fTemp776 / fTemp657) - fRec946[1];
			fRec947[0] = fRec947[1] + 2.0 * (fTemp656 * fTemp776 / fTemp657);
			double fRec948 = fTemp659 * fTemp776 / fTemp657;
			double fTemp777 = fTemp661 * (fTemp754 - fRec950[1]) + fRec949[1];
			fRec949[0] = 2.0 * (fTemp777 / fTemp662) - fRec949[1];
			fRec950[0] = fRec950[1] + 2.0 * (fTemp661 * fTemp777 / fTemp662);
			double fRec951 = fTemp664 * fTemp777 / fTemp662;
			double fTemp778 = fTemp666 * (fTemp754 - fRec953[1]) + fRec952[1];
			fRec952[0] = 2.0 * (fTemp778 / fTemp667) - fRec952[1];
			fRec953[0] = fRec953[1] + 2.0 * (fTemp666 * fTemp778 / fTemp667);
			double fRec954 = fTemp669 * fTemp778 / fTemp667;
			double fTemp779 = fTemp671 * (fTemp754 - fRec956[1]) + fRec955[1];
			fRec955[0] = 2.0 * (fTemp779 / fTemp672) - fRec955[1];
			fRec956[0] = fRec956[1] + 2.0 * (fTemp671 * fTemp779 / fTemp672);
			double fRec957 = fTemp674 * fTemp779 / fTemp672;
			double fTemp780 = fTemp676 * (fTemp754 - fRec959[1]) + fRec958[1];
			fRec958[0] = 2.0 * (fTemp780 / fTemp677) - fRec958[1];
			fRec959[0] = fRec959[1] + 2.0 * (fTemp676 * fTemp780 / fTemp677);
			double fRec960 = fTemp679 * fTemp780 / fTemp677;
			double fTemp781 = fTemp681 * (fTemp754 - fRec962[1]) + fRec961[1];
			fRec961[0] = 2.0 * (fTemp781 / fTemp682) - fRec961[1];
			fRec962[0] = fRec962[1] + 2.0 * (fTemp681 * fTemp781 / fTemp682);
			double fRec963 = fTemp684 * fTemp781 / fTemp682;
			double fTemp782 = fTemp686 * (fTemp754 - fRec965[1]) + fRec964[1];
			fRec964[0] = 2.0 * (fTemp782 / fTemp687) - fRec964[1];
			fRec965[0] = fRec965[1] + 2.0 * (fTemp686 * fTemp782 / fTemp687);
			double fRec966 = fTemp689 * fTemp782 / fTemp687;
			double fTemp783 = fTemp691 * (fTemp754 - fRec968[1]) + fRec967[1];
			fRec967[0] = 2.0 * (fTemp783 / fTemp692) - fRec967[1];
			fRec968[0] = fRec968[1] + 2.0 * (fTemp691 * fTemp783 / fTemp692);
			double fRec969 = fTemp694 * fTemp783 / fTemp692;
			double fTemp784 = fTemp696 * (fTemp754 - fRec971[1]) + fRec970[1];
			fRec970[0] = 2.0 * (fTemp784 / fTemp697) - fRec970[1];
			fRec971[0] = fRec971[1] + 2.0 * (fTemp696 * fTemp784 / fTemp697);
			double fRec972 = fTemp699 * fTemp784 / fTemp697;
			double fTemp785 = fTemp701 * (fTemp754 - fRec974[1]) + fRec973[1];
			fRec973[0] = 2.0 * (fTemp785 / fTemp702) - fRec973[1];
			fRec974[0] = fRec974[1] + 2.0 * (fTemp701 * fTemp785 / fTemp702);
			double fRec975 = fTemp704 * fTemp785 / fTemp702;
			double fTemp786 = fTemp706 * (fTemp754 - fRec977[1]) + fRec976[1];
			fRec976[0] = 2.0 * (fTemp786 / fTemp707) - fRec976[1];
			fRec977[0] = fRec977[1] + 2.0 * (fTemp706 * fTemp786 / fTemp707);
			double fRec978 = fTemp709 * fTemp786 / fTemp707;
			double fTemp787 = 0.03125 * fRec137[0] * (fRec978 + fRec975 + fRec972 + fRec969 + fRec966 + fRec963 + fRec960 + fRec957 + fRec954 + fRec951 + fRec948 + fRec945 + fRec942 + fRec939 + fRec936 + fRec933 + fRec930 + fRec927 + fRec924 + fRec921 + fRec918 + fRec915 + fRec912 + fRec909 + fRec906 + fRec903 + fRec900 + fRec897 + fRec894 + fRec891 + fRec888 + fRec885) + fRec36[0] * fTemp754;
			fRec879[0] = std::max<double>(fConst1 * fRec879[1], std::fabs(fTemp787));
			fVbargraph35 = FAUSTFLOAT(fRec879[0]);
			fRec667[0] = fTemp787;
			double fTemp788 = (fRec667[0] + fRec665[0] + fRec666[0]) / fTemp4;
			fVec17[IOTA0 & 4194303] = fTemp788;
			double fTemp789 = ((fRec979[1] != 0.0) ? (((fRec980[1] > 0.0) & (fRec980[1] < 1.0)) ? fRec979[1] : 0.0) : (((fRec980[1] == 0.0) & (fSlow30 != fRec981[1])) ? 0.0009765625 : (((fRec980[1] == 1.0) & (fSlow30 != fRec982[1])) ? -0.0009765625 : 0.0)));
			fRec979[0] = fTemp789;
			fRec980[0] = std::max<double>(0.0, std::min<double>(1.0, fRec980[1] + fTemp789));
			fRec981[0] = (((fRec980[1] >= 1.0) & (fRec982[1] != fSlow30)) ? fSlow30 : fRec981[1]);
			fRec982[0] = (((fRec980[1] <= 0.0) & (fRec981[1] != fSlow30)) ? fSlow30 : fRec982[1]);
			double fTemp790 = fVec17[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec981[0])))) & 4194303];
			fRec664[0] = 0.3333333333333333 * fTemp790 + fRec980[0] * (0.0 - 0.3333333333333333 * (fTemp790 - fVec17[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec982[0])))) & 4194303]));
			double fTemp791 = fRec26[0] * fRec984[1];
			fRec991[0] = std::max<double>(fConst1 * fRec991[1], std::fabs(fTemp791));
			fVbargraph36 = FAUSTFLOAT(fRec991[0]);
			double fTemp792 = fTemp791;
			double fTemp793 = fRec26[0] * fRec985[1];
			fRec992[0] = std::max<double>(fConst1 * fRec992[1], std::fabs(fTemp793));
			fVbargraph37 = FAUSTFLOAT(fRec992[0]);
			double fTemp794 = fTemp793;
			double fTemp795 = fTemp10 * (fTemp794 - fTemp792);
			double fTemp796 = fSlow31 * fRec11[1];
			fVec18[IOTA0 & 4194303] = fTemp796;
			double fTemp797 = ((fRec994[1] != 0.0) ? (((fRec995[1] > 0.0) & (fRec995[1] < 1.0)) ? fRec994[1] : 0.0) : (((fRec995[1] == 0.0) & (fSlow32 != fRec996[1])) ? 0.0009765625 : (((fRec995[1] == 1.0) & (fSlow32 != fRec997[1])) ? -0.0009765625 : 0.0)));
			fRec994[0] = fTemp797;
			fRec995[0] = std::max<double>(0.0, std::min<double>(1.0, fRec995[1] + fTemp797));
			fRec996[0] = (((fRec995[1] >= 1.0) & (fRec997[1] != fSlow32)) ? fSlow32 : fRec996[1]);
			fRec997[0] = (((fRec995[1] <= 0.0) & (fRec996[1] != fSlow32)) ? fSlow32 : fRec997[1]);
			double fTemp798 = fVec18[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec996[0])))) & 4194303];
			fRec993[0] = fTemp798 + fRec995[0] * (fVec18[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec997[0])))) & 4194303] - fTemp798);
			fVec19[0] = fRec993[1] + fTemp12 + fTemp792 + fTemp795 + fTemp5;
			fRec990[0] = fTemp795 + fRec993[1] + fTemp792 + fTemp12 + 0.995 * fRec990[1] + (1.2 - (fVec0[1] + fVec19[1]));
			fRec989[0] = std::max<double>(fConst1 * fRec989[1], std::fabs(fRec990[0]));
			fVbargraph38 = FAUSTFLOAT(fRec989[0]);
			double fTemp799 = fRec17[0] * tanh(fRec990[0] / fTemp4);
			fRec988[0] = std::max<double>(fConst1 * fRec988[1], std::fabs(fTemp799));
			fVbargraph39 = FAUSTFLOAT(fRec988[0]);
			double fTemp800 = fTemp799;
			fRec1001[0] = fSlow33 + fConst3 * fRec1001[1];
			double fTemp801 = fTemp18 / fRec1001[0];
			double fTemp802 = std::tan(fConst7 * fRec1001[0]);
			double fTemp803 = fTemp802 * (fTemp802 + 0.005076142131979695 * fTemp801) + 1.0;
			double fTemp804 = fTemp802 * (fTemp800 - fRec999[1]) + fRec998[1];
			fRec998[0] = 2.0 * (fTemp804 / fTemp803) - fRec998[1];
			fRec999[0] = fRec999[1] + 2.0 * (fTemp802 * fTemp804 / fTemp803);
			fRec1002[0] = fSlow34 + fConst3 * fRec1002[1];
			fRec1003[0] = fSlow35 + fConst3 * fRec1003[1];
			double fTemp805 = 0.51466542 * fRec1002[0] + fRec1003[0] * (0.51466542 - 1.02933084 * fRec1002[0]) + 0.48533458;
			double fRec1000 = fTemp804 * fTemp805 / fTemp803;
			double fTemp806 = 115.0 * fRec1002[0];
			double fTemp807 = 7.0 * fRec1002[0];
			double fTemp808 = fRec1001[0] * (fTemp807 + fRec1003[0] * (108.0 - fTemp806) + 2096.0);
			double fTemp809 = std::tan(fConst5 * fTemp808);
			double fTemp810 = fTemp809 * (fTemp809 + fTemp18 / fTemp808) + 1.0;
			double fTemp811 = fTemp809 * (fTemp800 - fRec1005[1]) + fRec1004[1];
			fRec1004[0] = 2.0 * (fTemp811 / fTemp810) - fRec1004[1];
			fRec1005[0] = fRec1005[1] + 2.0 * (fTemp809 * fTemp811 / fTemp810);
			double fTemp812 = 0.00492482 * fRec1002[0] + fRec1003[0] * (0.0035387400000000003 - 0.00846356 * fRec1002[0]) + 0.00514822;
			double fRec1006 = fTemp811 * fTemp812 / fTemp810;
			double fTemp813 = fRec1001[0] * (fTemp807 + fRec1003[0] * (106.0 - 113.0 * fRec1002[0]) + 1965.0);
			double fTemp814 = std::tan(fConst5 * fTemp813);
			double fTemp815 = fTemp814 * (fTemp814 + fTemp18 / fTemp813) + 1.0;
			double fTemp816 = fTemp814 * (fTemp800 - fRec1008[1]) + fRec1007[1];
			fRec1007[0] = 2.0 * (fTemp816 / fTemp815) - fRec1007[1];
			fRec1008[0] = fRec1008[1] + 2.0 * (fTemp814 * fTemp816 / fTemp815);
			double fTemp817 = 0.003961 * fRec1002[0] + fRec1003[0] * (0.02133127 - 0.02529227 * fRec1002[0]) + 0.00356349;
			double fRec1009 = fTemp816 * fTemp817 / fTemp815;
			double fTemp818 = 111.0 * fRec1002[0];
			double fTemp819 = 8.0 * fRec1002[0];
			double fTemp820 = fRec1001[0] * (fTemp819 + fRec1003[0] * (103.0 - fTemp818) + 1834.0);
			double fTemp821 = std::tan(fConst5 * fTemp820);
			double fTemp822 = fTemp821 * (fTemp821 + fTemp18 / fTemp820) + 1.0;
			double fTemp823 = fTemp821 * (fTemp800 - fRec1011[1]) + fRec1010[1];
			fRec1010[0] = 2.0 * (fTemp823 / fTemp822) - fRec1010[1];
			fRec1011[0] = fRec1011[1] + 2.0 * (fTemp821 * fTemp823 / fTemp822);
			double fTemp824 = fRec1003[0] * (0.00286025 * fRec1002[0] + -3.855000000000004e-05) + (0.00511717 - 0.0028217 * fRec1002[0]);
			double fRec1012 = fTemp823 * fTemp824 / fTemp822;
			double fTemp825 = fRec1001[0] * (fTemp807 + fRec1003[0] * (101.0 - 108.0 * fRec1002[0]) + 1702.0);
			double fTemp826 = std::tan(fConst5 * fTemp825);
			double fTemp827 = fTemp826 * (fTemp826 + fTemp18 / fTemp825) + 1.0;
			double fTemp828 = fTemp826 * (fTemp800 - fRec1014[1]) + fRec1013[1];
			fRec1013[0] = 2.0 * (fTemp828 / fTemp827) - fRec1013[1];
			fRec1014[0] = fRec1014[1] + 2.0 * (fTemp826 * fTemp828 / fTemp827);
			double fTemp829 = 0.015484530000000002 * fRec1002[0] + fRec1003[0] * (0.00335505 - 0.01883958 * fRec1002[0]) + 0.0048918;
			double fRec1015 = fTemp828 * fTemp829 / fTemp827;
			double fTemp830 = 6.0 * fRec1002[0];
			double fTemp831 = fRec1001[0] * (fTemp830 + fRec1003[0] * (31.0 - 37.0 * fRec1002[0]) + 1572.0);
			double fTemp832 = std::tan(fConst5 * fTemp831);
			double fTemp833 = fTemp832 * (fTemp832 + fTemp18 / fTemp831) + 1.0;
			double fTemp834 = fTemp832 * (fTemp800 - fRec1017[1]) + fRec1016[1];
			fRec1016[0] = 2.0 * (fTemp834 / fTemp833) - fRec1016[1];
			fRec1017[0] = fRec1017[1] + 2.0 * (fTemp832 * fTemp834 / fTemp833);
			double fTemp835 = fRec1003[0] * (0.0007354499999999986 * fRec1002[0] + -0.0006947099999999977) + (0.02091359 - 4.0740000000000914e-05 * fRec1002[0]);
			double fRec1018 = fTemp834 * fTemp835 / fTemp833;
			double fTemp836 = 5.0 * fRec1002[0];
			double fTemp837 = fRec1001[0] * (fTemp836 + fRec1003[0] * (28.0 - 33.0 * fRec1002[0]) + 1441.0);
			double fTemp838 = std::tan(fConst5 * fTemp837);
			double fTemp839 = fTemp838 * (fTemp838 + fTemp18 / fTemp837) + 1.0;
			double fTemp840 = fTemp838 * (fTemp800 - fRec1020[1]) + fRec1019[1];
			fRec1019[0] = 2.0 * (fTemp840 / fTemp839) - fRec1019[1];
			fRec1020[0] = fRec1020[1] + 2.0 * (fTemp838 * fTemp840 / fTemp839);
			double fTemp841 = 0.00404728 * fRec1002[0] + fRec1003[0] * (0.00189104 - 0.00593832 * fRec1002[0]) + 0.00888014;
			double fRec1021 = fTemp840 * fTemp841 / fTemp839;
			double fTemp842 = fRec1001[0] * (fTemp836 + fRec1003[0] * (26.0 - 31.0 * fRec1002[0]) + 1.31e+03);
			double fTemp843 = std::tan(fConst5 * fTemp842);
			double fTemp844 = fTemp843 * (fTemp843 + fTemp18 / fTemp842) + 1.0;
			double fTemp845 = fTemp843 * (fTemp800 - fRec1023[1]) + fRec1022[1];
			fRec1022[0] = 2.0 * (fTemp845 / fTemp844) - fRec1022[1];
			fRec1023[0] = fRec1023[1] + 2.0 * (fTemp843 * fTemp845 / fTemp844);
			double fTemp846 = 0.0227416 * fRec1002[0] + fRec1003[0] * (0.00469608 - 0.02743768 * fRec1002[0]) + 0.01193177;
			double fRec1024 = fTemp845 * fTemp846 / fTemp844;
			double fTemp847 = fRec1001[0] * (fTemp836 + fRec1003[0] * (15.0 - 2e+01 * fRec1002[0]) + 1178.0);
			double fTemp848 = std::tan(fConst5 * fTemp847);
			double fTemp849 = fTemp848 * (fTemp848 + fTemp18 / fTemp847) + 1.0;
			double fTemp850 = fTemp848 * (fTemp800 - fRec1026[1]) + fRec1025[1];
			fRec1025[0] = 2.0 * (fTemp850 / fTemp849) - fRec1025[1];
			fRec1026[0] = fRec1026[1] + 2.0 * (fTemp848 * fTemp850 / fTemp849);
			double fTemp851 = fRec1003[0] * (0.004585809999999999 - 0.0018878599999999982 * fRec1002[0]) + (0.01707981 - 0.002697950000000001 * fRec1002[0]);
			double fRec1027 = fTemp850 * fTemp851 / fTemp849;
			double fTemp852 = fRec1001[0] * (fTemp836 + fRec1003[0] * (22.0 - 27.0 * fRec1002[0]) + 1047.0);
			double fTemp853 = std::tan(fConst5 * fTemp852);
			double fTemp854 = fTemp853 * (fTemp853 + fTemp18 / fTemp852) + 1.0;
			double fTemp855 = fTemp853 * (fTemp800 - fRec1029[1]) + fRec1028[1];
			fRec1028[0] = 2.0 * (fTemp855 / fTemp854) - fRec1028[1];
			fRec1029[0] = fRec1029[1] + 2.0 * (fTemp853 * fTemp855 / fTemp854);
			double fTemp856 = 0.01049454 * fRec1002[0] + fRec1003[0] * (0.022906150000000004 - 0.033400690000000004 * fRec1002[0]) + 0.02127434;
			double fRec1030 = fTemp855 * fTemp856 / fTemp854;
			double fTemp857 = 3.0 * fRec1002[0];
			double fTemp858 = fRec1001[0] * (fTemp857 + fRec1003[0] * (1e+01 - 13.0 * fRec1002[0]) + 917.0);
			double fTemp859 = std::tan(fConst5 * fTemp858);
			double fTemp860 = fTemp859 * (fTemp859 + fTemp18 / fTemp858) + 1.0;
			double fTemp861 = fTemp859 * (fTemp800 - fRec1032[1]) + fRec1031[1];
			fRec1031[0] = 2.0 * (fTemp861 / fTemp860) - fRec1031[1];
			fRec1032[0] = fRec1032[1] + 2.0 * (fTemp859 * fTemp861 / fTemp860);
			double fTemp862 = fRec1003[0] * (0.11867802000000001 * fRec1002[0] + -0.06216229000000001) + (0.08372042 - 0.05651573 * fRec1002[0]);
			double fRec1033 = fTemp861 * fTemp862 / fTemp860;
			double fTemp863 = fRec1001[0] * (fTemp857 + fRec1003[0] * (15.0 - 18.0 * fRec1002[0]) + 786.0);
			double fTemp864 = std::tan(fConst5 * fTemp863);
			double fTemp865 = fTemp864 * (fTemp864 + fTemp18 / fTemp863) + 1.0;
			double fTemp866 = fTemp864 * (fTemp800 - fRec1035[1]) + fRec1034[1];
			fRec1034[0] = 2.0 * (fTemp866 / fTemp865) - fRec1034[1];
			fRec1035[0] = fRec1035[1] + 2.0 * (fTemp864 * fTemp866 / fTemp865);
			double fTemp867 = 0.007078770000000002 * fRec1002[0] + fRec1003[0] * (0.0313596 - 0.03843837 * fRec1002[0]) + 0.02810959;
			double fRec1036 = fTemp866 * fTemp867 / fTemp865;
			double fTemp868 = 2.0 * fRec1002[0];
			double fTemp869 = fRec1001[0] * (fTemp868 + fRec1003[0] * (13.0 - 15.0 * fRec1002[0]) + 655.0);
			double fTemp870 = std::tan(fConst5 * fTemp869);
			double fTemp871 = fTemp870 * (fTemp870 + fTemp18 / fTemp869) + 1.0;
			double fTemp872 = fTemp870 * (fTemp800 - fRec1038[1]) + fRec1037[1];
			fRec1037[0] = 2.0 * (fTemp872 / fTemp871) - fRec1037[1];
			fRec1038[0] = fRec1038[1] + 2.0 * (fTemp870 * fTemp872 / fTemp871);
			double fTemp873 = 0.039912470000000005 * fRec1002[0] + fRec1003[0] * (0.005417789999999992 - 0.04533026 * fRec1002[0]) + 0.10262931;
			double fRec1039 = fTemp872 * fTemp873 / fTemp871;
			double fTemp874 = fTemp868 + fRec1003[0] * (1e+01 - 12.0 * fRec1002[0]);
			double fTemp875 = fRec1001[0] * (fTemp874 + 524.0);
			double fTemp876 = std::tan(fConst5 * fTemp875);
			double fTemp877 = fTemp876 * (fTemp876 + fTemp18 / fTemp875) + 1.0;
			double fTemp878 = fTemp876 * (fTemp800 - fRec1041[1]) + fRec1040[1];
			fRec1040[0] = 2.0 * (fTemp878 / fTemp877) - fRec1040[1];
			fRec1041[0] = fRec1041[1] + 2.0 * (fTemp876 * fTemp878 / fTemp877);
			double fTemp879 = 0.16088293999999997 * fRec1002[0] + fRec1003[0] * (-0.06794681000000001 - 0.09293612999999996 * fRec1002[0]) + 0.15710983;
			double fRec1042 = fTemp878 * fTemp879 / fTemp877;
			double fTemp880 = fRec1001[0] * (fRec1002[0] + fRec1003[0] * (5.0 - fTemp830) + 393.0);
			double fTemp881 = std::tan(fConst5 * fTemp880);
			double fTemp882 = fTemp881 * (fTemp881 + fTemp18 / fTemp880) + 1.0;
			double fTemp883 = fTemp881 * (fTemp800 - fRec1044[1]) + fRec1043[1];
			fRec1043[0] = 2.0 * (fTemp883 / fTemp882) - fRec1043[1];
			fRec1044[0] = fRec1044[1] + 2.0 * (fTemp881 * fTemp883 / fTemp882);
			double fTemp884 = 0.52347231 * fRec1002[0] + fRec1003[0] * (-0.11388923 - 0.40958308000000004 * fRec1002[0]) + 0.20074493;
			double fRec1045 = fTemp883 * fTemp884 / fTemp882;
			double fTemp885 = fRec1001[0] * (fRec1002[0] + fRec1003[0] * (4.0 - fTemp836) + 262.0);
			double fTemp886 = std::tan(fConst5 * fTemp885);
			double fTemp887 = fTemp886 * (fTemp886 + fTemp18 / fTemp885) + 1.0;
			double fTemp888 = fTemp886 * (fTemp800 - fRec1047[1]) + fRec1046[1];
			fRec1046[0] = 2.0 * (fTemp888 / fTemp887) - fRec1046[1];
			fRec1047[0] = fRec1047[1] + 2.0 * (fTemp886 * fTemp888 / fTemp887);
			double fTemp889 = 0.02997270000000002 * fRec1002[0] + fRec1003[0] * (0.13487834999999998 * fRec1002[0] + -0.16485105) + 0.29825361;
			double fRec1048 = fTemp888 * fTemp889 / fTemp887;
			double fTemp890 = std::tan(fConst8 * fRec1001[0]);
			double fTemp891 = fTemp890 * (fTemp890 + 0.007633587786259542 * fTemp801) + 1.0;
			double fTemp892 = fTemp890 * (fTemp800 - fRec1050[1]) + fRec1049[1];
			fRec1049[0] = 2.0 * (fTemp892 / fTemp891) - fRec1049[1];
			fRec1050[0] = fRec1050[1] + 2.0 * (fTemp890 * fTemp892 / fTemp891);
			double fTemp893 = fRec1003[0] * (0.6123959999999999 * fRec1002[0] + -0.41317138) + (1.0 - 0.19922461999999996 * fRec1002[0]);
			double fRec1051 = fTemp892 * fTemp893 / fTemp891;
			double fTemp894 = fRec1001[0] * (fTemp868 + fRec1003[0] * (6.0 - fTemp819) + 327.0);
			double fTemp895 = std::tan(fConst5 * fTemp894);
			double fTemp896 = fTemp895 * (fTemp895 + fTemp18 / fTemp894) + 1.0;
			double fTemp897 = fTemp895 * (fTemp800 - fRec1053[1]) + fRec1052[1];
			fRec1052[0] = 2.0 * (fTemp897 / fTemp896) - fRec1052[1];
			fRec1053[0] = fRec1053[1] + 2.0 * (fTemp895 * fTemp897 / fTemp896);
			double fTemp898 = 0.07501773 * fRec1002[0] + fRec1003[0] * (-0.04893692999999999 - 0.026080800000000015 * fRec1002[0]) + 0.24961559;
			double fRec1054 = fTemp897 * fTemp898 / fTemp896;
			double fTemp899 = fRec1001[0] * (fTemp874 + 458.0);
			double fTemp900 = std::tan(fConst5 * fTemp899);
			double fTemp901 = fTemp900 * (fTemp900 + fTemp18 / fTemp899) + 1.0;
			double fTemp902 = fTemp900 * (fTemp800 - fRec1056[1]) + fRec1055[1];
			fRec1055[0] = 2.0 * (fTemp902 / fTemp901) - fRec1055[1];
			fRec1056[0] = fRec1056[1] + 2.0 * (fTemp900 * fTemp902 / fTemp901);
			double fTemp903 = 0.031150369999999983 * fRec1002[0] + fRec1003[0] * (0.03386702 - 0.06501738999999998 * fRec1002[0]) + 0.1571452;
			double fRec1057 = fTemp902 * fTemp903 / fTemp901;
			double fTemp904 = fRec1001[0] * (fTemp868 + fRec1003[0] * (12.0 - 14.0 * fRec1002[0]) + 589.0);
			double fTemp905 = std::tan(fConst5 * fTemp904);
			double fTemp906 = fTemp905 * (fTemp905 + fTemp18 / fTemp904) + 1.0;
			double fTemp907 = fTemp905 * (fTemp800 - fRec1059[1]) + fRec1058[1];
			fRec1058[0] = 2.0 * (fTemp907 / fTemp906) - fRec1058[1];
			fRec1059[0] = fRec1059[1] + 2.0 * (fTemp905 * fTemp907 / fTemp906);
			double fTemp908 = fRec1003[0] * (0.15122519 * fRec1002[0] + -0.08735081) + (0.20902308 - 0.06387438000000001 * fRec1002[0]);
			double fRec1060 = fTemp907 * fTemp908 / fTemp906;
			double fTemp909 = fRec1001[0] * (fTemp857 + fRec1003[0] * (14.0 - 17.0 * fRec1002[0]) + 7.2e+02);
			double fTemp910 = std::tan(fConst5 * fTemp909);
			double fTemp911 = fTemp910 * (fTemp910 + fTemp18 / fTemp909) + 1.0;
			double fTemp912 = fTemp910 * (fTemp800 - fRec1062[1]) + fRec1061[1];
			fRec1061[0] = 2.0 * (fTemp912 / fTemp911) - fRec1061[1];
			fRec1062[0] = fRec1062[1] + 2.0 * (fTemp910 * fTemp912 / fTemp911);
			double fTemp913 = 0.006377540000000001 * fRec1002[0] + fRec1003[0] * (0.03603802 * fRec1002[0] + -0.04241556) + 0.07819993;
			double fRec1063 = fTemp912 * fTemp913 / fTemp911;
			double fTemp914 = 4.0 * fRec1002[0];
			double fTemp915 = fRec1001[0] * (fTemp914 + fRec1003[0] * (17.0 - 21.0 * fRec1002[0]) + 851.0);
			double fTemp916 = std::tan(fConst5 * fTemp915);
			double fTemp917 = fTemp916 * (fTemp916 + fTemp18 / fTemp915) + 1.0;
			double fTemp918 = fTemp916 * (fTemp800 - fRec1065[1]) + fRec1064[1];
			fRec1064[0] = 2.0 * (fTemp918 / fTemp917) - fRec1064[1];
			fRec1065[0] = fRec1065[1] + 2.0 * (fTemp916 * fTemp918 / fTemp917);
			double fTemp919 = 0.043723639999999994 * fRec1002[0] + fRec1003[0] * (-0.00032270000000000215 - 0.04340093999999999 * fRec1002[0]) + 0.03754288;
			double fRec1066 = fTemp918 * fTemp919 / fTemp917;
			double fTemp920 = fRec1001[0] * (fTemp914 + fRec1003[0] * (19.0 - 23.0 * fRec1002[0]) + 982.0);
			double fTemp921 = std::tan(fConst5 * fTemp920);
			double fTemp922 = fTemp921 * (fTemp921 + fTemp18 / fTemp920) + 1.0;
			double fTemp923 = fTemp921 * (fTemp800 - fRec1068[1]) + fRec1067[1];
			fRec1067[0] = 2.0 * (fTemp923 / fTemp922) - fRec1067[1];
			fRec1068[0] = fRec1068[1] + 2.0 * (fTemp921 * fTemp923 / fTemp922);
			double fTemp924 = 0.022372620000000003 * fRec1002[0] + fRec1003[0] * (0.029409400000000002 - 0.051782020000000005 * fRec1002[0]) + 0.00927965;
			double fRec1069 = fTemp923 * fTemp924 / fTemp922;
			double fTemp925 = fRec1001[0] * (fTemp914 + fRec1003[0] * (22.0 - 26.0 * fRec1002[0]) + 1113.0);
			double fTemp926 = std::tan(fConst5 * fTemp925);
			double fTemp927 = fTemp926 * (fTemp926 + fTemp18 / fTemp925) + 1.0;
			double fTemp928 = fTemp926 * (fTemp800 - fRec1071[1]) + fRec1070[1];
			fRec1070[0] = 2.0 * (fTemp928 / fTemp927) - fRec1070[1];
			fRec1071[0] = fRec1071[1] + 2.0 * (fTemp926 * fTemp928 / fTemp927);
			double fTemp929 = 0.01651215 * fRec1002[0] + fRec1003[0] * (0.004918780000000001 - 0.02143093 * fRec1002[0]) + 0.02702054;
			double fRec1072 = fTemp928 * fTemp929 / fTemp927;
			double fTemp930 = fRec1001[0] * (fTemp836 + fRec1003[0] * (25.0 - 3e+01 * fRec1002[0]) + 1244.0);
			double fTemp931 = std::tan(fConst5 * fTemp930);
			double fTemp932 = fTemp931 * (fTemp931 + fTemp18 / fTemp930) + 1.0;
			double fTemp933 = fTemp931 * (fTemp800 - fRec1074[1]) + fRec1073[1];
			fRec1073[0] = 2.0 * (fTemp933 / fTemp932) - fRec1073[1];
			fRec1074[0] = fRec1074[1] + 2.0 * (fTemp931 * fTemp933 / fTemp932);
			double fTemp934 = fRec1003[0] * (0.009495489999999999 - 0.006188469999999999 * fRec1002[0]) + (0.01010378 - 0.00330702 * fRec1002[0]);
			double fRec1075 = fTemp933 * fTemp934 / fTemp932;
			double fTemp935 = fRec1001[0] * (fTemp836 + fRec1003[0] * (27.0 - 32.0 * fRec1002[0]) + 1375.0);
			double fTemp936 = std::tan(fConst5 * fTemp935);
			double fTemp937 = fTemp936 * (fTemp936 + fTemp18 / fTemp935) + 1.0;
			double fTemp938 = fTemp936 * (fTemp800 - fRec1077[1]) + fRec1076[1];
			fRec1076[0] = 2.0 * (fTemp938 / fTemp937) - fRec1076[1];
			fRec1077[0] = fRec1077[1] + 2.0 * (fTemp936 * fTemp938 / fTemp937);
			double fTemp939 = fRec1003[0] * (0.0277721 - 0.025426740000000003 * fRec1002[0]) + (0.00929211 - 0.0023453599999999995 * fRec1002[0]);
			double fRec1078 = fTemp938 * fTemp939 / fTemp937;
			double fTemp940 = fRec1001[0] * (fTemp830 + fRec1003[0] * (3e+01 - 36.0 * fRec1002[0]) + 1506.0);
			double fTemp941 = std::tan(fConst5 * fTemp940);
			double fTemp942 = fTemp941 * (fTemp941 + fTemp18 / fTemp940) + 1.0;
			double fTemp943 = fTemp941 * (fTemp800 - fRec1080[1]) + fRec1079[1];
			fRec1079[0] = 2.0 * (fTemp943 / fTemp942) - fRec1079[1];
			fRec1080[0] = fRec1080[1] + 2.0 * (fTemp941 * fTemp943 / fTemp942);
			double fTemp944 = 0.01661545 * fRec1002[0] + fRec1003[0] * (0.023741299999999996 - 0.04035675 * fRec1002[0]) + 0.00940227;
			double fRec1081 = fTemp943 * fTemp944 / fTemp942;
			double fTemp945 = fRec1001[0] * (fTemp830 + fRec1003[0] * (33.0 - 39.0 * fRec1002[0]) + 1637.0);
			double fTemp946 = std::tan(fConst5 * fTemp945);
			double fTemp947 = fTemp946 * (fTemp946 + fTemp18 / fTemp945) + 1.0;
			double fTemp948 = fTemp946 * (fTemp800 - fRec1083[1]) + fRec1082[1];
			fRec1082[0] = 2.0 * (fTemp948 / fTemp947) - fRec1082[1];
			fRec1083[0] = fRec1083[1] + 2.0 * (fTemp946 * fTemp948 / fTemp947);
			double fTemp949 = 0.005929820000000001 * fRec1002[0] + fRec1003[0] * (0.00200935 - 0.00793917 * fRec1002[0]) + 0.00459008;
			double fRec1084 = fTemp948 * fTemp949 / fTemp947;
			double fTemp950 = fRec1001[0] * (fTemp807 + fRec1003[0] * (102.0 - 109.0 * fRec1002[0]) + 1768.0);
			double fTemp951 = std::tan(fConst5 * fTemp950);
			double fTemp952 = fTemp951 * (fTemp951 + fTemp18 / fTemp950) + 1.0;
			double fTemp953 = fTemp951 * (fTemp800 - fRec1086[1]) + fRec1085[1];
			fRec1085[0] = 2.0 * (fTemp953 / fTemp952) - fRec1085[1];
			fRec1086[0] = fRec1086[1] + 2.0 * (fTemp951 * fTemp953 / fTemp952);
			double fTemp954 = 0.005757190000000001 * fRec1002[0] + fRec1003[0] * (-0.0044776 - 0.0012795900000000006 * fRec1002[0]) + 0.00941733;
			double fRec1087 = fTemp953 * fTemp954 / fTemp952;
			double fTemp955 = fRec1001[0] * (fTemp807 + fRec1003[0] * (104.0 - fTemp818) + 1899.0);
			double fTemp956 = std::tan(fConst5 * fTemp955);
			double fTemp957 = fTemp956 * (fTemp956 + fTemp18 / fTemp955) + 1.0;
			double fTemp958 = fTemp956 * (fTemp800 - fRec1089[1]) + fRec1088[1];
			fRec1088[0] = 2.0 * (fTemp958 / fTemp957) - fRec1088[1];
			fRec1089[0] = fRec1089[1] + 2.0 * (fTemp956 * fTemp958 / fTemp957);
			double fTemp959 = 0.00223778 * fRec1002[0] + fRec1003[0] * (0.003461960000000001 - 0.005699740000000001 * fRec1002[0]) + 0.00503596;
			double fRec1090 = fTemp958 * fTemp959 / fTemp957;
			double fTemp960 = fRec1001[0] * (fTemp819 + fRec1003[0] * (107.0 - fTemp806) + 2.03e+03);
			double fTemp961 = std::tan(fConst5 * fTemp960);
			double fTemp962 = fTemp961 * (fTemp961 + fTemp18 / fTemp960) + 1.0;
			double fTemp963 = fTemp961 * (fTemp800 - fRec1092[1]) + fRec1091[1];
			fRec1091[0] = 2.0 * (fTemp963 / fTemp962) - fRec1091[1];
			fRec1092[0] = fRec1092[1] + 2.0 * (fTemp961 * fTemp963 / fTemp962);
			double fTemp964 = 0.0033720900000000003 * fRec1002[0] + fRec1003[0] * (0.007210579999999999 - 0.010582669999999999 * fRec1002[0]) + 0.00223048;
			double fRec1093 = fTemp963 * fTemp964 / fTemp962;
			double fTemp965 = fRec1001[0] * (fTemp807 + fRec1003[0] * (109.0 - 116.0 * fRec1002[0]) + 2162.0);
			double fTemp966 = std::tan(fConst5 * fTemp965);
			double fTemp967 = fTemp966 * (fTemp966 + fTemp18 / fTemp965) + 1.0;
			double fTemp968 = fTemp966 * (fTemp800 - fRec1095[1]) + fRec1094[1];
			fRec1094[0] = 2.0 * (fTemp968 / fTemp967) - fRec1094[1];
			fRec1095[0] = fRec1095[1] + 2.0 * (fTemp966 * fTemp968 / fTemp967);
			double fTemp969 = 0.01214753 * fRec1002[0] + fRec1003[0] * (0.005874650000000001 - 0.018022180000000002 * fRec1002[0]) + 0.00459407;
			double fRec1096 = fTemp968 * fTemp969 / fTemp967;
			double fTemp970 = 0.03125 * fRec137[0] * (fRec1096 + fRec1093 + fRec1090 + fRec1087 + fRec1084 + fRec1081 + fRec1078 + fRec1075 + fRec1072 + fRec1069 + fRec1066 + fRec1063 + fRec1060 + fRec1057 + fRec1054 + fRec1051 + fRec1048 + fRec1045 + fRec1042 + fRec1039 + fRec1036 + fRec1033 + fRec1030 + fRec1027 + fRec1024 + fRec1021 + fRec1018 + fRec1015 + fRec1012 + fRec1009 + fRec1006 + fRec1000) + fRec36[0] * fTemp800;
			fRec987[0] = std::max<double>(fConst1 * fRec987[1], std::fabs(fTemp970));
			fVbargraph40 = FAUSTFLOAT(fRec987[0]);
			fRec984[0] = fTemp970;
			double fTemp971 = fRec26[0] * fRec986[1];
			fRec1101[0] = std::max<double>(fConst1 * fRec1101[1], std::fabs(fTemp971));
			fVbargraph41 = FAUSTFLOAT(fRec1101[0]);
			double fTemp972 = fTemp971;
			double fTemp973 = fRec28[0] * (fTemp792 * (fRec143[0] - fTemp972) - fTemp794);
			double fTemp974 = fTemp12 + fRec993[1];
			double fTemp975 = fTemp974 + fTemp794;
			fVec20[0] = fTemp975 + fTemp973 + fTemp189;
			fRec1100[0] = fTemp973 + 0.995 * fRec1100[1] + fTemp975 + (1.3 - (fVec3[1] + fVec20[1]));
			fRec1099[0] = std::max<double>(fConst1 * fRec1099[1], std::fabs(fRec1100[0]));
			fVbargraph42 = FAUSTFLOAT(fRec1099[0]);
			double fTemp976 = fRec17[0] * tanh(fRec1100[0] / fTemp4);
			fRec1098[0] = std::max<double>(fConst1 * fRec1098[1], std::fabs(fTemp976));
			fVbargraph43 = FAUSTFLOAT(fRec1098[0]);
			double fTemp977 = fTemp976;
			double fTemp978 = fTemp802 * (fTemp977 - fRec1103[1]) + fRec1102[1];
			fRec1102[0] = 2.0 * (fTemp978 / fTemp803) - fRec1102[1];
			fRec1103[0] = fRec1103[1] + 2.0 * (fTemp802 * fTemp978 / fTemp803);
			double fRec1104 = fTemp805 * fTemp978 / fTemp803;
			double fTemp979 = fTemp809 * (fTemp977 - fRec1106[1]) + fRec1105[1];
			fRec1105[0] = 2.0 * (fTemp979 / fTemp810) - fRec1105[1];
			fRec1106[0] = fRec1106[1] + 2.0 * (fTemp809 * fTemp979 / fTemp810);
			double fRec1107 = fTemp812 * fTemp979 / fTemp810;
			double fTemp980 = fTemp814 * (fTemp977 - fRec1109[1]) + fRec1108[1];
			fRec1108[0] = 2.0 * (fTemp980 / fTemp815) - fRec1108[1];
			fRec1109[0] = fRec1109[1] + 2.0 * (fTemp814 * fTemp980 / fTemp815);
			double fRec1110 = fTemp817 * fTemp980 / fTemp815;
			double fTemp981 = fTemp821 * (fTemp977 - fRec1112[1]) + fRec1111[1];
			fRec1111[0] = 2.0 * (fTemp981 / fTemp822) - fRec1111[1];
			fRec1112[0] = fRec1112[1] + 2.0 * (fTemp821 * fTemp981 / fTemp822);
			double fRec1113 = fTemp824 * fTemp981 / fTemp822;
			double fTemp982 = fTemp826 * (fTemp977 - fRec1115[1]) + fRec1114[1];
			fRec1114[0] = 2.0 * (fTemp982 / fTemp827) - fRec1114[1];
			fRec1115[0] = fRec1115[1] + 2.0 * (fTemp826 * fTemp982 / fTemp827);
			double fRec1116 = fTemp829 * fTemp982 / fTemp827;
			double fTemp983 = fTemp832 * (fTemp977 - fRec1118[1]) + fRec1117[1];
			fRec1117[0] = 2.0 * (fTemp983 / fTemp833) - fRec1117[1];
			fRec1118[0] = fRec1118[1] + 2.0 * (fTemp832 * fTemp983 / fTemp833);
			double fRec1119 = fTemp835 * fTemp983 / fTemp833;
			double fTemp984 = fTemp838 * (fTemp977 - fRec1121[1]) + fRec1120[1];
			fRec1120[0] = 2.0 * (fTemp984 / fTemp839) - fRec1120[1];
			fRec1121[0] = fRec1121[1] + 2.0 * (fTemp838 * fTemp984 / fTemp839);
			double fRec1122 = fTemp841 * fTemp984 / fTemp839;
			double fTemp985 = fTemp843 * (fTemp977 - fRec1124[1]) + fRec1123[1];
			fRec1123[0] = 2.0 * (fTemp985 / fTemp844) - fRec1123[1];
			fRec1124[0] = fRec1124[1] + 2.0 * (fTemp843 * fTemp985 / fTemp844);
			double fRec1125 = fTemp846 * fTemp985 / fTemp844;
			double fTemp986 = fTemp848 * (fTemp977 - fRec1127[1]) + fRec1126[1];
			fRec1126[0] = 2.0 * (fTemp986 / fTemp849) - fRec1126[1];
			fRec1127[0] = fRec1127[1] + 2.0 * (fTemp848 * fTemp986 / fTemp849);
			double fRec1128 = fTemp851 * fTemp986 / fTemp849;
			double fTemp987 = fTemp853 * (fTemp977 - fRec1130[1]) + fRec1129[1];
			fRec1129[0] = 2.0 * (fTemp987 / fTemp854) - fRec1129[1];
			fRec1130[0] = fRec1130[1] + 2.0 * (fTemp853 * fTemp987 / fTemp854);
			double fRec1131 = fTemp856 * fTemp987 / fTemp854;
			double fTemp988 = fTemp859 * (fTemp977 - fRec1133[1]) + fRec1132[1];
			fRec1132[0] = 2.0 * (fTemp988 / fTemp860) - fRec1132[1];
			fRec1133[0] = fRec1133[1] + 2.0 * (fTemp859 * fTemp988 / fTemp860);
			double fRec1134 = fTemp862 * fTemp988 / fTemp860;
			double fTemp989 = fTemp864 * (fTemp977 - fRec1136[1]) + fRec1135[1];
			fRec1135[0] = 2.0 * (fTemp989 / fTemp865) - fRec1135[1];
			fRec1136[0] = fRec1136[1] + 2.0 * (fTemp864 * fTemp989 / fTemp865);
			double fRec1137 = fTemp867 * fTemp989 / fTemp865;
			double fTemp990 = fTemp870 * (fTemp977 - fRec1139[1]) + fRec1138[1];
			fRec1138[0] = 2.0 * (fTemp990 / fTemp871) - fRec1138[1];
			fRec1139[0] = fRec1139[1] + 2.0 * (fTemp870 * fTemp990 / fTemp871);
			double fRec1140 = fTemp873 * fTemp990 / fTemp871;
			double fTemp991 = fTemp876 * (fTemp977 - fRec1142[1]) + fRec1141[1];
			fRec1141[0] = 2.0 * (fTemp991 / fTemp877) - fRec1141[1];
			fRec1142[0] = fRec1142[1] + 2.0 * (fTemp876 * fTemp991 / fTemp877);
			double fRec1143 = fTemp879 * fTemp991 / fTemp877;
			double fTemp992 = fTemp881 * (fTemp977 - fRec1145[1]) + fRec1144[1];
			fRec1144[0] = 2.0 * (fTemp992 / fTemp882) - fRec1144[1];
			fRec1145[0] = fRec1145[1] + 2.0 * (fTemp881 * fTemp992 / fTemp882);
			double fRec1146 = fTemp884 * fTemp992 / fTemp882;
			double fTemp993 = fTemp886 * (fTemp977 - fRec1148[1]) + fRec1147[1];
			fRec1147[0] = 2.0 * (fTemp993 / fTemp887) - fRec1147[1];
			fRec1148[0] = fRec1148[1] + 2.0 * (fTemp886 * fTemp993 / fTemp887);
			double fRec1149 = fTemp889 * fTemp993 / fTemp887;
			double fTemp994 = fTemp890 * (fTemp977 - fRec1151[1]) + fRec1150[1];
			fRec1150[0] = 2.0 * (fTemp994 / fTemp891) - fRec1150[1];
			fRec1151[0] = fRec1151[1] + 2.0 * (fTemp890 * fTemp994 / fTemp891);
			double fRec1152 = fTemp893 * fTemp994 / fTemp891;
			double fTemp995 = fTemp895 * (fTemp977 - fRec1154[1]) + fRec1153[1];
			fRec1153[0] = 2.0 * (fTemp995 / fTemp896) - fRec1153[1];
			fRec1154[0] = fRec1154[1] + 2.0 * (fTemp895 * fTemp995 / fTemp896);
			double fRec1155 = fTemp898 * fTemp995 / fTemp896;
			double fTemp996 = fTemp900 * (fTemp977 - fRec1157[1]) + fRec1156[1];
			fRec1156[0] = 2.0 * (fTemp996 / fTemp901) - fRec1156[1];
			fRec1157[0] = fRec1157[1] + 2.0 * (fTemp900 * fTemp996 / fTemp901);
			double fRec1158 = fTemp903 * fTemp996 / fTemp901;
			double fTemp997 = fTemp905 * (fTemp977 - fRec1160[1]) + fRec1159[1];
			fRec1159[0] = 2.0 * (fTemp997 / fTemp906) - fRec1159[1];
			fRec1160[0] = fRec1160[1] + 2.0 * (fTemp905 * fTemp997 / fTemp906);
			double fRec1161 = fTemp908 * fTemp997 / fTemp906;
			double fTemp998 = fTemp910 * (fTemp977 - fRec1163[1]) + fRec1162[1];
			fRec1162[0] = 2.0 * (fTemp998 / fTemp911) - fRec1162[1];
			fRec1163[0] = fRec1163[1] + 2.0 * (fTemp910 * fTemp998 / fTemp911);
			double fRec1164 = fTemp913 * fTemp998 / fTemp911;
			double fTemp999 = fTemp916 * (fTemp977 - fRec1166[1]) + fRec1165[1];
			fRec1165[0] = 2.0 * (fTemp999 / fTemp917) - fRec1165[1];
			fRec1166[0] = fRec1166[1] + 2.0 * (fTemp916 * fTemp999 / fTemp917);
			double fRec1167 = fTemp919 * fTemp999 / fTemp917;
			double fTemp1000 = fTemp921 * (fTemp977 - fRec1169[1]) + fRec1168[1];
			fRec1168[0] = 2.0 * (fTemp1000 / fTemp922) - fRec1168[1];
			fRec1169[0] = fRec1169[1] + 2.0 * (fTemp921 * fTemp1000 / fTemp922);
			double fRec1170 = fTemp924 * fTemp1000 / fTemp922;
			double fTemp1001 = fTemp926 * (fTemp977 - fRec1172[1]) + fRec1171[1];
			fRec1171[0] = 2.0 * (fTemp1001 / fTemp927) - fRec1171[1];
			fRec1172[0] = fRec1172[1] + 2.0 * (fTemp926 * fTemp1001 / fTemp927);
			double fRec1173 = fTemp929 * fTemp1001 / fTemp927;
			double fTemp1002 = fTemp931 * (fTemp977 - fRec1175[1]) + fRec1174[1];
			fRec1174[0] = 2.0 * (fTemp1002 / fTemp932) - fRec1174[1];
			fRec1175[0] = fRec1175[1] + 2.0 * (fTemp931 * fTemp1002 / fTemp932);
			double fRec1176 = fTemp934 * fTemp1002 / fTemp932;
			double fTemp1003 = fTemp936 * (fTemp977 - fRec1178[1]) + fRec1177[1];
			fRec1177[0] = 2.0 * (fTemp1003 / fTemp937) - fRec1177[1];
			fRec1178[0] = fRec1178[1] + 2.0 * (fTemp936 * fTemp1003 / fTemp937);
			double fRec1179 = fTemp939 * fTemp1003 / fTemp937;
			double fTemp1004 = fTemp941 * (fTemp977 - fRec1181[1]) + fRec1180[1];
			fRec1180[0] = 2.0 * (fTemp1004 / fTemp942) - fRec1180[1];
			fRec1181[0] = fRec1181[1] + 2.0 * (fTemp941 * fTemp1004 / fTemp942);
			double fRec1182 = fTemp944 * fTemp1004 / fTemp942;
			double fTemp1005 = fTemp946 * (fTemp977 - fRec1184[1]) + fRec1183[1];
			fRec1183[0] = 2.0 * (fTemp1005 / fTemp947) - fRec1183[1];
			fRec1184[0] = fRec1184[1] + 2.0 * (fTemp946 * fTemp1005 / fTemp947);
			double fRec1185 = fTemp949 * fTemp1005 / fTemp947;
			double fTemp1006 = fTemp951 * (fTemp977 - fRec1187[1]) + fRec1186[1];
			fRec1186[0] = 2.0 * (fTemp1006 / fTemp952) - fRec1186[1];
			fRec1187[0] = fRec1187[1] + 2.0 * (fTemp951 * fTemp1006 / fTemp952);
			double fRec1188 = fTemp954 * fTemp1006 / fTemp952;
			double fTemp1007 = fTemp956 * (fTemp977 - fRec1190[1]) + fRec1189[1];
			fRec1189[0] = 2.0 * (fTemp1007 / fTemp957) - fRec1189[1];
			fRec1190[0] = fRec1190[1] + 2.0 * (fTemp956 * fTemp1007 / fTemp957);
			double fRec1191 = fTemp959 * fTemp1007 / fTemp957;
			double fTemp1008 = fTemp961 * (fTemp977 - fRec1193[1]) + fRec1192[1];
			fRec1192[0] = 2.0 * (fTemp1008 / fTemp962) - fRec1192[1];
			fRec1193[0] = fRec1193[1] + 2.0 * (fTemp961 * fTemp1008 / fTemp962);
			double fRec1194 = fTemp964 * fTemp1008 / fTemp962;
			double fTemp1009 = fTemp966 * (fTemp977 - fRec1196[1]) + fRec1195[1];
			fRec1195[0] = 2.0 * (fTemp1009 / fTemp967) - fRec1195[1];
			fRec1196[0] = fRec1196[1] + 2.0 * (fTemp966 * fTemp1009 / fTemp967);
			double fRec1197 = fTemp969 * fTemp1009 / fTemp967;
			double fTemp1010 = 0.03125 * fRec137[0] * (fRec1197 + fRec1194 + fRec1191 + fRec1188 + fRec1185 + fRec1182 + fRec1179 + fRec1176 + fRec1173 + fRec1170 + fRec1167 + fRec1164 + fRec1161 + fRec1158 + fRec1155 + fRec1152 + fRec1149 + fRec1146 + fRec1143 + fRec1140 + fRec1137 + fRec1134 + fRec1131 + fRec1128 + fRec1125 + fRec1122 + fRec1119 + fRec1116 + fRec1113 + fRec1110 + fRec1107 + fRec1104) + fRec36[0] * fTemp977;
			fRec1097[0] = std::max<double>(fConst1 * fRec1097[1], std::fabs(fTemp1010));
			fVbargraph44 = FAUSTFLOAT(fRec1097[0]);
			fRec985[0] = fTemp1010;
			double fTemp1011 = fRec28[0] * (fTemp792 * fTemp794 - fRec244[0] * fTemp972);
			double fTemp1012 = fTemp974 + fTemp972;
			fVec21[0] = fTemp1012 + fTemp1011 + fTemp230;
			fRec1201[0] = fTemp1011 + 0.995 * fRec1201[1] + fTemp1012 + (1.6 - (fVec5[1] + fVec21[1]));
			fRec1200[0] = std::max<double>(fConst1 * fRec1200[1], std::fabs(fRec1201[0]));
			fVbargraph45 = FAUSTFLOAT(fRec1200[0]);
			double fTemp1013 = fRec17[0] * tanh(fRec1201[0] / fTemp4);
			fRec1199[0] = std::max<double>(fConst1 * fRec1199[1], std::fabs(fTemp1013));
			fVbargraph46 = FAUSTFLOAT(fRec1199[0]);
			double fTemp1014 = fTemp1013;
			double fTemp1015 = fTemp802 * (fTemp1014 - fRec1203[1]) + fRec1202[1];
			fRec1202[0] = 2.0 * (fTemp1015 / fTemp803) - fRec1202[1];
			fRec1203[0] = fRec1203[1] + 2.0 * (fTemp802 * fTemp1015 / fTemp803);
			double fRec1204 = fTemp805 * fTemp1015 / fTemp803;
			double fTemp1016 = fTemp809 * (fTemp1014 - fRec1206[1]) + fRec1205[1];
			fRec1205[0] = 2.0 * (fTemp1016 / fTemp810) - fRec1205[1];
			fRec1206[0] = fRec1206[1] + 2.0 * (fTemp809 * fTemp1016 / fTemp810);
			double fRec1207 = fTemp812 * fTemp1016 / fTemp810;
			double fTemp1017 = fTemp814 * (fTemp1014 - fRec1209[1]) + fRec1208[1];
			fRec1208[0] = 2.0 * (fTemp1017 / fTemp815) - fRec1208[1];
			fRec1209[0] = fRec1209[1] + 2.0 * (fTemp814 * fTemp1017 / fTemp815);
			double fRec1210 = fTemp817 * fTemp1017 / fTemp815;
			double fTemp1018 = fTemp821 * (fTemp1014 - fRec1212[1]) + fRec1211[1];
			fRec1211[0] = 2.0 * (fTemp1018 / fTemp822) - fRec1211[1];
			fRec1212[0] = fRec1212[1] + 2.0 * (fTemp821 * fTemp1018 / fTemp822);
			double fRec1213 = fTemp824 * fTemp1018 / fTemp822;
			double fTemp1019 = fTemp826 * (fTemp1014 - fRec1215[1]) + fRec1214[1];
			fRec1214[0] = 2.0 * (fTemp1019 / fTemp827) - fRec1214[1];
			fRec1215[0] = fRec1215[1] + 2.0 * (fTemp826 * fTemp1019 / fTemp827);
			double fRec1216 = fTemp829 * fTemp1019 / fTemp827;
			double fTemp1020 = fTemp832 * (fTemp1014 - fRec1218[1]) + fRec1217[1];
			fRec1217[0] = 2.0 * (fTemp1020 / fTemp833) - fRec1217[1];
			fRec1218[0] = fRec1218[1] + 2.0 * (fTemp832 * fTemp1020 / fTemp833);
			double fRec1219 = fTemp835 * fTemp1020 / fTemp833;
			double fTemp1021 = fTemp838 * (fTemp1014 - fRec1221[1]) + fRec1220[1];
			fRec1220[0] = 2.0 * (fTemp1021 / fTemp839) - fRec1220[1];
			fRec1221[0] = fRec1221[1] + 2.0 * (fTemp838 * fTemp1021 / fTemp839);
			double fRec1222 = fTemp841 * fTemp1021 / fTemp839;
			double fTemp1022 = fTemp843 * (fTemp1014 - fRec1224[1]) + fRec1223[1];
			fRec1223[0] = 2.0 * (fTemp1022 / fTemp844) - fRec1223[1];
			fRec1224[0] = fRec1224[1] + 2.0 * (fTemp843 * fTemp1022 / fTemp844);
			double fRec1225 = fTemp846 * fTemp1022 / fTemp844;
			double fTemp1023 = fTemp848 * (fTemp1014 - fRec1227[1]) + fRec1226[1];
			fRec1226[0] = 2.0 * (fTemp1023 / fTemp849) - fRec1226[1];
			fRec1227[0] = fRec1227[1] + 2.0 * (fTemp848 * fTemp1023 / fTemp849);
			double fRec1228 = fTemp851 * fTemp1023 / fTemp849;
			double fTemp1024 = fTemp853 * (fTemp1014 - fRec1230[1]) + fRec1229[1];
			fRec1229[0] = 2.0 * (fTemp1024 / fTemp854) - fRec1229[1];
			fRec1230[0] = fRec1230[1] + 2.0 * (fTemp853 * fTemp1024 / fTemp854);
			double fRec1231 = fTemp856 * fTemp1024 / fTemp854;
			double fTemp1025 = fTemp859 * (fTemp1014 - fRec1233[1]) + fRec1232[1];
			fRec1232[0] = 2.0 * (fTemp1025 / fTemp860) - fRec1232[1];
			fRec1233[0] = fRec1233[1] + 2.0 * (fTemp859 * fTemp1025 / fTemp860);
			double fRec1234 = fTemp862 * fTemp1025 / fTemp860;
			double fTemp1026 = fTemp864 * (fTemp1014 - fRec1236[1]) + fRec1235[1];
			fRec1235[0] = 2.0 * (fTemp1026 / fTemp865) - fRec1235[1];
			fRec1236[0] = fRec1236[1] + 2.0 * (fTemp864 * fTemp1026 / fTemp865);
			double fRec1237 = fTemp867 * fTemp1026 / fTemp865;
			double fTemp1027 = fTemp870 * (fTemp1014 - fRec1239[1]) + fRec1238[1];
			fRec1238[0] = 2.0 * (fTemp1027 / fTemp871) - fRec1238[1];
			fRec1239[0] = fRec1239[1] + 2.0 * (fTemp870 * fTemp1027 / fTemp871);
			double fRec1240 = fTemp873 * fTemp1027 / fTemp871;
			double fTemp1028 = fTemp876 * (fTemp1014 - fRec1242[1]) + fRec1241[1];
			fRec1241[0] = 2.0 * (fTemp1028 / fTemp877) - fRec1241[1];
			fRec1242[0] = fRec1242[1] + 2.0 * (fTemp876 * fTemp1028 / fTemp877);
			double fRec1243 = fTemp879 * fTemp1028 / fTemp877;
			double fTemp1029 = fTemp881 * (fTemp1014 - fRec1245[1]) + fRec1244[1];
			fRec1244[0] = 2.0 * (fTemp1029 / fTemp882) - fRec1244[1];
			fRec1245[0] = fRec1245[1] + 2.0 * (fTemp881 * fTemp1029 / fTemp882);
			double fRec1246 = fTemp884 * fTemp1029 / fTemp882;
			double fTemp1030 = fTemp886 * (fTemp1014 - fRec1248[1]) + fRec1247[1];
			fRec1247[0] = 2.0 * (fTemp1030 / fTemp887) - fRec1247[1];
			fRec1248[0] = fRec1248[1] + 2.0 * (fTemp886 * fTemp1030 / fTemp887);
			double fRec1249 = fTemp889 * fTemp1030 / fTemp887;
			double fTemp1031 = fTemp890 * (fTemp1014 - fRec1251[1]) + fRec1250[1];
			fRec1250[0] = 2.0 * (fTemp1031 / fTemp891) - fRec1250[1];
			fRec1251[0] = fRec1251[1] + 2.0 * (fTemp890 * fTemp1031 / fTemp891);
			double fRec1252 = fTemp893 * fTemp1031 / fTemp891;
			double fTemp1032 = fTemp895 * (fTemp1014 - fRec1254[1]) + fRec1253[1];
			fRec1253[0] = 2.0 * (fTemp1032 / fTemp896) - fRec1253[1];
			fRec1254[0] = fRec1254[1] + 2.0 * (fTemp895 * fTemp1032 / fTemp896);
			double fRec1255 = fTemp898 * fTemp1032 / fTemp896;
			double fTemp1033 = fTemp900 * (fTemp1014 - fRec1257[1]) + fRec1256[1];
			fRec1256[0] = 2.0 * (fTemp1033 / fTemp901) - fRec1256[1];
			fRec1257[0] = fRec1257[1] + 2.0 * (fTemp900 * fTemp1033 / fTemp901);
			double fRec1258 = fTemp903 * fTemp1033 / fTemp901;
			double fTemp1034 = fTemp905 * (fTemp1014 - fRec1260[1]) + fRec1259[1];
			fRec1259[0] = 2.0 * (fTemp1034 / fTemp906) - fRec1259[1];
			fRec1260[0] = fRec1260[1] + 2.0 * (fTemp905 * fTemp1034 / fTemp906);
			double fRec1261 = fTemp908 * fTemp1034 / fTemp906;
			double fTemp1035 = fTemp910 * (fTemp1014 - fRec1263[1]) + fRec1262[1];
			fRec1262[0] = 2.0 * (fTemp1035 / fTemp911) - fRec1262[1];
			fRec1263[0] = fRec1263[1] + 2.0 * (fTemp910 * fTemp1035 / fTemp911);
			double fRec1264 = fTemp913 * fTemp1035 / fTemp911;
			double fTemp1036 = fTemp916 * (fTemp1014 - fRec1266[1]) + fRec1265[1];
			fRec1265[0] = 2.0 * (fTemp1036 / fTemp917) - fRec1265[1];
			fRec1266[0] = fRec1266[1] + 2.0 * (fTemp916 * fTemp1036 / fTemp917);
			double fRec1267 = fTemp919 * fTemp1036 / fTemp917;
			double fTemp1037 = fTemp921 * (fTemp1014 - fRec1269[1]) + fRec1268[1];
			fRec1268[0] = 2.0 * (fTemp1037 / fTemp922) - fRec1268[1];
			fRec1269[0] = fRec1269[1] + 2.0 * (fTemp921 * fTemp1037 / fTemp922);
			double fRec1270 = fTemp924 * fTemp1037 / fTemp922;
			double fTemp1038 = fTemp926 * (fTemp1014 - fRec1272[1]) + fRec1271[1];
			fRec1271[0] = 2.0 * (fTemp1038 / fTemp927) - fRec1271[1];
			fRec1272[0] = fRec1272[1] + 2.0 * (fTemp926 * fTemp1038 / fTemp927);
			double fRec1273 = fTemp929 * fTemp1038 / fTemp927;
			double fTemp1039 = fTemp931 * (fTemp1014 - fRec1275[1]) + fRec1274[1];
			fRec1274[0] = 2.0 * (fTemp1039 / fTemp932) - fRec1274[1];
			fRec1275[0] = fRec1275[1] + 2.0 * (fTemp931 * fTemp1039 / fTemp932);
			double fRec1276 = fTemp934 * fTemp1039 / fTemp932;
			double fTemp1040 = fTemp936 * (fTemp1014 - fRec1278[1]) + fRec1277[1];
			fRec1277[0] = 2.0 * (fTemp1040 / fTemp937) - fRec1277[1];
			fRec1278[0] = fRec1278[1] + 2.0 * (fTemp936 * fTemp1040 / fTemp937);
			double fRec1279 = fTemp939 * fTemp1040 / fTemp937;
			double fTemp1041 = fTemp941 * (fTemp1014 - fRec1281[1]) + fRec1280[1];
			fRec1280[0] = 2.0 * (fTemp1041 / fTemp942) - fRec1280[1];
			fRec1281[0] = fRec1281[1] + 2.0 * (fTemp941 * fTemp1041 / fTemp942);
			double fRec1282 = fTemp944 * fTemp1041 / fTemp942;
			double fTemp1042 = fTemp946 * (fTemp1014 - fRec1284[1]) + fRec1283[1];
			fRec1283[0] = 2.0 * (fTemp1042 / fTemp947) - fRec1283[1];
			fRec1284[0] = fRec1284[1] + 2.0 * (fTemp946 * fTemp1042 / fTemp947);
			double fRec1285 = fTemp949 * fTemp1042 / fTemp947;
			double fTemp1043 = fTemp951 * (fTemp1014 - fRec1287[1]) + fRec1286[1];
			fRec1286[0] = 2.0 * (fTemp1043 / fTemp952) - fRec1286[1];
			fRec1287[0] = fRec1287[1] + 2.0 * (fTemp951 * fTemp1043 / fTemp952);
			double fRec1288 = fTemp954 * fTemp1043 / fTemp952;
			double fTemp1044 = fTemp956 * (fTemp1014 - fRec1290[1]) + fRec1289[1];
			fRec1289[0] = 2.0 * (fTemp1044 / fTemp957) - fRec1289[1];
			fRec1290[0] = fRec1290[1] + 2.0 * (fTemp956 * fTemp1044 / fTemp957);
			double fRec1291 = fTemp959 * fTemp1044 / fTemp957;
			double fTemp1045 = fTemp961 * (fTemp1014 - fRec1293[1]) + fRec1292[1];
			fRec1292[0] = 2.0 * (fTemp1045 / fTemp962) - fRec1292[1];
			fRec1293[0] = fRec1293[1] + 2.0 * (fTemp961 * fTemp1045 / fTemp962);
			double fRec1294 = fTemp964 * fTemp1045 / fTemp962;
			double fTemp1046 = fTemp966 * (fTemp1014 - fRec1296[1]) + fRec1295[1];
			fRec1295[0] = 2.0 * (fTemp1046 / fTemp967) - fRec1295[1];
			fRec1296[0] = fRec1296[1] + 2.0 * (fTemp966 * fTemp1046 / fTemp967);
			double fRec1297 = fTemp969 * fTemp1046 / fTemp967;
			double fTemp1047 = 0.03125 * fRec137[0] * (fRec1297 + fRec1294 + fRec1291 + fRec1288 + fRec1285 + fRec1282 + fRec1279 + fRec1276 + fRec1273 + fRec1270 + fRec1267 + fRec1264 + fRec1261 + fRec1258 + fRec1255 + fRec1252 + fRec1249 + fRec1246 + fRec1243 + fRec1240 + fRec1237 + fRec1234 + fRec1231 + fRec1228 + fRec1225 + fRec1222 + fRec1219 + fRec1216 + fRec1213 + fRec1210 + fRec1207 + fRec1204) + fRec36[0] * fTemp1014;
			fRec1198[0] = std::max<double>(fConst1 * fRec1198[1], std::fabs(fTemp1047));
			fVbargraph47 = FAUSTFLOAT(fRec1198[0]);
			fRec986[0] = fTemp1047;
			double fTemp1048 = (fRec986[0] + fRec984[0] + fRec985[0]) / fTemp4;
			fVec22[IOTA0 & 4194303] = fTemp1048;
			double fTemp1049 = ((fRec1298[1] != 0.0) ? (((fRec1299[1] > 0.0) & (fRec1299[1] < 1.0)) ? fRec1298[1] : 0.0) : (((fRec1299[1] == 0.0) & (fSlow36 != fRec1300[1])) ? 0.0009765625 : (((fRec1299[1] == 1.0) & (fSlow36 != fRec1301[1])) ? -0.0009765625 : 0.0)));
			fRec1298[0] = fTemp1049;
			fRec1299[0] = std::max<double>(0.0, std::min<double>(1.0, fRec1299[1] + fTemp1049));
			...
			double fTemp1050 = fVec22[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec1300[0])))) & 4194303];
			fRec983[0] = 0.3333333333333333 * fTemp1050 + fRec1299[0] * (0.0 - 0.3333333333333333 * (fTemp1050 - fVec22[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec1301[0])))) & 4194303]));
			fRec11[0] = 0.25 * (fRec983[1] + fRec664[1] + fRec345[1] + fRec16[1]);
			double fRec12 = 0.3333333333333333 * fTemp788;
			double fRec13 = 0.3333333333333333 * fTemp268;
			double fRec14 = 0.3333333333333333 * fTemp528;
			double fRec15 = 0.3333333333333333 * fTemp1048;
			double fTemp1051 = (fRec12 - fRec8[1]) * fTemp2 / fTemp3;
			fRec8[0] = fRec8[1] + 2.0 * fTemp1051;
			double fTemp1052 = fRec8[1] + fTemp1051;
			double fRec9 = fRec12 - fTemp1052;
			double fTemp1053 = (fRec9 - fRec5[1]) * fTemp0 / fTemp1;
			fRec5[0] = fRec5[1] + 2.0 * fTemp1053;
			double fTemp1054 = fRec5[1] + fTemp1053;
			fRec6[IOTA0 & 511] = fTemp1054;
			double fTemp1055 = std::fabs(fRec6[IOTA0 & 511]);
			int iTemp1056 = (fTemp1055 >= fRec4[1]) | (double(iRec3[1]) >= fConst2);
			iRec3[0] = ((iTemp1056) ? 0 : iRec3[1] + 1);
			fRec4[0] = ((iTemp1056) ? fTemp1055 : fRec4[1]);
			double fTemp1057 = fRec4[0] - fRec1[1];
			fRec1[0] = fRec1[1] + fConst11 * fTemp1057;
			double fTemp1058 = fRec1[1] + fConst10 * fTemp1057;
			double fRec2 = fTemp1058;
			fRec0[0] = std::max<double>(fConst1 * fRec0[1], std::fabs(fRec2));
			fRec1302[0] = fSlow38 + fConst3 * fRec1302[1];
			output0[i0] = FAUSTFLOAT(fRec1302[0] * fRec6[(IOTA0 - iConst12) & 511] / fRec0[0]);
			double fTemp1059 = fTemp2 * (fRec13 - fRec1310[1]) / fTemp3;
			fRec1310[0] = fRec1310[1] + 2.0 * fTemp1059;
			double fTemp1060 = fRec1310[1] + fTemp1059;
			double fRec1311 = fRec13 - fTemp1060;
			double fTemp1061 = fTemp0 * (fRec1311 - fRec1308[1]) / fTemp1;
			fRec1308[0] = fRec1308[1] + 2.0 * fTemp1061;
			double fTemp1062 = fRec1308[1] + fTemp1061;
			fRec1309[IOTA0 & 511] = fTemp1062;
			double fTemp1063 = std::fabs(fRec1309[IOTA0 & 511]);
			int iTemp1064 = (fTemp1063 >= fRec1307[1]) | (double(iRec1306[1]) >= fConst2);
			iRec1306[0] = ((iTemp1064) ? 0 : iRec1306[1] + 1);
			fRec1307[0] = ((iTemp1064) ? fTemp1063 : fRec1307[1]);
			double fTemp1065 = fRec1307[0] - fRec1304[1];
			fRec1304[0] = fRec1304[1] + fConst11 * fTemp1065;
			double fTemp1066 = fRec1304[1] + fConst10 * fTemp1065;
			double fRec1305 = fTemp1066;
			fRec1303[0] = std::max<double>(fConst1 * fRec1303[1], std::fabs(fRec1305));
			output1[i0] = FAUSTFLOAT(fRec1302[0] * fRec1309[(IOTA0 - iConst12) & 511] / fRec1303[0]);
			double fTemp1067 = fTemp2 * (fRec14 - fRec1319[1]) / fTemp3;
			fRec1319[0] = fRec1319[1] + 2.0 * fTemp1067;
			double fTemp1068 = fRec1319[1] + fTemp1067;
			double fRec1320 = fRec14 - fTemp1068;
			double fTemp1069 = fTemp0 * (fRec1320 - fRec1317[1]) / fTemp1;
			fRec1317[0] = fRec1317[1] + 2.0 * fTemp1069;
			double fTemp1070 = fRec1317[1] + fTemp1069;
			fRec1318[IOTA0 & 511] = fTemp1070;
			double fTemp1071 = std::fabs(fRec1318[IOTA0 & 511]);
			int iTemp1072 = (fTemp1071 >= fRec1316[1]) | (double(iRec1315[1]) >= fConst2);
			iRec1315[0] = ((iTemp1072) ? 0 : iRec1315[1] + 1);
			fRec1316[0] = ((iTemp1072) ? fTemp1071 : fRec1316[1]);
			double fTemp1073 = fRec1316[0] - fRec1313[1];
			fRec1313[0] = fRec1313[1] + fConst11 * fTemp1073;
			double fTemp1074 = fRec1313[1] + fConst10 * fTemp1073;
			double fRec1314 = fTemp1074;
			fRec1312[0] = std::max<double>(fConst1 * fRec1312[1], std::fabs(fRec1314));
			output2[i0] = FAUSTFLOAT(fRec1302[0] * fRec1318[(IOTA0 - iConst12) & 511] / fRec1312[0]);
			double fTemp1075 = fTemp2 * (fRec15 - fRec1328[1]) / fTemp3;
			fRec1328[0] = fRec1328[1] + 2.0 * fTemp1075;
			double fTemp1076 = fRec1328[1] + fTemp1075;
			double fRec1329 = fRec15 - fTemp1076;
			double fTemp1077 = fTemp0 * (fRec1329 - fRec1326[1]) / fTemp1;
			fRec1326[0] = fRec1326[1] + 2.0 * fTemp1077;
			double fTemp1078 = fRec1326[1] + fTemp1077;
			fRec1327[IOTA0 & 511] = fTemp1078;
			double fTemp1079 = std::fabs(fRec1327[IOTA0 & 511]);
			int iTemp1080 = (fTemp1079 >= fRec1325[1]) | (double(iRec1324[1]) >= fConst2);
			iRec1324[0] = ((iTemp1080) ? 0 : iRec1324[1] + 1);
			fRec1325[0] = ((iTemp1080) ? fTemp1079 : fRec1325[1]);
			double fTemp1081 = fRec1325[0] - fRec1322[1];
			fRec1322[0] = fRec1322[1] + fConst11 * fTemp1081;
			double fTemp1082 = fRec1322[1] + fConst10 * fTemp1081;
			double fRec1323 = fTemp1082;
			fRec1321[0] = std::max<double>(fConst1 * fRec1321[1], std::fabs(fRec1323));
			output3[i0] = FAUSTFLOAT(fRec1302[0] * fRec1327[(IOTA0 - iConst12) & 511] / fRec1321[0]);
			fRec7[1] = fRec7[0];
			fRec10[1] = fRec10[0];
			fRec17[1] = fRec17[0];
			fVec0[1] = fVec0[0];
	...
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations A", fVslider27, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations B", fVslider28, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Frequency", fVslider10, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations A", fVslider12, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations B", fVslider13, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Frequency", fVslider20, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations A", fVslider21, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations B", fVslider22, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Frequency", fVslider32, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations A", fVslider33, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations B", fVslider34, 1.0, 0.0, 1.0, 0.001);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations A", fVslider27, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations B", fVslider28, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Frequency", fVslider10, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations A", fVslider12, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations B", fVslider13, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Frequency", fVslider20, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations A", fVslider21, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations B", fVslider22, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Frequency", fVslider32, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations A", fVslider33, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations B", fVslider34, 1.0, 0.0, 1.0, 0.001) \

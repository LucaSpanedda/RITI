...
'''
print("Cello_C2pp_frequencies: ", frequencies)
print("Cello_C2pp_amplitudes: ", amplitudes)
print("Cello_C2pp_bandwidths: ", bandwidths)
'''
...
print("Amplitudes: ", sorted_amplitudes)
print("Bandwidths: ", sorted_bandwidths)


# Save the selected frequencies
with open((listsfile_no_ext)+"_sortedfrequencies.txt", "w") as f:

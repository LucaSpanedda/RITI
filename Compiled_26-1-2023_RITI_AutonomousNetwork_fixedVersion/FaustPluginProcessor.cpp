...
class mydsp : public base_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = std::exp(0.0 - 1.0 / fConst0);
		fConst4 = 1.0 - fConst3;
		fConst5 = 3.141592653589793 / fConst0;
		fConst6 = 12.0 * fConst0;
		fConst7 = 9.2528 * fConst0 + -1.0;
		fConst8 = 6.9396 * fConst0 + -1.0;
		fConst9 = 4.6264 * fConst0 + -1.0;
		fConst10 = 2.3132 * fConst0 + -1.0;
		double fConst11 = std::tan(1570.7963267948965 / fConst0);
		fConst12 = fConst11 / (fConst11 + 1.0);
		fConst13 = 2.0 * fConst12;
		iConst14 = int(0.002 * fConst0);
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider6 = FAUSTFLOAT(0.62);
		fVslider7 = FAUSTFLOAT(8.2);
		fVslider8 = FAUSTFLOAT(0.0);
		fVslider9 = FAUSTFLOAT(0.01);
		fVslider10 = FAUSTFLOAT(0.1);
	...
	virtual void instanceClear() {
		...
		for (int l221 = 0; l221 < 4194304; l221 = l221 + 1) {
			fVec7[l221] = 0.0;
		}
		...
		for (int l429 = 0; l429 < 4194304; l429 = l429 + 1) {
			fVec11[l429] = 0.0;
		}
		for (int l430 = 0; l430 < 512; l430 = l430 + 1) {
			fRec6[l430] = 0.0;
		}
		...
		for (int l637 = 0; l637 < 4194304; l637 = l637 + 1) {
			fVec15[l637] = 0.0;
		}
		for (int l638 = 0; l638 < 512; l638 = l638 + 1) {
			fRec7[l638] = 0.0;
		}
		...
		for (int l845 = 0; l845 < 4194304; l845 = l845 + 1) {
			fVec19[l845] = 0.0;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("Lorenz Tan", &fVslider0, FAUSTFLOAT(1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(1e+02), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openHorizontalBox("Bandpass Filters Bank");
		ui_interface->addVerticalSlider("BP Bypass", &fVslider8, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Bandwidth", &fVslider4, FAUSTFLOAT(1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(1e+02), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Frequency", &fVslider3, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations 1", &fVslider1, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations 2", &fVslider2, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->declare(0, "3", "");
		ui_interface->openHorizontalBox("Input/Output");
		ui_interface->addVerticalSlider("External Sum", &fVslider5, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1e+02), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Master", &fVslider11, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->declare(0, "0", "");
		ui_interface->openHorizontalBox("Lorenz Equation Parameters");
		ui_interface->addVerticalSlider("Beta", &fVslider10, FAUSTFLOAT(0.1), FAUSTFLOAT(0.0), FAUSTFLOAT(1e+01), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Dt", &fVslider6, FAUSTFLOAT(0.62), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Rho", &fVslider9, FAUSTFLOAT(0.01), FAUSTFLOAT(0.0), FAUSTFLOAT(0.1), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Sigma", &fVslider7, FAUSTFLOAT(8.2), FAUSTFLOAT(0.0), FAUSTFLOAT(1e+02), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow3 = fConst4 * std::pow(16.0, double(fVslider3));
		...
		double fSlow9 = fConst4 * double(fVslider9);
		double fSlow10 = fConst4 * double(fVslider10);
		double fSlow11 = fConst4 * double(fVslider11);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec9[0] = fSlow0 + fConst3 * fRec9[1];
			double fTemp0 = std::max<double>(fRec9[0], 2.220446049250313e-16);
			fRec16[0] = fSlow1 + fConst3 * fRec16[1];
			fRec17[0] = fSlow2 + fConst3 * fRec17[1];
			fRec18[0] = fSlow3 + fConst3 * fRec18[1];
			double fTemp1 = fRec18[0] * (561.0 * fRec16[0] + fRec17[0] * (562.0 - 1097.0 * fRec16[0]) + 221.0);
			fRec19[0] = fSlow4 + fConst3 * fRec19[1];
			double fTemp2 = std::max<double>(2.220446049250313e-16, fRec19[0]);
			double fTemp3 = std::tan(fConst5 * fTemp1);
			double fTemp4 = fTemp3 * (fTemp3 + fTemp2 / fTemp1) + 1.0;
			fVec0[0] = 1.2;
			double fTemp5 = 1.2 - fVec0[1];
			fRec22[0] = fSlow5 + fConst3 * fRec22[1];
			double fTemp6 = fRec22[0] * (double(input7[i0]) + double(input6[i0]) + double(input5[i0]) + double(input4[i0]) + double(input3[i0]) + double(input2[i0]) + double(input0[i0]) + double(input1[i0]));
			fVec1[IOTA0 & 4194303] = fTemp6;
			double fTemp7 = ((fRec23[1] != 0.0) ? (((fRec24[1] > 0.0) & (fRec24[1] < 1.0)) ? fRec23[1] : 0.0) : (((fRec24[1] == 0.0) & (fConst7 != fRec25[1])) ? 0.0009765625 : (((fRec24[1] == 1.0) & (fConst7 != fRec26[1])) ? -0.0009765625 : 0.0)));
			fRec23[0] = fTemp7;
			fRec24[0] = std::max<double>(0.0, std::min<double>(1.0, fRec24[1] + fTemp7));
			fRec25[0] = (((fRec24[1] >= 1.0) & (fRec26[1] != fConst7)) ? fConst7 : fRec25[1]);
			fRec26[0] = (((fRec24[1] <= 0.0) & (fRec25[1] != fConst7)) ? fConst7 : fRec26[1]);
			double fTemp8 = fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec25[0])))) & 4194303];
			fRec21[0] = 0.25 * fTemp8 + fRec24[0] * (0.0 - 0.25 * (fTemp8 - fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec26[0])))) & 4194303]));
			fRec27[0] = fSlow6 + fConst3 * fRec27[1];
			fRec28[0] = fSlow7 + fConst3 * fRec28[1];
			double fTemp9 = fRec28[0] * fRec27[0];
			double fTemp10 = fTemp9 * (fRec11[1] - fRec10[1]);
			fVec2[0] = fRec10[1] + fTemp10 + fRec21[1] + fTemp5;
			fRec20[0] = fRec21[1] + fTemp10 + 0.995 * fRec20[1] + fRec10[1] + (1.2 - (fVec0[1] + fVec2[1]));
			double fTemp11 = fRec9[0] * tanh(fRec20[0] / fTemp0);
			double fTemp12 = fTemp3 * (fTemp11 - fRec14[1]) + fRec13[1];
			fRec13[0] = 2.0 * (fTemp12 / fTemp4) - fRec13[1];
			fRec14[0] = fRec14[1] + 2.0 * (fTemp3 * fTemp12 / fTemp4);
			double fTemp13 = fRec17[0] * (0.20948251265282836 * fRec16[0] + -0.35882756573771113) + (0.883508750371294 - 0.3295246174054942 * fRec16[0]);
			double fRec15 = fTemp12 * fTemp13 / fTemp4;
			double fTemp14 = fRec18[0] * (1048.0 * fRec16[0] + fRec17[0] * (1.07e+03 * fRec16[0] + -787.0) + 1619.0);
			double fTemp15 = std::tan(fConst5 * fTemp14);
			double fTemp16 = fTemp15 * (fTemp15 + fTemp2 / fTemp14) + 1.0;
			double fTemp17 = fTemp15 * (fTemp11 - fRec30[1]) + fRec29[1];
			fRec29[0] = 2.0 * (fTemp17 / fTemp16) - fRec29[1];
			fRec30[0] = fRec30[1] + 2.0 * (fTemp15 * fTemp17 / fTemp16);
			double fTemp18 = fRec17[0] * (0.0016935641831933154 * fRec16[0] + -0.0070591277129707815) + (0.014962909727368317 - 0.007613896970744654 * fRec16[0]);
			double fRec31 = fTemp17 * fTemp18 / fTemp16;
			double fTemp19 = fRec18[0] * (687.0 * fRec16[0] + fRec17[0] * (311.0 - 2032.0 * fRec16[0]) + 2429.0);
			double fTemp20 = std::tan(fConst5 * fTemp19);
			double fTemp21 = fTemp20 * (fTemp20 + fTemp2 / fTemp19) + 1.0;
			double fTemp22 = fTemp20 * (fTemp11 - fRec33[1]) + fRec32[1];
			fRec32[0] = 2.0 * (fTemp22 / fTemp21) - fRec32[1];
			fRec33[0] = fRec33[1] + 2.0 * (fTemp20 * fTemp22 / fTemp21);
			double fTemp23 = fRec17[0] * (0.005227226473626777 * fRec16[0] + -0.010433410102575844) + (0.01934635943322834 - 0.010538363987102131 * fRec16[0]);
			double fRec34 = fTemp22 * fTemp23 / fTemp21;
			double fTemp24 = fRec18[0] * (1422.0 * fRec16[0] + fRec17[0] * (-4.0 - 526.0 * fRec16[0]) + 1178.0);
			double fTemp25 = std::tan(fConst5 * fTemp24);
			double fTemp26 = fTemp25 * (fTemp25 + fTemp2 / fTemp24) + 1.0;
			double fTemp27 = fTemp25 * (fTemp11 - fRec36[1]) + fRec35[1];
			fRec35[0] = 2.0 * (fTemp27 / fTemp26) - fRec35[1];
			fRec36[0] = fRec36[1] + 2.0 * (fTemp25 * fTemp27 / fTemp26);
			double fTemp28 = fRec17[0] * (0.0015990719330448112 * fRec16[0] + -0.009377259975676547) + (0.020502590513884294 - 0.008575258476103987 * fRec16[0]);
			double fRec37 = fTemp27 * fTemp28 / fTemp26;
			double fTemp29 = fRec18[0] * (1005.0 * fRec16[0] + fRec17[0] * (1538.0 - 1969.0 * fRec16[0]) + 1398.0);
			double fTemp30 = std::tan(fConst5 * fTemp29);
			double fTemp31 = fTemp30 * (fTemp30 + fTemp2 / fTemp29) + 1.0;
			double fTemp32 = fTemp30 * (fTemp11 - fRec39[1]) + fRec38[1];
			fRec38[0] = 2.0 * (fTemp32 / fTemp31) - fRec38[1];
			fRec39[0] = fRec39[1] + 2.0 * (fTemp30 * fTemp32 / fTemp31);
			double fTemp33 = fRec17[0] * (-0.004224308163056342 - 0.007247221109719737 * fRec16[0]) + (0.020955020563014883 - 0.004499122746580129 * fRec16[0]);
			double fRec40 = fTemp32 * fTemp33 / fTemp31;
			double fTemp34 = fRec18[0] * (726.0 * fRec16[0] + fRec17[0] * (507.0 - 2138.0 * fRec16[0]) + 2135.0);
			double fTemp35 = std::tan(fConst5 * fTemp34);
			double fTemp36 = fTemp35 * (fTemp35 + fTemp2 / fTemp34) + 1.0;
			double fTemp37 = fTemp35 * (fTemp11 - fRec42[1]) + fRec41[1];
			fRec41[0] = 2.0 * (fTemp37 / fTemp36) - fRec41[1];
			fRec42[0] = fRec42[1] + 2.0 * (fTemp35 * fTemp37 / fTemp36);
			double fTemp38 = fRec17[0] * (0.0009039247818369497 - 0.013893501673791466 * fRec16[0]) + (0.02359690477324046 - 0.005322076674786635 * fRec16[0]);
			double fRec43 = fTemp37 * fTemp38 / fTemp36;
			double fTemp39 = fRec18[0] * (125.0 * fRec16[0] + fRec17[0] * (9e+01 - 7.0 * fRec16[0]) + 2356.0);
			double fTemp40 = std::tan(fConst5 * fTemp39);
			double fTemp41 = fTemp40 * (fTemp40 + fTemp2 / fTemp39) + 1.0;
			double fTemp42 = fTemp40 * (fTemp11 - fRec45[1]) + fRec44[1];
			fRec44[0] = 2.0 * (fTemp42 / fTemp41) - fRec44[1];
			fRec45[0] = fRec45[1] + 2.0 * (fTemp40 * fTemp42 / fTemp41);
			double fTemp43 = fRec17[0] * (0.00789733404453236 - 0.022269972441420545 * fRec16[0]) + (0.024970356245165314 - 0.004948333836676418 * fRec16[0]);
			double fRec46 = fTemp42 * fTemp43 / fTemp41;
			double fTemp44 = fRec18[0] * (74.0 * fRec16[0] + fRec17[0] * (1147.0 - 837.0 * fRec16[0]) + 1104.0);
			double fTemp45 = std::tan(fConst5 * fTemp44);
			double fTemp46 = fTemp45 * (fTemp45 + fTemp2 / fTemp44) + 1.0;
			double fTemp47 = fTemp45 * (fTemp11 - fRec48[1]) + fRec47[1];
			fRec47[0] = 2.0 * (fTemp47 / fTemp46) - fRec47[1];
			fRec48[0] = fRec48[1] + 2.0 * (fTemp45 * fTemp47 / fTemp46);
			double fTemp48 = fRec17[0] * (0.014369998843206975 - 0.03300092964654322 * fRec16[0]) + (0.025519908386620865 - 0.0011683893550737713 * fRec16[0]);
			double fRec49 = fTemp47 * fTemp48 / fTemp46;
			double fTemp49 = fRec18[0] * (fRec17[0] * (241.0 * fRec16[0] + 6.3e+02) + (1914.0 - 1472.0 * fRec16[0]));
			double fTemp50 = std::tan(fConst5 * fTemp49);
			double fTemp51 = fTemp50 * (fTemp50 + fTemp2 / fTemp49) + 1.0;
			double fTemp52 = fTemp50 * (fTemp11 - fRec51[1]) + fRec50[1];
			fRec50[0] = 2.0 * (fTemp52 / fTemp51) - fRec50[1];
			fRec51[0] = fRec51[1] + 2.0 * (fTemp50 * fTemp52 / fTemp51);
			double fTemp53 = fRec17[0] * (0.012092025104768513 - 0.030118723258832435 * fRec16[0]) + (0.034299901561064564 - 0.009167713045154305 * fRec16[0]);
			double fRec52 = fTemp52 * fTemp53 / fTemp51;
			double fTemp54 = fRec18[0] * (403.0 * fRec16[0] + fRec17[0] * (1123.0 - 898.0 * fRec16[0]) + 1.03e+03);
			double fTemp55 = std::tan(fConst5 * fTemp54);
			double fTemp56 = fTemp55 * (fTemp55 + fTemp2 / fTemp54) + 1.0;
			double fTemp57 = fTemp55 * (fTemp11 - fRec54[1]) + fRec53[1];
			fRec53[0] = 2.0 * (fTemp57 / fTemp56) - fRec53[1];
			fRec54[0] = fRec54[1] + 2.0 * (fTemp55 * fTemp57 / fTemp56);
			double fTemp58 = fRec17[0] * (0.021778225322525664 - 0.04184590502930971 * fRec16[0]) + (0.03695324484801036 - 0.00815043374124962 * fRec16[0]);
			double fRec55 = fTemp57 * fTemp58 / fTemp56;
			double fTemp59 = 6.0 * fRec16[0];
			double fTemp60 = fRec18[0] * (fTemp59 + fRec17[0] * (838.0 * fRec16[0] + -812.0) + 1693.0);
			double fTemp61 = std::tan(fConst5 * fTemp60);
			double fTemp62 = fTemp61 * (fTemp61 + fTemp2 / fTemp60) + 1.0;
			double fTemp63 = fTemp61 * (fTemp11 - fRec57[1]) + fRec56[1];
			fRec56[0] = 2.0 * (fTemp63 / fTemp62) - fRec56[1];
			fRec57[0] = fRec57[1] + 2.0 * (fTemp61 * fTemp63 / fTemp62);
			double fTemp64 = fRec17[0] * (0.01054367849960227 - 0.044428922548055166 * fRec16[0]) + (0.04993743413946004 - 0.006818779501746489 * fRec16[0]);
			double fRec58 = fTemp63 * fTemp64 / fTemp62;
			double fTemp65 = fRec18[0] * (209.0 * fRec16[0] + fRec17[0] * (1515.0 - 1507.0 * fRec16[0]) + 442.0);
			double fTemp66 = std::tan(fConst5 * fTemp65);
			double fTemp67 = fTemp66 * (fTemp66 + fTemp2 / fTemp65) + 1.0;
			double fTemp68 = fTemp66 * (fTemp11 - fRec60[1]) + fRec59[1];
			fRec59[0] = 2.0 * (fTemp68 / fTemp67) - fRec59[1];
			fRec60[0] = fRec60[1] + 2.0 * (fTemp66 * fTemp68 / fTemp67);
			double fTemp69 = fRec17[0] * (-0.00836319425786336 - 0.027213728546822337 * fRec16[0]) + (0.07568694217870818 - 0.01847465835663161 * fRec16[0]);
			double fRec61 = fTemp68 * fTemp69 / fTemp67;
			double fTemp70 = fRec18[0] * (675.0 * fRec16[0] + fRec17[0] * (1172.0 - 1989.0 * fRec16[0]) + 883.0);
			double fTemp71 = std::tan(fConst5 * fTemp70);
			double fTemp72 = fTemp71 * (fTemp71 + fTemp2 / fTemp70) + 1.0;
			double fTemp73 = fTemp71 * (fTemp11 - fRec63[1]) + fRec62[1];
			fRec62[0] = 2.0 * (fTemp73 / fTemp72) - fRec62[1];
			fRec63[0] = fRec63[1] + 2.0 * (fTemp71 * fTemp73 / fTemp72);
			double fTemp74 = fRec17[0] * (0.01667332967615094 * fRec16[0] + -0.0754718266524771) + (0.15388399774271314 - 0.05838064149040649 * fRec16[0]);
			double fRec64 = fTemp73 * fTemp74 / fTemp72;
			double fTemp75 = fRec18[0] * (1.36e+03 * fRec16[0] + fRec17[0] * (-1e+02 - 1025.0 * fRec16[0]) + 589.0);
			double fTemp76 = std::tan(fConst5 * fTemp75);
			double fTemp77 = fTemp76 * (fTemp76 + fTemp2 / fTemp75) + 1.0;
			double fTemp78 = fTemp76 * (fTemp11 - fRec66[1]) + fRec65[1];
			fRec65[0] = 2.0 * (fTemp78 / fTemp77) - fRec65[1];
			fRec66[0] = fRec66[1] + 2.0 * (fTemp76 * fTemp78 / fTemp77);
			double fTemp79 = 0.012026367628721973 * fRec16[0] + fRec17[0] * (-0.03484164734028006 - 0.07088469349182304 * fRec16[0]) + 0.15986608084324763;
			double fRec67 = fTemp78 * fTemp79 / fTemp77;
			double fTemp80 = fRec18[0] * (fRec17[0] * (-51.0 - 11.0 * fRec16[0]) + (736.0 - 345.0 * fRec16[0]));
			double fTemp81 = std::tan(fConst5 * fTemp80);
			double fTemp82 = fTemp81 * (fTemp81 + fTemp2 / fTemp80) + 1.0;
			double fTemp83 = fTemp81 * (fTemp11 - fRec69[1]) + fRec68[1];
			fRec68[0] = 2.0 * (fTemp83 / fTemp82) - fRec68[1];
			fRec69[0] = fRec69[1] + 2.0 * (fTemp81 * fTemp83 / fTemp82);
			double fTemp84 = 0.043418834059638534 * fRec16[0] + fRec17[0] * (0.0003590165583120808 - 0.1653942291667907 * fRec16[0]) + 0.2004373971446242;
			double fRec70 = fTemp83 * fTemp84 / fTemp82;
			double fTemp85 = fRec18[0] * (113.0 * fRec16[0] + fRec17[0] * (147.0 - 325.0 * fRec16[0]) + 147.0);
			double fTemp86 = std::tan(fConst5 * fTemp85);
			double fTemp87 = fTemp86 * (fTemp86 + fTemp2 / fTemp85) + 1.0;
			double fTemp88 = fTemp86 * (fTemp11 - fRec72[1]) + fRec71[1];
			fRec71[0] = 2.0 * (fTemp88 / fTemp87) - fRec71[1];
			fRec72[0] = fRec72[1] + 2.0 * (fTemp86 * fTemp88 / fTemp87);
			double fTemp89 = fRec17[0] * (-0.20926865897501318 - 0.10045148502362689 * fRec16[0]) + (0.6105272358722508 - 0.05775171174785887 * fRec16[0]);
			double fRec73 = fTemp88 * fTemp89 / fTemp87;
			double fTemp90 = fRec18[0] * (fRec17[0] * (306.0 * fRec16[0] + -2.7e+02) + (368.0 - 239.0 * fRec16[0]));
			double fTemp91 = std::tan(fConst5 * fTemp90);
			double fTemp92 = fTemp91 * (fTemp91 + fTemp2 / fTemp90) + 1.0;
			double fTemp93 = fTemp91 * (fTemp11 - fRec75[1]) + fRec74[1];
			double fTemp94 = fTemp93 / fTemp92;
			fRec74[0] = 2.0 * fTemp94 - fRec74[1];
			fRec75[0] = fRec75[1] + 2.0 * (fTemp91 * fTemp93 / fTemp92);
			double fRec76 = fTemp94;
			double fTemp95 = fRec18[0] * (fTemp59 + fRec17[0] * (72.0 - 181.0 * fRec16[0]) + 515.0);
			double fTemp96 = std::tan(fConst5 * fTemp95);
			double fTemp97 = fTemp96 * (fTemp96 + fTemp2 / fTemp95) + 1.0;
			double fTemp98 = fTemp96 * (fTemp11 - fRec78[1]) + fRec77[1];
			fRec77[0] = 2.0 * (fTemp98 / fTemp97) - fRec77[1];
			fRec78[0] = fRec78[1] + 2.0 * (fTemp96 * fTemp98 / fTemp97);
			double fTemp99 = 0.1297691905274158 * fRec16[0] + fRec17[0] * (-0.020679500617239138 - 0.26354737961410307 * fRec16[0]) + 0.25009984168236576;
			double fRec79 = fTemp98 * fTemp99 / fTemp97;
			double fTemp100 = fRec18[0] * (968.0 * fRec16[0] + fRec17[0] * (122.0 - 588.0 * fRec16[0]) + 74.0);
			double fTemp101 = std::tan(fConst5 * fTemp100);
			double fTemp102 = fTemp101 * (fTemp101 + fTemp2 / fTemp100) + 1.0;
			double fTemp103 = fTemp101 * (fTemp11 - fRec81[1]) + fRec80[1];
			fRec80[0] = 2.0 * (fTemp103 / fTemp102) - fRec80[1];
			fRec81[0] = fRec81[1] + 2.0 * (fTemp101 * fTemp103 / fTemp102);
			double fTemp104 = fRec17[0] * (-0.00905548290563929 - 0.10407317928289174 * fRec16[0]) + (0.19782531572463796 - 0.011967933866223551 * fRec16[0]);
			double fRec82 = fTemp103 * fTemp104 / fTemp102;
			double fTemp105 = fRec18[0] * (102.0 * fRec16[0] + fRec17[0] * (756.0 - 762.0 * fRec16[0]) + 8.1e+02);
			double fTemp106 = std::tan(fConst5 * fTemp105);
			double fTemp107 = fTemp106 * (fTemp106 + fTemp2 / fTemp105) + 1.0;
			double fTemp108 = fTemp106 * (fTemp11 - fRec84[1]) + fRec83[1];
			fRec83[0] = 2.0 * (fTemp108 / fTemp107) - fRec83[1];
			fRec84[0] = fRec84[1] + 2.0 * (fTemp106 * fTemp108 / fTemp107);
			double fTemp109 = fRec17[0] * (-0.06073025380607225 - 0.02103357250515689 * fRec16[0]) + (0.15408867955329245 - 0.01859664908410899 * fRec16[0]);
			double fRec85 = fTemp108 * fTemp109 / fTemp107;
			double fTemp110 = fRec18[0] * (1784.0 * fRec16[0] + fRec17[0] * (96.0 - 1681.0 * fRec16[0]) + 295.0);
			double fTemp111 = std::tan(fConst5 * fTemp110);
			double fTemp112 = fTemp111 * (fTemp111 + fTemp2 / fTemp110) + 1.0;
			double fTemp113 = fTemp111 * (fTemp11 - fRec87[1]) + fRec86[1];
			fRec86[0] = 2.0 * (fTemp113 / fTemp112) - fRec86[1];
			fRec87[0] = fRec87[1] + 2.0 * (fTemp111 * fTemp113 / fTemp112);
			double fTemp114 = fRec17[0] * (0.00832579588520789 * fRec16[0] + -0.044200755516049905) + (0.12206611629626225 - 0.05880265929429268 * fRec16[0]);
			double fRec88 = fTemp113 * fTemp114 / fTemp112;
			double fTemp115 = fRec18[0] * (1689.0 * fRec16[0] + fRec17[0] * (806.0 - 1597.0 * fRec16[0]) + 662.0);
			double fTemp116 = std::tan(fConst5 * fTemp115);
			double fTemp117 = fTemp116 * (fTemp116 + fTemp2 / fTemp115) + 1.0;
			double fTemp118 = fTemp116 * (fTemp11 - fRec90[1]) + fRec89[1];
			fRec89[0] = 2.0 * (fTemp118 / fTemp117) - fRec89[1];
			fRec90[0] = fRec90[1] + 2.0 * (fTemp116 * fTemp118 / fTemp117);
			double fTemp119 = fRec17[0] * (-0.010952558243701213 - 0.024561127441574723 * fRec16[0]) + (0.0749419685950924 - 0.028820358890550887 * fRec16[0]);
			double fRec91 = fTemp118 * fTemp119 / fTemp117;
			double fTemp120 = fRec18[0] * (1265.0 * fRec16[0] + fRec17[0] * (1.2e+02 - 1.27e+03 * fRec16[0]) + 956.0);
			double fTemp121 = std::tan(fConst5 * fTemp120);
			double fTemp122 = fTemp121 * (fTemp121 + fTemp2 / fTemp120) + 1.0;
			double fTemp123 = fTemp121 * (fTemp11 - fRec93[1]) + fRec92[1];
			fRec92[0] = 2.0 * (fTemp123 / fTemp122) - fRec92[1];
			fRec93[0] = fRec93[1] + 2.0 * (fTemp121 * fTemp123 / fTemp122);
			double fTemp124 = fRec17[0] * (0.016194260220710646 - 0.04017164138792575 * fRec16[0]) + (0.04296305701601583 - 0.009998228849321458 * fRec16[0]);
			double fRec94 = fTemp123 * fTemp124 / fTemp122;
			double fTemp125 = fRec18[0] * (fRec17[0] * (951.0 * fRec16[0] + -618.0) + (2282.0 - 463.0 * fRec16[0]));
			double fTemp126 = std::tan(fConst5 * fTemp125);
			double fTemp127 = fTemp126 * (fTemp126 + fTemp2 / fTemp125) + 1.0;
			double fTemp128 = fTemp126 * (fTemp11 - fRec96[1]) + fRec95[1];
			fRec95[0] = 2.0 * (fTemp128 / fTemp127) - fRec95[1];
			fRec96[0] = fRec96[1] + 2.0 * (fTemp126 * fTemp128 / fTemp127);
			double fTemp129 = fRec17[0] * (0.015993820877451798 - 0.03561073091810513 * fRec16[0]) + (0.035190168499954565 - 0.007711275872944394 * fRec16[0]);
			double fRec97 = fTemp128 * fTemp129 / fTemp127;
			double fTemp130 = fRec18[0] * (fRec17[0] * (803.0 - 1117.0 * fRec16[0]) + (1546.0 - 238.0 * fRec16[0]));
			double fTemp131 = std::tan(fConst5 * fTemp130);
			double fTemp132 = fTemp131 * (fTemp131 + fTemp2 / fTemp130) + 1.0;
			double fTemp133 = fTemp131 * (fTemp11 - fRec99[1]) + fRec98[1];
			fRec98[0] = 2.0 * (fTemp133 / fTemp132) - fRec98[1];
			fRec99[0] = fRec99[1] + 2.0 * (fTemp131 * fTemp133 / fTemp132);
			double fTemp134 = fRec17[0] * (0.012251807773129418 - 0.030545193317676356 * fRec16[0]) + (0.027814420294695608 - 0.002830824883261286 * fRec16[0]);
			double fRec100 = fTemp133 * fTemp134 / fTemp132;
			double fTemp135 = fRec18[0] * (fRec17[0] * (1.34e+03 * fRec16[0] + -102.0) + (1472.0 - 903.0 * fRec16[0]));
			double fTemp136 = std::tan(fConst5 * fTemp135);
			double fTemp137 = fTemp136 * (fTemp136 + fTemp2 / fTemp135) + 1.0;
			double fTemp138 = fTemp136 * (fTemp11 - fRec102[1]) + fRec101[1];
			fRec101[0] = 2.0 * (fTemp138 / fTemp137) - fRec101[1];
			fRec102[0] = fRec102[1] + 2.0 * (fTemp136 * fTemp138 / fTemp137);
			double fTemp139 = fRec17[0] * (0.008006093262504007 - 0.024671130121872657 * fRec16[0]) + (0.025451275008886335 - 0.003130799157219928 * fRec16[0]);
			double fRec103 = fTemp138 * fTemp139 / fTemp137;
			double fTemp140 = fRec18[0] * (fRec17[0] * (861.0 * fRec16[0] + -1231.0) + (2503.0 - 228.0 * fRec16[0]));
			double fTemp141 = std::tan(fConst5 * fTemp140);
			double fTemp142 = fTemp141 * (fTemp141 + fTemp2 / fTemp140) + 1.0;
			double fTemp143 = fTemp141 * (fTemp11 - fRec105[1]) + fRec104[1];
			fRec104[0] = 2.0 * (fTemp143 / fTemp142) - fRec104[1];
			fRec105[0] = fRec105[1] + 2.0 * (fTemp141 * fTemp143 / fTemp142);
			double fTemp144 = fRec17[0] * (0.002393508230319367 - 0.01643892312610763 * fRec16[0]) + (0.02376619002590769 - 0.004291546045942368 * fRec16[0]);
			double fRec106 = fTemp143 * fTemp144 / fTemp142;
			double fTemp145 = fRec18[0] * (1281.0 * fRec16[0] + fRec17[0] * (37.0 * fRec16[0] + -273.0) + 1251.0);
			double fTemp146 = std::tan(fConst5 * fTemp145);
			double fTemp147 = fTemp146 * (fTemp146 + fTemp2 / fTemp145) + 1.0;
			double fTemp148 = fTemp146 * (fTemp11 - fRec108[1]) + fRec107[1];
			fRec107[0] = 2.0 * (fTemp148 / fTemp147) - fRec107[1];
			fRec108[0] = fRec108[1] + 2.0 * (fTemp146 * fTemp148 / fTemp147);
			double fTemp149 = fRec17[0] * (0.001634210217413834 - 0.013674190403903216 * fRec16[0]) + (0.02108580284017779 - 0.003933981224376031 * fRec16[0]);
			double fRec109 = fTemp148 * fTemp149 / fTemp147;
			double fTemp150 = fRec18[0] * (1666.0 * fRec16[0] + fRec17[0] * (436.0 - 1213.0 * fRec16[0]) + 1325.0);
			double fTemp151 = std::tan(fConst5 * fTemp150);
			double fTemp152 = fTemp151 * (fTemp151 + fTemp2 / fTemp150) + 1.0;
			double fTemp153 = fTemp151 * (fTemp11 - fRec111[1]) + fRec110[1];
			fRec110[0] = 2.0 * (fTemp153 / fTemp152) - fRec110[1];
			fRec111[0] = fRec111[1] + 2.0 * (fTemp151 * fTemp153 / fTemp152);
			double fTemp154 = fRec17[0] * (-0.006947658589813211 - 0.0032192382202462302 * fRec16[0]) + (0.02080994218773682 - 0.006343538597854104 * fRec16[0]);
			double fRec112 = fTemp153 * fTemp154 / fTemp152;
			double fTemp155 = fRec18[0] * (81.0 * fRec16[0] + fRec17[0] * (972.0 - 715.0 * fRec16[0]) + 2061.0);
			double fTemp156 = std::tan(fConst5 * fTemp155);
			double fTemp157 = fTemp156 * (fTemp156 + fTemp2 / fTemp155) + 1.0;
			double fTemp158 = fTemp156 * (fTemp11 - fRec114[1]) + fRec113[1];
			fRec113[0] = 2.0 * (fTemp158 / fTemp157) - fRec113[1];
			fRec114[0] = fRec114[1] + 2.0 * (fTemp156 * fTemp158 / fTemp157);
			double fTemp159 = fRec17[0] * (0.0021589052725694453 * fRec16[0] + -0.008904165411473826) + (0.019359564369447416 - 0.008690192954800124 * fRec16[0]);
			double fRec115 = fTemp158 * fTemp159 / fTemp157;
			double fTemp160 = fRec18[0] * (fRec17[0] * (1.02e+03 - 1.62e+03 * fRec16[0]) + (2209.0 - 456.0 * fRec16[0]));
			double fTemp161 = std::tan(fConst5 * fTemp160);
			double fTemp162 = fTemp161 * (fTemp161 + fTemp2 / fTemp160) + 1.0;
			double fTemp163 = fTemp161 * (fTemp11 - fRec117[1]) + fRec116[1];
			fRec116[0] = 2.0 * (fTemp163 / fTemp162) - fRec116[1];
			fRec117[0] = fRec117[1] + 2.0 * (fTemp161 * fTemp163 / fTemp162);
			double fTemp164 = fRec17[0] * (0.005044160613158476 * fRec16[0] + -0.01013056637869131) + (0.018745547950376563 - 0.011232336533809374 * fRec16[0]);
			double fRec118 = fTemp163 * fTemp164 / fTemp162;
			double fTemp165 = fRec18[0] * (805.0 * fRec16[0] + fRec17[0] * (266.0 - 7.7e+02 * fRec16[0]) + 2572.0);
			double fTemp166 = std::tan(fConst5 * fTemp165);
			double fTemp167 = fTemp166 * (fTemp166 + fTemp2 / fTemp165) + 1.0;
			double fTemp168 = fTemp166 * (fTemp11 - fRec120[1]) + fRec119[1];
			fRec119[0] = 2.0 * (fTemp168 / fTemp167) - fRec119[1];
			fRec120[0] = fRec120[1] + 2.0 * (fTemp166 * fTemp168 / fTemp167);
			double fTemp169 = fRec17[0] * (0.0016378452192321808 * fRec16[0] + -0.004344936518553382) + (0.011249397635411025 - 0.006780823623904783 * fRec16[0]);
			double fRec121 = fTemp168 * fTemp169 / fTemp167;
			fRec122[0] = fSlow8 + fConst3 * fRec122[1];
			double fTemp170 = 1.0 - fRec122[0];
			fRec10[0] = fTemp11 * fRec122[0] + 0.03125 * fTemp170 * (fRec121 + fRec118 + fRec115 + fRec112 + fRec109 + fRec106 + fRec103 + fRec100 + fRec97 + fRec94 + fRec91 + fRec88 + fRec85 + fRec82 + fRec79 + fRec76 + fRec73 + fRec70 + fRec67 + fRec64 + fRec61 + fRec58 + fRec55 + fRec52 + fRec49 + fRec46 + fRec43 + fRec40 + fRec37 + fRec34 + fRec31 + fRec15);
			fVec3[0] = 1.3;
			double fTemp171 = 1.3 - fVec3[1];
			double fTemp172 = fRec11[1] + fRec21[1];
			fRec124[0] = fSlow9 + fConst3 * fRec124[1];
			double fTemp173 = fRec27[0] * (fRec10[1] * (fRec124[0] - fRec12[1]) - fRec11[1]);
			fVec4[0] = fTemp173 + fTemp172 + fTemp171;
			fRec123[0] = fTemp173 + 0.995 * fRec123[1] + fTemp172 + (1.3 - (fVec3[1] + fVec4[1]));
			double fTemp174 = tanh(fRec123[0] / fTemp0);
			double fTemp175 = fRec9[0] * fRec122[0];
			double fTemp176 = fRec9[0] * fTemp174;
			double fTemp177 = fTemp3 * (fTemp176 - fRec126[1]) + fRec125[1];
			fRec125[0] = 2.0 * (fTemp177 / fTemp4) - fRec125[1];
			fRec126[0] = fRec126[1] + 2.0 * (fTemp3 * fTemp177 / fTemp4);
			double fRec127 = fTemp13 * fTemp177 / fTemp4;
			double fTemp178 = fTemp15 * (fTemp176 - fRec129[1]) + fRec128[1];
			fRec128[0] = 2.0 * (fTemp178 / fTemp16) - fRec128[1];
			fRec129[0] = fRec129[1] + 2.0 * (fTemp15 * fTemp178 / fTemp16);
			double fRec130 = fTemp18 * fTemp178 / fTemp16;
			double fTemp179 = fTemp20 * (fTemp176 - fRec132[1]) + fRec131[1];
			fRec131[0] = 2.0 * (fTemp179 / fTemp21) - fRec131[1];
			fRec132[0] = fRec132[1] + 2.0 * (fTemp20 * fTemp179 / fTemp21);
			double fRec133 = fTemp23 * fTemp179 / fTemp21;
			double fTemp180 = fTemp25 * (fTemp176 - fRec135[1]) + fRec134[1];
			fRec134[0] = 2.0 * (fTemp180 / fTemp26) - fRec134[1];
			fRec135[0] = fRec135[1] + 2.0 * (fTemp25 * fTemp180 / fTemp26);
			double fRec136 = fTemp28 * fTemp180 / fTemp26;
			double fTemp181 = fTemp30 * (fTemp176 - fRec138[1]) + fRec137[1];
			fRec137[0] = 2.0 * (fTemp181 / fTemp31) - fRec137[1];
			fRec138[0] = fRec138[1] + 2.0 * (fTemp30 * fTemp181 / fTemp31);
			double fRec139 = fTemp33 * fTemp181 / fTemp31;
			double fTemp182 = fTemp35 * (fTemp176 - fRec141[1]) + fRec140[1];
			fRec140[0] = 2.0 * (fTemp182 / fTemp36) - fRec140[1];
			fRec141[0] = fRec141[1] + 2.0 * (fTemp35 * fTemp182 / fTemp36);
			double fRec142 = fTemp38 * fTemp182 / fTemp36;
			double fTemp183 = fTemp40 * (fTemp176 - fRec144[1]) + fRec143[1];
			fRec143[0] = 2.0 * (fTemp183 / fTemp41) - fRec143[1];
			fRec144[0] = fRec144[1] + 2.0 * (fTemp40 * fTemp183 / fTemp41);
			double fRec145 = fTemp43 * fTemp183 / fTemp41;
			double fTemp184 = fTemp45 * (fTemp176 - fRec147[1]) + fRec146[1];
			fRec146[0] = 2.0 * (fTemp184 / fTemp46) - fRec146[1];
			fRec147[0] = fRec147[1] + 2.0 * (fTemp45 * fTemp184 / fTemp46);
			double fRec148 = fTemp48 * fTemp184 / fTemp46;
			double fTemp185 = fTemp50 * (fTemp176 - fRec150[1]) + fRec149[1];
			fRec149[0] = 2.0 * (fTemp185 / fTemp51) - fRec149[1];
			fRec150[0] = fRec150[1] + 2.0 * (fTemp50 * fTemp185 / fTemp51);
			double fRec151 = fTemp53 * fTemp185 / fTemp51;
			double fTemp186 = fTemp55 * (fTemp176 - fRec153[1]) + fRec152[1];
			fRec152[0] = 2.0 * (fTemp186 / fTemp56) - fRec152[1];
			fRec153[0] = fRec153[1] + 2.0 * (fTemp55 * fTemp186 / fTemp56);
			double fRec154 = fTemp58 * fTemp186 / fTemp56;
			double fTemp187 = fTemp61 * (fTemp176 - fRec156[1]) + fRec155[1];
			fRec155[0] = 2.0 * (fTemp187 / fTemp62) - fRec155[1];
			fRec156[0] = fRec156[1] + 2.0 * (fTemp61 * fTemp187 / fTemp62);
			double fRec157 = fTemp64 * fTemp187 / fTemp62;
			double fTemp188 = fTemp66 * (fTemp176 - fRec159[1]) + fRec158[1];
			fRec158[0] = 2.0 * (fTemp188 / fTemp67) - fRec158[1];
			fRec159[0] = fRec159[1] + 2.0 * (fTemp66 * fTemp188 / fTemp67);
			double fRec160 = fTemp69 * fTemp188 / fTemp67;
			double fTemp189 = fTemp71 * (fTemp176 - fRec162[1]) + fRec161[1];
			fRec161[0] = 2.0 * (fTemp189 / fTemp72) - fRec161[1];
			fRec162[0] = fRec162[1] + 2.0 * (fTemp71 * fTemp189 / fTemp72);
			double fRec163 = fTemp74 * fTemp189 / fTemp72;
			double fTemp190 = fTemp76 * (fTemp176 - fRec165[1]) + fRec164[1];
			fRec164[0] = 2.0 * (fTemp190 / fTemp77) - fRec164[1];
			fRec165[0] = fRec165[1] + 2.0 * (fTemp76 * fTemp190 / fTemp77);
			double fRec166 = fTemp79 * fTemp190 / fTemp77;
			double fTemp191 = fTemp81 * (fTemp176 - fRec168[1]) + fRec167[1];
			fRec167[0] = 2.0 * (fTemp191 / fTemp82) - fRec167[1];
			fRec168[0] = fRec168[1] + 2.0 * (fTemp81 * fTemp191 / fTemp82);
			double fRec169 = fTemp84 * fTemp191 / fTemp82;
			double fTemp192 = fTemp86 * (fTemp176 - fRec171[1]) + fRec170[1];
			fRec170[0] = 2.0 * (fTemp192 / fTemp87) - fRec170[1];
			fRec171[0] = fRec171[1] + 2.0 * (fTemp86 * fTemp192 / fTemp87);
			double fRec172 = fTemp89 * fTemp192 / fTemp87;
			double fTemp193 = fTemp91 * (fTemp176 - fRec174[1]) + fRec173[1];
			double fTemp194 = fTemp193 / fTemp92;
			fRec173[0] = 2.0 * fTemp194 - fRec173[1];
			fRec174[0] = fRec174[1] + 2.0 * (fTemp91 * fTemp193 / fTemp92);
			double fRec175 = fTemp194;
			double fTemp195 = fTemp96 * (fTemp176 - fRec177[1]) + fRec176[1];
			fRec176[0] = 2.0 * (fTemp195 / fTemp97) - fRec176[1];
			fRec177[0] = fRec177[1] + 2.0 * (fTemp96 * fTemp195 / fTemp97);
			double fRec178 = fTemp99 * fTemp195 / fTemp97;
			double fTemp196 = fTemp101 * (fTemp176 - fRec180[1]) + fRec179[1];
			fRec179[0] = 2.0 * (fTemp196 / fTemp102) - fRec179[1];
			fRec180[0] = fRec180[1] + 2.0 * (fTemp101 * fTemp196 / fTemp102);
			double fRec181 = fTemp104 * fTemp196 / fTemp102;
			double fTemp197 = fTemp106 * (fTemp176 - fRec183[1]) + fRec182[1];
			fRec182[0] = 2.0 * (fTemp197 / fTemp107) - fRec182[1];
			fRec183[0] = fRec183[1] + 2.0 * (fTemp106 * fTemp197 / fTemp107);
			double fRec184 = fTemp109 * fTemp197 / fTemp107;
			double fTemp198 = fTemp111 * (fTemp176 - fRec186[1]) + fRec185[1];
			fRec185[0] = 2.0 * (fTemp198 / fTemp112) - fRec185[1];
			fRec186[0] = fRec186[1] + 2.0 * (fTemp111 * fTemp198 / fTemp112);
			double fRec187 = fTemp114 * fTemp198 / fTemp112;
			double fTemp199 = fTemp116 * (fTemp176 - fRec189[1]) + fRec188[1];
			fRec188[0] = 2.0 * (fTemp199 / fTemp117) - fRec188[1];
			fRec189[0] = fRec189[1] + 2.0 * (fTemp116 * fTemp199 / fTemp117);
			double fRec190 = fTemp119 * fTemp199 / fTemp117;
			double fTemp200 = fTemp121 * (fTemp176 - fRec192[1]) + fRec191[1];
			fRec191[0] = 2.0 * (fTemp200 / fTemp122) - fRec191[1];
			fRec192[0] = fRec192[1] + 2.0 * (fTemp121 * fTemp200 / fTemp122);
			double fRec193 = fTemp124 * fTemp200 / fTemp122;
			double fTemp201 = fTemp126 * (fTemp176 - fRec195[1]) + fRec194[1];
			fRec194[0] = 2.0 * (fTemp201 / fTemp127) - fRec194[1];
			fRec195[0] = fRec195[1] + 2.0 * (fTemp126 * fTemp201 / fTemp127);
			double fRec196 = fTemp129 * fTemp201 / fTemp127;
			double fTemp202 = fTemp131 * (fTemp176 - fRec198[1]) + fRec197[1];
			fRec197[0] = 2.0 * (fTemp202 / fTemp132) - fRec197[1];
			fRec198[0] = fRec198[1] + 2.0 * (fTemp131 * fTemp202 / fTemp132);
			double fRec199 = fTemp134 * fTemp202 / fTemp132;
			double fTemp203 = fTemp136 * (fTemp176 - fRec201[1]) + fRec200[1];
			fRec200[0] = 2.0 * (fTemp203 / fTemp137) - fRec200[1];
			fRec201[0] = fRec201[1] + 2.0 * (fTemp136 * fTemp203 / fTemp137);
			double fRec202 = fTemp139 * fTemp203 / fTemp137;
			double fTemp204 = fTemp141 * (fTemp176 - fRec204[1]) + fRec203[1];
			fRec203[0] = 2.0 * (fTemp204 / fTemp142) - fRec203[1];
			fRec204[0] = fRec204[1] + 2.0 * (fTemp141 * fTemp204 / fTemp142);
			double fRec205 = fTemp144 * fTemp204 / fTemp142;
			double fTemp205 = fTemp146 * (fTemp176 - fRec207[1]) + fRec206[1];
			fRec206[0] = 2.0 * (fTemp205 / fTemp147) - fRec206[1];
			fRec207[0] = fRec207[1] + 2.0 * (fTemp146 * fTemp205 / fTemp147);
			double fRec208 = fTemp149 * fTemp205 / fTemp147;
			double fTemp206 = fTemp151 * (fTemp176 - fRec210[1]) + fRec209[1];
			fRec209[0] = 2.0 * (fTemp206 / fTemp152) - fRec209[1];
			fRec210[0] = fRec210[1] + 2.0 * (fTemp151 * fTemp206 / fTemp152);
			double fRec211 = fTemp154 * fTemp206 / fTemp152;
			double fTemp207 = fTemp156 * (fTemp176 - fRec213[1]) + fRec212[1];
			fRec212[0] = 2.0 * (fTemp207 / fTemp157) - fRec212[1];
			fRec213[0] = fRec213[1] + 2.0 * (fTemp156 * fTemp207 / fTemp157);
			double fRec214 = fTemp159 * fTemp207 / fTemp157;
			double fTemp208 = fTemp161 * (fTemp176 - fRec216[1]) + fRec215[1];
			fRec215[0] = 2.0 * (fTemp208 / fTemp162) - fRec215[1];
			fRec216[0] = fRec216[1] + 2.0 * (fTemp161 * fTemp208 / fTemp162);
			double fRec217 = fTemp164 * fTemp208 / fTemp162;
			double fTemp209 = fTemp166 * (fTemp176 - fRec219[1]) + fRec218[1];
			fRec218[0] = 2.0 * (fTemp209 / fTemp167) - fRec218[1];
			fRec219[0] = fRec219[1] + 2.0 * (fTemp166 * fTemp209 / fTemp167);
			double fRec220 = fTemp169 * fTemp209 / fTemp167;
			fRec11[0] = 0.03125 * fTemp170 * (fRec220 + fRec217 + fRec214 + fRec211 + fRec208 + fRec205 + fRec202 + fRec199 + fRec196 + fRec193 + fRec190 + fRec187 + fRec184 + fRec181 + fRec178 + fRec175 + fRec172 + fRec169 + fRec166 + fRec163 + fRec160 + fRec157 + fRec154 + fRec151 + fRec148 + fRec145 + fRec142 + fRec139 + fRec136 + fRec133 + fRec130 + fRec127) + fTemp175 * fTemp174;
			fVec5[0] = 1.6;
			double fTemp210 = 1.6 - fVec5[1];
			double fTemp211 = fRec21[1] + fRec12[1];
			fRec222[0] = fSlow10 + fConst3 * fRec222[1];
			double fTemp212 = fRec27[0] * (fRec10[1] * fRec11[1] - fRec222[0] * fRec12[1]);
			fVec6[0] = fTemp212 + fTemp211 + fTemp210;
			fRec221[0] = fTemp212 + 0.995 * fRec221[1] + fTemp211 + (1.6 - (fVec5[1] + fVec6[1]));
			double fTemp213 = tanh(fRec221[0] / fTemp0);
			double fTemp214 = fRec9[0] * fTemp213;
			double fTemp215 = fTemp3 * (fTemp214 - fRec224[1]) + fRec223[1];
			fRec223[0] = 2.0 * (fTemp215 / fTemp4) - fRec223[1];
			fRec224[0] = fRec224[1] + 2.0 * (fTemp3 * fTemp215 / fTemp4);
			double fRec225 = fTemp13 * fTemp215 / fTemp4;
			double fTemp216 = fTemp15 * (fTemp214 - fRec227[1]) + fRec226[1];
			fRec226[0] = 2.0 * (fTemp216 / fTemp16) - fRec226[1];
			fRec227[0] = fRec227[1] + 2.0 * (fTemp15 * fTemp216 / fTemp16);
			double fRec228 = fTemp18 * fTemp216 / fTemp16;
			double fTemp217 = fTemp20 * (fTemp214 - fRec230[1]) + fRec229[1];
			fRec229[0] = 2.0 * (fTemp217 / fTemp21) - fRec229[1];
			fRec230[0] = fRec230[1] + 2.0 * (fTemp20 * fTemp217 / fTemp21);
			double fRec231 = fTemp23 * fTemp217 / fTemp21;
			double fTemp218 = fTemp25 * (fTemp214 - fRec233[1]) + fRec232[1];
			fRec232[0] = 2.0 * (fTemp218 / fTemp26) - fRec232[1];
			fRec233[0] = fRec233[1] + 2.0 * (fTemp25 * fTemp218 / fTemp26);
			double fRec234 = fTemp28 * fTemp218 / fTemp26;
			double fTemp219 = fTemp30 * (fTemp214 - fRec236[1]) + fRec235[1];
			fRec235[0] = 2.0 * (fTemp219 / fTemp31) - fRec235[1];
			fRec236[0] = fRec236[1] + 2.0 * (fTemp30 * fTemp219 / fTemp31);
			double fRec237 = fTemp33 * fTemp219 / fTemp31;
			double fTemp220 = fTemp35 * (fTemp214 - fRec239[1]) + fRec238[1];
			fRec238[0] = 2.0 * (fTemp220 / fTemp36) - fRec238[1];
			fRec239[0] = fRec239[1] + 2.0 * (fTemp35 * fTemp220 / fTemp36);
			double fRec240 = fTemp38 * fTemp220 / fTemp36;
			double fTemp221 = fTemp40 * (fTemp214 - fRec242[1]) + fRec241[1];
			fRec241[0] = 2.0 * (fTemp221 / fTemp41) - fRec241[1];
			fRec242[0] = fRec242[1] + 2.0 * (fTemp40 * fTemp221 / fTemp41);
			double fRec243 = fTemp43 * fTemp221 / fTemp41;
			double fTemp222 = fTemp45 * (fTemp214 - fRec245[1]) + fRec244[1];
			fRec244[0] = 2.0 * (fTemp222 / fTemp46) - fRec244[1];
			fRec245[0] = fRec245[1] + 2.0 * (fTemp45 * fTemp222 / fTemp46);
			double fRec246 = fTemp48 * fTemp222 / fTemp46;
			double fTemp223 = fTemp50 * (fTemp214 - fRec248[1]) + fRec247[1];
			fRec247[0] = 2.0 * (fTemp223 / fTemp51) - fRec247[1];
			fRec248[0] = fRec248[1] + 2.0 * (fTemp50 * fTemp223 / fTemp51);
			double fRec249 = fTemp53 * fTemp223 / fTemp51;
			double fTemp224 = fTemp55 * (fTemp214 - fRec251[1]) + fRec250[1];
			fRec250[0] = 2.0 * (fTemp224 / fTemp56) - fRec250[1];
			fRec251[0] = fRec251[1] + 2.0 * (fTemp55 * fTemp224 / fTemp56);
			double fRec252 = fTemp58 * fTemp224 / fTemp56;
			double fTemp225 = fTemp61 * (fTemp214 - fRec254[1]) + fRec253[1];
			fRec253[0] = 2.0 * (fTemp225 / fTemp62) - fRec253[1];
			fRec254[0] = fRec254[1] + 2.0 * (fTemp61 * fTemp225 / fTemp62);
			double fRec255 = fTemp64 * fTemp225 / fTemp62;
			double fTemp226 = fTemp66 * (fTemp214 - fRec257[1]) + fRec256[1];
			fRec256[0] = 2.0 * (fTemp226 / fTemp67) - fRec256[1];
			fRec257[0] = fRec257[1] + 2.0 * (fTemp66 * fTemp226 / fTemp67);
			double fRec258 = fTemp69 * fTemp226 / fTemp67;
			double fTemp227 = fTemp71 * (fTemp214 - fRec260[1]) + fRec259[1];
			fRec259[0] = 2.0 * (fTemp227 / fTemp72) - fRec259[1];
			fRec260[0] = fRec260[1] + 2.0 * (fTemp71 * fTemp227 / fTemp72);
			double fRec261 = fTemp74 * fTemp227 / fTemp72;
			double fTemp228 = fTemp76 * (fTemp214 - fRec263[1]) + fRec262[1];
			fRec262[0] = 2.0 * (fTemp228 / fTemp77) - fRec262[1];
			fRec263[0] = fRec263[1] + 2.0 * (fTemp76 * fTemp228 / fTemp77);
			double fRec264 = fTemp79 * fTemp228 / fTemp77;
			double fTemp229 = fTemp81 * (fTemp214 - fRec266[1]) + fRec265[1];
			fRec265[0] = 2.0 * (fTemp229 / fTemp82) - fRec265[1];
			fRec266[0] = fRec266[1] + 2.0 * (fTemp81 * fTemp229 / fTemp82);
			double fRec267 = fTemp84 * fTemp229 / fTemp82;
			double fTemp230 = fTemp86 * (fTemp214 - fRec269[1]) + fRec268[1];
			fRec268[0] = 2.0 * (fTemp230 / fTemp87) - fRec268[1];
			fRec269[0] = fRec269[1] + 2.0 * (fTemp86 * fTemp230 / fTemp87);
			double fRec270 = fTemp89 * fTemp230 / fTemp87;
			double fTemp231 = fTemp91 * (fTemp214 - fRec272[1]) + fRec271[1];
			double fTemp232 = fTemp231 / fTemp92;
			fRec271[0] = 2.0 * fTemp232 - fRec271[1];
			fRec272[0] = fRec272[1] + 2.0 * (fTemp91 * fTemp231 / fTemp92);
			double fRec273 = fTemp232;
			double fTemp233 = fTemp96 * (fTemp214 - fRec275[1]) + fRec274[1];
			fRec274[0] = 2.0 * (fTemp233 / fTemp97) - fRec274[1];
			fRec275[0] = fRec275[1] + 2.0 * (fTemp96 * fTemp233 / fTemp97);
			double fRec276 = fTemp99 * fTemp233 / fTemp97;
			double fTemp234 = fTemp101 * (fTemp214 - fRec278[1]) + fRec277[1];
			fRec277[0] = 2.0 * (fTemp234 / fTemp102) - fRec277[1];
			fRec278[0] = fRec278[1] + 2.0 * (fTemp101 * fTemp234 / fTemp102);
			double fRec279 = fTemp104 * fTemp234 / fTemp102;
			double fTemp235 = fTemp106 * (fTemp214 - fRec281[1]) + fRec280[1];
			fRec280[0] = 2.0 * (fTemp235 / fTemp107) - fRec280[1];
			fRec281[0] = fRec281[1] + 2.0 * (fTemp106 * fTemp235 / fTemp107);
			double fRec282 = fTemp109 * fTemp235 / fTemp107;
			double fTemp236 = fTemp111 * (fTemp214 - fRec284[1]) + fRec283[1];
			fRec283[0] = 2.0 * (fTemp236 / fTemp112) - fRec283[1];
			fRec284[0] = fRec284[1] + 2.0 * (fTemp111 * fTemp236 / fTemp112);
			double fRec285 = fTemp114 * fTemp236 / fTemp112;
			double fTemp237 = fTemp116 * (fTemp214 - fRec287[1]) + fRec286[1];
			fRec286[0] = 2.0 * (fTemp237 / fTemp117) - fRec286[1];
			fRec287[0] = fRec287[1] + 2.0 * (fTemp116 * fTemp237 / fTemp117);
			double fRec288 = fTemp119 * fTemp237 / fTemp117;
			double fTemp238 = fTemp121 * (fTemp214 - fRec290[1]) + fRec289[1];
			fRec289[0] = 2.0 * (fTemp238 / fTemp122) - fRec289[1];
			fRec290[0] = fRec290[1] + 2.0 * (fTemp121 * fTemp238 / fTemp122);
			double fRec291 = fTemp124 * fTemp238 / fTemp122;
			double fTemp239 = fTemp126 * (fTemp214 - fRec293[1]) + fRec292[1];
			fRec292[0] = 2.0 * (fTemp239 / fTemp127) - fRec292[1];
			fRec293[0] = fRec293[1] + 2.0 * (fTemp126 * fTemp239 / fTemp127);
			double fRec294 = fTemp129 * fTemp239 / fTemp127;
			double fTemp240 = fTemp131 * (fTemp214 - fRec296[1]) + fRec295[1];
			fRec295[0] = 2.0 * (fTemp240 / fTemp132) - fRec295[1];
			fRec296[0] = fRec296[1] + 2.0 * (fTemp131 * fTemp240 / fTemp132);
			double fRec297 = fTemp134 * fTemp240 / fTemp132;
			double fTemp241 = fTemp136 * (fTemp214 - fRec299[1]) + fRec298[1];
			fRec298[0] = 2.0 * (fTemp241 / fTemp137) - fRec298[1];
			fRec299[0] = fRec299[1] + 2.0 * (fTemp136 * fTemp241 / fTemp137);
			double fRec300 = fTemp139 * fTemp241 / fTemp137;
			double fTemp242 = fTemp141 * (fTemp214 - fRec302[1]) + fRec301[1];
			fRec301[0] = 2.0 * (fTemp242 / fTemp142) - fRec301[1];
			fRec302[0] = fRec302[1] + 2.0 * (fTemp141 * fTemp242 / fTemp142);
			double fRec303 = fTemp144 * fTemp242 / fTemp142;
			double fTemp243 = fTemp146 * (fTemp214 - fRec305[1]) + fRec304[1];
			fRec304[0] = 2.0 * (fTemp243 / fTemp147) - fRec304[1];
			fRec305[0] = fRec305[1] + 2.0 * (fTemp146 * fTemp243 / fTemp147);
			double fRec306 = fTemp149 * fTemp243 / fTemp147;
			double fTemp244 = fTemp151 * (fTemp214 - fRec308[1]) + fRec307[1];
			fRec307[0] = 2.0 * (fTemp244 / fTemp152) - fRec307[1];
			fRec308[0] = fRec308[1] + 2.0 * (fTemp151 * fTemp244 / fTemp152);
			double fRec309 = fTemp154 * fTemp244 / fTemp152;
			double fTemp245 = fTemp156 * (fTemp214 - fRec311[1]) + fRec310[1];
			fRec310[0] = 2.0 * (fTemp245 / fTemp157) - fRec310[1];
			fRec311[0] = fRec311[1] + 2.0 * (fTemp156 * fTemp245 / fTemp157);
			double fRec312 = fTemp159 * fTemp245 / fTemp157;
			double fTemp246 = fTemp161 * (fTemp214 - fRec314[1]) + fRec313[1];
			fRec313[0] = 2.0 * (fTemp246 / fTemp162) - fRec313[1];
			fRec314[0] = fRec314[1] + 2.0 * (fTemp161 * fTemp246 / fTemp162);
			double fRec315 = fTemp164 * fTemp246 / fTemp162;
			double fTemp247 = fTemp166 * (fTemp214 - fRec317[1]) + fRec316[1];
			fRec316[0] = 2.0 * (fTemp247 / fTemp167) - fRec316[1];
			fRec317[0] = fRec317[1] + 2.0 * (fTemp166 * fTemp247 / fTemp167);
			double fRec318 = fTemp169 * fTemp247 / fTemp167;
			fRec12[0] = 0.03125 * fTemp170 * (fRec318 + fRec315 + fRec312 + fRec309 + fRec306 + fRec303 + fRec300 + fRec297 + fRec294 + fRec291 + fRec288 + fRec285 + fRec282 + fRec279 + fRec276 + fRec273 + fRec270 + fRec267 + fRec264 + fRec261 + fRec258 + fRec255 + fRec252 + fRec249 + fRec246 + fRec243 + fRec240 + fRec237 + fRec234 + fRec231 + fRec228 + fRec225) + fTemp175 * fTemp213;
			double fTemp248 = (fRec12[0] + fRec10[0] + fRec11[0]) / fTemp0;
			fVec7[IOTA0 & 4194303] = fTemp248;
			fRec5[IOTA0 & 511] = 0.3333333333333333 * fTemp248;
			double fTemp249 = ((fRec324[1] != 0.0) ? (((fRec325[1] > 0.0) & (fRec325[1] < 1.0)) ? fRec324[1] : 0.0) : (((fRec325[1] == 0.0) & (fConst8 != fRec326[1])) ? 0.0009765625 : (((fRec325[1] == 1.0) & (fConst8 != fRec327[1])) ? -0.0009765625 : 0.0)));
			fRec324[0] = fTemp249;
			fRec325[0] = std::max<double>(0.0, std::min<double>(1.0, fRec325[1] + fTemp249));
			fRec326[0] = (((fRec325[1] >= 1.0) & (fRec327[1] != fConst8)) ? fConst8 : fRec326[1]);
			fRec327[0] = (((fRec325[1] <= 0.0) & (fRec326[1] != fConst8)) ? fConst8 : fRec327[1]);
			double fTemp250 = fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec326[0])))) & 4194303];
			fRec323[0] = 0.25 * fTemp250 + fRec325[0] * (0.0 - 0.25 * (fTemp250 - fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec327[0])))) & 4194303]));
			double fTemp251 = fTemp9 * (fRec320[1] - fRec319[1]);
			fVec8[0] = fRec319[1] + fTemp251 + fRec323[1] + fTemp5;
			fRec322[0] = fRec323[1] + fTemp251 + 0.995 * fRec322[1] + fRec319[1] + (1.2 - (fVec0[1] + fVec8[1]));
			double fTemp252 = tanh(fRec322[0] / fTemp0);
			double fTemp253 = fRec9[0] * fTemp252;
			double fTemp254 = fTemp3 * (fTemp253 - fRec329[1]) + fRec328[1];
			fRec328[0] = 2.0 * (fTemp254 / fTemp4) - fRec328[1];
			fRec329[0] = fRec329[1] + 2.0 * (fTemp3 * fTemp254 / fTemp4);
			double fRec330 = fTemp13 * fTemp254 / fTemp4;
			double fTemp255 = fTemp15 * (fTemp253 - fRec332[1]) + fRec331[1];
			fRec331[0] = 2.0 * (fTemp255 / fTemp16) - fRec331[1];
			fRec332[0] = fRec332[1] + 2.0 * (fTemp15 * fTemp255 / fTemp16);
			double fRec333 = fTemp18 * fTemp255 / fTemp16;
			double fTemp256 = fTemp20 * (fTemp253 - fRec335[1]) + fRec334[1];
			fRec334[0] = 2.0 * (fTemp256 / fTemp21) - fRec334[1];
			fRec335[0] = fRec335[1] + 2.0 * (fTemp20 * fTemp256 / fTemp21);
			double fRec336 = fTemp23 * fTemp256 / fTemp21;
			double fTemp257 = fTemp25 * (fTemp253 - fRec338[1]) + fRec337[1];
			fRec337[0] = 2.0 * (fTemp257 / fTemp26) - fRec337[1];
			fRec338[0] = fRec338[1] + 2.0 * (fTemp25 * fTemp257 / fTemp26);
			double fRec339 = fTemp28 * fTemp257 / fTemp26;
			double fTemp258 = fTemp30 * (fTemp253 - fRec341[1]) + fRec340[1];
			fRec340[0] = 2.0 * (fTemp258 / fTemp31) - fRec340[1];
			fRec341[0] = fRec341[1] + 2.0 * (fTemp30 * fTemp258 / fTemp31);
			double fRec342 = fTemp33 * fTemp258 / fTemp31;
			double fTemp259 = fTemp35 * (fTemp253 - fRec344[1]) + fRec343[1];
			fRec343[0] = 2.0 * (fTemp259 / fTemp36) - fRec343[1];
			fRec344[0] = fRec344[1] + 2.0 * (fTemp35 * fTemp259 / fTemp36);
			double fRec345 = fTemp38 * fTemp259 / fTemp36;
			double fTemp260 = fTemp40 * (fTemp253 - fRec347[1]) + fRec346[1];
			fRec346[0] = 2.0 * (fTemp260 / fTemp41) - fRec346[1];
			fRec347[0] = fRec347[1] + 2.0 * (fTemp40 * fTemp260 / fTemp41);
			double fRec348 = fTemp43 * fTemp260 / fTemp41;
			double fTemp261 = fTemp45 * (fTemp253 - fRec350[1]) + fRec349[1];
			fRec349[0] = 2.0 * (fTemp261 / fTemp46) - fRec349[1];
			fRec350[0] = fRec350[1] + 2.0 * (fTemp45 * fTemp261 / fTemp46);
			double fRec351 = fTemp48 * fTemp261 / fTemp46;
			double fTemp262 = fTemp50 * (fTemp253 - fRec353[1]) + fRec352[1];
			fRec352[0] = 2.0 * (fTemp262 / fTemp51) - fRec352[1];
			fRec353[0] = fRec353[1] + 2.0 * (fTemp50 * fTemp262 / fTemp51);
			double fRec354 = fTemp53 * fTemp262 / fTemp51;
			double fTemp263 = fTemp55 * (fTemp253 - fRec356[1]) + fRec355[1];
			fRec355[0] = 2.0 * (fTemp263 / fTemp56) - fRec355[1];
			fRec356[0] = fRec356[1] + 2.0 * (fTemp55 * fTemp263 / fTemp56);
			double fRec357 = fTemp58 * fTemp263 / fTemp56;
			double fTemp264 = fTemp61 * (fTemp253 - fRec359[1]) + fRec358[1];
			fRec358[0] = 2.0 * (fTemp264 / fTemp62) - fRec358[1];
			fRec359[0] = fRec359[1] + 2.0 * (fTemp61 * fTemp264 / fTemp62);
			double fRec360 = fTemp64 * fTemp264 / fTemp62;
			double fTemp265 = fTemp66 * (fTemp253 - fRec362[1]) + fRec361[1];
			fRec361[0] = 2.0 * (fTemp265 / fTemp67) - fRec361[1];
			fRec362[0] = fRec362[1] + 2.0 * (fTemp66 * fTemp265 / fTemp67);
			double fRec363 = fTemp69 * fTemp265 / fTemp67;
			double fTemp266 = fTemp71 * (fTemp253 - fRec365[1]) + fRec364[1];
			fRec364[0] = 2.0 * (fTemp266 / fTemp72) - fRec364[1];
			fRec365[0] = fRec365[1] + 2.0 * (fTemp71 * fTemp266 / fTemp72);
			double fRec366 = fTemp74 * fTemp266 / fTemp72;
			double fTemp267 = fTemp76 * (fTemp253 - fRec368[1]) + fRec367[1];
			fRec367[0] = 2.0 * (fTemp267 / fTemp77) - fRec367[1];
			fRec368[0] = fRec368[1] + 2.0 * (fTemp76 * fTemp267 / fTemp77);
			double fRec369 = fTemp79 * fTemp267 / fTemp77;
			double fTemp268 = fTemp81 * (fTemp253 - fRec371[1]) + fRec370[1];
			fRec370[0] = 2.0 * (fTemp268 / fTemp82) - fRec370[1];
			fRec371[0] = fRec371[1] + 2.0 * (fTemp81 * fTemp268 / fTemp82);
			double fRec372 = fTemp84 * fTemp268 / fTemp82;
			double fTemp269 = fTemp86 * (fTemp253 - fRec374[1]) + fRec373[1];
			fRec373[0] = 2.0 * (fTemp269 / fTemp87) - fRec373[1];
			fRec374[0] = fRec374[1] + 2.0 * (fTemp86 * fTemp269 / fTemp87);
			double fRec375 = fTemp89 * fTemp269 / fTemp87;
			double fTemp270 = fTemp91 * (fTemp253 - fRec377[1]) + fRec376[1];
			double fTemp271 = fTemp270 / fTemp92;
			fRec376[0] = 2.0 * fTemp271 - fRec376[1];
			fRec377[0] = fRec377[1] + 2.0 * (fTemp91 * fTemp270 / fTemp92);
			double fRec378 = fTemp271;
			double fTemp272 = fTemp96 * (fTemp253 - fRec380[1]) + fRec379[1];
			fRec379[0] = 2.0 * (fTemp272 / fTemp97) - fRec379[1];
			fRec380[0] = fRec380[1] + 2.0 * (fTemp96 * fTemp272 / fTemp97);
			double fRec381 = fTemp99 * fTemp272 / fTemp97;
			double fTemp273 = fTemp101 * (fTemp253 - fRec383[1]) + fRec382[1];
			fRec382[0] = 2.0 * (fTemp273 / fTemp102) - fRec382[1];
			fRec383[0] = fRec383[1] + 2.0 * (fTemp101 * fTemp273 / fTemp102);
			double fRec384 = fTemp104 * fTemp273 / fTemp102;
			double fTemp274 = fTemp106 * (fTemp253 - fRec386[1]) + fRec385[1];
			fRec385[0] = 2.0 * (fTemp274 / fTemp107) - fRec385[1];
			fRec386[0] = fRec386[1] + 2.0 * (fTemp106 * fTemp274 / fTemp107);
			double fRec387 = fTemp109 * fTemp274 / fTemp107;
			double fTemp275 = fTemp111 * (fTemp253 - fRec389[1]) + fRec388[1];
			fRec388[0] = 2.0 * (fTemp275 / fTemp112) - fRec388[1];
			fRec389[0] = fRec389[1] + 2.0 * (fTemp111 * fTemp275 / fTemp112);
			double fRec390 = fTemp114 * fTemp275 / fTemp112;
			double fTemp276 = fTemp116 * (fTemp253 - fRec392[1]) + fRec391[1];
			fRec391[0] = 2.0 * (fTemp276 / fTemp117) - fRec391[1];
			fRec392[0] = fRec392[1] + 2.0 * (fTemp116 * fTemp276 / fTemp117);
			double fRec393 = fTemp119 * fTemp276 / fTemp117;
			double fTemp277 = fTemp121 * (fTemp253 - fRec395[1]) + fRec394[1];
			fRec394[0] = 2.0 * (fTemp277 / fTemp122) - fRec394[1];
			fRec395[0] = fRec395[1] + 2.0 * (fTemp121 * fTemp277 / fTemp122);
			double fRec396 = fTemp124 * fTemp277 / fTemp122;
			double fTemp278 = fTemp126 * (fTemp253 - fRec398[1]) + fRec397[1];
			fRec397[0] = 2.0 * (fTemp278 / fTemp127) - fRec397[1];
			fRec398[0] = fRec398[1] + 2.0 * (fTemp126 * fTemp278 / fTemp127);
			double fRec399 = fTemp129 * fTemp278 / fTemp127;
			double fTemp279 = fTemp131 * (fTemp253 - fRec401[1]) + fRec400[1];
			fRec400[0] = 2.0 * (fTemp279 / fTemp132) - fRec400[1];
			fRec401[0] = fRec401[1] + 2.0 * (fTemp131 * fTemp279 / fTemp132);
			double fRec402 = fTemp134 * fTemp279 / fTemp132;
			double fTemp280 = fTemp136 * (fTemp253 - fRec404[1]) + fRec403[1];
			fRec403[0] = 2.0 * (fTemp280 / fTemp137) - fRec403[1];
			fRec404[0] = fRec404[1] + 2.0 * (fTemp136 * fTemp280 / fTemp137);
			double fRec405 = fTemp139 * fTemp280 / fTemp137;
			double fTemp281 = fTemp141 * (fTemp253 - fRec407[1]) + fRec406[1];
			fRec406[0] = 2.0 * (fTemp281 / fTemp142) - fRec406[1];
			fRec407[0] = fRec407[1] + 2.0 * (fTemp141 * fTemp281 / fTemp142);
			double fRec408 = fTemp144 * fTemp281 / fTemp142;
			double fTemp282 = fTemp146 * (fTemp253 - fRec410[1]) + fRec409[1];
			fRec409[0] = 2.0 * (fTemp282 / fTemp147) - fRec409[1];
			fRec410[0] = fRec410[1] + 2.0 * (fTemp146 * fTemp282 / fTemp147);
			double fRec411 = fTemp149 * fTemp282 / fTemp147;
			double fTemp283 = fTemp151 * (fTemp253 - fRec413[1]) + fRec412[1];
			fRec412[0] = 2.0 * (fTemp283 / fTemp152) - fRec412[1];
			fRec413[0] = fRec413[1] + 2.0 * (fTemp151 * fTemp283 / fTemp152);
			double fRec414 = fTemp154 * fTemp283 / fTemp152;
			double fTemp284 = fTemp156 * (fTemp253 - fRec416[1]) + fRec415[1];
			fRec415[0] = 2.0 * (fTemp284 / fTemp157) - fRec415[1];
			fRec416[0] = fRec416[1] + 2.0 * (fTemp156 * fTemp284 / fTemp157);
			double fRec417 = fTemp159 * fTemp284 / fTemp157;
			double fTemp285 = fTemp161 * (fTemp253 - fRec419[1]) + fRec418[1];
			fRec418[0] = 2.0 * (fTemp285 / fTemp162) - fRec418[1];
			fRec419[0] = fRec419[1] + 2.0 * (fTemp161 * fTemp285 / fTemp162);
			double fRec420 = fTemp164 * fTemp285 / fTemp162;
			double fTemp286 = fTemp166 * (fTemp253 - fRec422[1]) + fRec421[1];
			fRec421[0] = 2.0 * (fTemp286 / fTemp167) - fRec421[1];
			fRec422[0] = fRec422[1] + 2.0 * (fTemp166 * fTemp286 / fTemp167);
			double fRec423 = fTemp169 * fTemp286 / fTemp167;
			fRec319[0] = 0.03125 * fTemp170 * (fRec423 + fRec420 + fRec417 + fRec414 + fRec411 + fRec408 + fRec405 + fRec402 + fRec399 + fRec396 + fRec393 + fRec390 + fRec387 + fRec384 + fRec381 + fRec378 + fRec375 + fRec372 + fRec369 + fRec366 + fRec363 + fRec360 + fRec357 + fRec354 + fRec351 + fRec348 + fRec345 + fRec342 + fRec339 + fRec336 + fRec333 + fRec330) + fTemp175 * fTemp252;
			double fTemp287 = fRec320[1] + fRec323[1];
			double fTemp288 = fRec27[0] * (fRec319[1] * (fRec124[0] - fRec321[1]) - fRec320[1]);
			fVec9[0] = fTemp288 + fTemp287 + fTemp171;
			fRec424[0] = fTemp288 + 0.995 * fRec424[1] + fTemp287 + (1.3 - (fVec3[1] + fVec9[1]));
			double fTemp289 = tanh(fRec424[0] / fTemp0);
			double fTemp290 = fRec9[0] * fTemp289;
			double fTemp291 = fTemp3 * (fTemp290 - fRec426[1]) + fRec425[1];
			fRec425[0] = 2.0 * (fTemp291 / fTemp4) - fRec425[1];
			fRec426[0] = fRec426[1] + 2.0 * (fTemp3 * fTemp291 / fTemp4);
			double fRec427 = fTemp13 * fTemp291 / fTemp4;
			double fTemp292 = fTemp15 * (fTemp290 - fRec429[1]) + fRec428[1];
			fRec428[0] = 2.0 * (fTemp292 / fTemp16) - fRec428[1];
			fRec429[0] = fRec429[1] + 2.0 * (fTemp15 * fTemp292 / fTemp16);
			double fRec430 = fTemp18 * fTemp292 / fTemp16;
			double fTemp293 = fTemp20 * (fTemp290 - fRec432[1]) + fRec431[1];
			fRec431[0] = 2.0 * (fTemp293 / fTemp21) - fRec431[1];
			fRec432[0] = fRec432[1] + 2.0 * (fTemp20 * fTemp293 / fTemp21);
			double fRec433 = fTemp23 * fTemp293 / fTemp21;
			double fTemp294 = fTemp25 * (fTemp290 - fRec435[1]) + fRec434[1];
			fRec434[0] = 2.0 * (fTemp294 / fTemp26) - fRec434[1];
			fRec435[0] = fRec435[1] + 2.0 * (fTemp25 * fTemp294 / fTemp26);
			double fRec436 = fTemp28 * fTemp294 / fTemp26;
			double fTemp295 = fTemp30 * (fTemp290 - fRec438[1]) + fRec437[1];
			fRec437[0] = 2.0 * (fTemp295 / fTemp31) - fRec437[1];
			fRec438[0] = fRec438[1] + 2.0 * (fTemp30 * fTemp295 / fTemp31);
			double fRec439 = fTemp33 * fTemp295 / fTemp31;
			double fTemp296 = fTemp35 * (fTemp290 - fRec441[1]) + fRec440[1];
			fRec440[0] = 2.0 * (fTemp296 / fTemp36) - fRec440[1];
			fRec441[0] = fRec441[1] + 2.0 * (fTemp35 * fTemp296 / fTemp36);
			double fRec442 = fTemp38 * fTemp296 / fTemp36;
			double fTemp297 = fTemp40 * (fTemp290 - fRec444[1]) + fRec443[1];
			fRec443[0] = 2.0 * (fTemp297 / fTemp41) - fRec443[1];
			fRec444[0] = fRec444[1] + 2.0 * (fTemp40 * fTemp297 / fTemp41);
			double fRec445 = fTemp43 * fTemp297 / fTemp41;
			double fTemp298 = fTemp45 * (fTemp290 - fRec447[1]) + fRec446[1];
			fRec446[0] = 2.0 * (fTemp298 / fTemp46) - fRec446[1];
			fRec447[0] = fRec447[1] + 2.0 * (fTemp45 * fTemp298 / fTemp46);
			double fRec448 = fTemp48 * fTemp298 / fTemp46;
			double fTemp299 = fTemp50 * (fTemp290 - fRec450[1]) + fRec449[1];
			fRec449[0] = 2.0 * (fTemp299 / fTemp51) - fRec449[1];
			fRec450[0] = fRec450[1] + 2.0 * (fTemp50 * fTemp299 / fTemp51);
			double fRec451 = fTemp53 * fTemp299 / fTemp51;
			double fTemp300 = fTemp55 * (fTemp290 - fRec453[1]) + fRec452[1];
			fRec452[0] = 2.0 * (fTemp300 / fTemp56) - fRec452[1];
			fRec453[0] = fRec453[1] + 2.0 * (fTemp55 * fTemp300 / fTemp56);
			double fRec454 = fTemp58 * fTemp300 / fTemp56;
			double fTemp301 = fTemp61 * (fTemp290 - fRec456[1]) + fRec455[1];
			fRec455[0] = 2.0 * (fTemp301 / fTemp62) - fRec455[1];
			fRec456[0] = fRec456[1] + 2.0 * (fTemp61 * fTemp301 / fTemp62);
			double fRec457 = fTemp64 * fTemp301 / fTemp62;
			double fTemp302 = fTemp66 * (fTemp290 - fRec459[1]) + fRec458[1];
			fRec458[0] = 2.0 * (fTemp302 / fTemp67) - fRec458[1];
			fRec459[0] = fRec459[1] + 2.0 * (fTemp66 * fTemp302 / fTemp67);
			double fRec460 = fTemp69 * fTemp302 / fTemp67;
			double fTemp303 = fTemp71 * (fTemp290 - fRec462[1]) + fRec461[1];
			fRec461[0] = 2.0 * (fTemp303 / fTemp72) - fRec461[1];
			fRec462[0] = fRec462[1] + 2.0 * (fTemp71 * fTemp303 / fTemp72);
			double fRec463 = fTemp74 * fTemp303 / fTemp72;
			double fTemp304 = fTemp76 * (fTemp290 - fRec465[1]) + fRec464[1];
			fRec464[0] = 2.0 * (fTemp304 / fTemp77) - fRec464[1];
			fRec465[0] = fRec465[1] + 2.0 * (fTemp76 * fTemp304 / fTemp77);
			double fRec466 = fTemp79 * fTemp304 / fTemp77;
			double fTemp305 = fTemp81 * (fTemp290 - fRec468[1]) + fRec467[1];
			fRec467[0] = 2.0 * (fTemp305 / fTemp82) - fRec467[1];
			fRec468[0] = fRec468[1] + 2.0 * (fTemp81 * fTemp305 / fTemp82);
			double fRec469 = fTemp84 * fTemp305 / fTemp82;
			double fTemp306 = fTemp86 * (fTemp290 - fRec471[1]) + fRec470[1];
			fRec470[0] = 2.0 * (fTemp306 / fTemp87) - fRec470[1];
			fRec471[0] = fRec471[1] + 2.0 * (fTemp86 * fTemp306 / fTemp87);
			double fRec472 = fTemp89 * fTemp306 / fTemp87;
			double fTemp307 = fTemp91 * (fTemp290 - fRec474[1]) + fRec473[1];
			double fTemp308 = fTemp307 / fTemp92;
			fRec473[0] = 2.0 * fTemp308 - fRec473[1];
			fRec474[0] = fRec474[1] + 2.0 * (fTemp91 * fTemp307 / fTemp92);
			double fRec475 = fTemp308;
			double fTemp309 = fTemp96 * (fTemp290 - fRec477[1]) + fRec476[1];
			fRec476[0] = 2.0 * (fTemp309 / fTemp97) - fRec476[1];
			fRec477[0] = fRec477[1] + 2.0 * (fTemp96 * fTemp309 / fTemp97);
			double fRec478 = fTemp99 * fTemp309 / fTemp97;
			double fTemp310 = fTemp101 * (fTemp290 - fRec480[1]) + fRec479[1];
			fRec479[0] = 2.0 * (fTemp310 / fTemp102) - fRec479[1];
			fRec480[0] = fRec480[1] + 2.0 * (fTemp101 * fTemp310 / fTemp102);
			double fRec481 = fTemp104 * fTemp310 / fTemp102;
			double fTemp311 = fTemp106 * (fTemp290 - fRec483[1]) + fRec482[1];
			fRec482[0] = 2.0 * (fTemp311 / fTemp107) - fRec482[1];
			fRec483[0] = fRec483[1] + 2.0 * (fTemp106 * fTemp311 / fTemp107);
			double fRec484 = fTemp109 * fTemp311 / fTemp107;
			double fTemp312 = fTemp111 * (fTemp290 - fRec486[1]) + fRec485[1];
			fRec485[0] = 2.0 * (fTemp312 / fTemp112) - fRec485[1];
			fRec486[0] = fRec486[1] + 2.0 * (fTemp111 * fTemp312 / fTemp112);
			double fRec487 = fTemp114 * fTemp312 / fTemp112;
			double fTemp313 = fTemp116 * (fTemp290 - fRec489[1]) + fRec488[1];
			fRec488[0] = 2.0 * (fTemp313 / fTemp117) - fRec488[1];
			fRec489[0] = fRec489[1] + 2.0 * (fTemp116 * fTemp313 / fTemp117);
			double fRec490 = fTemp119 * fTemp313 / fTemp117;
			double fTemp314 = fTemp121 * (fTemp290 - fRec492[1]) + fRec491[1];
			fRec491[0] = 2.0 * (fTemp314 / fTemp122) - fRec491[1];
			fRec492[0] = fRec492[1] + 2.0 * (fTemp121 * fTemp314 / fTemp122);
			double fRec493 = fTemp124 * fTemp314 / fTemp122;
			double fTemp315 = fTemp126 * (fTemp290 - fRec495[1]) + fRec494[1];
			fRec494[0] = 2.0 * (fTemp315 / fTemp127) - fRec494[1];
			fRec495[0] = fRec495[1] + 2.0 * (fTemp126 * fTemp315 / fTemp127);
			double fRec496 = fTemp129 * fTemp315 / fTemp127;
			double fTemp316 = fTemp131 * (fTemp290 - fRec498[1]) + fRec497[1];
			fRec497[0] = 2.0 * (fTemp316 / fTemp132) - fRec497[1];
			fRec498[0] = fRec498[1] + 2.0 * (fTemp131 * fTemp316 / fTemp132);
			double fRec499 = fTemp134 * fTemp316 / fTemp132;
			double fTemp317 = fTemp136 * (fTemp290 - fRec501[1]) + fRec500[1];
			fRec500[0] = 2.0 * (fTemp317 / fTemp137) - fRec500[1];
			fRec501[0] = fRec501[1] + 2.0 * (fTemp136 * fTemp317 / fTemp137);
			double fRec502 = fTemp139 * fTemp317 / fTemp137;
			double fTemp318 = fTemp141 * (fTemp290 - fRec504[1]) + fRec503[1];
			fRec503[0] = 2.0 * (fTemp318 / fTemp142) - fRec503[1];
			fRec504[0] = fRec504[1] + 2.0 * (fTemp141 * fTemp318 / fTemp142);
			double fRec505 = fTemp144 * fTemp318 / fTemp142;
			double fTemp319 = fTemp146 * (fTemp290 - fRec507[1]) + fRec506[1];
			fRec506[0] = 2.0 * (fTemp319 / fTemp147) - fRec506[1];
			fRec507[0] = fRec507[1] + 2.0 * (fTemp146 * fTemp319 / fTemp147);
			double fRec508 = fTemp149 * fTemp319 / fTemp147;
			double fTemp320 = fTemp151 * (fTemp290 - fRec510[1]) + fRec509[1];
			fRec509[0] = 2.0 * (fTemp320 / fTemp152) - fRec509[1];
			fRec510[0] = fRec510[1] + 2.0 * (fTemp151 * fTemp320 / fTemp152);
			double fRec511 = fTemp154 * fTemp320 / fTemp152;
			double fTemp321 = fTemp156 * (fTemp290 - fRec513[1]) + fRec512[1];
			fRec512[0] = 2.0 * (fTemp321 / fTemp157) - fRec512[1];
			fRec513[0] = fRec513[1] + 2.0 * (fTemp156 * fTemp321 / fTemp157);
			double fRec514 = fTemp159 * fTemp321 / fTemp157;
			double fTemp322 = fTemp161 * (fTemp290 - fRec516[1]) + fRec515[1];
			fRec515[0] = 2.0 * (fTemp322 / fTemp162) - fRec515[1];
			fRec516[0] = fRec516[1] + 2.0 * (fTemp161 * fTemp322 / fTemp162);
			double fRec517 = fTemp164 * fTemp322 / fTemp162;
			double fTemp323 = fTemp166 * (fTemp290 - fRec519[1]) + fRec518[1];
			fRec518[0] = 2.0 * (fTemp323 / fTemp167) - fRec518[1];
			fRec519[0] = fRec519[1] + 2.0 * (fTemp166 * fTemp323 / fTemp167);
			double fRec520 = fTemp169 * fTemp323 / fTemp167;
			fRec320[0] = 0.03125 * fTemp170 * (fRec520 + fRec517 + fRec514 + fRec511 + fRec508 + fRec505 + fRec502 + fRec499 + fRec496 + fRec493 + fRec490 + fRec487 + fRec484 + fRec481 + fRec478 + fRec475 + fRec472 + fRec469 + fRec466 + fRec463 + fRec460 + fRec457 + fRec454 + fRec451 + fRec448 + fRec445 + fRec442 + fRec439 + fRec436 + fRec433 + fRec430 + fRec427) + fTemp175 * fTemp289;
			double fTemp324 = fRec323[1] + fRec321[1];
			double fTemp325 = fRec27[0] * (fRec319[1] * fRec320[1] - fRec222[0] * fRec321[1]);
			fVec10[0] = fTemp325 + fTemp324 + fTemp210;
			fRec521[0] = fTemp325 + 0.995 * fRec521[1] + fTemp324 + (1.6 - (fVec5[1] + fVec10[1]));
			double fTemp326 = tanh(fRec521[0] / fTemp0);
			double fTemp327 = fRec9[0] * fTemp326;
			double fTemp328 = fTemp3 * (fTemp327 - fRec523[1]) + fRec522[1];
			fRec522[0] = 2.0 * (fTemp328 / fTemp4) - fRec522[1];
			fRec523[0] = fRec523[1] + 2.0 * (fTemp3 * fTemp328 / fTemp4);
			double fRec524 = fTemp13 * fTemp328 / fTemp4;
			double fTemp329 = fTemp15 * (fTemp327 - fRec526[1]) + fRec525[1];
			fRec525[0] = 2.0 * (fTemp329 / fTemp16) - fRec525[1];
			fRec526[0] = fRec526[1] + 2.0 * (fTemp15 * fTemp329 / fTemp16);
			double fRec527 = fTemp18 * fTemp329 / fTemp16;
			double fTemp330 = fTemp20 * (fTemp327 - fRec529[1]) + fRec528[1];
			fRec528[0] = 2.0 * (fTemp330 / fTemp21) - fRec528[1];
			fRec529[0] = fRec529[1] + 2.0 * (fTemp20 * fTemp330 / fTemp21);
			double fRec530 = fTemp23 * fTemp330 / fTemp21;
			double fTemp331 = fTemp25 * (fTemp327 - fRec532[1]) + fRec531[1];
			fRec531[0] = 2.0 * (fTemp331 / fTemp26) - fRec531[1];
			fRec532[0] = fRec532[1] + 2.0 * (fTemp25 * fTemp331 / fTemp26);
			double fRec533 = fTemp28 * fTemp331 / fTemp26;
			double fTemp332 = fTemp30 * (fTemp327 - fRec535[1]) + fRec534[1];
			fRec534[0] = 2.0 * (fTemp332 / fTemp31) - fRec534[1];
			fRec535[0] = fRec535[1] + 2.0 * (fTemp30 * fTemp332 / fTemp31);
			double fRec536 = fTemp33 * fTemp332 / fTemp31;
			double fTemp333 = fTemp35 * (fTemp327 - fRec538[1]) + fRec537[1];
			fRec537[0] = 2.0 * (fTemp333 / fTemp36) - fRec537[1];
			fRec538[0] = fRec538[1] + 2.0 * (fTemp35 * fTemp333 / fTemp36);
			double fRec539 = fTemp38 * fTemp333 / fTemp36;
			double fTemp334 = fTemp40 * (fTemp327 - fRec541[1]) + fRec540[1];
			fRec540[0] = 2.0 * (fTemp334 / fTemp41) - fRec540[1];
			fRec541[0] = fRec541[1] + 2.0 * (fTemp40 * fTemp334 / fTemp41);
			double fRec542 = fTemp43 * fTemp334 / fTemp41;
			double fTemp335 = fTemp45 * (fTemp327 - fRec544[1]) + fRec543[1];
			fRec543[0] = 2.0 * (fTemp335 / fTemp46) - fRec543[1];
			fRec544[0] = fRec544[1] + 2.0 * (fTemp45 * fTemp335 / fTemp46);
			double fRec545 = fTemp48 * fTemp335 / fTemp46;
			double fTemp336 = fTemp50 * (fTemp327 - fRec547[1]) + fRec546[1];
			fRec546[0] = 2.0 * (fTemp336 / fTemp51) - fRec546[1];
			fRec547[0] = fRec547[1] + 2.0 * (fTemp50 * fTemp336 / fTemp51);
			double fRec548 = fTemp53 * fTemp336 / fTemp51;
			double fTemp337 = fTemp55 * (fTemp327 - fRec550[1]) + fRec549[1];
			fRec549[0] = 2.0 * (fTemp337 / fTemp56) - fRec549[1];
			fRec550[0] = fRec550[1] + 2.0 * (fTemp55 * fTemp337 / fTemp56);
			double fRec551 = fTemp58 * fTemp337 / fTemp56;
			double fTemp338 = fTemp61 * (fTemp327 - fRec553[1]) + fRec552[1];
			fRec552[0] = 2.0 * (fTemp338 / fTemp62) - fRec552[1];
			fRec553[0] = fRec553[1] + 2.0 * (fTemp61 * fTemp338 / fTemp62);
			double fRec554 = fTemp64 * fTemp338 / fTemp62;
			double fTemp339 = fTemp66 * (fTemp327 - fRec556[1]) + fRec555[1];
			fRec555[0] = 2.0 * (fTemp339 / fTemp67) - fRec555[1];
			fRec556[0] = fRec556[1] + 2.0 * (fTemp66 * fTemp339 / fTemp67);
			double fRec557 = fTemp69 * fTemp339 / fTemp67;
			double fTemp340 = fTemp71 * (fTemp327 - fRec559[1]) + fRec558[1];
			fRec558[0] = 2.0 * (fTemp340 / fTemp72) - fRec558[1];
			fRec559[0] = fRec559[1] + 2.0 * (fTemp71 * fTemp340 / fTemp72);
			double fRec560 = fTemp74 * fTemp340 / fTemp72;
			double fTemp341 = fTemp76 * (fTemp327 - fRec562[1]) + fRec561[1];
			fRec561[0] = 2.0 * (fTemp341 / fTemp77) - fRec561[1];
			fRec562[0] = fRec562[1] + 2.0 * (fTemp76 * fTemp341 / fTemp77);
			double fRec563 = fTemp79 * fTemp341 / fTemp77;
			double fTemp342 = fTemp81 * (fTemp327 - fRec565[1]) + fRec564[1];
			fRec564[0] = 2.0 * (fTemp342 / fTemp82) - fRec564[1];
			fRec565[0] = fRec565[1] + 2.0 * (fTemp81 * fTemp342 / fTemp82);
			double fRec566 = fTemp84 * fTemp342 / fTemp82;
			double fTemp343 = fTemp86 * (fTemp327 - fRec568[1]) + fRec567[1];
			fRec567[0] = 2.0 * (fTemp343 / fTemp87) - fRec567[1];
			fRec568[0] = fRec568[1] + 2.0 * (fTemp86 * fTemp343 / fTemp87);
			double fRec569 = fTemp89 * fTemp343 / fTemp87;
			double fTemp344 = fTemp91 * (fTemp327 - fRec571[1]) + fRec570[1];
			double fTemp345 = fTemp344 / fTemp92;
			fRec570[0] = 2.0 * fTemp345 - fRec570[1];
			fRec571[0] = fRec571[1] + 2.0 * (fTemp91 * fTemp344 / fTemp92);
			double fRec572 = fTemp345;
			double fTemp346 = fTemp96 * (fTemp327 - fRec574[1]) + fRec573[1];
			fRec573[0] = 2.0 * (fTemp346 / fTemp97) - fRec573[1];
			fRec574[0] = fRec574[1] + 2.0 * (fTemp96 * fTemp346 / fTemp97);
			double fRec575 = fTemp99 * fTemp346 / fTemp97;
			double fTemp347 = fTemp101 * (fTemp327 - fRec577[1]) + fRec576[1];
			fRec576[0] = 2.0 * (fTemp347 / fTemp102) - fRec576[1];
			fRec577[0] = fRec577[1] + 2.0 * (fTemp101 * fTemp347 / fTemp102);
			double fRec578 = fTemp104 * fTemp347 / fTemp102;
			double fTemp348 = fTemp106 * (fTemp327 - fRec580[1]) + fRec579[1];
			fRec579[0] = 2.0 * (fTemp348 / fTemp107) - fRec579[1];
			fRec580[0] = fRec580[1] + 2.0 * (fTemp106 * fTemp348 / fTemp107);
			double fRec581 = fTemp109 * fTemp348 / fTemp107;
			double fTemp349 = fTemp111 * (fTemp327 - fRec583[1]) + fRec582[1];
			fRec582[0] = 2.0 * (fTemp349 / fTemp112) - fRec582[1];
			fRec583[0] = fRec583[1] + 2.0 * (fTemp111 * fTemp349 / fTemp112);
			double fRec584 = fTemp114 * fTemp349 / fTemp112;
			double fTemp350 = fTemp116 * (fTemp327 - fRec586[1]) + fRec585[1];
			fRec585[0] = 2.0 * (fTemp350 / fTemp117) - fRec585[1];
			fRec586[0] = fRec586[1] + 2.0 * (fTemp116 * fTemp350 / fTemp117);
			double fRec587 = fTemp119 * fTemp350 / fTemp117;
			double fTemp351 = fTemp121 * (fTemp327 - fRec589[1]) + fRec588[1];
			fRec588[0] = 2.0 * (fTemp351 / fTemp122) - fRec588[1];
			fRec589[0] = fRec589[1] + 2.0 * (fTemp121 * fTemp351 / fTemp122);
			double fRec590 = fTemp124 * fTemp351 / fTemp122;
			double fTemp352 = fTemp126 * (fTemp327 - fRec592[1]) + fRec591[1];
			fRec591[0] = 2.0 * (fTemp352 / fTemp127) - fRec591[1];
			fRec592[0] = fRec592[1] + 2.0 * (fTemp126 * fTemp352 / fTemp127);
			double fRec593 = fTemp129 * fTemp352 / fTemp127;
			double fTemp353 = fTemp131 * (fTemp327 - fRec595[1]) + fRec594[1];
			fRec594[0] = 2.0 * (fTemp353 / fTemp132) - fRec594[1];
			fRec595[0] = fRec595[1] + 2.0 * (fTemp131 * fTemp353 / fTemp132);
			double fRec596 = fTemp134 * fTemp353 / fTemp132;
			double fTemp354 = fTemp136 * (fTemp327 - fRec598[1]) + fRec597[1];
			fRec597[0] = 2.0 * (fTemp354 / fTemp137) - fRec597[1];
			fRec598[0] = fRec598[1] + 2.0 * (fTemp136 * fTemp354 / fTemp137);
			double fRec599 = fTemp139 * fTemp354 / fTemp137;
			double fTemp355 = fTemp141 * (fTemp327 - fRec601[1]) + fRec600[1];
			fRec600[0] = 2.0 * (fTemp355 / fTemp142) - fRec600[1];
			fRec601[0] = fRec601[1] + 2.0 * (fTemp141 * fTemp355 / fTemp142);
			double fRec602 = fTemp144 * fTemp355 / fTemp142;
			double fTemp356 = fTemp146 * (fTemp327 - fRec604[1]) + fRec603[1];
			fRec603[0] = 2.0 * (fTemp356 / fTemp147) - fRec603[1];
			fRec604[0] = fRec604[1] + 2.0 * (fTemp146 * fTemp356 / fTemp147);
			double fRec605 = fTemp149 * fTemp356 / fTemp147;
			double fTemp357 = fTemp151 * (fTemp327 - fRec607[1]) + fRec606[1];
			fRec606[0] = 2.0 * (fTemp357 / fTemp152) - fRec606[1];
			fRec607[0] = fRec607[1] + 2.0 * (fTemp151 * fTemp357 / fTemp152);
			double fRec608 = fTemp154 * fTemp357 / fTemp152;
			double fTemp358 = fTemp156 * (fTemp327 - fRec610[1]) + fRec609[1];
			fRec609[0] = 2.0 * (fTemp358 / fTemp157) - fRec609[1];
			fRec610[0] = fRec610[1] + 2.0 * (fTemp156 * fTemp358 / fTemp157);
			double fRec611 = fTemp159 * fTemp358 / fTemp157;
			double fTemp359 = fTemp161 * (fTemp327 - fRec613[1]) + fRec612[1];
			fRec612[0] = 2.0 * (fTemp359 / fTemp162) - fRec612[1];
			fRec613[0] = fRec613[1] + 2.0 * (fTemp161 * fTemp359 / fTemp162);
			double fRec614 = fTemp164 * fTemp359 / fTemp162;
			double fTemp360 = fTemp166 * (fTemp327 - fRec616[1]) + fRec615[1];
			fRec615[0] = 2.0 * (fTemp360 / fTemp167) - fRec615[1];
			fRec616[0] = fRec616[1] + 2.0 * (fTemp166 * fTemp360 / fTemp167);
			double fRec617 = fTemp169 * fTemp360 / fTemp167;
			fRec321[0] = 0.03125 * fTemp170 * (fRec617 + fRec614 + fRec611 + fRec608 + fRec605 + fRec602 + fRec599 + fRec596 + fRec593 + fRec590 + fRec587 + fRec584 + fRec581 + fRec578 + fRec575 + fRec572 + fRec569 + fRec566 + fRec563 + fRec560 + fRec557 + fRec554 + fRec551 + fRec548 + fRec545 + fRec542 + fRec539 + fRec536 + fRec533 + fRec530 + fRec527 + fRec524) + fTemp175 * fTemp326;
			double fTemp361 = (fRec321[0] + fRec319[0] + fRec320[0]) / fTemp0;
			fVec11[IOTA0 & 4194303] = fTemp361;
			fRec6[IOTA0 & 511] = 0.3333333333333333 * fTemp361;
			double fTemp362 = ((fRec623[1] != 0.0) ? (((fRec624[1] > 0.0) & (fRec624[1] < 1.0)) ? fRec623[1] : 0.0) : (((fRec624[1] == 0.0) & (fConst9 != fRec625[1])) ? 0.0009765625 : (((fRec624[1] == 1.0) & (fConst9 != fRec626[1])) ? -0.0009765625 : 0.0)));
			fRec623[0] = fTemp362;
			fRec624[0] = std::max<double>(0.0, std::min<double>(1.0, fRec624[1] + fTemp362));
			fRec625[0] = (((fRec624[1] >= 1.0) & (fRec626[1] != fConst9)) ? fConst9 : fRec625[1]);
			fRec626[0] = (((fRec624[1] <= 0.0) & (fRec625[1] != fConst9)) ? fConst9 : fRec626[1]);
			double fTemp363 = fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec625[0])))) & 4194303];
			fRec622[0] = 0.25 * fTemp363 + fRec624[0] * (0.0 - 0.25 * (fTemp363 - fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec626[0])))) & 4194303]));
			double fTemp364 = fTemp9 * (fRec619[1] - fRec618[1]);
			fVec12[0] = fRec618[1] + fTemp364 + fRec622[1] + fTemp5;
			fRec621[0] = fRec622[1] + fTemp364 + 0.995 * fRec621[1] + fRec618[1] + (1.2 - (fVec0[1] + fVec12[1]));
			double fTemp365 = tanh(fRec621[0] / fTemp0);
			double fTemp366 = fRec9[0] * fTemp365;
			double fTemp367 = fTemp3 * (fTemp366 - fRec628[1]) + fRec627[1];
			fRec627[0] = 2.0 * (fTemp367 / fTemp4) - fRec627[1];
			fRec628[0] = fRec628[1] + 2.0 * (fTemp3 * fTemp367 / fTemp4);
			double fRec629 = fTemp13 * fTemp367 / fTemp4;
			double fTemp368 = fTemp15 * (fTemp366 - fRec631[1]) + fRec630[1];
			fRec630[0] = 2.0 * (fTemp368 / fTemp16) - fRec630[1];
			fRec631[0] = fRec631[1] + 2.0 * (fTemp15 * fTemp368 / fTemp16);
			double fRec632 = fTemp18 * fTemp368 / fTemp16;
			double fTemp369 = fTemp20 * (fTemp366 - fRec634[1]) + fRec633[1];
			fRec633[0] = 2.0 * (fTemp369 / fTemp21) - fRec633[1];
			fRec634[0] = fRec634[1] + 2.0 * (fTemp20 * fTemp369 / fTemp21);
			double fRec635 = fTemp23 * fTemp369 / fTemp21;
			double fTemp370 = fTemp25 * (fTemp366 - fRec637[1]) + fRec636[1];
			fRec636[0] = 2.0 * (fTemp370 / fTemp26) - fRec636[1];
			fRec637[0] = fRec637[1] + 2.0 * (fTemp25 * fTemp370 / fTemp26);
			double fRec638 = fTemp28 * fTemp370 / fTemp26;
			double fTemp371 = fTemp30 * (fTemp366 - fRec640[1]) + fRec639[1];
			fRec639[0] = 2.0 * (fTemp371 / fTemp31) - fRec639[1];
			fRec640[0] = fRec640[1] + 2.0 * (fTemp30 * fTemp371 / fTemp31);
			double fRec641 = fTemp33 * fTemp371 / fTemp31;
			double fTemp372 = fTemp35 * (fTemp366 - fRec643[1]) + fRec642[1];
			fRec642[0] = 2.0 * (fTemp372 / fTemp36) - fRec642[1];
			fRec643[0] = fRec643[1] + 2.0 * (fTemp35 * fTemp372 / fTemp36);
			double fRec644 = fTemp38 * fTemp372 / fTemp36;
			double fTemp373 = fTemp40 * (fTemp366 - fRec646[1]) + fRec645[1];
			fRec645[0] = 2.0 * (fTemp373 / fTemp41) - fRec645[1];
			fRec646[0] = fRec646[1] + 2.0 * (fTemp40 * fTemp373 / fTemp41);
			double fRec647 = fTemp43 * fTemp373 / fTemp41;
			double fTemp374 = fTemp45 * (fTemp366 - fRec649[1]) + fRec648[1];
			fRec648[0] = 2.0 * (fTemp374 / fTemp46) - fRec648[1];
			fRec649[0] = fRec649[1] + 2.0 * (fTemp45 * fTemp374 / fTemp46);
			double fRec650 = fTemp48 * fTemp374 / fTemp46;
			double fTemp375 = fTemp50 * (fTemp366 - fRec652[1]) + fRec651[1];
			fRec651[0] = 2.0 * (fTemp375 / fTemp51) - fRec651[1];
			fRec652[0] = fRec652[1] + 2.0 * (fTemp50 * fTemp375 / fTemp51);
			double fRec653 = fTemp53 * fTemp375 / fTemp51;
			double fTemp376 = fTemp55 * (fTemp366 - fRec655[1]) + fRec654[1];
			fRec654[0] = 2.0 * (fTemp376 / fTemp56) - fRec654[1];
			fRec655[0] = fRec655[1] + 2.0 * (fTemp55 * fTemp376 / fTemp56);
			double fRec656 = fTemp58 * fTemp376 / fTemp56;
			double fTemp377 = fTemp61 * (fTemp366 - fRec658[1]) + fRec657[1];
			fRec657[0] = 2.0 * (fTemp377 / fTemp62) - fRec657[1];
			fRec658[0] = fRec658[1] + 2.0 * (fTemp61 * fTemp377 / fTemp62);
			double fRec659 = fTemp64 * fTemp377 / fTemp62;
			double fTemp378 = fTemp66 * (fTemp366 - fRec661[1]) + fRec660[1];
			fRec660[0] = 2.0 * (fTemp378 / fTemp67) - fRec660[1];
			fRec661[0] = fRec661[1] + 2.0 * (fTemp66 * fTemp378 / fTemp67);
			double fRec662 = fTemp69 * fTemp378 / fTemp67;
			double fTemp379 = fTemp71 * (fTemp366 - fRec664[1]) + fRec663[1];
			fRec663[0] = 2.0 * (fTemp379 / fTemp72) - fRec663[1];
			fRec664[0] = fRec664[1] + 2.0 * (fTemp71 * fTemp379 / fTemp72);
			double fRec665 = fTemp74 * fTemp379 / fTemp72;
			double fTemp380 = fTemp76 * (fTemp366 - fRec667[1]) + fRec666[1];
			fRec666[0] = 2.0 * (fTemp380 / fTemp77) - fRec666[1];
			fRec667[0] = fRec667[1] + 2.0 * (fTemp76 * fTemp380 / fTemp77);
			double fRec668 = fTemp79 * fTemp380 / fTemp77;
			double fTemp381 = fTemp81 * (fTemp366 - fRec670[1]) + fRec669[1];
			fRec669[0] = 2.0 * (fTemp381 / fTemp82) - fRec669[1];
			fRec670[0] = fRec670[1] + 2.0 * (fTemp81 * fTemp381 / fTemp82);
			double fRec671 = fTemp84 * fTemp381 / fTemp82;
			double fTemp382 = fTemp86 * (fTemp366 - fRec673[1]) + fRec672[1];
			fRec672[0] = 2.0 * (fTemp382 / fTemp87) - fRec672[1];
			fRec673[0] = fRec673[1] + 2.0 * (fTemp86 * fTemp382 / fTemp87);
			double fRec674 = fTemp89 * fTemp382 / fTemp87;
			double fTemp383 = fTemp91 * (fTemp366 - fRec676[1]) + fRec675[1];
			double fTemp384 = fTemp383 / fTemp92;
			fRec675[0] = 2.0 * fTemp384 - fRec675[1];
			fRec676[0] = fRec676[1] + 2.0 * (fTemp91 * fTemp383 / fTemp92);
			double fRec677 = fTemp384;
			double fTemp385 = fTemp96 * (fTemp366 - fRec679[1]) + fRec678[1];
			fRec678[0] = 2.0 * (fTemp385 / fTemp97) - fRec678[1];
			fRec679[0] = fRec679[1] + 2.0 * (fTemp96 * fTemp385 / fTemp97);
			double fRec680 = fTemp99 * fTemp385 / fTemp97;
			double fTemp386 = fTemp101 * (fTemp366 - fRec682[1]) + fRec681[1];
			fRec681[0] = 2.0 * (fTemp386 / fTemp102) - fRec681[1];
			fRec682[0] = fRec682[1] + 2.0 * (fTemp101 * fTemp386 / fTemp102);
			double fRec683 = fTemp104 * fTemp386 / fTemp102;
			double fTemp387 = fTemp106 * (fTemp366 - fRec685[1]) + fRec684[1];
			fRec684[0] = 2.0 * (fTemp387 / fTemp107) - fRec684[1];
			fRec685[0] = fRec685[1] + 2.0 * (fTemp106 * fTemp387 / fTemp107);
			double fRec686 = fTemp109 * fTemp387 / fTemp107;
			double fTemp388 = fTemp111 * (fTemp366 - fRec688[1]) + fRec687[1];
			fRec687[0] = 2.0 * (fTemp388 / fTemp112) - fRec687[1];
			fRec688[0] = fRec688[1] + 2.0 * (fTemp111 * fTemp388 / fTemp112);
			double fRec689 = fTemp114 * fTemp388 / fTemp112;
			double fTemp389 = fTemp116 * (fTemp366 - fRec691[1]) + fRec690[1];
			fRec690[0] = 2.0 * (fTemp389 / fTemp117) - fRec690[1];
			fRec691[0] = fRec691[1] + 2.0 * (fTemp116 * fTemp389 / fTemp117);
			double fRec692 = fTemp119 * fTemp389 / fTemp117;
			double fTemp390 = fTemp121 * (fTemp366 - fRec694[1]) + fRec693[1];
			fRec693[0] = 2.0 * (fTemp390 / fTemp122) - fRec693[1];
			fRec694[0] = fRec694[1] + 2.0 * (fTemp121 * fTemp390 / fTemp122);
			double fRec695 = fTemp124 * fTemp390 / fTemp122;
			double fTemp391 = fTemp126 * (fTemp366 - fRec697[1]) + fRec696[1];
			fRec696[0] = 2.0 * (fTemp391 / fTemp127) - fRec696[1];
			fRec697[0] = fRec697[1] + 2.0 * (fTemp126 * fTemp391 / fTemp127);
			double fRec698 = fTemp129 * fTemp391 / fTemp127;
			double fTemp392 = fTemp131 * (fTemp366 - fRec700[1]) + fRec699[1];
			fRec699[0] = 2.0 * (fTemp392 / fTemp132) - fRec699[1];
			fRec700[0] = fRec700[1] + 2.0 * (fTemp131 * fTemp392 / fTemp132);
			double fRec701 = fTemp134 * fTemp392 / fTemp132;
			double fTemp393 = fTemp136 * (fTemp366 - fRec703[1]) + fRec702[1];
			fRec702[0] = 2.0 * (fTemp393 / fTemp137) - fRec702[1];
			fRec703[0] = fRec703[1] + 2.0 * (fTemp136 * fTemp393 / fTemp137);
			double fRec704 = fTemp139 * fTemp393 / fTemp137;
			double fTemp394 = fTemp141 * (fTemp366 - fRec706[1]) + fRec705[1];
			fRec705[0] = 2.0 * (fTemp394 / fTemp142) - fRec705[1];
			fRec706[0] = fRec706[1] + 2.0 * (fTemp141 * fTemp394 / fTemp142);
			double fRec707 = fTemp144 * fTemp394 / fTemp142;
			double fTemp395 = fTemp146 * (fTemp366 - fRec709[1]) + fRec708[1];
			fRec708[0] = 2.0 * (fTemp395 / fTemp147) - fRec708[1];
			fRec709[0] = fRec709[1] + 2.0 * (fTemp146 * fTemp395 / fTemp147);
			double fRec710 = fTemp149 * fTemp395 / fTemp147;
			double fTemp396 = fTemp151 * (fTemp366 - fRec712[1]) + fRec711[1];
			fRec711[0] = 2.0 * (fTemp396 / fTemp152) - fRec711[1];
			fRec712[0] = fRec712[1] + 2.0 * (fTemp151 * fTemp396 / fTemp152);
			double fRec713 = fTemp154 * fTemp396 / fTemp152;
			double fTemp397 = fTemp156 * (fTemp366 - fRec715[1]) + fRec714[1];
			fRec714[0] = 2.0 * (fTemp397 / fTemp157) - fRec714[1];
			fRec715[0] = fRec715[1] + 2.0 * (fTemp156 * fTemp397 / fTemp157);
			double fRec716 = fTemp159 * fTemp397 / fTemp157;
			double fTemp398 = fTemp161 * (fTemp366 - fRec718[1]) + fRec717[1];
			fRec717[0] = 2.0 * (fTemp398 / fTemp162) - fRec717[1];
			fRec718[0] = fRec718[1] + 2.0 * (fTemp161 * fTemp398 / fTemp162);
			double fRec719 = fTemp164 * fTemp398 / fTemp162;
			double fTemp399 = fTemp166 * (fTemp366 - fRec721[1]) + fRec720[1];
			fRec720[0] = 2.0 * (fTemp399 / fTemp167) - fRec720[1];
			fRec721[0] = fRec721[1] + 2.0 * (fTemp166 * fTemp399 / fTemp167);
			double fRec722 = fTemp169 * fTemp399 / fTemp167;
			fRec618[0] = 0.03125 * fTemp170 * (fRec722 + fRec719 + fRec716 + fRec713 + fRec710 + fRec707 + fRec704 + fRec701 + fRec698 + fRec695 + fRec692 + fRec689 + fRec686 + fRec683 + fRec680 + fRec677 + fRec674 + fRec671 + fRec668 + fRec665 + fRec662 + fRec659 + fRec656 + fRec653 + fRec650 + fRec647 + fRec644 + fRec641 + fRec638 + fRec635 + fRec632 + fRec629) + fTemp175 * fTemp365;
			double fTemp400 = fRec619[1] + fRec622[1];
			double fTemp401 = fRec27[0] * (fRec618[1] * (fRec124[0] - fRec620[1]) - fRec619[1]);
			fVec13[0] = fTemp401 + fTemp400 + fTemp171;
			fRec723[0] = fTemp401 + 0.995 * fRec723[1] + fTemp400 + (1.3 - (fVec3[1] + fVec13[1]));
			double fTemp402 = tanh(fRec723[0] / fTemp0);
			double fTemp403 = fRec9[0] * fTemp402;
			double fTemp404 = fTemp3 * (fTemp403 - fRec725[1]) + fRec724[1];
			fRec724[0] = 2.0 * (fTemp404 / fTemp4) - fRec724[1];
			fRec725[0] = fRec725[1] + 2.0 * (fTemp3 * fTemp404 / fTemp4);
			double fRec726 = fTemp13 * fTemp404 / fTemp4;
			double fTemp405 = fTemp15 * (fTemp403 - fRec728[1]) + fRec727[1];
			fRec727[0] = 2.0 * (fTemp405 / fTemp16) - fRec727[1];
			fRec728[0] = fRec728[1] + 2.0 * (fTemp15 * fTemp405 / fTemp16);
			double fRec729 = fTemp18 * fTemp405 / fTemp16;
			double fTemp406 = fTemp20 * (fTemp403 - fRec731[1]) + fRec730[1];
			fRec730[0] = 2.0 * (fTemp406 / fTemp21) - fRec730[1];
			fRec731[0] = fRec731[1] + 2.0 * (fTemp20 * fTemp406 / fTemp21);
			double fRec732 = fTemp23 * fTemp406 / fTemp21;
			double fTemp407 = fTemp25 * (fTemp403 - fRec734[1]) + fRec733[1];
			fRec733[0] = 2.0 * (fTemp407 / fTemp26) - fRec733[1];
			fRec734[0] = fRec734[1] + 2.0 * (fTemp25 * fTemp407 / fTemp26);
			double fRec735 = fTemp28 * fTemp407 / fTemp26;
			double fTemp408 = fTemp30 * (fTemp403 - fRec737[1]) + fRec736[1];
			fRec736[0] = 2.0 * (fTemp408 / fTemp31) - fRec736[1];
			fRec737[0] = fRec737[1] + 2.0 * (fTemp30 * fTemp408 / fTemp31);
			double fRec738 = fTemp33 * fTemp408 / fTemp31;
			double fTemp409 = fTemp35 * (fTemp403 - fRec740[1]) + fRec739[1];
			fRec739[0] = 2.0 * (fTemp409 / fTemp36) - fRec739[1];
			fRec740[0] = fRec740[1] + 2.0 * (fTemp35 * fTemp409 / fTemp36);
			double fRec741 = fTemp38 * fTemp409 / fTemp36;
			double fTemp410 = fTemp40 * (fTemp403 - fRec743[1]) + fRec742[1];
			fRec742[0] = 2.0 * (fTemp410 / fTemp41) - fRec742[1];
			fRec743[0] = fRec743[1] + 2.0 * (fTemp40 * fTemp410 / fTemp41);
			double fRec744 = fTemp43 * fTemp410 / fTemp41;
			double fTemp411 = fTemp45 * (fTemp403 - fRec746[1]) + fRec745[1];
			fRec745[0] = 2.0 * (fTemp411 / fTemp46) - fRec745[1];
			fRec746[0] = fRec746[1] + 2.0 * (fTemp45 * fTemp411 / fTemp46);
			double fRec747 = fTemp48 * fTemp411 / fTemp46;
			double fTemp412 = fTemp50 * (fTemp403 - fRec749[1]) + fRec748[1];
			fRec748[0] = 2.0 * (fTemp412 / fTemp51) - fRec748[1];
			fRec749[0] = fRec749[1] + 2.0 * (fTemp50 * fTemp412 / fTemp51);
			double fRec750 = fTemp53 * fTemp412 / fTemp51;
			double fTemp413 = fTemp55 * (fTemp403 - fRec752[1]) + fRec751[1];
			fRec751[0] = 2.0 * (fTemp413 / fTemp56) - fRec751[1];
			fRec752[0] = fRec752[1] + 2.0 * (fTemp55 * fTemp413 / fTemp56);
			double fRec753 = fTemp58 * fTemp413 / fTemp56;
			double fTemp414 = fTemp61 * (fTemp403 - fRec755[1]) + fRec754[1];
			fRec754[0] = 2.0 * (fTemp414 / fTemp62) - fRec754[1];
			fRec755[0] = fRec755[1] + 2.0 * (fTemp61 * fTemp414 / fTemp62);
			double fRec756 = fTemp64 * fTemp414 / fTemp62;
			double fTemp415 = fTemp66 * (fTemp403 - fRec758[1]) + fRec757[1];
			fRec757[0] = 2.0 * (fTemp415 / fTemp67) - fRec757[1];
			fRec758[0] = fRec758[1] + 2.0 * (fTemp66 * fTemp415 / fTemp67);
			double fRec759 = fTemp69 * fTemp415 / fTemp67;
			double fTemp416 = fTemp71 * (fTemp403 - fRec761[1]) + fRec760[1];
			fRec760[0] = 2.0 * (fTemp416 / fTemp72) - fRec760[1];
			fRec761[0] = fRec761[1] + 2.0 * (fTemp71 * fTemp416 / fTemp72);
			double fRec762 = fTemp74 * fTemp416 / fTemp72;
			double fTemp417 = fTemp76 * (fTemp403 - fRec764[1]) + fRec763[1];
			fRec763[0] = 2.0 * (fTemp417 / fTemp77) - fRec763[1];
			fRec764[0] = fRec764[1] + 2.0 * (fTemp76 * fTemp417 / fTemp77);
			double fRec765 = fTemp79 * fTemp417 / fTemp77;
			double fTemp418 = fTemp81 * (fTemp403 - fRec767[1]) + fRec766[1];
			fRec766[0] = 2.0 * (fTemp418 / fTemp82) - fRec766[1];
			fRec767[0] = fRec767[1] + 2.0 * (fTemp81 * fTemp418 / fTemp82);
			double fRec768 = fTemp84 * fTemp418 / fTemp82;
			double fTemp419 = fTemp86 * (fTemp403 - fRec770[1]) + fRec769[1];
			fRec769[0] = 2.0 * (fTemp419 / fTemp87) - fRec769[1];
			fRec770[0] = fRec770[1] + 2.0 * (fTemp86 * fTemp419 / fTemp87);
			double fRec771 = fTemp89 * fTemp419 / fTemp87;
			double fTemp420 = fTemp91 * (fTemp403 - fRec773[1]) + fRec772[1];
			double fTemp421 = fTemp420 / fTemp92;
			fRec772[0] = 2.0 * fTemp421 - fRec772[1];
			fRec773[0] = fRec773[1] + 2.0 * (fTemp91 * fTemp420 / fTemp92);
			double fRec774 = fTemp421;
			double fTemp422 = fTemp96 * (fTemp403 - fRec776[1]) + fRec775[1];
			fRec775[0] = 2.0 * (fTemp422 / fTemp97) - fRec775[1];
			fRec776[0] = fRec776[1] + 2.0 * (fTemp96 * fTemp422 / fTemp97);
			double fRec777 = fTemp99 * fTemp422 / fTemp97;
			double fTemp423 = fTemp101 * (fTemp403 - fRec779[1]) + fRec778[1];
			fRec778[0] = 2.0 * (fTemp423 / fTemp102) - fRec778[1];
			fRec779[0] = fRec779[1] + 2.0 * (fTemp101 * fTemp423 / fTemp102);
			double fRec780 = fTemp104 * fTemp423 / fTemp102;
			double fTemp424 = fTemp106 * (fTemp403 - fRec782[1]) + fRec781[1];
			fRec781[0] = 2.0 * (fTemp424 / fTemp107) - fRec781[1];
			fRec782[0] = fRec782[1] + 2.0 * (fTemp106 * fTemp424 / fTemp107);
			double fRec783 = fTemp109 * fTemp424 / fTemp107;
			double fTemp425 = fTemp111 * (fTemp403 - fRec785[1]) + fRec784[1];
			fRec784[0] = 2.0 * (fTemp425 / fTemp112) - fRec784[1];
			fRec785[0] = fRec785[1] + 2.0 * (fTemp111 * fTemp425 / fTemp112);
			double fRec786 = fTemp114 * fTemp425 / fTemp112;
			double fTemp426 = fTemp116 * (fTemp403 - fRec788[1]) + fRec787[1];
			fRec787[0] = 2.0 * (fTemp426 / fTemp117) - fRec787[1];
			fRec788[0] = fRec788[1] + 2.0 * (fTemp116 * fTemp426 / fTemp117);
			double fRec789 = fTemp119 * fTemp426 / fTemp117;
			double fTemp427 = fTemp121 * (fTemp403 - fRec791[1]) + fRec790[1];
			fRec790[0] = 2.0 * (fTemp427 / fTemp122) - fRec790[1];
			fRec791[0] = fRec791[1] + 2.0 * (fTemp121 * fTemp427 / fTemp122);
			double fRec792 = fTemp124 * fTemp427 / fTemp122;
			double fTemp428 = fTemp126 * (fTemp403 - fRec794[1]) + fRec793[1];
			fRec793[0] = 2.0 * (fTemp428 / fTemp127) - fRec793[1];
			fRec794[0] = fRec794[1] + 2.0 * (fTemp126 * fTemp428 / fTemp127);
			double fRec795 = fTemp129 * fTemp428 / fTemp127;
			double fTemp429 = fTemp131 * (fTemp403 - fRec797[1]) + fRec796[1];
			fRec796[0] = 2.0 * (fTemp429 / fTemp132) - fRec796[1];
			fRec797[0] = fRec797[1] + 2.0 * (fTemp131 * fTemp429 / fTemp132);
			double fRec798 = fTemp134 * fTemp429 / fTemp132;
			double fTemp430 = fTemp136 * (fTemp403 - fRec800[1]) + fRec799[1];
			fRec799[0] = 2.0 * (fTemp430 / fTemp137) - fRec799[1];
			fRec800[0] = fRec800[1] + 2.0 * (fTemp136 * fTemp430 / fTemp137);
			double fRec801 = fTemp139 * fTemp430 / fTemp137;
			double fTemp431 = fTemp141 * (fTemp403 - fRec803[1]) + fRec802[1];
			fRec802[0] = 2.0 * (fTemp431 / fTemp142) - fRec802[1];
			fRec803[0] = fRec803[1] + 2.0 * (fTemp141 * fTemp431 / fTemp142);
			double fRec804 = fTemp144 * fTemp431 / fTemp142;
			double fTemp432 = fTemp146 * (fTemp403 - fRec806[1]) + fRec805[1];
			fRec805[0] = 2.0 * (fTemp432 / fTemp147) - fRec805[1];
			fRec806[0] = fRec806[1] + 2.0 * (fTemp146 * fTemp432 / fTemp147);
			double fRec807 = fTemp149 * fTemp432 / fTemp147;
			double fTemp433 = fTemp151 * (fTemp403 - fRec809[1]) + fRec808[1];
			fRec808[0] = 2.0 * (fTemp433 / fTemp152) - fRec808[1];
			fRec809[0] = fRec809[1] + 2.0 * (fTemp151 * fTemp433 / fTemp152);
			double fRec810 = fTemp154 * fTemp433 / fTemp152;
			double fTemp434 = fTemp156 * (fTemp403 - fRec812[1]) + fRec811[1];
			fRec811[0] = 2.0 * (fTemp434 / fTemp157) - fRec811[1];
			fRec812[0] = fRec812[1] + 2.0 * (fTemp156 * fTemp434 / fTemp157);
			double fRec813 = fTemp159 * fTemp434 / fTemp157;
			double fTemp435 = fTemp161 * (fTemp403 - fRec815[1]) + fRec814[1];
			fRec814[0] = 2.0 * (fTemp435 / fTemp162) - fRec814[1];
			fRec815[0] = fRec815[1] + 2.0 * (fTemp161 * fTemp435 / fTemp162);
			double fRec816 = fTemp164 * fTemp435 / fTemp162;
			double fTemp436 = fTemp166 * (fTemp403 - fRec818[1]) + fRec817[1];
			fRec817[0] = 2.0 * (fTemp436 / fTemp167) - fRec817[1];
			fRec818[0] = fRec818[1] + 2.0 * (fTemp166 * fTemp436 / fTemp167);
			double fRec819 = fTemp169 * fTemp436 / fTemp167;
			fRec619[0] = 0.03125 * fTemp170 * (fRec819 + fRec816 + fRec813 + fRec810 + fRec807 + fRec804 + fRec801 + fRec798 + fRec795 + fRec792 + fRec789 + fRec786 + fRec783 + fRec780 + fRec777 + fRec774 + fRec771 + fRec768 + fRec765 + fRec762 + fRec759 + fRec756 + fRec753 + fRec750 + fRec747 + fRec744 + fRec741 + fRec738 + fRec735 + fRec732 + fRec729 + fRec726) + fTemp175 * fTemp402;
			double fTemp437 = fRec622[1] + fRec620[1];
			double fTemp438 = fRec27[0] * (fRec618[1] * fRec619[1] - fRec222[0] * fRec620[1]);
			fVec14[0] = fTemp438 + fTemp437 + fTemp210;
			fRec820[0] = fTemp438 + 0.995 * fRec820[1] + fTemp437 + (1.6 - (fVec5[1] + fVec14[1]));
			double fTemp439 = tanh(fRec820[0] / fTemp0);
			double fTemp440 = fRec9[0] * fTemp439;
			double fTemp441 = fTemp3 * (fTemp440 - fRec822[1]) + fRec821[1];
			fRec821[0] = 2.0 * (fTemp441 / fTemp4) - fRec821[1];
			fRec822[0] = fRec822[1] + 2.0 * (fTemp3 * fTemp441 / fTemp4);
			double fRec823 = fTemp13 * fTemp441 / fTemp4;
			double fTemp442 = fTemp15 * (fTemp440 - fRec825[1]) + fRec824[1];
			fRec824[0] = 2.0 * (fTemp442 / fTemp16) - fRec824[1];
			fRec825[0] = fRec825[1] + 2.0 * (fTemp15 * fTemp442 / fTemp16);
			double fRec826 = fTemp18 * fTemp442 / fTemp16;
			double fTemp443 = fTemp20 * (fTemp440 - fRec828[1]) + fRec827[1];
			fRec827[0] = 2.0 * (fTemp443 / fTemp21) - fRec827[1];
			fRec828[0] = fRec828[1] + 2.0 * (fTemp20 * fTemp443 / fTemp21);
			double fRec829 = fTemp23 * fTemp443 / fTemp21;
			double fTemp444 = fTemp25 * (fTemp440 - fRec831[1]) + fRec830[1];
			fRec830[0] = 2.0 * (fTemp444 / fTemp26) - fRec830[1];
			fRec831[0] = fRec831[1] + 2.0 * (fTemp25 * fTemp444 / fTemp26);
			double fRec832 = fTemp28 * fTemp444 / fTemp26;
			double fTemp445 = fTemp30 * (fTemp440 - fRec834[1]) + fRec833[1];
			fRec833[0] = 2.0 * (fTemp445 / fTemp31) - fRec833[1];
			fRec834[0] = fRec834[1] + 2.0 * (fTemp30 * fTemp445 / fTemp31);
			double fRec835 = fTemp33 * fTemp445 / fTemp31;
			double fTemp446 = fTemp35 * (fTemp440 - fRec837[1]) + fRec836[1];
			fRec836[0] = 2.0 * (fTemp446 / fTemp36) - fRec836[1];
			fRec837[0] = fRec837[1] + 2.0 * (fTemp35 * fTemp446 / fTemp36);
			double fRec838 = fTemp38 * fTemp446 / fTemp36;
			double fTemp447 = fTemp40 * (fTemp440 - fRec840[1]) + fRec839[1];
			fRec839[0] = 2.0 * (fTemp447 / fTemp41) - fRec839[1];
			fRec840[0] = fRec840[1] + 2.0 * (fTemp40 * fTemp447 / fTemp41);
			double fRec841 = fTemp43 * fTemp447 / fTemp41;
			double fTemp448 = fTemp45 * (fTemp440 - fRec843[1]) + fRec842[1];
			fRec842[0] = 2.0 * (fTemp448 / fTemp46) - fRec842[1];
			fRec843[0] = fRec843[1] + 2.0 * (fTemp45 * fTemp448 / fTemp46);
			double fRec844 = fTemp48 * fTemp448 / fTemp46;
			double fTemp449 = fTemp50 * (fTemp440 - fRec846[1]) + fRec845[1];
			fRec845[0] = 2.0 * (fTemp449 / fTemp51) - fRec845[1];
			fRec846[0] = fRec846[1] + 2.0 * (fTemp50 * fTemp449 / fTemp51);
			double fRec847 = fTemp53 * fTemp449 / fTemp51;
			double fTemp450 = fTemp55 * (fTemp440 - fRec849[1]) + fRec848[1];
			fRec848[0] = 2.0 * (fTemp450 / fTemp56) - fRec848[1];
			fRec849[0] = fRec849[1] + 2.0 * (fTemp55 * fTemp450 / fTemp56);
			double fRec850 = fTemp58 * fTemp450 / fTemp56;
			double fTemp451 = fTemp61 * (fTemp440 - fRec852[1]) + fRec851[1];
			fRec851[0] = 2.0 * (fTemp451 / fTemp62) - fRec851[1];
			fRec852[0] = fRec852[1] + 2.0 * (fTemp61 * fTemp451 / fTemp62);
			double fRec853 = fTemp64 * fTemp451 / fTemp62;
			double fTemp452 = fTemp66 * (fTemp440 - fRec855[1]) + fRec854[1];
			fRec854[0] = 2.0 * (fTemp452 / fTemp67) - fRec854[1];
			fRec855[0] = fRec855[1] + 2.0 * (fTemp66 * fTemp452 / fTemp67);
			double fRec856 = fTemp69 * fTemp452 / fTemp67;
			double fTemp453 = fTemp71 * (fTemp440 - fRec858[1]) + fRec857[1];
			fRec857[0] = 2.0 * (fTemp453 / fTemp72) - fRec857[1];
			fRec858[0] = fRec858[1] + 2.0 * (fTemp71 * fTemp453 / fTemp72);
			double fRec859 = fTemp74 * fTemp453 / fTemp72;
			double fTemp454 = fTemp76 * (fTemp440 - fRec861[1]) + fRec860[1];
			fRec860[0] = 2.0 * (fTemp454 / fTemp77) - fRec860[1];
			fRec861[0] = fRec861[1] + 2.0 * (fTemp76 * fTemp454 / fTemp77);
			double fRec862 = fTemp79 * fTemp454 / fTemp77;
			double fTemp455 = fTemp81 * (fTemp440 - fRec864[1]) + fRec863[1];
			fRec863[0] = 2.0 * (fTemp455 / fTemp82) - fRec863[1];
			fRec864[0] = fRec864[1] + 2.0 * (fTemp81 * fTemp455 / fTemp82);
			double fRec865 = fTemp84 * fTemp455 / fTemp82;
			double fTemp456 = fTemp86 * (fTemp440 - fRec867[1]) + fRec866[1];
			fRec866[0] = 2.0 * (fTemp456 / fTemp87) - fRec866[1];
			fRec867[0] = fRec867[1] + 2.0 * (fTemp86 * fTemp456 / fTemp87);
			double fRec868 = fTemp89 * fTemp456 / fTemp87;
			double fTemp457 = fTemp91 * (fTemp440 - fRec870[1]) + fRec869[1];
			double fTemp458 = fTemp457 / fTemp92;
			fRec869[0] = 2.0 * fTemp458 - fRec869[1];
			fRec870[0] = fRec870[1] + 2.0 * (fTemp91 * fTemp457 / fTemp92);
			double fRec871 = fTemp458;
			double fTemp459 = fTemp96 * (fTemp440 - fRec873[1]) + fRec872[1];
			fRec872[0] = 2.0 * (fTemp459 / fTemp97) - fRec872[1];
			fRec873[0] = fRec873[1] + 2.0 * (fTemp96 * fTemp459 / fTemp97);
			double fRec874 = fTemp99 * fTemp459 / fTemp97;
			double fTemp460 = fTemp101 * (fTemp440 - fRec876[1]) + fRec875[1];
			fRec875[0] = 2.0 * (fTemp460 / fTemp102) - fRec875[1];
			fRec876[0] = fRec876[1] + 2.0 * (fTemp101 * fTemp460 / fTemp102);
			double fRec877 = fTemp104 * fTemp460 / fTemp102;
			double fTemp461 = fTemp106 * (fTemp440 - fRec879[1]) + fRec878[1];
			fRec878[0] = 2.0 * (fTemp461 / fTemp107) - fRec878[1];
			fRec879[0] = fRec879[1] + 2.0 * (fTemp106 * fTemp461 / fTemp107);
			double fRec880 = fTemp109 * fTemp461 / fTemp107;
			double fTemp462 = fTemp111 * (fTemp440 - fRec882[1]) + fRec881[1];
			fRec881[0] = 2.0 * (fTemp462 / fTemp112) - fRec881[1];
			fRec882[0] = fRec882[1] + 2.0 * (fTemp111 * fTemp462 / fTemp112);
			double fRec883 = fTemp114 * fTemp462 / fTemp112;
			double fTemp463 = fTemp116 * (fTemp440 - fRec885[1]) + fRec884[1];
			fRec884[0] = 2.0 * (fTemp463 / fTemp117) - fRec884[1];
			fRec885[0] = fRec885[1] + 2.0 * (fTemp116 * fTemp463 / fTemp117);
			double fRec886 = fTemp119 * fTemp463 / fTemp117;
			double fTemp464 = fTemp121 * (fTemp440 - fRec888[1]) + fRec887[1];
			fRec887[0] = 2.0 * (fTemp464 / fTemp122) - fRec887[1];
			fRec888[0] = fRec888[1] + 2.0 * (fTemp121 * fTemp464 / fTemp122);
			double fRec889 = fTemp124 * fTemp464 / fTemp122;
			double fTemp465 = fTemp126 * (fTemp440 - fRec891[1]) + fRec890[1];
			fRec890[0] = 2.0 * (fTemp465 / fTemp127) - fRec890[1];
			fRec891[0] = fRec891[1] + 2.0 * (fTemp126 * fTemp465 / fTemp127);
			double fRec892 = fTemp129 * fTemp465 / fTemp127;
			double fTemp466 = fTemp131 * (fTemp440 - fRec894[1]) + fRec893[1];
			fRec893[0] = 2.0 * (fTemp466 / fTemp132) - fRec893[1];
			fRec894[0] = fRec894[1] + 2.0 * (fTemp131 * fTemp466 / fTemp132);
			double fRec895 = fTemp134 * fTemp466 / fTemp132;
			double fTemp467 = fTemp136 * (fTemp440 - fRec897[1]) + fRec896[1];
			fRec896[0] = 2.0 * (fTemp467 / fTemp137) - fRec896[1];
			fRec897[0] = fRec897[1] + 2.0 * (fTemp136 * fTemp467 / fTemp137);
			double fRec898 = fTemp139 * fTemp467 / fTemp137;
			double fTemp468 = fTemp141 * (fTemp440 - fRec900[1]) + fRec899[1];
			fRec899[0] = 2.0 * (fTemp468 / fTemp142) - fRec899[1];
			fRec900[0] = fRec900[1] + 2.0 * (fTemp141 * fTemp468 / fTemp142);
			double fRec901 = fTemp144 * fTemp468 / fTemp142;
			double fTemp469 = fTemp146 * (fTemp440 - fRec903[1]) + fRec902[1];
			fRec902[0] = 2.0 * (fTemp469 / fTemp147) - fRec902[1];
			fRec903[0] = fRec903[1] + 2.0 * (fTemp146 * fTemp469 / fTemp147);
			double fRec904 = fTemp149 * fTemp469 / fTemp147;
			double fTemp470 = fTemp151 * (fTemp440 - fRec906[1]) + fRec905[1];
			fRec905[0] = 2.0 * (fTemp470 / fTemp152) - fRec905[1];
			fRec906[0] = fRec906[1] + 2.0 * (fTemp151 * fTemp470 / fTemp152);
			double fRec907 = fTemp154 * fTemp470 / fTemp152;
			double fTemp471 = fTemp156 * (fTemp440 - fRec909[1]) + fRec908[1];
			fRec908[0] = 2.0 * (fTemp471 / fTemp157) - fRec908[1];
			fRec909[0] = fRec909[1] + 2.0 * (fTemp156 * fTemp471 / fTemp157);
			double fRec910 = fTemp159 * fTemp471 / fTemp157;
			double fTemp472 = fTemp161 * (fTemp440 - fRec912[1]) + fRec911[1];
			fRec911[0] = 2.0 * (fTemp472 / fTemp162) - fRec911[1];
			fRec912[0] = fRec912[1] + 2.0 * (fTemp161 * fTemp472 / fTemp162);
			double fRec913 = fTemp164 * fTemp472 / fTemp162;
			double fTemp473 = fTemp166 * (fTemp440 - fRec915[1]) + fRec914[1];
			fRec914[0] = 2.0 * (fTemp473 / fTemp167) - fRec914[1];
			fRec915[0] = fRec915[1] + 2.0 * (fTemp166 * fTemp473 / fTemp167);
			double fRec916 = fTemp169 * fTemp473 / fTemp167;
			fRec620[0] = 0.03125 * fTemp170 * (fRec916 + fRec913 + fRec910 + fRec907 + fRec904 + fRec901 + fRec898 + fRec895 + fRec892 + fRec889 + fRec886 + fRec883 + fRec880 + fRec877 + fRec874 + fRec871 + fRec868 + fRec865 + fRec862 + fRec859 + fRec856 + fRec853 + fRec850 + fRec847 + fRec844 + fRec841 + fRec838 + fRec835 + fRec832 + fRec829 + fRec826 + fRec823) + fTemp175 * fTemp439;
			double fTemp474 = (fRec620[0] + fRec618[0] + fRec619[0]) / fTemp0;
			fVec15[IOTA0 & 4194303] = fTemp474;
			fRec7[IOTA0 & 511] = 0.3333333333333333 * fTemp474;
			double fTemp475 = ((fRec922[1] != 0.0) ? (((fRec923[1] > 0.0) & (fRec923[1] < 1.0)) ? fRec922[1] : 0.0) : (((fRec923[1] == 0.0) & (fConst10 != fRec924[1])) ? 0.0009765625 : (((fRec923[1] == 1.0) & (fConst10 != fRec925[1])) ? -0.0009765625 : 0.0)));
			fRec922[0] = fTemp475;
			fRec923[0] = std::max<double>(0.0, std::min<double>(1.0, fRec923[1] + fTemp475));
			fRec924[0] = (((fRec923[1] >= 1.0) & (fRec925[1] != fConst10)) ? fConst10 : fRec924[1]);
			fRec925[0] = (((fRec923[1] <= 0.0) & (fRec924[1] != fConst10)) ? fConst10 : fRec925[1]);
			double fTemp476 = fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec924[0])))) & 4194303];
			fRec921[0] = 0.25 * fTemp476 + fRec923[0] * (0.0 - 0.25 * (fTemp476 - fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec925[0])))) & 4194303]));
			double fTemp477 = fTemp9 * (fRec918[1] - fRec917[1]);
			fVec16[0] = fRec917[1] + fTemp477 + fRec921[1] + fTemp5;
			fRec920[0] = fRec921[1] + fTemp477 + 0.995 * fRec920[1] + fRec917[1] + (1.2 - (fVec0[1] + fVec16[1]));
			double fTemp478 = tanh(fRec920[0] / fTemp0);
			double fTemp479 = fRec9[0] * fTemp478;
			double fTemp480 = fTemp3 * (fTemp479 - fRec927[1]) + fRec926[1];
			fRec926[0] = 2.0 * (fTemp480 / fTemp4) - fRec926[1];
			fRec927[0] = fRec927[1] + 2.0 * (fTemp3 * fTemp480 / fTemp4);
			double fRec928 = fTemp13 * fTemp480 / fTemp4;
			double fTemp481 = fTemp15 * (fTemp479 - fRec930[1]) + fRec929[1];
			fRec929[0] = 2.0 * (fTemp481 / fTemp16) - fRec929[1];
			fRec930[0] = fRec930[1] + 2.0 * (fTemp15 * fTemp481 / fTemp16);
			double fRec931 = fTemp18 * fTemp481 / fTemp16;
			double fTemp482 = fTemp20 * (fTemp479 - fRec933[1]) + fRec932[1];
			fRec932[0] = 2.0 * (fTemp482 / fTemp21) - fRec932[1];
			fRec933[0] = fRec933[1] + 2.0 * (fTemp20 * fTemp482 / fTemp21);
			double fRec934 = fTemp23 * fTemp482 / fTemp21;
			double fTemp483 = fTemp25 * (fTemp479 - fRec936[1]) + fRec935[1];
			fRec935[0] = 2.0 * (fTemp483 / fTemp26) - fRec935[1];
			fRec936[0] = fRec936[1] + 2.0 * (fTemp25 * fTemp483 / fTemp26);
			double fRec937 = fTemp28 * fTemp483 / fTemp26;
			double fTemp484 = fTemp30 * (fTemp479 - fRec939[1]) + fRec938[1];
			fRec938[0] = 2.0 * (fTemp484 / fTemp31) - fRec938[1];
			fRec939[0] = fRec939[1] + 2.0 * (fTemp30 * fTemp484 / fTemp31);
			double fRec940 = fTemp33 * fTemp484 / fTemp31;
			double fTemp485 = fTemp35 * (fTemp479 - fRec942[1]) + fRec941[1];
			fRec941[0] = 2.0 * (fTemp485 / fTemp36) - fRec941[1];
			fRec942[0] = fRec942[1] + 2.0 * (fTemp35 * fTemp485 / fTemp36);
			double fRec943 = fTemp38 * fTemp485 / fTemp36;
			double fTemp486 = fTemp40 * (fTemp479 - fRec945[1]) + fRec944[1];
			fRec944[0] = 2.0 * (fTemp486 / fTemp41) - fRec944[1];
			fRec945[0] = fRec945[1] + 2.0 * (fTemp40 * fTemp486 / fTemp41);
			double fRec946 = fTemp43 * fTemp486 / fTemp41;
			double fTemp487 = fTemp45 * (fTemp479 - fRec948[1]) + fRec947[1];
			fRec947[0] = 2.0 * (fTemp487 / fTemp46) - fRec947[1];
			fRec948[0] = fRec948[1] + 2.0 * (fTemp45 * fTemp487 / fTemp46);
			double fRec949 = fTemp48 * fTemp487 / fTemp46;
			double fTemp488 = fTemp50 * (fTemp479 - fRec951[1]) + fRec950[1];
			fRec950[0] = 2.0 * (fTemp488 / fTemp51) - fRec950[1];
			fRec951[0] = fRec951[1] + 2.0 * (fTemp50 * fTemp488 / fTemp51);
			double fRec952 = fTemp53 * fTemp488 / fTemp51;
			double fTemp489 = fTemp55 * (fTemp479 - fRec954[1]) + fRec953[1];
			fRec953[0] = 2.0 * (fTemp489 / fTemp56) - fRec953[1];
			fRec954[0] = fRec954[1] + 2.0 * (fTemp55 * fTemp489 / fTemp56);
			double fRec955 = fTemp58 * fTemp489 / fTemp56;
			double fTemp490 = fTemp61 * (fTemp479 - fRec957[1]) + fRec956[1];
			fRec956[0] = 2.0 * (fTemp490 / fTemp62) - fRec956[1];
			fRec957[0] = fRec957[1] + 2.0 * (fTemp61 * fTemp490 / fTemp62);
			double fRec958 = fTemp64 * fTemp490 / fTemp62;
			double fTemp491 = fTemp66 * (fTemp479 - fRec960[1]) + fRec959[1];
			fRec959[0] = 2.0 * (fTemp491 / fTemp67) - fRec959[1];
			fRec960[0] = fRec960[1] + 2.0 * (fTemp66 * fTemp491 / fTemp67);
			double fRec961 = fTemp69 * fTemp491 / fTemp67;
			double fTemp492 = fTemp71 * (fTemp479 - fRec963[1]) + fRec962[1];
			fRec962[0] = 2.0 * (fTemp492 / fTemp72) - fRec962[1];
			fRec963[0] = fRec963[1] + 2.0 * (fTemp71 * fTemp492 / fTemp72);
			double fRec964 = fTemp74 * fTemp492 / fTemp72;
			double fTemp493 = fTemp76 * (fTemp479 - fRec966[1]) + fRec965[1];
			fRec965[0] = 2.0 * (fTemp493 / fTemp77) - fRec965[1];
			fRec966[0] = fRec966[1] + 2.0 * (fTemp76 * fTemp493 / fTemp77);
			double fRec967 = fTemp79 * fTemp493 / fTemp77;
			double fTemp494 = fTemp81 * (fTemp479 - fRec969[1]) + fRec968[1];
			fRec968[0] = 2.0 * (fTemp494 / fTemp82) - fRec968[1];
			fRec969[0] = fRec969[1] + 2.0 * (fTemp81 * fTemp494 / fTemp82);
			double fRec970 = fTemp84 * fTemp494 / fTemp82;
			double fTemp495 = fTemp86 * (fTemp479 - fRec972[1]) + fRec971[1];
			fRec971[0] = 2.0 * (fTemp495 / fTemp87) - fRec971[1];
			fRec972[0] = fRec972[1] + 2.0 * (fTemp86 * fTemp495 / fTemp87);
			double fRec973 = fTemp89 * fTemp495 / fTemp87;
			double fTemp496 = fTemp91 * (fTemp479 - fRec975[1]) + fRec974[1];
			double fTemp497 = fTemp496 / fTemp92;
			fRec974[0] = 2.0 * fTemp497 - fRec974[1];
			fRec975[0] = fRec975[1] + 2.0 * (fTemp91 * fTemp496 / fTemp92);
			double fRec976 = fTemp497;
			double fTemp498 = fTemp96 * (fTemp479 - fRec978[1]) + fRec977[1];
			fRec977[0] = 2.0 * (fTemp498 / fTemp97) - fRec977[1];
			fRec978[0] = fRec978[1] + 2.0 * (fTemp96 * fTemp498 / fTemp97);
			double fRec979 = fTemp99 * fTemp498 / fTemp97;
			double fTemp499 = fTemp101 * (fTemp479 - fRec981[1]) + fRec980[1];
			fRec980[0] = 2.0 * (fTemp499 / fTemp102) - fRec980[1];
			fRec981[0] = fRec981[1] + 2.0 * (fTemp101 * fTemp499 / fTemp102);
			double fRec982 = fTemp104 * fTemp499 / fTemp102;
			double fTemp500 = fTemp106 * (fTemp479 - fRec984[1]) + fRec983[1];
			fRec983[0] = 2.0 * (fTemp500 / fTemp107) - fRec983[1];
			fRec984[0] = fRec984[1] + 2.0 * (fTemp106 * fTemp500 / fTemp107);
			double fRec985 = fTemp109 * fTemp500 / fTemp107;
			double fTemp501 = fTemp111 * (fTemp479 - fRec987[1]) + fRec986[1];
			fRec986[0] = 2.0 * (fTemp501 / fTemp112) - fRec986[1];
			fRec987[0] = fRec987[1] + 2.0 * (fTemp111 * fTemp501 / fTemp112);
			double fRec988 = fTemp114 * fTemp501 / fTemp112;
			double fTemp502 = fTemp116 * (fTemp479 - fRec990[1]) + fRec989[1];
			fRec989[0] = 2.0 * (fTemp502 / fTemp117) - fRec989[1];
			fRec990[0] = fRec990[1] + 2.0 * (fTemp116 * fTemp502 / fTemp117);
			double fRec991 = fTemp119 * fTemp502 / fTemp117;
			double fTemp503 = fTemp121 * (fTemp479 - fRec993[1]) + fRec992[1];
			fRec992[0] = 2.0 * (fTemp503 / fTemp122) - fRec992[1];
			fRec993[0] = fRec993[1] + 2.0 * (fTemp121 * fTemp503 / fTemp122);
			double fRec994 = fTemp124 * fTemp503 / fTemp122;
			double fTemp504 = fTemp126 * (fTemp479 - fRec996[1]) + fRec995[1];
			fRec995[0] = 2.0 * (fTemp504 / fTemp127) - fRec995[1];
			fRec996[0] = fRec996[1] + 2.0 * (fTemp126 * fTemp504 / fTemp127);
			double fRec997 = fTemp129 * fTemp504 / fTemp127;
			double fTemp505 = fTemp131 * (fTemp479 - fRec999[1]) + fRec998[1];
			fRec998[0] = 2.0 * (fTemp505 / fTemp132) - fRec998[1];
			fRec999[0] = fRec999[1] + 2.0 * (fTemp131 * fTemp505 / fTemp132);
			double fRec1000 = fTemp134 * fTemp505 / fTemp132;
			double fTemp506 = fTemp136 * (fTemp479 - fRec1002[1]) + fRec1001[1];
			fRec1001[0] = 2.0 * (fTemp506 / fTemp137) - fRec1001[1];
			fRec1002[0] = fRec1002[1] + 2.0 * (fTemp136 * fTemp506 / fTemp137);
			double fRec1003 = fTemp139 * fTemp506 / fTemp137;
			double fTemp507 = fTemp141 * (fTemp479 - fRec1005[1]) + fRec1004[1];
			fRec1004[0] = 2.0 * (fTemp507 / fTemp142) - fRec1004[1];
			fRec1005[0] = fRec1005[1] + 2.0 * (fTemp141 * fTemp507 / fTemp142);
			double fRec1006 = fTemp144 * fTemp507 / fTemp142;
			double fTemp508 = fTemp146 * (fTemp479 - fRec1008[1]) + fRec1007[1];
			fRec1007[0] = 2.0 * (fTemp508 / fTemp147) - fRec1007[1];
			fRec1008[0] = fRec1008[1] + 2.0 * (fTemp146 * fTemp508 / fTemp147);
			double fRec1009 = fTemp149 * fTemp508 / fTemp147;
			double fTemp509 = fTemp151 * (fTemp479 - fRec1011[1]) + fRec1010[1];
			fRec1010[0] = 2.0 * (fTemp509 / fTemp152) - fRec1010[1];
			fRec1011[0] = fRec1011[1] + 2.0 * (fTemp151 * fTemp509 / fTemp152);
			double fRec1012 = fTemp154 * fTemp509 / fTemp152;
			double fTemp510 = fTemp156 * (fTemp479 - fRec1014[1]) + fRec1013[1];
			fRec1013[0] = 2.0 * (fTemp510 / fTemp157) - fRec1013[1];
			fRec1014[0] = fRec1014[1] + 2.0 * (fTemp156 * fTemp510 / fTemp157);
			double fRec1015 = fTemp159 * fTemp510 / fTemp157;
			double fTemp511 = fTemp161 * (fTemp479 - fRec1017[1]) + fRec1016[1];
			fRec1016[0] = 2.0 * (fTemp511 / fTemp162) - fRec1016[1];
			fRec1017[0] = fRec1017[1] + 2.0 * (fTemp161 * fTemp511 / fTemp162);
			double fRec1018 = fTemp164 * fTemp511 / fTemp162;
			double fTemp512 = fTemp166 * (fTemp479 - fRec1020[1]) + fRec1019[1];
			fRec1019[0] = 2.0 * (fTemp512 / fTemp167) - fRec1019[1];
			fRec1020[0] = fRec1020[1] + 2.0 * (fTemp166 * fTemp512 / fTemp167);
			double fRec1021 = fTemp169 * fTemp512 / fTemp167;
			fRec917[0] = 0.03125 * fTemp170 * (fRec1021 + fRec1018 + fRec1015 + fRec1012 + fRec1009 + fRec1006 + fRec1003 + fRec1000 + fRec997 + fRec994 + fRec991 + fRec988 + fRec985 + fRec982 + fRec979 + fRec976 + fRec973 + fRec970 + fRec967 + fRec964 + fRec961 + fRec958 + fRec955 + fRec952 + fRec949 + fRec946 + fRec943 + fRec940 + fRec937 + fRec934 + fRec931 + fRec928) + fTemp175 * fTemp478;
			double fTemp513 = fRec918[1] + fRec921[1];
			double fTemp514 = fRec27[0] * (fRec917[1] * (fRec124[0] - fRec919[1]) - fRec918[1]);
			fVec17[0] = fTemp514 + fTemp513 + fTemp171;
			fRec1022[0] = fTemp514 + 0.995 * fRec1022[1] + fTemp513 + (1.3 - (fVec3[1] + fVec17[1]));
			double fTemp515 = tanh(fRec1022[0] / fTemp0);
			double fTemp516 = fRec9[0] * fTemp515;
			double fTemp517 = fTemp3 * (fTemp516 - fRec1024[1]) + fRec1023[1];
			fRec1023[0] = 2.0 * (fTemp517 / fTemp4) - fRec1023[1];
			fRec1024[0] = fRec1024[1] + 2.0 * (fTemp3 * fTemp517 / fTemp4);
			double fRec1025 = fTemp13 * fTemp517 / fTemp4;
			double fTemp518 = fTemp15 * (fTemp516 - fRec1027[1]) + fRec1026[1];
			fRec1026[0] = 2.0 * (fTemp518 / fTemp16) - fRec1026[1];
			fRec1027[0] = fRec1027[1] + 2.0 * (fTemp15 * fTemp518 / fTemp16);
			double fRec1028 = fTemp18 * fTemp518 / fTemp16;
			double fTemp519 = fTemp20 * (fTemp516 - fRec1030[1]) + fRec1029[1];
			fRec1029[0] = 2.0 * (fTemp519 / fTemp21) - fRec1029[1];
			fRec1030[0] = fRec1030[1] + 2.0 * (fTemp20 * fTemp519 / fTemp21);
			double fRec1031 = fTemp23 * fTemp519 / fTemp21;
			double fTemp520 = fTemp25 * (fTemp516 - fRec1033[1]) + fRec1032[1];
			fRec1032[0] = 2.0 * (fTemp520 / fTemp26) - fRec1032[1];
			fRec1033[0] = fRec1033[1] + 2.0 * (fTemp25 * fTemp520 / fTemp26);
			double fRec1034 = fTemp28 * fTemp520 / fTemp26;
			double fTemp521 = fTemp30 * (fTemp516 - fRec1036[1]) + fRec1035[1];
			fRec1035[0] = 2.0 * (fTemp521 / fTemp31) - fRec1035[1];
			fRec1036[0] = fRec1036[1] + 2.0 * (fTemp30 * fTemp521 / fTemp31);
			double fRec1037 = fTemp33 * fTemp521 / fTemp31;
			double fTemp522 = fTemp35 * (fTemp516 - fRec1039[1]) + fRec1038[1];
			fRec1038[0] = 2.0 * (fTemp522 / fTemp36) - fRec1038[1];
			fRec1039[0] = fRec1039[1] + 2.0 * (fTemp35 * fTemp522 / fTemp36);
			double fRec1040 = fTemp38 * fTemp522 / fTemp36;
			double fTemp523 = fTemp40 * (fTemp516 - fRec1042[1]) + fRec1041[1];
			fRec1041[0] = 2.0 * (fTemp523 / fTemp41) - fRec1041[1];
			fRec1042[0] = fRec1042[1] + 2.0 * (fTemp40 * fTemp523 / fTemp41);
			double fRec1043 = fTemp43 * fTemp523 / fTemp41;
			double fTemp524 = fTemp45 * (fTemp516 - fRec1045[1]) + fRec1044[1];
			fRec1044[0] = 2.0 * (fTemp524 / fTemp46) - fRec1044[1];
			fRec1045[0] = fRec1045[1] + 2.0 * (fTemp45 * fTemp524 / fTemp46);
			double fRec1046 = fTemp48 * fTemp524 / fTemp46;
			double fTemp525 = fTemp50 * (fTemp516 - fRec1048[1]) + fRec1047[1];
			fRec1047[0] = 2.0 * (fTemp525 / fTemp51) - fRec1047[1];
			fRec1048[0] = fRec1048[1] + 2.0 * (fTemp50 * fTemp525 / fTemp51);
			double fRec1049 = fTemp53 * fTemp525 / fTemp51;
			double fTemp526 = fTemp55 * (fTemp516 - fRec1051[1]) + fRec1050[1];
			fRec1050[0] = 2.0 * (fTemp526 / fTemp56) - fRec1050[1];
			fRec1051[0] = fRec1051[1] + 2.0 * (fTemp55 * fTemp526 / fTemp56);
			double fRec1052 = fTemp58 * fTemp526 / fTemp56;
			double fTemp527 = fTemp61 * (fTemp516 - fRec1054[1]) + fRec1053[1];
			fRec1053[0] = 2.0 * (fTemp527 / fTemp62) - fRec1053[1];
			fRec1054[0] = fRec1054[1] + 2.0 * (fTemp61 * fTemp527 / fTemp62);
			double fRec1055 = fTemp64 * fTemp527 / fTemp62;
			double fTemp528 = fTemp66 * (fTemp516 - fRec1057[1]) + fRec1056[1];
			fRec1056[0] = 2.0 * (fTemp528 / fTemp67) - fRec1056[1];
			fRec1057[0] = fRec1057[1] + 2.0 * (fTemp66 * fTemp528 / fTemp67);
			double fRec1058 = fTemp69 * fTemp528 / fTemp67;
			double fTemp529 = fTemp71 * (fTemp516 - fRec1060[1]) + fRec1059[1];
			fRec1059[0] = 2.0 * (fTemp529 / fTemp72) - fRec1059[1];
			fRec1060[0] = fRec1060[1] + 2.0 * (fTemp71 * fTemp529 / fTemp72);
			double fRec1061 = fTemp74 * fTemp529 / fTemp72;
			double fTemp530 = fTemp76 * (fTemp516 - fRec1063[1]) + fRec1062[1];
			fRec1062[0] = 2.0 * (fTemp530 / fTemp77) - fRec1062[1];
			fRec1063[0] = fRec1063[1] + 2.0 * (fTemp76 * fTemp530 / fTemp77);
			double fRec1064 = fTemp79 * fTemp530 / fTemp77;
			double fTemp531 = fTemp81 * (fTemp516 - fRec1066[1]) + fRec1065[1];
			fRec1065[0] = 2.0 * (fTemp531 / fTemp82) - fRec1065[1];
			fRec1066[0] = fRec1066[1] + 2.0 * (fTemp81 * fTemp531 / fTemp82);
			double fRec1067 = fTemp84 * fTemp531 / fTemp82;
			double fTemp532 = fTemp86 * (fTemp516 - fRec1069[1]) + fRec1068[1];
			fRec1068[0] = 2.0 * (fTemp532 / fTemp87) - fRec1068[1];
			fRec1069[0] = fRec1069[1] + 2.0 * (fTemp86 * fTemp532 / fTemp87);
			double fRec1070 = fTemp89 * fTemp532 / fTemp87;
			double fTemp533 = fTemp91 * (fTemp516 - fRec1072[1]) + fRec1071[1];
			double fTemp534 = fTemp533 / fTemp92;
			fRec1071[0] = 2.0 * fTemp534 - fRec1071[1];
			fRec1072[0] = fRec1072[1] + 2.0 * (fTemp91 * fTemp533 / fTemp92);
			double fRec1073 = fTemp534;
			double fTemp535 = fTemp96 * (fTemp516 - fRec1075[1]) + fRec1074[1];
			fRec1074[0] = 2.0 * (fTemp535 / fTemp97) - fRec1074[1];
			fRec1075[0] = fRec1075[1] + 2.0 * (fTemp96 * fTemp535 / fTemp97);
			double fRec1076 = fTemp99 * fTemp535 / fTemp97;
			double fTemp536 = fTemp101 * (fTemp516 - fRec1078[1]) + fRec1077[1];
			fRec1077[0] = 2.0 * (fTemp536 / fTemp102) - fRec1077[1];
			fRec1078[0] = fRec1078[1] + 2.0 * (fTemp101 * fTemp536 / fTemp102);
			double fRec1079 = fTemp104 * fTemp536 / fTemp102;
			double fTemp537 = fTemp106 * (fTemp516 - fRec1081[1]) + fRec1080[1];
			fRec1080[0] = 2.0 * (fTemp537 / fTemp107) - fRec1080[1];
			fRec1081[0] = fRec1081[1] + 2.0 * (fTemp106 * fTemp537 / fTemp107);
			double fRec1082 = fTemp109 * fTemp537 / fTemp107;
			double fTemp538 = fTemp111 * (fTemp516 - fRec1084[1]) + fRec1083[1];
			fRec1083[0] = 2.0 * (fTemp538 / fTemp112) - fRec1083[1];
			fRec1084[0] = fRec1084[1] + 2.0 * (fTemp111 * fTemp538 / fTemp112);
			double fRec1085 = fTemp114 * fTemp538 / fTemp112;
			double fTemp539 = fTemp116 * (fTemp516 - fRec1087[1]) + fRec1086[1];
			fRec1086[0] = 2.0 * (fTemp539 / fTemp117) - fRec1086[1];
			fRec1087[0] = fRec1087[1] + 2.0 * (fTemp116 * fTemp539 / fTemp117);
			double fRec1088 = fTemp119 * fTemp539 / fTemp117;
			double fTemp540 = fTemp121 * (fTemp516 - fRec1090[1]) + fRec1089[1];
			fRec1089[0] = 2.0 * (fTemp540 / fTemp122) - fRec1089[1];
			fRec1090[0] = fRec1090[1] + 2.0 * (fTemp121 * fTemp540 / fTemp122);
			double fRec1091 = fTemp124 * fTemp540 / fTemp122;
			double fTemp541 = fTemp126 * (fTemp516 - fRec1093[1]) + fRec1092[1];
			fRec1092[0] = 2.0 * (fTemp541 / fTemp127) - fRec1092[1];
			fRec1093[0] = fRec1093[1] + 2.0 * (fTemp126 * fTemp541 / fTemp127);
			double fRec1094 = fTemp129 * fTemp541 / fTemp127;
			double fTemp542 = fTemp131 * (fTemp516 - fRec1096[1]) + fRec1095[1];
			fRec1095[0] = 2.0 * (fTemp542 / fTemp132) - fRec1095[1];
			fRec1096[0] = fRec1096[1] + 2.0 * (fTemp131 * fTemp542 / fTemp132);
			double fRec1097 = fTemp134 * fTemp542 / fTemp132;
			double fTemp543 = fTemp136 * (fTemp516 - fRec1099[1]) + fRec1098[1];
			fRec1098[0] = 2.0 * (fTemp543 / fTemp137) - fRec1098[1];
			fRec1099[0] = fRec1099[1] + 2.0 * (fTemp136 * fTemp543 / fTemp137);
			double fRec1100 = fTemp139 * fTemp543 / fTemp137;
			double fTemp544 = fTemp141 * (fTemp516 - fRec1102[1]) + fRec1101[1];
			fRec1101[0] = 2.0 * (fTemp544 / fTemp142) - fRec1101[1];
			fRec1102[0] = fRec1102[1] + 2.0 * (fTemp141 * fTemp544 / fTemp142);
			double fRec1103 = fTemp144 * fTemp544 / fTemp142;
			double fTemp545 = fTemp146 * (fTemp516 - fRec1105[1]) + fRec1104[1];
			fRec1104[0] = 2.0 * (fTemp545 / fTemp147) - fRec1104[1];
			fRec1105[0] = fRec1105[1] + 2.0 * (fTemp146 * fTemp545 / fTemp147);
			double fRec1106 = fTemp149 * fTemp545 / fTemp147;
			double fTemp546 = fTemp151 * (fTemp516 - fRec1108[1]) + fRec1107[1];
			fRec1107[0] = 2.0 * (fTemp546 / fTemp152) - fRec1107[1];
			fRec1108[0] = fRec1108[1] + 2.0 * (fTemp151 * fTemp546 / fTemp152);
			double fRec1109 = fTemp154 * fTemp546 / fTemp152;
			double fTemp547 = fTemp156 * (fTemp516 - fRec1111[1]) + fRec1110[1];
			fRec1110[0] = 2.0 * (fTemp547 / fTemp157) - fRec1110[1];
			fRec1111[0] = fRec1111[1] + 2.0 * (fTemp156 * fTemp547 / fTemp157);
			double fRec1112 = fTemp159 * fTemp547 / fTemp157;
			double fTemp548 = fTemp161 * (fTemp516 - fRec1114[1]) + fRec1113[1];
			fRec1113[0] = 2.0 * (fTemp548 / fTemp162) - fRec1113[1];
			fRec1114[0] = fRec1114[1] + 2.0 * (fTemp161 * fTemp548 / fTemp162);
			double fRec1115 = fTemp164 * fTemp548 / fTemp162;
			double fTemp549 = fTemp166 * (fTemp516 - fRec1117[1]) + fRec1116[1];
			fRec1116[0] = 2.0 * (fTemp549 / fTemp167) - fRec1116[1];
			fRec1117[0] = fRec1117[1] + 2.0 * (fTemp166 * fTemp549 / fTemp167);
			double fRec1118 = fTemp169 * fTemp549 / fTemp167;
			fRec918[0] = 0.03125 * fTemp170 * (fRec1118 + fRec1115 + fRec1112 + fRec1109 + fRec1106 + fRec1103 + fRec1100 + fRec1097 + fRec1094 + fRec1091 + fRec1088 + fRec1085 + fRec1082 + fRec1079 + fRec1076 + fRec1073 + fRec1070 + fRec1067 + fRec1064 + fRec1061 + fRec1058 + fRec1055 + fRec1052 + fRec1049 + fRec1046 + fRec1043 + fRec1040 + fRec1037 + fRec1034 + fRec1031 + fRec1028 + fRec1025) + fTemp175 * fTemp515;
			double fTemp550 = fRec921[1] + fRec919[1];
			double fTemp551 = fRec27[0] * (fRec917[1] * fRec918[1] - fRec222[0] * fRec919[1]);
			fVec18[0] = fTemp551 + fTemp550 + fTemp210;
			fRec1119[0] = fTemp551 + 0.995 * fRec1119[1] + fTemp550 + (1.6 - (fVec5[1] + fVec18[1]));
			double fTemp552 = tanh(fRec1119[0] / fTemp0);
			double fTemp553 = fRec9[0] * fTemp552;
			double fTemp554 = fTemp3 * (fTemp553 - fRec1121[1]) + fRec1120[1];
			fRec1120[0] = 2.0 * (fTemp554 / fTemp4) - fRec1120[1];
			fRec1121[0] = fRec1121[1] + 2.0 * (fTemp3 * fTemp554 / fTemp4);
			double fRec1122 = fTemp13 * fTemp554 / fTemp4;
			double fTemp555 = fTemp15 * (fTemp553 - fRec1124[1]) + fRec1123[1];
			fRec1123[0] = 2.0 * (fTemp555 / fTemp16) - fRec1123[1];
			fRec1124[0] = fRec1124[1] + 2.0 * (fTemp15 * fTemp555 / fTemp16);
			double fRec1125 = fTemp18 * fTemp555 / fTemp16;
			double fTemp556 = fTemp20 * (fTemp553 - fRec1127[1]) + fRec1126[1];
			fRec1126[0] = 2.0 * (fTemp556 / fTemp21) - fRec1126[1];
			fRec1127[0] = fRec1127[1] + 2.0 * (fTemp20 * fTemp556 / fTemp21);
			double fRec1128 = fTemp23 * fTemp556 / fTemp21;
			double fTemp557 = fTemp25 * (fTemp553 - fRec1130[1]) + fRec1129[1];
			fRec1129[0] = 2.0 * (fTemp557 / fTemp26) - fRec1129[1];
			fRec1130[0] = fRec1130[1] + 2.0 * (fTemp25 * fTemp557 / fTemp26);
			double fRec1131 = fTemp28 * fTemp557 / fTemp26;
			double fTemp558 = fTemp30 * (fTemp553 - fRec1133[1]) + fRec1132[1];
			fRec1132[0] = 2.0 * (fTemp558 / fTemp31) - fRec1132[1];
			fRec1133[0] = fRec1133[1] + 2.0 * (fTemp30 * fTemp558 / fTemp31);
			double fRec1134 = fTemp33 * fTemp558 / fTemp31;
			double fTemp559 = fTemp35 * (fTemp553 - fRec1136[1]) + fRec1135[1];
			fRec1135[0] = 2.0 * (fTemp559 / fTemp36) - fRec1135[1];
			fRec1136[0] = fRec1136[1] + 2.0 * (fTemp35 * fTemp559 / fTemp36);
			double fRec1137 = fTemp38 * fTemp559 / fTemp36;
			double fTemp560 = fTemp40 * (fTemp553 - fRec1139[1]) + fRec1138[1];
			fRec1138[0] = 2.0 * (fTemp560 / fTemp41) - fRec1138[1];
			fRec1139[0] = fRec1139[1] + 2.0 * (fTemp40 * fTemp560 / fTemp41);
			double fRec1140 = fTemp43 * fTemp560 / fTemp41;
			double fTemp561 = fTemp45 * (fTemp553 - fRec1142[1]) + fRec1141[1];
			fRec1141[0] = 2.0 * (fTemp561 / fTemp46) - fRec1141[1];
			fRec1142[0] = fRec1142[1] + 2.0 * (fTemp45 * fTemp561 / fTemp46);
			double fRec1143 = fTemp48 * fTemp561 / fTemp46;
			double fTemp562 = fTemp50 * (fTemp553 - fRec1145[1]) + fRec1144[1];
			fRec1144[0] = 2.0 * (fTemp562 / fTemp51) - fRec1144[1];
			fRec1145[0] = fRec1145[1] + 2.0 * (fTemp50 * fTemp562 / fTemp51);
			double fRec1146 = fTemp53 * fTemp562 / fTemp51;
			double fTemp563 = fTemp55 * (fTemp553 - fRec1148[1]) + fRec1147[1];
			fRec1147[0] = 2.0 * (fTemp563 / fTemp56) - fRec1147[1];
			fRec1148[0] = fRec1148[1] + 2.0 * (fTemp55 * fTemp563 / fTemp56);
			double fRec1149 = fTemp58 * fTemp563 / fTemp56;
			double fTemp564 = fTemp61 * (fTemp553 - fRec1151[1]) + fRec1150[1];
			fRec1150[0] = 2.0 * (fTemp564 / fTemp62) - fRec1150[1];
			fRec1151[0] = fRec1151[1] + 2.0 * (fTemp61 * fTemp564 / fTemp62);
			double fRec1152 = fTemp64 * fTemp564 / fTemp62;
			double fTemp565 = fTemp66 * (fTemp553 - fRec1154[1]) + fRec1153[1];
			fRec1153[0] = 2.0 * (fTemp565 / fTemp67) - fRec1153[1];
			fRec1154[0] = fRec1154[1] + 2.0 * (fTemp66 * fTemp565 / fTemp67);
			double fRec1155 = fTemp69 * fTemp565 / fTemp67;
			double fTemp566 = fTemp71 * (fTemp553 - fRec1157[1]) + fRec1156[1];
			fRec1156[0] = 2.0 * (fTemp566 / fTemp72) - fRec1156[1];
			fRec1157[0] = fRec1157[1] + 2.0 * (fTemp71 * fTemp566 / fTemp72);
			double fRec1158 = fTemp74 * fTemp566 / fTemp72;
			double fTemp567 = fTemp76 * (fTemp553 - fRec1160[1]) + fRec1159[1];
			fRec1159[0] = 2.0 * (fTemp567 / fTemp77) - fRec1159[1];
			fRec1160[0] = fRec1160[1] + 2.0 * (fTemp76 * fTemp567 / fTemp77);
			double fRec1161 = fTemp79 * fTemp567 / fTemp77;
			double fTemp568 = fTemp81 * (fTemp553 - fRec1163[1]) + fRec1162[1];
			fRec1162[0] = 2.0 * (fTemp568 / fTemp82) - fRec1162[1];
			fRec1163[0] = fRec1163[1] + 2.0 * (fTemp81 * fTemp568 / fTemp82);
			double fRec1164 = fTemp84 * fTemp568 / fTemp82;
			double fTemp569 = fTemp86 * (fTemp553 - fRec1166[1]) + fRec1165[1];
			fRec1165[0] = 2.0 * (fTemp569 / fTemp87) - fRec1165[1];
			fRec1166[0] = fRec1166[1] + 2.0 * (fTemp86 * fTemp569 / fTemp87);
			double fRec1167 = fTemp89 * fTemp569 / fTemp87;
			double fTemp570 = fTemp91 * (fTemp553 - fRec1169[1]) + fRec1168[1];
			double fTemp571 = fTemp570 / fTemp92;
			fRec1168[0] = 2.0 * fTemp571 - fRec1168[1];
			fRec1169[0] = fRec1169[1] + 2.0 * (fTemp91 * fTemp570 / fTemp92);
			double fRec1170 = fTemp571;
			double fTemp572 = fTemp96 * (fTemp553 - fRec1172[1]) + fRec1171[1];
			fRec1171[0] = 2.0 * (fTemp572 / fTemp97) - fRec1171[1];
			fRec1172[0] = fRec1172[1] + 2.0 * (fTemp96 * fTemp572 / fTemp97);
			double fRec1173 = fTemp99 * fTemp572 / fTemp97;
			double fTemp573 = fTemp101 * (fTemp553 - fRec1175[1]) + fRec1174[1];
			fRec1174[0] = 2.0 * (fTemp573 / fTemp102) - fRec1174[1];
			fRec1175[0] = fRec1175[1] + 2.0 * (fTemp101 * fTemp573 / fTemp102);
			double fRec1176 = fTemp104 * fTemp573 / fTemp102;
			double fTemp574 = fTemp106 * (fTemp553 - fRec1178[1]) + fRec1177[1];
			fRec1177[0] = 2.0 * (fTemp574 / fTemp107) - fRec1177[1];
			fRec1178[0] = fRec1178[1] + 2.0 * (fTemp106 * fTemp574 / fTemp107);
			double fRec1179 = fTemp109 * fTemp574 / fTemp107;
			double fTemp575 = fTemp111 * (fTemp553 - fRec1181[1]) + fRec1180[1];
			fRec1180[0] = 2.0 * (fTemp575 / fTemp112) - fRec1180[1];
			fRec1181[0] = fRec1181[1] + 2.0 * (fTemp111 * fTemp575 / fTemp112);
			double fRec1182 = fTemp114 * fTemp575 / fTemp112;
			double fTemp576 = fTemp116 * (fTemp553 - fRec1184[1]) + fRec1183[1];
			fRec1183[0] = 2.0 * (fTemp576 / fTemp117) - fRec1183[1];
			fRec1184[0] = fRec1184[1] + 2.0 * (fTemp116 * fTemp576 / fTemp117);
			double fRec1185 = fTemp119 * fTemp576 / fTemp117;
			double fTemp577 = fTemp121 * (fTemp553 - fRec1187[1]) + fRec1186[1];
			fRec1186[0] = 2.0 * (fTemp577 / fTemp122) - fRec1186[1];
			fRec1187[0] = fRec1187[1] + 2.0 * (fTemp121 * fTemp577 / fTemp122);
			double fRec1188 = fTemp124 * fTemp577 / fTemp122;
			double fTemp578 = fTemp126 * (fTemp553 - fRec1190[1]) + fRec1189[1];
			fRec1189[0] = 2.0 * (fTemp578 / fTemp127) - fRec1189[1];
			fRec1190[0] = fRec1190[1] + 2.0 * (fTemp126 * fTemp578 / fTemp127);
			double fRec1191 = fTemp129 * fTemp578 / fTemp127;
			double fTemp579 = fTemp131 * (fTemp553 - fRec1193[1]) + fRec1192[1];
			fRec1192[0] = 2.0 * (fTemp579 / fTemp132) - fRec1192[1];
			fRec1193[0] = fRec1193[1] + 2.0 * (fTemp131 * fTemp579 / fTemp132);
			double fRec1194 = fTemp134 * fTemp579 / fTemp132;
			double fTemp580 = fTemp136 * (fTemp553 - fRec1196[1]) + fRec1195[1];
			fRec1195[0] = 2.0 * (fTemp580 / fTemp137) - fRec1195[1];
			fRec1196[0] = fRec1196[1] + 2.0 * (fTemp136 * fTemp580 / fTemp137);
			double fRec1197 = fTemp139 * fTemp580 / fTemp137;
			double fTemp581 = fTemp141 * (fTemp553 - fRec1199[1]) + fRec1198[1];
			fRec1198[0] = 2.0 * (fTemp581 / fTemp142) - fRec1198[1];
			fRec1199[0] = fRec1199[1] + 2.0 * (fTemp141 * fTemp581 / fTemp142);
			double fRec1200 = fTemp144 * fTemp581 / fTemp142;
			double fTemp582 = fTemp146 * (fTemp553 - fRec1202[1]) + fRec1201[1];
			fRec1201[0] = 2.0 * (fTemp582 / fTemp147) - fRec1201[1];
			fRec1202[0] = fRec1202[1] + 2.0 * (fTemp146 * fTemp582 / fTemp147);
			double fRec1203 = fTemp149 * fTemp582 / fTemp147;
			double fTemp583 = fTemp151 * (fTemp553 - fRec1205[1]) + fRec1204[1];
			fRec1204[0] = 2.0 * (fTemp583 / fTemp152) - fRec1204[1];
			fRec1205[0] = fRec1205[1] + 2.0 * (fTemp151 * fTemp583 / fTemp152);
			double fRec1206 = fTemp154 * fTemp583 / fTemp152;
			double fTemp584 = fTemp156 * (fTemp553 - fRec1208[1]) + fRec1207[1];
			fRec1207[0] = 2.0 * (fTemp584 / fTemp157) - fRec1207[1];
			fRec1208[0] = fRec1208[1] + 2.0 * (fTemp156 * fTemp584 / fTemp157);
			double fRec1209 = fTemp159 * fTemp584 / fTemp157;
			double fTemp585 = fTemp161 * (fTemp553 - fRec1211[1]) + fRec1210[1];
			fRec1210[0] = 2.0 * (fTemp585 / fTemp162) - fRec1210[1];
			fRec1211[0] = fRec1211[1] + 2.0 * (fTemp161 * fTemp585 / fTemp162);
			double fRec1212 = fTemp164 * fTemp585 / fTemp162;
			double fTemp586 = fTemp166 * (fTemp553 - fRec1214[1]) + fRec1213[1];
			fRec1213[0] = 2.0 * (fTemp586 / fTemp167) - fRec1213[1];
			fRec1214[0] = fRec1214[1] + 2.0 * (fTemp166 * fTemp586 / fTemp167);
			double fRec1215 = fTemp169 * fTemp586 / fTemp167;
			fRec919[0] = 0.03125 * fTemp170 * (fRec1215 + fRec1212 + fRec1209 + fRec1206 + fRec1203 + fRec1200 + fRec1197 + fRec1194 + fRec1191 + fRec1188 + fRec1185 + fRec1182 + fRec1179 + fRec1176 + fRec1173 + fRec1170 + fRec1167 + fRec1164 + fRec1161 + fRec1158 + fRec1155 + fRec1152 + fRec1149 + fRec1146 + fRec1143 + fRec1140 + fRec1137 + fRec1134 + fRec1131 + fRec1128 + fRec1125 + fRec1122) + fTemp175 * fTemp552;
			double fTemp587 = (fRec919[0] + fRec917[0] + fRec918[0]) / fTemp0;
			fVec19[IOTA0 & 4194303] = fTemp587;
			fRec8[IOTA0 & 511] = 0.3333333333333333 * fTemp587;
			double fTemp588 = std::fabs(fRec5[IOTA0 & 511]);
			int iTemp589 = (fTemp588 >= fRec4[1]) | (double(iRec3[1]) >= fConst2);
			iRec3[0] = ((iTemp589) ? 0 : iRec3[1] + 1);
			fRec4[0] = ((iTemp589) ? fTemp588 : fRec4[1]);
			double fTemp590 = fRec4[0] - fRec1[1];
			fRec1[0] = fRec1[1] + fConst13 * fTemp590;
			double fTemp591 = fRec1[1] + fConst12 * fTemp590;
			double fRec2 = fTemp591;
			fRec0[0] = std::max<double>(fConst1 * fRec0[1], std::fabs(fRec2));
			fRec1216[0] = fSlow11 + fConst3 * fRec1216[1];
			output0[i0] = FAUSTFLOAT(fRec1216[0] * fRec5[(IOTA0 - iConst14) & 511] / fRec0[0]);
			double fTemp592 = std::fabs(fRec6[IOTA0 & 511]);
			int iTemp593 = (fTemp592 >= fRec1221[1]) | (double(iRec1220[1]) >= fConst2);
			iRec1220[0] = ((iTemp593) ? 0 : iRec1220[1] + 1);
			fRec1221[0] = ((iTemp593) ? fTemp592 : fRec1221[1]);
			double fTemp594 = fRec1221[0] - fRec1218[1];
			fRec1218[0] = fRec1218[1] + fConst13 * fTemp594;
			double fTemp595 = fRec1218[1] + fConst12 * fTemp594;
			double fRec1219 = fTemp595;
			fRec1217[0] = std::max<double>(fConst1 * fRec1217[1], std::fabs(fRec1219));
			output1[i0] = FAUSTFLOAT(fRec1216[0] * fRec6[(IOTA0 - iConst14) & 511] / fRec1217[0]);
			double fTemp596 = std::fabs(fRec7[IOTA0 & 511]);
			int iTemp597 = (fTemp596 >= fRec1226[1]) | (double(iRec1225[1]) >= fConst2);
			iRec1225[0] = ((iTemp597) ? 0 : iRec1225[1] + 1);
			fRec1226[0] = ((iTemp597) ? fTemp596 : fRec1226[1]);
			double fTemp598 = fRec1226[0] - fRec1223[1];
			fRec1223[0] = fRec1223[1] + fConst13 * fTemp598;
			double fTemp599 = fRec1223[1] + fConst12 * fTemp598;
			double fRec1224 = fTemp599;
			fRec1222[0] = std::max<double>(fConst1 * fRec1222[1], std::fabs(fRec1224));
			output2[i0] = FAUSTFLOAT(fRec1216[0] * fRec7[(IOTA0 - iConst14) & 511] / fRec1222[0]);
			double fTemp600 = std::fabs(fRec8[IOTA0 & 511]);
			int iTemp601 = (fTemp600 >= fRec1231[1]) | (double(iRec1230[1]) >= fConst2);
			iRec1230[0] = ((iTemp601) ? 0 : iRec1230[1] + 1);
			fRec1231[0] = ((iTemp601) ? fTemp600 : fRec1231[1]);
			double fTemp602 = fRec1231[0] - fRec1228[1];
			fRec1228[0] = fRec1228[1] + fConst13 * fTemp602;
			double fTemp603 = fRec1228[1] + fConst12 * fTemp602;
			double fRec1229 = fTemp603;
			fRec1227[0] = std::max<double>(fConst1 * fRec1227[1], std::fabs(fRec1229));
			output3[i0] = FAUSTFLOAT(fRec1216[0] * fRec8[(IOTA0 - iConst14) & 511] / fRec1227[0]);
			fRec9[1] = fRec9[0];
			fRec16[1] = fRec16[0];
			fRec17[1] = fRec17[0];
			fRec18[1] = fRec18[0];
	...
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Amplificators [2]/Lorenz Tan", fVslider0, 1.0, 1.0, 1e+02, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/BP Bypass", fVslider8, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Bandwidth", fVslider4, 1.0, 1.0, 1e+02, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Frequency", fVslider3, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Interpolations 1", fVslider1, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Interpolations 2", fVslider2, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Input/Output [3]/External Sum", fVslider5, 0.0, 0.0, 1e+02, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Input/Output [3]/Master", fVslider11, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Beta", fVslider10, 0.1, 0.0, 1e+01, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Dt", fVslider6, 0.62, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Rho", fVslider9, 0.01, 0.0, 0.1, 0.001);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Sigma", fVslider7, 8.2, 0.0, 1e+02, 0.001);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, Lorenz_Tan, "RITI Mixer/Amplificators [2]/Lorenz Tan", fVslider0, 1.0, 1.0, 1e+02, 0.001) \
		p(VERTICALSLIDER, BP_Bypass, "RITI Mixer/Bandpass Filters Bank [1]/BP Bypass", fVslider8, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Bandwidth, "RITI Mixer/Bandpass Filters Bank [1]/Bandwidth", fVslider4, 1.0, 1.0, 1e+02, 0.001) \
		p(VERTICALSLIDER, Frequency, "RITI Mixer/Bandpass Filters Bank [1]/Frequency", fVslider3, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_1, "RITI Mixer/Bandpass Filters Bank [1]/Interpolations 1", fVslider1, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_2, "RITI Mixer/Bandpass Filters Bank [1]/Interpolations 2", fVslider2, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, External_Sum, "RITI Mixer/Input/Output [3]/External Sum", fVslider5, 0.0, 0.0, 1e+02, 0.001) \
		p(VERTICALSLIDER, Master, "RITI Mixer/Input/Output [3]/Master", fVslider11, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Beta, "RITI Mixer/Lorenz Equation Parameters[0]/Beta", fVslider10, 0.1, 0.0, 1e+01, 0.001) \
		p(VERTICALSLIDER, Dt, "RITI Mixer/Lorenz Equation Parameters[0]/Dt", fVslider6, 0.62, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Rho, "RITI Mixer/Lorenz Equation Parameters[0]/Rho", fVslider9, 0.01, 0.0, 0.1, 0.001) \
		p(VERTICALSLIDER, Sigma, "RITI Mixer/Lorenz Equation Parameters[0]/Sigma", fVslider7, 8.2, 0.0, 1e+02, 0.001) \

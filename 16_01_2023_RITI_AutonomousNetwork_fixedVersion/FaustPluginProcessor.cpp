...
class mydsp : public base_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("library_path7", "/libraries/delays.lib");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = 12.0f * fConst0;
		fConst6 = 6.9396f * fConst0 + -1.0f;
		fConst7 = 3.1415927f / fConst0;
		fConst8 = 5.7426f * fConst0 + -1.0f;
		fConst9 = 4.6264f * fConst0 + -1.0f;
		fConst10 = 8.6139f * fConst0 + -1.0f;
		fConst11 = 9.2528f * fConst0 + -1.0f;
		fConst12 = 2.8713f * fConst0 + -1.0f;
		fConst13 = 2.3132f * fConst0 + -1.0f;
		fConst14 = 11.4852f * fConst0 + -1.0f;
		float fConst15 = std::tan(1570.7964f / fConst0);
		fConst16 = fConst15 / (fConst15 + 1.0f);
		fConst17 = 2.0f * fConst16;
		iConst18 = int(0.002f * fConst0);
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider3 = FAUSTFLOAT(0.62f);
		fVslider4 = FAUSTFLOAT(8.2f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("Lorenz FB", &fVslider5, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Lorenz Tan", &fVslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Network FB", &fVslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openHorizontalBox("Bandpass Filters Bank");
		ui_interface->addVerticalSlider("BP Bypass", &fVslider6, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.1f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Bandwidth", &fVslider10, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Frequency", &fVslider9, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Interpolations 1", &fVslider7, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Interpolations 2", &fVslider8, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
		ui_interface->declare(0, "3", "");
		ui_interface->openHorizontalBox("Input/Output");
		ui_interface->addVerticalSlider("External Sum", &fVslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.001f));
		...
		ui_interface->addVerticalSlider("Dt", &fVslider3, FAUSTFLOAT(0.62f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Rho", &fVslider11, FAUSTFLOAT(0.01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.1f), FAUSTFLOAT(0.001f));
		ui_interface->addVerticalSlider("Sigma", &fVslider4, FAUSTFLOAT(8.2f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.001f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = fConst4 * float(fVslider1);
		float fSlow2 = fConst4 * std::pow(1e+01f, float(fVslider2));
		float fSlow3 = fConst4 * float(fVslider3);
		float fSlow4 = fConst4 * float(fVslider4);
		float fSlow5 = fConst4 * std::pow(1e+01f, float(fVslider5));
		float fSlow6 = fConst4 * float(fVslider6);
		float fSlow7 = fConst4 * float(fVslider7);
		float fSlow8 = fConst4 * float(fVslider8);
		float fSlow9 = fConst4 * std::pow(16.0f, float(fVslider9));
		float fSlow10 = fConst4 * float(fVslider10);
		float fSlow11 = fConst4 * float(fVslider11);
		float fSlow12 = fConst4 * float(fVslider12);
		float fSlow13 = fConst4 * float(fVslider13);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = fRec18[0] * fRec5[1] + 0.25f * fRec17[0] * (float(input3[i0]) + float(input2[i0]) + float(input0[i0]) + float(input1[i0]));
			fVec0[IOTA0 & 4194303] = fTemp2;
			float fThen1 = (((fRec20[1] == 1.0f) & (fConst6 != fRec22[1])) ? -0.0009765625f : 0.0f);
			float fThen3 = (((fRec20[1] == 0.0f) & (fConst6 != fRec21[1])) ? 0.0009765625f : fThen1);
			float fElse3 = (((fRec20[1] > 0.0f) & (fRec20[1] < 1.0f)) ? fRec19[1] : 0.0f);
			float fTemp3 = ((fRec19[1] != 0.0f) ? fElse3 : fThen3);
			fRec19[0] = fTemp3;
			fRec20[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec20[1] + fTemp3));
			fRec21[0] = (((fRec20[1] >= 1.0f) & (fRec22[1] != fConst6)) ? fConst6 : fRec21[1]);
			fRec22[0] = (((fRec20[1] <= 0.0f) & (fRec21[1] != fConst6)) ? fConst6 : fRec22[1]);
			float fTemp4 = fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec21[0])))) & 4194303];
			fRec16[0] = fTemp4 + fRec20[0] * (fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec22[0])))) & 4194303] - fTemp4);
			fVec1[0] = 1.2f;
			float fTemp5 = 1.2f - fVec1[1];
			fRec23[0] = fSlow3 + fConst3 * fRec23[1];
			fRec24[0] = fSlow4 + fConst3 * fRec24[1];
			float fTemp6 = fRec24[0] * fRec23[0];
			fRec25[0] = fSlow5 + fConst3 * fRec25[1];
			float fTemp7 = fRec25[0] * (fRec12[1] + fTemp6 * (fRec13[1] - fRec12[1]) + fTemp5);
			fVec2[0] = fTemp7 + fRec16[1];
			fRec15[0] = fRec16[1] + 0.995f * fRec15[1] + fTemp7 - fVec2[1];
			float fTemp8 = tanhf(fRec15[0] / fTemp1);
			fRec26[0] = fSlow6 + fConst3 * fRec26[1];
			float fTemp9 = fRec26[0] * fTemp0;
			fRec30[0] = fSlow7 + fConst3 * fRec30[1];
			fRec31[0] = fSlow8 + fConst3 * fRec31[1];
			fRec32[0] = fSlow9 + fConst3 * fRec32[1];
			float fTemp10 = fRec32[0] * (561.0f * fRec30[0] + fRec31[0] * (562.0f - 1097.0f * fRec30[0]) + 221.0f);
			fRec33[0] = fSlow10 + fConst3 * fRec33[1];
			float fTemp11 = std::max<float>(1.1920929e-07f, fRec33[0]);
			float fTemp12 = std::tan(fConst7 * fTemp10);
			float fTemp13 = fTemp12 * (fTemp12 + fTemp11 / fTemp10) + 1.0f;
			float fTemp14 = fTemp0 * fTemp8;
			float fTemp15 = fTemp12 * (fTemp14 - fRec28[1]) + fRec27[1];
			fRec27[0] = 2.0f * (fTemp15 / fTemp13) - fRec27[1];
			fRec28[0] = fRec28[1] + 2.0f * (fTemp12 * fTemp15 / fTemp13);
			float fTemp16 = fRec31[0] * (0.20948249f * fRec30[0] + -0.35882753f) + (0.88350874f - 0.3295246f * fRec30[0]);
			float fRec29 = fTemp16 * fTemp15 / fTemp13;
			float fTemp17 = fRec32[0] * (1048.0f * fRec30[0] + fRec31[0] * (1.07e+03f * fRec30[0] + -787.0f) + 1619.0f);
			float fTemp18 = std::tan(fConst7 * fTemp17);
			float fTemp19 = fTemp18 * (fTemp18 + fTemp11 / fTemp17) + 1.0f;
			float fTemp20 = fTemp18 * (fTemp14 - fRec35[1]) + fRec34[1];
			fRec34[0] = 2.0f * (fTemp20 / fTemp19) - fRec34[1];
			fRec35[0] = fRec35[1] + 2.0f * (fTemp18 * fTemp20 / fTemp19);
			float fTemp21 = fRec31[0] * (0.001693564f * fRec30[0] + -0.007059128f) + (0.01496291f - 0.007613897f * fRec30[0]);
			float fRec36 = fTemp21 * fTemp20 / fTemp19;
			float fTemp22 = fRec32[0] * (687.0f * fRec30[0] + fRec31[0] * (311.0f - 2032.0f * fRec30[0]) + 2429.0f);
			float fTemp23 = std::tan(fConst7 * fTemp22);
			float fTemp24 = fTemp23 * (fTemp23 + fTemp11 / fTemp22) + 1.0f;
			float fTemp25 = fTemp23 * (fTemp14 - fRec38[1]) + fRec37[1];
			fRec37[0] = 2.0f * (fTemp25 / fTemp24) - fRec37[1];
			fRec38[0] = fRec38[1] + 2.0f * (fTemp23 * fTemp25 / fTemp24);
			float fTemp26 = fRec31[0] * (0.0052272263f * fRec30[0] + -0.010433411f) + (0.01934636f - 0.010538364f * fRec30[0]);
			float fRec39 = fTemp26 * fTemp25 / fTemp24;
			float fTemp27 = fRec32[0] * (1422.0f * fRec30[0] + fRec31[0] * (-4.0f - 526.0f * fRec30[0]) + 1178.0f);
			float fTemp28 = std::tan(fConst7 * fTemp27);
			float fTemp29 = fTemp28 * (fTemp28 + fTemp11 / fTemp27) + 1.0f;
			float fTemp30 = fTemp28 * (fTemp14 - fRec41[1]) + fRec40[1];
			fRec40[0] = 2.0f * (fTemp30 / fTemp29) - fRec40[1];
			fRec41[0] = fRec41[1] + 2.0f * (fTemp28 * fTemp30 / fTemp29);
			float fTemp31 = fRec31[0] * (0.0015990722f * fRec30[0] + -0.009377259f) + (0.02050259f - 0.008575259f * fRec30[0]);
			float fRec42 = fTemp31 * fTemp30 / fTemp29;
			float fTemp32 = fRec32[0] * (1005.0f * fRec30[0] + fRec31[0] * (1538.0f - 1969.0f * fRec30[0]) + 1398.0f);
			float fTemp33 = std::tan(fConst7 * fTemp32);
			float fTemp34 = fTemp33 * (fTemp33 + fTemp11 / fTemp32) + 1.0f;
			float fTemp35 = fTemp33 * (fTemp14 - fRec44[1]) + fRec43[1];
			fRec43[0] = 2.0f * (fTemp35 / fTemp34) - fRec43[1];
			fRec44[0] = fRec44[1] + 2.0f * (fTemp33 * fTemp35 / fTemp34);
			float fTemp36 = fRec31[0] * (-0.004224307f - 0.007247221f * fRec30[0]) + (0.02095502f - 0.004499123f * fRec30[0]);
			float fRec45 = fTemp36 * fTemp35 / fTemp34;
			float fTemp37 = fRec32[0] * (726.0f * fRec30[0] + fRec31[0] * (507.0f - 2138.0f * fRec30[0]) + 2135.0f);
			float fTemp38 = std::tan(fConst7 * fTemp37);
			float fTemp39 = fTemp38 * (fTemp38 + fTemp11 / fTemp37) + 1.0f;
			float fTemp40 = fTemp38 * (fTemp14 - fRec47[1]) + fRec46[1];
			fRec46[0] = 2.0f * (fTemp40 / fTemp39) - fRec46[1];
			fRec47[0] = fRec47[1] + 2.0f * (fTemp38 * fTemp40 / fTemp39);
			float fTemp41 = fRec31[0] * (0.000903925f - 0.013893501f * fRec30[0]) + (0.023596905f - 0.005322077f * fRec30[0]);
			float fRec48 = fTemp41 * fTemp40 / fTemp39;
			float fTemp42 = fRec32[0] * (125.0f * fRec30[0] + fRec31[0] * (9e+01f - 7.0f * fRec30[0]) + 2356.0f);
			float fTemp43 = std::tan(fConst7 * fTemp42);
			float fTemp44 = fTemp43 * (fTemp43 + fTemp11 / fTemp42) + 1.0f;
			float fTemp45 = fTemp43 * (fTemp14 - fRec50[1]) + fRec49[1];
			fRec49[0] = 2.0f * (fTemp45 / fTemp44) - fRec49[1];
			fRec50[0] = fRec50[1] + 2.0f * (fTemp43 * fTemp45 / fTemp44);
			float fTemp46 = fRec31[0] * (0.007897334f - 0.022269972f * fRec30[0]) + (0.024970356f - 0.004948334f * fRec30[0]);
			float fRec51 = fTemp46 * fTemp45 / fTemp44;
			float fTemp47 = fRec32[0] * (74.0f * fRec30[0] + fRec31[0] * (1147.0f - 837.0f * fRec30[0]) + 1104.0f);
			float fTemp48 = std::tan(fConst7 * fTemp47);
			float fTemp49 = fTemp48 * (fTemp48 + fTemp11 / fTemp47) + 1.0f;
			float fTemp50 = fTemp48 * (fTemp14 - fRec53[1]) + fRec52[1];
			fRec52[0] = 2.0f * (fTemp50 / fTemp49) - fRec52[1];
			fRec53[0] = fRec53[1] + 2.0f * (fTemp48 * fTemp50 / fTemp49);
			float fTemp51 = fRec31[0] * (0.014369999f - 0.03300093f * fRec30[0]) + (0.025519907f - 0.0011683893f * fRec30[0]);
			float fRec54 = fTemp51 * fTemp50 / fTemp49;
			float fTemp52 = fRec32[0] * (fRec31[0] * (241.0f * fRec30[0] + 6.3e+02f) + (1914.0f - 1472.0f * fRec30[0]));
			float fTemp53 = std::tan(fConst7 * fTemp52);
			float fTemp54 = fTemp53 * (fTemp53 + fTemp11 / fTemp52) + 1.0f;
			float fTemp55 = fTemp53 * (fTemp14 - fRec56[1]) + fRec55[1];
			fRec55[0] = 2.0f * (fTemp55 / fTemp54) - fRec55[1];
			fRec56[0] = fRec56[1] + 2.0f * (fTemp53 * fTemp55 / fTemp54);
			float fTemp56 = fRec31[0] * (0.012092024f - 0.030118722f * fRec30[0]) + (0.034299903f - 0.009167713f * fRec30[0]);
			float fRec57 = fTemp56 * fTemp55 / fTemp54;
			float fTemp57 = fRec32[0] * (403.0f * fRec30[0] + fRec31[0] * (1123.0f - 898.0f * fRec30[0]) + 1.03e+03f);
			float fTemp58 = std::tan(fConst7 * fTemp57);
			float fTemp59 = fTemp58 * (fTemp58 + fTemp11 / fTemp57) + 1.0f;
			float fTemp60 = fTemp58 * (fTemp14 - fRec59[1]) + fRec58[1];
			fRec58[0] = 2.0f * (fTemp60 / fTemp59) - fRec58[1];
			fRec59[0] = fRec59[1] + 2.0f * (fTemp58 * fTemp60 / fTemp59);
			float fTemp61 = fRec31[0] * (0.021778226f - 0.041845907f * fRec30[0]) + (0.036953244f - 0.008150434f * fRec30[0]);
			float fRec60 = fTemp61 * fTemp60 / fTemp59;
			float fTemp62 = 6.0f * fRec30[0];
			float fTemp63 = fRec32[0] * (fTemp62 + fRec31[0] * (838.0f * fRec30[0] + -812.0f) + 1693.0f);
			float fTemp64 = std::tan(fConst7 * fTemp63);
			float fTemp65 = fTemp64 * (fTemp64 + fTemp11 / fTemp63) + 1.0f;
			float fTemp66 = fTemp64 * (fTemp14 - fRec62[1]) + fRec61[1];
			fRec61[0] = 2.0f * (fTemp66 / fTemp65) - fRec61[1];
			fRec62[0] = fRec62[1] + 2.0f * (fTemp64 * fTemp66 / fTemp65);
			float fTemp67 = fRec31[0] * (0.010543678f - 0.044428922f * fRec30[0]) + (0.049937434f - 0.0068187793f * fRec30[0]);
			float fRec63 = fTemp67 * fTemp66 / fTemp65;
			float fTemp68 = fRec32[0] * (209.0f * fRec30[0] + fRec31[0] * (1515.0f - 1507.0f * fRec30[0]) + 442.0f);
			float fTemp69 = std::tan(fConst7 * fTemp68);
			float fTemp70 = fTemp69 * (fTemp69 + fTemp11 / fTemp68) + 1.0f;
			float fTemp71 = fTemp69 * (fTemp14 - fRec65[1]) + fRec64[1];
			fRec64[0] = 2.0f * (fTemp71 / fTemp70) - fRec64[1];
			fRec65[0] = fRec65[1] + 2.0f * (fTemp69 * fTemp71 / fTemp70);
			float fTemp72 = fRec31[0] * (-0.008363196f - 0.027213728f * fRec30[0]) + (0.07568694f - 0.018474659f * fRec30[0]);
			float fRec66 = fTemp72 * fTemp71 / fTemp70;
			float fTemp73 = fRec32[0] * (675.0f * fRec30[0] + fRec31[0] * (1172.0f - 1989.0f * fRec30[0]) + 883.0f);
			float fTemp74 = std::tan(fConst7 * fTemp73);
			float fTemp75 = fTemp74 * (fTemp74 + fTemp11 / fTemp73) + 1.0f;
			float fTemp76 = fTemp74 * (fTemp14 - fRec68[1]) + fRec67[1];
			fRec67[0] = 2.0f * (fTemp76 / fTemp75) - fRec67[1];
			fRec68[0] = fRec68[1] + 2.0f * (fTemp74 * fTemp76 / fTemp75);
			float fTemp77 = fRec31[0] * (0.01667333f * fRec30[0] + -0.07547183f) + (0.153884f - 0.05838064f * fRec30[0]);
			float fRec69 = fTemp77 * fTemp76 / fTemp75;
			float fTemp78 = fRec32[0] * (1.36e+03f * fRec30[0] + fRec31[0] * (-1e+02f - 1025.0f * fRec30[0]) + 589.0f);
			float fTemp79 = std::tan(fConst7 * fTemp78);
			float fTemp80 = fTemp79 * (fTemp79 + fTemp11 / fTemp78) + 1.0f;
			float fTemp81 = fTemp79 * (fTemp14 - fRec71[1]) + fRec70[1];
			fRec70[0] = 2.0f * (fTemp81 / fTemp80) - fRec70[1];
			fRec71[0] = fRec71[1] + 2.0f * (fTemp79 * fTemp81 / fTemp80);
			float fTemp82 = 0.012026368f * fRec30[0] + fRec31[0] * (-0.03484164f - 0.0708847f * fRec30[0]) + 0.15986608f;
			float fRec72 = fTemp82 * fTemp81 / fTemp80;
			float fTemp83 = fRec32[0] * (fRec31[0] * (-51.0f - 11.0f * fRec30[0]) + (736.0f - 345.0f * fRec30[0]));
			float fTemp84 = std::tan(fConst7 * fTemp83);
			float fTemp85 = fTemp84 * (fTemp84 + fTemp11 / fTemp83) + 1.0f;
			float fTemp86 = fTemp84 * (fTemp14 - fRec74[1]) + fRec73[1];
			fRec73[0] = 2.0f * (fTemp86 / fTemp85) - fRec73[1];
			fRec74[0] = fRec74[1] + 2.0f * (fTemp84 * fTemp86 / fTemp85);
			float fTemp87 = 0.043418836f * fRec30[0] + fRec31[0] * (0.00035901f - 0.16539423f * fRec30[0]) + 0.2004374f;
			float fRec75 = fTemp87 * fTemp86 / fTemp85;
			float fTemp88 = fRec32[0] * (113.0f * fRec30[0] + fRec31[0] * (147.0f - 325.0f * fRec30[0]) + 147.0f);
			float fTemp89 = std::tan(fConst7 * fTemp88);
			float fTemp90 = fTemp89 * (fTemp89 + fTemp11 / fTemp88) + 1.0f;
			float fTemp91 = fTemp89 * (fTemp14 - fRec77[1]) + fRec76[1];
			fRec76[0] = 2.0f * (fTemp91 / fTemp90) - fRec76[1];
			fRec77[0] = fRec77[1] + 2.0f * (fTemp89 * fTemp91 / fTemp90);
			float fTemp92 = fRec31[0] * (-0.2092686f - 0.10045149f * fRec30[0]) + (0.6105272f - 0.05775171f * fRec30[0]);
			float fRec78 = fTemp92 * fTemp91 / fTemp90;
			float fTemp93 = fRec32[0] * (fRec31[0] * (306.0f * fRec30[0] + -2.7e+02f) + (368.0f - 239.0f * fRec30[0]));
			float fTemp94 = std::tan(fConst7 * fTemp93);
			float fTemp95 = fTemp94 * (fTemp94 + fTemp11 / fTemp93) + 1.0f;
			float fTemp96 = fTemp94 * (fTemp14 - fRec80[1]) + fRec79[1];
			float fTemp97 = fTemp96 / fTemp95;
			fRec79[0] = 2.0f * fTemp97 - fRec79[1];
			fRec80[0] = fRec80[1] + 2.0f * (fTemp94 * fTemp96 / fTemp95);
			float fRec81 = fTemp97;
			float fTemp98 = fRec32[0] * (fTemp62 + fRec31[0] * (72.0f - 181.0f * fRec30[0]) + 515.0f);
			float fTemp99 = std::tan(fConst7 * fTemp98);
			float fTemp100 = fTemp99 * (fTemp99 + fTemp11 / fTemp98) + 1.0f;
			float fTemp101 = fTemp99 * (fTemp14 - fRec83[1]) + fRec82[1];
			fRec82[0] = 2.0f * (fTemp101 / fTemp100) - fRec82[1];
			fRec83[0] = fRec83[1] + 2.0f * (fTemp99 * fTemp101 / fTemp100);
			float fTemp102 = 0.12976919f * fRec30[0] + fRec31[0] * (-0.02067951f - 0.26354736f * fRec30[0]) + 0.25009984f;
			float fRec84 = fTemp102 * fTemp101 / fTemp100;
			float fTemp103 = fRec32[0] * (968.0f * fRec30[0] + fRec31[0] * (122.0f - 588.0f * fRec30[0]) + 74.0f);
			float fTemp104 = std::tan(fConst7 * fTemp103);
			float fTemp105 = fTemp104 * (fTemp104 + fTemp11 / fTemp103) + 1.0f;
			float fTemp106 = fTemp104 * (fTemp14 - fRec86[1]) + fRec85[1];
			fRec85[0] = 2.0f * (fTemp106 / fTemp105) - fRec85[1];
			fRec86[0] = fRec86[1] + 2.0f * (fTemp104 * fTemp106 / fTemp105);
			float fTemp107 = fRec31[0] * (-0.00905548f - 0.10407319f * fRec30[0]) + (0.19782531f - 0.011967934f * fRec30[0]);
			float fRec87 = fTemp107 * fTemp106 / fTemp105;
			float fTemp108 = fRec32[0] * (102.0f * fRec30[0] + fRec31[0] * (756.0f - 762.0f * fRec30[0]) + 8.1e+02f);
			float fTemp109 = std::tan(fConst7 * fTemp108);
			float fTemp110 = fTemp109 * (fTemp109 + fTemp11 / fTemp108) + 1.0f;
			float fTemp111 = fTemp109 * (fTemp14 - fRec89[1]) + fRec88[1];
			fRec88[0] = 2.0f * (fTemp111 / fTemp110) - fRec88[1];
			fRec89[0] = fRec89[1] + 2.0f * (fTemp109 * fTemp111 / fTemp110);
			float fTemp112 = fRec31[0] * (-0.06073025f - 0.021033574f * fRec30[0]) + (0.15408868f - 0.01859665f * fRec30[0]);
			float fRec90 = fTemp112 * fTemp111 / fTemp110;
			float fTemp113 = fRec32[0] * (1784.0f * fRec30[0] + fRec31[0] * (96.0f - 1681.0f * fRec30[0]) + 295.0f);
			float fTemp114 = std::tan(fConst7 * fTemp113);
			float fTemp115 = fTemp114 * (fTemp114 + fTemp11 / fTemp113) + 1.0f;
			float fTemp116 = fTemp114 * (fTemp14 - fRec92[1]) + fRec91[1];
			fRec91[0] = 2.0f * (fTemp116 / fTemp115) - fRec91[1];
			fRec92[0] = fRec92[1] + 2.0f * (fTemp114 * fTemp116 / fTemp115);
			float fTemp117 = fRec31[0] * (0.008325796f * fRec30[0] + -0.04420076f) + (0.12206612f - 0.05880266f * fRec30[0]);
			float fRec93 = fTemp117 * fTemp116 / fTemp115;
			float fTemp118 = fRec32[0] * (1689.0f * fRec30[0] + fRec31[0] * (806.0f - 1597.0f * fRec30[0]) + 662.0f);
			float fTemp119 = std::tan(fConst7 * fTemp118);
			float fTemp120 = fTemp119 * (fTemp119 + fTemp11 / fTemp118) + 1.0f;
			float fTemp121 = fTemp119 * (fTemp14 - fRec95[1]) + fRec94[1];
			fRec94[0] = 2.0f * (fTemp121 / fTemp120) - fRec94[1];
			fRec95[0] = fRec95[1] + 2.0f * (fTemp119 * fTemp121 / fTemp120);
			float fTemp122 = fRec31[0] * (-0.01095256f - 0.02456113f * fRec30[0]) + (0.07494197f - 0.028820358f * fRec30[0]);
			float fRec96 = fTemp122 * fTemp121 / fTemp120;
			float fTemp123 = fRec32[0] * (1265.0f * fRec30[0] + fRec31[0] * (1.2e+02f - 1.27e+03f * fRec30[0]) + 956.0f);
			float fTemp124 = std::tan(fConst7 * fTemp123);
			float fTemp125 = fTemp124 * (fTemp124 + fTemp11 / fTemp123) + 1.0f;
			float fTemp126 = fTemp124 * (fTemp14 - fRec98[1]) + fRec97[1];
			fRec97[0] = 2.0f * (fTemp126 / fTemp125) - fRec97[1];
			fRec98[0] = fRec98[1] + 2.0f * (fTemp124 * fTemp126 / fTemp125);
			float fTemp127 = fRec31[0] * (0.016194258f - 0.04017164f * fRec30[0]) + (0.042963058f - 0.009998228f * fRec30[0]);
			float fRec99 = fTemp127 * fTemp126 / fTemp125;
			float fTemp128 = fRec32[0] * (fRec31[0] * (951.0f * fRec30[0] + -618.0f) + (2282.0f - 463.0f * fRec30[0]));
			float fTemp129 = std::tan(fConst7 * fTemp128);
			float fTemp130 = fTemp129 * (fTemp129 + fTemp11 / fTemp128) + 1.0f;
			float fTemp131 = fTemp129 * (fTemp14 - fRec101[1]) + fRec100[1];
			fRec100[0] = 2.0f * (fTemp131 / fTemp130) - fRec100[1];
			fRec101[0] = fRec101[1] + 2.0f * (fTemp129 * fTemp131 / fTemp130);
			float fTemp132 = fRec31[0] * (0.01599382f - 0.03561073f * fRec30[0]) + (0.03519017f - 0.007711276f * fRec30[0]);
			float fRec102 = fTemp132 * fTemp131 / fTemp130;
			float fTemp133 = fRec32[0] * (fRec31[0] * (803.0f - 1117.0f * fRec30[0]) + (1546.0f - 238.0f * fRec30[0]));
			float fTemp134 = std::tan(fConst7 * fTemp133);
			float fTemp135 = fTemp134 * (fTemp134 + fTemp11 / fTemp133) + 1.0f;
			float fTemp136 = fTemp134 * (fTemp14 - fRec104[1]) + fRec103[1];
			fRec103[0] = 2.0f * (fTemp136 / fTemp135) - fRec103[1];
			fRec104[0] = fRec104[1] + 2.0f * (fTemp134 * fTemp136 / fTemp135);
			float fTemp137 = fRec31[0] * (0.012251807f - 0.030545196f * fRec30[0]) + (0.02781442f - 0.0028308248f * fRec30[0]);
			float fRec105 = fTemp137 * fTemp136 / fTemp135;
			float fTemp138 = fRec32[0] * (fRec31[0] * (1.34e+03f * fRec30[0] + -102.0f) + (1472.0f - 903.0f * fRec30[0]));
			float fTemp139 = std::tan(fConst7 * fTemp138);
			float fTemp140 = fTemp139 * (fTemp139 + fTemp11 / fTemp138) + 1.0f;
			float fTemp141 = fTemp139 * (fTemp14 - fRec107[1]) + fRec106[1];
			fRec106[0] = 2.0f * (fTemp141 / fTemp140) - fRec106[1];
			fRec107[0] = fRec107[1] + 2.0f * (fTemp139 * fTemp141 / fTemp140);
			float fTemp142 = fRec31[0] * (0.008006095f - 0.02467113f * fRec30[0]) + (0.025451275f - 0.0031307992f * fRec30[0]);
			float fRec108 = fTemp142 * fTemp141 / fTemp140;
			float fTemp143 = fRec32[0] * (fRec31[0] * (861.0f * fRec30[0] + -1231.0f) + (2503.0f - 228.0f * fRec30[0]));
			float fTemp144 = std::tan(fConst7 * fTemp143);
			float fTemp145 = fTemp144 * (fTemp144 + fTemp11 / fTemp143) + 1.0f;
			float fTemp146 = fTemp144 * (fTemp14 - fRec110[1]) + fRec109[1];
			fRec109[0] = 2.0f * (fTemp146 / fTemp145) - fRec109[1];
			fRec110[0] = fRec110[1] + 2.0f * (fTemp144 * fTemp146 / fTemp145);
			float fTemp147 = fRec31[0] * (0.002393508f - 0.016438924f * fRec30[0]) + (0.02376619f - 0.004291546f * fRec30[0]);
			float fRec111 = fTemp147 * fTemp146 / fTemp145;
			float fTemp148 = fRec32[0] * (1281.0f * fRec30[0] + fRec31[0] * (37.0f * fRec30[0] + -273.0f) + 1251.0f);
			float fTemp149 = std::tan(fConst7 * fTemp148);
			float fTemp150 = fTemp149 * (fTemp149 + fTemp11 / fTemp148) + 1.0f;
			float fTemp151 = fTemp149 * (fTemp14 - fRec113[1]) + fRec112[1];
			fRec112[0] = 2.0f * (fTemp151 / fTemp150) - fRec112[1];
			fRec113[0] = fRec113[1] + 2.0f * (fTemp149 * fTemp151 / fTemp150);
			float fTemp152 = fRec31[0] * (0.001634211f - 0.01367419f * fRec30[0]) + (0.021085802f - 0.003933981f * fRec30[0]);
			float fRec114 = fTemp152 * fTemp151 / fTemp150;
			float fTemp153 = fRec32[0] * (1666.0f * fRec30[0] + fRec31[0] * (436.0f - 1213.0f * fRec30[0]) + 1325.0f);
			float fTemp154 = std::tan(fConst7 * fTemp153);
			float fTemp155 = fTemp154 * (fTemp154 + fTemp11 / fTemp153) + 1.0f;
			float fTemp156 = fTemp154 * (fTemp14 - fRec116[1]) + fRec115[1];
			fRec115[0] = 2.0f * (fTemp156 / fTemp155) - fRec115[1];
			fRec116[0] = fRec116[1] + 2.0f * (fTemp154 * fTemp156 / fTemp155);
			float fTemp157 = fRec31[0] * (-0.006947659f - 0.0032192376f * fRec30[0]) + (0.020809943f - 0.0063435384f * fRec30[0]);
			float fRec117 = fTemp157 * fTemp156 / fTemp155;
			float fTemp158 = fRec32[0] * (81.0f * fRec30[0] + fRec31[0] * (972.0f - 715.0f * fRec30[0]) + 2061.0f);
			float fTemp159 = std::tan(fConst7 * fTemp158);
			float fTemp160 = fTemp159 * (fTemp159 + fTemp11 / fTemp158) + 1.0f;
			float fTemp161 = fTemp159 * (fTemp14 - fRec119[1]) + fRec118[1];
			fRec118[0] = 2.0f * (fTemp161 / fTemp160) - fRec118[1];
			fRec119[0] = fRec119[1] + 2.0f * (fTemp159 * fTemp161 / fTemp160);
			float fTemp162 = fRec31[0] * (0.0021589056f * fRec30[0] + -0.008904165f) + (0.019359564f - 0.008690193f * fRec30[0]);
			float fRec120 = fTemp162 * fTemp161 / fTemp160;
			float fTemp163 = fRec32[0] * (fRec31[0] * (1.02e+03f - 1.62e+03f * fRec30[0]) + (2209.0f - 456.0f * fRec30[0]));
			float fTemp164 = std::tan(fConst7 * fTemp163);
			float fTemp165 = fTemp164 * (fTemp164 + fTemp11 / fTemp163) + 1.0f;
			float fTemp166 = fTemp164 * (fTemp14 - fRec122[1]) + fRec121[1];
			fRec121[0] = 2.0f * (fTemp166 / fTemp165) - fRec121[1];
			fRec122[0] = fRec122[1] + 2.0f * (fTemp164 * fTemp166 / fTemp165);
			float fTemp167 = fRec31[0] * (0.005044161f * fRec30[0] + -0.010130565f) + (0.018745547f - 0.011232337f * fRec30[0]);
			float fRec123 = fTemp167 * fTemp166 / fTemp165;
			float fTemp168 = fRec32[0] * (805.0f * fRec30[0] + fRec31[0] * (266.0f - 7.7e+02f * fRec30[0]) + 2572.0f);
			float fTemp169 = std::tan(fConst7 * fTemp168);
			float fTemp170 = fTemp169 * (fTemp169 + fTemp11 / fTemp168) + 1.0f;
			float fTemp171 = fTemp169 * (fTemp14 - fRec125[1]) + fRec124[1];
			fRec124[0] = 2.0f * (fTemp171 / fTemp170) - fRec124[1];
			fRec125[0] = fRec125[1] + 2.0f * (fTemp169 * fTemp171 / fTemp170);
			float fTemp172 = fRec31[0] * (0.0016378453f * fRec30[0] + -0.004344937f) + (0.011249398f - 0.0067808237f * fRec30[0]);
			float fRec126 = fTemp172 * fTemp171 / fTemp170;
			float fTemp173 = 1.0f - fRec26[0];
			fRec12[0] = 0.03125f * fTemp173 * (fRec126 + fRec123 + fRec120 + fRec117 + fRec114 + fRec111 + fRec108 + fRec105 + fRec102 + fRec99 + fRec96 + fRec93 + fRec90 + fRec87 + fRec84 + fRec81 + fRec78 + fRec75 + fRec72 + fRec69 + fRec66 + fRec63 + fRec60 + fRec57 + fRec54 + fRec51 + fRec48 + fRec45 + fRec42 + fRec39 + fRec36 + fRec29) + fTemp9 * fTemp8;
			fVec3[0] = 1.3f;
			float fTemp174 = 1.3f - fVec3[1];
			fRec128[0] = fSlow11 + fConst3 * fRec128[1];
			float fTemp175 = fRec25[0] * (fRec13[1] + fRec23[0] * (fRec12[1] * (fRec128[0] - fRec14[1]) - fRec13[1]) + fTemp174);
			fVec4[0] = fRec16[1] + fTemp175;
			fRec127[0] = fTemp175 + fRec16[1] + 0.995f * fRec127[1] - fVec4[1];
			float fTemp176 = tanhf(fRec127[0] / fTemp1);
			float fTemp177 = fTemp0 * fTemp176;
			float fTemp178 = fTemp12 * (fTemp177 - fRec130[1]) + fRec129[1];
			fRec129[0] = 2.0f * (fTemp178 / fTemp13) - fRec129[1];
			fRec130[0] = fRec130[1] + 2.0f * (fTemp12 * fTemp178 / fTemp13);
			float fRec131 = fTemp16 * fTemp178 / fTemp13;
			float fTemp179 = fTemp18 * (fTemp177 - fRec133[1]) + fRec132[1];
			fRec132[0] = 2.0f * (fTemp179 / fTemp19) - fRec132[1];
			fRec133[0] = fRec133[1] + 2.0f * (fTemp18 * fTemp179 / fTemp19);
			float fRec134 = fTemp21 * fTemp179 / fTemp19;
			float fTemp180 = fTemp23 * (fTemp177 - fRec136[1]) + fRec135[1];
			fRec135[0] = 2.0f * (fTemp180 / fTemp24) - fRec135[1];
			fRec136[0] = fRec136[1] + 2.0f * (fTemp23 * fTemp180 / fTemp24);
			float fRec137 = fTemp26 * fTemp180 / fTemp24;
			float fTemp181 = fTemp28 * (fTemp177 - fRec139[1]) + fRec138[1];
			fRec138[0] = 2.0f * (fTemp181 / fTemp29) - fRec138[1];
			fRec139[0] = fRec139[1] + 2.0f * (fTemp28 * fTemp181 / fTemp29);
			float fRec140 = fTemp31 * fTemp181 / fTemp29;
			float fTemp182 = fTemp33 * (fTemp177 - fRec142[1]) + fRec141[1];
			fRec141[0] = 2.0f * (fTemp182 / fTemp34) - fRec141[1];
			fRec142[0] = fRec142[1] + 2.0f * (fTemp33 * fTemp182 / fTemp34);
			float fRec143 = fTemp36 * fTemp182 / fTemp34;
			float fTemp183 = fTemp38 * (fTemp177 - fRec145[1]) + fRec144[1];
			fRec144[0] = 2.0f * (fTemp183 / fTemp39) - fRec144[1];
			fRec145[0] = fRec145[1] + 2.0f * (fTemp38 * fTemp183 / fTemp39);
			float fRec146 = fTemp41 * fTemp183 / fTemp39;
			float fTemp184 = fTemp43 * (fTemp177 - fRec148[1]) + fRec147[1];
			fRec147[0] = 2.0f * (fTemp184 / fTemp44) - fRec147[1];
			fRec148[0] = fRec148[1] + 2.0f * (fTemp43 * fTemp184 / fTemp44);
			float fRec149 = fTemp46 * fTemp184 / fTemp44;
			float fTemp185 = fTemp48 * (fTemp177 - fRec151[1]) + fRec150[1];
			fRec150[0] = 2.0f * (fTemp185 / fTemp49) - fRec150[1];
			fRec151[0] = fRec151[1] + 2.0f * (fTemp48 * fTemp185 / fTemp49);
			float fRec152 = fTemp51 * fTemp185 / fTemp49;
			float fTemp186 = fTemp53 * (fTemp177 - fRec154[1]) + fRec153[1];
			fRec153[0] = 2.0f * (fTemp186 / fTemp54) - fRec153[1];
			fRec154[0] = fRec154[1] + 2.0f * (fTemp53 * fTemp186 / fTemp54);
			float fRec155 = fTemp56 * fTemp186 / fTemp54;
			float fTemp187 = fTemp58 * (fTemp177 - fRec157[1]) + fRec156[1];
			fRec156[0] = 2.0f * (fTemp187 / fTemp59) - fRec156[1];
			fRec157[0] = fRec157[1] + 2.0f * (fTemp58 * fTemp187 / fTemp59);
			float fRec158 = fTemp61 * fTemp187 / fTemp59;
			float fTemp188 = fTemp64 * (fTemp177 - fRec160[1]) + fRec159[1];
			fRec159[0] = 2.0f * (fTemp188 / fTemp65) - fRec159[1];
			fRec160[0] = fRec160[1] + 2.0f * (fTemp64 * fTemp188 / fTemp65);
			float fRec161 = fTemp67 * fTemp188 / fTemp65;
			float fTemp189 = fTemp69 * (fTemp177 - fRec163[1]) + fRec162[1];
			fRec162[0] = 2.0f * (fTemp189 / fTemp70) - fRec162[1];
			fRec163[0] = fRec163[1] + 2.0f * (fTemp69 * fTemp189 / fTemp70);
			float fRec164 = fTemp72 * fTemp189 / fTemp70;
			float fTemp190 = fTemp74 * (fTemp177 - fRec166[1]) + fRec165[1];
			fRec165[0] = 2.0f * (fTemp190 / fTemp75) - fRec165[1];
			fRec166[0] = fRec166[1] + 2.0f * (fTemp74 * fTemp190 / fTemp75);
			float fRec167 = fTemp77 * fTemp190 / fTemp75;
			float fTemp191 = fTemp79 * (fTemp177 - fRec169[1]) + fRec168[1];
			fRec168[0] = 2.0f * (fTemp191 / fTemp80) - fRec168[1];
			fRec169[0] = fRec169[1] + 2.0f * (fTemp79 * fTemp191 / fTemp80);
			float fRec170 = fTemp82 * fTemp191 / fTemp80;
			float fTemp192 = fTemp84 * (fTemp177 - fRec172[1]) + fRec171[1];
			fRec171[0] = 2.0f * (fTemp192 / fTemp85) - fRec171[1];
			fRec172[0] = fRec172[1] + 2.0f * (fTemp84 * fTemp192 / fTemp85);
			float fRec173 = fTemp87 * fTemp192 / fTemp85;
			float fTemp193 = fTemp89 * (fTemp177 - fRec175[1]) + fRec174[1];
			fRec174[0] = 2.0f * (fTemp193 / fTemp90) - fRec174[1];
			fRec175[0] = fRec175[1] + 2.0f * (fTemp89 * fTemp193 / fTemp90);
			float fRec176 = fTemp92 * fTemp193 / fTemp90;
			float fTemp194 = fTemp94 * (fTemp177 - fRec178[1]) + fRec177[1];
			float fTemp195 = fTemp194 / fTemp95;
			fRec177[0] = 2.0f * fTemp195 - fRec177[1];
			fRec178[0] = fRec178[1] + 2.0f * (fTemp94 * fTemp194 / fTemp95);
			float fRec179 = fTemp195;
			float fTemp196 = fTemp99 * (fTemp177 - fRec181[1]) + fRec180[1];
			fRec180[0] = 2.0f * (fTemp196 / fTemp100) - fRec180[1];
			fRec181[0] = fRec181[1] + 2.0f * (fTemp99 * fTemp196 / fTemp100);
			float fRec182 = fTemp102 * fTemp196 / fTemp100;
			float fTemp197 = fTemp104 * (fTemp177 - fRec184[1]) + fRec183[1];
			fRec183[0] = 2.0f * (fTemp197 / fTemp105) - fRec183[1];
			fRec184[0] = fRec184[1] + 2.0f * (fTemp104 * fTemp197 / fTemp105);
			float fRec185 = fTemp107 * fTemp197 / fTemp105;
			float fTemp198 = fTemp109 * (fTemp177 - fRec187[1]) + fRec186[1];
			fRec186[0] = 2.0f * (fTemp198 / fTemp110) - fRec186[1];
			fRec187[0] = fRec187[1] + 2.0f * (fTemp109 * fTemp198 / fTemp110);
			float fRec188 = fTemp112 * fTemp198 / fTemp110;
			float fTemp199 = fTemp114 * (fTemp177 - fRec190[1]) + fRec189[1];
			fRec189[0] = 2.0f * (fTemp199 / fTemp115) - fRec189[1];
			fRec190[0] = fRec190[1] + 2.0f * (fTemp114 * fTemp199 / fTemp115);
			float fRec191 = fTemp117 * fTemp199 / fTemp115;
			float fTemp200 = fTemp119 * (fTemp177 - fRec193[1]) + fRec192[1];
			fRec192[0] = 2.0f * (fTemp200 / fTemp120) - fRec192[1];
			fRec193[0] = fRec193[1] + 2.0f * (fTemp119 * fTemp200 / fTemp120);
			float fRec194 = fTemp122 * fTemp200 / fTemp120;
			float fTemp201 = fTemp124 * (fTemp177 - fRec196[1]) + fRec195[1];
			fRec195[0] = 2.0f * (fTemp201 / fTemp125) - fRec195[1];
			fRec196[0] = fRec196[1] + 2.0f * (fTemp124 * fTemp201 / fTemp125);
			float fRec197 = fTemp127 * fTemp201 / fTemp125;
			float fTemp202 = fTemp129 * (fTemp177 - fRec199[1]) + fRec198[1];
			fRec198[0] = 2.0f * (fTemp202 / fTemp130) - fRec198[1];
			fRec199[0] = fRec199[1] + 2.0f * (fTemp129 * fTemp202 / fTemp130);
			float fRec200 = fTemp132 * fTemp202 / fTemp130;
			float fTemp203 = fTemp134 * (fTemp177 - fRec202[1]) + fRec201[1];
			fRec201[0] = 2.0f * (fTemp203 / fTemp135) - fRec201[1];
			fRec202[0] = fRec202[1] + 2.0f * (fTemp134 * fTemp203 / fTemp135);
			float fRec203 = fTemp137 * fTemp203 / fTemp135;
			float fTemp204 = fTemp139 * (fTemp177 - fRec205[1]) + fRec204[1];
			fRec204[0] = 2.0f * (fTemp204 / fTemp140) - fRec204[1];
			fRec205[0] = fRec205[1] + 2.0f * (fTemp139 * fTemp204 / fTemp140);
			float fRec206 = fTemp142 * fTemp204 / fTemp140;
			float fTemp205 = fTemp144 * (fTemp177 - fRec208[1]) + fRec207[1];
			fRec207[0] = 2.0f * (fTemp205 / fTemp145) - fRec207[1];
			fRec208[0] = fRec208[1] + 2.0f * (fTemp144 * fTemp205 / fTemp145);
			float fRec209 = fTemp147 * fTemp205 / fTemp145;
			float fTemp206 = fTemp149 * (fTemp177 - fRec211[1]) + fRec210[1];
			fRec210[0] = 2.0f * (fTemp206 / fTemp150) - fRec210[1];
			fRec211[0] = fRec211[1] + 2.0f * (fTemp149 * fTemp206 / fTemp150);
			float fRec212 = fTemp152 * fTemp206 / fTemp150;
			float fTemp207 = fTemp154 * (fTemp177 - fRec214[1]) + fRec213[1];
			fRec213[0] = 2.0f * (fTemp207 / fTemp155) - fRec213[1];
			fRec214[0] = fRec214[1] + 2.0f * (fTemp154 * fTemp207 / fTemp155);
			float fRec215 = fTemp157 * fTemp207 / fTemp155;
			float fTemp208 = fTemp159 * (fTemp177 - fRec217[1]) + fRec216[1];
			fRec216[0] = 2.0f * (fTemp208 / fTemp160) - fRec216[1];
			fRec217[0] = fRec217[1] + 2.0f * (fTemp159 * fTemp208 / fTemp160);
			float fRec218 = fTemp162 * fTemp208 / fTemp160;
			float fTemp209 = fTemp164 * (fTemp177 - fRec220[1]) + fRec219[1];
			fRec219[0] = 2.0f * (fTemp209 / fTemp165) - fRec219[1];
			fRec220[0] = fRec220[1] + 2.0f * (fTemp164 * fTemp209 / fTemp165);
			float fRec221 = fTemp167 * fTemp209 / fTemp165;
			float fTemp210 = fTemp169 * (fTemp177 - fRec223[1]) + fRec222[1];
			fRec222[0] = 2.0f * (fTemp210 / fTemp170) - fRec222[1];
			fRec223[0] = fRec223[1] + 2.0f * (fTemp169 * fTemp210 / fTemp170);
			float fRec224 = fTemp172 * fTemp210 / fTemp170;
			fRec13[0] = 0.03125f * fTemp173 * (fRec224 + fRec221 + fRec218 + fRec215 + fRec212 + fRec209 + fRec206 + fRec203 + fRec200 + fRec197 + fRec194 + fRec191 + fRec188 + fRec185 + fRec182 + fRec179 + fRec176 + fRec173 + fRec170 + fRec167 + fRec164 + fRec161 + fRec158 + fRec155 + fRec152 + fRec149 + fRec146 + fRec143 + fRec140 + fRec137 + fRec134 + fRec131) + fTemp9 * fTemp176;
			fVec5[0] = 1.6f;
			float fTemp211 = 1.6f - fVec5[1];
			fRec226[0] = fSlow12 + fConst3 * fRec226[1];
			float fTemp212 = fRec25[0] * (fRec14[1] + fRec23[0] * (fRec12[1] * fRec13[1] - fRec226[0] * fRec14[1]) + fTemp211);
			fVec6[0] = fRec16[1] + fTemp212;
			fRec225[0] = fTemp212 + fRec16[1] + 0.995f * fRec225[1] - fVec6[1];
			float fTemp213 = tanhf(fRec225[0] / fTemp1);
			float fTemp214 = fTemp0 * fTemp213;
			float fTemp215 = fTemp12 * (fTemp214 - fRec228[1]) + fRec227[1];
			fRec227[0] = 2.0f * (fTemp215 / fTemp13) - fRec227[1];
			fRec228[0] = fRec228[1] + 2.0f * (fTemp12 * fTemp215 / fTemp13);
			float fRec229 = fTemp16 * fTemp215 / fTemp13;
			float fTemp216 = fTemp18 * (fTemp214 - fRec231[1]) + fRec230[1];
			fRec230[0] = 2.0f * (fTemp216 / fTemp19) - fRec230[1];
			fRec231[0] = fRec231[1] + 2.0f * (fTemp18 * fTemp216 / fTemp19);
			float fRec232 = fTemp21 * fTemp216 / fTemp19;
			float fTemp217 = fTemp23 * (fTemp214 - fRec234[1]) + fRec233[1];
			fRec233[0] = 2.0f * (fTemp217 / fTemp24) - fRec233[1];
			fRec234[0] = fRec234[1] + 2.0f * (fTemp23 * fTemp217 / fTemp24);
			float fRec235 = fTemp26 * fTemp217 / fTemp24;
			float fTemp218 = fTemp28 * (fTemp214 - fRec237[1]) + fRec236[1];
			fRec236[0] = 2.0f * (fTemp218 / fTemp29) - fRec236[1];
			fRec237[0] = fRec237[1] + 2.0f * (fTemp28 * fTemp218 / fTemp29);
			float fRec238 = fTemp31 * fTemp218 / fTemp29;
			float fTemp219 = fTemp33 * (fTemp214 - fRec240[1]) + fRec239[1];
			fRec239[0] = 2.0f * (fTemp219 / fTemp34) - fRec239[1];
			fRec240[0] = fRec240[1] + 2.0f * (fTemp33 * fTemp219 / fTemp34);
			float fRec241 = fTemp36 * fTemp219 / fTemp34;
			float fTemp220 = fTemp38 * (fTemp214 - fRec243[1]) + fRec242[1];
			fRec242[0] = 2.0f * (fTemp220 / fTemp39) - fRec242[1];
			fRec243[0] = fRec243[1] + 2.0f * (fTemp38 * fTemp220 / fTemp39);
			float fRec244 = fTemp41 * fTemp220 / fTemp39;
			float fTemp221 = fTemp43 * (fTemp214 - fRec246[1]) + fRec245[1];
			fRec245[0] = 2.0f * (fTemp221 / fTemp44) - fRec245[1];
			fRec246[0] = fRec246[1] + 2.0f * (fTemp43 * fTemp221 / fTemp44);
			float fRec247 = fTemp46 * fTemp221 / fTemp44;
			float fTemp222 = fTemp48 * (fTemp214 - fRec249[1]) + fRec248[1];
			fRec248[0] = 2.0f * (fTemp222 / fTemp49) - fRec248[1];
			fRec249[0] = fRec249[1] + 2.0f * (fTemp48 * fTemp222 / fTemp49);
			float fRec250 = fTemp51 * fTemp222 / fTemp49;
			float fTemp223 = fTemp53 * (fTemp214 - fRec252[1]) + fRec251[1];
			fRec251[0] = 2.0f * (fTemp223 / fTemp54) - fRec251[1];
			fRec252[0] = fRec252[1] + 2.0f * (fTemp53 * fTemp223 / fTemp54);
			float fRec253 = fTemp56 * fTemp223 / fTemp54;
			float fTemp224 = fTemp58 * (fTemp214 - fRec255[1]) + fRec254[1];
			fRec254[0] = 2.0f * (fTemp224 / fTemp59) - fRec254[1];
			fRec255[0] = fRec255[1] + 2.0f * (fTemp58 * fTemp224 / fTemp59);
			float fRec256 = fTemp61 * fTemp224 / fTemp59;
			float fTemp225 = fTemp64 * (fTemp214 - fRec258[1]) + fRec257[1];
			fRec257[0] = 2.0f * (fTemp225 / fTemp65) - fRec257[1];
			fRec258[0] = fRec258[1] + 2.0f * (fTemp64 * fTemp225 / fTemp65);
			float fRec259 = fTemp67 * fTemp225 / fTemp65;
			float fTemp226 = fTemp69 * (fTemp214 - fRec261[1]) + fRec260[1];
			fRec260[0] = 2.0f * (fTemp226 / fTemp70) - fRec260[1];
			fRec261[0] = fRec261[1] + 2.0f * (fTemp69 * fTemp226 / fTemp70);
			float fRec262 = fTemp72 * fTemp226 / fTemp70;
			float fTemp227 = fTemp74 * (fTemp214 - fRec264[1]) + fRec263[1];
			fRec263[0] = 2.0f * (fTemp227 / fTemp75) - fRec263[1];
			fRec264[0] = fRec264[1] + 2.0f * (fTemp74 * fTemp227 / fTemp75);
			float fRec265 = fTemp77 * fTemp227 / fTemp75;
			float fTemp228 = fTemp79 * (fTemp214 - fRec267[1]) + fRec266[1];
			fRec266[0] = 2.0f * (fTemp228 / fTemp80) - fRec266[1];
			fRec267[0] = fRec267[1] + 2.0f * (fTemp79 * fTemp228 / fTemp80);
			float fRec268 = fTemp82 * fTemp228 / fTemp80;
			float fTemp229 = fTemp84 * (fTemp214 - fRec270[1]) + fRec269[1];
			fRec269[0] = 2.0f * (fTemp229 / fTemp85) - fRec269[1];
			fRec270[0] = fRec270[1] + 2.0f * (fTemp84 * fTemp229 / fTemp85);
			float fRec271 = fTemp87 * fTemp229 / fTemp85;
			float fTemp230 = fTemp89 * (fTemp214 - fRec273[1]) + fRec272[1];
			fRec272[0] = 2.0f * (fTemp230 / fTemp90) - fRec272[1];
			fRec273[0] = fRec273[1] + 2.0f * (fTemp89 * fTemp230 / fTemp90);
			float fRec274 = fTemp92 * fTemp230 / fTemp90;
			float fTemp231 = fTemp94 * (fTemp214 - fRec276[1]) + fRec275[1];
			float fTemp232 = fTemp231 / fTemp95;
			fRec275[0] = 2.0f * fTemp232 - fRec275[1];
			fRec276[0] = fRec276[1] + 2.0f * (fTemp94 * fTemp231 / fTemp95);
			float fRec277 = fTemp232;
			float fTemp233 = fTemp99 * (fTemp214 - fRec279[1]) + fRec278[1];
			fRec278[0] = 2.0f * (fTemp233 / fTemp100) - fRec278[1];
			fRec279[0] = fRec279[1] + 2.0f * (fTemp99 * fTemp233 / fTemp100);
			float fRec280 = fTemp102 * fTemp233 / fTemp100;
			float fTemp234 = fTemp104 * (fTemp214 - fRec282[1]) + fRec281[1];
			fRec281[0] = 2.0f * (fTemp234 / fTemp105) - fRec281[1];
			fRec282[0] = fRec282[1] + 2.0f * (fTemp104 * fTemp234 / fTemp105);
			float fRec283 = fTemp107 * fTemp234 / fTemp105;
			float fTemp235 = fTemp109 * (fTemp214 - fRec285[1]) + fRec284[1];
			fRec284[0] = 2.0f * (fTemp235 / fTemp110) - fRec284[1];
			fRec285[0] = fRec285[1] + 2.0f * (fTemp109 * fTemp235 / fTemp110);
			float fRec286 = fTemp112 * fTemp235 / fTemp110;
			float fTemp236 = fTemp114 * (fTemp214 - fRec288[1]) + fRec287[1];
			fRec287[0] = 2.0f * (fTemp236 / fTemp115) - fRec287[1];
			fRec288[0] = fRec288[1] + 2.0f * (fTemp114 * fTemp236 / fTemp115);
			float fRec289 = fTemp117 * fTemp236 / fTemp115;
			float fTemp237 = fTemp119 * (fTemp214 - fRec291[1]) + fRec290[1];
			fRec290[0] = 2.0f * (fTemp237 / fTemp120) - fRec290[1];
			fRec291[0] = fRec291[1] + 2.0f * (fTemp119 * fTemp237 / fTemp120);
			float fRec292 = fTemp122 * fTemp237 / fTemp120;
			float fTemp238 = fTemp124 * (fTemp214 - fRec294[1]) + fRec293[1];
			fRec293[0] = 2.0f * (fTemp238 / fTemp125) - fRec293[1];
			fRec294[0] = fRec294[1] + 2.0f * (fTemp124 * fTemp238 / fTemp125);
			float fRec295 = fTemp127 * fTemp238 / fTemp125;
			float fTemp239 = fTemp129 * (fTemp214 - fRec297[1]) + fRec296[1];
			fRec296[0] = 2.0f * (fTemp239 / fTemp130) - fRec296[1];
			fRec297[0] = fRec297[1] + 2.0f * (fTemp129 * fTemp239 / fTemp130);
			float fRec298 = fTemp132 * fTemp239 / fTemp130;
			float fTemp240 = fTemp134 * (fTemp214 - fRec300[1]) + fRec299[1];
			fRec299[0] = 2.0f * (fTemp240 / fTemp135) - fRec299[1];
			fRec300[0] = fRec300[1] + 2.0f * (fTemp134 * fTemp240 / fTemp135);
			float fRec301 = fTemp137 * fTemp240 / fTemp135;
			float fTemp241 = fTemp139 * (fTemp214 - fRec303[1]) + fRec302[1];
			fRec302[0] = 2.0f * (fTemp241 / fTemp140) - fRec302[1];
			fRec303[0] = fRec303[1] + 2.0f * (fTemp139 * fTemp241 / fTemp140);
			float fRec304 = fTemp142 * fTemp241 / fTemp140;
			float fTemp242 = fTemp144 * (fTemp214 - fRec306[1]) + fRec305[1];
			fRec305[0] = 2.0f * (fTemp242 / fTemp145) - fRec305[1];
			fRec306[0] = fRec306[1] + 2.0f * (fTemp144 * fTemp242 / fTemp145);
			float fRec307 = fTemp147 * fTemp242 / fTemp145;
			float fTemp243 = fTemp149 * (fTemp214 - fRec309[1]) + fRec308[1];
			fRec308[0] = 2.0f * (fTemp243 / fTemp150) - fRec308[1];
			fRec309[0] = fRec309[1] + 2.0f * (fTemp149 * fTemp243 / fTemp150);
			float fRec310 = fTemp152 * fTemp243 / fTemp150;
			float fTemp244 = fTemp154 * (fTemp214 - fRec312[1]) + fRec311[1];
			fRec311[0] = 2.0f * (fTemp244 / fTemp155) - fRec311[1];
			fRec312[0] = fRec312[1] + 2.0f * (fTemp154 * fTemp244 / fTemp155);
			float fRec313 = fTemp157 * fTemp244 / fTemp155;
			float fTemp245 = fTemp159 * (fTemp214 - fRec315[1]) + fRec314[1];
			fRec314[0] = 2.0f * (fTemp245 / fTemp160) - fRec314[1];
			fRec315[0] = fRec315[1] + 2.0f * (fTemp159 * fTemp245 / fTemp160);
			float fRec316 = fTemp162 * fTemp245 / fTemp160;
			float fTemp246 = fTemp164 * (fTemp214 - fRec318[1]) + fRec317[1];
			fRec317[0] = 2.0f * (fTemp246 / fTemp165) - fRec317[1];
			fRec318[0] = fRec318[1] + 2.0f * (fTemp164 * fTemp246 / fTemp165);
			float fRec319 = fTemp167 * fTemp246 / fTemp165;
			float fTemp247 = fTemp169 * (fTemp214 - fRec321[1]) + fRec320[1];
			fRec320[0] = 2.0f * (fTemp247 / fTemp170) - fRec320[1];
			fRec321[0] = fRec321[1] + 2.0f * (fTemp169 * fTemp247 / fTemp170);
			float fRec322 = fTemp172 * fTemp247 / fTemp170;
			fRec14[0] = 0.03125f * fTemp173 * (fRec322 + fRec319 + fRec316 + fRec313 + fRec310 + fRec307 + fRec304 + fRec301 + fRec298 + fRec295 + fRec292 + fRec289 + fRec286 + fRec283 + fRec280 + fRec277 + fRec274 + fRec271 + fRec268 + fRec265 + fRec262 + fRec259 + fRec256 + fRec253 + fRec250 + fRec247 + fRec244 + fRec241 + fRec238 + fRec235 + fRec232 + fRec229) + fTemp9 * fTemp213;
			float fTemp248 = (fRec14[0] + fRec12[0] + fRec13[0]) / fTemp0;
			fVec7[IOTA0 & 4194303] = fTemp248;
			float fThen7 = (((fRec324[1] == 1.0f) & (fConst8 != fRec326[1])) ? -0.0009765625f : 0.0f);
			float fThen9 = (((fRec324[1] == 0.0f) & (fConst8 != fRec325[1])) ? 0.0009765625f : fThen7);
			float fElse9 = (((fRec324[1] > 0.0f) & (fRec324[1] < 1.0f)) ? fRec323[1] : 0.0f);
			float fTemp249 = ((fRec323[1] != 0.0f) ? fElse9 : fThen9);
			fRec323[0] = fTemp249;
			fRec324[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec324[1] + fTemp249));
			fRec325[0] = (((fRec324[1] >= 1.0f) & (fRec326[1] != fConst8)) ? fConst8 : fRec325[1]);
			fRec326[0] = (((fRec324[1] <= 0.0f) & (fRec325[1] != fConst8)) ? fConst8 : fRec326[1]);
			float fTemp250 = fVec7[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec325[0])))) & 4194303];
			fRec10[0] = 0.33333334f * fTemp250 + fRec324[0] * (0.0f - 0.33333334f * (fTemp250 - fVec7[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec326[0])))) & 4194303]));
			float fThen13 = (((fRec334[1] == 1.0f) & (fConst9 != fRec336[1])) ? -0.0009765625f : 0.0f);
			float fThen15 = (((fRec334[1] == 0.0f) & (fConst9 != fRec335[1])) ? 0.0009765625f : fThen13);
			float fElse15 = (((fRec334[1] > 0.0f) & (fRec334[1] < 1.0f)) ? fRec333[1] : 0.0f);
			float fTemp251 = ((fRec333[1] != 0.0f) ? fElse15 : fThen15);
			fRec333[0] = fTemp251;
			fRec334[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec334[1] + fTemp251));
			fRec335[0] = (((fRec334[1] >= 1.0f) & (fRec336[1] != fConst9)) ? fConst9 : fRec335[1]);
			fRec336[0] = (((fRec334[1] <= 0.0f) & (fRec335[1] != fConst9)) ? fConst9 : fRec336[1]);
			float fTemp252 = fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec335[0])))) & 4194303];
			fRec332[0] = fTemp252 + fRec334[0] * (fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec336[0])))) & 4194303] - fTemp252);
			float fTemp253 = fRec25[0] * (fRec328[1] + fTemp6 * (fRec329[1] - fRec328[1]) + fTemp5);
			fVec8[0] = fTemp253 + fRec332[1];
			fRec331[0] = fRec332[1] + 0.995f * fRec331[1] + fTemp253 - fVec8[1];
			float fTemp254 = tanhf(fRec331[0] / fTemp1);
			float fTemp255 = fTemp0 * fTemp254;
			float fTemp256 = fTemp12 * (fTemp255 - fRec338[1]) + fRec337[1];
			fRec337[0] = 2.0f * (fTemp256 / fTemp13) - fRec337[1];
			fRec338[0] = fRec338[1] + 2.0f * (fTemp12 * fTemp256 / fTemp13);
			float fRec339 = fTemp16 * fTemp256 / fTemp13;
			float fTemp257 = fTemp18 * (fTemp255 - fRec341[1]) + fRec340[1];
			fRec340[0] = 2.0f * (fTemp257 / fTemp19) - fRec340[1];
			fRec341[0] = fRec341[1] + 2.0f * (fTemp18 * fTemp257 / fTemp19);
			float fRec342 = fTemp21 * fTemp257 / fTemp19;
			float fTemp258 = fTemp23 * (fTemp255 - fRec344[1]) + fRec343[1];
			fRec343[0] = 2.0f * (fTemp258 / fTemp24) - fRec343[1];
			fRec344[0] = fRec344[1] + 2.0f * (fTemp23 * fTemp258 / fTemp24);
			float fRec345 = fTemp26 * fTemp258 / fTemp24;
			float fTemp259 = fTemp28 * (fTemp255 - fRec347[1]) + fRec346[1];
			fRec346[0] = 2.0f * (fTemp259 / fTemp29) - fRec346[1];
			fRec347[0] = fRec347[1] + 2.0f * (fTemp28 * fTemp259 / fTemp29);
			float fRec348 = fTemp31 * fTemp259 / fTemp29;
			float fTemp260 = fTemp33 * (fTemp255 - fRec350[1]) + fRec349[1];
			fRec349[0] = 2.0f * (fTemp260 / fTemp34) - fRec349[1];
			fRec350[0] = fRec350[1] + 2.0f * (fTemp33 * fTemp260 / fTemp34);
			float fRec351 = fTemp36 * fTemp260 / fTemp34;
			float fTemp261 = fTemp38 * (fTemp255 - fRec353[1]) + fRec352[1];
			fRec352[0] = 2.0f * (fTemp261 / fTemp39) - fRec352[1];
			fRec353[0] = fRec353[1] + 2.0f * (fTemp38 * fTemp261 / fTemp39);
			float fRec354 = fTemp41 * fTemp261 / fTemp39;
			float fTemp262 = fTemp43 * (fTemp255 - fRec356[1]) + fRec355[1];
			fRec355[0] = 2.0f * (fTemp262 / fTemp44) - fRec355[1];
			fRec356[0] = fRec356[1] + 2.0f * (fTemp43 * fTemp262 / fTemp44);
			float fRec357 = fTemp46 * fTemp262 / fTemp44;
			float fTemp263 = fTemp48 * (fTemp255 - fRec359[1]) + fRec358[1];
			fRec358[0] = 2.0f * (fTemp263 / fTemp49) - fRec358[1];
			fRec359[0] = fRec359[1] + 2.0f * (fTemp48 * fTemp263 / fTemp49);
			float fRec360 = fTemp51 * fTemp263 / fTemp49;
			float fTemp264 = fTemp53 * (fTemp255 - fRec362[1]) + fRec361[1];
			fRec361[0] = 2.0f * (fTemp264 / fTemp54) - fRec361[1];
			fRec362[0] = fRec362[1] + 2.0f * (fTemp53 * fTemp264 / fTemp54);
			float fRec363 = fTemp56 * fTemp264 / fTemp54;
			float fTemp265 = fTemp58 * (fTemp255 - fRec365[1]) + fRec364[1];
			fRec364[0] = 2.0f * (fTemp265 / fTemp59) - fRec364[1];
			fRec365[0] = fRec365[1] + 2.0f * (fTemp58 * fTemp265 / fTemp59);
			float fRec366 = fTemp61 * fTemp265 / fTemp59;
			float fTemp266 = fTemp64 * (fTemp255 - fRec368[1]) + fRec367[1];
			fRec367[0] = 2.0f * (fTemp266 / fTemp65) - fRec367[1];
			fRec368[0] = fRec368[1] + 2.0f * (fTemp64 * fTemp266 / fTemp65);
			float fRec369 = fTemp67 * fTemp266 / fTemp65;
			float fTemp267 = fTemp69 * (fTemp255 - fRec371[1]) + fRec370[1];
			fRec370[0] = 2.0f * (fTemp267 / fTemp70) - fRec370[1];
			fRec371[0] = fRec371[1] + 2.0f * (fTemp69 * fTemp267 / fTemp70);
			float fRec372 = fTemp72 * fTemp267 / fTemp70;
			float fTemp268 = fTemp74 * (fTemp255 - fRec374[1]) + fRec373[1];
			fRec373[0] = 2.0f * (fTemp268 / fTemp75) - fRec373[1];
			fRec374[0] = fRec374[1] + 2.0f * (fTemp74 * fTemp268 / fTemp75);
			float fRec375 = fTemp77 * fTemp268 / fTemp75;
			float fTemp269 = fTemp79 * (fTemp255 - fRec377[1]) + fRec376[1];
			fRec376[0] = 2.0f * (fTemp269 / fTemp80) - fRec376[1];
			fRec377[0] = fRec377[1] + 2.0f * (fTemp79 * fTemp269 / fTemp80);
			float fRec378 = fTemp82 * fTemp269 / fTemp80;
			float fTemp270 = fTemp84 * (fTemp255 - fRec380[1]) + fRec379[1];
			fRec379[0] = 2.0f * (fTemp270 / fTemp85) - fRec379[1];
			fRec380[0] = fRec380[1] + 2.0f * (fTemp84 * fTemp270 / fTemp85);
			float fRec381 = fTemp87 * fTemp270 / fTemp85;
			float fTemp271 = fTemp89 * (fTemp255 - fRec383[1]) + fRec382[1];
			fRec382[0] = 2.0f * (fTemp271 / fTemp90) - fRec382[1];
			fRec383[0] = fRec383[1] + 2.0f * (fTemp89 * fTemp271 / fTemp90);
			float fRec384 = fTemp92 * fTemp271 / fTemp90;
			float fTemp272 = fTemp94 * (fTemp255 - fRec386[1]) + fRec385[1];
			float fTemp273 = fTemp272 / fTemp95;
			fRec385[0] = 2.0f * fTemp273 - fRec385[1];
			fRec386[0] = fRec386[1] + 2.0f * (fTemp94 * fTemp272 / fTemp95);
			float fRec387 = fTemp273;
			float fTemp274 = fTemp99 * (fTemp255 - fRec389[1]) + fRec388[1];
			fRec388[0] = 2.0f * (fTemp274 / fTemp100) - fRec388[1];
			fRec389[0] = fRec389[1] + 2.0f * (fTemp99 * fTemp274 / fTemp100);
			float fRec390 = fTemp102 * fTemp274 / fTemp100;
			float fTemp275 = fTemp104 * (fTemp255 - fRec392[1]) + fRec391[1];
			fRec391[0] = 2.0f * (fTemp275 / fTemp105) - fRec391[1];
			fRec392[0] = fRec392[1] + 2.0f * (fTemp104 * fTemp275 / fTemp105);
			float fRec393 = fTemp107 * fTemp275 / fTemp105;
			float fTemp276 = fTemp109 * (fTemp255 - fRec395[1]) + fRec394[1];
			fRec394[0] = 2.0f * (fTemp276 / fTemp110) - fRec394[1];
			fRec395[0] = fRec395[1] + 2.0f * (fTemp109 * fTemp276 / fTemp110);
			float fRec396 = fTemp112 * fTemp276 / fTemp110;
			float fTemp277 = fTemp114 * (fTemp255 - fRec398[1]) + fRec397[1];
			fRec397[0] = 2.0f * (fTemp277 / fTemp115) - fRec397[1];
			fRec398[0] = fRec398[1] + 2.0f * (fTemp114 * fTemp277 / fTemp115);
			float fRec399 = fTemp117 * fTemp277 / fTemp115;
			float fTemp278 = fTemp119 * (fTemp255 - fRec401[1]) + fRec400[1];
			fRec400[0] = 2.0f * (fTemp278 / fTemp120) - fRec400[1];
			fRec401[0] = fRec401[1] + 2.0f * (fTemp119 * fTemp278 / fTemp120);
			float fRec402 = fTemp122 * fTemp278 / fTemp120;
			float fTemp279 = fTemp124 * (fTemp255 - fRec404[1]) + fRec403[1];
			fRec403[0] = 2.0f * (fTemp279 / fTemp125) - fRec403[1];
			fRec404[0] = fRec404[1] + 2.0f * (fTemp124 * fTemp279 / fTemp125);
			float fRec405 = fTemp127 * fTemp279 / fTemp125;
			float fTemp280 = fTemp129 * (fTemp255 - fRec407[1]) + fRec406[1];
			fRec406[0] = 2.0f * (fTemp280 / fTemp130) - fRec406[1];
			fRec407[0] = fRec407[1] + 2.0f * (fTemp129 * fTemp280 / fTemp130);
			float fRec408 = fTemp132 * fTemp280 / fTemp130;
			float fTemp281 = fTemp134 * (fTemp255 - fRec410[1]) + fRec409[1];
			fRec409[0] = 2.0f * (fTemp281 / fTemp135) - fRec409[1];
			fRec410[0] = fRec410[1] + 2.0f * (fTemp134 * fTemp281 / fTemp135);
			float fRec411 = fTemp137 * fTemp281 / fTemp135;
			float fTemp282 = fTemp139 * (fTemp255 - fRec413[1]) + fRec412[1];
			fRec412[0] = 2.0f * (fTemp282 / fTemp140) - fRec412[1];
			fRec413[0] = fRec413[1] + 2.0f * (fTemp139 * fTemp282 / fTemp140);
			float fRec414 = fTemp142 * fTemp282 / fTemp140;
			float fTemp283 = fTemp144 * (fTemp255 - fRec416[1]) + fRec415[1];
			fRec415[0] = 2.0f * (fTemp283 / fTemp145) - fRec415[1];
			fRec416[0] = fRec416[1] + 2.0f * (fTemp144 * fTemp283 / fTemp145);
			float fRec417 = fTemp147 * fTemp283 / fTemp145;
			float fTemp284 = fTemp149 * (fTemp255 - fRec419[1]) + fRec418[1];
			fRec418[0] = 2.0f * (fTemp284 / fTemp150) - fRec418[1];
			fRec419[0] = fRec419[1] + 2.0f * (fTemp149 * fTemp284 / fTemp150);
			float fRec420 = fTemp152 * fTemp284 / fTemp150;
			float fTemp285 = fTemp154 * (fTemp255 - fRec422[1]) + fRec421[1];
			fRec421[0] = 2.0f * (fTemp285 / fTemp155) - fRec421[1];
			fRec422[0] = fRec422[1] + 2.0f * (fTemp154 * fTemp285 / fTemp155);
			float fRec423 = fTemp157 * fTemp285 / fTemp155;
			float fTemp286 = fTemp159 * (fTemp255 - fRec425[1]) + fRec424[1];
			fRec424[0] = 2.0f * (fTemp286 / fTemp160) - fRec424[1];
			fRec425[0] = fRec425[1] + 2.0f * (fTemp159 * fTemp286 / fTemp160);
			float fRec426 = fTemp162 * fTemp286 / fTemp160;
			float fTemp287 = fTemp164 * (fTemp255 - fRec428[1]) + fRec427[1];
			fRec427[0] = 2.0f * (fTemp287 / fTemp165) - fRec427[1];
			fRec428[0] = fRec428[1] + 2.0f * (fTemp164 * fTemp287 / fTemp165);
			float fRec429 = fTemp167 * fTemp287 / fTemp165;
			float fTemp288 = fTemp169 * (fTemp255 - fRec431[1]) + fRec430[1];
			fRec430[0] = 2.0f * (fTemp288 / fTemp170) - fRec430[1];
			fRec431[0] = fRec431[1] + 2.0f * (fTemp169 * fTemp288 / fTemp170);
			float fRec432 = fTemp172 * fTemp288 / fTemp170;
			fRec328[0] = 0.03125f * fTemp173 * (fRec432 + fRec429 + fRec426 + fRec423 + fRec420 + fRec417 + fRec414 + fRec411 + fRec408 + fRec405 + fRec402 + fRec399 + fRec396 + fRec393 + fRec390 + fRec387 + fRec384 + fRec381 + fRec378 + fRec375 + fRec372 + fRec369 + fRec366 + fRec363 + fRec360 + fRec357 + fRec354 + fRec351 + fRec348 + fRec345 + fRec342 + fRec339) + fTemp9 * fTemp254;
			float fTemp289 = fRec25[0] * (fRec329[1] + fRec23[0] * (fRec328[1] * (fRec128[0] - fRec330[1]) - fRec329[1]) + fTemp174);
			fVec9[0] = fRec332[1] + fTemp289;
			fRec433[0] = fTemp289 + fRec332[1] + 0.995f * fRec433[1] - fVec9[1];
			float fTemp290 = tanhf(fRec433[0] / fTemp1);
			float fTemp291 = fTemp0 * fTemp290;
			float fTemp292 = fTemp12 * (fTemp291 - fRec435[1]) + fRec434[1];
			fRec434[0] = 2.0f * (fTemp292 / fTemp13) - fRec434[1];
			fRec435[0] = fRec435[1] + 2.0f * (fTemp12 * fTemp292 / fTemp13);
			float fRec436 = fTemp16 * fTemp292 / fTemp13;
			float fTemp293 = fTemp18 * (fTemp291 - fRec438[1]) + fRec437[1];
			fRec437[0] = 2.0f * (fTemp293 / fTemp19) - fRec437[1];
			fRec438[0] = fRec438[1] + 2.0f * (fTemp18 * fTemp293 / fTemp19);
			float fRec439 = fTemp21 * fTemp293 / fTemp19;
			float fTemp294 = fTemp23 * (fTemp291 - fRec441[1]) + fRec440[1];
			fRec440[0] = 2.0f * (fTemp294 / fTemp24) - fRec440[1];
			fRec441[0] = fRec441[1] + 2.0f * (fTemp23 * fTemp294 / fTemp24);
			float fRec442 = fTemp26 * fTemp294 / fTemp24;
			float fTemp295 = fTemp28 * (fTemp291 - fRec444[1]) + fRec443[1];
			fRec443[0] = 2.0f * (fTemp295 / fTemp29) - fRec443[1];
			fRec444[0] = fRec444[1] + 2.0f * (fTemp28 * fTemp295 / fTemp29);
			float fRec445 = fTemp31 * fTemp295 / fTemp29;
			float fTemp296 = fTemp33 * (fTemp291 - fRec447[1]) + fRec446[1];
			fRec446[0] = 2.0f * (fTemp296 / fTemp34) - fRec446[1];
			fRec447[0] = fRec447[1] + 2.0f * (fTemp33 * fTemp296 / fTemp34);
			float fRec448 = fTemp36 * fTemp296 / fTemp34;
			float fTemp297 = fTemp38 * (fTemp291 - fRec450[1]) + fRec449[1];
			fRec449[0] = 2.0f * (fTemp297 / fTemp39) - fRec449[1];
			fRec450[0] = fRec450[1] + 2.0f * (fTemp38 * fTemp297 / fTemp39);
			float fRec451 = fTemp41 * fTemp297 / fTemp39;
			float fTemp298 = fTemp43 * (fTemp291 - fRec453[1]) + fRec452[1];
			fRec452[0] = 2.0f * (fTemp298 / fTemp44) - fRec452[1];
			fRec453[0] = fRec453[1] + 2.0f * (fTemp43 * fTemp298 / fTemp44);
			float fRec454 = fTemp46 * fTemp298 / fTemp44;
			float fTemp299 = fTemp48 * (fTemp291 - fRec456[1]) + fRec455[1];
			fRec455[0] = 2.0f * (fTemp299 / fTemp49) - fRec455[1];
			fRec456[0] = fRec456[1] + 2.0f * (fTemp48 * fTemp299 / fTemp49);
			float fRec457 = fTemp51 * fTemp299 / fTemp49;
			float fTemp300 = fTemp53 * (fTemp291 - fRec459[1]) + fRec458[1];
			fRec458[0] = 2.0f * (fTemp300 / fTemp54) - fRec458[1];
			fRec459[0] = fRec459[1] + 2.0f * (fTemp53 * fTemp300 / fTemp54);
			float fRec460 = fTemp56 * fTemp300 / fTemp54;
			float fTemp301 = fTemp58 * (fTemp291 - fRec462[1]) + fRec461[1];
			fRec461[0] = 2.0f * (fTemp301 / fTemp59) - fRec461[1];
			fRec462[0] = fRec462[1] + 2.0f * (fTemp58 * fTemp301 / fTemp59);
			float fRec463 = fTemp61 * fTemp301 / fTemp59;
			float fTemp302 = fTemp64 * (fTemp291 - fRec465[1]) + fRec464[1];
			fRec464[0] = 2.0f * (fTemp302 / fTemp65) - fRec464[1];
			fRec465[0] = fRec465[1] + 2.0f * (fTemp64 * fTemp302 / fTemp65);
			float fRec466 = fTemp67 * fTemp302 / fTemp65;
			float fTemp303 = fTemp69 * (fTemp291 - fRec468[1]) + fRec467[1];
			fRec467[0] = 2.0f * (fTemp303 / fTemp70) - fRec467[1];
			fRec468[0] = fRec468[1] + 2.0f * (fTemp69 * fTemp303 / fTemp70);
			float fRec469 = fTemp72 * fTemp303 / fTemp70;
			float fTemp304 = fTemp74 * (fTemp291 - fRec471[1]) + fRec470[1];
			fRec470[0] = 2.0f * (fTemp304 / fTemp75) - fRec470[1];
			fRec471[0] = fRec471[1] + 2.0f * (fTemp74 * fTemp304 / fTemp75);
			float fRec472 = fTemp77 * fTemp304 / fTemp75;
			float fTemp305 = fTemp79 * (fTemp291 - fRec474[1]) + fRec473[1];
			fRec473[0] = 2.0f * (fTemp305 / fTemp80) - fRec473[1];
			fRec474[0] = fRec474[1] + 2.0f * (fTemp79 * fTemp305 / fTemp80);
			float fRec475 = fTemp82 * fTemp305 / fTemp80;
			float fTemp306 = fTemp84 * (fTemp291 - fRec477[1]) + fRec476[1];
			fRec476[0] = 2.0f * (fTemp306 / fTemp85) - fRec476[1];
			fRec477[0] = fRec477[1] + 2.0f * (fTemp84 * fTemp306 / fTemp85);
			float fRec478 = fTemp87 * fTemp306 / fTemp85;
			float fTemp307 = fTemp89 * (fTemp291 - fRec480[1]) + fRec479[1];
			fRec479[0] = 2.0f * (fTemp307 / fTemp90) - fRec479[1];
			fRec480[0] = fRec480[1] + 2.0f * (fTemp89 * fTemp307 / fTemp90);
			float fRec481 = fTemp92 * fTemp307 / fTemp90;
			float fTemp308 = fTemp94 * (fTemp291 - fRec483[1]) + fRec482[1];
			float fTemp309 = fTemp308 / fTemp95;
			fRec482[0] = 2.0f * fTemp309 - fRec482[1];
			fRec483[0] = fRec483[1] + 2.0f * (fTemp94 * fTemp308 / fTemp95);
			float fRec484 = fTemp309;
			float fTemp310 = fTemp99 * (fTemp291 - fRec486[1]) + fRec485[1];
			fRec485[0] = 2.0f * (fTemp310 / fTemp100) - fRec485[1];
			fRec486[0] = fRec486[1] + 2.0f * (fTemp99 * fTemp310 / fTemp100);
			float fRec487 = fTemp102 * fTemp310 / fTemp100;
			float fTemp311 = fTemp104 * (fTemp291 - fRec489[1]) + fRec488[1];
			fRec488[0] = 2.0f * (fTemp311 / fTemp105) - fRec488[1];
			fRec489[0] = fRec489[1] + 2.0f * (fTemp104 * fTemp311 / fTemp105);
			float fRec490 = fTemp107 * fTemp311 / fTemp105;
			float fTemp312 = fTemp109 * (fTemp291 - fRec492[1]) + fRec491[1];
			fRec491[0] = 2.0f * (fTemp312 / fTemp110) - fRec491[1];
			fRec492[0] = fRec492[1] + 2.0f * (fTemp109 * fTemp312 / fTemp110);
			float fRec493 = fTemp112 * fTemp312 / fTemp110;
			float fTemp313 = fTemp114 * (fTemp291 - fRec495[1]) + fRec494[1];
			fRec494[0] = 2.0f * (fTemp313 / fTemp115) - fRec494[1];
			fRec495[0] = fRec495[1] + 2.0f * (fTemp114 * fTemp313 / fTemp115);
			float fRec496 = fTemp117 * fTemp313 / fTemp115;
			float fTemp314 = fTemp119 * (fTemp291 - fRec498[1]) + fRec497[1];
			fRec497[0] = 2.0f * (fTemp314 / fTemp120) - fRec497[1];
			fRec498[0] = fRec498[1] + 2.0f * (fTemp119 * fTemp314 / fTemp120);
			float fRec499 = fTemp122 * fTemp314 / fTemp120;
			float fTemp315 = fTemp124 * (fTemp291 - fRec501[1]) + fRec500[1];
			fRec500[0] = 2.0f * (fTemp315 / fTemp125) - fRec500[1];
			fRec501[0] = fRec501[1] + 2.0f * (fTemp124 * fTemp315 / fTemp125);
			float fRec502 = fTemp127 * fTemp315 / fTemp125;
			float fTemp316 = fTemp129 * (fTemp291 - fRec504[1]) + fRec503[1];
			fRec503[0] = 2.0f * (fTemp316 / fTemp130) - fRec503[1];
			fRec504[0] = fRec504[1] + 2.0f * (fTemp129 * fTemp316 / fTemp130);
			float fRec505 = fTemp132 * fTemp316 / fTemp130;
			float fTemp317 = fTemp134 * (fTemp291 - fRec507[1]) + fRec506[1];
			fRec506[0] = 2.0f * (fTemp317 / fTemp135) - fRec506[1];
			fRec507[0] = fRec507[1] + 2.0f * (fTemp134 * fTemp317 / fTemp135);
			float fRec508 = fTemp137 * fTemp317 / fTemp135;
			float fTemp318 = fTemp139 * (fTemp291 - fRec510[1]) + fRec509[1];
			fRec509[0] = 2.0f * (fTemp318 / fTemp140) - fRec509[1];
			fRec510[0] = fRec510[1] + 2.0f * (fTemp139 * fTemp318 / fTemp140);
			float fRec511 = fTemp142 * fTemp318 / fTemp140;
			float fTemp319 = fTemp144 * (fTemp291 - fRec513[1]) + fRec512[1];
			fRec512[0] = 2.0f * (fTemp319 / fTemp145) - fRec512[1];
			fRec513[0] = fRec513[1] + 2.0f * (fTemp144 * fTemp319 / fTemp145);
			float fRec514 = fTemp147 * fTemp319 / fTemp145;
			float fTemp320 = fTemp149 * (fTemp291 - fRec516[1]) + fRec515[1];
			fRec515[0] = 2.0f * (fTemp320 / fTemp150) - fRec515[1];
			fRec516[0] = fRec516[1] + 2.0f * (fTemp149 * fTemp320 / fTemp150);
			float fRec517 = fTemp152 * fTemp320 / fTemp150;
			float fTemp321 = fTemp154 * (fTemp291 - fRec519[1]) + fRec518[1];
			fRec518[0] = 2.0f * (fTemp321 / fTemp155) - fRec518[1];
			fRec519[0] = fRec519[1] + 2.0f * (fTemp154 * fTemp321 / fTemp155);
			float fRec520 = fTemp157 * fTemp321 / fTemp155;
			float fTemp322 = fTemp159 * (fTemp291 - fRec522[1]) + fRec521[1];
			fRec521[0] = 2.0f * (fTemp322 / fTemp160) - fRec521[1];
			fRec522[0] = fRec522[1] + 2.0f * (fTemp159 * fTemp322 / fTemp160);
			float fRec523 = fTemp162 * fTemp322 / fTemp160;
			float fTemp323 = fTemp164 * (fTemp291 - fRec525[1]) + fRec524[1];
			fRec524[0] = 2.0f * (fTemp323 / fTemp165) - fRec524[1];
			fRec525[0] = fRec525[1] + 2.0f * (fTemp164 * fTemp323 / fTemp165);
			float fRec526 = fTemp167 * fTemp323 / fTemp165;
			float fTemp324 = fTemp169 * (fTemp291 - fRec528[1]) + fRec527[1];
			fRec527[0] = 2.0f * (fTemp324 / fTemp170) - fRec527[1];
			fRec528[0] = fRec528[1] + 2.0f * (fTemp169 * fTemp324 / fTemp170);
			float fRec529 = fTemp172 * fTemp324 / fTemp170;
			fRec329[0] = 0.03125f * fTemp173 * (fRec529 + fRec526 + fRec523 + fRec520 + fRec517 + fRec514 + fRec511 + fRec508 + fRec505 + fRec502 + fRec499 + fRec496 + fRec493 + fRec490 + fRec487 + fRec484 + fRec481 + fRec478 + fRec475 + fRec472 + fRec469 + fRec466 + fRec463 + fRec460 + fRec457 + fRec454 + fRec451 + fRec448 + fRec445 + fRec442 + fRec439 + fRec436) + fTemp9 * fTemp290;
			float fTemp325 = fRec25[0] * (fRec330[1] + fRec23[0] * (fRec328[1] * fRec329[1] - fRec226[0] * fRec330[1]) + fTemp211);
			fVec10[0] = fRec332[1] + fTemp325;
			fRec530[0] = fTemp325 + fRec332[1] + 0.995f * fRec530[1] - fVec10[1];
			float fTemp326 = tanhf(fRec530[0] / fTemp1);
			float fTemp327 = fTemp0 * fTemp326;
			float fTemp328 = fTemp12 * (fTemp327 - fRec532[1]) + fRec531[1];
			fRec531[0] = 2.0f * (fTemp328 / fTemp13) - fRec531[1];
			fRec532[0] = fRec532[1] + 2.0f * (fTemp12 * fTemp328 / fTemp13);
			float fRec533 = fTemp16 * fTemp328 / fTemp13;
			float fTemp329 = fTemp18 * (fTemp327 - fRec535[1]) + fRec534[1];
			fRec534[0] = 2.0f * (fTemp329 / fTemp19) - fRec534[1];
			fRec535[0] = fRec535[1] + 2.0f * (fTemp18 * fTemp329 / fTemp19);
			float fRec536 = fTemp21 * fTemp329 / fTemp19;
			float fTemp330 = fTemp23 * (fTemp327 - fRec538[1]) + fRec537[1];
			fRec537[0] = 2.0f * (fTemp330 / fTemp24) - fRec537[1];
			fRec538[0] = fRec538[1] + 2.0f * (fTemp23 * fTemp330 / fTemp24);
			float fRec539 = fTemp26 * fTemp330 / fTemp24;
			float fTemp331 = fTemp28 * (fTemp327 - fRec541[1]) + fRec540[1];
			fRec540[0] = 2.0f * (fTemp331 / fTemp29) - fRec540[1];
			fRec541[0] = fRec541[1] + 2.0f * (fTemp28 * fTemp331 / fTemp29);
			float fRec542 = fTemp31 * fTemp331 / fTemp29;
			float fTemp332 = fTemp33 * (fTemp327 - fRec544[1]) + fRec543[1];
			fRec543[0] = 2.0f * (fTemp332 / fTemp34) - fRec543[1];
			fRec544[0] = fRec544[1] + 2.0f * (fTemp33 * fTemp332 / fTemp34);
			float fRec545 = fTemp36 * fTemp332 / fTemp34;
			float fTemp333 = fTemp38 * (fTemp327 - fRec547[1]) + fRec546[1];
			fRec546[0] = 2.0f * (fTemp333 / fTemp39) - fRec546[1];
			fRec547[0] = fRec547[1] + 2.0f * (fTemp38 * fTemp333 / fTemp39);
			float fRec548 = fTemp41 * fTemp333 / fTemp39;
			float fTemp334 = fTemp43 * (fTemp327 - fRec550[1]) + fRec549[1];
			fRec549[0] = 2.0f * (fTemp334 / fTemp44) - fRec549[1];
			fRec550[0] = fRec550[1] + 2.0f * (fTemp43 * fTemp334 / fTemp44);
			float fRec551 = fTemp46 * fTemp334 / fTemp44;
			float fTemp335 = fTemp48 * (fTemp327 - fRec553[1]) + fRec552[1];
			fRec552[0] = 2.0f * (fTemp335 / fTemp49) - fRec552[1];
			fRec553[0] = fRec553[1] + 2.0f * (fTemp48 * fTemp335 / fTemp49);
			float fRec554 = fTemp51 * fTemp335 / fTemp49;
			float fTemp336 = fTemp53 * (fTemp327 - fRec556[1]) + fRec555[1];
			fRec555[0] = 2.0f * (fTemp336 / fTemp54) - fRec555[1];
			fRec556[0] = fRec556[1] + 2.0f * (fTemp53 * fTemp336 / fTemp54);
			float fRec557 = fTemp56 * fTemp336 / fTemp54;
			float fTemp337 = fTemp58 * (fTemp327 - fRec559[1]) + fRec558[1];
			fRec558[0] = 2.0f * (fTemp337 / fTemp59) - fRec558[1];
			fRec559[0] = fRec559[1] + 2.0f * (fTemp58 * fTemp337 / fTemp59);
			float fRec560 = fTemp61 * fTemp337 / fTemp59;
			float fTemp338 = fTemp64 * (fTemp327 - fRec562[1]) + fRec561[1];
			fRec561[0] = 2.0f * (fTemp338 / fTemp65) - fRec561[1];
			fRec562[0] = fRec562[1] + 2.0f * (fTemp64 * fTemp338 / fTemp65);
			float fRec563 = fTemp67 * fTemp338 / fTemp65;
			float fTemp339 = fTemp69 * (fTemp327 - fRec565[1]) + fRec564[1];
			fRec564[0] = 2.0f * (fTemp339 / fTemp70) - fRec564[1];
			fRec565[0] = fRec565[1] + 2.0f * (fTemp69 * fTemp339 / fTemp70);
			float fRec566 = fTemp72 * fTemp339 / fTemp70;
			float fTemp340 = fTemp74 * (fTemp327 - fRec568[1]) + fRec567[1];
			fRec567[0] = 2.0f * (fTemp340 / fTemp75) - fRec567[1];
			fRec568[0] = fRec568[1] + 2.0f * (fTemp74 * fTemp340 / fTemp75);
			float fRec569 = fTemp77 * fTemp340 / fTemp75;
			float fTemp341 = fTemp79 * (fTemp327 - fRec571[1]) + fRec570[1];
			fRec570[0] = 2.0f * (fTemp341 / fTemp80) - fRec570[1];
			fRec571[0] = fRec571[1] + 2.0f * (fTemp79 * fTemp341 / fTemp80);
			float fRec572 = fTemp82 * fTemp341 / fTemp80;
			float fTemp342 = fTemp84 * (fTemp327 - fRec574[1]) + fRec573[1];
			fRec573[0] = 2.0f * (fTemp342 / fTemp85) - fRec573[1];
			fRec574[0] = fRec574[1] + 2.0f * (fTemp84 * fTemp342 / fTemp85);
			float fRec575 = fTemp87 * fTemp342 / fTemp85;
			float fTemp343 = fTemp89 * (fTemp327 - fRec577[1]) + fRec576[1];
			fRec576[0] = 2.0f * (fTemp343 / fTemp90) - fRec576[1];
			fRec577[0] = fRec577[1] + 2.0f * (fTemp89 * fTemp343 / fTemp90);
			float fRec578 = fTemp92 * fTemp343 / fTemp90;
			float fTemp344 = fTemp94 * (fTemp327 - fRec580[1]) + fRec579[1];
			float fTemp345 = fTemp344 / fTemp95;
			fRec579[0] = 2.0f * fTemp345 - fRec579[1];
			fRec580[0] = fRec580[1] + 2.0f * (fTemp94 * fTemp344 / fTemp95);
			float fRec581 = fTemp345;
			float fTemp346 = fTemp99 * (fTemp327 - fRec583[1]) + fRec582[1];
			fRec582[0] = 2.0f * (fTemp346 / fTemp100) - fRec582[1];
			fRec583[0] = fRec583[1] + 2.0f * (fTemp99 * fTemp346 / fTemp100);
			float fRec584 = fTemp102 * fTemp346 / fTemp100;
			float fTemp347 = fTemp104 * (fTemp327 - fRec586[1]) + fRec585[1];
			fRec585[0] = 2.0f * (fTemp347 / fTemp105) - fRec585[1];
			fRec586[0] = fRec586[1] + 2.0f * (fTemp104 * fTemp347 / fTemp105);
			float fRec587 = fTemp107 * fTemp347 / fTemp105;
			float fTemp348 = fTemp109 * (fTemp327 - fRec589[1]) + fRec588[1];
			fRec588[0] = 2.0f * (fTemp348 / fTemp110) - fRec588[1];
			fRec589[0] = fRec589[1] + 2.0f * (fTemp109 * fTemp348 / fTemp110);
			float fRec590 = fTemp112 * fTemp348 / fTemp110;
			float fTemp349 = fTemp114 * (fTemp327 - fRec592[1]) + fRec591[1];
			fRec591[0] = 2.0f * (fTemp349 / fTemp115) - fRec591[1];
			fRec592[0] = fRec592[1] + 2.0f * (fTemp114 * fTemp349 / fTemp115);
			float fRec593 = fTemp117 * fTemp349 / fTemp115;
			float fTemp350 = fTemp119 * (fTemp327 - fRec595[1]) + fRec594[1];
			fRec594[0] = 2.0f * (fTemp350 / fTemp120) - fRec594[1];
			fRec595[0] = fRec595[1] + 2.0f * (fTemp119 * fTemp350 / fTemp120);
			float fRec596 = fTemp122 * fTemp350 / fTemp120;
			float fTemp351 = fTemp124 * (fTemp327 - fRec598[1]) + fRec597[1];
			fRec597[0] = 2.0f * (fTemp351 / fTemp125) - fRec597[1];
			fRec598[0] = fRec598[1] + 2.0f * (fTemp124 * fTemp351 / fTemp125);
			float fRec599 = fTemp127 * fTemp351 / fTemp125;
			float fTemp352 = fTemp129 * (fTemp327 - fRec601[1]) + fRec600[1];
			fRec600[0] = 2.0f * (fTemp352 / fTemp130) - fRec600[1];
			fRec601[0] = fRec601[1] + 2.0f * (fTemp129 * fTemp352 / fTemp130);
			float fRec602 = fTemp132 * fTemp352 / fTemp130;
			float fTemp353 = fTemp134 * (fTemp327 - fRec604[1]) + fRec603[1];
			fRec603[0] = 2.0f * (fTemp353 / fTemp135) - fRec603[1];
			fRec604[0] = fRec604[1] + 2.0f * (fTemp134 * fTemp353 / fTemp135);
			float fRec605 = fTemp137 * fTemp353 / fTemp135;
			float fTemp354 = fTemp139 * (fTemp327 - fRec607[1]) + fRec606[1];
			fRec606[0] = 2.0f * (fTemp354 / fTemp140) - fRec606[1];
			fRec607[0] = fRec607[1] + 2.0f * (fTemp139 * fTemp354 / fTemp140);
			float fRec608 = fTemp142 * fTemp354 / fTemp140;
			float fTemp355 = fTemp144 * (fTemp327 - fRec610[1]) + fRec609[1];
			fRec609[0] = 2.0f * (fTemp355 / fTemp145) - fRec609[1];
			fRec610[0] = fRec610[1] + 2.0f * (fTemp144 * fTemp355 / fTemp145);
			float fRec611 = fTemp147 * fTemp355 / fTemp145;
			float fTemp356 = fTemp149 * (fTemp327 - fRec613[1]) + fRec612[1];
			fRec612[0] = 2.0f * (fTemp356 / fTemp150) - fRec612[1];
			fRec613[0] = fRec613[1] + 2.0f * (fTemp149 * fTemp356 / fTemp150);
			float fRec614 = fTemp152 * fTemp356 / fTemp150;
			float fTemp357 = fTemp154 * (fTemp327 - fRec616[1]) + fRec615[1];
			fRec615[0] = 2.0f * (fTemp357 / fTemp155) - fRec615[1];
			fRec616[0] = fRec616[1] + 2.0f * (fTemp154 * fTemp357 / fTemp155);
			float fRec617 = fTemp157 * fTemp357 / fTemp155;
			float fTemp358 = fTemp159 * (fTemp327 - fRec619[1]) + fRec618[1];
			fRec618[0] = 2.0f * (fTemp358 / fTemp160) - fRec618[1];
			fRec619[0] = fRec619[1] + 2.0f * (fTemp159 * fTemp358 / fTemp160);
			float fRec620 = fTemp162 * fTemp358 / fTemp160;
			float fTemp359 = fTemp164 * (fTemp327 - fRec622[1]) + fRec621[1];
			fRec621[0] = 2.0f * (fTemp359 / fTemp165) - fRec621[1];
			fRec622[0] = fRec622[1] + 2.0f * (fTemp164 * fTemp359 / fTemp165);
			float fRec623 = fTemp167 * fTemp359 / fTemp165;
			float fTemp360 = fTemp169 * (fTemp327 - fRec625[1]) + fRec624[1];
			fRec624[0] = 2.0f * (fTemp360 / fTemp170) - fRec624[1];
			fRec625[0] = fRec625[1] + 2.0f * (fTemp169 * fTemp360 / fTemp170);
			float fRec626 = fTemp172 * fTemp360 / fTemp170;
			fRec330[0] = 0.03125f * fTemp173 * (fRec626 + fRec623 + fRec620 + fRec617 + fRec614 + fRec611 + fRec608 + fRec605 + fRec602 + fRec599 + fRec596 + fRec593 + fRec590 + fRec587 + fRec584 + fRec581 + fRec578 + fRec575 + fRec572 + fRec569 + fRec566 + fRec563 + fRec560 + fRec557 + fRec554 + fRec551 + fRec548 + fRec545 + fRec542 + fRec539 + fRec536 + fRec533) + fTemp9 * fTemp326;
			float fTemp361 = (fRec330[0] + fRec328[0] + fRec329[0]) / fTemp0;
			fVec11[IOTA0 & 4194303] = fTemp361;
			float fThen19 = (((fRec628[1] == 1.0f) & (fConst10 != fRec630[1])) ? -0.0009765625f : 0.0f);
			float fThen21 = (((fRec628[1] == 0.0f) & (fConst10 != fRec629[1])) ? 0.0009765625f : fThen19);
			float fElse21 = (((fRec628[1] > 0.0f) & (fRec628[1] < 1.0f)) ? fRec627[1] : 0.0f);
			float fTemp362 = ((fRec627[1] != 0.0f) ? fElse21 : fThen21);
			fRec627[0] = fTemp362;
			fRec628[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec628[1] + fTemp362));
			fRec629[0] = (((fRec628[1] >= 1.0f) & (fRec630[1] != fConst10)) ? fConst10 : fRec629[1]);
			fRec630[0] = (((fRec628[1] <= 0.0f) & (fRec629[1] != fConst10)) ? fConst10 : fRec630[1]);
			float fTemp363 = fVec11[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec629[0])))) & 4194303];
			fRec327[0] = 0.33333334f * fTemp363 + fRec628[0] * (0.0f - 0.33333334f * (fTemp363 - fVec11[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec630[0])))) & 4194303]));
			float fThen25 = (((fRec638[1] == 1.0f) & (fConst11 != fRec640[1])) ? -0.0009765625f : 0.0f);
			float fThen27 = (((fRec638[1] == 0.0f) & (fConst11 != fRec639[1])) ? 0.0009765625f : fThen25);
			float fElse27 = (((fRec638[1] > 0.0f) & (fRec638[1] < 1.0f)) ? fRec637[1] : 0.0f);
			float fTemp364 = ((fRec637[1] != 0.0f) ? fElse27 : fThen27);
			fRec637[0] = fTemp364;
			fRec638[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec638[1] + fTemp364));
			fRec639[0] = (((fRec638[1] >= 1.0f) & (fRec640[1] != fConst11)) ? fConst11 : fRec639[1]);
			fRec640[0] = (((fRec638[1] <= 0.0f) & (fRec639[1] != fConst11)) ? fConst11 : fRec640[1]);
			float fTemp365 = fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec639[0])))) & 4194303];
			fRec636[0] = fTemp365 + fRec638[0] * (fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec640[0])))) & 4194303] - fTemp365);
			float fTemp366 = fRec25[0] * (fRec632[1] + fTemp6 * (fRec633[1] - fRec632[1]) + fTemp5);
			fVec12[0] = fTemp366 + fRec636[1];
			fRec635[0] = fRec636[1] + 0.995f * fRec635[1] + fTemp366 - fVec12[1];
			float fTemp367 = tanhf(fRec635[0] / fTemp1);
			float fTemp368 = fTemp0 * fTemp367;
			float fTemp369 = fTemp12 * (fTemp368 - fRec642[1]) + fRec641[1];
			fRec641[0] = 2.0f * (fTemp369 / fTemp13) - fRec641[1];
			fRec642[0] = fRec642[1] + 2.0f * (fTemp12 * fTemp369 / fTemp13);
			float fRec643 = fTemp369 * fTemp16 / fTemp13;
			float fTemp370 = fTemp18 * (fTemp368 - fRec645[1]) + fRec644[1];
			fRec644[0] = 2.0f * (fTemp370 / fTemp19) - fRec644[1];
			fRec645[0] = fRec645[1] + 2.0f * (fTemp18 * fTemp370 / fTemp19);
			float fRec646 = fTemp370 * fTemp21 / fTemp19;
			float fTemp371 = fTemp23 * (fTemp368 - fRec648[1]) + fRec647[1];
			fRec647[0] = 2.0f * (fTemp371 / fTemp24) - fRec647[1];
			fRec648[0] = fRec648[1] + 2.0f * (fTemp23 * fTemp371 / fTemp24);
			float fRec649 = fTemp371 * fTemp26 / fTemp24;
			float fTemp372 = fTemp28 * (fTemp368 - fRec651[1]) + fRec650[1];
			fRec650[0] = 2.0f * (fTemp372 / fTemp29) - fRec650[1];
			fRec651[0] = fRec651[1] + 2.0f * (fTemp28 * fTemp372 / fTemp29);
			float fRec652 = fTemp372 * fTemp31 / fTemp29;
			float fTemp373 = fTemp33 * (fTemp368 - fRec654[1]) + fRec653[1];
			fRec653[0] = 2.0f * (fTemp373 / fTemp34) - fRec653[1];
			fRec654[0] = fRec654[1] + 2.0f * (fTemp33 * fTemp373 / fTemp34);
			float fRec655 = fTemp373 * fTemp36 / fTemp34;
			float fTemp374 = fTemp38 * (fTemp368 - fRec657[1]) + fRec656[1];
			fRec656[0] = 2.0f * (fTemp374 / fTemp39) - fRec656[1];
			fRec657[0] = fRec657[1] + 2.0f * (fTemp38 * fTemp374 / fTemp39);
			float fRec658 = fTemp374 * fTemp41 / fTemp39;
			float fTemp375 = fTemp43 * (fTemp368 - fRec660[1]) + fRec659[1];
			fRec659[0] = 2.0f * (fTemp375 / fTemp44) - fRec659[1];
			fRec660[0] = fRec660[1] + 2.0f * (fTemp43 * fTemp375 / fTemp44);
			float fRec661 = fTemp375 * fTemp46 / fTemp44;
			float fTemp376 = fTemp48 * (fTemp368 - fRec663[1]) + fRec662[1];
			fRec662[0] = 2.0f * (fTemp376 / fTemp49) - fRec662[1];
			fRec663[0] = fRec663[1] + 2.0f * (fTemp48 * fTemp376 / fTemp49);
			float fRec664 = fTemp376 * fTemp51 / fTemp49;
			float fTemp377 = fTemp53 * (fTemp368 - fRec666[1]) + fRec665[1];
			fRec665[0] = 2.0f * (fTemp377 / fTemp54) - fRec665[1];
			fRec666[0] = fRec666[1] + 2.0f * (fTemp53 * fTemp377 / fTemp54);
			float fRec667 = fTemp377 * fTemp56 / fTemp54;
			float fTemp378 = fTemp58 * (fTemp368 - fRec669[1]) + fRec668[1];
			fRec668[0] = 2.0f * (fTemp378 / fTemp59) - fRec668[1];
			fRec669[0] = fRec669[1] + 2.0f * (fTemp58 * fTemp378 / fTemp59);
			float fRec670 = fTemp378 * fTemp61 / fTemp59;
			float fTemp379 = fTemp64 * (fTemp368 - fRec672[1]) + fRec671[1];
			fRec671[0] = 2.0f * (fTemp379 / fTemp65) - fRec671[1];
			fRec672[0] = fRec672[1] + 2.0f * (fTemp64 * fTemp379 / fTemp65);
			float fRec673 = fTemp379 * fTemp67 / fTemp65;
			float fTemp380 = fTemp69 * (fTemp368 - fRec675[1]) + fRec674[1];
			fRec674[0] = 2.0f * (fTemp380 / fTemp70) - fRec674[1];
			fRec675[0] = fRec675[1] + 2.0f * (fTemp69 * fTemp380 / fTemp70);
			float fRec676 = fTemp380 * fTemp72 / fTemp70;
			float fTemp381 = fTemp74 * (fTemp368 - fRec678[1]) + fRec677[1];
			fRec677[0] = 2.0f * (fTemp381 / fTemp75) - fRec677[1];
			fRec678[0] = fRec678[1] + 2.0f * (fTemp74 * fTemp381 / fTemp75);
			float fRec679 = fTemp381 * fTemp77 / fTemp75;
			float fTemp382 = fTemp79 * (fTemp368 - fRec681[1]) + fRec680[1];
			fRec680[0] = 2.0f * (fTemp382 / fTemp80) - fRec680[1];
			fRec681[0] = fRec681[1] + 2.0f * (fTemp79 * fTemp382 / fTemp80);
			float fRec682 = fTemp382 * fTemp82 / fTemp80;
			float fTemp383 = fTemp84 * (fTemp368 - fRec684[1]) + fRec683[1];
			fRec683[0] = 2.0f * (fTemp383 / fTemp85) - fRec683[1];
			fRec684[0] = fRec684[1] + 2.0f * (fTemp84 * fTemp383 / fTemp85);
			float fRec685 = fTemp383 * fTemp87 / fTemp85;
			float fTemp384 = fTemp89 * (fTemp368 - fRec687[1]) + fRec686[1];
			fRec686[0] = 2.0f * (fTemp384 / fTemp90) - fRec686[1];
			fRec687[0] = fRec687[1] + 2.0f * (fTemp89 * fTemp384 / fTemp90);
			float fRec688 = fTemp384 * fTemp92 / fTemp90;
			float fTemp385 = fTemp94 * (fTemp368 - fRec690[1]) + fRec689[1];
			float fTemp386 = fTemp385 / fTemp95;
			fRec689[0] = 2.0f * fTemp386 - fRec689[1];
			fRec690[0] = fRec690[1] + 2.0f * (fTemp94 * fTemp385 / fTemp95);
			float fRec691 = fTemp386;
			float fTemp387 = fTemp99 * (fTemp368 - fRec693[1]) + fRec692[1];
			fRec692[0] = 2.0f * (fTemp387 / fTemp100) - fRec692[1];
			fRec693[0] = fRec693[1] + 2.0f * (fTemp99 * fTemp387 / fTemp100);
			float fRec694 = fTemp387 * fTemp102 / fTemp100;
			float fTemp388 = fTemp104 * (fTemp368 - fRec696[1]) + fRec695[1];
			fRec695[0] = 2.0f * (fTemp388 / fTemp105) - fRec695[1];
			fRec696[0] = fRec696[1] + 2.0f * (fTemp104 * fTemp388 / fTemp105);
			float fRec697 = fTemp388 * fTemp107 / fTemp105;
			float fTemp389 = fTemp109 * (fTemp368 - fRec699[1]) + fRec698[1];
			fRec698[0] = 2.0f * (fTemp389 / fTemp110) - fRec698[1];
			fRec699[0] = fRec699[1] + 2.0f * (fTemp109 * fTemp389 / fTemp110);
			float fRec700 = fTemp389 * fTemp112 / fTemp110;
			float fTemp390 = fTemp114 * (fTemp368 - fRec702[1]) + fRec701[1];
			fRec701[0] = 2.0f * (fTemp390 / fTemp115) - fRec701[1];
			fRec702[0] = fRec702[1] + 2.0f * (fTemp114 * fTemp390 / fTemp115);
			float fRec703 = fTemp390 * fTemp117 / fTemp115;
			float fTemp391 = fTemp119 * (fTemp368 - fRec705[1]) + fRec704[1];
			fRec704[0] = 2.0f * (fTemp391 / fTemp120) - fRec704[1];
			fRec705[0] = fRec705[1] + 2.0f * (fTemp119 * fTemp391 / fTemp120);
			float fRec706 = fTemp391 * fTemp122 / fTemp120;
			float fTemp392 = fTemp124 * (fTemp368 - fRec708[1]) + fRec707[1];
			fRec707[0] = 2.0f * (fTemp392 / fTemp125) - fRec707[1];
			fRec708[0] = fRec708[1] + 2.0f * (fTemp124 * fTemp392 / fTemp125);
			float fRec709 = fTemp392 * fTemp127 / fTemp125;
			float fTemp393 = fTemp129 * (fTemp368 - fRec711[1]) + fRec710[1];
			fRec710[0] = 2.0f * (fTemp393 / fTemp130) - fRec710[1];
			fRec711[0] = fRec711[1] + 2.0f * (fTemp129 * fTemp393 / fTemp130);
			float fRec712 = fTemp393 * fTemp132 / fTemp130;
			float fTemp394 = fTemp134 * (fTemp368 - fRec714[1]) + fRec713[1];
			fRec713[0] = 2.0f * (fTemp394 / fTemp135) - fRec713[1];
			fRec714[0] = fRec714[1] + 2.0f * (fTemp134 * fTemp394 / fTemp135);
			float fRec715 = fTemp394 * fTemp137 / fTemp135;
			float fTemp395 = fTemp139 * (fTemp368 - fRec717[1]) + fRec716[1];
			fRec716[0] = 2.0f * (fTemp395 / fTemp140) - fRec716[1];
			fRec717[0] = fRec717[1] + 2.0f * (fTemp139 * fTemp395 / fTemp140);
			float fRec718 = fTemp395 * fTemp142 / fTemp140;
			float fTemp396 = fTemp144 * (fTemp368 - fRec720[1]) + fRec719[1];
			fRec719[0] = 2.0f * (fTemp396 / fTemp145) - fRec719[1];
			fRec720[0] = fRec720[1] + 2.0f * (fTemp144 * fTemp396 / fTemp145);
			float fRec721 = fTemp396 * fTemp147 / fTemp145;
			float fTemp397 = fTemp149 * (fTemp368 - fRec723[1]) + fRec722[1];
			fRec722[0] = 2.0f * (fTemp397 / fTemp150) - fRec722[1];
			fRec723[0] = fRec723[1] + 2.0f * (fTemp149 * fTemp397 / fTemp150);
			float fRec724 = fTemp397 * fTemp152 / fTemp150;
			float fTemp398 = fTemp154 * (fTemp368 - fRec726[1]) + fRec725[1];
			fRec725[0] = 2.0f * (fTemp398 / fTemp155) - fRec725[1];
			fRec726[0] = fRec726[1] + 2.0f * (fTemp154 * fTemp398 / fTemp155);
			float fRec727 = fTemp398 * fTemp157 / fTemp155;
			float fTemp399 = fTemp159 * (fTemp368 - fRec729[1]) + fRec728[1];
			fRec728[0] = 2.0f * (fTemp399 / fTemp160) - fRec728[1];
			fRec729[0] = fRec729[1] + 2.0f * (fTemp159 * fTemp399 / fTemp160);
			float fRec730 = fTemp399 * fTemp162 / fTemp160;
			float fTemp400 = fTemp164 * (fTemp368 - fRec732[1]) + fRec731[1];
			fRec731[0] = 2.0f * (fTemp400 / fTemp165) - fRec731[1];
			fRec732[0] = fRec732[1] + 2.0f * (fTemp164 * fTemp400 / fTemp165);
			float fRec733 = fTemp400 * fTemp167 / fTemp165;
			float fTemp401 = fTemp169 * (fTemp368 - fRec735[1]) + fRec734[1];
			fRec734[0] = 2.0f * (fTemp401 / fTemp170) - fRec734[1];
			fRec735[0] = fRec735[1] + 2.0f * (fTemp169 * fTemp401 / fTemp170);
			float fRec736 = fTemp401 * fTemp172 / fTemp170;
			fRec632[0] = 0.03125f * fTemp173 * (fRec736 + fRec733 + fRec730 + fRec727 + fRec724 + fRec721 + fRec718 + fRec715 + fRec712 + fRec709 + fRec706 + fRec703 + fRec700 + fRec697 + fRec694 + fRec691 + fRec688 + fRec685 + fRec682 + fRec679 + fRec676 + fRec673 + fRec670 + fRec667 + fRec664 + fRec661 + fRec658 + fRec655 + fRec652 + fRec649 + fRec646 + fRec643) + fTemp9 * fTemp367;
			float fTemp402 = fRec25[0] * (fRec633[1] + fRec23[0] * (fRec632[1] * (fRec128[0] - fRec634[1]) - fRec633[1]) + fTemp174);
			fVec13[0] = fRec636[1] + fTemp402;
			fRec737[0] = fTemp402 + fRec636[1] + 0.995f * fRec737[1] - fVec13[1];
			float fTemp403 = tanhf(fRec737[0] / fTemp1);
			float fTemp404 = fTemp0 * fTemp403;
			float fTemp405 = fTemp12 * (fTemp404 - fRec739[1]) + fRec738[1];
			fRec738[0] = 2.0f * (fTemp405 / fTemp13) - fRec738[1];
			fRec739[0] = fRec739[1] + 2.0f * (fTemp12 * fTemp405 / fTemp13);
			float fRec740 = fTemp16 * fTemp405 / fTemp13;
			float fTemp406 = fTemp18 * (fTemp404 - fRec742[1]) + fRec741[1];
			fRec741[0] = 2.0f * (fTemp406 / fTemp19) - fRec741[1];
			fRec742[0] = fRec742[1] + 2.0f * (fTemp18 * fTemp406 / fTemp19);
			float fRec743 = fTemp21 * fTemp406 / fTemp19;
			float fTemp407 = fTemp23 * (fTemp404 - fRec745[1]) + fRec744[1];
			fRec744[0] = 2.0f * (fTemp407 / fTemp24) - fRec744[1];
			fRec745[0] = fRec745[1] + 2.0f * (fTemp23 * fTemp407 / fTemp24);
			float fRec746 = fTemp26 * fTemp407 / fTemp24;
			float fTemp408 = fTemp28 * (fTemp404 - fRec748[1]) + fRec747[1];
			fRec747[0] = 2.0f * (fTemp408 / fTemp29) - fRec747[1];
			fRec748[0] = fRec748[1] + 2.0f * (fTemp28 * fTemp408 / fTemp29);
			float fRec749 = fTemp31 * fTemp408 / fTemp29;
			float fTemp409 = fTemp33 * (fTemp404 - fRec751[1]) + fRec750[1];
			fRec750[0] = 2.0f * (fTemp409 / fTemp34) - fRec750[1];
			fRec751[0] = fRec751[1] + 2.0f * (fTemp33 * fTemp409 / fTemp34);
			float fRec752 = fTemp36 * fTemp409 / fTemp34;
			float fTemp410 = fTemp38 * (fTemp404 - fRec754[1]) + fRec753[1];
			fRec753[0] = 2.0f * (fTemp410 / fTemp39) - fRec753[1];
			fRec754[0] = fRec754[1] + 2.0f * (fTemp38 * fTemp410 / fTemp39);
			float fRec755 = fTemp41 * fTemp410 / fTemp39;
			float fTemp411 = fTemp43 * (fTemp404 - fRec757[1]) + fRec756[1];
			fRec756[0] = 2.0f * (fTemp411 / fTemp44) - fRec756[1];
			fRec757[0] = fRec757[1] + 2.0f * (fTemp43 * fTemp411 / fTemp44);
			float fRec758 = fTemp46 * fTemp411 / fTemp44;
			float fTemp412 = fTemp48 * (fTemp404 - fRec760[1]) + fRec759[1];
			fRec759[0] = 2.0f * (fTemp412 / fTemp49) - fRec759[1];
			fRec760[0] = fRec760[1] + 2.0f * (fTemp48 * fTemp412 / fTemp49);
			float fRec761 = fTemp51 * fTemp412 / fTemp49;
			float fTemp413 = fTemp53 * (fTemp404 - fRec763[1]) + fRec762[1];
			fRec762[0] = 2.0f * (fTemp413 / fTemp54) - fRec762[1];
			fRec763[0] = fRec763[1] + 2.0f * (fTemp53 * fTemp413 / fTemp54);
			float fRec764 = fTemp56 * fTemp413 / fTemp54;
			float fTemp414 = fTemp58 * (fTemp404 - fRec766[1]) + fRec765[1];
			fRec765[0] = 2.0f * (fTemp414 / fTemp59) - fRec765[1];
			fRec766[0] = fRec766[1] + 2.0f * (fTemp58 * fTemp414 / fTemp59);
			float fRec767 = fTemp61 * fTemp414 / fTemp59;
			float fTemp415 = fTemp64 * (fTemp404 - fRec769[1]) + fRec768[1];
			fRec768[0] = 2.0f * (fTemp415 / fTemp65) - fRec768[1];
			fRec769[0] = fRec769[1] + 2.0f * (fTemp64 * fTemp415 / fTemp65);
			float fRec770 = fTemp67 * fTemp415 / fTemp65;
			float fTemp416 = fTemp69 * (fTemp404 - fRec772[1]) + fRec771[1];
			fRec771[0] = 2.0f * (fTemp416 / fTemp70) - fRec771[1];
			fRec772[0] = fRec772[1] + 2.0f * (fTemp69 * fTemp416 / fTemp70);
			float fRec773 = fTemp72 * fTemp416 / fTemp70;
			float fTemp417 = fTemp74 * (fTemp404 - fRec775[1]) + fRec774[1];
			fRec774[0] = 2.0f * (fTemp417 / fTemp75) - fRec774[1];
			fRec775[0] = fRec775[1] + 2.0f * (fTemp74 * fTemp417 / fTemp75);
			float fRec776 = fTemp77 * fTemp417 / fTemp75;
			float fTemp418 = fTemp79 * (fTemp404 - fRec778[1]) + fRec777[1];
			fRec777[0] = 2.0f * (fTemp418 / fTemp80) - fRec777[1];
			fRec778[0] = fRec778[1] + 2.0f * (fTemp79 * fTemp418 / fTemp80);
			float fRec779 = fTemp82 * fTemp418 / fTemp80;
			float fTemp419 = fTemp84 * (fTemp404 - fRec781[1]) + fRec780[1];
			fRec780[0] = 2.0f * (fTemp419 / fTemp85) - fRec780[1];
			fRec781[0] = fRec781[1] + 2.0f * (fTemp84 * fTemp419 / fTemp85);
			float fRec782 = fTemp87 * fTemp419 / fTemp85;
			float fTemp420 = fTemp89 * (fTemp404 - fRec784[1]) + fRec783[1];
			fRec783[0] = 2.0f * (fTemp420 / fTemp90) - fRec783[1];
			fRec784[0] = fRec784[1] + 2.0f * (fTemp89 * fTemp420 / fTemp90);
			float fRec785 = fTemp92 * fTemp420 / fTemp90;
			float fTemp421 = fTemp94 * (fTemp404 - fRec787[1]) + fRec786[1];
			float fTemp422 = fTemp421 / fTemp95;
			fRec786[0] = 2.0f * fTemp422 - fRec786[1];
			fRec787[0] = fRec787[1] + 2.0f * (fTemp94 * fTemp421 / fTemp95);
			float fRec788 = fTemp422;
			float fTemp423 = fTemp99 * (fTemp404 - fRec790[1]) + fRec789[1];
			fRec789[0] = 2.0f * (fTemp423 / fTemp100) - fRec789[1];
			fRec790[0] = fRec790[1] + 2.0f * (fTemp99 * fTemp423 / fTemp100);
			float fRec791 = fTemp102 * fTemp423 / fTemp100;
			float fTemp424 = fTemp104 * (fTemp404 - fRec793[1]) + fRec792[1];
			fRec792[0] = 2.0f * (fTemp424 / fTemp105) - fRec792[1];
			fRec793[0] = fRec793[1] + 2.0f * (fTemp104 * fTemp424 / fTemp105);
			float fRec794 = fTemp107 * fTemp424 / fTemp105;
			float fTemp425 = fTemp109 * (fTemp404 - fRec796[1]) + fRec795[1];
			fRec795[0] = 2.0f * (fTemp425 / fTemp110) - fRec795[1];
			fRec796[0] = fRec796[1] + 2.0f * (fTemp109 * fTemp425 / fTemp110);
			float fRec797 = fTemp112 * fTemp425 / fTemp110;
			float fTemp426 = fTemp114 * (fTemp404 - fRec799[1]) + fRec798[1];
			fRec798[0] = 2.0f * (fTemp426 / fTemp115) - fRec798[1];
			fRec799[0] = fRec799[1] + 2.0f * (fTemp114 * fTemp426 / fTemp115);
			float fRec800 = fTemp117 * fTemp426 / fTemp115;
			float fTemp427 = fTemp119 * (fTemp404 - fRec802[1]) + fRec801[1];
			fRec801[0] = 2.0f * (fTemp427 / fTemp120) - fRec801[1];
			fRec802[0] = fRec802[1] + 2.0f * (fTemp119 * fTemp427 / fTemp120);
			float fRec803 = fTemp122 * fTemp427 / fTemp120;
			float fTemp428 = fTemp124 * (fTemp404 - fRec805[1]) + fRec804[1];
			fRec804[0] = 2.0f * (fTemp428 / fTemp125) - fRec804[1];
			fRec805[0] = fRec805[1] + 2.0f * (fTemp124 * fTemp428 / fTemp125);
			float fRec806 = fTemp127 * fTemp428 / fTemp125;
			float fTemp429 = fTemp129 * (fTemp404 - fRec808[1]) + fRec807[1];
			fRec807[0] = 2.0f * (fTemp429 / fTemp130) - fRec807[1];
			fRec808[0] = fRec808[1] + 2.0f * (fTemp129 * fTemp429 / fTemp130);
			float fRec809 = fTemp132 * fTemp429 / fTemp130;
			float fTemp430 = fTemp134 * (fTemp404 - fRec811[1]) + fRec810[1];
			fRec810[0] = 2.0f * (fTemp430 / fTemp135) - fRec810[1];
			fRec811[0] = fRec811[1] + 2.0f * (fTemp134 * fTemp430 / fTemp135);
			float fRec812 = fTemp137 * fTemp430 / fTemp135;
			float fTemp431 = fTemp139 * (fTemp404 - fRec814[1]) + fRec813[1];
			fRec813[0] = 2.0f * (fTemp431 / fTemp140) - fRec813[1];
			fRec814[0] = fRec814[1] + 2.0f * (fTemp139 * fTemp431 / fTemp140);
			float fRec815 = fTemp142 * fTemp431 / fTemp140;
			float fTemp432 = fTemp144 * (fTemp404 - fRec817[1]) + fRec816[1];
			fRec816[0] = 2.0f * (fTemp432 / fTemp145) - fRec816[1];
			fRec817[0] = fRec817[1] + 2.0f * (fTemp144 * fTemp432 / fTemp145);
			float fRec818 = fTemp147 * fTemp432 / fTemp145;
			float fTemp433 = fTemp149 * (fTemp404 - fRec820[1]) + fRec819[1];
			fRec819[0] = 2.0f * (fTemp433 / fTemp150) - fRec819[1];
			fRec820[0] = fRec820[1] + 2.0f * (fTemp149 * fTemp433 / fTemp150);
			float fRec821 = fTemp152 * fTemp433 / fTemp150;
			float fTemp434 = fTemp154 * (fTemp404 - fRec823[1]) + fRec822[1];
			fRec822[0] = 2.0f * (fTemp434 / fTemp155) - fRec822[1];
			fRec823[0] = fRec823[1] + 2.0f * (fTemp154 * fTemp434 / fTemp155);
			float fRec824 = fTemp157 * fTemp434 / fTemp155;
			float fTemp435 = fTemp159 * (fTemp404 - fRec826[1]) + fRec825[1];
			fRec825[0] = 2.0f * (fTemp435 / fTemp160) - fRec825[1];
			fRec826[0] = fRec826[1] + 2.0f * (fTemp159 * fTemp435 / fTemp160);
			float fRec827 = fTemp162 * fTemp435 / fTemp160;
			float fTemp436 = fTemp164 * (fTemp404 - fRec829[1]) + fRec828[1];
			fRec828[0] = 2.0f * (fTemp436 / fTemp165) - fRec828[1];
			fRec829[0] = fRec829[1] + 2.0f * (fTemp164 * fTemp436 / fTemp165);
			float fRec830 = fTemp167 * fTemp436 / fTemp165;
			float fTemp437 = fTemp169 * (fTemp404 - fRec832[1]) + fRec831[1];
			fRec831[0] = 2.0f * (fTemp437 / fTemp170) - fRec831[1];
			fRec832[0] = fRec832[1] + 2.0f * (fTemp169 * fTemp437 / fTemp170);
			float fRec833 = fTemp172 * fTemp437 / fTemp170;
			fRec633[0] = 0.03125f * fTemp173 * (fRec833 + fRec830 + fRec827 + fRec824 + fRec821 + fRec818 + fRec815 + fRec812 + fRec809 + fRec806 + fRec803 + fRec800 + fRec797 + fRec794 + fRec791 + fRec788 + fRec785 + fRec782 + fRec779 + fRec776 + fRec773 + fRec770 + fRec767 + fRec764 + fRec761 + fRec758 + fRec755 + fRec752 + fRec749 + fRec746 + fRec743 + fRec740) + fTemp9 * fTemp403;
			float fTemp438 = fRec25[0] * (fRec634[1] + fRec23[0] * (fRec632[1] * fRec633[1] - fRec226[0] * fRec634[1]) + fTemp211);
			fVec14[0] = fRec636[1] + fTemp438;
			fRec834[0] = fTemp438 + fRec636[1] + 0.995f * fRec834[1] - fVec14[1];
			float fTemp439 = tanhf(fRec834[0] / fTemp1);
			float fTemp440 = fTemp0 * fTemp439;
			float fTemp441 = fTemp12 * (fTemp440 - fRec836[1]) + fRec835[1];
			fRec835[0] = 2.0f * (fTemp441 / fTemp13) - fRec835[1];
			fRec836[0] = fRec836[1] + 2.0f * (fTemp12 * fTemp441 / fTemp13);
			float fRec837 = fTemp16 * fTemp441 / fTemp13;
			float fTemp442 = fTemp18 * (fTemp440 - fRec839[1]) + fRec838[1];
			fRec838[0] = 2.0f * (fTemp442 / fTemp19) - fRec838[1];
			fRec839[0] = fRec839[1] + 2.0f * (fTemp18 * fTemp442 / fTemp19);
			float fRec840 = fTemp21 * fTemp442 / fTemp19;
			float fTemp443 = fTemp23 * (fTemp440 - fRec842[1]) + fRec841[1];
			fRec841[0] = 2.0f * (fTemp443 / fTemp24) - fRec841[1];
			fRec842[0] = fRec842[1] + 2.0f * (fTemp23 * fTemp443 / fTemp24);
			float fRec843 = fTemp26 * fTemp443 / fTemp24;
			float fTemp444 = fTemp28 * (fTemp440 - fRec845[1]) + fRec844[1];
			fRec844[0] = 2.0f * (fTemp444 / fTemp29) - fRec844[1];
			fRec845[0] = fRec845[1] + 2.0f * (fTemp28 * fTemp444 / fTemp29);
			float fRec846 = fTemp31 * fTemp444 / fTemp29;
			float fTemp445 = fTemp33 * (fTemp440 - fRec848[1]) + fRec847[1];
			fRec847[0] = 2.0f * (fTemp445 / fTemp34) - fRec847[1];
			fRec848[0] = fRec848[1] + 2.0f * (fTemp33 * fTemp445 / fTemp34);
			float fRec849 = fTemp36 * fTemp445 / fTemp34;
			float fTemp446 = fTemp38 * (fTemp440 - fRec851[1]) + fRec850[1];
			fRec850[0] = 2.0f * (fTemp446 / fTemp39) - fRec850[1];
			fRec851[0] = fRec851[1] + 2.0f * (fTemp38 * fTemp446 / fTemp39);
			float fRec852 = fTemp41 * fTemp446 / fTemp39;
			float fTemp447 = fTemp43 * (fTemp440 - fRec854[1]) + fRec853[1];
			fRec853[0] = 2.0f * (fTemp447 / fTemp44) - fRec853[1];
			fRec854[0] = fRec854[1] + 2.0f * (fTemp43 * fTemp447 / fTemp44);
			float fRec855 = fTemp46 * fTemp447 / fTemp44;
			float fTemp448 = fTemp48 * (fTemp440 - fRec857[1]) + fRec856[1];
			fRec856[0] = 2.0f * (fTemp448 / fTemp49) - fRec856[1];
			fRec857[0] = fRec857[1] + 2.0f * (fTemp48 * fTemp448 / fTemp49);
			float fRec858 = fTemp51 * fTemp448 / fTemp49;
			float fTemp449 = fTemp53 * (fTemp440 - fRec860[1]) + fRec859[1];
			fRec859[0] = 2.0f * (fTemp449 / fTemp54) - fRec859[1];
			fRec860[0] = fRec860[1] + 2.0f * (fTemp53 * fTemp449 / fTemp54);
			float fRec861 = fTemp56 * fTemp449 / fTemp54;
			float fTemp450 = fTemp58 * (fTemp440 - fRec863[1]) + fRec862[1];
			fRec862[0] = 2.0f * (fTemp450 / fTemp59) - fRec862[1];
			fRec863[0] = fRec863[1] + 2.0f * (fTemp58 * fTemp450 / fTemp59);
			float fRec864 = fTemp61 * fTemp450 / fTemp59;
			float fTemp451 = fTemp64 * (fTemp440 - fRec866[1]) + fRec865[1];
			fRec865[0] = 2.0f * (fTemp451 / fTemp65) - fRec865[1];
			fRec866[0] = fRec866[1] + 2.0f * (fTemp64 * fTemp451 / fTemp65);
			float fRec867 = fTemp67 * fTemp451 / fTemp65;
			float fTemp452 = fTemp69 * (fTemp440 - fRec869[1]) + fRec868[1];
			fRec868[0] = 2.0f * (fTemp452 / fTemp70) - fRec868[1];
			fRec869[0] = fRec869[1] + 2.0f * (fTemp69 * fTemp452 / fTemp70);
			float fRec870 = fTemp72 * fTemp452 / fTemp70;
			float fTemp453 = fTemp74 * (fTemp440 - fRec872[1]) + fRec871[1];
			fRec871[0] = 2.0f * (fTemp453 / fTemp75) - fRec871[1];
			fRec872[0] = fRec872[1] + 2.0f * (fTemp74 * fTemp453 / fTemp75);
			float fRec873 = fTemp77 * fTemp453 / fTemp75;
			float fTemp454 = fTemp79 * (fTemp440 - fRec875[1]) + fRec874[1];
			fRec874[0] = 2.0f * (fTemp454 / fTemp80) - fRec874[1];
			fRec875[0] = fRec875[1] + 2.0f * (fTemp79 * fTemp454 / fTemp80);
			float fRec876 = fTemp82 * fTemp454 / fTemp80;
			float fTemp455 = fTemp84 * (fTemp440 - fRec878[1]) + fRec877[1];
			fRec877[0] = 2.0f * (fTemp455 / fTemp85) - fRec877[1];
			fRec878[0] = fRec878[1] + 2.0f * (fTemp84 * fTemp455 / fTemp85);
			float fRec879 = fTemp87 * fTemp455 / fTemp85;
			float fTemp456 = fTemp89 * (fTemp440 - fRec881[1]) + fRec880[1];
			fRec880[0] = 2.0f * (fTemp456 / fTemp90) - fRec880[1];
			fRec881[0] = fRec881[1] + 2.0f * (fTemp89 * fTemp456 / fTemp90);
			float fRec882 = fTemp92 * fTemp456 / fTemp90;
			float fTemp457 = fTemp94 * (fTemp440 - fRec884[1]) + fRec883[1];
			float fTemp458 = fTemp457 / fTemp95;
			fRec883[0] = 2.0f * fTemp458 - fRec883[1];
			fRec884[0] = fRec884[1] + 2.0f * (fTemp94 * fTemp457 / fTemp95);
			float fRec885 = fTemp458;
			float fTemp459 = fTemp99 * (fTemp440 - fRec887[1]) + fRec886[1];
			fRec886[0] = 2.0f * (fTemp459 / fTemp100) - fRec886[1];
			fRec887[0] = fRec887[1] + 2.0f * (fTemp99 * fTemp459 / fTemp100);
			float fRec888 = fTemp102 * fTemp459 / fTemp100;
			float fTemp460 = fTemp104 * (fTemp440 - fRec890[1]) + fRec889[1];
			fRec889[0] = 2.0f * (fTemp460 / fTemp105) - fRec889[1];
			fRec890[0] = fRec890[1] + 2.0f * (fTemp104 * fTemp460 / fTemp105);
			float fRec891 = fTemp107 * fTemp460 / fTemp105;
			float fTemp461 = fTemp109 * (fTemp440 - fRec893[1]) + fRec892[1];
			fRec892[0] = 2.0f * (fTemp461 / fTemp110) - fRec892[1];
			fRec893[0] = fRec893[1] + 2.0f * (fTemp109 * fTemp461 / fTemp110);
			float fRec894 = fTemp112 * fTemp461 / fTemp110;
			float fTemp462 = fTemp114 * (fTemp440 - fRec896[1]) + fRec895[1];
			fRec895[0] = 2.0f * (fTemp462 / fTemp115) - fRec895[1];
			fRec896[0] = fRec896[1] + 2.0f * (fTemp114 * fTemp462 / fTemp115);
			float fRec897 = fTemp117 * fTemp462 / fTemp115;
			float fTemp463 = fTemp119 * (fTemp440 - fRec899[1]) + fRec898[1];
			fRec898[0] = 2.0f * (fTemp463 / fTemp120) - fRec898[1];
			fRec899[0] = fRec899[1] + 2.0f * (fTemp119 * fTemp463 / fTemp120);
			float fRec900 = fTemp122 * fTemp463 / fTemp120;
			float fTemp464 = fTemp124 * (fTemp440 - fRec902[1]) + fRec901[1];
			fRec901[0] = 2.0f * (fTemp464 / fTemp125) - fRec901[1];
			fRec902[0] = fRec902[1] + 2.0f * (fTemp124 * fTemp464 / fTemp125);
			float fRec903 = fTemp127 * fTemp464 / fTemp125;
			float fTemp465 = fTemp129 * (fTemp440 - fRec905[1]) + fRec904[1];
			fRec904[0] = 2.0f * (fTemp465 / fTemp130) - fRec904[1];
			fRec905[0] = fRec905[1] + 2.0f * (fTemp129 * fTemp465 / fTemp130);
			float fRec906 = fTemp132 * fTemp465 / fTemp130;
			float fTemp466 = fTemp134 * (fTemp440 - fRec908[1]) + fRec907[1];
			fRec907[0] = 2.0f * (fTemp466 / fTemp135) - fRec907[1];
			fRec908[0] = fRec908[1] + 2.0f * (fTemp134 * fTemp466 / fTemp135);
			float fRec909 = fTemp137 * fTemp466 / fTemp135;
			float fTemp467 = fTemp139 * (fTemp440 - fRec911[1]) + fRec910[1];
			fRec910[0] = 2.0f * (fTemp467 / fTemp140) - fRec910[1];
			fRec911[0] = fRec911[1] + 2.0f * (fTemp139 * fTemp467 / fTemp140);
			float fRec912 = fTemp142 * fTemp467 / fTemp140;
			float fTemp468 = fTemp144 * (fTemp440 - fRec914[1]) + fRec913[1];
			fRec913[0] = 2.0f * (fTemp468 / fTemp145) - fRec913[1];
			fRec914[0] = fRec914[1] + 2.0f * (fTemp144 * fTemp468 / fTemp145);
			float fRec915 = fTemp147 * fTemp468 / fTemp145;
			float fTemp469 = fTemp149 * (fTemp440 - fRec917[1]) + fRec916[1];
			fRec916[0] = 2.0f * (fTemp469 / fTemp150) - fRec916[1];
			fRec917[0] = fRec917[1] + 2.0f * (fTemp149 * fTemp469 / fTemp150);
			float fRec918 = fTemp152 * fTemp469 / fTemp150;
			float fTemp470 = fTemp154 * (fTemp440 - fRec920[1]) + fRec919[1];
			fRec919[0] = 2.0f * (fTemp470 / fTemp155) - fRec919[1];
			fRec920[0] = fRec920[1] + 2.0f * (fTemp154 * fTemp470 / fTemp155);
			float fRec921 = fTemp157 * fTemp470 / fTemp155;
			float fTemp471 = fTemp159 * (fTemp440 - fRec923[1]) + fRec922[1];
			fRec922[0] = 2.0f * (fTemp471 / fTemp160) - fRec922[1];
			fRec923[0] = fRec923[1] + 2.0f * (fTemp159 * fTemp471 / fTemp160);
			float fRec924 = fTemp162 * fTemp471 / fTemp160;
			float fTemp472 = fTemp164 * (fTemp440 - fRec926[1]) + fRec925[1];
			fRec925[0] = 2.0f * (fTemp472 / fTemp165) - fRec925[1];
			fRec926[0] = fRec926[1] + 2.0f * (fTemp164 * fTemp472 / fTemp165);
			float fRec927 = fTemp167 * fTemp472 / fTemp165;
			float fTemp473 = fTemp169 * (fTemp440 - fRec929[1]) + fRec928[1];
			fRec928[0] = 2.0f * (fTemp473 / fTemp170) - fRec928[1];
			fRec929[0] = fRec929[1] + 2.0f * (fTemp169 * fTemp473 / fTemp170);
			float fRec930 = fTemp172 * fTemp473 / fTemp170;
			fRec634[0] = 0.03125f * fTemp173 * (fRec930 + fRec927 + fRec924 + fRec921 + fRec918 + fRec915 + fRec912 + fRec909 + fRec906 + fRec903 + fRec900 + fRec897 + fRec894 + fRec891 + fRec888 + fRec885 + fRec882 + fRec879 + fRec876 + fRec873 + fRec870 + fRec867 + fRec864 + fRec861 + fRec858 + fRec855 + fRec852 + fRec849 + fRec846 + fRec843 + fRec840 + fRec837) + fTemp9 * fTemp439;
			float fTemp474 = (fRec634[0] + fRec632[0] + fRec633[0]) / fTemp0;
			fVec15[IOTA0 & 4194303] = fTemp474;
			float fThen31 = (((fRec932[1] == 1.0f) & (fConst12 != fRec934[1])) ? -0.0009765625f : 0.0f);
			float fThen33 = (((fRec932[1] == 0.0f) & (fConst12 != fRec933[1])) ? 0.0009765625f : fThen31);
			float fElse33 = (((fRec932[1] > 0.0f) & (fRec932[1] < 1.0f)) ? fRec931[1] : 0.0f);
			float fTemp475 = ((fRec931[1] != 0.0f) ? fElse33 : fThen33);
			fRec931[0] = fTemp475;
			fRec932[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec932[1] + fTemp475));
			fRec933[0] = (((fRec932[1] >= 1.0f) & (fRec934[1] != fConst12)) ? fConst12 : fRec933[1]);
			fRec934[0] = (((fRec932[1] <= 0.0f) & (fRec933[1] != fConst12)) ? fConst12 : fRec934[1]);
			float fTemp476 = fVec15[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec933[0])))) & 4194303];
			fRec631[0] = 0.33333334f * fTemp476 + fRec932[0] * (0.0f - 0.33333334f * (fTemp476 - fVec15[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec934[0])))) & 4194303]));
			float fThen37 = (((fRec942[1] == 1.0f) & (fConst13 != fRec944[1])) ? -0.0009765625f : 0.0f);
			float fThen39 = (((fRec942[1] == 0.0f) & (fConst13 != fRec943[1])) ? 0.0009765625f : fThen37);
			float fElse39 = (((fRec942[1] > 0.0f) & (fRec942[1] < 1.0f)) ? fRec941[1] : 0.0f);
			float fTemp477 = ((fRec941[1] != 0.0f) ? fElse39 : fThen39);
			fRec941[0] = fTemp477;
			fRec942[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec942[1] + fTemp477));
			fRec943[0] = (((fRec942[1] >= 1.0f) & (fRec944[1] != fConst13)) ? fConst13 : fRec943[1]);
			fRec944[0] = (((fRec942[1] <= 0.0f) & (fRec943[1] != fConst13)) ? fConst13 : fRec944[1]);
			float fTemp478 = fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec943[0])))) & 4194303];
			fRec940[0] = fTemp478 + fRec942[0] * (fVec0[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec944[0])))) & 4194303] - fTemp478);
			float fTemp479 = fRec25[0] * (fRec936[1] + fTemp6 * (fRec937[1] - fRec936[1]) + fTemp5);
			fVec16[0] = fTemp479 + fRec940[1];
			fRec939[0] = fRec940[1] + 0.995f * fRec939[1] + fTemp479 - fVec16[1];
			float fTemp480 = tanhf(fRec939[0] / fTemp1);
			float fTemp481 = fTemp0 * fTemp480;
			float fTemp482 = fTemp12 * (fTemp481 - fRec946[1]) + fRec945[1];
			fRec945[0] = 2.0f * (fTemp482 / fTemp13) - fRec945[1];
			fRec946[0] = fRec946[1] + 2.0f * (fTemp12 * fTemp482 / fTemp13);
			float fRec947 = fTemp16 * fTemp482 / fTemp13;
			float fTemp483 = fTemp18 * (fTemp481 - fRec949[1]) + fRec948[1];
			fRec948[0] = 2.0f * (fTemp483 / fTemp19) - fRec948[1];
			fRec949[0] = fRec949[1] + 2.0f * (fTemp18 * fTemp483 / fTemp19);
			float fRec950 = fTemp21 * fTemp483 / fTemp19;
			float fTemp484 = fTemp23 * (fTemp481 - fRec952[1]) + fRec951[1];
			fRec951[0] = 2.0f * (fTemp484 / fTemp24) - fRec951[1];
			fRec952[0] = fRec952[1] + 2.0f * (fTemp23 * fTemp484 / fTemp24);
			float fRec953 = fTemp26 * fTemp484 / fTemp24;
			float fTemp485 = fTemp28 * (fTemp481 - fRec955[1]) + fRec954[1];
			fRec954[0] = 2.0f * (fTemp485 / fTemp29) - fRec954[1];
			fRec955[0] = fRec955[1] + 2.0f * (fTemp28 * fTemp485 / fTemp29);
			float fRec956 = fTemp31 * fTemp485 / fTemp29;
			float fTemp486 = fTemp33 * (fTemp481 - fRec958[1]) + fRec957[1];
			fRec957[0] = 2.0f * (fTemp486 / fTemp34) - fRec957[1];
			fRec958[0] = fRec958[1] + 2.0f * (fTemp33 * fTemp486 / fTemp34);
			float fRec959 = fTemp36 * fTemp486 / fTemp34;
			float fTemp487 = fTemp38 * (fTemp481 - fRec961[1]) + fRec960[1];
			fRec960[0] = 2.0f * (fTemp487 / fTemp39) - fRec960[1];
			fRec961[0] = fRec961[1] + 2.0f * (fTemp38 * fTemp487 / fTemp39);
			float fRec962 = fTemp41 * fTemp487 / fTemp39;
			float fTemp488 = fTemp43 * (fTemp481 - fRec964[1]) + fRec963[1];
			fRec963[0] = 2.0f * (fTemp488 / fTemp44) - fRec963[1];
			fRec964[0] = fRec964[1] + 2.0f * (fTemp43 * fTemp488 / fTemp44);
			float fRec965 = fTemp46 * fTemp488 / fTemp44;
			float fTemp489 = fTemp48 * (fTemp481 - fRec967[1]) + fRec966[1];
			fRec966[0] = 2.0f * (fTemp489 / fTemp49) - fRec966[1];
			fRec967[0] = fRec967[1] + 2.0f * (fTemp48 * fTemp489 / fTemp49);
			float fRec968 = fTemp51 * fTemp489 / fTemp49;
			float fTemp490 = fTemp53 * (fTemp481 - fRec970[1]) + fRec969[1];
			fRec969[0] = 2.0f * (fTemp490 / fTemp54) - fRec969[1];
			fRec970[0] = fRec970[1] + 2.0f * (fTemp53 * fTemp490 / fTemp54);
			float fRec971 = fTemp56 * fTemp490 / fTemp54;
			float fTemp491 = fTemp58 * (fTemp481 - fRec973[1]) + fRec972[1];
			fRec972[0] = 2.0f * (fTemp491 / fTemp59) - fRec972[1];
			fRec973[0] = fRec973[1] + 2.0f * (fTemp58 * fTemp491 / fTemp59);
			float fRec974 = fTemp61 * fTemp491 / fTemp59;
			float fTemp492 = fTemp64 * (fTemp481 - fRec976[1]) + fRec975[1];
			fRec975[0] = 2.0f * (fTemp492 / fTemp65) - fRec975[1];
			fRec976[0] = fRec976[1] + 2.0f * (fTemp64 * fTemp492 / fTemp65);
			float fRec977 = fTemp67 * fTemp492 / fTemp65;
			float fTemp493 = fTemp69 * (fTemp481 - fRec979[1]) + fRec978[1];
			fRec978[0] = 2.0f * (fTemp493 / fTemp70) - fRec978[1];
			fRec979[0] = fRec979[1] + 2.0f * (fTemp69 * fTemp493 / fTemp70);
			float fRec980 = fTemp72 * fTemp493 / fTemp70;
			float fTemp494 = fTemp74 * (fTemp481 - fRec982[1]) + fRec981[1];
			fRec981[0] = 2.0f * (fTemp494 / fTemp75) - fRec981[1];
			fRec982[0] = fRec982[1] + 2.0f * (fTemp74 * fTemp494 / fTemp75);
			float fRec983 = fTemp77 * fTemp494 / fTemp75;
			float fTemp495 = fTemp79 * (fTemp481 - fRec985[1]) + fRec984[1];
			fRec984[0] = 2.0f * (fTemp495 / fTemp80) - fRec984[1];
			fRec985[0] = fRec985[1] + 2.0f * (fTemp79 * fTemp495 / fTemp80);
			float fRec986 = fTemp82 * fTemp495 / fTemp80;
			float fTemp496 = fTemp84 * (fTemp481 - fRec988[1]) + fRec987[1];
			fRec987[0] = 2.0f * (fTemp496 / fTemp85) - fRec987[1];
			fRec988[0] = fRec988[1] + 2.0f * (fTemp84 * fTemp496 / fTemp85);
			float fRec989 = fTemp87 * fTemp496 / fTemp85;
			float fTemp497 = fTemp89 * (fTemp481 - fRec991[1]) + fRec990[1];
			fRec990[0] = 2.0f * (fTemp497 / fTemp90) - fRec990[1];
			fRec991[0] = fRec991[1] + 2.0f * (fTemp89 * fTemp497 / fTemp90);
			float fRec992 = fTemp92 * fTemp497 / fTemp90;
			float fTemp498 = fTemp94 * (fTemp481 - fRec994[1]) + fRec993[1];
			float fTemp499 = fTemp498 / fTemp95;
			fRec993[0] = 2.0f * fTemp499 - fRec993[1];
			fRec994[0] = fRec994[1] + 2.0f * (fTemp94 * fTemp498 / fTemp95);
			float fRec995 = fTemp499;
			float fTemp500 = fTemp99 * (fTemp481 - fRec997[1]) + fRec996[1];
			fRec996[0] = 2.0f * (fTemp500 / fTemp100) - fRec996[1];
			fRec997[0] = fRec997[1] + 2.0f * (fTemp99 * fTemp500 / fTemp100);
			float fRec998 = fTemp102 * fTemp500 / fTemp100;
			float fTemp501 = fTemp104 * (fTemp481 - fRec1000[1]) + fRec999[1];
			fRec999[0] = 2.0f * (fTemp501 / fTemp105) - fRec999[1];
			fRec1000[0] = fRec1000[1] + 2.0f * (fTemp104 * fTemp501 / fTemp105);
			float fRec1001 = fTemp107 * fTemp501 / fTemp105;
			float fTemp502 = fTemp109 * (fTemp481 - fRec1003[1]) + fRec1002[1];
			fRec1002[0] = 2.0f * (fTemp502 / fTemp110) - fRec1002[1];
			fRec1003[0] = fRec1003[1] + 2.0f * (fTemp109 * fTemp502 / fTemp110);
			float fRec1004 = fTemp112 * fTemp502 / fTemp110;
			float fTemp503 = fTemp114 * (fTemp481 - fRec1006[1]) + fRec1005[1];
			fRec1005[0] = 2.0f * (fTemp503 / fTemp115) - fRec1005[1];
			fRec1006[0] = fRec1006[1] + 2.0f * (fTemp114 * fTemp503 / fTemp115);
			float fRec1007 = fTemp117 * fTemp503 / fTemp115;
			float fTemp504 = fTemp119 * (fTemp481 - fRec1009[1]) + fRec1008[1];
			fRec1008[0] = 2.0f * (fTemp504 / fTemp120) - fRec1008[1];
			fRec1009[0] = fRec1009[1] + 2.0f * (fTemp119 * fTemp504 / fTemp120);
			float fRec1010 = fTemp122 * fTemp504 / fTemp120;
			float fTemp505 = fTemp124 * (fTemp481 - fRec1012[1]) + fRec1011[1];
			fRec1011[0] = 2.0f * (fTemp505 / fTemp125) - fRec1011[1];
			fRec1012[0] = fRec1012[1] + 2.0f * (fTemp124 * fTemp505 / fTemp125);
			float fRec1013 = fTemp127 * fTemp505 / fTemp125;
			float fTemp506 = fTemp129 * (fTemp481 - fRec1015[1]) + fRec1014[1];
			fRec1014[0] = 2.0f * (fTemp506 / fTemp130) - fRec1014[1];
			fRec1015[0] = fRec1015[1] + 2.0f * (fTemp129 * fTemp506 / fTemp130);
			float fRec1016 = fTemp132 * fTemp506 / fTemp130;
			float fTemp507 = fTemp134 * (fTemp481 - fRec1018[1]) + fRec1017[1];
			fRec1017[0] = 2.0f * (fTemp507 / fTemp135) - fRec1017[1];
			fRec1018[0] = fRec1018[1] + 2.0f * (fTemp134 * fTemp507 / fTemp135);
			float fRec1019 = fTemp137 * fTemp507 / fTemp135;
			float fTemp508 = fTemp139 * (fTemp481 - fRec1021[1]) + fRec1020[1];
			fRec1020[0] = 2.0f * (fTemp508 / fTemp140) - fRec1020[1];
			fRec1021[0] = fRec1021[1] + 2.0f * (fTemp139 * fTemp508 / fTemp140);
			float fRec1022 = fTemp142 * fTemp508 / fTemp140;
			float fTemp509 = fTemp144 * (fTemp481 - fRec1024[1]) + fRec1023[1];
			fRec1023[0] = 2.0f * (fTemp509 / fTemp145) - fRec1023[1];
			fRec1024[0] = fRec1024[1] + 2.0f * (fTemp144 * fTemp509 / fTemp145);
			float fRec1025 = fTemp147 * fTemp509 / fTemp145;
			float fTemp510 = fTemp149 * (fTemp481 - fRec1027[1]) + fRec1026[1];
			fRec1026[0] = 2.0f * (fTemp510 / fTemp150) - fRec1026[1];
			fRec1027[0] = fRec1027[1] + 2.0f * (fTemp149 * fTemp510 / fTemp150);
			float fRec1028 = fTemp152 * fTemp510 / fTemp150;
			float fTemp511 = fTemp154 * (fTemp481 - fRec1030[1]) + fRec1029[1];
			fRec1029[0] = 2.0f * (fTemp511 / fTemp155) - fRec1029[1];
			fRec1030[0] = fRec1030[1] + 2.0f * (fTemp154 * fTemp511 / fTemp155);
			float fRec1031 = fTemp157 * fTemp511 / fTemp155;
			float fTemp512 = fTemp159 * (fTemp481 - fRec1033[1]) + fRec1032[1];
			fRec1032[0] = 2.0f * (fTemp512 / fTemp160) - fRec1032[1];
			fRec1033[0] = fRec1033[1] + 2.0f * (fTemp159 * fTemp512 / fTemp160);
			float fRec1034 = fTemp162 * fTemp512 / fTemp160;
			float fTemp513 = fTemp164 * (fTemp481 - fRec1036[1]) + fRec1035[1];
			fRec1035[0] = 2.0f * (fTemp513 / fTemp165) - fRec1035[1];
			fRec1036[0] = fRec1036[1] + 2.0f * (fTemp164 * fTemp513 / fTemp165);
			float fRec1037 = fTemp167 * fTemp513 / fTemp165;
			float fTemp514 = fTemp169 * (fTemp481 - fRec1039[1]) + fRec1038[1];
			fRec1038[0] = 2.0f * (fTemp514 / fTemp170) - fRec1038[1];
			fRec1039[0] = fRec1039[1] + 2.0f * (fTemp169 * fTemp514 / fTemp170);
			float fRec1040 = fTemp172 * fTemp514 / fTemp170;
			fRec936[0] = 0.03125f * fTemp173 * (fRec1040 + fRec1037 + fRec1034 + fRec1031 + fRec1028 + fRec1025 + fRec1022 + fRec1019 + fRec1016 + fRec1013 + fRec1010 + fRec1007 + fRec1004 + fRec1001 + fRec998 + fRec995 + fRec992 + fRec989 + fRec986 + fRec983 + fRec980 + fRec977 + fRec974 + fRec971 + fRec968 + fRec965 + fRec962 + fRec959 + fRec956 + fRec953 + fRec950 + fRec947) + fTemp9 * fTemp480;
			float fTemp515 = fRec25[0] * (fRec937[1] + fRec23[0] * (fRec936[1] * (fRec128[0] - fRec938[1]) - fRec937[1]) + fTemp174);
			fVec17[0] = fRec940[1] + fTemp515;
			fRec1041[0] = fTemp515 + fRec940[1] + 0.995f * fRec1041[1] - fVec17[1];
			float fTemp516 = tanhf(fRec1041[0] / fTemp1);
			float fTemp517 = fTemp0 * fTemp516;
			float fTemp518 = fTemp12 * (fTemp517 - fRec1043[1]) + fRec1042[1];
			fRec1042[0] = 2.0f * (fTemp518 / fTemp13) - fRec1042[1];
			fRec1043[0] = fRec1043[1] + 2.0f * (fTemp12 * fTemp518 / fTemp13);
			float fRec1044 = fTemp16 * fTemp518 / fTemp13;
			float fTemp519 = fTemp18 * (fTemp517 - fRec1046[1]) + fRec1045[1];
			fRec1045[0] = 2.0f * (fTemp519 / fTemp19) - fRec1045[1];
			fRec1046[0] = fRec1046[1] + 2.0f * (fTemp18 * fTemp519 / fTemp19);
			float fRec1047 = fTemp21 * fTemp519 / fTemp19;
			float fTemp520 = fTemp23 * (fTemp517 - fRec1049[1]) + fRec1048[1];
			fRec1048[0] = 2.0f * (fTemp520 / fTemp24) - fRec1048[1];
			fRec1049[0] = fRec1049[1] + 2.0f * (fTemp23 * fTemp520 / fTemp24);
			float fRec1050 = fTemp26 * fTemp520 / fTemp24;
			float fTemp521 = fTemp28 * (fTemp517 - fRec1052[1]) + fRec1051[1];
			fRec1051[0] = 2.0f * (fTemp521 / fTemp29) - fRec1051[1];
			fRec1052[0] = fRec1052[1] + 2.0f * (fTemp28 * fTemp521 / fTemp29);
			float fRec1053 = fTemp31 * fTemp521 / fTemp29;
			float fTemp522 = fTemp33 * (fTemp517 - fRec1055[1]) + fRec1054[1];
			fRec1054[0] = 2.0f * (fTemp522 / fTemp34) - fRec1054[1];
			fRec1055[0] = fRec1055[1] + 2.0f * (fTemp33 * fTemp522 / fTemp34);
			float fRec1056 = fTemp36 * fTemp522 / fTemp34;
			float fTemp523 = fTemp38 * (fTemp517 - fRec1058[1]) + fRec1057[1];
			fRec1057[0] = 2.0f * (fTemp523 / fTemp39) - fRec1057[1];
			fRec1058[0] = fRec1058[1] + 2.0f * (fTemp38 * fTemp523 / fTemp39);
			float fRec1059 = fTemp41 * fTemp523 / fTemp39;
			float fTemp524 = fTemp43 * (fTemp517 - fRec1061[1]) + fRec1060[1];
			fRec1060[0] = 2.0f * (fTemp524 / fTemp44) - fRec1060[1];
			fRec1061[0] = fRec1061[1] + 2.0f * (fTemp43 * fTemp524 / fTemp44);
			float fRec1062 = fTemp46 * fTemp524 / fTemp44;
			float fTemp525 = fTemp48 * (fTemp517 - fRec1064[1]) + fRec1063[1];
			fRec1063[0] = 2.0f * (fTemp525 / fTemp49) - fRec1063[1];
			fRec1064[0] = fRec1064[1] + 2.0f * (fTemp48 * fTemp525 / fTemp49);
			float fRec1065 = fTemp51 * fTemp525 / fTemp49;
			float fTemp526 = fTemp53 * (fTemp517 - fRec1067[1]) + fRec1066[1];
			fRec1066[0] = 2.0f * (fTemp526 / fTemp54) - fRec1066[1];
			fRec1067[0] = fRec1067[1] + 2.0f * (fTemp53 * fTemp526 / fTemp54);
			float fRec1068 = fTemp56 * fTemp526 / fTemp54;
			float fTemp527 = fTemp58 * (fTemp517 - fRec1070[1]) + fRec1069[1];
			fRec1069[0] = 2.0f * (fTemp527 / fTemp59) - fRec1069[1];
			fRec1070[0] = fRec1070[1] + 2.0f * (fTemp58 * fTemp527 / fTemp59);
			float fRec1071 = fTemp61 * fTemp527 / fTemp59;
			float fTemp528 = fTemp64 * (fTemp517 - fRec1073[1]) + fRec1072[1];
			fRec1072[0] = 2.0f * (fTemp528 / fTemp65) - fRec1072[1];
			fRec1073[0] = fRec1073[1] + 2.0f * (fTemp64 * fTemp528 / fTemp65);
			float fRec1074 = fTemp67 * fTemp528 / fTemp65;
			float fTemp529 = fTemp69 * (fTemp517 - fRec1076[1]) + fRec1075[1];
			fRec1075[0] = 2.0f * (fTemp529 / fTemp70) - fRec1075[1];
			fRec1076[0] = fRec1076[1] + 2.0f * (fTemp69 * fTemp529 / fTemp70);
			float fRec1077 = fTemp72 * fTemp529 / fTemp70;
			float fTemp530 = fTemp74 * (fTemp517 - fRec1079[1]) + fRec1078[1];
			fRec1078[0] = 2.0f * (fTemp530 / fTemp75) - fRec1078[1];
			fRec1079[0] = fRec1079[1] + 2.0f * (fTemp74 * fTemp530 / fTemp75);
			float fRec1080 = fTemp77 * fTemp530 / fTemp75;
			float fTemp531 = fTemp79 * (fTemp517 - fRec1082[1]) + fRec1081[1];
			fRec1081[0] = 2.0f * (fTemp531 / fTemp80) - fRec1081[1];
			fRec1082[0] = fRec1082[1] + 2.0f * (fTemp79 * fTemp531 / fTemp80);
			float fRec1083 = fTemp82 * fTemp531 / fTemp80;
			float fTemp532 = fTemp84 * (fTemp517 - fRec1085[1]) + fRec1084[1];
			fRec1084[0] = 2.0f * (fTemp532 / fTemp85) - fRec1084[1];
			fRec1085[0] = fRec1085[1] + 2.0f * (fTemp84 * fTemp532 / fTemp85);
			float fRec1086 = fTemp87 * fTemp532 / fTemp85;
			float fTemp533 = fTemp89 * (fTemp517 - fRec1088[1]) + fRec1087[1];
			fRec1087[0] = 2.0f * (fTemp533 / fTemp90) - fRec1087[1];
			fRec1088[0] = fRec1088[1] + 2.0f * (fTemp89 * fTemp533 / fTemp90);
			float fRec1089 = fTemp92 * fTemp533 / fTemp90;
			float fTemp534 = fTemp94 * (fTemp517 - fRec1091[1]) + fRec1090[1];
			float fTemp535 = fTemp534 / fTemp95;
			fRec1090[0] = 2.0f * fTemp535 - fRec1090[1];
			fRec1091[0] = fRec1091[1] + 2.0f * (fTemp94 * fTemp534 / fTemp95);
			float fRec1092 = fTemp535;
			float fTemp536 = fTemp99 * (fTemp517 - fRec1094[1]) + fRec1093[1];
			fRec1093[0] = 2.0f * (fTemp536 / fTemp100) - fRec1093[1];
			fRec1094[0] = fRec1094[1] + 2.0f * (fTemp99 * fTemp536 / fTemp100);
			float fRec1095 = fTemp102 * fTemp536 / fTemp100;
			float fTemp537 = fTemp104 * (fTemp517 - fRec1097[1]) + fRec1096[1];
			fRec1096[0] = 2.0f * (fTemp537 / fTemp105) - fRec1096[1];
			fRec1097[0] = fRec1097[1] + 2.0f * (fTemp104 * fTemp537 / fTemp105);
			float fRec1098 = fTemp107 * fTemp537 / fTemp105;
			float fTemp538 = fTemp109 * (fTemp517 - fRec1100[1]) + fRec1099[1];
			fRec1099[0] = 2.0f * (fTemp538 / fTemp110) - fRec1099[1];
			fRec1100[0] = fRec1100[1] + 2.0f * (fTemp109 * fTemp538 / fTemp110);
			float fRec1101 = fTemp112 * fTemp538 / fTemp110;
			float fTemp539 = fTemp114 * (fTemp517 - fRec1103[1]) + fRec1102[1];
			fRec1102[0] = 2.0f * (fTemp539 / fTemp115) - fRec1102[1];
			fRec1103[0] = fRec1103[1] + 2.0f * (fTemp114 * fTemp539 / fTemp115);
			float fRec1104 = fTemp117 * fTemp539 / fTemp115;
			float fTemp540 = fTemp119 * (fTemp517 - fRec1106[1]) + fRec1105[1];
			fRec1105[0] = 2.0f * (fTemp540 / fTemp120) - fRec1105[1];
			fRec1106[0] = fRec1106[1] + 2.0f * (fTemp119 * fTemp540 / fTemp120);
			float fRec1107 = fTemp122 * fTemp540 / fTemp120;
			float fTemp541 = fTemp124 * (fTemp517 - fRec1109[1]) + fRec1108[1];
			fRec1108[0] = 2.0f * (fTemp541 / fTemp125) - fRec1108[1];
			fRec1109[0] = fRec1109[1] + 2.0f * (fTemp124 * fTemp541 / fTemp125);
			float fRec1110 = fTemp127 * fTemp541 / fTemp125;
			float fTemp542 = fTemp129 * (fTemp517 - fRec1112[1]) + fRec1111[1];
			fRec1111[0] = 2.0f * (fTemp542 / fTemp130) - fRec1111[1];
			fRec1112[0] = fRec1112[1] + 2.0f * (fTemp129 * fTemp542 / fTemp130);
			float fRec1113 = fTemp132 * fTemp542 / fTemp130;
			float fTemp543 = fTemp134 * (fTemp517 - fRec1115[1]) + fRec1114[1];
			fRec1114[0] = 2.0f * (fTemp543 / fTemp135) - fRec1114[1];
			fRec1115[0] = fRec1115[1] + 2.0f * (fTemp134 * fTemp543 / fTemp135);
			float fRec1116 = fTemp137 * fTemp543 / fTemp135;
			float fTemp544 = fTemp139 * (fTemp517 - fRec1118[1]) + fRec1117[1];
			fRec1117[0] = 2.0f * (fTemp544 / fTemp140) - fRec1117[1];
			fRec1118[0] = fRec1118[1] + 2.0f * (fTemp139 * fTemp544 / fTemp140);
			float fRec1119 = fTemp142 * fTemp544 / fTemp140;
			float fTemp545 = fTemp144 * (fTemp517 - fRec1121[1]) + fRec1120[1];
			fRec1120[0] = 2.0f * (fTemp545 / fTemp145) - fRec1120[1];
			fRec1121[0] = fRec1121[1] + 2.0f * (fTemp144 * fTemp545 / fTemp145);
			float fRec1122 = fTemp147 * fTemp545 / fTemp145;
			float fTemp546 = fTemp149 * (fTemp517 - fRec1124[1]) + fRec1123[1];
			fRec1123[0] = 2.0f * (fTemp546 / fTemp150) - fRec1123[1];
			fRec1124[0] = fRec1124[1] + 2.0f * (fTemp149 * fTemp546 / fTemp150);
			float fRec1125 = fTemp152 * fTemp546 / fTemp150;
			float fTemp547 = fTemp154 * (fTemp517 - fRec1127[1]) + fRec1126[1];
			fRec1126[0] = 2.0f * (fTemp547 / fTemp155) - fRec1126[1];
			fRec1127[0] = fRec1127[1] + 2.0f * (fTemp154 * fTemp547 / fTemp155);
			float fRec1128 = fTemp157 * fTemp547 / fTemp155;
			float fTemp548 = fTemp159 * (fTemp517 - fRec1130[1]) + fRec1129[1];
			fRec1129[0] = 2.0f * (fTemp548 / fTemp160) - fRec1129[1];
			fRec1130[0] = fRec1130[1] + 2.0f * (fTemp159 * fTemp548 / fTemp160);
			float fRec1131 = fTemp162 * fTemp548 / fTemp160;
			float fTemp549 = fTemp164 * (fTemp517 - fRec1133[1]) + fRec1132[1];
			fRec1132[0] = 2.0f * (fTemp549 / fTemp165) - fRec1132[1];
			fRec1133[0] = fRec1133[1] + 2.0f * (fTemp164 * fTemp549 / fTemp165);
			float fRec1134 = fTemp167 * fTemp549 / fTemp165;
			float fTemp550 = fTemp169 * (fTemp517 - fRec1136[1]) + fRec1135[1];
			fRec1135[0] = 2.0f * (fTemp550 / fTemp170) - fRec1135[1];
			fRec1136[0] = fRec1136[1] + 2.0f * (fTemp169 * fTemp550 / fTemp170);
			float fRec1137 = fTemp172 * fTemp550 / fTemp170;
			fRec937[0] = 0.03125f * fTemp173 * (fRec1137 + fRec1134 + fRec1131 + fRec1128 + fRec1125 + fRec1122 + fRec1119 + fRec1116 + fRec1113 + fRec1110 + fRec1107 + fRec1104 + fRec1101 + fRec1098 + fRec1095 + fRec1092 + fRec1089 + fRec1086 + fRec1083 + fRec1080 + fRec1077 + fRec1074 + fRec1071 + fRec1068 + fRec1065 + fRec1062 + fRec1059 + fRec1056 + fRec1053 + fRec1050 + fRec1047 + fRec1044) + fTemp9 * fTemp516;
			float fTemp551 = fRec25[0] * (fRec938[1] + fRec23[0] * (fRec936[1] * fRec937[1] - fRec226[0] * fRec938[1]) + fTemp211);
			fVec18[0] = fRec940[1] + fTemp551;
			fRec1138[0] = fTemp551 + fRec940[1] + 0.995f * fRec1138[1] - fVec18[1];
			float fTemp552 = tanhf(fRec1138[0] / fTemp1);
			float fTemp553 = fTemp0 * fTemp552;
			float fTemp554 = fTemp12 * (fTemp553 - fRec1140[1]) + fRec1139[1];
			fRec1139[0] = 2.0f * (fTemp554 / fTemp13) - fRec1139[1];
			fRec1140[0] = fRec1140[1] + 2.0f * (fTemp12 * fTemp554 / fTemp13);
			float fRec1141 = fTemp16 * fTemp554 / fTemp13;
			float fTemp555 = fTemp18 * (fTemp553 - fRec1143[1]) + fRec1142[1];
			fRec1142[0] = 2.0f * (fTemp555 / fTemp19) - fRec1142[1];
			fRec1143[0] = fRec1143[1] + 2.0f * (fTemp18 * fTemp555 / fTemp19);
			float fRec1144 = fTemp21 * fTemp555 / fTemp19;
			float fTemp556 = fTemp23 * (fTemp553 - fRec1146[1]) + fRec1145[1];
			fRec1145[0] = 2.0f * (fTemp556 / fTemp24) - fRec1145[1];
			fRec1146[0] = fRec1146[1] + 2.0f * (fTemp23 * fTemp556 / fTemp24);
			float fRec1147 = fTemp26 * fTemp556 / fTemp24;
			float fTemp557 = fTemp28 * (fTemp553 - fRec1149[1]) + fRec1148[1];
			fRec1148[0] = 2.0f * (fTemp557 / fTemp29) - fRec1148[1];
			fRec1149[0] = fRec1149[1] + 2.0f * (fTemp28 * fTemp557 / fTemp29);
			float fRec1150 = fTemp31 * fTemp557 / fTemp29;
			float fTemp558 = fTemp33 * (fTemp553 - fRec1152[1]) + fRec1151[1];
			fRec1151[0] = 2.0f * (fTemp558 / fTemp34) - fRec1151[1];
			fRec1152[0] = fRec1152[1] + 2.0f * (fTemp33 * fTemp558 / fTemp34);
			float fRec1153 = fTemp36 * fTemp558 / fTemp34;
			float fTemp559 = fTemp38 * (fTemp553 - fRec1155[1]) + fRec1154[1];
			fRec1154[0] = 2.0f * (fTemp559 / fTemp39) - fRec1154[1];
			fRec1155[0] = fRec1155[1] + 2.0f * (fTemp38 * fTemp559 / fTemp39);
			float fRec1156 = fTemp41 * fTemp559 / fTemp39;
			float fTemp560 = fTemp43 * (fTemp553 - fRec1158[1]) + fRec1157[1];
			fRec1157[0] = 2.0f * (fTemp560 / fTemp44) - fRec1157[1];
			fRec1158[0] = fRec1158[1] + 2.0f * (fTemp43 * fTemp560 / fTemp44);
			float fRec1159 = fTemp46 * fTemp560 / fTemp44;
			float fTemp561 = fTemp48 * (fTemp553 - fRec1161[1]) + fRec1160[1];
			fRec1160[0] = 2.0f * (fTemp561 / fTemp49) - fRec1160[1];
			fRec1161[0] = fRec1161[1] + 2.0f * (fTemp48 * fTemp561 / fTemp49);
			float fRec1162 = fTemp51 * fTemp561 / fTemp49;
			float fTemp562 = fTemp53 * (fTemp553 - fRec1164[1]) + fRec1163[1];
			fRec1163[0] = 2.0f * (fTemp562 / fTemp54) - fRec1163[1];
			fRec1164[0] = fRec1164[1] + 2.0f * (fTemp53 * fTemp562 / fTemp54);
			float fRec1165 = fTemp56 * fTemp562 / fTemp54;
			float fTemp563 = fTemp58 * (fTemp553 - fRec1167[1]) + fRec1166[1];
			fRec1166[0] = 2.0f * (fTemp563 / fTemp59) - fRec1166[1];
			fRec1167[0] = fRec1167[1] + 2.0f * (fTemp58 * fTemp563 / fTemp59);
			float fRec1168 = fTemp61 * fTemp563 / fTemp59;
			float fTemp564 = fTemp64 * (fTemp553 - fRec1170[1]) + fRec1169[1];
			fRec1169[0] = 2.0f * (fTemp564 / fTemp65) - fRec1169[1];
			fRec1170[0] = fRec1170[1] + 2.0f * (fTemp64 * fTemp564 / fTemp65);
			float fRec1171 = fTemp67 * fTemp564 / fTemp65;
			float fTemp565 = fTemp69 * (fTemp553 - fRec1173[1]) + fRec1172[1];
			fRec1172[0] = 2.0f * (fTemp565 / fTemp70) - fRec1172[1];
			fRec1173[0] = fRec1173[1] + 2.0f * (fTemp69 * fTemp565 / fTemp70);
			float fRec1174 = fTemp72 * fTemp565 / fTemp70;
			float fTemp566 = fTemp74 * (fTemp553 - fRec1176[1]) + fRec1175[1];
			fRec1175[0] = 2.0f * (fTemp566 / fTemp75) - fRec1175[1];
			fRec1176[0] = fRec1176[1] + 2.0f * (fTemp74 * fTemp566 / fTemp75);
			float fRec1177 = fTemp77 * fTemp566 / fTemp75;
			float fTemp567 = fTemp79 * (fTemp553 - fRec1179[1]) + fRec1178[1];
			fRec1178[0] = 2.0f * (fTemp567 / fTemp80) - fRec1178[1];
			fRec1179[0] = fRec1179[1] + 2.0f * (fTemp79 * fTemp567 / fTemp80);
			float fRec1180 = fTemp82 * fTemp567 / fTemp80;
			float fTemp568 = fTemp84 * (fTemp553 - fRec1182[1]) + fRec1181[1];
			fRec1181[0] = 2.0f * (fTemp568 / fTemp85) - fRec1181[1];
			fRec1182[0] = fRec1182[1] + 2.0f * (fTemp84 * fTemp568 / fTemp85);
			float fRec1183 = fTemp87 * fTemp568 / fTemp85;
			float fTemp569 = fTemp89 * (fTemp553 - fRec1185[1]) + fRec1184[1];
			fRec1184[0] = 2.0f * (fTemp569 / fTemp90) - fRec1184[1];
			fRec1185[0] = fRec1185[1] + 2.0f * (fTemp89 * fTemp569 / fTemp90);
			float fRec1186 = fTemp92 * fTemp569 / fTemp90;
			float fTemp570 = fTemp94 * (fTemp553 - fRec1188[1]) + fRec1187[1];
			float fTemp571 = fTemp570 / fTemp95;
			fRec1187[0] = 2.0f * fTemp571 - fRec1187[1];
			fRec1188[0] = fRec1188[1] + 2.0f * (fTemp94 * fTemp570 / fTemp95);
			float fRec1189 = fTemp571;
			float fTemp572 = fTemp99 * (fTemp553 - fRec1191[1]) + fRec1190[1];
			fRec1190[0] = 2.0f * (fTemp572 / fTemp100) - fRec1190[1];
			fRec1191[0] = fRec1191[1] + 2.0f * (fTemp99 * fTemp572 / fTemp100);
			float fRec1192 = fTemp102 * fTemp572 / fTemp100;
			float fTemp573 = fTemp104 * (fTemp553 - fRec1194[1]) + fRec1193[1];
			fRec1193[0] = 2.0f * (fTemp573 / fTemp105) - fRec1193[1];
			fRec1194[0] = fRec1194[1] + 2.0f * (fTemp104 * fTemp573 / fTemp105);
			float fRec1195 = fTemp107 * fTemp573 / fTemp105;
			float fTemp574 = fTemp109 * (fTemp553 - fRec1197[1]) + fRec1196[1];
			fRec1196[0] = 2.0f * (fTemp574 / fTemp110) - fRec1196[1];
			fRec1197[0] = fRec1197[1] + 2.0f * (fTemp109 * fTemp574 / fTemp110);
			float fRec1198 = fTemp112 * fTemp574 / fTemp110;
			float fTemp575 = fTemp114 * (fTemp553 - fRec1200[1]) + fRec1199[1];
			fRec1199[0] = 2.0f * (fTemp575 / fTemp115) - fRec1199[1];
			fRec1200[0] = fRec1200[1] + 2.0f * (fTemp114 * fTemp575 / fTemp115);
			float fRec1201 = fTemp117 * fTemp575 / fTemp115;
			float fTemp576 = fTemp119 * (fTemp553 - fRec1203[1]) + fRec1202[1];
			fRec1202[0] = 2.0f * (fTemp576 / fTemp120) - fRec1202[1];
			fRec1203[0] = fRec1203[1] + 2.0f * (fTemp119 * fTemp576 / fTemp120);
			float fRec1204 = fTemp122 * fTemp576 / fTemp120;
			float fTemp577 = fTemp124 * (fTemp553 - fRec1206[1]) + fRec1205[1];
			fRec1205[0] = 2.0f * (fTemp577 / fTemp125) - fRec1205[1];
			fRec1206[0] = fRec1206[1] + 2.0f * (fTemp124 * fTemp577 / fTemp125);
			float fRec1207 = fTemp127 * fTemp577 / fTemp125;
			float fTemp578 = fTemp129 * (fTemp553 - fRec1209[1]) + fRec1208[1];
			fRec1208[0] = 2.0f * (fTemp578 / fTemp130) - fRec1208[1];
			fRec1209[0] = fRec1209[1] + 2.0f * (fTemp129 * fTemp578 / fTemp130);
			float fRec1210 = fTemp132 * fTemp578 / fTemp130;
			float fTemp579 = fTemp134 * (fTemp553 - fRec1212[1]) + fRec1211[1];
			fRec1211[0] = 2.0f * (fTemp579 / fTemp135) - fRec1211[1];
			fRec1212[0] = fRec1212[1] + 2.0f * (fTemp134 * fTemp579 / fTemp135);
			float fRec1213 = fTemp137 * fTemp579 / fTemp135;
			float fTemp580 = fTemp139 * (fTemp553 - fRec1215[1]) + fRec1214[1];
			fRec1214[0] = 2.0f * (fTemp580 / fTemp140) - fRec1214[1];
			fRec1215[0] = fRec1215[1] + 2.0f * (fTemp139 * fTemp580 / fTemp140);
			float fRec1216 = fTemp142 * fTemp580 / fTemp140;
			float fTemp581 = fTemp144 * (fTemp553 - fRec1218[1]) + fRec1217[1];
			fRec1217[0] = 2.0f * (fTemp581 / fTemp145) - fRec1217[1];
			fRec1218[0] = fRec1218[1] + 2.0f * (fTemp144 * fTemp581 / fTemp145);
			float fRec1219 = fTemp147 * fTemp581 / fTemp145;
			float fTemp582 = fTemp149 * (fTemp553 - fRec1221[1]) + fRec1220[1];
			fRec1220[0] = 2.0f * (fTemp582 / fTemp150) - fRec1220[1];
			fRec1221[0] = fRec1221[1] + 2.0f * (fTemp149 * fTemp582 / fTemp150);
			float fRec1222 = fTemp152 * fTemp582 / fTemp150;
			float fTemp583 = fTemp154 * (fTemp553 - fRec1224[1]) + fRec1223[1];
			fRec1223[0] = 2.0f * (fTemp583 / fTemp155) - fRec1223[1];
			fRec1224[0] = fRec1224[1] + 2.0f * (fTemp154 * fTemp583 / fTemp155);
			float fRec1225 = fTemp157 * fTemp583 / fTemp155;
			float fTemp584 = fTemp159 * (fTemp553 - fRec1227[1]) + fRec1226[1];
			fRec1226[0] = 2.0f * (fTemp584 / fTemp160) - fRec1226[1];
			fRec1227[0] = fRec1227[1] + 2.0f * (fTemp159 * fTemp584 / fTemp160);
			float fRec1228 = fTemp162 * fTemp584 / fTemp160;
			float fTemp585 = fTemp164 * (fTemp553 - fRec1230[1]) + fRec1229[1];
			fRec1229[0] = 2.0f * (fTemp585 / fTemp165) - fRec1229[1];
			fRec1230[0] = fRec1230[1] + 2.0f * (fTemp164 * fTemp585 / fTemp165);
			float fRec1231 = fTemp167 * fTemp585 / fTemp165;
			float fTemp586 = fTemp169 * (fTemp553 - fRec1233[1]) + fRec1232[1];
			fRec1232[0] = 2.0f * (fTemp586 / fTemp170) - fRec1232[1];
			fRec1233[0] = fRec1233[1] + 2.0f * (fTemp169 * fTemp586 / fTemp170);
			float fRec1234 = fTemp172 * fTemp586 / fTemp170;
			fRec938[0] = 0.03125f * fTemp173 * (fRec1234 + fRec1231 + fRec1228 + fRec1225 + fRec1222 + fRec1219 + fRec1216 + fRec1213 + fRec1210 + fRec1207 + fRec1204 + fRec1201 + fRec1198 + fRec1195 + fRec1192 + fRec1189 + fRec1186 + fRec1183 + fRec1180 + fRec1177 + fRec1174 + fRec1171 + fRec1168 + fRec1165 + fRec1162 + fRec1159 + fRec1156 + fRec1153 + fRec1150 + fRec1147 + fRec1144 + fRec1141) + fTemp9 * fTemp552;
			float fTemp587 = (fRec938[0] + fRec936[0] + fRec937[0]) / fTemp0;
			fVec19[IOTA0 & 4194303] = fTemp587;
			float fThen43 = (((fRec1236[1] == 1.0f) & (fConst14 != fRec1238[1])) ? -0.0009765625f : 0.0f);
			float fThen45 = (((fRec1236[1] == 0.0f) & (fConst14 != fRec1237[1])) ? 0.0009765625f : fThen43);
			float fElse45 = (((fRec1236[1] > 0.0f) & (fRec1236[1] < 1.0f)) ? fRec1235[1] : 0.0f);
			float fTemp588 = ((fRec1235[1] != 0.0f) ? fElse45 : fThen45);
			fRec1235[0] = fTemp588;
			fRec1236[0] = std::max<float>(0.0f, std::min<float>(1.0f, fRec1236[1] + fTemp588));
			fRec1237[0] = (((fRec1236[1] >= 1.0f) & (fRec1238[1] != fConst14)) ? fConst14 : fRec1237[1]);
			fRec1238[0] = (((fRec1236[1] <= 0.0f) & (fRec1237[1] != fConst14)) ? fConst14 : fRec1238[1]);
			float fTemp589 = fVec19[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec1237[0])))) & 4194303];
			fRec935[0] = 0.33333334f * fTemp589 + fRec1236[0] * (0.0f - 0.33333334f * (fTemp589 - fVec19[(IOTA0 - int(std::min<float>(fConst5, std::max<float>(0.0f, fRec1238[0])))) & 4194303]));
			fRec5[0] = 0.25f * (fRec935[1] + fRec631[1] + fRec327[1] + fRec10[1]);
			fRec6[IOTA0 & 511] = fRec631[1];
			fRec7[IOTA0 & 511] = fRec10[1];
			fRec8[IOTA0 & 511] = fRec327[1];
			fRec9[IOTA0 & 511] = fRec935[1];
			float fTemp590 = std::fabs(fRec6[IOTA0 & 511]);
			int iTemp591 = (fTemp590 >= fRec4[1]) | (float(iRec3[1]) >= fConst2);
			int iThen48 = iRec3[1] + 1;
			iRec3[0] = ((iTemp591) ? 0 : iThen48);
			fRec4[0] = ((iTemp591) ? fTemp590 : fRec4[1]);
			float fTemp592 = fRec4[0] - fRec1[1];
			fRec1[0] = fRec1[1] + fConst17 * fTemp592;
			float fTemp593 = fRec1[1] + fConst16 * fTemp592;
			float fRec2 = fTemp593;
			...
			float fTemp594 = std::fabs(fRec7[IOTA0 & 511]);
			int iTemp595 = (fTemp594 >= fRec1244[1]) | (float(iRec1243[1]) >= fConst2);
			int iThen50 = iRec1243[1] + 1;
			iRec1243[0] = ((iTemp595) ? 0 : iThen50);
			fRec1244[0] = ((iTemp595) ? fTemp594 : fRec1244[1]);
			float fTemp596 = fRec1244[0] - fRec1241[1];
			fRec1241[0] = fRec1241[1] + fConst17 * fTemp596;
			float fTemp597 = fRec1241[1] + fConst16 * fTemp596;
			float fRec1242 = fTemp597;
			fRec1240[0] = std::max<float>(fConst1 * fRec1240[1], std::fabs(fRec1242));
			output1[i0] = FAUSTFLOAT(fRec1239[0] * fRec7[(IOTA0 - iConst18) & 511] / fRec1240[0]);
			float fTemp598 = std::fabs(fRec8[IOTA0 & 511]);
			int iTemp599 = (fTemp598 >= fRec1249[1]) | (float(iRec1248[1]) >= fConst2);
			int iThen52 = iRec1248[1] + 1;
			iRec1248[0] = ((iTemp599) ? 0 : iThen52);
			fRec1249[0] = ((iTemp599) ? fTemp598 : fRec1249[1]);
			float fTemp600 = fRec1249[0] - fRec1246[1];
			fRec1246[0] = fRec1246[1] + fConst17 * fTemp600;
			float fTemp601 = fRec1246[1] + fConst16 * fTemp600;
			float fRec1247 = fTemp601;
			fRec1245[0] = std::max<float>(fConst1 * fRec1245[1], std::fabs(fRec1247));
			output2[i0] = FAUSTFLOAT(fRec1239[0] * fRec8[(IOTA0 - iConst18) & 511] / fRec1245[0]);
			float fTemp602 = std::fabs(fRec9[IOTA0 & 511]);
			int iTemp603 = (fTemp602 >= fRec1254[1]) | (float(iRec1253[1]) >= fConst2);
			int iThen54 = iRec1253[1] + 1;
			iRec1253[0] = ((iTemp603) ? 0 : iThen54);
			fRec1254[0] = ((iTemp603) ? fTemp602 : fRec1254[1]);
			float fTemp604 = fRec1254[0] - fRec1251[1];
			fRec1251[0] = fRec1251[1] + fConst17 * fTemp604;
			float fTemp605 = fRec1251[1] + fConst16 * fTemp604;
			float fRec1252 = fTemp605;
			fRec1250[0] = std::max<float>(fConst1 * fRec1250[1], std::fabs(fRec1252));
	...
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Amplificators [2]/Lorenz FB", fVslider5, 0.0f, -1.0f, 1.0f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Amplificators [2]/Lorenz Tan", fVslider0, 0.0f, 0.0f, 1e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Amplificators [2]/Network FB", fVslider2, 0.0f, -1.0f, 1.0f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/BP Bypass", fVslider6, 0.0f, 0.0f, 0.1f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Bandwidth", fVslider10, 1.0f, 1.0f, 1e+02f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Frequency", fVslider9, 0.0f, -1.0f, 1.0f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Interpolations 1", fVslider7, 1.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Bandpass Filters Bank [1]/Interpolations 2", fVslider8, 1.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Input/Output [3]/External Sum", fVslider1, 0.0f, 0.0f, 1e+02f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Input/Output [3]/Master", fVslider13, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Beta", fVslider12, 0.1f, 0.0f, 1e+01f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Dt", fVslider3, 0.62f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Rho", fVslider11, 0.01f, 0.0f, 0.1f, 0.001f);
	FAUST_ADDVERTICALSLIDER("RITI Mixer/Lorenz Equation Parameters[0]/Sigma", fVslider4, 8.2f, 0.0f, 1e+02f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, Lorenz_FB, "RITI Mixer/Amplificators [2]/Lorenz FB", fVslider5, 0.0f, -1.0f, 1.0f, 0.001f) \
		p(VERTICALSLIDER, Lorenz_Tan, "RITI Mixer/Amplificators [2]/Lorenz Tan", fVslider0, 0.0f, 0.0f, 1e+01f, 0.001f) \
		p(VERTICALSLIDER, Network_FB, "RITI Mixer/Amplificators [2]/Network FB", fVslider2, 0.0f, -1.0f, 1.0f, 0.001f) \
		p(VERTICALSLIDER, BP_Bypass, "RITI Mixer/Bandpass Filters Bank [1]/BP Bypass", fVslider6, 0.0f, 0.0f, 0.1f, 0.001f) \
		p(VERTICALSLIDER, Bandwidth, "RITI Mixer/Bandpass Filters Bank [1]/Bandwidth", fVslider10, 1.0f, 1.0f, 1e+02f, 0.001f) \
		p(VERTICALSLIDER, Frequency, "RITI Mixer/Bandpass Filters Bank [1]/Frequency", fVslider9, 0.0f, -1.0f, 1.0f, 0.001f) \
		p(VERTICALSLIDER, Interpolations_1, "RITI Mixer/Bandpass Filters Bank [1]/Interpolations 1", fVslider7, 1.0f, 0.0f, 1.0f, 0.001f) \
		p(VERTICALSLIDER, Interpolations_2, "RITI Mixer/Bandpass Filters Bank [1]/Interpolations 2", fVslider8, 1.0f, 0.0f, 1.0f, 0.001f) \
		p(VERTICALSLIDER, External_Sum, "RITI Mixer/Input/Output [3]/External Sum", fVslider1, 0.0f, 0.0f, 1e+02f, 0.001f) \
		p(VERTICALSLIDER, Master, "RITI Mixer/Input/Output [3]/Master", fVslider13, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(VERTICALSLIDER, Beta, "RITI Mixer/Lorenz Equation Parameters[0]/Beta", fVslider12, 0.1f, 0.0f, 1e+01f, 0.001f) \
		p(VERTICALSLIDER, Dt, "RITI Mixer/Lorenz Equation Parameters[0]/Dt", fVslider3, 0.62f, 0.0f, 1.0f, 0.001f) \
		p(VERTICALSLIDER, Rho, "RITI Mixer/Lorenz Equation Parameters[0]/Rho", fVslider11, 0.01f, 0.0f, 0.1f, 0.001f) \
		p(VERTICALSLIDER, Sigma, "RITI Mixer/Lorenz Equation Parameters[0]/Sigma", fVslider4, 8.2f, 0.0f, 1e+02f, 0.001f) \

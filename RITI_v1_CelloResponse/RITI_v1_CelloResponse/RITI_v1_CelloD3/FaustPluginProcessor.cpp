...
class mydsp : public base_dsp {
 ...
 public:
	...
	virtual void instanceClear() {
		...
		for (int l473 = 0; l473 < 4194304; l473 = l473 + 1) {
			fVec13[l473] = 0.0;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider23, "unit", "Hz");
		ui_interface->addVerticalSlider("Frequency", &fVslider23, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations A", &fVslider26, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider22, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Interpolations A", &fVslider11, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider8, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Voice_3");
		ui_interface->declare(&fVslider19, "unit", "Hz");
		ui_interface->addVerticalSlider("Frequency", &fVslider19, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations A", &fVslider20, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider18, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Voice_4");
		ui_interface->declare(&fVslider31, "unit", "Hz");
		ui_interface->addVerticalSlider("Frequency", &fVslider31, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations A", &fVslider32, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider30, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Voice_0+1", &fVslider24, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		...
		ui_interface->declare(&fVslider25, "unit", "Sec");
		ui_interface->addVerticalSlider("Voice_0+1", &fVslider25, FAUSTFLOAT(9.2528), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow10 = fConst4 * std::pow(16.0, double(fVslider9));
		...
		double fSlow20 = fConst4 * std::pow(16.0, double(fVslider19));
		...
		double fSlow24 = fConst4 * std::pow(16.0, double(fVslider23));
		double fSlow25 = double(fVslider24);
		double fSlow26 = fConst0 * double(fVslider25) + -1.0;
		double fSlow27 = fConst4 * double(fVslider26);
		...
		double fSlow32 = fConst4 * std::pow(16.0, double(fVslider31));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			double fTemp14 = fRec36[0] * (147.0 - 27.0 * fRec35[0]);
			fRec37[0] = fSlow11 + fConst3 * fRec37[1];
			double fTemp15 = std::max<double>(2.220446049250313e-16, fRec37[0]);
			...
			double fTemp19 = fRec35[0] * (0.07073352 * fRec38[0] + -0.7955404699999999) + (1.0 - 0.20564242 * fRec38[0]);
			double fRec34 = fTemp18 * fTemp19 / fTemp17;
			double fTemp20 = 5462.0 * fRec38[0];
			double fTemp21 = fRec36[0] * (fTemp20 + fRec35[0] * (184.0 - 5696.0 * fRec38[0]) + 3.38e+03);
			double fTemp22 = std::tan(fConst6 * fTemp21);
			double fTemp23 = fTemp22 * (fTemp22 + fTemp15 / fTemp21) + 1.0;
			double fTemp24 = fTemp22 * (fTemp13 - fRec40[1]) + fRec39[1];
			fRec39[0] = 2.0 * (fTemp24 / fTemp23) - fRec39[1];
			fRec40[0] = fRec40[1] + 2.0 * (fTemp22 * fTemp24 / fTemp23);
			double fTemp25 = fRec35[0] * (0.06439533 - 0.05859501 * fRec38[0]) + (0.00962998 - 0.00539943 * fRec38[0]);
			double fRec41 = fTemp24 * fTemp25 / fTemp23;
			double fTemp26 = fRec36[0] * (1924.0 * fRec38[0] + fRec35[0] * (-67.0 - 1709.0 * fRec38[0]) + 2792.0);
			...
			double fTemp30 = fRec35[0] * (0.18126063 - 0.15936859 * fRec38[0]) + (0.03127152 - 0.026182169999999998 * fRec38[0]);
			double fRec44 = fTemp29 * fTemp30 / fTemp28;
			double fTemp31 = fRec36[0] * (1334.0 * fRec38[0] + fRec35[0] * (69.0 - 1321.0 * fRec38[0]) + 2498.0);
			...
			double fTemp35 = 0.00024740000000000005 * fRec38[0] + fRec35[0] * (0.08007111 - 0.08267900999999998 * fRec38[0]) + 0.01134687;
			double fRec47 = fTemp34 * fTemp35 / fTemp33;
			double fTemp36 = fRec36[0] * (1117.0 * fRec38[0] + fRec35[0] * (-4e+01 - 1001.0 * fRec38[0]) + 2273.0);
			...
			double fTemp40 = 0.009332220000000002 * fRec38[0] + fRec35[0] * (0.26175163 - 0.22162943000000002 * fRec38[0]) + 0.00656447;
			double fRec50 = fTemp39 * fTemp40 / fTemp38;
			double fTemp41 = fRec36[0] * (1041.0 * fRec38[0] + fRec35[0] * (-121.0 - 812.0 * fRec38[0]) + 2054.0);
			...
			double fTemp45 = fRec35[0] * (0.39552505 - 0.38007101 * fRec38[0]) + (0.06985491 - 0.060508160000000005 * fRec38[0]);
			double fRec53 = fTemp44 * fTemp45 / fTemp43;
			double fTemp46 = fRec36[0] * (945.0 * fRec38[0] + fRec35[0] * (-128.0 - 743.0 * fRec38[0]) + 1855.0);
			double fTemp47 = std::tan(fConst6 * fTemp46);
			double fTemp48 = fTemp47 * (fTemp47 + fTemp15 / fTemp46) + 1.0;
			double fTemp49 = fTemp47 * (fTemp13 - fRec55[1]) + fRec54[1];
			fRec54[0] = 2.0 * (fTemp49 / fTemp48) - fRec54[1];
			fRec55[0] = fRec55[1] + 2.0 * (fTemp47 * fTemp49 / fTemp48);
			double fTemp50 = 0.02476806 * fRec38[0] + fRec35[0] * (0.04345912 - 0.05426385 * fRec38[0]) + 0.01093969;
			double fRec56 = fTemp49 * fTemp50 / fTemp48;
			double fTemp51 = 889.0 * fRec38[0];
			double fTemp52 = fRec36[0] * (fTemp51 + fRec35[0] * (-137.0 - 601.0 * fRec38[0]) + 1617.0);
			...
			double fTemp56 = fRec35[0] * (0.89755644 - 0.83241899 * fRec38[0]) + (0.07354127 - 0.06668288 * fRec38[0]);
			double fRec59 = fTemp55 * fTemp56 / fTemp54;
			double fTemp57 = 888.0 * fRec38[0];
			double fTemp58 = fRec36[0] * (fTemp57 + fRec35[0] * (7.0 - 646.0 * fRec38[0]) + 1323.0);
			...
			double fTemp62 = 0.01378994 * fRec38[0] + fRec35[0] * (0.16180601 - 0.17199811 * fRec38[0]) + 0.07170723;
			double fRec62 = fTemp61 * fTemp62 / fTemp60;
			double fTemp63 = fRec36[0] * (741.0 * fRec38[0] + fRec35[0] * (4.0 - 506.0 * fRec38[0]) + 1175.0);
			double fTemp64 = std::tan(fConst6 * fTemp63);
			double fTemp65 = fTemp64 * (fTemp64 + fTemp15 / fTemp63) + 1.0;
			double fTemp66 = fTemp64 * (fTemp13 - fRec64[1]) + fRec63[1];
			fRec63[0] = 2.0 * (fTemp66 / fTemp65) - fRec63[1];
			fRec64[0] = fRec64[1] + 2.0 * (fTemp64 * fTemp66 / fTemp65);
			double fTemp67 = fRec35[0] * (0.29407844000000005 - 0.3172501500000001 * fRec38[0]) + (0.28175268 - 0.21568321999999998 * fRec38[0]);
			double fRec65 = fTemp66 * fTemp67 / fTemp65;
			double fTemp68 = fRec36[0] * (593.0 * fRec38[0] + fRec35[0] * (3.0 - 447.0 * fRec38[0]) + 1028.0);
			double fTemp69 = std::tan(fConst6 * fTemp68);
			double fTemp70 = fTemp69 * (fTemp69 + fTemp15 / fTemp68) + 1.0;
			double fTemp71 = fTemp69 * (fTemp13 - fRec67[1]) + fRec66[1];
			fRec66[0] = 2.0 * (fTemp71 / fTemp70) - fRec66[1];
			fRec67[0] = fRec67[1] + 2.0 * (fTemp69 * fTemp71 / fTemp70);
			double fTemp72 = 0.07792940000000001 * fRec38[0] + fRec35[0] * (0.19518858000000003 * fRec38[0] + 0.16366607) + 0.14442907;
			double fRec68 = fTemp71 * fTemp72 / fTemp70;
			double fTemp73 = fRec36[0] * (444.0 * fRec38[0] + fRec35[0] * (-2.0 - 315.0 * fRec38[0]) + 882.0);
			double fTemp74 = std::tan(fConst6 * fTemp73);
			double fTemp75 = fTemp74 * (fTemp74 + fTemp15 / fTemp73) + 1.0;
			double fTemp76 = fTemp74 * (fTemp13 - fRec70[1]) + fRec69[1];
			fRec69[0] = 2.0 * (fTemp76 / fTemp75) - fRec69[1];
			fRec70[0] = fRec70[1] + 2.0 * (fTemp74 * fTemp76 / fTemp75);
			double fTemp77 = fRec35[0] * (0.14853099000000003 - 0.11225552000000005 * fRec38[0]) + (0.2722688 - 0.2582559 * fRec38[0]);
			double fRec71 = fTemp76 * fTemp77 / fTemp75;
			double fTemp78 = fRec36[0] * (297.0 * fRec38[0] + fRec35[0] * (1.0 - 157.0 * fRec38[0]) + 735.0);
			double fTemp79 = std::tan(fConst6 * fTemp78);
			double fTemp80 = fTemp79 * (fTemp79 + fTemp15 / fTemp78) + 1.0;
			double fTemp81 = fTemp79 * (fTemp13 - fRec73[1]) + fRec72[1];
			fRec72[0] = 2.0 * (fTemp81 / fTemp80) - fRec72[1];
			fRec73[0] = fRec73[1] + 2.0 * (fTemp79 * fTemp81 / fTemp80);
			double fTemp82 = fRec35[0] * (0.17857318999999994 - 0.36552292 * fRec38[0]) + (0.54357606 - 0.31600273 * fRec38[0]);
			double fRec74 = fTemp81 * fTemp82 / fTemp80;
			double fTemp83 = fRec36[0] * (203.0 * fRec38[0] + fRec35[0] * (3.0 - 29.0 * fRec38[0]) + 534.0);
			double fTemp84 = std::tan(fConst6 * fTemp83);
			double fTemp85 = fTemp84 * (fTemp84 + fTemp15 / fTemp83) + 1.0;
			double fTemp86 = fTemp84 * (fTemp13 - fRec76[1]) + fRec75[1];
			fRec75[0] = 2.0 * (fTemp86 / fTemp85) - fRec75[1];
			fRec76[0] = fRec76[1] + 2.0 * (fTemp84 * fTemp86 / fTemp85);
			double fTemp87 = 0.67536956 * fRec38[0] + fRec35[0] * (0.16028896 - 0.80657534 * fRec38[0]) + 0.0250452;
			double fRec77 = fTemp86 * fTemp87 / fTemp85;
			double fTemp88 = fRec36[0] * (75.0 * fRec38[0] + fRec35[0] * (0.0 - 79.0 * fRec38[0]) + 367.0);
			double fTemp89 = std::tan(fConst6 * fTemp88);
			double fTemp90 = fTemp89 * (fTemp89 + fTemp15 / fTemp88) + 1.0;
			double fTemp91 = fTemp89 * (fTemp13 - fRec79[1]) + fRec78[1];
			fRec78[0] = 2.0 * (fTemp91 / fTemp90) - fRec78[1];
			fRec79[0] = fRec79[1] + 2.0 * (fTemp89 * fTemp91 / fTemp90);
			double fTemp92 = 0.28677124 * fRec38[0] + fRec35[0] * (0.27661398 - 0.52141959 * fRec38[0]) + 0.02470587;
			double fRec80 = fTemp91 * fTemp92 / fTemp90;
			double fTemp93 = fRec36[0] * (92.0 * fRec38[0] + fRec35[0] * (-1e+01 - 96.0 * fRec38[0]) + 203.0);
			double fTemp94 = std::tan(fConst6 * fTemp93);
			double fTemp95 = fTemp94 * (fTemp94 + fTemp15 / fTemp93) + 1.0;
			double fTemp96 = fTemp94 * (fTemp13 - fRec82[1]) + fRec81[1];
			fRec81[0] = 2.0 * (fTemp96 / fTemp95) - fRec81[1];
			fRec82[0] = fRec82[1] + 2.0 * (fTemp94 * fTemp96 / fTemp95);
			double fTemp97 = 0.9594288 * fRec38[0] + fRec35[0] * (0.32743217999999996 - 0.9405872099999999 * fRec38[0]) + 0.0405712;
			double fRec83 = fTemp96 * fTemp97 / fTemp95;
			double fTemp98 = 6.0 * fRec38[0];
			double fTemp99 = fRec36[0] * (fRec35[0] * (fTemp98 + -3.0) + (53.0 - fTemp98));
			double fTemp100 = std::tan(fConst6 * fTemp99);
			double fTemp101 = fTemp100 * (fTemp100 + fTemp15 / fTemp99) + 1.0;
			double fTemp102 = fTemp100 * (fTemp13 - fRec85[1]) + fRec84[1];
			fRec84[0] = 2.0 * (fTemp102 / fTemp101) - fRec84[1];
			fRec85[0] = fRec85[1] + 2.0 * (fTemp100 * fTemp102 / fTemp101);
			double fTemp103 = fRec35[0] * (0.02738166999999999 * fRec38[0] + 0.04900900000000001) + (0.07116083 - 0.059562029999999995 * fRec38[0]);
			double fRec86 = fTemp102 * fTemp103 / fTemp101;
			double fTemp104 = fRec36[0] * (82.0 * fRec38[0] + fRec35[0] * (14.0 - 89.0 * fRec38[0]) + 294.0);
			double fTemp105 = std::tan(fConst6 * fTemp104);
			double fTemp106 = fTemp105 * (fTemp105 + fTemp15 / fTemp104) + 1.0;
			double fTemp107 = fTemp105 * (fTemp13 - fRec88[1]) + fRec87[1];
			fRec87[0] = 2.0 * (fTemp107 / fTemp106) - fRec87[1];
			fRec88[0] = fRec88[1] + 2.0 * (fTemp105 * fTemp107 / fTemp106);
			double fTemp108 = fRec35[0] * (0.45472109 * fRec38[0] + -0.34135506) + (0.49828005 - 0.49066910999999996 * fRec38[0]);
			double fRec89 = fTemp107 * fTemp108 / fTemp106;
			double fTemp109 = fRec36[0] * (148.0 * fRec38[0] + fRec35[0] * (12.0 - 13.0 * fRec38[0]) + 441.0);
			double fTemp110 = std::tan(fConst6 * fTemp109);
			double fTemp111 = fTemp110 * (fTemp110 + fTemp15 / fTemp109) + 1.0;
			double fTemp112 = fTemp110 * (fTemp13 - fRec91[1]) + fRec90[1];
			fRec90[0] = 2.0 * (fTemp112 / fTemp111) - fRec90[1];
			fRec91[0] = fRec91[1] + 2.0 * (fTemp110 * fTemp112 / fTemp111);
			double fTemp113 = 0.026025509999999974 * fRec38[0] + fRec35[0] * (0.82424861 * fRec38[0] + -0.10070198) + 0.25042786;
			double fRec92 = fTemp112 * fTemp113 / fTemp111;
			double fTemp114 = fRec36[0] * (296.0 * fRec38[0] + fRec35[0] * (1.0 - 1.1e+02 * fRec38[0]) + 588.0);
			double fTemp115 = std::tan(fConst6 * fTemp114);
			double fTemp116 = fTemp115 * (fTemp115 + fTemp15 / fTemp114) + 1.0;
			double fTemp117 = fTemp115 * (fTemp13 - fRec94[1]) + fRec93[1];
			fRec93[0] = 2.0 * (fTemp117 / fTemp116) - fRec93[1];
			fRec94[0] = fRec94[1] + 2.0 * (fTemp115 * fTemp117 / fTemp116);
			double fTemp118 = 0.27049557 * fRec38[0] + fRec35[0] * (0.23776758000000003 - 0.53709331 * fRec38[0]) + 0.09954785;
			double fRec95 = fTemp117 * fTemp118 / fTemp116;
			double fTemp119 = fRec36[0] * (394.0 * fRec38[0] + fRec35[0] * (43.0 - 285.0 * fRec38[0]) + 785.0);
			double fTemp120 = std::tan(fConst6 * fTemp119);
			double fTemp121 = fTemp120 * (fTemp120 + fTemp15 / fTemp119) + 1.0;
			double fTemp122 = fTemp120 * (fTemp13 - fRec97[1]) + fRec96[1];
			fRec96[0] = 2.0 * (fTemp122 / fTemp121) - fRec96[1];
			fRec97[0] = fRec97[1] + 2.0 * (fTemp120 * fTemp122 / fTemp121);
			double fTemp123 = 0.24706891000000003 * fRec38[0] + fRec35[0] * (0.037263420000000005 - 0.24153450000000004 * fRec38[0]) + 0.01573797;
			double fRec98 = fTemp122 * fTemp123 / fTemp121;
			double fTemp124 = fRec36[0] * (513.0 * fRec38[0] + fRec35[0] * (3.0 - 381.0 * fRec38[0]) + 961.0);
			double fTemp125 = std::tan(fConst6 * fTemp124);
			double fTemp126 = fTemp125 * (fTemp125 + fTemp15 / fTemp124) + 1.0;
			double fTemp127 = fTemp125 * (fTemp13 - fRec100[1]) + fRec99[1];
			fRec99[0] = 2.0 * (fTemp127 / fTemp126) - fRec99[1];
			fRec100[0] = fRec100[1] + 2.0 * (fTemp125 * fTemp127 / fTemp126);
			double fTemp128 = 0.25012827 * fRec38[0] + fRec35[0] * (0.11585875999999999 - 0.20043951 * fRec38[0]) + 0.01228042;
			double fRec101 = fTemp127 * fTemp128 / fTemp126;
			double fTemp129 = fRec36[0] * (6.9e+02 * fRec38[0] + fRec35[0] * (23.0 - 483.0 * fRec38[0]) + 1078.0);
			double fTemp130 = std::tan(fConst6 * fTemp129);
			double fTemp131 = fTemp130 * (fTemp130 + fTemp15 / fTemp129) + 1.0;
			double fTemp132 = fTemp130 * (fTemp13 - fRec103[1]) + fRec102[1];
			fRec102[0] = 2.0 * (fTemp132 / fTemp131) - fRec102[1];
			fRec103[0] = fRec103[1] + 2.0 * (fTemp130 * fTemp132 / fTemp131);
			double fTemp133 = 0.08014510000000001 * fRec38[0] + fRec35[0] * (0.08188717000000001 - 0.15931663000000001 * fRec38[0]) + 0.01626654;
			double fRec104 = fTemp132 * fTemp133 / fTemp131;
			double fTemp134 = fRec36[0] * (794.0 * fRec38[0] + fRec35[0] * (6.0 - 563.0 * fRec38[0]) + 1269.0);
			double fTemp135 = std::tan(fConst6 * fTemp134);
			double fTemp136 = fTemp135 * (fTemp135 + fTemp15 / fTemp134) + 1.0;
			double fTemp137 = fTemp135 * (fTemp13 - fRec106[1]) + fRec105[1];
			fRec105[0] = 2.0 * (fTemp137 / fTemp136) - fRec105[1];
			fRec106[0] = fRec106[1] + 2.0 * (fTemp135 * fTemp137 / fTemp136);
			double fTemp138 = 0.15692174 * fRec38[0] + fRec35[0] * (0.019392789999999997 - 0.13171841 * fRec38[0]) + 0.02115358;
			double fRec107 = fTemp137 * fTemp138 / fTemp136;
			double fTemp139 = fRec36[0] * (fTemp57 + fRec35[0] * (-62.0 - 612.0 * fRec38[0]) + 1.47e+03);
			double fTemp140 = std::tan(fConst6 * fTemp139);
			double fTemp141 = fTemp140 * (fTemp140 + fTemp15 / fTemp139) + 1.0;
			double fTemp142 = fTemp140 * (fTemp13 - fRec109[1]) + fRec108[1];
			fRec108[0] = 2.0 * (fTemp142 / fTemp141) - fRec108[1];
			fRec109[0] = fRec109[1] + 2.0 * (fTemp140 * fTemp142 / fTemp141);
			double fTemp143 = fRec35[0] * (0.020997170000000002 - 0.020033680000000005 * fRec38[0]) + (0.06191843 - 0.02241523 * fRec38[0]);
			double fRec110 = fTemp142 * fTemp143 / fTemp141;
			double fTemp144 = fRec36[0] * (fTemp51 + fRec35[0] * (-134.0 - 649.0 * fRec38[0]) + 1764.0);
			double fTemp145 = std::tan(fConst6 * fTemp144);
			double fTemp146 = fTemp145 * (fTemp145 + fTemp15 / fTemp144) + 1.0;
			double fTemp147 = fTemp145 * (fTemp13 - fRec112[1]) + fRec111[1];
			fRec111[0] = 2.0 * (fTemp147 / fTemp146) - fRec111[1];
			fRec112[0] = fRec112[1] + 2.0 * (fTemp145 * fTemp147 / fTemp146);
			double fTemp148 = fRec35[0] * (0.94873963 - 0.9622067 * fRec38[0]) + (0.05126037 - 0.02103158 * fRec38[0]);
			double fRec113 = fTemp147 * fTemp148 / fTemp146;
			double fTemp149 = fRec36[0] * (1037.0 * fRec38[0] + fRec35[0] * (-128.0 - 751.0 * fRec38[0]) + 1.91e+03);
			double fTemp150 = std::tan(fConst6 * fTemp149);
			double fTemp151 = fTemp150 * (fTemp150 + fTemp15 / fTemp149) + 1.0;
			double fTemp152 = fTemp150 * (fTemp13 - fRec115[1]) + fRec114[1];
			fRec114[0] = 2.0 * (fTemp152 / fTemp151) - fRec114[1];
			fRec115[0] = fRec115[1] + 2.0 * (fTemp150 * fTemp152 / fTemp151);
			double fTemp153 = fRec35[0] * (0.58336649 - 0.5666712700000001 * fRec38[0]) + (0.0343155 - 0.02668976 * fRec38[0]);
			double fRec116 = fTemp152 * fTemp153 / fTemp151;
			double fTemp154 = fRec36[0] * (1038.0 * fRec38[0] + fRec35[0] * (-119.0 - 846.0 * fRec38[0]) + 2204.0);
			double fTemp155 = std::tan(fConst6 * fTemp154);
			double fTemp156 = fTemp155 * (fTemp155 + fTemp15 / fTemp154) + 1.0;
			double fTemp157 = fTemp155 * (fTemp13 - fRec118[1]) + fRec117[1];
			fRec117[0] = 2.0 * (fTemp157 / fTemp156) - fRec117[1];
			fRec118[0] = fRec118[1] + 2.0 * (fTemp155 * fTemp157 / fTemp156);
			double fTemp158 = fRec35[0] * (0.5577936099999999 - 0.54352849 * fRec38[0]) + (0.09585942 - 0.086804 * fRec38[0]);
			double fRec119 = fTemp157 * fTemp158 / fTemp156;
			double fTemp159 = fRec36[0] * (1186.0 * fRec38[0] + fRec35[0] * (51.0 - 1.13e+03 * fRec38[0]) + 2351.0);
			double fTemp160 = std::tan(fConst6 * fTemp159);
			double fTemp161 = fTemp160 * (fTemp160 + fTemp15 / fTemp159) + 1.0;
			double fTemp162 = fTemp160 * (fTemp13 - fRec121[1]) + fRec120[1];
			fRec120[0] = 2.0 * (fTemp162 / fTemp161) - fRec120[1];
			fRec121[0] = fRec121[1] + 2.0 * (fTemp160 * fTemp162 / fTemp161);
			double fTemp163 = fRec35[0] * (0.18329145 - 0.17669554 * fRec38[0]) + (0.01233555 - 0.008431840000000001 * fRec38[0]);
			double fRec122 = fTemp162 * fTemp163 / fTemp161;
			double fTemp164 = fRec36[0] * (1481.0 * fRec38[0] + fRec35[0] * (13.0 - 1359.0 * fRec38[0]) + 2645.0);
			double fTemp165 = std::tan(fConst6 * fTemp164);
			double fTemp166 = fTemp165 * (fTemp165 + fTemp15 / fTemp164) + 1.0;
			double fTemp167 = fTemp165 * (fTemp13 - fRec124[1]) + fRec123[1];
			fRec123[0] = 2.0 * (fTemp167 / fTemp166) - fRec123[1];
			fRec124[0] = fRec124[1] + 2.0 * (fTemp165 * fTemp167 / fTemp166);
			double fTemp168 = fRec35[0] * (0.052822430000000004 - 0.026333230000000006 * fRec38[0]) + (0.01055565 - 0.00626412 * fRec38[0]);
			double fRec125 = fTemp167 * fTemp168 / fTemp166;
			double fTemp169 = fRec36[0] * (fTemp20 + fRec35[0] * (152.0 - 5648.0 * fRec38[0]) + 3233.0);
			double fTemp170 = std::tan(fConst6 * fTemp169);
			double fTemp171 = fTemp170 * (fTemp170 + fTemp15 / fTemp169) + 1.0;
			double fTemp172 = fTemp170 * (fTemp13 - fRec127[1]) + fRec126[1];
			fRec126[0] = 2.0 * (fTemp172 / fTemp171) - fRec126[1];
			fRec127[0] = fRec127[1] + 2.0 * (fTemp170 * fTemp172 / fTemp171);
			double fTemp173 = fRec35[0] * (0.03251611 - 0.026476020000000003 * fRec38[0]) + (0.01587526 - 0.011935889999999998 * fRec38[0]);
			double fRec128 = fTemp172 * fTemp173 / fTemp171;
			double fTemp174 = fRec36[0] * (5463.0 * fRec38[0] + fRec35[0] * (189.0 - 5063.0 * fRec38[0]) + 3527.0);
			double fTemp175 = std::tan(fConst6 * fTemp174);
			double fTemp176 = fTemp175 * (fTemp175 + fTemp15 / fTemp174) + 1.0;
			double fTemp177 = fTemp175 * (fTemp13 - fRec130[1]) + fRec129[1];
			fRec129[0] = 2.0 * (fTemp177 / fTemp176) - fRec129[1];
			fRec130[0] = fRec130[1] + 2.0 * (fTemp175 * fTemp177 / fTemp176);
			double fTemp178 = fRec35[0] * (0.14146586 - 0.1338637 * fRec38[0]) + (0.0068168 - 0.0019190699999999993 * fRec38[0]);
			double fRec131 = fTemp177 * fTemp178 / fTemp176;
			fRec132[0] = fSlow13 + fConst3 * fRec132[1];
			double fTemp179 = 0.03125 * fRec132[0] * (fRec131 + fRec128 + fRec125 + fRec122 + fRec119 + fRec116 + fRec113 + fRec110 + fRec107 + fRec104 + fRec101 + fRec98 + fRec95 + fRec92 + fRec89 + fRec86 + fRec83 + fRec80 + fRec77 + fRec74 + fRec71 + fRec68 + fRec65 + fRec62 + fRec59 + fRec56 + fRec53 + fRec50 + fRec47 + fRec44 + fRec41 + fRec34) + fRec31[0] * fTemp13;
			fRec16[0] = std::max<double>(fConst1 * fRec16[1], std::fabs(fTemp179));
			fVbargraph4 = FAUSTFLOAT(fRec16[0]);
			fRec13[0] = fTemp179;
			fVec3[0] = 1.3;
			double fTemp180 = 1.3 - fVec3[1];
			double fTemp181 = fRec21[0] * fRec15[1];
			fRec137[0] = std::max<double>(fConst1 * fRec137[1], std::fabs(fTemp181));
			fVbargraph5 = FAUSTFLOAT(fRec137[0]);
			double fTemp182 = fTemp181;
			fRec138[0] = fSlow14 + fConst3 * fRec138[1];
			double fTemp183 = fRec23[0] * (fTemp3 * (fRec138[0] - fTemp182) - fTemp5);
			double fTemp184 = fTemp8 + fRec26[1];
			double fTemp185 = fTemp184 + fTemp5;
			fVec4[0] = fTemp185 + fTemp183 + fTemp180;
			fRec136[0] = fTemp183 + 0.995 * fRec136[1] + fTemp185 + (1.3 - (fVec3[1] + fVec4[1]));
			fRec135[0] = std::max<double>(fConst1 * fRec135[1], std::fabs(fRec136[0]));
			fVbargraph6 = FAUSTFLOAT(fRec135[0]);
			double fTemp186 = fRec12[0] * tanh(fRec136[0] / fTemp0);
			fRec134[0] = std::max<double>(fConst1 * fRec134[1], std::fabs(fTemp186));
			fVbargraph7 = FAUSTFLOAT(fRec134[0]);
			double fTemp187 = fTemp186;
			double fTemp188 = fTemp16 * (fTemp187 - fRec140[1]) + fRec139[1];
			fRec139[0] = 2.0 * (fTemp188 / fTemp17) - fRec139[1];
			fRec140[0] = fRec140[1] + 2.0 * (fTemp16 * fTemp188 / fTemp17);
			double fRec141 = fTemp19 * fTemp188 / fTemp17;
			double fTemp189 = fTemp22 * (fTemp187 - fRec143[1]) + fRec142[1];
			fRec142[0] = 2.0 * (fTemp189 / fTemp23) - fRec142[1];
			fRec143[0] = fRec143[1] + 2.0 * (fTemp22 * fTemp189 / fTemp23);
			double fRec144 = fTemp25 * fTemp189 / fTemp23;
			double fTemp190 = fTemp27 * (fTemp187 - fRec146[1]) + fRec145[1];
			fRec145[0] = 2.0 * (fTemp190 / fTemp28) - fRec145[1];
			fRec146[0] = fRec146[1] + 2.0 * (fTemp27 * fTemp190 / fTemp28);
			double fRec147 = fTemp30 * fTemp190 / fTemp28;
			double fTemp191 = fTemp32 * (fTemp187 - fRec149[1]) + fRec148[1];
			fRec148[0] = 2.0 * (fTemp191 / fTemp33) - fRec148[1];
			fRec149[0] = fRec149[1] + 2.0 * (fTemp32 * fTemp191 / fTemp33);
			double fRec150 = fTemp35 * fTemp191 / fTemp33;
			double fTemp192 = fTemp37 * (fTemp187 - fRec152[1]) + fRec151[1];
			fRec151[0] = 2.0 * (fTemp192 / fTemp38) - fRec151[1];
			fRec152[0] = fRec152[1] + 2.0 * (fTemp37 * fTemp192 / fTemp38);
			double fRec153 = fTemp40 * fTemp192 / fTemp38;
			double fTemp193 = fTemp42 * (fTemp187 - fRec155[1]) + fRec154[1];
			fRec154[0] = 2.0 * (fTemp193 / fTemp43) - fRec154[1];
			fRec155[0] = fRec155[1] + 2.0 * (fTemp42 * fTemp193 / fTemp43);
			double fRec156 = fTemp45 * fTemp193 / fTemp43;
			double fTemp194 = fTemp47 * (fTemp187 - fRec158[1]) + fRec157[1];
			fRec157[0] = 2.0 * (fTemp194 / fTemp48) - fRec157[1];
			fRec158[0] = fRec158[1] + 2.0 * (fTemp47 * fTemp194 / fTemp48);
			double fRec159 = fTemp50 * fTemp194 / fTemp48;
			double fTemp195 = fTemp53 * (fTemp187 - fRec161[1]) + fRec160[1];
			fRec160[0] = 2.0 * (fTemp195 / fTemp54) - fRec160[1];
			fRec161[0] = fRec161[1] + 2.0 * (fTemp53 * fTemp195 / fTemp54);
			double fRec162 = fTemp56 * fTemp195 / fTemp54;
			double fTemp196 = fTemp59 * (fTemp187 - fRec164[1]) + fRec163[1];
			fRec163[0] = 2.0 * (fTemp196 / fTemp60) - fRec163[1];
			fRec164[0] = fRec164[1] + 2.0 * (fTemp59 * fTemp196 / fTemp60);
			double fRec165 = fTemp62 * fTemp196 / fTemp60;
			double fTemp197 = fTemp64 * (fTemp187 - fRec167[1]) + fRec166[1];
			fRec166[0] = 2.0 * (fTemp197 / fTemp65) - fRec166[1];
			fRec167[0] = fRec167[1] + 2.0 * (fTemp64 * fTemp197 / fTemp65);
			double fRec168 = fTemp67 * fTemp197 / fTemp65;
			double fTemp198 = fTemp69 * (fTemp187 - fRec170[1]) + fRec169[1];
			fRec169[0] = 2.0 * (fTemp198 / fTemp70) - fRec169[1];
			fRec170[0] = fRec170[1] + 2.0 * (fTemp69 * fTemp198 / fTemp70);
			double fRec171 = fTemp72 * fTemp198 / fTemp70;
			double fTemp199 = fTemp74 * (fTemp187 - fRec173[1]) + fRec172[1];
			fRec172[0] = 2.0 * (fTemp199 / fTemp75) - fRec172[1];
			fRec173[0] = fRec173[1] + 2.0 * (fTemp74 * fTemp199 / fTemp75);
			double fRec174 = fTemp77 * fTemp199 / fTemp75;
			double fTemp200 = fTemp79 * (fTemp187 - fRec176[1]) + fRec175[1];
			fRec175[0] = 2.0 * (fTemp200 / fTemp80) - fRec175[1];
			fRec176[0] = fRec176[1] + 2.0 * (fTemp79 * fTemp200 / fTemp80);
			double fRec177 = fTemp82 * fTemp200 / fTemp80;
			double fTemp201 = fTemp84 * (fTemp187 - fRec179[1]) + fRec178[1];
			fRec178[0] = 2.0 * (fTemp201 / fTemp85) - fRec178[1];
			fRec179[0] = fRec179[1] + 2.0 * (fTemp84 * fTemp201 / fTemp85);
			double fRec180 = fTemp87 * fTemp201 / fTemp85;
			double fTemp202 = fTemp89 * (fTemp187 - fRec182[1]) + fRec181[1];
			fRec181[0] = 2.0 * (fTemp202 / fTemp90) - fRec181[1];
			fRec182[0] = fRec182[1] + 2.0 * (fTemp89 * fTemp202 / fTemp90);
			double fRec183 = fTemp92 * fTemp202 / fTemp90;
			double fTemp203 = fTemp94 * (fTemp187 - fRec185[1]) + fRec184[1];
			fRec184[0] = 2.0 * (fTemp203 / fTemp95) - fRec184[1];
			fRec185[0] = fRec185[1] + 2.0 * (fTemp94 * fTemp203 / fTemp95);
			double fRec186 = fTemp97 * fTemp203 / fTemp95;
			double fTemp204 = fTemp100 * (fTemp187 - fRec188[1]) + fRec187[1];
			fRec187[0] = 2.0 * (fTemp204 / fTemp101) - fRec187[1];
			fRec188[0] = fRec188[1] + 2.0 * (fTemp100 * fTemp204 / fTemp101);
			double fRec189 = fTemp103 * fTemp204 / fTemp101;
			double fTemp205 = fTemp105 * (fTemp187 - fRec191[1]) + fRec190[1];
			fRec190[0] = 2.0 * (fTemp205 / fTemp106) - fRec190[1];
			fRec191[0] = fRec191[1] + 2.0 * (fTemp105 * fTemp205 / fTemp106);
			double fRec192 = fTemp108 * fTemp205 / fTemp106;
			double fTemp206 = fTemp110 * (fTemp187 - fRec194[1]) + fRec193[1];
			fRec193[0] = 2.0 * (fTemp206 / fTemp111) - fRec193[1];
			fRec194[0] = fRec194[1] + 2.0 * (fTemp110 * fTemp206 / fTemp111);
			double fRec195 = fTemp113 * fTemp206 / fTemp111;
			double fTemp207 = fTemp115 * (fTemp187 - fRec197[1]) + fRec196[1];
			fRec196[0] = 2.0 * (fTemp207 / fTemp116) - fRec196[1];
			fRec197[0] = fRec197[1] + 2.0 * (fTemp115 * fTemp207 / fTemp116);
			double fRec198 = fTemp118 * fTemp207 / fTemp116;
			double fTemp208 = fTemp120 * (fTemp187 - fRec200[1]) + fRec199[1];
			fRec199[0] = 2.0 * (fTemp208 / fTemp121) - fRec199[1];
			fRec200[0] = fRec200[1] + 2.0 * (fTemp120 * fTemp208 / fTemp121);
			double fRec201 = fTemp123 * fTemp208 / fTemp121;
			double fTemp209 = fTemp125 * (fTemp187 - fRec203[1]) + fRec202[1];
			fRec202[0] = 2.0 * (fTemp209 / fTemp126) - fRec202[1];
			fRec203[0] = fRec203[1] + 2.0 * (fTemp125 * fTemp209 / fTemp126);
			double fRec204 = fTemp128 * fTemp209 / fTemp126;
			double fTemp210 = fTemp130 * (fTemp187 - fRec206[1]) + fRec205[1];
			fRec205[0] = 2.0 * (fTemp210 / fTemp131) - fRec205[1];
			fRec206[0] = fRec206[1] + 2.0 * (fTemp130 * fTemp210 / fTemp131);
			double fRec207 = fTemp133 * fTemp210 / fTemp131;
			double fTemp211 = fTemp135 * (fTemp187 - fRec209[1]) + fRec208[1];
			fRec208[0] = 2.0 * (fTemp211 / fTemp136) - fRec208[1];
			fRec209[0] = fRec209[1] + 2.0 * (fTemp135 * fTemp211 / fTemp136);
			double fRec210 = fTemp138 * fTemp211 / fTemp136;
			double fTemp212 = fTemp140 * (fTemp187 - fRec212[1]) + fRec211[1];
			fRec211[0] = 2.0 * (fTemp212 / fTemp141) - fRec211[1];
			fRec212[0] = fRec212[1] + 2.0 * (fTemp140 * fTemp212 / fTemp141);
			double fRec213 = fTemp143 * fTemp212 / fTemp141;
			double fTemp213 = fTemp145 * (fTemp187 - fRec215[1]) + fRec214[1];
			fRec214[0] = 2.0 * (fTemp213 / fTemp146) - fRec214[1];
			fRec215[0] = fRec215[1] + 2.0 * (fTemp145 * fTemp213 / fTemp146);
			double fRec216 = fTemp148 * fTemp213 / fTemp146;
			double fTemp214 = fTemp150 * (fTemp187 - fRec218[1]) + fRec217[1];
			fRec217[0] = 2.0 * (fTemp214 / fTemp151) - fRec217[1];
			fRec218[0] = fRec218[1] + 2.0 * (fTemp150 * fTemp214 / fTemp151);
			double fRec219 = fTemp153 * fTemp214 / fTemp151;
			double fTemp215 = fTemp155 * (fTemp187 - fRec221[1]) + fRec220[1];
			fRec220[0] = 2.0 * (fTemp215 / fTemp156) - fRec220[1];
			fRec221[0] = fRec221[1] + 2.0 * (fTemp155 * fTemp215 / fTemp156);
			double fRec222 = fTemp158 * fTemp215 / fTemp156;
			double fTemp216 = fTemp160 * (fTemp187 - fRec224[1]) + fRec223[1];
			fRec223[0] = 2.0 * (fTemp216 / fTemp161) - fRec223[1];
			fRec224[0] = fRec224[1] + 2.0 * (fTemp160 * fTemp216 / fTemp161);
			double fRec225 = fTemp163 * fTemp216 / fTemp161;
			double fTemp217 = fTemp165 * (fTemp187 - fRec227[1]) + fRec226[1];
			fRec226[0] = 2.0 * (fTemp217 / fTemp166) - fRec226[1];
			fRec227[0] = fRec227[1] + 2.0 * (fTemp165 * fTemp217 / fTemp166);
			double fRec228 = fTemp168 * fTemp217 / fTemp166;
			double fTemp218 = fTemp170 * (fTemp187 - fRec230[1]) + fRec229[1];
			fRec229[0] = 2.0 * (fTemp218 / fTemp171) - fRec229[1];
			fRec230[0] = fRec230[1] + 2.0 * (fTemp170 * fTemp218 / fTemp171);
			double fRec231 = fTemp173 * fTemp218 / fTemp171;
			double fTemp219 = fTemp175 * (fTemp187 - fRec233[1]) + fRec232[1];
			fRec232[0] = 2.0 * (fTemp219 / fTemp176) - fRec232[1];
			fRec233[0] = fRec233[1] + 2.0 * (fTemp175 * fTemp219 / fTemp176);
			double fRec234 = fTemp178 * fTemp219 / fTemp176;
			double fTemp220 = 0.03125 * fRec132[0] * (fRec234 + fRec231 + fRec228 + fRec225 + fRec222 + fRec219 + fRec216 + fRec213 + fRec210 + fRec207 + fRec204 + fRec201 + fRec198 + fRec195 + fRec192 + fRec189 + fRec186 + fRec183 + fRec180 + fRec177 + fRec174 + fRec171 + fRec168 + fRec165 + fRec162 + fRec159 + fRec156 + fRec153 + fRec150 + fRec147 + fRec144 + fRec141) + fRec31[0] * fTemp187;
			fRec133[0] = std::max<double>(fConst1 * fRec133[1], std::fabs(fTemp220));
			fVbargraph8 = FAUSTFLOAT(fRec133[0]);
			fRec14[0] = fTemp220;
			fVec5[0] = 1.6;
			double fTemp221 = 1.6 - fVec5[1];
			fRec239[0] = fSlow15 + fConst3 * fRec239[1];
			double fTemp222 = fRec23[0] * (fTemp3 * fTemp5 - fRec239[0] * fTemp182);
			double fTemp223 = fTemp184 + fTemp182;
			fVec6[0] = fTemp223 + fTemp222 + fTemp221;
			fRec238[0] = fTemp222 + 0.995 * fRec238[1] + fTemp223 + (1.6 - (fVec5[1] + fVec6[1]));
			fRec237[0] = std::max<double>(fConst1 * fRec237[1], std::fabs(fRec238[0]));
			fVbargraph9 = FAUSTFLOAT(fRec237[0]);
			double fTemp224 = fRec12[0] * tanh(fRec238[0] / fTemp0);
			fRec236[0] = std::max<double>(fConst1 * fRec236[1], std::fabs(fTemp224));
			fVbargraph10 = FAUSTFLOAT(fRec236[0]);
			double fTemp225 = fTemp224;
			double fTemp226 = fTemp16 * (fTemp225 - fRec241[1]) + fRec240[1];
			fRec240[0] = 2.0 * (fTemp226 / fTemp17) - fRec240[1];
			fRec241[0] = fRec241[1] + 2.0 * (fTemp16 * fTemp226 / fTemp17);
			double fRec242 = fTemp19 * fTemp226 / fTemp17;
			double fTemp227 = fTemp22 * (fTemp225 - fRec244[1]) + fRec243[1];
			fRec243[0] = 2.0 * (fTemp227 / fTemp23) - fRec243[1];
			fRec244[0] = fRec244[1] + 2.0 * (fTemp22 * fTemp227 / fTemp23);
			double fRec245 = fTemp25 * fTemp227 / fTemp23;
			double fTemp228 = fTemp27 * (fTemp225 - fRec247[1]) + fRec246[1];
			fRec246[0] = 2.0 * (fTemp228 / fTemp28) - fRec246[1];
			fRec247[0] = fRec247[1] + 2.0 * (fTemp27 * fTemp228 / fTemp28);
			double fRec248 = fTemp30 * fTemp228 / fTemp28;
			double fTemp229 = fTemp32 * (fTemp225 - fRec250[1]) + fRec249[1];
			fRec249[0] = 2.0 * (fTemp229 / fTemp33) - fRec249[1];
			fRec250[0] = fRec250[1] + 2.0 * (fTemp32 * fTemp229 / fTemp33);
			double fRec251 = fTemp35 * fTemp229 / fTemp33;
			double fTemp230 = fTemp37 * (fTemp225 - fRec253[1]) + fRec252[1];
			fRec252[0] = 2.0 * (fTemp230 / fTemp38) - fRec252[1];
			fRec253[0] = fRec253[1] + 2.0 * (fTemp37 * fTemp230 / fTemp38);
			double fRec254 = fTemp40 * fTemp230 / fTemp38;
			double fTemp231 = fTemp42 * (fTemp225 - fRec256[1]) + fRec255[1];
			fRec255[0] = 2.0 * (fTemp231 / fTemp43) - fRec255[1];
			fRec256[0] = fRec256[1] + 2.0 * (fTemp42 * fTemp231 / fTemp43);
			double fRec257 = fTemp45 * fTemp231 / fTemp43;
			double fTemp232 = fTemp47 * (fTemp225 - fRec259[1]) + fRec258[1];
			fRec258[0] = 2.0 * (fTemp232 / fTemp48) - fRec258[1];
			fRec259[0] = fRec259[1] + 2.0 * (fTemp47 * fTemp232 / fTemp48);
			double fRec260 = fTemp50 * fTemp232 / fTemp48;
			double fTemp233 = fTemp53 * (fTemp225 - fRec262[1]) + fRec261[1];
			fRec261[0] = 2.0 * (fTemp233 / fTemp54) - fRec261[1];
			fRec262[0] = fRec262[1] + 2.0 * (fTemp53 * fTemp233 / fTemp54);
			double fRec263 = fTemp56 * fTemp233 / fTemp54;
			double fTemp234 = fTemp59 * (fTemp225 - fRec265[1]) + fRec264[1];
			fRec264[0] = 2.0 * (fTemp234 / fTemp60) - fRec264[1];
			fRec265[0] = fRec265[1] + 2.0 * (fTemp59 * fTemp234 / fTemp60);
			double fRec266 = fTemp62 * fTemp234 / fTemp60;
			double fTemp235 = fTemp64 * (fTemp225 - fRec268[1]) + fRec267[1];
			fRec267[0] = 2.0 * (fTemp235 / fTemp65) - fRec267[1];
			fRec268[0] = fRec268[1] + 2.0 * (fTemp64 * fTemp235 / fTemp65);
			double fRec269 = fTemp67 * fTemp235 / fTemp65;
			double fTemp236 = fTemp69 * (fTemp225 - fRec271[1]) + fRec270[1];
			fRec270[0] = 2.0 * (fTemp236 / fTemp70) - fRec270[1];
			fRec271[0] = fRec271[1] + 2.0 * (fTemp69 * fTemp236 / fTemp70);
			double fRec272 = fTemp72 * fTemp236 / fTemp70;
			double fTemp237 = fTemp74 * (fTemp225 - fRec274[1]) + fRec273[1];
			fRec273[0] = 2.0 * (fTemp237 / fTemp75) - fRec273[1];
			fRec274[0] = fRec274[1] + 2.0 * (fTemp74 * fTemp237 / fTemp75);
			double fRec275 = fTemp77 * fTemp237 / fTemp75;
			double fTemp238 = fTemp79 * (fTemp225 - fRec277[1]) + fRec276[1];
			fRec276[0] = 2.0 * (fTemp238 / fTemp80) - fRec276[1];
			fRec277[0] = fRec277[1] + 2.0 * (fTemp79 * fTemp238 / fTemp80);
			double fRec278 = fTemp82 * fTemp238 / fTemp80;
			double fTemp239 = fTemp84 * (fTemp225 - fRec280[1]) + fRec279[1];
			fRec279[0] = 2.0 * (fTemp239 / fTemp85) - fRec279[1];
			fRec280[0] = fRec280[1] + 2.0 * (fTemp84 * fTemp239 / fTemp85);
			double fRec281 = fTemp87 * fTemp239 / fTemp85;
			double fTemp240 = fTemp89 * (fTemp225 - fRec283[1]) + fRec282[1];
			fRec282[0] = 2.0 * (fTemp240 / fTemp90) - fRec282[1];
			fRec283[0] = fRec283[1] + 2.0 * (fTemp89 * fTemp240 / fTemp90);
			double fRec284 = fTemp92 * fTemp240 / fTemp90;
			double fTemp241 = fTemp94 * (fTemp225 - fRec286[1]) + fRec285[1];
			fRec285[0] = 2.0 * (fTemp241 / fTemp95) - fRec285[1];
			fRec286[0] = fRec286[1] + 2.0 * (fTemp94 * fTemp241 / fTemp95);
			double fRec287 = fTemp97 * fTemp241 / fTemp95;
			double fTemp242 = fTemp100 * (fTemp225 - fRec289[1]) + fRec288[1];
			fRec288[0] = 2.0 * (fTemp242 / fTemp101) - fRec288[1];
			fRec289[0] = fRec289[1] + 2.0 * (fTemp100 * fTemp242 / fTemp101);
			double fRec290 = fTemp103 * fTemp242 / fTemp101;
			double fTemp243 = fTemp105 * (fTemp225 - fRec292[1]) + fRec291[1];
			fRec291[0] = 2.0 * (fTemp243 / fTemp106) - fRec291[1];
			fRec292[0] = fRec292[1] + 2.0 * (fTemp105 * fTemp243 / fTemp106);
			double fRec293 = fTemp108 * fTemp243 / fTemp106;
			double fTemp244 = fTemp110 * (fTemp225 - fRec295[1]) + fRec294[1];
			fRec294[0] = 2.0 * (fTemp244 / fTemp111) - fRec294[1];
			fRec295[0] = fRec295[1] + 2.0 * (fTemp110 * fTemp244 / fTemp111);
			double fRec296 = fTemp113 * fTemp244 / fTemp111;
			double fTemp245 = fTemp115 * (fTemp225 - fRec298[1]) + fRec297[1];
			fRec297[0] = 2.0 * (fTemp245 / fTemp116) - fRec297[1];
			fRec298[0] = fRec298[1] + 2.0 * (fTemp115 * fTemp245 / fTemp116);
			double fRec299 = fTemp118 * fTemp245 / fTemp116;
			double fTemp246 = fTemp120 * (fTemp225 - fRec301[1]) + fRec300[1];
			fRec300[0] = 2.0 * (fTemp246 / fTemp121) - fRec300[1];
			fRec301[0] = fRec301[1] + 2.0 * (fTemp120 * fTemp246 / fTemp121);
			double fRec302 = fTemp123 * fTemp246 / fTemp121;
			double fTemp247 = fTemp125 * (fTemp225 - fRec304[1]) + fRec303[1];
			fRec303[0] = 2.0 * (fTemp247 / fTemp126) - fRec303[1];
			fRec304[0] = fRec304[1] + 2.0 * (fTemp125 * fTemp247 / fTemp126);
			double fRec305 = fTemp128 * fTemp247 / fTemp126;
			double fTemp248 = fTemp130 * (fTemp225 - fRec307[1]) + fRec306[1];
			fRec306[0] = 2.0 * (fTemp248 / fTemp131) - fRec306[1];
			fRec307[0] = fRec307[1] + 2.0 * (fTemp130 * fTemp248 / fTemp131);
			double fRec308 = fTemp133 * fTemp248 / fTemp131;
			double fTemp249 = fTemp135 * (fTemp225 - fRec310[1]) + fRec309[1];
			fRec309[0] = 2.0 * (fTemp249 / fTemp136) - fRec309[1];
			fRec310[0] = fRec310[1] + 2.0 * (fTemp135 * fTemp249 / fTemp136);
			double fRec311 = fTemp138 * fTemp249 / fTemp136;
			double fTemp250 = fTemp140 * (fTemp225 - fRec313[1]) + fRec312[1];
			fRec312[0] = 2.0 * (fTemp250 / fTemp141) - fRec312[1];
			fRec313[0] = fRec313[1] + 2.0 * (fTemp140 * fTemp250 / fTemp141);
			double fRec314 = fTemp143 * fTemp250 / fTemp141;
			double fTemp251 = fTemp145 * (fTemp225 - fRec316[1]) + fRec315[1];
			fRec315[0] = 2.0 * (fTemp251 / fTemp146) - fRec315[1];
			fRec316[0] = fRec316[1] + 2.0 * (fTemp145 * fTemp251 / fTemp146);
			double fRec317 = fTemp148 * fTemp251 / fTemp146;
			double fTemp252 = fTemp150 * (fTemp225 - fRec319[1]) + fRec318[1];
			fRec318[0] = 2.0 * (fTemp252 / fTemp151) - fRec318[1];
			fRec319[0] = fRec319[1] + 2.0 * (fTemp150 * fTemp252 / fTemp151);
			double fRec320 = fTemp153 * fTemp252 / fTemp151;
			double fTemp253 = fTemp155 * (fTemp225 - fRec322[1]) + fRec321[1];
			fRec321[0] = 2.0 * (fTemp253 / fTemp156) - fRec321[1];
			fRec322[0] = fRec322[1] + 2.0 * (fTemp155 * fTemp253 / fTemp156);
			double fRec323 = fTemp158 * fTemp253 / fTemp156;
			double fTemp254 = fTemp160 * (fTemp225 - fRec325[1]) + fRec324[1];
			fRec324[0] = 2.0 * (fTemp254 / fTemp161) - fRec324[1];
			fRec325[0] = fRec325[1] + 2.0 * (fTemp160 * fTemp254 / fTemp161);
			double fRec326 = fTemp163 * fTemp254 / fTemp161;
			double fTemp255 = fTemp165 * (fTemp225 - fRec328[1]) + fRec327[1];
			fRec327[0] = 2.0 * (fTemp255 / fTemp166) - fRec327[1];
			fRec328[0] = fRec328[1] + 2.0 * (fTemp165 * fTemp255 / fTemp166);
			double fRec329 = fTemp168 * fTemp255 / fTemp166;
			double fTemp256 = fTemp170 * (fTemp225 - fRec331[1]) + fRec330[1];
			fRec330[0] = 2.0 * (fTemp256 / fTemp171) - fRec330[1];
			fRec331[0] = fRec331[1] + 2.0 * (fTemp170 * fTemp256 / fTemp171);
			double fRec332 = fTemp173 * fTemp256 / fTemp171;
			double fTemp257 = fTemp175 * (fTemp225 - fRec334[1]) + fRec333[1];
			fRec333[0] = 2.0 * (fTemp257 / fTemp176) - fRec333[1];
			fRec334[0] = fRec334[1] + 2.0 * (fTemp175 * fTemp257 / fTemp176);
			double fRec335 = fTemp178 * fTemp257 / fTemp176;
			double fTemp258 = 0.03125 * fRec132[0] * (fRec335 + fRec332 + fRec329 + fRec326 + fRec323 + fRec320 + fRec317 + fRec314 + fRec311 + fRec308 + fRec305 + fRec302 + fRec299 + fRec296 + fRec293 + fRec290 + fRec287 + fRec284 + fRec281 + fRec278 + fRec275 + fRec272 + fRec269 + fRec266 + fRec263 + fRec260 + fRec257 + fRec254 + fRec251 + fRec248 + fRec245 + fRec242) + fRec31[0] * fTemp225;
			fRec235[0] = std::max<double>(fConst1 * fRec235[1], std::fabs(fTemp258));
			fVbargraph11 = FAUSTFLOAT(fRec235[0]);
			fRec15[0] = fTemp258;
			double fTemp259 = (fRec15[0] + fRec13[0] + fRec14[0]) / fTemp0;
			fVec7[IOTA0 & 4194303] = fTemp259;
			double fTemp260 = ((fRec336[1] != 0.0) ? (((fRec337[1] > 0.0) & (fRec337[1] < 1.0)) ? fRec336[1] : 0.0) : (((fRec337[1] == 0.0) & (fSlow16 != fRec338[1])) ? 0.0009765625 : (((fRec337[1] == 1.0) & (fSlow16 != fRec339[1])) ? -0.0009765625 : 0.0)));
			fRec336[0] = fTemp260;
			fRec337[0] = std::max<double>(0.0, std::min<double>(1.0, fRec337[1] + fTemp260));
			fRec338[0] = (((fRec337[1] >= 1.0) & (fRec339[1] != fSlow16)) ? fSlow16 : fRec338[1]);
			fRec339[0] = (((fRec337[1] <= 0.0) & (fRec338[1] != fSlow16)) ? fSlow16 : fRec339[1]);
			double fTemp261 = fVec7[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec338[0])))) & 4194303];
			fRec11[0] = 0.3333333333333333 * fTemp261 + fRec337[0] * (0.0 - 0.3333333333333333 * (fTemp261 - fVec7[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec339[0])))) & 4194303]));
			double fTemp262 = fRec21[0] * fRec341[1];
			fRec348[0] = std::max<double>(fConst1 * fRec348[1], std::fabs(fTemp262));
			fVbargraph12 = FAUSTFLOAT(fRec348[0]);
			double fTemp263 = fTemp262;
			double fTemp264 = fRec21[0] * fRec342[1];
			fRec349[0] = std::max<double>(fConst1 * fRec349[1], std::fabs(fTemp264));
			fVbargraph13 = FAUSTFLOAT(fRec349[0]);
			double fTemp265 = fTemp264;
			double fTemp266 = fTemp6 * (fTemp265 - fTemp263);
			double fTemp267 = fSlow17 * fRec6[1];
			fVec8[IOTA0 & 4194303] = fTemp267;
			double fTemp268 = ((fRec351[1] != 0.0) ? (((fRec352[1] > 0.0) & (fRec352[1] < 1.0)) ? fRec351[1] : 0.0) : (((fRec352[1] == 0.0) & (fSlow18 != fRec353[1])) ? 0.0009765625 : (((fRec352[1] == 1.0) & (fSlow18 != fRec354[1])) ? -0.0009765625 : 0.0)));
			fRec351[0] = fTemp268;
			fRec352[0] = std::max<double>(0.0, std::min<double>(1.0, fRec352[1] + fTemp268));
			fRec353[0] = (((fRec352[1] >= 1.0) & (fRec354[1] != fSlow18)) ? fSlow18 : fRec353[1]);
			fRec354[0] = (((fRec352[1] <= 0.0) & (fRec353[1] != fSlow18)) ? fSlow18 : fRec354[1]);
			double fTemp269 = fVec8[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec353[0])))) & 4194303];
			fRec350[0] = fTemp269 + fRec352[0] * (fVec8[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec354[0])))) & 4194303] - fTemp269);
			fVec9[0] = fRec350[1] + fTemp8 + fTemp263 + fTemp266 + fTemp1;
			fRec347[0] = fTemp266 + fRec350[1] + fTemp263 + fTemp8 + 0.995 * fRec347[1] + (1.2 - (fVec0[1] + fVec9[1]));
			fRec346[0] = std::max<double>(fConst1 * fRec346[1], std::fabs(fRec347[0]));
			fVbargraph14 = FAUSTFLOAT(fRec346[0]);
			double fTemp270 = fRec12[0] * tanh(fRec347[0] / fTemp0);
			fRec345[0] = std::max<double>(fConst1 * fRec345[1], std::fabs(fTemp270));
			fVbargraph15 = FAUSTFLOAT(fRec345[0]);
			double fTemp271 = fTemp270;
			fRec358[0] = fSlow19 + fConst3 * fRec358[1];
			fRec359[0] = fSlow20 + fConst3 * fRec359[1];
			double fTemp272 = fRec359[0] * (147.0 - 27.0 * fRec358[0]);
			double fTemp273 = std::tan(fConst6 * fTemp272);
			double fTemp274 = fTemp273 * (fTemp273 + fTemp15 / fTemp272) + 1.0;
			double fTemp275 = fTemp273 * (fTemp271 - fRec356[1]) + fRec355[1];
			fRec355[0] = 2.0 * (fTemp275 / fTemp274) - fRec355[1];
			fRec356[0] = fRec356[1] + 2.0 * (fTemp273 * fTemp275 / fTemp274);
			fRec360[0] = fSlow21 + fConst3 * fRec360[1];
			double fTemp276 = fRec358[0] * (0.07073352 * fRec360[0] + -0.7955404699999999) + (1.0 - 0.20564242 * fRec360[0]);
			double fRec357 = fTemp275 * fTemp276 / fTemp274;
			double fTemp277 = 5462.0 * fRec360[0];
			double fTemp278 = fRec359[0] * (fTemp277 + fRec358[0] * (184.0 - 5696.0 * fRec360[0]) + 3.38e+03);
			double fTemp279 = std::tan(fConst6 * fTemp278);
			double fTemp280 = fTemp279 * (fTemp279 + fTemp15 / fTemp278) + 1.0;
			double fTemp281 = fTemp279 * (fTemp271 - fRec362[1]) + fRec361[1];
			fRec361[0] = 2.0 * (fTemp281 / fTemp280) - fRec361[1];
			fRec362[0] = fRec362[1] + 2.0 * (fTemp279 * fTemp281 / fTemp280);
			double fTemp282 = fRec358[0] * (0.06439533 - 0.05859501 * fRec360[0]) + (0.00962998 - 0.00539943 * fRec360[0]);
			double fRec363 = fTemp281 * fTemp282 / fTemp280;
			double fTemp283 = fRec359[0] * (1924.0 * fRec360[0] + fRec358[0] * (-67.0 - 1709.0 * fRec360[0]) + 2792.0);
			double fTemp284 = std::tan(fConst6 * fTemp283);
			double fTemp285 = fTemp284 * (fTemp284 + fTemp15 / fTemp283) + 1.0;
			double fTemp286 = fTemp284 * (fTemp271 - fRec365[1]) + fRec364[1];
			fRec364[0] = 2.0 * (fTemp286 / fTemp285) - fRec364[1];
			fRec365[0] = fRec365[1] + 2.0 * (fTemp284 * fTemp286 / fTemp285);
			double fTemp287 = fRec358[0] * (0.18126063 - 0.15936859 * fRec360[0]) + (0.03127152 - 0.026182169999999998 * fRec360[0]);
			double fRec366 = fTemp286 * fTemp287 / fTemp285;
			double fTemp288 = fRec359[0] * (1334.0 * fRec360[0] + fRec358[0] * (69.0 - 1321.0 * fRec360[0]) + 2498.0);
			double fTemp289 = std::tan(fConst6 * fTemp288);
			double fTemp290 = fTemp289 * (fTemp289 + fTemp15 / fTemp288) + 1.0;
			double fTemp291 = fTemp289 * (fTemp271 - fRec368[1]) + fRec367[1];
			fRec367[0] = 2.0 * (fTemp291 / fTemp290) - fRec367[1];
			fRec368[0] = fRec368[1] + 2.0 * (fTemp289 * fTemp291 / fTemp290);
			double fTemp292 = 0.00024740000000000005 * fRec360[0] + fRec358[0] * (0.08007111 - 0.08267900999999998 * fRec360[0]) + 0.01134687;
			double fRec369 = fTemp291 * fTemp292 / fTemp290;
			double fTemp293 = fRec359[0] * (1117.0 * fRec360[0] + fRec358[0] * (-4e+01 - 1001.0 * fRec360[0]) + 2273.0);
			double fTemp294 = std::tan(fConst6 * fTemp293);
			double fTemp295 = fTemp294 * (fTemp294 + fTemp15 / fTemp293) + 1.0;
			double fTemp296 = fTemp294 * (fTemp271 - fRec371[1]) + fRec370[1];
			fRec370[0] = 2.0 * (fTemp296 / fTemp295) - fRec370[1];
			fRec371[0] = fRec371[1] + 2.0 * (fTemp294 * fTemp296 / fTemp295);
			double fTemp297 = 0.009332220000000002 * fRec360[0] + fRec358[0] * (0.26175163 - 0.22162943000000002 * fRec360[0]) + 0.00656447;
			double fRec372 = fTemp296 * fTemp297 / fTemp295;
			double fTemp298 = fRec359[0] * (1041.0 * fRec360[0] + fRec358[0] * (-121.0 - 812.0 * fRec360[0]) + 2054.0);
			double fTemp299 = std::tan(fConst6 * fTemp298);
			double fTemp300 = fTemp299 * (fTemp299 + fTemp15 / fTemp298) + 1.0;
			double fTemp301 = fTemp299 * (fTemp271 - fRec374[1]) + fRec373[1];
			fRec373[0] = 2.0 * (fTemp301 / fTemp300) - fRec373[1];
			fRec374[0] = fRec374[1] + 2.0 * (fTemp299 * fTemp301 / fTemp300);
			double fTemp302 = fRec358[0] * (0.39552505 - 0.38007101 * fRec360[0]) + (0.06985491 - 0.060508160000000005 * fRec360[0]);
			double fRec375 = fTemp301 * fTemp302 / fTemp300;
			double fTemp303 = fRec359[0] * (945.0 * fRec360[0] + fRec358[0] * (-128.0 - 743.0 * fRec360[0]) + 1855.0);
			double fTemp304 = std::tan(fConst6 * fTemp303);
			double fTemp305 = fTemp304 * (fTemp304 + fTemp15 / fTemp303) + 1.0;
			double fTemp306 = fTemp304 * (fTemp271 - fRec377[1]) + fRec376[1];
			fRec376[0] = 2.0 * (fTemp306 / fTemp305) - fRec376[1];
			fRec377[0] = fRec377[1] + 2.0 * (fTemp304 * fTemp306 / fTemp305);
			double fTemp307 = 0.02476806 * fRec360[0] + fRec358[0] * (0.04345912 - 0.05426385 * fRec360[0]) + 0.01093969;
			double fRec378 = fTemp306 * fTemp307 / fTemp305;
			double fTemp308 = 889.0 * fRec360[0];
			double fTemp309 = fRec359[0] * (fTemp308 + fRec358[0] * (-137.0 - 601.0 * fRec360[0]) + 1617.0);
			double fTemp310 = std::tan(fConst6 * fTemp309);
			double fTemp311 = fTemp310 * (fTemp310 + fTemp15 / fTemp309) + 1.0;
			double fTemp312 = fTemp310 * (fTemp271 - fRec380[1]) + fRec379[1];
			fRec379[0] = 2.0 * (fTemp312 / fTemp311) - fRec379[1];
			fRec380[0] = fRec380[1] + 2.0 * (fTemp310 * fTemp312 / fTemp311);
			double fTemp313 = fRec358[0] * (0.89755644 - 0.83241899 * fRec360[0]) + (0.07354127 - 0.06668288 * fRec360[0]);
			double fRec381 = fTemp312 * fTemp313 / fTemp311;
			double fTemp314 = 888.0 * fRec360[0];
			double fTemp315 = fRec359[0] * (fTemp314 + fRec358[0] * (7.0 - 646.0 * fRec360[0]) + 1323.0);
			double fTemp316 = std::tan(fConst6 * fTemp315);
			double fTemp317 = fTemp316 * (fTemp316 + fTemp15 / fTemp315) + 1.0;
			double fTemp318 = fTemp316 * (fTemp271 - fRec383[1]) + fRec382[1];
			fRec382[0] = 2.0 * (fTemp318 / fTemp317) - fRec382[1];
			fRec383[0] = fRec383[1] + 2.0 * (fTemp316 * fTemp318 / fTemp317);
			double fTemp319 = 0.01378994 * fRec360[0] + fRec358[0] * (0.16180601 - 0.17199811 * fRec360[0]) + 0.07170723;
			double fRec384 = fTemp318 * fTemp319 / fTemp317;
			double fTemp320 = fRec359[0] * (741.0 * fRec360[0] + fRec358[0] * (4.0 - 506.0 * fRec360[0]) + 1175.0);
			double fTemp321 = std::tan(fConst6 * fTemp320);
			double fTemp322 = fTemp321 * (fTemp321 + fTemp15 / fTemp320) + 1.0;
			double fTemp323 = fTemp321 * (fTemp271 - fRec386[1]) + fRec385[1];
			fRec385[0] = 2.0 * (fTemp323 / fTemp322) - fRec385[1];
			fRec386[0] = fRec386[1] + 2.0 * (fTemp321 * fTemp323 / fTemp322);
			double fTemp324 = fRec358[0] * (0.29407844000000005 - 0.3172501500000001 * fRec360[0]) + (0.28175268 - 0.21568321999999998 * fRec360[0]);
			double fRec387 = fTemp323 * fTemp324 / fTemp322;
			double fTemp325 = fRec359[0] * (593.0 * fRec360[0] + fRec358[0] * (3.0 - 447.0 * fRec360[0]) + 1028.0);
			double fTemp326 = std::tan(fConst6 * fTemp325);
			double fTemp327 = fTemp326 * (fTemp326 + fTemp15 / fTemp325) + 1.0;
			double fTemp328 = fTemp326 * (fTemp271 - fRec389[1]) + fRec388[1];
			fRec388[0] = 2.0 * (fTemp328 / fTemp327) - fRec388[1];
			fRec389[0] = fRec389[1] + 2.0 * (fTemp326 * fTemp328 / fTemp327);
			double fTemp329 = 0.07792940000000001 * fRec360[0] + fRec358[0] * (0.19518858000000003 * fRec360[0] + 0.16366607) + 0.14442907;
			double fRec390 = fTemp328 * fTemp329 / fTemp327;
			double fTemp330 = fRec359[0] * (444.0 * fRec360[0] + fRec358[0] * (-2.0 - 315.0 * fRec360[0]) + 882.0);
			double fTemp331 = std::tan(fConst6 * fTemp330);
			double fTemp332 = fTemp331 * (fTemp331 + fTemp15 / fTemp330) + 1.0;
			double fTemp333 = fTemp331 * (fTemp271 - fRec392[1]) + fRec391[1];
			fRec391[0] = 2.0 * (fTemp333 / fTemp332) - fRec391[1];
			fRec392[0] = fRec392[1] + 2.0 * (fTemp331 * fTemp333 / fTemp332);
			double fTemp334 = fRec358[0] * (0.14853099000000003 - 0.11225552000000005 * fRec360[0]) + (0.2722688 - 0.2582559 * fRec360[0]);
			double fRec393 = fTemp333 * fTemp334 / fTemp332;
			double fTemp335 = fRec359[0] * (297.0 * fRec360[0] + fRec358[0] * (1.0 - 157.0 * fRec360[0]) + 735.0);
			double fTemp336 = std::tan(fConst6 * fTemp335);
			double fTemp337 = fTemp336 * (fTemp336 + fTemp15 / fTemp335) + 1.0;
			double fTemp338 = fTemp336 * (fTemp271 - fRec395[1]) + fRec394[1];
			fRec394[0] = 2.0 * (fTemp338 / fTemp337) - fRec394[1];
			fRec395[0] = fRec395[1] + 2.0 * (fTemp336 * fTemp338 / fTemp337);
			double fTemp339 = fRec358[0] * (0.17857318999999994 - 0.36552292 * fRec360[0]) + (0.54357606 - 0.31600273 * fRec360[0]);
			double fRec396 = fTemp338 * fTemp339 / fTemp337;
			double fTemp340 = fRec359[0] * (203.0 * fRec360[0] + fRec358[0] * (3.0 - 29.0 * fRec360[0]) + 534.0);
			double fTemp341 = std::tan(fConst6 * fTemp340);
			double fTemp342 = fTemp341 * (fTemp341 + fTemp15 / fTemp340) + 1.0;
			double fTemp343 = fTemp341 * (fTemp271 - fRec398[1]) + fRec397[1];
			fRec397[0] = 2.0 * (fTemp343 / fTemp342) - fRec397[1];
			fRec398[0] = fRec398[1] + 2.0 * (fTemp341 * fTemp343 / fTemp342);
			double fTemp344 = 0.67536956 * fRec360[0] + fRec358[0] * (0.16028896 - 0.80657534 * fRec360[0]) + 0.0250452;
			double fRec399 = fTemp343 * fTemp344 / fTemp342;
			double fTemp345 = fRec359[0] * (75.0 * fRec360[0] + fRec358[0] * (0.0 - 79.0 * fRec360[0]) + 367.0);
			double fTemp346 = std::tan(fConst6 * fTemp345);
			double fTemp347 = fTemp346 * (fTemp346 + fTemp15 / fTemp345) + 1.0;
			double fTemp348 = fTemp346 * (fTemp271 - fRec401[1]) + fRec400[1];
			fRec400[0] = 2.0 * (fTemp348 / fTemp347) - fRec400[1];
			fRec401[0] = fRec401[1] + 2.0 * (fTemp346 * fTemp348 / fTemp347);
			double fTemp349 = 0.28677124 * fRec360[0] + fRec358[0] * (0.27661398 - 0.52141959 * fRec360[0]) + 0.02470587;
			double fRec402 = fTemp348 * fTemp349 / fTemp347;
			double fTemp350 = fRec359[0] * (92.0 * fRec360[0] + fRec358[0] * (-1e+01 - 96.0 * fRec360[0]) + 203.0);
			double fTemp351 = std::tan(fConst6 * fTemp350);
			double fTemp352 = fTemp351 * (fTemp351 + fTemp15 / fTemp350) + 1.0;
			double fTemp353 = fTemp351 * (fTemp271 - fRec404[1]) + fRec403[1];
			fRec403[0] = 2.0 * (fTemp353 / fTemp352) - fRec403[1];
			fRec404[0] = fRec404[1] + 2.0 * (fTemp351 * fTemp353 / fTemp352);
			double fTemp354 = 0.9594288 * fRec360[0] + fRec358[0] * (0.32743217999999996 - 0.9405872099999999 * fRec360[0]) + 0.0405712;
			double fRec405 = fTemp353 * fTemp354 / fTemp352;
			double fTemp355 = 6.0 * fRec360[0];
			double fTemp356 = fRec359[0] * (fRec358[0] * (fTemp355 + -3.0) + (53.0 - fTemp355));
			double fTemp357 = std::tan(fConst6 * fTemp356);
			double fTemp358 = fTemp357 * (fTemp357 + fTemp15 / fTemp356) + 1.0;
			double fTemp359 = fTemp357 * (fTemp271 - fRec407[1]) + fRec406[1];
			fRec406[0] = 2.0 * (fTemp359 / fTemp358) - fRec406[1];
			fRec407[0] = fRec407[1] + 2.0 * (fTemp357 * fTemp359 / fTemp358);
			double fTemp360 = fRec358[0] * (0.02738166999999999 * fRec360[0] + 0.04900900000000001) + (0.07116083 - 0.059562029999999995 * fRec360[0]);
			double fRec408 = fTemp359 * fTemp360 / fTemp358;
			double fTemp361 = fRec359[0] * (82.0 * fRec360[0] + fRec358[0] * (14.0 - 89.0 * fRec360[0]) + 294.0);
			double fTemp362 = std::tan(fConst6 * fTemp361);
			double fTemp363 = fTemp362 * (fTemp362 + fTemp15 / fTemp361) + 1.0;
			double fTemp364 = fTemp362 * (fTemp271 - fRec410[1]) + fRec409[1];
			fRec409[0] = 2.0 * (fTemp364 / fTemp363) - fRec409[1];
			fRec410[0] = fRec410[1] + 2.0 * (fTemp362 * fTemp364 / fTemp363);
			double fTemp365 = fRec358[0] * (0.45472109 * fRec360[0] + -0.34135506) + (0.49828005 - 0.49066910999999996 * fRec360[0]);
			double fRec411 = fTemp364 * fTemp365 / fTemp363;
			double fTemp366 = fRec359[0] * (148.0 * fRec360[0] + fRec358[0] * (12.0 - 13.0 * fRec360[0]) + 441.0);
			double fTemp367 = std::tan(fConst6 * fTemp366);
			double fTemp368 = fTemp367 * (fTemp367 + fTemp15 / fTemp366) + 1.0;
			double fTemp369 = fTemp367 * (fTemp271 - fRec413[1]) + fRec412[1];
			fRec412[0] = 2.0 * (fTemp369 / fTemp368) - fRec412[1];
			fRec413[0] = fRec413[1] + 2.0 * (fTemp367 * fTemp369 / fTemp368);
			double fTemp370 = 0.026025509999999974 * fRec360[0] + fRec358[0] * (0.82424861 * fRec360[0] + -0.10070198) + 0.25042786;
			double fRec414 = fTemp369 * fTemp370 / fTemp368;
			double fTemp371 = fRec359[0] * (296.0 * fRec360[0] + fRec358[0] * (1.0 - 1.1e+02 * fRec360[0]) + 588.0);
			double fTemp372 = std::tan(fConst6 * fTemp371);
			double fTemp373 = fTemp372 * (fTemp372 + fTemp15 / fTemp371) + 1.0;
			double fTemp374 = fTemp372 * (fTemp271 - fRec416[1]) + fRec415[1];
			fRec415[0] = 2.0 * (fTemp374 / fTemp373) - fRec415[1];
			fRec416[0] = fRec416[1] + 2.0 * (fTemp372 * fTemp374 / fTemp373);
			double fTemp375 = 0.27049557 * fRec360[0] + fRec358[0] * (0.23776758000000003 - 0.53709331 * fRec360[0]) + 0.09954785;
			double fRec417 = fTemp374 * fTemp375 / fTemp373;
			double fTemp376 = fRec359[0] * (394.0 * fRec360[0] + fRec358[0] * (43.0 - 285.0 * fRec360[0]) + 785.0);
			double fTemp377 = std::tan(fConst6 * fTemp376);
			double fTemp378 = fTemp377 * (fTemp377 + fTemp15 / fTemp376) + 1.0;
			double fTemp379 = fTemp377 * (fTemp271 - fRec419[1]) + fRec418[1];
			fRec418[0] = 2.0 * (fTemp379 / fTemp378) - fRec418[1];
			fRec419[0] = fRec419[1] + 2.0 * (fTemp377 * fTemp379 / fTemp378);
			double fTemp380 = 0.24706891000000003 * fRec360[0] + fRec358[0] * (0.037263420000000005 - 0.24153450000000004 * fRec360[0]) + 0.01573797;
			double fRec420 = fTemp379 * fTemp380 / fTemp378;
			double fTemp381 = fRec359[0] * (513.0 * fRec360[0] + fRec358[0] * (3.0 - 381.0 * fRec360[0]) + 961.0);
			double fTemp382 = std::tan(fConst6 * fTemp381);
			double fTemp383 = fTemp382 * (fTemp382 + fTemp15 / fTemp381) + 1.0;
			double fTemp384 = fTemp382 * (fTemp271 - fRec422[1]) + fRec421[1];
			fRec421[0] = 2.0 * (fTemp384 / fTemp383) - fRec421[1];
			fRec422[0] = fRec422[1] + 2.0 * (fTemp382 * fTemp384 / fTemp383);
			double fTemp385 = 0.25012827 * fRec360[0] + fRec358[0] * (0.11585875999999999 - 0.20043951 * fRec360[0]) + 0.01228042;
			double fRec423 = fTemp384 * fTemp385 / fTemp383;
			double fTemp386 = fRec359[0] * (6.9e+02 * fRec360[0] + fRec358[0] * (23.0 - 483.0 * fRec360[0]) + 1078.0);
			double fTemp387 = std::tan(fConst6 * fTemp386);
			double fTemp388 = fTemp387 * (fTemp387 + fTemp15 / fTemp386) + 1.0;
			double fTemp389 = fTemp387 * (fTemp271 - fRec425[1]) + fRec424[1];
			fRec424[0] = 2.0 * (fTemp389 / fTemp388) - fRec424[1];
			fRec425[0] = fRec425[1] + 2.0 * (fTemp387 * fTemp389 / fTemp388);
			double fTemp390 = 0.08014510000000001 * fRec360[0] + fRec358[0] * (0.08188717000000001 - 0.15931663000000001 * fRec360[0]) + 0.01626654;
			double fRec426 = fTemp389 * fTemp390 / fTemp388;
			double fTemp391 = fRec359[0] * (794.0 * fRec360[0] + fRec358[0] * (6.0 - 563.0 * fRec360[0]) + 1269.0);
			double fTemp392 = std::tan(fConst6 * fTemp391);
			double fTemp393 = fTemp392 * (fTemp392 + fTemp15 / fTemp391) + 1.0;
			double fTemp394 = fTemp392 * (fTemp271 - fRec428[1]) + fRec427[1];
			fRec427[0] = 2.0 * (fTemp394 / fTemp393) - fRec427[1];
			fRec428[0] = fRec428[1] + 2.0 * (fTemp392 * fTemp394 / fTemp393);
			double fTemp395 = 0.15692174 * fRec360[0] + fRec358[0] * (0.019392789999999997 - 0.13171841 * fRec360[0]) + 0.02115358;
			double fRec429 = fTemp394 * fTemp395 / fTemp393;
			double fTemp396 = fRec359[0] * (fTemp314 + fRec358[0] * (-62.0 - 612.0 * fRec360[0]) + 1.47e+03);
			double fTemp397 = std::tan(fConst6 * fTemp396);
			double fTemp398 = fTemp397 * (fTemp397 + fTemp15 / fTemp396) + 1.0;
			double fTemp399 = fTemp397 * (fTemp271 - fRec431[1]) + fRec430[1];
			fRec430[0] = 2.0 * (fTemp399 / fTemp398) - fRec430[1];
			fRec431[0] = fRec431[1] + 2.0 * (fTemp397 * fTemp399 / fTemp398);
			double fTemp400 = fRec358[0] * (0.020997170000000002 - 0.020033680000000005 * fRec360[0]) + (0.06191843 - 0.02241523 * fRec360[0]);
			double fRec432 = fTemp399 * fTemp400 / fTemp398;
			double fTemp401 = fRec359[0] * (fTemp308 + fRec358[0] * (-134.0 - 649.0 * fRec360[0]) + 1764.0);
			double fTemp402 = std::tan(fConst6 * fTemp401);
			double fTemp403 = fTemp402 * (fTemp402 + fTemp15 / fTemp401) + 1.0;
			double fTemp404 = fTemp402 * (fTemp271 - fRec434[1]) + fRec433[1];
			fRec433[0] = 2.0 * (fTemp404 / fTemp403) - fRec433[1];
			fRec434[0] = fRec434[1] + 2.0 * (fTemp402 * fTemp404 / fTemp403);
			double fTemp405 = fRec358[0] * (0.94873963 - 0.9622067 * fRec360[0]) + (0.05126037 - 0.02103158 * fRec360[0]);
			double fRec435 = fTemp404 * fTemp405 / fTemp403;
			double fTemp406 = fRec359[0] * (1037.0 * fRec360[0] + fRec358[0] * (-128.0 - 751.0 * fRec360[0]) + 1.91e+03);
			double fTemp407 = std::tan(fConst6 * fTemp406);
			double fTemp408 = fTemp407 * (fTemp407 + fTemp15 / fTemp406) + 1.0;
			double fTemp409 = fTemp407 * (fTemp271 - fRec437[1]) + fRec436[1];
			fRec436[0] = 2.0 * (fTemp409 / fTemp408) - fRec436[1];
			fRec437[0] = fRec437[1] + 2.0 * (fTemp407 * fTemp409 / fTemp408);
			double fTemp410 = fRec358[0] * (0.58336649 - 0.5666712700000001 * fRec360[0]) + (0.0343155 - 0.02668976 * fRec360[0]);
			double fRec438 = fTemp409 * fTemp410 / fTemp408;
			double fTemp411 = fRec359[0] * (1038.0 * fRec360[0] + fRec358[0] * (-119.0 - 846.0 * fRec360[0]) + 2204.0);
			double fTemp412 = std::tan(fConst6 * fTemp411);
			double fTemp413 = fTemp412 * (fTemp412 + fTemp15 / fTemp411) + 1.0;
			double fTemp414 = fTemp412 * (fTemp271 - fRec440[1]) + fRec439[1];
			fRec439[0] = 2.0 * (fTemp414 / fTemp413) - fRec439[1];
			fRec440[0] = fRec440[1] + 2.0 * (fTemp412 * fTemp414 / fTemp413);
			double fTemp415 = fRec358[0] * (0.5577936099999999 - 0.54352849 * fRec360[0]) + (0.09585942 - 0.086804 * fRec360[0]);
			double fRec441 = fTemp414 * fTemp415 / fTemp413;
			double fTemp416 = fRec359[0] * (1186.0 * fRec360[0] + fRec358[0] * (51.0 - 1.13e+03 * fRec360[0]) + 2351.0);
			double fTemp417 = std::tan(fConst6 * fTemp416);
			double fTemp418 = fTemp417 * (fTemp417 + fTemp15 / fTemp416) + 1.0;
			double fTemp419 = fTemp417 * (fTemp271 - fRec443[1]) + fRec442[1];
			fRec442[0] = 2.0 * (fTemp419 / fTemp418) - fRec442[1];
			fRec443[0] = fRec443[1] + 2.0 * (fTemp417 * fTemp419 / fTemp418);
			double fTemp420 = fRec358[0] * (0.18329145 - 0.17669554 * fRec360[0]) + (0.01233555 - 0.008431840000000001 * fRec360[0]);
			double fRec444 = fTemp419 * fTemp420 / fTemp418;
			double fTemp421 = fRec359[0] * (1481.0 * fRec360[0] + fRec358[0] * (13.0 - 1359.0 * fRec360[0]) + 2645.0);
			double fTemp422 = std::tan(fConst6 * fTemp421);
			double fTemp423 = fTemp422 * (fTemp422 + fTemp15 / fTemp421) + 1.0;
			double fTemp424 = fTemp422 * (fTemp271 - fRec446[1]) + fRec445[1];
			fRec445[0] = 2.0 * (fTemp424 / fTemp423) - fRec445[1];
			fRec446[0] = fRec446[1] + 2.0 * (fTemp422 * fTemp424 / fTemp423);
			double fTemp425 = fRec358[0] * (0.052822430000000004 - 0.026333230000000006 * fRec360[0]) + (0.01055565 - 0.00626412 * fRec360[0]);
			double fRec447 = fTemp424 * fTemp425 / fTemp423;
			double fTemp426 = fRec359[0] * (fTemp277 + fRec358[0] * (152.0 - 5648.0 * fRec360[0]) + 3233.0);
			double fTemp427 = std::tan(fConst6 * fTemp426);
			double fTemp428 = fTemp427 * (fTemp427 + fTemp15 / fTemp426) + 1.0;
			double fTemp429 = fTemp427 * (fTemp271 - fRec449[1]) + fRec448[1];
			fRec448[0] = 2.0 * (fTemp429 / fTemp428) - fRec448[1];
			fRec449[0] = fRec449[1] + 2.0 * (fTemp427 * fTemp429 / fTemp428);
			double fTemp430 = fRec358[0] * (0.03251611 - 0.026476020000000003 * fRec360[0]) + (0.01587526 - 0.011935889999999998 * fRec360[0]);
			double fRec450 = fTemp429 * fTemp430 / fTemp428;
			double fTemp431 = fRec359[0] * (5463.0 * fRec360[0] + fRec358[0] * (189.0 - 5063.0 * fRec360[0]) + 3527.0);
			double fTemp432 = std::tan(fConst6 * fTemp431);
			double fTemp433 = fTemp432 * (fTemp432 + fTemp15 / fTemp431) + 1.0;
			double fTemp434 = fTemp432 * (fTemp271 - fRec452[1]) + fRec451[1];
			fRec451[0] = 2.0 * (fTemp434 / fTemp433) - fRec451[1];
			fRec452[0] = fRec452[1] + 2.0 * (fTemp432 * fTemp434 / fTemp433);
			double fTemp435 = fRec358[0] * (0.14146586 - 0.1338637 * fRec360[0]) + (0.0068168 - 0.0019190699999999993 * fRec360[0]);
			double fRec453 = fTemp434 * fTemp435 / fTemp433;
			double fTemp436 = 0.03125 * fRec132[0] * (fRec453 + fRec450 + fRec447 + fRec444 + fRec441 + fRec438 + fRec435 + fRec432 + fRec429 + fRec426 + fRec423 + fRec420 + fRec417 + fRec414 + fRec411 + fRec408 + fRec405 + fRec402 + fRec399 + fRec396 + fRec393 + fRec390 + fRec387 + fRec384 + fRec381 + fRec378 + fRec375 + fRec372 + fRec369 + fRec366 + fRec363 + fRec357) + fRec31[0] * fTemp271;
			fRec344[0] = std::max<double>(fConst1 * fRec344[1], std::fabs(fTemp436));
			fVbargraph16 = FAUSTFLOAT(fRec344[0]);
			fRec341[0] = fTemp436;
			double fTemp437 = fRec21[0] * fRec343[1];
			fRec458[0] = std::max<double>(fConst1 * fRec458[1], std::fabs(fTemp437));
			fVbargraph17 = FAUSTFLOAT(fRec458[0]);
			double fTemp438 = fTemp437;
			double fTemp439 = fRec23[0] * (fTemp263 * (fRec138[0] - fTemp438) - fTemp265);
			double fTemp440 = fTemp8 + fRec350[1];
			double fTemp441 = fTemp440 + fTemp265;
			fVec10[0] = fTemp441 + fTemp439 + fTemp180;
			fRec457[0] = fTemp439 + 0.995 * fRec457[1] + fTemp441 + (1.3 - (fVec3[1] + fVec10[1]));
			fRec456[0] = std::max<double>(fConst1 * fRec456[1], std::fabs(fRec457[0]));
			fVbargraph18 = FAUSTFLOAT(fRec456[0]);
			double fTemp442 = fRec12[0] * tanh(fRec457[0] / fTemp0);
			fRec455[0] = std::max<double>(fConst1 * fRec455[1], std::fabs(fTemp442));
			fVbargraph19 = FAUSTFLOAT(fRec455[0]);
			double fTemp443 = fTemp442;
			double fTemp444 = fTemp273 * (fTemp443 - fRec460[1]) + fRec459[1];
			fRec459[0] = 2.0 * (fTemp444 / fTemp274) - fRec459[1];
			fRec460[0] = fRec460[1] + 2.0 * (fTemp273 * fTemp444 / fTemp274);
			double fRec461 = fTemp276 * fTemp444 / fTemp274;
			double fTemp445 = fTemp279 * (fTemp443 - fRec463[1]) + fRec462[1];
			fRec462[0] = 2.0 * (fTemp445 / fTemp280) - fRec462[1];
			fRec463[0] = fRec463[1] + 2.0 * (fTemp279 * fTemp445 / fTemp280);
			double fRec464 = fTemp282 * fTemp445 / fTemp280;
			double fTemp446 = fTemp284 * (fTemp443 - fRec466[1]) + fRec465[1];
			fRec465[0] = 2.0 * (fTemp446 / fTemp285) - fRec465[1];
			fRec466[0] = fRec466[1] + 2.0 * (fTemp284 * fTemp446 / fTemp285);
			double fRec467 = fTemp287 * fTemp446 / fTemp285;
			double fTemp447 = fTemp289 * (fTemp443 - fRec469[1]) + fRec468[1];
			fRec468[0] = 2.0 * (fTemp447 / fTemp290) - fRec468[1];
			fRec469[0] = fRec469[1] + 2.0 * (fTemp289 * fTemp447 / fTemp290);
			double fRec470 = fTemp292 * fTemp447 / fTemp290;
			double fTemp448 = fTemp294 * (fTemp443 - fRec472[1]) + fRec471[1];
			fRec471[0] = 2.0 * (fTemp448 / fTemp295) - fRec471[1];
			fRec472[0] = fRec472[1] + 2.0 * (fTemp294 * fTemp448 / fTemp295);
			double fRec473 = fTemp297 * fTemp448 / fTemp295;
			double fTemp449 = fTemp299 * (fTemp443 - fRec475[1]) + fRec474[1];
			fRec474[0] = 2.0 * (fTemp449 / fTemp300) - fRec474[1];
			fRec475[0] = fRec475[1] + 2.0 * (fTemp299 * fTemp449 / fTemp300);
			double fRec476 = fTemp302 * fTemp449 / fTemp300;
			double fTemp450 = fTemp304 * (fTemp443 - fRec478[1]) + fRec477[1];
			fRec477[0] = 2.0 * (fTemp450 / fTemp305) - fRec477[1];
			fRec478[0] = fRec478[1] + 2.0 * (fTemp304 * fTemp450 / fTemp305);
			double fRec479 = fTemp307 * fTemp450 / fTemp305;
			double fTemp451 = fTemp310 * (fTemp443 - fRec481[1]) + fRec480[1];
			fRec480[0] = 2.0 * (fTemp451 / fTemp311) - fRec480[1];
			fRec481[0] = fRec481[1] + 2.0 * (fTemp310 * fTemp451 / fTemp311);
			double fRec482 = fTemp313 * fTemp451 / fTemp311;
			double fTemp452 = fTemp316 * (fTemp443 - fRec484[1]) + fRec483[1];
			fRec483[0] = 2.0 * (fTemp452 / fTemp317) - fRec483[1];
			fRec484[0] = fRec484[1] + 2.0 * (fTemp316 * fTemp452 / fTemp317);
			double fRec485 = fTemp319 * fTemp452 / fTemp317;
			double fTemp453 = fTemp321 * (fTemp443 - fRec487[1]) + fRec486[1];
			fRec486[0] = 2.0 * (fTemp453 / fTemp322) - fRec486[1];
			fRec487[0] = fRec487[1] + 2.0 * (fTemp321 * fTemp453 / fTemp322);
			double fRec488 = fTemp324 * fTemp453 / fTemp322;
			double fTemp454 = fTemp326 * (fTemp443 - fRec490[1]) + fRec489[1];
			fRec489[0] = 2.0 * (fTemp454 / fTemp327) - fRec489[1];
			fRec490[0] = fRec490[1] + 2.0 * (fTemp326 * fTemp454 / fTemp327);
			double fRec491 = fTemp329 * fTemp454 / fTemp327;
			double fTemp455 = fTemp331 * (fTemp443 - fRec493[1]) + fRec492[1];
			fRec492[0] = 2.0 * (fTemp455 / fTemp332) - fRec492[1];
			fRec493[0] = fRec493[1] + 2.0 * (fTemp331 * fTemp455 / fTemp332);
			double fRec494 = fTemp334 * fTemp455 / fTemp332;
			double fTemp456 = fTemp336 * (fTemp443 - fRec496[1]) + fRec495[1];
			fRec495[0] = 2.0 * (fTemp456 / fTemp337) - fRec495[1];
			fRec496[0] = fRec496[1] + 2.0 * (fTemp336 * fTemp456 / fTemp337);
			double fRec497 = fTemp339 * fTemp456 / fTemp337;
			double fTemp457 = fTemp341 * (fTemp443 - fRec499[1]) + fRec498[1];
			fRec498[0] = 2.0 * (fTemp457 / fTemp342) - fRec498[1];
			fRec499[0] = fRec499[1] + 2.0 * (fTemp341 * fTemp457 / fTemp342);
			double fRec500 = fTemp344 * fTemp457 / fTemp342;
			double fTemp458 = fTemp346 * (fTemp443 - fRec502[1]) + fRec501[1];
			fRec501[0] = 2.0 * (fTemp458 / fTemp347) - fRec501[1];
			fRec502[0] = fRec502[1] + 2.0 * (fTemp346 * fTemp458 / fTemp347);
			double fRec503 = fTemp349 * fTemp458 / fTemp347;
			double fTemp459 = fTemp351 * (fTemp443 - fRec505[1]) + fRec504[1];
			fRec504[0] = 2.0 * (fTemp459 / fTemp352) - fRec504[1];
			fRec505[0] = fRec505[1] + 2.0 * (fTemp351 * fTemp459 / fTemp352);
			double fRec506 = fTemp354 * fTemp459 / fTemp352;
			double fTemp460 = fTemp357 * (fTemp443 - fRec508[1]) + fRec507[1];
			fRec507[0] = 2.0 * (fTemp460 / fTemp358) - fRec507[1];
			fRec508[0] = fRec508[1] + 2.0 * (fTemp357 * fTemp460 / fTemp358);
			double fRec509 = fTemp360 * fTemp460 / fTemp358;
			double fTemp461 = fTemp362 * (fTemp443 - fRec511[1]) + fRec510[1];
			fRec510[0] = 2.0 * (fTemp461 / fTemp363) - fRec510[1];
			fRec511[0] = fRec511[1] + 2.0 * (fTemp362 * fTemp461 / fTemp363);
			double fRec512 = fTemp365 * fTemp461 / fTemp363;
			double fTemp462 = fTemp367 * (fTemp443 - fRec514[1]) + fRec513[1];
			fRec513[0] = 2.0 * (fTemp462 / fTemp368) - fRec513[1];
			fRec514[0] = fRec514[1] + 2.0 * (fTemp367 * fTemp462 / fTemp368);
			double fRec515 = fTemp370 * fTemp462 / fTemp368;
			double fTemp463 = fTemp372 * (fTemp443 - fRec517[1]) + fRec516[1];
			fRec516[0] = 2.0 * (fTemp463 / fTemp373) - fRec516[1];
			fRec517[0] = fRec517[1] + 2.0 * (fTemp372 * fTemp463 / fTemp373);
			double fRec518 = fTemp375 * fTemp463 / fTemp373;
			double fTemp464 = fTemp377 * (fTemp443 - fRec520[1]) + fRec519[1];
			fRec519[0] = 2.0 * (fTemp464 / fTemp378) - fRec519[1];
			fRec520[0] = fRec520[1] + 2.0 * (fTemp377 * fTemp464 / fTemp378);
			double fRec521 = fTemp380 * fTemp464 / fTemp378;
			double fTemp465 = fTemp382 * (fTemp443 - fRec523[1]) + fRec522[1];
			fRec522[0] = 2.0 * (fTemp465 / fTemp383) - fRec522[1];
			fRec523[0] = fRec523[1] + 2.0 * (fTemp382 * fTemp465 / fTemp383);
			double fRec524 = fTemp385 * fTemp465 / fTemp383;
			double fTemp466 = fTemp387 * (fTemp443 - fRec526[1]) + fRec525[1];
			fRec525[0] = 2.0 * (fTemp466 / fTemp388) - fRec525[1];
			fRec526[0] = fRec526[1] + 2.0 * (fTemp387 * fTemp466 / fTemp388);
			double fRec527 = fTemp390 * fTemp466 / fTemp388;
			double fTemp467 = fTemp392 * (fTemp443 - fRec529[1]) + fRec528[1];
			fRec528[0] = 2.0 * (fTemp467 / fTemp393) - fRec528[1];
			fRec529[0] = fRec529[1] + 2.0 * (fTemp392 * fTemp467 / fTemp393);
			double fRec530 = fTemp395 * fTemp467 / fTemp393;
			double fTemp468 = fTemp397 * (fTemp443 - fRec532[1]) + fRec531[1];
			fRec531[0] = 2.0 * (fTemp468 / fTemp398) - fRec531[1];
			fRec532[0] = fRec532[1] + 2.0 * (fTemp397 * fTemp468 / fTemp398);
			double fRec533 = fTemp400 * fTemp468 / fTemp398;
			double fTemp469 = fTemp402 * (fTemp443 - fRec535[1]) + fRec534[1];
			fRec534[0] = 2.0 * (fTemp469 / fTemp403) - fRec534[1];
			fRec535[0] = fRec535[1] + 2.0 * (fTemp402 * fTemp469 / fTemp403);
			double fRec536 = fTemp405 * fTemp469 / fTemp403;
			double fTemp470 = fTemp407 * (fTemp443 - fRec538[1]) + fRec537[1];
			fRec537[0] = 2.0 * (fTemp470 / fTemp408) - fRec537[1];
			fRec538[0] = fRec538[1] + 2.0 * (fTemp407 * fTemp470 / fTemp408);
			double fRec539 = fTemp410 * fTemp470 / fTemp408;
			double fTemp471 = fTemp412 * (fTemp443 - fRec541[1]) + fRec540[1];
			fRec540[0] = 2.0 * (fTemp471 / fTemp413) - fRec540[1];
			fRec541[0] = fRec541[1] + 2.0 * (fTemp412 * fTemp471 / fTemp413);
			double fRec542 = fTemp415 * fTemp471 / fTemp413;
			double fTemp472 = fTemp417 * (fTemp443 - fRec544[1]) + fRec543[1];
			fRec543[0] = 2.0 * (fTemp472 / fTemp418) - fRec543[1];
			fRec544[0] = fRec544[1] + 2.0 * (fTemp417 * fTemp472 / fTemp418);
			double fRec545 = fTemp420 * fTemp472 / fTemp418;
			double fTemp473 = fTemp422 * (fTemp443 - fRec547[1]) + fRec546[1];
			fRec546[0] = 2.0 * (fTemp473 / fTemp423) - fRec546[1];
			fRec547[0] = fRec547[1] + 2.0 * (fTemp422 * fTemp473 / fTemp423);
			double fRec548 = fTemp425 * fTemp473 / fTemp423;
			double fTemp474 = fTemp427 * (fTemp443 - fRec550[1]) + fRec549[1];
			fRec549[0] = 2.0 * (fTemp474 / fTemp428) - fRec549[1];
			fRec550[0] = fRec550[1] + 2.0 * (fTemp427 * fTemp474 / fTemp428);
			double fRec551 = fTemp430 * fTemp474 / fTemp428;
			double fTemp475 = fTemp432 * (fTemp443 - fRec553[1]) + fRec552[1];
			fRec552[0] = 2.0 * (fTemp475 / fTemp433) - fRec552[1];
			fRec553[0] = fRec553[1] + 2.0 * (fTemp432 * fTemp475 / fTemp433);
			double fRec554 = fTemp435 * fTemp475 / fTemp433;
			double fTemp476 = 0.03125 * fRec132[0] * (fRec554 + fRec551 + fRec548 + fRec545 + fRec542 + fRec539 + fRec536 + fRec533 + fRec530 + fRec527 + fRec524 + fRec521 + fRec518 + fRec515 + fRec512 + fRec509 + fRec506 + fRec503 + fRec500 + fRec497 + fRec494 + fRec491 + fRec488 + fRec485 + fRec482 + fRec479 + fRec476 + fRec473 + fRec470 + fRec467 + fRec464 + fRec461) + fRec31[0] * fTemp443;
			fRec454[0] = std::max<double>(fConst1 * fRec454[1], std::fabs(fTemp476));
			fVbargraph20 = FAUSTFLOAT(fRec454[0]);
			fRec342[0] = fTemp476;
			double fTemp477 = fRec23[0] * (fTemp263 * fTemp265 - fRec239[0] * fTemp438);
			double fTemp478 = fTemp440 + fTemp438;
			fVec11[0] = fTemp478 + fTemp477 + fTemp221;
			fRec558[0] = fTemp477 + 0.995 * fRec558[1] + fTemp478 + (1.6 - (fVec5[1] + fVec11[1]));
			fRec557[0] = std::max<double>(fConst1 * fRec557[1], std::fabs(fRec558[0]));
			fVbargraph21 = FAUSTFLOAT(fRec557[0]);
			double fTemp479 = fRec12[0] * tanh(fRec558[0] / fTemp0);
			fRec556[0] = std::max<double>(fConst1 * fRec556[1], std::fabs(fTemp479));
			fVbargraph22 = FAUSTFLOAT(fRec556[0]);
			double fTemp480 = fTemp479;
			double fTemp481 = fTemp273 * (fTemp480 - fRec560[1]) + fRec559[1];
			fRec559[0] = 2.0 * (fTemp481 / fTemp274) - fRec559[1];
			fRec560[0] = fRec560[1] + 2.0 * (fTemp273 * fTemp481 / fTemp274);
			double fRec561 = fTemp276 * fTemp481 / fTemp274;
			double fTemp482 = fTemp279 * (fTemp480 - fRec563[1]) + fRec562[1];
			fRec562[0] = 2.0 * (fTemp482 / fTemp280) - fRec562[1];
			fRec563[0] = fRec563[1] + 2.0 * (fTemp279 * fTemp482 / fTemp280);
			double fRec564 = fTemp282 * fTemp482 / fTemp280;
			double fTemp483 = fTemp284 * (fTemp480 - fRec566[1]) + fRec565[1];
			fRec565[0] = 2.0 * (fTemp483 / fTemp285) - fRec565[1];
			fRec566[0] = fRec566[1] + 2.0 * (fTemp284 * fTemp483 / fTemp285);
			double fRec567 = fTemp287 * fTemp483 / fTemp285;
			double fTemp484 = fTemp289 * (fTemp480 - fRec569[1]) + fRec568[1];
			fRec568[0] = 2.0 * (fTemp484 / fTemp290) - fRec568[1];
			fRec569[0] = fRec569[1] + 2.0 * (fTemp289 * fTemp484 / fTemp290);
			double fRec570 = fTemp292 * fTemp484 / fTemp290;
			double fTemp485 = fTemp294 * (fTemp480 - fRec572[1]) + fRec571[1];
			fRec571[0] = 2.0 * (fTemp485 / fTemp295) - fRec571[1];
			fRec572[0] = fRec572[1] + 2.0 * (fTemp294 * fTemp485 / fTemp295);
			double fRec573 = fTemp297 * fTemp485 / fTemp295;
			double fTemp486 = fTemp299 * (fTemp480 - fRec575[1]) + fRec574[1];
			fRec574[0] = 2.0 * (fTemp486 / fTemp300) - fRec574[1];
			fRec575[0] = fRec575[1] + 2.0 * (fTemp299 * fTemp486 / fTemp300);
			double fRec576 = fTemp302 * fTemp486 / fTemp300;
			double fTemp487 = fTemp304 * (fTemp480 - fRec578[1]) + fRec577[1];
			fRec577[0] = 2.0 * (fTemp487 / fTemp305) - fRec577[1];
			fRec578[0] = fRec578[1] + 2.0 * (fTemp304 * fTemp487 / fTemp305);
			double fRec579 = fTemp307 * fTemp487 / fTemp305;
			double fTemp488 = fTemp310 * (fTemp480 - fRec581[1]) + fRec580[1];
			fRec580[0] = 2.0 * (fTemp488 / fTemp311) - fRec580[1];
			fRec581[0] = fRec581[1] + 2.0 * (fTemp310 * fTemp488 / fTemp311);
			double fRec582 = fTemp313 * fTemp488 / fTemp311;
			double fTemp489 = fTemp316 * (fTemp480 - fRec584[1]) + fRec583[1];
			fRec583[0] = 2.0 * (fTemp489 / fTemp317) - fRec583[1];
			fRec584[0] = fRec584[1] + 2.0 * (fTemp316 * fTemp489 / fTemp317);
			double fRec585 = fTemp319 * fTemp489 / fTemp317;
			double fTemp490 = fTemp321 * (fTemp480 - fRec587[1]) + fRec586[1];
			fRec586[0] = 2.0 * (fTemp490 / fTemp322) - fRec586[1];
			fRec587[0] = fRec587[1] + 2.0 * (fTemp321 * fTemp490 / fTemp322);
			double fRec588 = fTemp324 * fTemp490 / fTemp322;
			double fTemp491 = fTemp326 * (fTemp480 - fRec590[1]) + fRec589[1];
			fRec589[0] = 2.0 * (fTemp491 / fTemp327) - fRec589[1];
			fRec590[0] = fRec590[1] + 2.0 * (fTemp326 * fTemp491 / fTemp327);
			double fRec591 = fTemp329 * fTemp491 / fTemp327;
			double fTemp492 = fTemp331 * (fTemp480 - fRec593[1]) + fRec592[1];
			fRec592[0] = 2.0 * (fTemp492 / fTemp332) - fRec592[1];
			fRec593[0] = fRec593[1] + 2.0 * (fTemp331 * fTemp492 / fTemp332);
			double fRec594 = fTemp334 * fTemp492 / fTemp332;
			double fTemp493 = fTemp336 * (fTemp480 - fRec596[1]) + fRec595[1];
			fRec595[0] = 2.0 * (fTemp493 / fTemp337) - fRec595[1];
			fRec596[0] = fRec596[1] + 2.0 * (fTemp336 * fTemp493 / fTemp337);
			double fRec597 = fTemp339 * fTemp493 / fTemp337;
			double fTemp494 = fTemp341 * (fTemp480 - fRec599[1]) + fRec598[1];
			fRec598[0] = 2.0 * (fTemp494 / fTemp342) - fRec598[1];
			fRec599[0] = fRec599[1] + 2.0 * (fTemp341 * fTemp494 / fTemp342);
			double fRec600 = fTemp344 * fTemp494 / fTemp342;
			double fTemp495 = fTemp346 * (fTemp480 - fRec602[1]) + fRec601[1];
			fRec601[0] = 2.0 * (fTemp495 / fTemp347) - fRec601[1];
			fRec602[0] = fRec602[1] + 2.0 * (fTemp346 * fTemp495 / fTemp347);
			double fRec603 = fTemp349 * fTemp495 / fTemp347;
			double fTemp496 = fTemp351 * (fTemp480 - fRec605[1]) + fRec604[1];
			fRec604[0] = 2.0 * (fTemp496 / fTemp352) - fRec604[1];
			fRec605[0] = fRec605[1] + 2.0 * (fTemp351 * fTemp496 / fTemp352);
			double fRec606 = fTemp354 * fTemp496 / fTemp352;
			double fTemp497 = fTemp357 * (fTemp480 - fRec608[1]) + fRec607[1];
			fRec607[0] = 2.0 * (fTemp497 / fTemp358) - fRec607[1];
			fRec608[0] = fRec608[1] + 2.0 * (fTemp357 * fTemp497 / fTemp358);
			double fRec609 = fTemp360 * fTemp497 / fTemp358;
			double fTemp498 = fTemp362 * (fTemp480 - fRec611[1]) + fRec610[1];
			fRec610[0] = 2.0 * (fTemp498 / fTemp363) - fRec610[1];
			fRec611[0] = fRec611[1] + 2.0 * (fTemp362 * fTemp498 / fTemp363);
			double fRec612 = fTemp365 * fTemp498 / fTemp363;
			double fTemp499 = fTemp367 * (fTemp480 - fRec614[1]) + fRec613[1];
			fRec613[0] = 2.0 * (fTemp499 / fTemp368) - fRec613[1];
			fRec614[0] = fRec614[1] + 2.0 * (fTemp367 * fTemp499 / fTemp368);
			double fRec615 = fTemp370 * fTemp499 / fTemp368;
			double fTemp500 = fTemp372 * (fTemp480 - fRec617[1]) + fRec616[1];
			fRec616[0] = 2.0 * (fTemp500 / fTemp373) - fRec616[1];
			fRec617[0] = fRec617[1] + 2.0 * (fTemp372 * fTemp500 / fTemp373);
			double fRec618 = fTemp375 * fTemp500 / fTemp373;
			double fTemp501 = fTemp377 * (fTemp480 - fRec620[1]) + fRec619[1];
			fRec619[0] = 2.0 * (fTemp501 / fTemp378) - fRec619[1];
			fRec620[0] = fRec620[1] + 2.0 * (fTemp377 * fTemp501 / fTemp378);
			double fRec621 = fTemp380 * fTemp501 / fTemp378;
			double fTemp502 = fTemp382 * (fTemp480 - fRec623[1]) + fRec622[1];
			fRec622[0] = 2.0 * (fTemp502 / fTemp383) - fRec622[1];
			fRec623[0] = fRec623[1] + 2.0 * (fTemp382 * fTemp502 / fTemp383);
			double fRec624 = fTemp385 * fTemp502 / fTemp383;
			double fTemp503 = fTemp387 * (fTemp480 - fRec626[1]) + fRec625[1];
			fRec625[0] = 2.0 * (fTemp503 / fTemp388) - fRec625[1];
			fRec626[0] = fRec626[1] + 2.0 * (fTemp387 * fTemp503 / fTemp388);
			double fRec627 = fTemp390 * fTemp503 / fTemp388;
			double fTemp504 = fTemp392 * (fTemp480 - fRec629[1]) + fRec628[1];
			fRec628[0] = 2.0 * (fTemp504 / fTemp393) - fRec628[1];
			fRec629[0] = fRec629[1] + 2.0 * (fTemp392 * fTemp504 / fTemp393);
			double fRec630 = fTemp395 * fTemp504 / fTemp393;
			double fTemp505 = fTemp397 * (fTemp480 - fRec632[1]) + fRec631[1];
			fRec631[0] = 2.0 * (fTemp505 / fTemp398) - fRec631[1];
			fRec632[0] = fRec632[1] + 2.0 * (fTemp397 * fTemp505 / fTemp398);
			double fRec633 = fTemp400 * fTemp505 / fTemp398;
			double fTemp506 = fTemp402 * (fTemp480 - fRec635[1]) + fRec634[1];
			fRec634[0] = 2.0 * (fTemp506 / fTemp403) - fRec634[1];
			fRec635[0] = fRec635[1] + 2.0 * (fTemp402 * fTemp506 / fTemp403);
			double fRec636 = fTemp405 * fTemp506 / fTemp403;
			double fTemp507 = fTemp407 * (fTemp480 - fRec638[1]) + fRec637[1];
			fRec637[0] = 2.0 * (fTemp507 / fTemp408) - fRec637[1];
			fRec638[0] = fRec638[1] + 2.0 * (fTemp407 * fTemp507 / fTemp408);
			double fRec639 = fTemp410 * fTemp507 / fTemp408;
			double fTemp508 = fTemp412 * (fTemp480 - fRec641[1]) + fRec640[1];
			fRec640[0] = 2.0 * (fTemp508 / fTemp413) - fRec640[1];
			fRec641[0] = fRec641[1] + 2.0 * (fTemp412 * fTemp508 / fTemp413);
			double fRec642 = fTemp415 * fTemp508 / fTemp413;
			double fTemp509 = fTemp417 * (fTemp480 - fRec644[1]) + fRec643[1];
			fRec643[0] = 2.0 * (fTemp509 / fTemp418) - fRec643[1];
			fRec644[0] = fRec644[1] + 2.0 * (fTemp417 * fTemp509 / fTemp418);
			double fRec645 = fTemp420 * fTemp509 / fTemp418;
			double fTemp510 = fTemp422 * (fTemp480 - fRec647[1]) + fRec646[1];
			fRec646[0] = 2.0 * (fTemp510 / fTemp423) - fRec646[1];
			fRec647[0] = fRec647[1] + 2.0 * (fTemp422 * fTemp510 / fTemp423);
			double fRec648 = fTemp425 * fTemp510 / fTemp423;
			double fTemp511 = fTemp427 * (fTemp480 - fRec650[1]) + fRec649[1];
			fRec649[0] = 2.0 * (fTemp511 / fTemp428) - fRec649[1];
			fRec650[0] = fRec650[1] + 2.0 * (fTemp427 * fTemp511 / fTemp428);
			double fRec651 = fTemp430 * fTemp511 / fTemp428;
			double fTemp512 = fTemp432 * (fTemp480 - fRec653[1]) + fRec652[1];
			fRec652[0] = 2.0 * (fTemp512 / fTemp433) - fRec652[1];
			fRec653[0] = fRec653[1] + 2.0 * (fTemp432 * fTemp512 / fTemp433);
			double fRec654 = fTemp435 * fTemp512 / fTemp433;
			double fTemp513 = 0.03125 * fRec132[0] * (fRec654 + fRec651 + fRec648 + fRec645 + fRec642 + fRec639 + fRec636 + fRec633 + fRec630 + fRec627 + fRec624 + fRec621 + fRec618 + fRec615 + fRec612 + fRec609 + fRec606 + fRec603 + fRec600 + fRec597 + fRec594 + fRec591 + fRec588 + fRec585 + fRec582 + fRec579 + fRec576 + fRec573 + fRec570 + fRec567 + fRec564 + fRec561) + fRec31[0] * fTemp480;
			fRec555[0] = std::max<double>(fConst1 * fRec555[1], std::fabs(fTemp513));
			fVbargraph23 = FAUSTFLOAT(fRec555[0]);
			fRec343[0] = fTemp513;
			double fTemp514 = (fRec343[0] + fRec341[0] + fRec342[0]) / fTemp0;
			fVec12[IOTA0 & 4194303] = fTemp514;
			double fTemp515 = ((fRec655[1] != 0.0) ? (((fRec656[1] > 0.0) & (fRec656[1] < 1.0)) ? fRec655[1] : 0.0) : (((fRec656[1] == 0.0) & (fSlow22 != fRec657[1])) ? 0.0009765625 : (((fRec656[1] == 1.0) & (fSlow22 != fRec658[1])) ? -0.0009765625 : 0.0)));
			fRec655[0] = fTemp515;
			fRec656[0] = std::max<double>(0.0, std::min<double>(1.0, fRec656[1] + fTemp515));
			fRec657[0] = (((fRec656[1] >= 1.0) & (fRec658[1] != fSlow22)) ? fSlow22 : fRec657[1]);
			fRec658[0] = (((fRec656[1] <= 0.0) & (fRec657[1] != fSlow22)) ? fSlow22 : fRec658[1]);
			double fTemp516 = fVec12[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec657[0])))) & 4194303];
			fRec340[0] = 0.3333333333333333 * fTemp516 + fRec656[0] * (0.0 - 0.3333333333333333 * (fTemp516 - fVec12[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec658[0])))) & 4194303]));
			fRec667[0] = fSlow23 + fConst3 * fRec667[1];
			fRec668[0] = fSlow24 + fConst3 * fRec668[1];
			double fTemp517 = fRec668[0] * (147.0 - 27.0 * fRec667[0]);
			double fTemp518 = std::tan(fConst6 * fTemp517);
			double fTemp519 = fTemp518 * (fTemp518 + fTemp15 / fTemp517) + 1.0;
			double fTemp520 = fRec21[0] * fRec660[1];
			fRec672[0] = std::max<double>(fConst1 * fRec672[1], std::fabs(fTemp520));
			fVbargraph24 = FAUSTFLOAT(fRec672[0]);
			double fTemp521 = fTemp520;
			double fTemp522 = fRec21[0] * fRec661[1];
			fRec673[0] = std::max<double>(fConst1 * fRec673[1], std::fabs(fTemp522));
			fVbargraph25 = FAUSTFLOAT(fRec673[0]);
			double fTemp523 = fTemp522;
			double fTemp524 = fTemp6 * (fTemp523 - fTemp521);
			double fTemp525 = fSlow25 * fRec6[1];
			fVec13[IOTA0 & 4194303] = fTemp525;
			double fTemp526 = ((fRec675[1] != 0.0) ? (((fRec676[1] > 0.0) & (fRec676[1] < 1.0)) ? fRec675[1] : 0.0) : (((fRec676[1] == 0.0) & (fSlow26 != fRec677[1])) ? 0.0009765625 : (((fRec676[1] == 1.0) & (fSlow26 != fRec678[1])) ? -0.0009765625 : 0.0)));
			fRec675[0] = fTemp526;
			fRec676[0] = std::max<double>(0.0, std::min<double>(1.0, fRec676[1] + fTemp526));
			fRec677[0] = (((fRec676[1] >= 1.0) & (fRec678[1] != fSlow26)) ? fSlow26 : fRec677[1]);
			fRec678[0] = (((fRec676[1] <= 0.0) & (fRec677[1] != fSlow26)) ? fSlow26 : fRec678[1]);
			double fTemp527 = fVec13[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec677[0])))) & 4194303];
			fRec674[0] = fTemp527 + fRec676[0] * (fVec13[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec678[0])))) & 4194303] - fTemp527);
			fVec14[0] = fTemp8 + fTemp521 + fRec674[1] + fTemp524 + fTemp1;
			fRec671[0] = fTemp524 + fTemp8 + fRec674[1] + 0.995 * fRec671[1] + fTemp521 + (1.2 - (fVec0[1] + fVec14[1]));
			fRec670[0] = std::max<double>(fConst1 * fRec670[1], std::fabs(fRec671[0]));
			fVbargraph26 = FAUSTFLOAT(fRec670[0]);
			double fTemp528 = fRec12[0] * tanh(fRec671[0] / fTemp0);
			fRec669[0] = std::max<double>(fConst1 * fRec669[1], std::fabs(fTemp528));
			fVbargraph27 = FAUSTFLOAT(fRec669[0]);
			double fTemp529 = fTemp528;
			double fTemp530 = fTemp518 * (fTemp529 - fRec665[1]) + fRec664[1];
			fRec664[0] = 2.0 * (fTemp530 / fTemp519) - fRec664[1];
			fRec665[0] = fRec665[1] + 2.0 * (fTemp518 * fTemp530 / fTemp519);
			fRec679[0] = fSlow27 + fConst3 * fRec679[1];
			double fTemp531 = fRec667[0] * (0.07073352 * fRec679[0] + -0.7955404699999999) + (1.0 - 0.20564242 * fRec679[0]);
			double fRec666 = fTemp530 * fTemp531 / fTemp519;
			double fTemp532 = 5462.0 * fRec679[0];
			double fTemp533 = fRec668[0] * (fTemp532 + fRec667[0] * (184.0 - 5696.0 * fRec679[0]) + 3.38e+03);
			double fTemp534 = std::tan(fConst6 * fTemp533);
			double fTemp535 = fTemp534 * (fTemp534 + fTemp15 / fTemp533) + 1.0;
			double fTemp536 = fTemp534 * (fTemp529 - fRec681[1]) + fRec680[1];
			fRec680[0] = 2.0 * (fTemp536 / fTemp535) - fRec680[1];
			fRec681[0] = fRec681[1] + 2.0 * (fTemp534 * fTemp536 / fTemp535);
			double fTemp537 = fRec667[0] * (0.06439533 - 0.05859501 * fRec679[0]) + (0.00962998 - 0.00539943 * fRec679[0]);
			double fRec682 = fTemp536 * fTemp537 / fTemp535;
			double fTemp538 = fRec668[0] * (1924.0 * fRec679[0] + fRec667[0] * (-67.0 - 1709.0 * fRec679[0]) + 2792.0);
			double fTemp539 = std::tan(fConst6 * fTemp538);
			double fTemp540 = fTemp539 * (fTemp539 + fTemp15 / fTemp538) + 1.0;
			double fTemp541 = fTemp539 * (fTemp529 - fRec684[1]) + fRec683[1];
			fRec683[0] = 2.0 * (fTemp541 / fTemp540) - fRec683[1];
			fRec684[0] = fRec684[1] + 2.0 * (fTemp539 * fTemp541 / fTemp540);
			double fTemp542 = fRec667[0] * (0.18126063 - 0.15936859 * fRec679[0]) + (0.03127152 - 0.026182169999999998 * fRec679[0]);
			double fRec685 = fTemp541 * fTemp542 / fTemp540;
			double fTemp543 = fRec668[0] * (1334.0 * fRec679[0] + fRec667[0] * (69.0 - 1321.0 * fRec679[0]) + 2498.0);
			double fTemp544 = std::tan(fConst6 * fTemp543);
			double fTemp545 = fTemp544 * (fTemp544 + fTemp15 / fTemp543) + 1.0;
			double fTemp546 = fTemp544 * (fTemp529 - fRec687[1]) + fRec686[1];
			fRec686[0] = 2.0 * (fTemp546 / fTemp545) - fRec686[1];
			fRec687[0] = fRec687[1] + 2.0 * (fTemp544 * fTemp546 / fTemp545);
			double fTemp547 = 0.00024740000000000005 * fRec679[0] + fRec667[0] * (0.08007111 - 0.08267900999999998 * fRec679[0]) + 0.01134687;
			double fRec688 = fTemp546 * fTemp547 / fTemp545;
			double fTemp548 = fRec668[0] * (1117.0 * fRec679[0] + fRec667[0] * (-4e+01 - 1001.0 * fRec679[0]) + 2273.0);
			double fTemp549 = std::tan(fConst6 * fTemp548);
			double fTemp550 = fTemp549 * (fTemp549 + fTemp15 / fTemp548) + 1.0;
			double fTemp551 = fTemp549 * (fTemp529 - fRec690[1]) + fRec689[1];
			fRec689[0] = 2.0 * (fTemp551 / fTemp550) - fRec689[1];
			fRec690[0] = fRec690[1] + 2.0 * (fTemp549 * fTemp551 / fTemp550);
			double fTemp552 = 0.009332220000000002 * fRec679[0] + fRec667[0] * (0.26175163 - 0.22162943000000002 * fRec679[0]) + 0.00656447;
			double fRec691 = fTemp551 * fTemp552 / fTemp550;
			double fTemp553 = fRec668[0] * (1041.0 * fRec679[0] + fRec667[0] * (-121.0 - 812.0 * fRec679[0]) + 2054.0);
			double fTemp554 = std::tan(fConst6 * fTemp553);
			double fTemp555 = fTemp554 * (fTemp554 + fTemp15 / fTemp553) + 1.0;
			double fTemp556 = fTemp554 * (fTemp529 - fRec693[1]) + fRec692[1];
			fRec692[0] = 2.0 * (fTemp556 / fTemp555) - fRec692[1];
			fRec693[0] = fRec693[1] + 2.0 * (fTemp554 * fTemp556 / fTemp555);
			double fTemp557 = fRec667[0] * (0.39552505 - 0.38007101 * fRec679[0]) + (0.06985491 - 0.060508160000000005 * fRec679[0]);
			double fRec694 = fTemp556 * fTemp557 / fTemp555;
			double fTemp558 = fRec668[0] * (945.0 * fRec679[0] + fRec667[0] * (-128.0 - 743.0 * fRec679[0]) + 1855.0);
			double fTemp559 = std::tan(fConst6 * fTemp558);
			double fTemp560 = fTemp559 * (fTemp559 + fTemp15 / fTemp558) + 1.0;
			double fTemp561 = fTemp559 * (fTemp529 - fRec696[1]) + fRec695[1];
			fRec695[0] = 2.0 * (fTemp561 / fTemp560) - fRec695[1];
			fRec696[0] = fRec696[1] + 2.0 * (fTemp559 * fTemp561 / fTemp560);
			double fTemp562 = 0.02476806 * fRec679[0] + fRec667[0] * (0.04345912 - 0.05426385 * fRec679[0]) + 0.01093969;
			double fRec697 = fTemp561 * fTemp562 / fTemp560;
			double fTemp563 = 889.0 * fRec679[0];
			double fTemp564 = fRec668[0] * (fTemp563 + fRec667[0] * (-137.0 - 601.0 * fRec679[0]) + 1617.0);
			double fTemp565 = std::tan(fConst6 * fTemp564);
			double fTemp566 = fTemp565 * (fTemp565 + fTemp15 / fTemp564) + 1.0;
			double fTemp567 = fTemp565 * (fTemp529 - fRec699[1]) + fRec698[1];
			fRec698[0] = 2.0 * (fTemp567 / fTemp566) - fRec698[1];
			fRec699[0] = fRec699[1] + 2.0 * (fTemp565 * fTemp567 / fTemp566);
			double fTemp568 = fRec667[0] * (0.89755644 - 0.83241899 * fRec679[0]) + (0.07354127 - 0.06668288 * fRec679[0]);
			double fRec700 = fTemp567 * fTemp568 / fTemp566;
			double fTemp569 = 888.0 * fRec679[0];
			double fTemp570 = fRec668[0] * (fTemp569 + fRec667[0] * (7.0 - 646.0 * fRec679[0]) + 1323.0);
			double fTemp571 = std::tan(fConst6 * fTemp570);
			double fTemp572 = fTemp571 * (fTemp571 + fTemp15 / fTemp570) + 1.0;
			double fTemp573 = fTemp571 * (fTemp529 - fRec702[1]) + fRec701[1];
			fRec701[0] = 2.0 * (fTemp573 / fTemp572) - fRec701[1];
			fRec702[0] = fRec702[1] + 2.0 * (fTemp571 * fTemp573 / fTemp572);
			double fTemp574 = 0.01378994 * fRec679[0] + fRec667[0] * (0.16180601 - 0.17199811 * fRec679[0]) + 0.07170723;
			double fRec703 = fTemp573 * fTemp574 / fTemp572;
			double fTemp575 = fRec668[0] * (741.0 * fRec679[0] + fRec667[0] * (4.0 - 506.0 * fRec679[0]) + 1175.0);
			double fTemp576 = std::tan(fConst6 * fTemp575);
			double fTemp577 = fTemp576 * (fTemp576 + fTemp15 / fTemp575) + 1.0;
			double fTemp578 = fTemp576 * (fTemp529 - fRec705[1]) + fRec704[1];
			fRec704[0] = 2.0 * (fTemp578 / fTemp577) - fRec704[1];
			fRec705[0] = fRec705[1] + 2.0 * (fTemp576 * fTemp578 / fTemp577);
			double fTemp579 = fRec667[0] * (0.29407844000000005 - 0.3172501500000001 * fRec679[0]) + (0.28175268 - 0.21568321999999998 * fRec679[0]);
			double fRec706 = fTemp578 * fTemp579 / fTemp577;
			double fTemp580 = fRec668[0] * (593.0 * fRec679[0] + fRec667[0] * (3.0 - 447.0 * fRec679[0]) + 1028.0);
			double fTemp581 = std::tan(fConst6 * fTemp580);
			double fTemp582 = fTemp581 * (fTemp581 + fTemp15 / fTemp580) + 1.0;
			double fTemp583 = fTemp581 * (fTemp529 - fRec708[1]) + fRec707[1];
			fRec707[0] = 2.0 * (fTemp583 / fTemp582) - fRec707[1];
			fRec708[0] = fRec708[1] + 2.0 * (fTemp581 * fTemp583 / fTemp582);
			double fTemp584 = 0.07792940000000001 * fRec679[0] + fRec667[0] * (0.19518858000000003 * fRec679[0] + 0.16366607) + 0.14442907;
			double fRec709 = fTemp583 * fTemp584 / fTemp582;
			double fTemp585 = fRec668[0] * (444.0 * fRec679[0] + fRec667[0] * (-2.0 - 315.0 * fRec679[0]) + 882.0);
			double fTemp586 = std::tan(fConst6 * fTemp585);
			double fTemp587 = fTemp586 * (fTemp586 + fTemp15 / fTemp585) + 1.0;
			double fTemp588 = fTemp586 * (fTemp529 - fRec711[1]) + fRec710[1];
			fRec710[0] = 2.0 * (fTemp588 / fTemp587) - fRec710[1];
			fRec711[0] = fRec711[1] + 2.0 * (fTemp586 * fTemp588 / fTemp587);
			double fTemp589 = fRec667[0] * (0.14853099000000003 - 0.11225552000000005 * fRec679[0]) + (0.2722688 - 0.2582559 * fRec679[0]);
			double fRec712 = fTemp588 * fTemp589 / fTemp587;
			double fTemp590 = fRec668[0] * (297.0 * fRec679[0] + fRec667[0] * (1.0 - 157.0 * fRec679[0]) + 735.0);
			double fTemp591 = std::tan(fConst6 * fTemp590);
			double fTemp592 = fTemp591 * (fTemp591 + fTemp15 / fTemp590) + 1.0;
			double fTemp593 = fTemp591 * (fTemp529 - fRec714[1]) + fRec713[1];
			fRec713[0] = 2.0 * (fTemp593 / fTemp592) - fRec713[1];
			fRec714[0] = fRec714[1] + 2.0 * (fTemp591 * fTemp593 / fTemp592);
			double fTemp594 = fRec667[0] * (0.17857318999999994 - 0.36552292 * fRec679[0]) + (0.54357606 - 0.31600273 * fRec679[0]);
			double fRec715 = fTemp593 * fTemp594 / fTemp592;
			double fTemp595 = fRec668[0] * (203.0 * fRec679[0] + fRec667[0] * (3.0 - 29.0 * fRec679[0]) + 534.0);
			double fTemp596 = std::tan(fConst6 * fTemp595);
			double fTemp597 = fTemp596 * (fTemp596 + fTemp15 / fTemp595) + 1.0;
			double fTemp598 = fTemp596 * (fTemp529 - fRec717[1]) + fRec716[1];
			fRec716[0] = 2.0 * (fTemp598 / fTemp597) - fRec716[1];
			fRec717[0] = fRec717[1] + 2.0 * (fTemp596 * fTemp598 / fTemp597);
			double fTemp599 = 0.67536956 * fRec679[0] + fRec667[0] * (0.16028896 - 0.80657534 * fRec679[0]) + 0.0250452;
			double fRec718 = fTemp598 * fTemp599 / fTemp597;
			double fTemp600 = fRec668[0] * (75.0 * fRec679[0] + fRec667[0] * (0.0 - 79.0 * fRec679[0]) + 367.0);
			double fTemp601 = std::tan(fConst6 * fTemp600);
			double fTemp602 = fTemp601 * (fTemp601 + fTemp15 / fTemp600) + 1.0;
			double fTemp603 = fTemp601 * (fTemp529 - fRec720[1]) + fRec719[1];
			fRec719[0] = 2.0 * (fTemp603 / fTemp602) - fRec719[1];
			fRec720[0] = fRec720[1] + 2.0 * (fTemp601 * fTemp603 / fTemp602);
			double fTemp604 = 0.28677124 * fRec679[0] + fRec667[0] * (0.27661398 - 0.52141959 * fRec679[0]) + 0.02470587;
			double fRec721 = fTemp603 * fTemp604 / fTemp602;
			double fTemp605 = fRec668[0] * (92.0 * fRec679[0] + fRec667[0] * (-1e+01 - 96.0 * fRec679[0]) + 203.0);
			double fTemp606 = std::tan(fConst6 * fTemp605);
			double fTemp607 = fTemp606 * (fTemp606 + fTemp15 / fTemp605) + 1.0;
			double fTemp608 = fTemp606 * (fTemp529 - fRec723[1]) + fRec722[1];
			fRec722[0] = 2.0 * (fTemp608 / fTemp607) - fRec722[1];
			fRec723[0] = fRec723[1] + 2.0 * (fTemp606 * fTemp608 / fTemp607);
			double fTemp609 = 0.9594288 * fRec679[0] + fRec667[0] * (0.32743217999999996 - 0.9405872099999999 * fRec679[0]) + 0.0405712;
			double fRec724 = fTemp608 * fTemp609 / fTemp607;
			double fTemp610 = 6.0 * fRec679[0];
			double fTemp611 = fRec668[0] * (fRec667[0] * (fTemp610 + -3.0) + (53.0 - fTemp610));
			double fTemp612 = std::tan(fConst6 * fTemp611);
			double fTemp613 = fTemp612 * (fTemp612 + fTemp15 / fTemp611) + 1.0;
			double fTemp614 = fTemp612 * (fTemp529 - fRec726[1]) + fRec725[1];
			fRec725[0] = 2.0 * (fTemp614 / fTemp613) - fRec725[1];
			fRec726[0] = fRec726[1] + 2.0 * (fTemp612 * fTemp614 / fTemp613);
			double fTemp615 = fRec667[0] * (0.02738166999999999 * fRec679[0] + 0.04900900000000001) + (0.07116083 - 0.059562029999999995 * fRec679[0]);
			double fRec727 = fTemp614 * fTemp615 / fTemp613;
			double fTemp616 = fRec668[0] * (82.0 * fRec679[0] + fRec667[0] * (14.0 - 89.0 * fRec679[0]) + 294.0);
			double fTemp617 = std::tan(fConst6 * fTemp616);
			double fTemp618 = fTemp617 * (fTemp617 + fTemp15 / fTemp616) + 1.0;
			double fTemp619 = fTemp617 * (fTemp529 - fRec729[1]) + fRec728[1];
			fRec728[0] = 2.0 * (fTemp619 / fTemp618) - fRec728[1];
			fRec729[0] = fRec729[1] + 2.0 * (fTemp617 * fTemp619 / fTemp618);
			double fTemp620 = fRec667[0] * (0.45472109 * fRec679[0] + -0.34135506) + (0.49828005 - 0.49066910999999996 * fRec679[0]);
			double fRec730 = fTemp619 * fTemp620 / fTemp618;
			double fTemp621 = fRec668[0] * (148.0 * fRec679[0] + fRec667[0] * (12.0 - 13.0 * fRec679[0]) + 441.0);
			double fTemp622 = std::tan(fConst6 * fTemp621);
			double fTemp623 = fTemp622 * (fTemp622 + fTemp15 / fTemp621) + 1.0;
			double fTemp624 = fTemp622 * (fTemp529 - fRec732[1]) + fRec731[1];
			fRec731[0] = 2.0 * (fTemp624 / fTemp623) - fRec731[1];
			fRec732[0] = fRec732[1] + 2.0 * (fTemp622 * fTemp624 / fTemp623);
			double fTemp625 = 0.026025509999999974 * fRec679[0] + fRec667[0] * (0.82424861 * fRec679[0] + -0.10070198) + 0.25042786;
			double fRec733 = fTemp624 * fTemp625 / fTemp623;
			double fTemp626 = fRec668[0] * (296.0 * fRec679[0] + fRec667[0] * (1.0 - 1.1e+02 * fRec679[0]) + 588.0);
			double fTemp627 = std::tan(fConst6 * fTemp626);
			double fTemp628 = fTemp627 * (fTemp627 + fTemp15 / fTemp626) + 1.0;
			double fTemp629 = fTemp627 * (fTemp529 - fRec735[1]) + fRec734[1];
			fRec734[0] = 2.0 * (fTemp629 / fTemp628) - fRec734[1];
			fRec735[0] = fRec735[1] + 2.0 * (fTemp627 * fTemp629 / fTemp628);
			double fTemp630 = 0.27049557 * fRec679[0] + fRec667[0] * (0.23776758000000003 - 0.53709331 * fRec679[0]) + 0.09954785;
			double fRec736 = fTemp629 * fTemp630 / fTemp628;
			double fTemp631 = fRec668[0] * (394.0 * fRec679[0] + fRec667[0] * (43.0 - 285.0 * fRec679[0]) + 785.0);
			double fTemp632 = std::tan(fConst6 * fTemp631);
			double fTemp633 = fTemp632 * (fTemp632 + fTemp15 / fTemp631) + 1.0;
			double fTemp634 = fTemp632 * (fTemp529 - fRec738[1]) + fRec737[1];
			fRec737[0] = 2.0 * (fTemp634 / fTemp633) - fRec737[1];
			fRec738[0] = fRec738[1] + 2.0 * (fTemp632 * fTemp634 / fTemp633);
			double fTemp635 = 0.24706891000000003 * fRec679[0] + fRec667[0] * (0.037263420000000005 - 0.24153450000000004 * fRec679[0]) + 0.01573797;
			double fRec739 = fTemp634 * fTemp635 / fTemp633;
			double fTemp636 = fRec668[0] * (513.0 * fRec679[0] + fRec667[0] * (3.0 - 381.0 * fRec679[0]) + 961.0);
			double fTemp637 = std::tan(fConst6 * fTemp636);
			double fTemp638 = fTemp637 * (fTemp637 + fTemp15 / fTemp636) + 1.0;
			double fTemp639 = fTemp637 * (fTemp529 - fRec741[1]) + fRec740[1];
			fRec740[0] = 2.0 * (fTemp639 / fTemp638) - fRec740[1];
			fRec741[0] = fRec741[1] + 2.0 * (fTemp637 * fTemp639 / fTemp638);
			double fTemp640 = 0.25012827 * fRec679[0] + fRec667[0] * (0.11585875999999999 - 0.20043951 * fRec679[0]) + 0.01228042;
			double fRec742 = fTemp639 * fTemp640 / fTemp638;
			double fTemp641 = fRec668[0] * (6.9e+02 * fRec679[0] + fRec667[0] * (23.0 - 483.0 * fRec679[0]) + 1078.0);
			double fTemp642 = std::tan(fConst6 * fTemp641);
			double fTemp643 = fTemp642 * (fTemp642 + fTemp15 / fTemp641) + 1.0;
			double fTemp644 = fTemp642 * (fTemp529 - fRec744[1]) + fRec743[1];
			fRec743[0] = 2.0 * (fTemp644 / fTemp643) - fRec743[1];
			fRec744[0] = fRec744[1] + 2.0 * (fTemp642 * fTemp644 / fTemp643);
			double fTemp645 = 0.08014510000000001 * fRec679[0] + fRec667[0] * (0.08188717000000001 - 0.15931663000000001 * fRec679[0]) + 0.01626654;
			double fRec745 = fTemp644 * fTemp645 / fTemp643;
			double fTemp646 = fRec668[0] * (794.0 * fRec679[0] + fRec667[0] * (6.0 - 563.0 * fRec679[0]) + 1269.0);
			double fTemp647 = std::tan(fConst6 * fTemp646);
			double fTemp648 = fTemp647 * (fTemp647 + fTemp15 / fTemp646) + 1.0;
			double fTemp649 = fTemp647 * (fTemp529 - fRec747[1]) + fRec746[1];
			fRec746[0] = 2.0 * (fTemp649 / fTemp648) - fRec746[1];
			fRec747[0] = fRec747[1] + 2.0 * (fTemp647 * fTemp649 / fTemp648);
			double fTemp650 = 0.15692174 * fRec679[0] + fRec667[0] * (0.019392789999999997 - 0.13171841 * fRec679[0]) + 0.02115358;
			double fRec748 = fTemp649 * fTemp650 / fTemp648;
			double fTemp651 = fRec668[0] * (fTemp569 + fRec667[0] * (-62.0 - 612.0 * fRec679[0]) + 1.47e+03);
			double fTemp652 = std::tan(fConst6 * fTemp651);
			double fTemp653 = fTemp652 * (fTemp652 + fTemp15 / fTemp651) + 1.0;
			double fTemp654 = fTemp652 * (fTemp529 - fRec750[1]) + fRec749[1];
			fRec749[0] = 2.0 * (fTemp654 / fTemp653) - fRec749[1];
			fRec750[0] = fRec750[1] + 2.0 * (fTemp652 * fTemp654 / fTemp653);
			double fTemp655 = fRec667[0] * (0.020997170000000002 - 0.020033680000000005 * fRec679[0]) + (0.06191843 - 0.02241523 * fRec679[0]);
			double fRec751 = fTemp654 * fTemp655 / fTemp653;
			double fTemp656 = fRec668[0] * (fTemp563 + fRec667[0] * (-134.0 - 649.0 * fRec679[0]) + 1764.0);
			double fTemp657 = std::tan(fConst6 * fTemp656);
			double fTemp658 = fTemp657 * (fTemp657 + fTemp15 / fTemp656) + 1.0;
			double fTemp659 = fTemp657 * (fTemp529 - fRec753[1]) + fRec752[1];
			fRec752[0] = 2.0 * (fTemp659 / fTemp658) - fRec752[1];
			fRec753[0] = fRec753[1] + 2.0 * (fTemp657 * fTemp659 / fTemp658);
			double fTemp660 = fRec667[0] * (0.94873963 - 0.9622067 * fRec679[0]) + (0.05126037 - 0.02103158 * fRec679[0]);
			double fRec754 = fTemp659 * fTemp660 / fTemp658;
			double fTemp661 = fRec668[0] * (1037.0 * fRec679[0] + fRec667[0] * (-128.0 - 751.0 * fRec679[0]) + 1.91e+03);
			double fTemp662 = std::tan(fConst6 * fTemp661);
			double fTemp663 = fTemp662 * (fTemp662 + fTemp15 / fTemp661) + 1.0;
			double fTemp664 = fTemp662 * (fTemp529 - fRec756[1]) + fRec755[1];
			fRec755[0] = 2.0 * (fTemp664 / fTemp663) - fRec755[1];
			fRec756[0] = fRec756[1] + 2.0 * (fTemp662 * fTemp664 / fTemp663);
			double fTemp665 = fRec667[0] * (0.58336649 - 0.5666712700000001 * fRec679[0]) + (0.0343155 - 0.02668976 * fRec679[0]);
			double fRec757 = fTemp664 * fTemp665 / fTemp663;
			double fTemp666 = fRec668[0] * (1038.0 * fRec679[0] + fRec667[0] * (-119.0 - 846.0 * fRec679[0]) + 2204.0);
			double fTemp667 = std::tan(fConst6 * fTemp666);
			double fTemp668 = fTemp667 * (fTemp667 + fTemp15 / fTemp666) + 1.0;
			double fTemp669 = fTemp667 * (fTemp529 - fRec759[1]) + fRec758[1];
			fRec758[0] = 2.0 * (fTemp669 / fTemp668) - fRec758[1];
			fRec759[0] = fRec759[1] + 2.0 * (fTemp667 * fTemp669 / fTemp668);
			double fTemp670 = fRec667[0] * (0.5577936099999999 - 0.54352849 * fRec679[0]) + (0.09585942 - 0.086804 * fRec679[0]);
			double fRec760 = fTemp669 * fTemp670 / fTemp668;
			double fTemp671 = fRec668[0] * (1186.0 * fRec679[0] + fRec667[0] * (51.0 - 1.13e+03 * fRec679[0]) + 2351.0);
			double fTemp672 = std::tan(fConst6 * fTemp671);
			double fTemp673 = fTemp672 * (fTemp672 + fTemp15 / fTemp671) + 1.0;
			double fTemp674 = fTemp672 * (fTemp529 - fRec762[1]) + fRec761[1];
			fRec761[0] = 2.0 * (fTemp674 / fTemp673) - fRec761[1];
			fRec762[0] = fRec762[1] + 2.0 * (fTemp672 * fTemp674 / fTemp673);
			double fTemp675 = fRec667[0] * (0.18329145 - 0.17669554 * fRec679[0]) + (0.01233555 - 0.008431840000000001 * fRec679[0]);
			double fRec763 = fTemp674 * fTemp675 / fTemp673;
			double fTemp676 = fRec668[0] * (1481.0 * fRec679[0] + fRec667[0] * (13.0 - 1359.0 * fRec679[0]) + 2645.0);
			double fTemp677 = std::tan(fConst6 * fTemp676);
			double fTemp678 = fTemp677 * (fTemp677 + fTemp15 / fTemp676) + 1.0;
			double fTemp679 = fTemp677 * (fTemp529 - fRec765[1]) + fRec764[1];
			fRec764[0] = 2.0 * (fTemp679 / fTemp678) - fRec764[1];
			fRec765[0] = fRec765[1] + 2.0 * (fTemp677 * fTemp679 / fTemp678);
			double fTemp680 = fRec667[0] * (0.052822430000000004 - 0.026333230000000006 * fRec679[0]) + (0.01055565 - 0.00626412 * fRec679[0]);
			double fRec766 = fTemp679 * fTemp680 / fTemp678;
			double fTemp681 = fRec668[0] * (fTemp532 + fRec667[0] * (152.0 - 5648.0 * fRec679[0]) + 3233.0);
			double fTemp682 = std::tan(fConst6 * fTemp681);
			double fTemp683 = fTemp682 * (fTemp682 + fTemp15 / fTemp681) + 1.0;
			double fTemp684 = fTemp682 * (fTemp529 - fRec768[1]) + fRec767[1];
			fRec767[0] = 2.0 * (fTemp684 / fTemp683) - fRec767[1];
			fRec768[0] = fRec768[1] + 2.0 * (fTemp682 * fTemp684 / fTemp683);
			double fTemp685 = fRec667[0] * (0.03251611 - 0.026476020000000003 * fRec679[0]) + (0.01587526 - 0.011935889999999998 * fRec679[0]);
			double fRec769 = fTemp684 * fTemp685 / fTemp683;
			double fTemp686 = fRec668[0] * (5463.0 * fRec679[0] + fRec667[0] * (189.0 - 5063.0 * fRec679[0]) + 3527.0);
			double fTemp687 = std::tan(fConst6 * fTemp686);
			double fTemp688 = fTemp687 * (fTemp687 + fTemp15 / fTemp686) + 1.0;
			double fTemp689 = fTemp687 * (fTemp529 - fRec771[1]) + fRec770[1];
			fRec770[0] = 2.0 * (fTemp689 / fTemp688) - fRec770[1];
			fRec771[0] = fRec771[1] + 2.0 * (fTemp687 * fTemp689 / fTemp688);
			double fTemp690 = fRec667[0] * (0.14146586 - 0.1338637 * fRec679[0]) + (0.0068168 - 0.0019190699999999993 * fRec679[0]);
			double fRec772 = fTemp689 * fTemp690 / fTemp688;
			double fTemp691 = fTemp529 * fRec31[0] + 0.03125 * fRec132[0] * (fRec772 + fRec769 + fRec766 + fRec763 + fRec760 + fRec757 + fRec754 + fRec751 + fRec748 + fRec745 + fRec742 + fRec739 + fRec736 + fRec733 + fRec730 + fRec727 + fRec724 + fRec721 + fRec718 + fRec715 + fRec712 + fRec709 + fRec706 + fRec703 + fRec700 + fRec697 + fRec694 + fRec691 + fRec688 + fRec685 + fRec682 + fRec666);
			fRec663[0] = std::max<double>(fConst1 * fRec663[1], std::fabs(fTemp691));
			fVbargraph28 = FAUSTFLOAT(fRec663[0]);
			fRec660[0] = fTemp691;
			double fTemp692 = fRec21[0] * fRec662[1];
			fRec777[0] = std::max<double>(fConst1 * fRec777[1], std::fabs(fTemp692));
			fVbargraph29 = FAUSTFLOAT(fRec777[0]);
			double fTemp693 = fTemp692;
			double fTemp694 = fRec23[0] * (fTemp521 * (fRec138[0] - fTemp693) - fTemp523);
			double fTemp695 = fRec674[1] + fTemp8;
			double fTemp696 = fTemp695 + fTemp523;
			fVec15[0] = fTemp696 + fTemp694 + fTemp180;
			fRec776[0] = fTemp694 + 0.995 * fRec776[1] + fTemp696 + (1.3 - (fVec3[1] + fVec15[1]));
			fRec775[0] = std::max<double>(fConst1 * fRec775[1], std::fabs(fRec776[0]));
			fVbargraph30 = FAUSTFLOAT(fRec775[0]);
			double fTemp697 = fRec12[0] * tanh(fRec776[0] / fTemp0);
			fRec774[0] = std::max<double>(fConst1 * fRec774[1], std::fabs(fTemp697));
			fVbargraph31 = FAUSTFLOAT(fRec774[0]);
			double fTemp698 = fTemp697;
			double fTemp699 = fTemp518 * (fTemp698 - fRec779[1]) + fRec778[1];
			fRec778[0] = 2.0 * (fTemp699 / fTemp519) - fRec778[1];
			fRec779[0] = fRec779[1] + 2.0 * (fTemp518 * fTemp699 / fTemp519);
			double fRec780 = fTemp531 * fTemp699 / fTemp519;
			double fTemp700 = fTemp534 * (fTemp698 - fRec782[1]) + fRec781[1];
			fRec781[0] = 2.0 * (fTemp700 / fTemp535) - fRec781[1];
			fRec782[0] = fRec782[1] + 2.0 * (fTemp534 * fTemp700 / fTemp535);
			double fRec783 = fTemp537 * fTemp700 / fTemp535;
			double fTemp701 = fTemp539 * (fTemp698 - fRec785[1]) + fRec784[1];
			fRec784[0] = 2.0 * (fTemp701 / fTemp540) - fRec784[1];
			fRec785[0] = fRec785[1] + 2.0 * (fTemp539 * fTemp701 / fTemp540);
			double fRec786 = fTemp542 * fTemp701 / fTemp540;
			double fTemp702 = fTemp544 * (fTemp698 - fRec788[1]) + fRec787[1];
			fRec787[0] = 2.0 * (fTemp702 / fTemp545) - fRec787[1];
			fRec788[0] = fRec788[1] + 2.0 * (fTemp544 * fTemp702 / fTemp545);
			double fRec789 = fTemp547 * fTemp702 / fTemp545;
			double fTemp703 = fTemp549 * (fTemp698 - fRec791[1]) + fRec790[1];
			fRec790[0] = 2.0 * (fTemp703 / fTemp550) - fRec790[1];
			fRec791[0] = fRec791[1] + 2.0 * (fTemp549 * fTemp703 / fTemp550);
			double fRec792 = fTemp552 * fTemp703 / fTemp550;
			double fTemp704 = fTemp554 * (fTemp698 - fRec794[1]) + fRec793[1];
			fRec793[0] = 2.0 * (fTemp704 / fTemp555) - fRec793[1];
			fRec794[0] = fRec794[1] + 2.0 * (fTemp554 * fTemp704 / fTemp555);
			double fRec795 = fTemp557 * fTemp704 / fTemp555;
			double fTemp705 = fTemp559 * (fTemp698 - fRec797[1]) + fRec796[1];
			fRec796[0] = 2.0 * (fTemp705 / fTemp560) - fRec796[1];
			fRec797[0] = fRec797[1] + 2.0 * (fTemp559 * fTemp705 / fTemp560);
			double fRec798 = fTemp562 * fTemp705 / fTemp560;
			double fTemp706 = fTemp565 * (fTemp698 - fRec800[1]) + fRec799[1];
			fRec799[0] = 2.0 * (fTemp706 / fTemp566) - fRec799[1];
			fRec800[0] = fRec800[1] + 2.0 * (fTemp565 * fTemp706 / fTemp566);
			double fRec801 = fTemp568 * fTemp706 / fTemp566;
			double fTemp707 = fTemp571 * (fTemp698 - fRec803[1]) + fRec802[1];
			fRec802[0] = 2.0 * (fTemp707 / fTemp572) - fRec802[1];
			fRec803[0] = fRec803[1] + 2.0 * (fTemp571 * fTemp707 / fTemp572);
			double fRec804 = fTemp574 * fTemp707 / fTemp572;
			double fTemp708 = fTemp576 * (fTemp698 - fRec806[1]) + fRec805[1];
			fRec805[0] = 2.0 * (fTemp708 / fTemp577) - fRec805[1];
			fRec806[0] = fRec806[1] + 2.0 * (fTemp576 * fTemp708 / fTemp577);
			double fRec807 = fTemp579 * fTemp708 / fTemp577;
			double fTemp709 = fTemp581 * (fTemp698 - fRec809[1]) + fRec808[1];
			fRec808[0] = 2.0 * (fTemp709 / fTemp582) - fRec808[1];
			fRec809[0] = fRec809[1] + 2.0 * (fTemp581 * fTemp709 / fTemp582);
			double fRec810 = fTemp584 * fTemp709 / fTemp582;
			double fTemp710 = fTemp586 * (fTemp698 - fRec812[1]) + fRec811[1];
			fRec811[0] = 2.0 * (fTemp710 / fTemp587) - fRec811[1];
			fRec812[0] = fRec812[1] + 2.0 * (fTemp586 * fTemp710 / fTemp587);
			double fRec813 = fTemp589 * fTemp710 / fTemp587;
			double fTemp711 = fTemp591 * (fTemp698 - fRec815[1]) + fRec814[1];
			fRec814[0] = 2.0 * (fTemp711 / fTemp592) - fRec814[1];
			fRec815[0] = fRec815[1] + 2.0 * (fTemp591 * fTemp711 / fTemp592);
			double fRec816 = fTemp594 * fTemp711 / fTemp592;
			double fTemp712 = fTemp596 * (fTemp698 - fRec818[1]) + fRec817[1];
			fRec817[0] = 2.0 * (fTemp712 / fTemp597) - fRec817[1];
			fRec818[0] = fRec818[1] + 2.0 * (fTemp596 * fTemp712 / fTemp597);
			double fRec819 = fTemp599 * fTemp712 / fTemp597;
			double fTemp713 = fTemp601 * (fTemp698 - fRec821[1]) + fRec820[1];
			fRec820[0] = 2.0 * (fTemp713 / fTemp602) - fRec820[1];
			fRec821[0] = fRec821[1] + 2.0 * (fTemp601 * fTemp713 / fTemp602);
			double fRec822 = fTemp604 * fTemp713 / fTemp602;
			double fTemp714 = fTemp606 * (fTemp698 - fRec824[1]) + fRec823[1];
			fRec823[0] = 2.0 * (fTemp714 / fTemp607) - fRec823[1];
			fRec824[0] = fRec824[1] + 2.0 * (fTemp606 * fTemp714 / fTemp607);
			double fRec825 = fTemp609 * fTemp714 / fTemp607;
			double fTemp715 = fTemp612 * (fTemp698 - fRec827[1]) + fRec826[1];
			fRec826[0] = 2.0 * (fTemp715 / fTemp613) - fRec826[1];
			fRec827[0] = fRec827[1] + 2.0 * (fTemp612 * fTemp715 / fTemp613);
			double fRec828 = fTemp615 * fTemp715 / fTemp613;
			double fTemp716 = fTemp617 * (fTemp698 - fRec830[1]) + fRec829[1];
			fRec829[0] = 2.0 * (fTemp716 / fTemp618) - fRec829[1];
			fRec830[0] = fRec830[1] + 2.0 * (fTemp617 * fTemp716 / fTemp618);
			double fRec831 = fTemp620 * fTemp716 / fTemp618;
			double fTemp717 = fTemp622 * (fTemp698 - fRec833[1]) + fRec832[1];
			fRec832[0] = 2.0 * (fTemp717 / fTemp623) - fRec832[1];
			fRec833[0] = fRec833[1] + 2.0 * (fTemp622 * fTemp717 / fTemp623);
			double fRec834 = fTemp625 * fTemp717 / fTemp623;
			double fTemp718 = fTemp627 * (fTemp698 - fRec836[1]) + fRec835[1];
			fRec835[0] = 2.0 * (fTemp718 / fTemp628) - fRec835[1];
			fRec836[0] = fRec836[1] + 2.0 * (fTemp627 * fTemp718 / fTemp628);
			double fRec837 = fTemp630 * fTemp718 / fTemp628;
			double fTemp719 = fTemp632 * (fTemp698 - fRec839[1]) + fRec838[1];
			fRec838[0] = 2.0 * (fTemp719 / fTemp633) - fRec838[1];
			fRec839[0] = fRec839[1] + 2.0 * (fTemp632 * fTemp719 / fTemp633);
			double fRec840 = fTemp635 * fTemp719 / fTemp633;
			double fTemp720 = fTemp637 * (fTemp698 - fRec842[1]) + fRec841[1];
			fRec841[0] = 2.0 * (fTemp720 / fTemp638) - fRec841[1];
			fRec842[0] = fRec842[1] + 2.0 * (fTemp637 * fTemp720 / fTemp638);
			double fRec843 = fTemp640 * fTemp720 / fTemp638;
			double fTemp721 = fTemp642 * (fTemp698 - fRec845[1]) + fRec844[1];
			fRec844[0] = 2.0 * (fTemp721 / fTemp643) - fRec844[1];
			fRec845[0] = fRec845[1] + 2.0 * (fTemp642 * fTemp721 / fTemp643);
			double fRec846 = fTemp645 * fTemp721 / fTemp643;
			double fTemp722 = fTemp647 * (fTemp698 - fRec848[1]) + fRec847[1];
			fRec847[0] = 2.0 * (fTemp722 / fTemp648) - fRec847[1];
			fRec848[0] = fRec848[1] + 2.0 * (fTemp647 * fTemp722 / fTemp648);
			double fRec849 = fTemp650 * fTemp722 / fTemp648;
			double fTemp723 = fTemp652 * (fTemp698 - fRec851[1]) + fRec850[1];
			fRec850[0] = 2.0 * (fTemp723 / fTemp653) - fRec850[1];
			fRec851[0] = fRec851[1] + 2.0 * (fTemp652 * fTemp723 / fTemp653);
			double fRec852 = fTemp655 * fTemp723 / fTemp653;
			double fTemp724 = fTemp657 * (fTemp698 - fRec854[1]) + fRec853[1];
			fRec853[0] = 2.0 * (fTemp724 / fTemp658) - fRec853[1];
			fRec854[0] = fRec854[1] + 2.0 * (fTemp657 * fTemp724 / fTemp658);
			double fRec855 = fTemp660 * fTemp724 / fTemp658;
			double fTemp725 = fTemp662 * (fTemp698 - fRec857[1]) + fRec856[1];
			fRec856[0] = 2.0 * (fTemp725 / fTemp663) - fRec856[1];
			fRec857[0] = fRec857[1] + 2.0 * (fTemp662 * fTemp725 / fTemp663);
			double fRec858 = fTemp665 * fTemp725 / fTemp663;
			double fTemp726 = fTemp667 * (fTemp698 - fRec860[1]) + fRec859[1];
			fRec859[0] = 2.0 * (fTemp726 / fTemp668) - fRec859[1];
			fRec860[0] = fRec860[1] + 2.0 * (fTemp667 * fTemp726 / fTemp668);
			double fRec861 = fTemp670 * fTemp726 / fTemp668;
			double fTemp727 = fTemp672 * (fTemp698 - fRec863[1]) + fRec862[1];
			fRec862[0] = 2.0 * (fTemp727 / fTemp673) - fRec862[1];
			fRec863[0] = fRec863[1] + 2.0 * (fTemp672 * fTemp727 / fTemp673);
			double fRec864 = fTemp675 * fTemp727 / fTemp673;
			double fTemp728 = fTemp677 * (fTemp698 - fRec866[1]) + fRec865[1];
			fRec865[0] = 2.0 * (fTemp728 / fTemp678) - fRec865[1];
			fRec866[0] = fRec866[1] + 2.0 * (fTemp677 * fTemp728 / fTemp678);
			double fRec867 = fTemp680 * fTemp728 / fTemp678;
			double fTemp729 = fTemp682 * (fTemp698 - fRec869[1]) + fRec868[1];
			fRec868[0] = 2.0 * (fTemp729 / fTemp683) - fRec868[1];
			fRec869[0] = fRec869[1] + 2.0 * (fTemp682 * fTemp729 / fTemp683);
			double fRec870 = fTemp685 * fTemp729 / fTemp683;
			double fTemp730 = fTemp687 * (fTemp698 - fRec872[1]) + fRec871[1];
			fRec871[0] = 2.0 * (fTemp730 / fTemp688) - fRec871[1];
			fRec872[0] = fRec872[1] + 2.0 * (fTemp687 * fTemp730 / fTemp688);
			double fRec873 = fTemp690 * fTemp730 / fTemp688;
			double fTemp731 = 0.03125 * fRec132[0] * (fRec873 + fRec870 + fRec867 + fRec864 + fRec861 + fRec858 + fRec855 + fRec852 + fRec849 + fRec846 + fRec843 + fRec840 + fRec837 + fRec834 + fRec831 + fRec828 + fRec825 + fRec822 + fRec819 + fRec816 + fRec813 + fRec810 + fRec807 + fRec804 + fRec801 + fRec798 + fRec795 + fRec792 + fRec789 + fRec786 + fRec783 + fRec780) + fRec31[0] * fTemp698;
			fRec773[0] = std::max<double>(fConst1 * fRec773[1], std::fabs(fTemp731));
			fVbargraph32 = FAUSTFLOAT(fRec773[0]);
			fRec661[0] = fTemp731;
			double fTemp732 = fRec23[0] * (fTemp521 * fTemp523 - fRec239[0] * fTemp693);
			double fTemp733 = fTemp695 + fTemp693;
			fVec16[0] = fTemp733 + fTemp732 + fTemp221;
			fRec877[0] = fTemp732 + 0.995 * fRec877[1] + fTemp733 + (1.6 - (fVec5[1] + fVec16[1]));
			fRec876[0] = std::max<double>(fConst1 * fRec876[1], std::fabs(fRec877[0]));
			fVbargraph33 = FAUSTFLOAT(fRec876[0]);
			double fTemp734 = fRec12[0] * tanh(fRec877[0] / fTemp0);
			fRec875[0] = std::max<double>(fConst1 * fRec875[1], std::fabs(fTemp734));
			fVbargraph34 = FAUSTFLOAT(fRec875[0]);
			double fTemp735 = fTemp734;
			double fTemp736 = fTemp518 * (fTemp735 - fRec879[1]) + fRec878[1];
			fRec878[0] = 2.0 * (fTemp736 / fTemp519) - fRec878[1];
			fRec879[0] = fRec879[1] + 2.0 * (fTemp518 * fTemp736 / fTemp519);
			double fRec880 = fTemp531 * fTemp736 / fTemp519;
			double fTemp737 = fTemp534 * (fTemp735 - fRec882[1]) + fRec881[1];
			fRec881[0] = 2.0 * (fTemp737 / fTemp535) - fRec881[1];
			fRec882[0] = fRec882[1] + 2.0 * (fTemp534 * fTemp737 / fTemp535);
			double fRec883 = fTemp537 * fTemp737 / fTemp535;
			double fTemp738 = fTemp539 * (fTemp735 - fRec885[1]) + fRec884[1];
			fRec884[0] = 2.0 * (fTemp738 / fTemp540) - fRec884[1];
			fRec885[0] = fRec885[1] + 2.0 * (fTemp539 * fTemp738 / fTemp540);
			double fRec886 = fTemp542 * fTemp738 / fTemp540;
			double fTemp739 = fTemp544 * (fTemp735 - fRec888[1]) + fRec887[1];
			fRec887[0] = 2.0 * (fTemp739 / fTemp545) - fRec887[1];
			fRec888[0] = fRec888[1] + 2.0 * (fTemp544 * fTemp739 / fTemp545);
			double fRec889 = fTemp547 * fTemp739 / fTemp545;
			double fTemp740 = fTemp549 * (fTemp735 - fRec891[1]) + fRec890[1];
			fRec890[0] = 2.0 * (fTemp740 / fTemp550) - fRec890[1];
			fRec891[0] = fRec891[1] + 2.0 * (fTemp549 * fTemp740 / fTemp550);
			double fRec892 = fTemp552 * fTemp740 / fTemp550;
			double fTemp741 = fTemp554 * (fTemp735 - fRec894[1]) + fRec893[1];
			fRec893[0] = 2.0 * (fTemp741 / fTemp555) - fRec893[1];
			fRec894[0] = fRec894[1] + 2.0 * (fTemp554 * fTemp741 / fTemp555);
			double fRec895 = fTemp557 * fTemp741 / fTemp555;
			double fTemp742 = fTemp559 * (fTemp735 - fRec897[1]) + fRec896[1];
			fRec896[0] = 2.0 * (fTemp742 / fTemp560) - fRec896[1];
			fRec897[0] = fRec897[1] + 2.0 * (fTemp559 * fTemp742 / fTemp560);
			double fRec898 = fTemp562 * fTemp742 / fTemp560;
			double fTemp743 = fTemp565 * (fTemp735 - fRec900[1]) + fRec899[1];
			fRec899[0] = 2.0 * (fTemp743 / fTemp566) - fRec899[1];
			fRec900[0] = fRec900[1] + 2.0 * (fTemp565 * fTemp743 / fTemp566);
			double fRec901 = fTemp568 * fTemp743 / fTemp566;
			double fTemp744 = fTemp571 * (fTemp735 - fRec903[1]) + fRec902[1];
			fRec902[0] = 2.0 * (fTemp744 / fTemp572) - fRec902[1];
			fRec903[0] = fRec903[1] + 2.0 * (fTemp571 * fTemp744 / fTemp572);
			double fRec904 = fTemp574 * fTemp744 / fTemp572;
			double fTemp745 = fTemp576 * (fTemp735 - fRec906[1]) + fRec905[1];
			fRec905[0] = 2.0 * (fTemp745 / fTemp577) - fRec905[1];
			fRec906[0] = fRec906[1] + 2.0 * (fTemp576 * fTemp745 / fTemp577);
			double fRec907 = fTemp579 * fTemp745 / fTemp577;
			double fTemp746 = fTemp581 * (fTemp735 - fRec909[1]) + fRec908[1];
			fRec908[0] = 2.0 * (fTemp746 / fTemp582) - fRec908[1];
			fRec909[0] = fRec909[1] + 2.0 * (fTemp581 * fTemp746 / fTemp582);
			double fRec910 = fTemp584 * fTemp746 / fTemp582;
			double fTemp747 = fTemp586 * (fTemp735 - fRec912[1]) + fRec911[1];
			fRec911[0] = 2.0 * (fTemp747 / fTemp587) - fRec911[1];
			fRec912[0] = fRec912[1] + 2.0 * (fTemp586 * fTemp747 / fTemp587);
			double fRec913 = fTemp589 * fTemp747 / fTemp587;
			double fTemp748 = fTemp591 * (fTemp735 - fRec915[1]) + fRec914[1];
			fRec914[0] = 2.0 * (fTemp748 / fTemp592) - fRec914[1];
			fRec915[0] = fRec915[1] + 2.0 * (fTemp591 * fTemp748 / fTemp592);
			double fRec916 = fTemp594 * fTemp748 / fTemp592;
			double fTemp749 = fTemp596 * (fTemp735 - fRec918[1]) + fRec917[1];
			fRec917[0] = 2.0 * (fTemp749 / fTemp597) - fRec917[1];
			fRec918[0] = fRec918[1] + 2.0 * (fTemp596 * fTemp749 / fTemp597);
			double fRec919 = fTemp599 * fTemp749 / fTemp597;
			double fTemp750 = fTemp601 * (fTemp735 - fRec921[1]) + fRec920[1];
			fRec920[0] = 2.0 * (fTemp750 / fTemp602) - fRec920[1];
			fRec921[0] = fRec921[1] + 2.0 * (fTemp601 * fTemp750 / fTemp602);
			double fRec922 = fTemp604 * fTemp750 / fTemp602;
			double fTemp751 = fTemp606 * (fTemp735 - fRec924[1]) + fRec923[1];
			fRec923[0] = 2.0 * (fTemp751 / fTemp607) - fRec923[1];
			fRec924[0] = fRec924[1] + 2.0 * (fTemp606 * fTemp751 / fTemp607);
			double fRec925 = fTemp609 * fTemp751 / fTemp607;
			double fTemp752 = fTemp612 * (fTemp735 - fRec927[1]) + fRec926[1];
			fRec926[0] = 2.0 * (fTemp752 / fTemp613) - fRec926[1];
			fRec927[0] = fRec927[1] + 2.0 * (fTemp612 * fTemp752 / fTemp613);
			double fRec928 = fTemp615 * fTemp752 / fTemp613;
			double fTemp753 = fTemp617 * (fTemp735 - fRec930[1]) + fRec929[1];
			fRec929[0] = 2.0 * (fTemp753 / fTemp618) - fRec929[1];
			fRec930[0] = fRec930[1] + 2.0 * (fTemp617 * fTemp753 / fTemp618);
			double fRec931 = fTemp620 * fTemp753 / fTemp618;
			double fTemp754 = fTemp622 * (fTemp735 - fRec933[1]) + fRec932[1];
			fRec932[0] = 2.0 * (fTemp754 / fTemp623) - fRec932[1];
			fRec933[0] = fRec933[1] + 2.0 * (fTemp622 * fTemp754 / fTemp623);
			double fRec934 = fTemp625 * fTemp754 / fTemp623;
			double fTemp755 = fTemp627 * (fTemp735 - fRec936[1]) + fRec935[1];
			fRec935[0] = 2.0 * (fTemp755 / fTemp628) - fRec935[1];
			fRec936[0] = fRec936[1] + 2.0 * (fTemp627 * fTemp755 / fTemp628);
			double fRec937 = fTemp630 * fTemp755 / fTemp628;
			double fTemp756 = fTemp632 * (fTemp735 - fRec939[1]) + fRec938[1];
			fRec938[0] = 2.0 * (fTemp756 / fTemp633) - fRec938[1];
			fRec939[0] = fRec939[1] + 2.0 * (fTemp632 * fTemp756 / fTemp633);
			double fRec940 = fTemp635 * fTemp756 / fTemp633;
			double fTemp757 = fTemp637 * (fTemp735 - fRec942[1]) + fRec941[1];
			fRec941[0] = 2.0 * (fTemp757 / fTemp638) - fRec941[1];
			fRec942[0] = fRec942[1] + 2.0 * (fTemp637 * fTemp757 / fTemp638);
			double fRec943 = fTemp640 * fTemp757 / fTemp638;
			double fTemp758 = fTemp642 * (fTemp735 - fRec945[1]) + fRec944[1];
			fRec944[0] = 2.0 * (fTemp758 / fTemp643) - fRec944[1];
			fRec945[0] = fRec945[1] + 2.0 * (fTemp642 * fTemp758 / fTemp643);
			double fRec946 = fTemp645 * fTemp758 / fTemp643;
			double fTemp759 = fTemp647 * (fTemp735 - fRec948[1]) + fRec947[1];
			fRec947[0] = 2.0 * (fTemp759 / fTemp648) - fRec947[1];
			fRec948[0] = fRec948[1] + 2.0 * (fTemp647 * fTemp759 / fTemp648);
			double fRec949 = fTemp650 * fTemp759 / fTemp648;
			double fTemp760 = fTemp652 * (fTemp735 - fRec951[1]) + fRec950[1];
			fRec950[0] = 2.0 * (fTemp760 / fTemp653) - fRec950[1];
			fRec951[0] = fRec951[1] + 2.0 * (fTemp652 * fTemp760 / fTemp653);
			double fRec952 = fTemp655 * fTemp760 / fTemp653;
			double fTemp761 = fTemp657 * (fTemp735 - fRec954[1]) + fRec953[1];
			fRec953[0] = 2.0 * (fTemp761 / fTemp658) - fRec953[1];
			fRec954[0] = fRec954[1] + 2.0 * (fTemp657 * fTemp761 / fTemp658);
			double fRec955 = fTemp660 * fTemp761 / fTemp658;
			double fTemp762 = fTemp662 * (fTemp735 - fRec957[1]) + fRec956[1];
			fRec956[0] = 2.0 * (fTemp762 / fTemp663) - fRec956[1];
			fRec957[0] = fRec957[1] + 2.0 * (fTemp662 * fTemp762 / fTemp663);
			double fRec958 = fTemp665 * fTemp762 / fTemp663;
			double fTemp763 = fTemp667 * (fTemp735 - fRec960[1]) + fRec959[1];
			fRec959[0] = 2.0 * (fTemp763 / fTemp668) - fRec959[1];
			fRec960[0] = fRec960[1] + 2.0 * (fTemp667 * fTemp763 / fTemp668);
			double fRec961 = fTemp670 * fTemp763 / fTemp668;
			double fTemp764 = fTemp672 * (fTemp735 - fRec963[1]) + fRec962[1];
			fRec962[0] = 2.0 * (fTemp764 / fTemp673) - fRec962[1];
			fRec963[0] = fRec963[1] + 2.0 * (fTemp672 * fTemp764 / fTemp673);
			double fRec964 = fTemp675 * fTemp764 / fTemp673;
			double fTemp765 = fTemp677 * (fTemp735 - fRec966[1]) + fRec965[1];
			fRec965[0] = 2.0 * (fTemp765 / fTemp678) - fRec965[1];
			fRec966[0] = fRec966[1] + 2.0 * (fTemp677 * fTemp765 / fTemp678);
			double fRec967 = fTemp680 * fTemp765 / fTemp678;
			double fTemp766 = fTemp682 * (fTemp735 - fRec969[1]) + fRec968[1];
			fRec968[0] = 2.0 * (fTemp766 / fTemp683) - fRec968[1];
			fRec969[0] = fRec969[1] + 2.0 * (fTemp682 * fTemp766 / fTemp683);
			double fRec970 = fTemp685 * fTemp766 / fTemp683;
			double fTemp767 = fTemp687 * (fTemp735 - fRec972[1]) + fRec971[1];
			fRec971[0] = 2.0 * (fTemp767 / fTemp688) - fRec971[1];
			fRec972[0] = fRec972[1] + 2.0 * (fTemp687 * fTemp767 / fTemp688);
			double fRec973 = fTemp690 * fTemp767 / fTemp688;
			double fTemp768 = 0.03125 * fRec132[0] * (fRec973 + fRec970 + fRec967 + fRec964 + fRec961 + fRec958 + fRec955 + fRec952 + fRec949 + fRec946 + fRec943 + fRec940 + fRec937 + fRec934 + fRec931 + fRec928 + fRec925 + fRec922 + fRec919 + fRec916 + fRec913 + fRec910 + fRec907 + fRec904 + fRec901 + fRec898 + fRec895 + fRec892 + fRec889 + fRec886 + fRec883 + fRec880) + fRec31[0] * fTemp735;
			fRec874[0] = std::max<double>(fConst1 * fRec874[1], std::fabs(fTemp768));
			fVbargraph35 = FAUSTFLOAT(fRec874[0]);
			fRec662[0] = fTemp768;
			double fTemp769 = (fRec662[0] + fRec660[0] + fRec661[0]) / fTemp0;
			fVec17[IOTA0 & 4194303] = fTemp769;
			double fTemp770 = ((fRec974[1] != 0.0) ? (((fRec975[1] > 0.0) & (fRec975[1] < 1.0)) ? fRec974[1] : 0.0) : (((fRec975[1] == 0.0) & (fSlow28 != fRec976[1])) ? 0.0009765625 : (((fRec975[1] == 1.0) & (fSlow28 != fRec977[1])) ? -0.0009765625 : 0.0)));
			fRec974[0] = fTemp770;
			fRec975[0] = std::max<double>(0.0, std::min<double>(1.0, fRec975[1] + fTemp770));
			fRec976[0] = (((fRec975[1] >= 1.0) & (fRec977[1] != fSlow28)) ? fSlow28 : fRec976[1]);
			fRec977[0] = (((fRec975[1] <= 0.0) & (fRec976[1] != fSlow28)) ? fSlow28 : fRec977[1]);
			double fTemp771 = fVec17[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec976[0])))) & 4194303];
			fRec659[0] = 0.3333333333333333 * fTemp771 + fRec975[0] * (0.0 - 0.3333333333333333 * (fTemp771 - fVec17[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec977[0])))) & 4194303]));
			double fTemp772 = fRec21[0] * fRec979[1];
			fRec986[0] = std::max<double>(fConst1 * fRec986[1], std::fabs(fTemp772));
			fVbargraph36 = FAUSTFLOAT(fRec986[0]);
			double fTemp773 = fTemp772;
			double fTemp774 = fRec21[0] * fRec980[1];
			fRec987[0] = std::max<double>(fConst1 * fRec987[1], std::fabs(fTemp774));
			fVbargraph37 = FAUSTFLOAT(fRec987[0]);
			double fTemp775 = fTemp774;
			double fTemp776 = fTemp6 * (fTemp775 - fTemp773);
			double fTemp777 = fSlow29 * fRec6[1];
			fVec18[IOTA0 & 4194303] = fTemp777;
			double fTemp778 = ((fRec989[1] != 0.0) ? (((fRec990[1] > 0.0) & (fRec990[1] < 1.0)) ? fRec989[1] : 0.0) : (((fRec990[1] == 0.0) & (fSlow30 != fRec991[1])) ? 0.0009765625 : (((fRec990[1] == 1.0) & (fSlow30 != fRec992[1])) ? -0.0009765625 : 0.0)));
			fRec989[0] = fTemp778;
			fRec990[0] = std::max<double>(0.0, std::min<double>(1.0, fRec990[1] + fTemp778));
			fRec991[0] = (((fRec990[1] >= 1.0) & (fRec992[1] != fSlow30)) ? fSlow30 : fRec991[1]);
			fRec992[0] = (((fRec990[1] <= 0.0) & (fRec991[1] != fSlow30)) ? fSlow30 : fRec992[1]);
			double fTemp779 = fVec18[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec991[0])))) & 4194303];
			fRec988[0] = fTemp779 + fRec990[0] * (fVec18[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec992[0])))) & 4194303] - fTemp779);
			fVec19[0] = fRec988[1] + fTemp8 + fTemp773 + fTemp776 + fTemp1;
			fRec985[0] = fTemp776 + fRec988[1] + fTemp773 + fTemp8 + 0.995 * fRec985[1] + (1.2 - (fVec0[1] + fVec19[1]));
			fRec984[0] = std::max<double>(fConst1 * fRec984[1], std::fabs(fRec985[0]));
			fVbargraph38 = FAUSTFLOAT(fRec984[0]);
			double fTemp780 = fRec12[0] * tanh(fRec985[0] / fTemp0);
			fRec983[0] = std::max<double>(fConst1 * fRec983[1], std::fabs(fTemp780));
			...
			double fTemp782 = fRec997[0] * (147.0 - 27.0 * fRec996[0]);
			double fTemp783 = std::tan(fConst6 * fTemp782);
			double fTemp784 = fTemp783 * (fTemp783 + fTemp15 / fTemp782) + 1.0;
			double fTemp785 = fTemp783 * (fTemp781 - fRec994[1]) + fRec993[1];
			fRec993[0] = 2.0 * (fTemp785 / fTemp784) - fRec993[1];
			fRec994[0] = fRec994[1] + 2.0 * (fTemp783 * fTemp785 / fTemp784);
			fRec998[0] = fSlow33 + fConst3 * fRec998[1];
			double fTemp786 = fRec996[0] * (0.07073352 * fRec998[0] + -0.7955404699999999) + (1.0 - 0.20564242 * fRec998[0]);
			double fRec995 = fTemp785 * fTemp786 / fTemp784;
			double fTemp787 = 5462.0 * fRec998[0];
			double fTemp788 = fRec997[0] * (fTemp787 + fRec996[0] * (184.0 - 5696.0 * fRec998[0]) + 3.38e+03);
			double fTemp789 = std::tan(fConst6 * fTemp788);
			double fTemp790 = fTemp789 * (fTemp789 + fTemp15 / fTemp788) + 1.0;
			double fTemp791 = fTemp789 * (fTemp781 - fRec1000[1]) + fRec999[1];
			fRec999[0] = 2.0 * (fTemp791 / fTemp790) - fRec999[1];
			fRec1000[0] = fRec1000[1] + 2.0 * (fTemp789 * fTemp791 / fTemp790);
			double fTemp792 = fRec996[0] * (0.06439533 - 0.05859501 * fRec998[0]) + (0.00962998 - 0.00539943 * fRec998[0]);
			double fRec1001 = fTemp791 * fTemp792 / fTemp790;
			double fTemp793 = fRec997[0] * (1924.0 * fRec998[0] + fRec996[0] * (-67.0 - 1709.0 * fRec998[0]) + 2792.0);
			double fTemp794 = std::tan(fConst6 * fTemp793);
			double fTemp795 = fTemp794 * (fTemp794 + fTemp15 / fTemp793) + 1.0;
			double fTemp796 = fTemp794 * (fTemp781 - fRec1003[1]) + fRec1002[1];
			fRec1002[0] = 2.0 * (fTemp796 / fTemp795) - fRec1002[1];
			fRec1003[0] = fRec1003[1] + 2.0 * (fTemp794 * fTemp796 / fTemp795);
			double fTemp797 = fRec996[0] * (0.18126063 - 0.15936859 * fRec998[0]) + (0.03127152 - 0.026182169999999998 * fRec998[0]);
			double fRec1004 = fTemp796 * fTemp797 / fTemp795;
			double fTemp798 = fRec997[0] * (1334.0 * fRec998[0] + fRec996[0] * (69.0 - 1321.0 * fRec998[0]) + 2498.0);
			double fTemp799 = std::tan(fConst6 * fTemp798);
			double fTemp800 = fTemp799 * (fTemp799 + fTemp15 / fTemp798) + 1.0;
			double fTemp801 = fTemp799 * (fTemp781 - fRec1006[1]) + fRec1005[1];
			fRec1005[0] = 2.0 * (fTemp801 / fTemp800) - fRec1005[1];
			fRec1006[0] = fRec1006[1] + 2.0 * (fTemp799 * fTemp801 / fTemp800);
			double fTemp802 = 0.00024740000000000005 * fRec998[0] + fRec996[0] * (0.08007111 - 0.08267900999999998 * fRec998[0]) + 0.01134687;
			double fRec1007 = fTemp801 * fTemp802 / fTemp800;
			double fTemp803 = fRec997[0] * (1117.0 * fRec998[0] + fRec996[0] * (-4e+01 - 1001.0 * fRec998[0]) + 2273.0);
			double fTemp804 = std::tan(fConst6 * fTemp803);
			double fTemp805 = fTemp804 * (fTemp804 + fTemp15 / fTemp803) + 1.0;
			double fTemp806 = fTemp804 * (fTemp781 - fRec1009[1]) + fRec1008[1];
			fRec1008[0] = 2.0 * (fTemp806 / fTemp805) - fRec1008[1];
			fRec1009[0] = fRec1009[1] + 2.0 * (fTemp804 * fTemp806 / fTemp805);
			double fTemp807 = 0.009332220000000002 * fRec998[0] + fRec996[0] * (0.26175163 - 0.22162943000000002 * fRec998[0]) + 0.00656447;
			double fRec1010 = fTemp806 * fTemp807 / fTemp805;
			double fTemp808 = fRec997[0] * (1041.0 * fRec998[0] + fRec996[0] * (-121.0 - 812.0 * fRec998[0]) + 2054.0);
			double fTemp809 = std::tan(fConst6 * fTemp808);
			double fTemp810 = fTemp809 * (fTemp809 + fTemp15 / fTemp808) + 1.0;
			double fTemp811 = fTemp809 * (fTemp781 - fRec1012[1]) + fRec1011[1];
			fRec1011[0] = 2.0 * (fTemp811 / fTemp810) - fRec1011[1];
			fRec1012[0] = fRec1012[1] + 2.0 * (fTemp809 * fTemp811 / fTemp810);
			double fTemp812 = fRec996[0] * (0.39552505 - 0.38007101 * fRec998[0]) + (0.06985491 - 0.060508160000000005 * fRec998[0]);
			double fRec1013 = fTemp811 * fTemp812 / fTemp810;
			double fTemp813 = fRec997[0] * (945.0 * fRec998[0] + fRec996[0] * (-128.0 - 743.0 * fRec998[0]) + 1855.0);
			double fTemp814 = std::tan(fConst6 * fTemp813);
			double fTemp815 = fTemp814 * (fTemp814 + fTemp15 / fTemp813) + 1.0;
			double fTemp816 = fTemp814 * (fTemp781 - fRec1015[1]) + fRec1014[1];
			fRec1014[0] = 2.0 * (fTemp816 / fTemp815) - fRec1014[1];
			fRec1015[0] = fRec1015[1] + 2.0 * (fTemp814 * fTemp816 / fTemp815);
			double fTemp817 = 0.02476806 * fRec998[0] + fRec996[0] * (0.04345912 - 0.05426385 * fRec998[0]) + 0.01093969;
			double fRec1016 = fTemp816 * fTemp817 / fTemp815;
			double fTemp818 = 889.0 * fRec998[0];
			double fTemp819 = fRec997[0] * (fTemp818 + fRec996[0] * (-137.0 - 601.0 * fRec998[0]) + 1617.0);
			double fTemp820 = std::tan(fConst6 * fTemp819);
			double fTemp821 = fTemp820 * (fTemp820 + fTemp15 / fTemp819) + 1.0;
			double fTemp822 = fTemp820 * (fTemp781 - fRec1018[1]) + fRec1017[1];
			fRec1017[0] = 2.0 * (fTemp822 / fTemp821) - fRec1017[1];
			fRec1018[0] = fRec1018[1] + 2.0 * (fTemp820 * fTemp822 / fTemp821);
			double fTemp823 = fRec996[0] * (0.89755644 - 0.83241899 * fRec998[0]) + (0.07354127 - 0.06668288 * fRec998[0]);
			double fRec1019 = fTemp822 * fTemp823 / fTemp821;
			double fTemp824 = 888.0 * fRec998[0];
			double fTemp825 = fRec997[0] * (fTemp824 + fRec996[0] * (7.0 - 646.0 * fRec998[0]) + 1323.0);
			double fTemp826 = std::tan(fConst6 * fTemp825);
			double fTemp827 = fTemp826 * (fTemp826 + fTemp15 / fTemp825) + 1.0;
			double fTemp828 = fTemp826 * (fTemp781 - fRec1021[1]) + fRec1020[1];
			fRec1020[0] = 2.0 * (fTemp828 / fTemp827) - fRec1020[1];
			fRec1021[0] = fRec1021[1] + 2.0 * (fTemp826 * fTemp828 / fTemp827);
			double fTemp829 = 0.01378994 * fRec998[0] + fRec996[0] * (0.16180601 - 0.17199811 * fRec998[0]) + 0.07170723;
			double fRec1022 = fTemp828 * fTemp829 / fTemp827;
			double fTemp830 = fRec997[0] * (741.0 * fRec998[0] + fRec996[0] * (4.0 - 506.0 * fRec998[0]) + 1175.0);
			double fTemp831 = std::tan(fConst6 * fTemp830);
			double fTemp832 = fTemp831 * (fTemp831 + fTemp15 / fTemp830) + 1.0;
			double fTemp833 = fTemp831 * (fTemp781 - fRec1024[1]) + fRec1023[1];
			fRec1023[0] = 2.0 * (fTemp833 / fTemp832) - fRec1023[1];
			fRec1024[0] = fRec1024[1] + 2.0 * (fTemp831 * fTemp833 / fTemp832);
			double fTemp834 = fRec996[0] * (0.29407844000000005 - 0.3172501500000001 * fRec998[0]) + (0.28175268 - 0.21568321999999998 * fRec998[0]);
			double fRec1025 = fTemp833 * fTemp834 / fTemp832;
			double fTemp835 = fRec997[0] * (593.0 * fRec998[0] + fRec996[0] * (3.0 - 447.0 * fRec998[0]) + 1028.0);
			double fTemp836 = std::tan(fConst6 * fTemp835);
			double fTemp837 = fTemp836 * (fTemp836 + fTemp15 / fTemp835) + 1.0;
			double fTemp838 = fTemp836 * (fTemp781 - fRec1027[1]) + fRec1026[1];
			fRec1026[0] = 2.0 * (fTemp838 / fTemp837) - fRec1026[1];
			fRec1027[0] = fRec1027[1] + 2.0 * (fTemp836 * fTemp838 / fTemp837);
			double fTemp839 = 0.07792940000000001 * fRec998[0] + fRec996[0] * (0.19518858000000003 * fRec998[0] + 0.16366607) + 0.14442907;
			double fRec1028 = fTemp838 * fTemp839 / fTemp837;
			double fTemp840 = fRec997[0] * (444.0 * fRec998[0] + fRec996[0] * (-2.0 - 315.0 * fRec998[0]) + 882.0);
			double fTemp841 = std::tan(fConst6 * fTemp840);
			double fTemp842 = fTemp841 * (fTemp841 + fTemp15 / fTemp840) + 1.0;
			double fTemp843 = fTemp841 * (fTemp781 - fRec1030[1]) + fRec1029[1];
			fRec1029[0] = 2.0 * (fTemp843 / fTemp842) - fRec1029[1];
			fRec1030[0] = fRec1030[1] + 2.0 * (fTemp841 * fTemp843 / fTemp842);
			double fTemp844 = fRec996[0] * (0.14853099000000003 - 0.11225552000000005 * fRec998[0]) + (0.2722688 - 0.2582559 * fRec998[0]);
			double fRec1031 = fTemp843 * fTemp844 / fTemp842;
			double fTemp845 = fRec997[0] * (297.0 * fRec998[0] + fRec996[0] * (1.0 - 157.0 * fRec998[0]) + 735.0);
			double fTemp846 = std::tan(fConst6 * fTemp845);
			double fTemp847 = fTemp846 * (fTemp846 + fTemp15 / fTemp845) + 1.0;
			double fTemp848 = fTemp846 * (fTemp781 - fRec1033[1]) + fRec1032[1];
			fRec1032[0] = 2.0 * (fTemp848 / fTemp847) - fRec1032[1];
			fRec1033[0] = fRec1033[1] + 2.0 * (fTemp846 * fTemp848 / fTemp847);
			double fTemp849 = fRec996[0] * (0.17857318999999994 - 0.36552292 * fRec998[0]) + (0.54357606 - 0.31600273 * fRec998[0]);
			double fRec1034 = fTemp848 * fTemp849 / fTemp847;
			double fTemp850 = fRec997[0] * (203.0 * fRec998[0] + fRec996[0] * (3.0 - 29.0 * fRec998[0]) + 534.0);
			double fTemp851 = std::tan(fConst6 * fTemp850);
			double fTemp852 = fTemp851 * (fTemp851 + fTemp15 / fTemp850) + 1.0;
			double fTemp853 = fTemp851 * (fTemp781 - fRec1036[1]) + fRec1035[1];
			fRec1035[0] = 2.0 * (fTemp853 / fTemp852) - fRec1035[1];
			fRec1036[0] = fRec1036[1] + 2.0 * (fTemp851 * fTemp853 / fTemp852);
			double fTemp854 = 0.67536956 * fRec998[0] + fRec996[0] * (0.16028896 - 0.80657534 * fRec998[0]) + 0.0250452;
			double fRec1037 = fTemp853 * fTemp854 / fTemp852;
			double fTemp855 = fRec997[0] * (75.0 * fRec998[0] + fRec996[0] * (0.0 - 79.0 * fRec998[0]) + 367.0);
			double fTemp856 = std::tan(fConst6 * fTemp855);
			double fTemp857 = fTemp856 * (fTemp856 + fTemp15 / fTemp855) + 1.0;
			double fTemp858 = fTemp856 * (fTemp781 - fRec1039[1]) + fRec1038[1];
			fRec1038[0] = 2.0 * (fTemp858 / fTemp857) - fRec1038[1];
			fRec1039[0] = fRec1039[1] + 2.0 * (fTemp856 * fTemp858 / fTemp857);
			double fTemp859 = 0.28677124 * fRec998[0] + fRec996[0] * (0.27661398 - 0.52141959 * fRec998[0]) + 0.02470587;
			double fRec1040 = fTemp858 * fTemp859 / fTemp857;
			double fTemp860 = fRec997[0] * (92.0 * fRec998[0] + fRec996[0] * (-1e+01 - 96.0 * fRec998[0]) + 203.0);
			double fTemp861 = std::tan(fConst6 * fTemp860);
			double fTemp862 = fTemp861 * (fTemp861 + fTemp15 / fTemp860) + 1.0;
			double fTemp863 = fTemp861 * (fTemp781 - fRec1042[1]) + fRec1041[1];
			fRec1041[0] = 2.0 * (fTemp863 / fTemp862) - fRec1041[1];
			fRec1042[0] = fRec1042[1] + 2.0 * (fTemp861 * fTemp863 / fTemp862);
			double fTemp864 = 0.9594288 * fRec998[0] + fRec996[0] * (0.32743217999999996 - 0.9405872099999999 * fRec998[0]) + 0.0405712;
			double fRec1043 = fTemp863 * fTemp864 / fTemp862;
			double fTemp865 = 6.0 * fRec998[0];
			double fTemp866 = fRec997[0] * (fRec996[0] * (fTemp865 + -3.0) + (53.0 - fTemp865));
			double fTemp867 = std::tan(fConst6 * fTemp866);
			double fTemp868 = fTemp867 * (fTemp867 + fTemp15 / fTemp866) + 1.0;
			double fTemp869 = fTemp867 * (fTemp781 - fRec1045[1]) + fRec1044[1];
			fRec1044[0] = 2.0 * (fTemp869 / fTemp868) - fRec1044[1];
			fRec1045[0] = fRec1045[1] + 2.0 * (fTemp867 * fTemp869 / fTemp868);
			double fTemp870 = fRec996[0] * (0.02738166999999999 * fRec998[0] + 0.04900900000000001) + (0.07116083 - 0.059562029999999995 * fRec998[0]);
			double fRec1046 = fTemp869 * fTemp870 / fTemp868;
			double fTemp871 = fRec997[0] * (82.0 * fRec998[0] + fRec996[0] * (14.0 - 89.0 * fRec998[0]) + 294.0);
			double fTemp872 = std::tan(fConst6 * fTemp871);
			double fTemp873 = fTemp872 * (fTemp872 + fTemp15 / fTemp871) + 1.0;
			double fTemp874 = fTemp872 * (fTemp781 - fRec1048[1]) + fRec1047[1];
			fRec1047[0] = 2.0 * (fTemp874 / fTemp873) - fRec1047[1];
			fRec1048[0] = fRec1048[1] + 2.0 * (fTemp872 * fTemp874 / fTemp873);
			double fTemp875 = fRec996[0] * (0.45472109 * fRec998[0] + -0.34135506) + (0.49828005 - 0.49066910999999996 * fRec998[0]);
			double fRec1049 = fTemp874 * fTemp875 / fTemp873;
			double fTemp876 = fRec997[0] * (148.0 * fRec998[0] + fRec996[0] * (12.0 - 13.0 * fRec998[0]) + 441.0);
			double fTemp877 = std::tan(fConst6 * fTemp876);
			double fTemp878 = fTemp877 * (fTemp877 + fTemp15 / fTemp876) + 1.0;
			double fTemp879 = fTemp877 * (fTemp781 - fRec1051[1]) + fRec1050[1];
			fRec1050[0] = 2.0 * (fTemp879 / fTemp878) - fRec1050[1];
			fRec1051[0] = fRec1051[1] + 2.0 * (fTemp877 * fTemp879 / fTemp878);
			double fTemp880 = 0.026025509999999974 * fRec998[0] + fRec996[0] * (0.82424861 * fRec998[0] + -0.10070198) + 0.25042786;
			double fRec1052 = fTemp879 * fTemp880 / fTemp878;
			double fTemp881 = fRec997[0] * (296.0 * fRec998[0] + fRec996[0] * (1.0 - 1.1e+02 * fRec998[0]) + 588.0);
			double fTemp882 = std::tan(fConst6 * fTemp881);
			double fTemp883 = fTemp882 * (fTemp882 + fTemp15 / fTemp881) + 1.0;
			double fTemp884 = fTemp882 * (fTemp781 - fRec1054[1]) + fRec1053[1];
			fRec1053[0] = 2.0 * (fTemp884 / fTemp883) - fRec1053[1];
			fRec1054[0] = fRec1054[1] + 2.0 * (fTemp882 * fTemp884 / fTemp883);
			double fTemp885 = 0.27049557 * fRec998[0] + fRec996[0] * (0.23776758000000003 - 0.53709331 * fRec998[0]) + 0.09954785;
			double fRec1055 = fTemp884 * fTemp885 / fTemp883;
			double fTemp886 = fRec997[0] * (394.0 * fRec998[0] + fRec996[0] * (43.0 - 285.0 * fRec998[0]) + 785.0);
			double fTemp887 = std::tan(fConst6 * fTemp886);
			double fTemp888 = fTemp887 * (fTemp887 + fTemp15 / fTemp886) + 1.0;
			double fTemp889 = fTemp887 * (fTemp781 - fRec1057[1]) + fRec1056[1];
			fRec1056[0] = 2.0 * (fTemp889 / fTemp888) - fRec1056[1];
			fRec1057[0] = fRec1057[1] + 2.0 * (fTemp887 * fTemp889 / fTemp888);
			double fTemp890 = 0.24706891000000003 * fRec998[0] + fRec996[0] * (0.037263420000000005 - 0.24153450000000004 * fRec998[0]) + 0.01573797;
			double fRec1058 = fTemp889 * fTemp890 / fTemp888;
			double fTemp891 = fRec997[0] * (513.0 * fRec998[0] + fRec996[0] * (3.0 - 381.0 * fRec998[0]) + 961.0);
			double fTemp892 = std::tan(fConst6 * fTemp891);
			double fTemp893 = fTemp892 * (fTemp892 + fTemp15 / fTemp891) + 1.0;
			double fTemp894 = fTemp892 * (fTemp781 - fRec1060[1]) + fRec1059[1];
			fRec1059[0] = 2.0 * (fTemp894 / fTemp893) - fRec1059[1];
			fRec1060[0] = fRec1060[1] + 2.0 * (fTemp892 * fTemp894 / fTemp893);
			double fTemp895 = 0.25012827 * fRec998[0] + fRec996[0] * (0.11585875999999999 - 0.20043951 * fRec998[0]) + 0.01228042;
			double fRec1061 = fTemp894 * fTemp895 / fTemp893;
			double fTemp896 = fRec997[0] * (6.9e+02 * fRec998[0] + fRec996[0] * (23.0 - 483.0 * fRec998[0]) + 1078.0);
			double fTemp897 = std::tan(fConst6 * fTemp896);
			double fTemp898 = fTemp897 * (fTemp897 + fTemp15 / fTemp896) + 1.0;
			double fTemp899 = fTemp897 * (fTemp781 - fRec1063[1]) + fRec1062[1];
			fRec1062[0] = 2.0 * (fTemp899 / fTemp898) - fRec1062[1];
			fRec1063[0] = fRec1063[1] + 2.0 * (fTemp897 * fTemp899 / fTemp898);
			double fTemp900 = 0.08014510000000001 * fRec998[0] + fRec996[0] * (0.08188717000000001 - 0.15931663000000001 * fRec998[0]) + 0.01626654;
			double fRec1064 = fTemp899 * fTemp900 / fTemp898;
			double fTemp901 = fRec997[0] * (794.0 * fRec998[0] + fRec996[0] * (6.0 - 563.0 * fRec998[0]) + 1269.0);
			double fTemp902 = std::tan(fConst6 * fTemp901);
			double fTemp903 = fTemp902 * (fTemp902 + fTemp15 / fTemp901) + 1.0;
			double fTemp904 = fTemp902 * (fTemp781 - fRec1066[1]) + fRec1065[1];
			fRec1065[0] = 2.0 * (fTemp904 / fTemp903) - fRec1065[1];
			fRec1066[0] = fRec1066[1] + 2.0 * (fTemp902 * fTemp904 / fTemp903);
			double fTemp905 = 0.15692174 * fRec998[0] + fRec996[0] * (0.019392789999999997 - 0.13171841 * fRec998[0]) + 0.02115358;
			double fRec1067 = fTemp904 * fTemp905 / fTemp903;
			double fTemp906 = fRec997[0] * (fTemp824 + fRec996[0] * (-62.0 - 612.0 * fRec998[0]) + 1.47e+03);
			double fTemp907 = std::tan(fConst6 * fTemp906);
			double fTemp908 = fTemp907 * (fTemp907 + fTemp15 / fTemp906) + 1.0;
			double fTemp909 = fTemp907 * (fTemp781 - fRec1069[1]) + fRec1068[1];
			fRec1068[0] = 2.0 * (fTemp909 / fTemp908) - fRec1068[1];
			fRec1069[0] = fRec1069[1] + 2.0 * (fTemp907 * fTemp909 / fTemp908);
			double fTemp910 = fRec996[0] * (0.020997170000000002 - 0.020033680000000005 * fRec998[0]) + (0.06191843 - 0.02241523 * fRec998[0]);
			double fRec1070 = fTemp909 * fTemp910 / fTemp908;
			double fTemp911 = fRec997[0] * (fTemp818 + fRec996[0] * (-134.0 - 649.0 * fRec998[0]) + 1764.0);
			double fTemp912 = std::tan(fConst6 * fTemp911);
			double fTemp913 = fTemp912 * (fTemp912 + fTemp15 / fTemp911) + 1.0;
			double fTemp914 = fTemp912 * (fTemp781 - fRec1072[1]) + fRec1071[1];
			fRec1071[0] = 2.0 * (fTemp914 / fTemp913) - fRec1071[1];
			fRec1072[0] = fRec1072[1] + 2.0 * (fTemp912 * fTemp914 / fTemp913);
			double fTemp915 = fRec996[0] * (0.94873963 - 0.9622067 * fRec998[0]) + (0.05126037 - 0.02103158 * fRec998[0]);
			double fRec1073 = fTemp914 * fTemp915 / fTemp913;
			double fTemp916 = fRec997[0] * (1037.0 * fRec998[0] + fRec996[0] * (-128.0 - 751.0 * fRec998[0]) + 1.91e+03);
			double fTemp917 = std::tan(fConst6 * fTemp916);
			double fTemp918 = fTemp917 * (fTemp917 + fTemp15 / fTemp916) + 1.0;
			double fTemp919 = fTemp917 * (fTemp781 - fRec1075[1]) + fRec1074[1];
			fRec1074[0] = 2.0 * (fTemp919 / fTemp918) - fRec1074[1];
			fRec1075[0] = fRec1075[1] + 2.0 * (fTemp917 * fTemp919 / fTemp918);
			double fTemp920 = fRec996[0] * (0.58336649 - 0.5666712700000001 * fRec998[0]) + (0.0343155 - 0.02668976 * fRec998[0]);
			double fRec1076 = fTemp919 * fTemp920 / fTemp918;
			double fTemp921 = fRec997[0] * (1038.0 * fRec998[0] + fRec996[0] * (-119.0 - 846.0 * fRec998[0]) + 2204.0);
			double fTemp922 = std::tan(fConst6 * fTemp921);
			double fTemp923 = fTemp922 * (fTemp922 + fTemp15 / fTemp921) + 1.0;
			double fTemp924 = fTemp922 * (fTemp781 - fRec1078[1]) + fRec1077[1];
			fRec1077[0] = 2.0 * (fTemp924 / fTemp923) - fRec1077[1];
			fRec1078[0] = fRec1078[1] + 2.0 * (fTemp922 * fTemp924 / fTemp923);
			double fTemp925 = fRec996[0] * (0.5577936099999999 - 0.54352849 * fRec998[0]) + (0.09585942 - 0.086804 * fRec998[0]);
			double fRec1079 = fTemp924 * fTemp925 / fTemp923;
			double fTemp926 = fRec997[0] * (1186.0 * fRec998[0] + fRec996[0] * (51.0 - 1.13e+03 * fRec998[0]) + 2351.0);
			double fTemp927 = std::tan(fConst6 * fTemp926);
			double fTemp928 = fTemp927 * (fTemp927 + fTemp15 / fTemp926) + 1.0;
			double fTemp929 = fTemp927 * (fTemp781 - fRec1081[1]) + fRec1080[1];
			fRec1080[0] = 2.0 * (fTemp929 / fTemp928) - fRec1080[1];
			fRec1081[0] = fRec1081[1] + 2.0 * (fTemp927 * fTemp929 / fTemp928);
			double fTemp930 = fRec996[0] * (0.18329145 - 0.17669554 * fRec998[0]) + (0.01233555 - 0.008431840000000001 * fRec998[0]);
			double fRec1082 = fTemp929 * fTemp930 / fTemp928;
			double fTemp931 = fRec997[0] * (1481.0 * fRec998[0] + fRec996[0] * (13.0 - 1359.0 * fRec998[0]) + 2645.0);
			double fTemp932 = std::tan(fConst6 * fTemp931);
			double fTemp933 = fTemp932 * (fTemp932 + fTemp15 / fTemp931) + 1.0;
			double fTemp934 = fTemp932 * (fTemp781 - fRec1084[1]) + fRec1083[1];
			fRec1083[0] = 2.0 * (fTemp934 / fTemp933) - fRec1083[1];
			fRec1084[0] = fRec1084[1] + 2.0 * (fTemp932 * fTemp934 / fTemp933);
			double fTemp935 = fRec996[0] * (0.052822430000000004 - 0.026333230000000006 * fRec998[0]) + (0.01055565 - 0.00626412 * fRec998[0]);
			double fRec1085 = fTemp934 * fTemp935 / fTemp933;
			double fTemp936 = fRec997[0] * (fTemp787 + fRec996[0] * (152.0 - 5648.0 * fRec998[0]) + 3233.0);
			double fTemp937 = std::tan(fConst6 * fTemp936);
			double fTemp938 = fTemp937 * (fTemp937 + fTemp15 / fTemp936) + 1.0;
			double fTemp939 = fTemp937 * (fTemp781 - fRec1087[1]) + fRec1086[1];
			fRec1086[0] = 2.0 * (fTemp939 / fTemp938) - fRec1086[1];
			fRec1087[0] = fRec1087[1] + 2.0 * (fTemp937 * fTemp939 / fTemp938);
			double fTemp940 = fRec996[0] * (0.03251611 - 0.026476020000000003 * fRec998[0]) + (0.01587526 - 0.011935889999999998 * fRec998[0]);
			double fRec1088 = fTemp939 * fTemp940 / fTemp938;
			double fTemp941 = fRec997[0] * (5463.0 * fRec998[0] + fRec996[0] * (189.0 - 5063.0 * fRec998[0]) + 3527.0);
			double fTemp942 = std::tan(fConst6 * fTemp941);
			double fTemp943 = fTemp942 * (fTemp942 + fTemp15 / fTemp941) + 1.0;
			double fTemp944 = fTemp942 * (fTemp781 - fRec1090[1]) + fRec1089[1];
			fRec1089[0] = 2.0 * (fTemp944 / fTemp943) - fRec1089[1];
			fRec1090[0] = fRec1090[1] + 2.0 * (fTemp942 * fTemp944 / fTemp943);
			double fTemp945 = fRec996[0] * (0.14146586 - 0.1338637 * fRec998[0]) + (0.0068168 - 0.0019190699999999993 * fRec998[0]);
			double fRec1091 = fTemp944 * fTemp945 / fTemp943;
			double fTemp946 = 0.03125 * fRec132[0] * (fRec1091 + fRec1088 + fRec1085 + fRec1082 + fRec1079 + fRec1076 + fRec1073 + fRec1070 + fRec1067 + fRec1064 + fRec1061 + fRec1058 + fRec1055 + fRec1052 + fRec1049 + fRec1046 + fRec1043 + fRec1040 + fRec1037 + fRec1034 + fRec1031 + fRec1028 + fRec1025 + fRec1022 + fRec1019 + fRec1016 + fRec1013 + fRec1010 + fRec1007 + fRec1004 + fRec1001 + fRec995) + fRec31[0] * fTemp781;
			fRec982[0] = std::max<double>(fConst1 * fRec982[1], std::fabs(fTemp946));
			fVbargraph40 = FAUSTFLOAT(fRec982[0]);
			fRec979[0] = fTemp946;
			double fTemp947 = fRec21[0] * fRec981[1];
			fRec1096[0] = std::max<double>(fConst1 * fRec1096[1], std::fabs(fTemp947));
			fVbargraph41 = FAUSTFLOAT(fRec1096[0]);
			double fTemp948 = fTemp947;
			double fTemp949 = fRec23[0] * (fTemp773 * (fRec138[0] - fTemp948) - fTemp775);
			double fTemp950 = fTemp8 + fRec988[1];
			double fTemp951 = fTemp950 + fTemp775;
			fVec20[0] = fTemp951 + fTemp949 + fTemp180;
			fRec1095[0] = fTemp949 + 0.995 * fRec1095[1] + fTemp951 + (1.3 - (fVec3[1] + fVec20[1]));
			fRec1094[0] = std::max<double>(fConst1 * fRec1094[1], std::fabs(fRec1095[0]));
			fVbargraph42 = FAUSTFLOAT(fRec1094[0]);
			double fTemp952 = fRec12[0] * tanh(fRec1095[0] / fTemp0);
			fRec1093[0] = std::max<double>(fConst1 * fRec1093[1], std::fabs(fTemp952));
			fVbargraph43 = FAUSTFLOAT(fRec1093[0]);
			double fTemp953 = fTemp952;
			double fTemp954 = fTemp783 * (fTemp953 - fRec1098[1]) + fRec1097[1];
			fRec1097[0] = 2.0 * (fTemp954 / fTemp784) - fRec1097[1];
			fRec1098[0] = fRec1098[1] + 2.0 * (fTemp783 * fTemp954 / fTemp784);
			double fRec1099 = fTemp786 * fTemp954 / fTemp784;
			double fTemp955 = fTemp789 * (fTemp953 - fRec1101[1]) + fRec1100[1];
			fRec1100[0] = 2.0 * (fTemp955 / fTemp790) - fRec1100[1];
			fRec1101[0] = fRec1101[1] + 2.0 * (fTemp789 * fTemp955 / fTemp790);
			double fRec1102 = fTemp792 * fTemp955 / fTemp790;
			double fTemp956 = fTemp794 * (fTemp953 - fRec1104[1]) + fRec1103[1];
			fRec1103[0] = 2.0 * (fTemp956 / fTemp795) - fRec1103[1];
			fRec1104[0] = fRec1104[1] + 2.0 * (fTemp794 * fTemp956 / fTemp795);
			double fRec1105 = fTemp797 * fTemp956 / fTemp795;
			double fTemp957 = fTemp799 * (fTemp953 - fRec1107[1]) + fRec1106[1];
			fRec1106[0] = 2.0 * (fTemp957 / fTemp800) - fRec1106[1];
			fRec1107[0] = fRec1107[1] + 2.0 * (fTemp799 * fTemp957 / fTemp800);
			double fRec1108 = fTemp802 * fTemp957 / fTemp800;
			double fTemp958 = fTemp804 * (fTemp953 - fRec1110[1]) + fRec1109[1];
			fRec1109[0] = 2.0 * (fTemp958 / fTemp805) - fRec1109[1];
			fRec1110[0] = fRec1110[1] + 2.0 * (fTemp804 * fTemp958 / fTemp805);
			double fRec1111 = fTemp807 * fTemp958 / fTemp805;
			double fTemp959 = fTemp809 * (fTemp953 - fRec1113[1]) + fRec1112[1];
			fRec1112[0] = 2.0 * (fTemp959 / fTemp810) - fRec1112[1];
			fRec1113[0] = fRec1113[1] + 2.0 * (fTemp809 * fTemp959 / fTemp810);
			double fRec1114 = fTemp812 * fTemp959 / fTemp810;
			double fTemp960 = fTemp814 * (fTemp953 - fRec1116[1]) + fRec1115[1];
			fRec1115[0] = 2.0 * (fTemp960 / fTemp815) - fRec1115[1];
			fRec1116[0] = fRec1116[1] + 2.0 * (fTemp814 * fTemp960 / fTemp815);
			double fRec1117 = fTemp817 * fTemp960 / fTemp815;
			double fTemp961 = fTemp820 * (fTemp953 - fRec1119[1]) + fRec1118[1];
			fRec1118[0] = 2.0 * (fTemp961 / fTemp821) - fRec1118[1];
			fRec1119[0] = fRec1119[1] + 2.0 * (fTemp820 * fTemp961 / fTemp821);
			double fRec1120 = fTemp823 * fTemp961 / fTemp821;
			double fTemp962 = fTemp826 * (fTemp953 - fRec1122[1]) + fRec1121[1];
			fRec1121[0] = 2.0 * (fTemp962 / fTemp827) - fRec1121[1];
			fRec1122[0] = fRec1122[1] + 2.0 * (fTemp826 * fTemp962 / fTemp827);
			double fRec1123 = fTemp829 * fTemp962 / fTemp827;
			double fTemp963 = fTemp831 * (fTemp953 - fRec1125[1]) + fRec1124[1];
			fRec1124[0] = 2.0 * (fTemp963 / fTemp832) - fRec1124[1];
			fRec1125[0] = fRec1125[1] + 2.0 * (fTemp831 * fTemp963 / fTemp832);
			double fRec1126 = fTemp834 * fTemp963 / fTemp832;
			double fTemp964 = fTemp836 * (fTemp953 - fRec1128[1]) + fRec1127[1];
			fRec1127[0] = 2.0 * (fTemp964 / fTemp837) - fRec1127[1];
			fRec1128[0] = fRec1128[1] + 2.0 * (fTemp836 * fTemp964 / fTemp837);
			double fRec1129 = fTemp839 * fTemp964 / fTemp837;
			double fTemp965 = fTemp841 * (fTemp953 - fRec1131[1]) + fRec1130[1];
			fRec1130[0] = 2.0 * (fTemp965 / fTemp842) - fRec1130[1];
			fRec1131[0] = fRec1131[1] + 2.0 * (fTemp841 * fTemp965 / fTemp842);
			double fRec1132 = fTemp844 * fTemp965 / fTemp842;
			double fTemp966 = fTemp846 * (fTemp953 - fRec1134[1]) + fRec1133[1];
			fRec1133[0] = 2.0 * (fTemp966 / fTemp847) - fRec1133[1];
			fRec1134[0] = fRec1134[1] + 2.0 * (fTemp846 * fTemp966 / fTemp847);
			double fRec1135 = fTemp849 * fTemp966 / fTemp847;
			double fTemp967 = fTemp851 * (fTemp953 - fRec1137[1]) + fRec1136[1];
			fRec1136[0] = 2.0 * (fTemp967 / fTemp852) - fRec1136[1];
			fRec1137[0] = fRec1137[1] + 2.0 * (fTemp851 * fTemp967 / fTemp852);
			double fRec1138 = fTemp854 * fTemp967 / fTemp852;
			double fTemp968 = fTemp856 * (fTemp953 - fRec1140[1]) + fRec1139[1];
			fRec1139[0] = 2.0 * (fTemp968 / fTemp857) - fRec1139[1];
			fRec1140[0] = fRec1140[1] + 2.0 * (fTemp856 * fTemp968 / fTemp857);
			double fRec1141 = fTemp859 * fTemp968 / fTemp857;
			double fTemp969 = fTemp861 * (fTemp953 - fRec1143[1]) + fRec1142[1];
			fRec1142[0] = 2.0 * (fTemp969 / fTemp862) - fRec1142[1];
			fRec1143[0] = fRec1143[1] + 2.0 * (fTemp861 * fTemp969 / fTemp862);
			double fRec1144 = fTemp864 * fTemp969 / fTemp862;
			double fTemp970 = fTemp867 * (fTemp953 - fRec1146[1]) + fRec1145[1];
			fRec1145[0] = 2.0 * (fTemp970 / fTemp868) - fRec1145[1];
			fRec1146[0] = fRec1146[1] + 2.0 * (fTemp867 * fTemp970 / fTemp868);
			double fRec1147 = fTemp870 * fTemp970 / fTemp868;
			double fTemp971 = fTemp872 * (fTemp953 - fRec1149[1]) + fRec1148[1];
			fRec1148[0] = 2.0 * (fTemp971 / fTemp873) - fRec1148[1];
			fRec1149[0] = fRec1149[1] + 2.0 * (fTemp872 * fTemp971 / fTemp873);
			double fRec1150 = fTemp875 * fTemp971 / fTemp873;
			double fTemp972 = fTemp877 * (fTemp953 - fRec1152[1]) + fRec1151[1];
			fRec1151[0] = 2.0 * (fTemp972 / fTemp878) - fRec1151[1];
			fRec1152[0] = fRec1152[1] + 2.0 * (fTemp877 * fTemp972 / fTemp878);
			double fRec1153 = fTemp880 * fTemp972 / fTemp878;
			double fTemp973 = fTemp882 * (fTemp953 - fRec1155[1]) + fRec1154[1];
			fRec1154[0] = 2.0 * (fTemp973 / fTemp883) - fRec1154[1];
			fRec1155[0] = fRec1155[1] + 2.0 * (fTemp882 * fTemp973 / fTemp883);
			double fRec1156 = fTemp885 * fTemp973 / fTemp883;
			double fTemp974 = fTemp887 * (fTemp953 - fRec1158[1]) + fRec1157[1];
			fRec1157[0] = 2.0 * (fTemp974 / fTemp888) - fRec1157[1];
			fRec1158[0] = fRec1158[1] + 2.0 * (fTemp887 * fTemp974 / fTemp888);
			double fRec1159 = fTemp890 * fTemp974 / fTemp888;
			double fTemp975 = fTemp892 * (fTemp953 - fRec1161[1]) + fRec1160[1];
			fRec1160[0] = 2.0 * (fTemp975 / fTemp893) - fRec1160[1];
			fRec1161[0] = fRec1161[1] + 2.0 * (fTemp892 * fTemp975 / fTemp893);
			double fRec1162 = fTemp895 * fTemp975 / fTemp893;
			double fTemp976 = fTemp897 * (fTemp953 - fRec1164[1]) + fRec1163[1];
			fRec1163[0] = 2.0 * (fTemp976 / fTemp898) - fRec1163[1];
			fRec1164[0] = fRec1164[1] + 2.0 * (fTemp897 * fTemp976 / fTemp898);
			double fRec1165 = fTemp900 * fTemp976 / fTemp898;
			double fTemp977 = fTemp902 * (fTemp953 - fRec1167[1]) + fRec1166[1];
			fRec1166[0] = 2.0 * (fTemp977 / fTemp903) - fRec1166[1];
			fRec1167[0] = fRec1167[1] + 2.0 * (fTemp902 * fTemp977 / fTemp903);
			double fRec1168 = fTemp905 * fTemp977 / fTemp903;
			double fTemp978 = fTemp907 * (fTemp953 - fRec1170[1]) + fRec1169[1];
			fRec1169[0] = 2.0 * (fTemp978 / fTemp908) - fRec1169[1];
			fRec1170[0] = fRec1170[1] + 2.0 * (fTemp907 * fTemp978 / fTemp908);
			double fRec1171 = fTemp910 * fTemp978 / fTemp908;
			double fTemp979 = fTemp912 * (fTemp953 - fRec1173[1]) + fRec1172[1];
			fRec1172[0] = 2.0 * (fTemp979 / fTemp913) - fRec1172[1];
			fRec1173[0] = fRec1173[1] + 2.0 * (fTemp912 * fTemp979 / fTemp913);
			double fRec1174 = fTemp915 * fTemp979 / fTemp913;
			double fTemp980 = fTemp917 * (fTemp953 - fRec1176[1]) + fRec1175[1];
			fRec1175[0] = 2.0 * (fTemp980 / fTemp918) - fRec1175[1];
			fRec1176[0] = fRec1176[1] + 2.0 * (fTemp917 * fTemp980 / fTemp918);
			double fRec1177 = fTemp920 * fTemp980 / fTemp918;
			double fTemp981 = fTemp922 * (fTemp953 - fRec1179[1]) + fRec1178[1];
			fRec1178[0] = 2.0 * (fTemp981 / fTemp923) - fRec1178[1];
			fRec1179[0] = fRec1179[1] + 2.0 * (fTemp922 * fTemp981 / fTemp923);
			double fRec1180 = fTemp925 * fTemp981 / fTemp923;
			double fTemp982 = fTemp927 * (fTemp953 - fRec1182[1]) + fRec1181[1];
			fRec1181[0] = 2.0 * (fTemp982 / fTemp928) - fRec1181[1];
			fRec1182[0] = fRec1182[1] + 2.0 * (fTemp927 * fTemp982 / fTemp928);
			double fRec1183 = fTemp930 * fTemp982 / fTemp928;
			double fTemp983 = fTemp932 * (fTemp953 - fRec1185[1]) + fRec1184[1];
			fRec1184[0] = 2.0 * (fTemp983 / fTemp933) - fRec1184[1];
			fRec1185[0] = fRec1185[1] + 2.0 * (fTemp932 * fTemp983 / fTemp933);
			double fRec1186 = fTemp935 * fTemp983 / fTemp933;
			double fTemp984 = fTemp937 * (fTemp953 - fRec1188[1]) + fRec1187[1];
			fRec1187[0] = 2.0 * (fTemp984 / fTemp938) - fRec1187[1];
			fRec1188[0] = fRec1188[1] + 2.0 * (fTemp937 * fTemp984 / fTemp938);
			double fRec1189 = fTemp940 * fTemp984 / fTemp938;
			double fTemp985 = fTemp942 * (fTemp953 - fRec1191[1]) + fRec1190[1];
			fRec1190[0] = 2.0 * (fTemp985 / fTemp943) - fRec1190[1];
			fRec1191[0] = fRec1191[1] + 2.0 * (fTemp942 * fTemp985 / fTemp943);
			double fRec1192 = fTemp945 * fTemp985 / fTemp943;
			double fTemp986 = 0.03125 * fRec132[0] * (fRec1192 + fRec1189 + fRec1186 + fRec1183 + fRec1180 + fRec1177 + fRec1174 + fRec1171 + fRec1168 + fRec1165 + fRec1162 + fRec1159 + fRec1156 + fRec1153 + fRec1150 + fRec1147 + fRec1144 + fRec1141 + fRec1138 + fRec1135 + fRec1132 + fRec1129 + fRec1126 + fRec1123 + fRec1120 + fRec1117 + fRec1114 + fRec1111 + fRec1108 + fRec1105 + fRec1102 + fRec1099) + fRec31[0] * fTemp953;
			fRec1092[0] = std::max<double>(fConst1 * fRec1092[1], std::fabs(fTemp986));
			fVbargraph44 = FAUSTFLOAT(fRec1092[0]);
			fRec980[0] = fTemp986;
			double fTemp987 = fRec23[0] * (fTemp773 * fTemp775 - fRec239[0] * fTemp948);
			double fTemp988 = fTemp950 + fTemp948;
			fVec21[0] = fTemp988 + fTemp987 + fTemp221;
			fRec1196[0] = fTemp987 + 0.995 * fRec1196[1] + fTemp988 + (1.6 - (fVec5[1] + fVec21[1]));
			fRec1195[0] = std::max<double>(fConst1 * fRec1195[1], std::fabs(fRec1196[0]));
			fVbargraph45 = FAUSTFLOAT(fRec1195[0]);
			double fTemp989 = fRec12[0] * tanh(fRec1196[0] / fTemp0);
			fRec1194[0] = std::max<double>(fConst1 * fRec1194[1], std::fabs(fTemp989));
			fVbargraph46 = FAUSTFLOAT(fRec1194[0]);
			double fTemp990 = fTemp989;
			double fTemp991 = fTemp783 * (fTemp990 - fRec1198[1]) + fRec1197[1];
			fRec1197[0] = 2.0 * (fTemp991 / fTemp784) - fRec1197[1];
			fRec1198[0] = fRec1198[1] + 2.0 * (fTemp783 * fTemp991 / fTemp784);
			double fRec1199 = fTemp786 * fTemp991 / fTemp784;
			double fTemp992 = fTemp789 * (fTemp990 - fRec1201[1]) + fRec1200[1];
			fRec1200[0] = 2.0 * (fTemp992 / fTemp790) - fRec1200[1];
			fRec1201[0] = fRec1201[1] + 2.0 * (fTemp789 * fTemp992 / fTemp790);
			double fRec1202 = fTemp792 * fTemp992 / fTemp790;
			double fTemp993 = fTemp794 * (fTemp990 - fRec1204[1]) + fRec1203[1];
			fRec1203[0] = 2.0 * (fTemp993 / fTemp795) - fRec1203[1];
			fRec1204[0] = fRec1204[1] + 2.0 * (fTemp794 * fTemp993 / fTemp795);
			double fRec1205 = fTemp797 * fTemp993 / fTemp795;
			double fTemp994 = fTemp799 * (fTemp990 - fRec1207[1]) + fRec1206[1];
			fRec1206[0] = 2.0 * (fTemp994 / fTemp800) - fRec1206[1];
			fRec1207[0] = fRec1207[1] + 2.0 * (fTemp799 * fTemp994 / fTemp800);
			double fRec1208 = fTemp802 * fTemp994 / fTemp800;
			double fTemp995 = fTemp804 * (fTemp990 - fRec1210[1]) + fRec1209[1];
			fRec1209[0] = 2.0 * (fTemp995 / fTemp805) - fRec1209[1];
			fRec1210[0] = fRec1210[1] + 2.0 * (fTemp804 * fTemp995 / fTemp805);
			double fRec1211 = fTemp807 * fTemp995 / fTemp805;
			double fTemp996 = fTemp809 * (fTemp990 - fRec1213[1]) + fRec1212[1];
			fRec1212[0] = 2.0 * (fTemp996 / fTemp810) - fRec1212[1];
			fRec1213[0] = fRec1213[1] + 2.0 * (fTemp809 * fTemp996 / fTemp810);
			double fRec1214 = fTemp812 * fTemp996 / fTemp810;
			double fTemp997 = fTemp814 * (fTemp990 - fRec1216[1]) + fRec1215[1];
			fRec1215[0] = 2.0 * (fTemp997 / fTemp815) - fRec1215[1];
			fRec1216[0] = fRec1216[1] + 2.0 * (fTemp814 * fTemp997 / fTemp815);
			double fRec1217 = fTemp817 * fTemp997 / fTemp815;
			double fTemp998 = fTemp820 * (fTemp990 - fRec1219[1]) + fRec1218[1];
			fRec1218[0] = 2.0 * (fTemp998 / fTemp821) - fRec1218[1];
			fRec1219[0] = fRec1219[1] + 2.0 * (fTemp820 * fTemp998 / fTemp821);
			double fRec1220 = fTemp823 * fTemp998 / fTemp821;
			double fTemp999 = fTemp826 * (fTemp990 - fRec1222[1]) + fRec1221[1];
			fRec1221[0] = 2.0 * (fTemp999 / fTemp827) - fRec1221[1];
			fRec1222[0] = fRec1222[1] + 2.0 * (fTemp826 * fTemp999 / fTemp827);
			double fRec1223 = fTemp829 * fTemp999 / fTemp827;
			double fTemp1000 = fTemp831 * (fTemp990 - fRec1225[1]) + fRec1224[1];
			fRec1224[0] = 2.0 * (fTemp1000 / fTemp832) - fRec1224[1];
			fRec1225[0] = fRec1225[1] + 2.0 * (fTemp831 * fTemp1000 / fTemp832);
			double fRec1226 = fTemp834 * fTemp1000 / fTemp832;
			double fTemp1001 = fTemp836 * (fTemp990 - fRec1228[1]) + fRec1227[1];
			fRec1227[0] = 2.0 * (fTemp1001 / fTemp837) - fRec1227[1];
			fRec1228[0] = fRec1228[1] + 2.0 * (fTemp836 * fTemp1001 / fTemp837);
			double fRec1229 = fTemp839 * fTemp1001 / fTemp837;
			double fTemp1002 = fTemp841 * (fTemp990 - fRec1231[1]) + fRec1230[1];
			fRec1230[0] = 2.0 * (fTemp1002 / fTemp842) - fRec1230[1];
			fRec1231[0] = fRec1231[1] + 2.0 * (fTemp841 * fTemp1002 / fTemp842);
			double fRec1232 = fTemp844 * fTemp1002 / fTemp842;
			double fTemp1003 = fTemp846 * (fTemp990 - fRec1234[1]) + fRec1233[1];
			fRec1233[0] = 2.0 * (fTemp1003 / fTemp847) - fRec1233[1];
			fRec1234[0] = fRec1234[1] + 2.0 * (fTemp846 * fTemp1003 / fTemp847);
			double fRec1235 = fTemp849 * fTemp1003 / fTemp847;
			double fTemp1004 = fTemp851 * (fTemp990 - fRec1237[1]) + fRec1236[1];
			fRec1236[0] = 2.0 * (fTemp1004 / fTemp852) - fRec1236[1];
			fRec1237[0] = fRec1237[1] + 2.0 * (fTemp851 * fTemp1004 / fTemp852);
			double fRec1238 = fTemp854 * fTemp1004 / fTemp852;
			double fTemp1005 = fTemp856 * (fTemp990 - fRec1240[1]) + fRec1239[1];
			fRec1239[0] = 2.0 * (fTemp1005 / fTemp857) - fRec1239[1];
			fRec1240[0] = fRec1240[1] + 2.0 * (fTemp856 * fTemp1005 / fTemp857);
			double fRec1241 = fTemp859 * fTemp1005 / fTemp857;
			double fTemp1006 = fTemp861 * (fTemp990 - fRec1243[1]) + fRec1242[1];
			fRec1242[0] = 2.0 * (fTemp1006 / fTemp862) - fRec1242[1];
			fRec1243[0] = fRec1243[1] + 2.0 * (fTemp861 * fTemp1006 / fTemp862);
			double fRec1244 = fTemp864 * fTemp1006 / fTemp862;
			double fTemp1007 = fTemp867 * (fTemp990 - fRec1246[1]) + fRec1245[1];
			fRec1245[0] = 2.0 * (fTemp1007 / fTemp868) - fRec1245[1];
			fRec1246[0] = fRec1246[1] + 2.0 * (fTemp867 * fTemp1007 / fTemp868);
			double fRec1247 = fTemp870 * fTemp1007 / fTemp868;
			double fTemp1008 = fTemp872 * (fTemp990 - fRec1249[1]) + fRec1248[1];
			fRec1248[0] = 2.0 * (fTemp1008 / fTemp873) - fRec1248[1];
			fRec1249[0] = fRec1249[1] + 2.0 * (fTemp872 * fTemp1008 / fTemp873);
			double fRec1250 = fTemp875 * fTemp1008 / fTemp873;
			double fTemp1009 = fTemp877 * (fTemp990 - fRec1252[1]) + fRec1251[1];
			fRec1251[0] = 2.0 * (fTemp1009 / fTemp878) - fRec1251[1];
			fRec1252[0] = fRec1252[1] + 2.0 * (fTemp877 * fTemp1009 / fTemp878);
			double fRec1253 = fTemp880 * fTemp1009 / fTemp878;
			double fTemp1010 = fTemp882 * (fTemp990 - fRec1255[1]) + fRec1254[1];
			fRec1254[0] = 2.0 * (fTemp1010 / fTemp883) - fRec1254[1];
			fRec1255[0] = fRec1255[1] + 2.0 * (fTemp882 * fTemp1010 / fTemp883);
			double fRec1256 = fTemp885 * fTemp1010 / fTemp883;
			double fTemp1011 = fTemp887 * (fTemp990 - fRec1258[1]) + fRec1257[1];
			fRec1257[0] = 2.0 * (fTemp1011 / fTemp888) - fRec1257[1];
			fRec1258[0] = fRec1258[1] + 2.0 * (fTemp887 * fTemp1011 / fTemp888);
			double fRec1259 = fTemp890 * fTemp1011 / fTemp888;
			double fTemp1012 = fTemp892 * (fTemp990 - fRec1261[1]) + fRec1260[1];
			fRec1260[0] = 2.0 * (fTemp1012 / fTemp893) - fRec1260[1];
			fRec1261[0] = fRec1261[1] + 2.0 * (fTemp892 * fTemp1012 / fTemp893);
			double fRec1262 = fTemp895 * fTemp1012 / fTemp893;
			double fTemp1013 = fTemp897 * (fTemp990 - fRec1264[1]) + fRec1263[1];
			fRec1263[0] = 2.0 * (fTemp1013 / fTemp898) - fRec1263[1];
			fRec1264[0] = fRec1264[1] + 2.0 * (fTemp897 * fTemp1013 / fTemp898);
			double fRec1265 = fTemp900 * fTemp1013 / fTemp898;
			double fTemp1014 = fTemp902 * (fTemp990 - fRec1267[1]) + fRec1266[1];
			fRec1266[0] = 2.0 * (fTemp1014 / fTemp903) - fRec1266[1];
			fRec1267[0] = fRec1267[1] + 2.0 * (fTemp902 * fTemp1014 / fTemp903);
			double fRec1268 = fTemp905 * fTemp1014 / fTemp903;
			double fTemp1015 = fTemp907 * (fTemp990 - fRec1270[1]) + fRec1269[1];
			fRec1269[0] = 2.0 * (fTemp1015 / fTemp908) - fRec1269[1];
			fRec1270[0] = fRec1270[1] + 2.0 * (fTemp907 * fTemp1015 / fTemp908);
			double fRec1271 = fTemp910 * fTemp1015 / fTemp908;
			double fTemp1016 = fTemp912 * (fTemp990 - fRec1273[1]) + fRec1272[1];
			fRec1272[0] = 2.0 * (fTemp1016 / fTemp913) - fRec1272[1];
			fRec1273[0] = fRec1273[1] + 2.0 * (fTemp912 * fTemp1016 / fTemp913);
			double fRec1274 = fTemp915 * fTemp1016 / fTemp913;
			double fTemp1017 = fTemp917 * (fTemp990 - fRec1276[1]) + fRec1275[1];
			fRec1275[0] = 2.0 * (fTemp1017 / fTemp918) - fRec1275[1];
			fRec1276[0] = fRec1276[1] + 2.0 * (fTemp917 * fTemp1017 / fTemp918);
			double fRec1277 = fTemp920 * fTemp1017 / fTemp918;
			double fTemp1018 = fTemp922 * (fTemp990 - fRec1279[1]) + fRec1278[1];
			fRec1278[0] = 2.0 * (fTemp1018 / fTemp923) - fRec1278[1];
			fRec1279[0] = fRec1279[1] + 2.0 * (fTemp922 * fTemp1018 / fTemp923);
			double fRec1280 = fTemp925 * fTemp1018 / fTemp923;
			double fTemp1019 = fTemp927 * (fTemp990 - fRec1282[1]) + fRec1281[1];
			fRec1281[0] = 2.0 * (fTemp1019 / fTemp928) - fRec1281[1];
			fRec1282[0] = fRec1282[1] + 2.0 * (fTemp927 * fTemp1019 / fTemp928);
			double fRec1283 = fTemp930 * fTemp1019 / fTemp928;
			double fTemp1020 = fTemp932 * (fTemp990 - fRec1285[1]) + fRec1284[1];
			fRec1284[0] = 2.0 * (fTemp1020 / fTemp933) - fRec1284[1];
			fRec1285[0] = fRec1285[1] + 2.0 * (fTemp932 * fTemp1020 / fTemp933);
			double fRec1286 = fTemp935 * fTemp1020 / fTemp933;
			double fTemp1021 = fTemp937 * (fTemp990 - fRec1288[1]) + fRec1287[1];
			fRec1287[0] = 2.0 * (fTemp1021 / fTemp938) - fRec1287[1];
			fRec1288[0] = fRec1288[1] + 2.0 * (fTemp937 * fTemp1021 / fTemp938);
			double fRec1289 = fTemp940 * fTemp1021 / fTemp938;
			double fTemp1022 = fTemp942 * (fTemp990 - fRec1291[1]) + fRec1290[1];
			fRec1290[0] = 2.0 * (fTemp1022 / fTemp943) - fRec1290[1];
			fRec1291[0] = fRec1291[1] + 2.0 * (fTemp942 * fTemp1022 / fTemp943);
			double fRec1292 = fTemp945 * fTemp1022 / fTemp943;
			double fTemp1023 = 0.03125 * fRec132[0] * (fRec1292 + fRec1289 + fRec1286 + fRec1283 + fRec1280 + fRec1277 + fRec1274 + fRec1271 + fRec1268 + fRec1265 + fRec1262 + fRec1259 + fRec1256 + fRec1253 + fRec1250 + fRec1247 + fRec1244 + fRec1241 + fRec1238 + fRec1235 + fRec1232 + fRec1229 + fRec1226 + fRec1223 + fRec1220 + fRec1217 + fRec1214 + fRec1211 + fRec1208 + fRec1205 + fRec1202 + fRec1199) + fRec31[0] * fTemp990;
			fRec1193[0] = std::max<double>(fConst1 * fRec1193[1], std::fabs(fTemp1023));
			fVbargraph47 = FAUSTFLOAT(fRec1193[0]);
			fRec981[0] = fTemp1023;
			double fTemp1024 = (fRec981[0] + fRec979[0] + fRec980[0]) / fTemp0;
			fVec22[IOTA0 & 4194303] = fTemp1024;
			double fTemp1025 = ((fRec1293[1] != 0.0) ? (((fRec1294[1] > 0.0) & (fRec1294[1] < 1.0)) ? fRec1293[1] : 0.0) : (((fRec1294[1] == 0.0) & (fSlow34 != fRec1295[1])) ? 0.0009765625 : (((fRec1294[1] == 1.0) & (fSlow34 != fRec1296[1])) ? -0.0009765625 : 0.0)));
			fRec1293[0] = fTemp1025;
			fRec1294[0] = std::max<double>(0.0, std::min<double>(1.0, fRec1294[1] + fTemp1025));
			...
			double fTemp1026 = fVec22[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec1295[0])))) & 4194303];
			fRec978[0] = 0.3333333333333333 * fTemp1026 + fRec1294[0] * (0.0 - 0.3333333333333333 * (fTemp1026 - fVec22[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec1296[0])))) & 4194303]));
			fRec6[0] = 0.25 * (fRec978[1] + fRec659[1] + fRec340[1] + fRec11[1]);
			fRec7[0] = 0.3333333333333333 * fTemp769;
			fRec8[0] = 0.3333333333333333 * fTemp259;
			fRec9[0] = 0.3333333333333333 * fTemp514;
			fRec10[0] = 0.3333333333333333 * fTemp1024;
			fRec5[IOTA0 & 511] = fRec7[0] + 0.995 * fRec5[(IOTA0 - 1) & 511] - fRec7[1];
			double fTemp1027 = std::fabs(fRec5[IOTA0 & 511]);
			int iTemp1028 = (fTemp1027 >= fRec4[1]) | (double(iRec3[1]) >= fConst2);
			iRec3[0] = ((iTemp1028) ? 0 : iRec3[1] + 1);
			fRec4[0] = ((iTemp1028) ? fTemp1027 : fRec4[1]);
			double fTemp1029 = fRec4[0] - fRec1[1];
			fRec1[0] = fRec1[1] + fConst9 * fTemp1029;
			double fTemp1030 = fRec1[1] + fConst8 * fTemp1029;
			double fRec2 = fTemp1030;
			...
			double fTemp1031 = std::fabs(fRec1303[IOTA0 & 511]);
			int iTemp1032 = (fTemp1031 >= fRec1302[1]) | (double(iRec1301[1]) >= fConst2);
			iRec1301[0] = ((iTemp1032) ? 0 : iRec1301[1] + 1);
			fRec1302[0] = ((iTemp1032) ? fTemp1031 : fRec1302[1]);
			double fTemp1033 = fRec1302[0] - fRec1299[1];
			fRec1299[0] = fRec1299[1] + fConst9 * fTemp1033;
			double fTemp1034 = fRec1299[1] + fConst8 * fTemp1033;
			double fRec1300 = fTemp1034;
			...
			double fTemp1035 = std::fabs(fRec1309[IOTA0 & 511]);
			int iTemp1036 = (fTemp1035 >= fRec1308[1]) | (double(iRec1307[1]) >= fConst2);
			iRec1307[0] = ((iTemp1036) ? 0 : iRec1307[1] + 1);
			fRec1308[0] = ((iTemp1036) ? fTemp1035 : fRec1308[1]);
			double fTemp1037 = fRec1308[0] - fRec1305[1];
			fRec1305[0] = fRec1305[1] + fConst9 * fTemp1037;
			double fTemp1038 = fRec1305[1] + fConst8 * fTemp1037;
			double fRec1306 = fTemp1038;
			...
			double fTemp1039 = std::fabs(fRec1315[IOTA0 & 511]);
			int iTemp1040 = (fTemp1039 >= fRec1314[1]) | (double(iRec1313[1]) >= fConst2);
			iRec1313[0] = ((iTemp1040) ? 0 : iRec1313[1] + 1);
			fRec1314[0] = ((iTemp1040) ? fTemp1039 : fRec1314[1]);
			double fTemp1041 = fRec1314[0] - fRec1311[1];
			fRec1311[0] = fRec1311[1] + fConst9 * fTemp1041;
			double fTemp1042 = fRec1311[1] + fConst8 * fTemp1041;
			double fRec1312 = fTemp1042;
	...
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bandwidth", fVslider10, 1.0, 1.0, 1e+02, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Frequency", fVslider23, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations A", fVslider26, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations B", fVslider22, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Frequency", fVslider9, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations A", fVslider11, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations B", fVslider8, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Frequency", fVslider19, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations A", fVslider20, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations B", fVslider18, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Frequency", fVslider31, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations A", fVslider32, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations B", fVslider30, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_0+1", fVslider24, 1.0, 0.0, 1.0, 0.001);
	...
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_0+1", fVslider25, 9.2528, 0.001, 12.0, 0.001);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(VERTICALSLIDER, Bandwidth, "Main/Mixer/Bandpass Filters Bank/Bandwidth", fVslider10, 1.0, 1.0, 1e+02, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Frequency", fVslider23, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations A", fVslider26, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations B", fVslider22, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Frequency", fVslider9, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations A", fVslider11, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations B", fVslider8, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Frequency", fVslider19, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations A", fVslider20, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations B", fVslider18, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Frequency", fVslider31, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations A", fVslider32, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations B", fVslider30, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Voice_0+1, "Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_0+1", fVslider24, 1.0, 0.0, 1.0, 0.001) \
		...
		p(VERTICALSLIDER, Voice_0+1, "Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_0+1", fVslider25, 9.2528, 0.001, 12.0, 0.001) \

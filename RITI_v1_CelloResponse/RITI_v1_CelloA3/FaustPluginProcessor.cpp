...
class mydsp : public base_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "RITI_v1_CelloA3.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.5");
		m->declare("name", "RITI_v1_CelloA3");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			double fTemp14 = fRec37[0] * (fRec36[0] * (0.0 - 33.0 * (1.0 - fRec35[0])) + 1.3e+02);
			...
			double fTemp19 = 0.003792499999999999 * fRec35[0] + fRec36[0] * (0.10944208 - 0.11432047 * fRec35[0]) + 0.01216278;
			double fRec34 = fTemp18 * fTemp19 / fTemp17;
			double fTemp20 = 2637.0 * fRec35[0];
			double fTemp21 = fRec37[0] * (fRec36[0] * (4164.0 * fRec35[0] + -1314.0) + (8574.0 - fTemp20));
			...
			double fTemp25 = fRec36[0] * (0.01694164 - 0.021432509999999995 * fRec35[0]) + (0.00986048 - 0.0008017400000000004 * fRec35[0]);
			double fRec41 = fTemp24 * fTemp25 / fTemp23;
			double fTemp26 = fRec37[0] * (fRec36[0] * (4608.0 * fRec35[0] + -2856.0) + (7035.0 - fTemp20));
			...
			double fTemp30 = fRec36[0] * (0.002267030000000003 * fRec35[0] + 0.0020714199999999974) + (0.02237106 - 0.014284890000000001 * fRec35[0]);
			double fRec44 = fTemp29 * fTemp30 / fTemp28;
			double fTemp31 = 1538.0 * fRec35[0];
			double fTemp32 = fRec37[0] * (fRec36[0] * (fTemp31 + -1979.0) + (5496.0 - fTemp31));
			...
			double fTemp36 = 0.006774230000000001 * fRec35[0] + fRec36[0] * (0.10261458000000001 - 0.10685212000000001 * fRec35[0]) + 0.01369543;
			double fRec47 = fTemp35 * fTemp36 / fTemp34;
			double fTemp37 = fRec37[0] * (fRec36[0] * (1205.0 * fRec35[0] + -1538.0) + (4617.0 - 1099.0 * fRec35[0]));
			...
			double fTemp41 = 0.02699203 * fRec35[0] + fRec36[0] * (0.04665504 - 0.07662214 * fRec35[0]) + 0.00854136;
			double fRec50 = fTemp40 * fTemp41 / fTemp39;
			double fTemp42 = 878.0 * fRec35[0];
			double fTemp43 = fRec37[0] * (fRec36[0] * (871.0 * fRec35[0] + -1318.0) + (3957.0 - fTemp42));
			double fTemp44 = std::tan(fConst6 * fTemp43);
			double fTemp45 = fTemp44 * (fTemp44 + fTemp15 / fTemp43) + 1.0;
			double fTemp46 = fTemp44 * (fTemp13 - fRec52[1]) + fRec51[1];
			fRec51[0] = 2.0 * (fTemp46 / fTemp45) - fRec51[1];
			fRec52[0] = fRec52[1] + 2.0 * (fTemp44 * fTemp46 / fTemp45);
			double fTemp47 = 0.01252276 * fRec35[0] + fRec36[0] * (0.10869632000000001 - 0.09120969000000001 * fRec35[0]) + 0.01631748;
			double fRec53 = fTemp46 * fTemp47 / fTemp45;
			double fTemp48 = fRec37[0] * (fRec36[0] * (1.06e+03 * fRec35[0] + -1318.0) + (3517.0 - fTemp42));
			double fTemp49 = std::tan(fConst6 * fTemp48);
			double fTemp50 = fTemp49 * (fTemp49 + fTemp15 / fTemp48) + 1.0;
			double fTemp51 = fTemp49 * (fTemp13 - fRec55[1]) + fRec54[1];
			fRec54[0] = 2.0 * (fTemp51 / fTemp50) - fRec54[1];
			fRec55[0] = fRec55[1] + 2.0 * (fTemp49 * fTemp51 / fTemp50);
			double fTemp52 = 0.04926784000000001 * fRec35[0] + fRec36[0] * (0.54408778 - 0.61006677 * fRec35[0]) + 0.02061391;
			double fRec56 = fTemp51 * fTemp52 / fTemp50;
			double fTemp53 = fRec37[0] * (fRec36[0] * (1.08e+03 * fRec35[0] + -1319.0) + (3078.0 - 789.0 * fRec35[0]));
			...
			double fTemp57 = fRec36[0] * (0.07516669000000001 - 0.07834676 * fRec35[0]) + (0.01222045 - 0.0014069800000000004 * fRec35[0]);
			double fRec59 = fTemp56 * fTemp57 / fTemp55;
			double fTemp58 = 659.0 * fRec35[0];
			double fTemp59 = fRec37[0] * (fRec36[0] * (943.0 * fRec35[0] + -1167.0) + (2638.0 - fTemp58));
			double fTemp60 = std::tan(fConst6 * fTemp59);
			double fTemp61 = fTemp60 * (fTemp60 + fTemp15 / fTemp59) + 1.0;
			double fTemp62 = fTemp60 * (fTemp13 - fRec61[1]) + fRec60[1];
			fRec60[0] = 2.0 * (fTemp62 / fTemp61) - fRec60[1];
			fRec61[0] = fRec61[1] + 2.0 * (fTemp60 * fTemp62 / fTemp61);
			double fTemp63 = 0.006005980000000001 * fRec35[0] + fRec36[0] * (0.14227104000000002 * fRec35[0] + -0.017441090000000003) + 0.04759307;
			double fRec62 = fTemp62 * fTemp63 / fTemp61;
			double fTemp64 = fRec37[0] * (fRec36[0] * (744.0 * fRec35[0] + -882.0) + (2198.0 - 588.0 * fRec35[0]));
			...
			double fTemp68 = fRec36[0] * (0.07178015999999998 * fRec35[0] + -0.07126405) + (0.22375855 - 0.21313116 * fRec35[0]);
			double fRec65 = fTemp67 * fTemp68 / fTemp66;
			double fTemp69 = fRec37[0] * (fRec36[0] * (358.0 * fRec35[0] + -661.0) + (1759.0 - 287.0 * fRec35[0]));
			...
			double fTemp73 = fRec36[0] * (0.92661765 - 0.9297246 * fRec35[0]) + (0.07338235 - 0.06490082999999999 * fRec35[0]);
			double fRec68 = fTemp72 * fTemp73 / fTemp71;
			double fTemp74 = 2.2e+02 * fRec35[0];
			double fTemp75 = fRec37[0] * (fRec36[0] * (232.0 * fRec35[0] + -359.0) + (1319.0 - fTemp74));
			...
			double fTemp79 = 0.30503947000000003 * fRec35[0] + fRec36[0] * (-0.22500213 - 0.35131018 * fRec35[0]) + 0.27821024;
			double fRec71 = fTemp78 * fTemp79 / fTemp77;
			double fTemp80 = fRec37[0] * (fRec35[0] + fRec36[0] * (-115.0 - 6e+01 * fRec35[0]) + 879.0);
			...
			double fTemp84 = fRec36[0] * (0.00015622000000001246 * fRec35[0] + -0.36691775000000004) + (0.4053105 - 0.023941270000000014 * fRec35[0]);
			double fRec74 = fTemp83 * fTemp84 / fTemp82;
			double fTemp85 = fRec37[0] * (33.0 * fRec35[0] + fRec36[0] * (3.0 - 117.0 * fRec35[0]) + 538.0);
			...
			double fTemp89 = 0.001517609999999999 * fRec35[0] + fRec36[0] * (0.06630294 - 0.06758767 * fRec35[0]) + 0.00707754;
			double fRec77 = fTemp88 * fTemp89 / fTemp87;
			double fTemp90 = fRec37[0] * (2.0 * fRec35[0] + fRec36[0] * (-3.0 - 56.0 * fRec35[0]) + 368.0);
			...
			double fTemp94 = 0.004375260000000001 * fRec35[0] + fRec36[0] * (0.12435025999999999 - 0.13294609999999998 * fRec35[0]) + 0.01035828;
			double fRec80 = fTemp93 * fTemp94 / fTemp92;
			double fTemp95 = fRec37[0] * (2.2e+02 - 29.0 * fRec36[0]);
			...
			double fTemp99 = fRec36[0] * (-0.62251682 - 0.33358304 * fRec35[0]) + 1.0;
			double fRec83 = fTemp98 * fTemp99 / fTemp97;
			double fTemp100 = fRec36[0] * fRec35[0];
			double fTemp101 = fRec37[0] * (12.0 * fTemp100 + 5e+01);
			double fTemp102 = std::tan(fConst6 * fTemp101);
			double fTemp103 = fTemp102 * (fTemp102 + fTemp15 / fTemp101) + 1.0;
			double fTemp104 = fTemp102 * (fTemp13 - fRec85[1]) + fRec84[1];
			fRec84[0] = 2.0 * (fTemp104 / fTemp103) - fRec84[1];
			fRec85[0] = fRec85[1] + 2.0 * (fTemp102 * fTemp104 / fTemp103);
			double fTemp105 = fRec36[0] * (0.07282898 - 0.03932521 * fRec35[0]) + 0.01835863;
			double fRec86 = fTemp104 * fTemp105 / fTemp103;
			double fTemp106 = fRec37[0] * (fRec36[0] * (0.0 - 48.0 * fRec35[0]) + 309.0);
			double fTemp107 = std::tan(fConst6 * fTemp106);
			double fTemp108 = fTemp107 * (fTemp107 + fTemp15 / fTemp106) + 1.0;
			double fTemp109 = fTemp107 * (fTemp13 - fRec88[1]) + fRec87[1];
			fRec87[0] = 2.0 * (fTemp109 / fTemp108) - fRec87[1];
			fRec88[0] = fRec88[1] + 2.0 * (fTemp107 * fTemp109 / fTemp108);
			double fTemp110 = 0.0026099600000000006 * fTemp100 + 0.00749257;
			double fRec89 = fTemp109 * fTemp110 / fTemp108;
			double fTemp111 = fRec37[0] * (fRec35[0] + fRec36[0] * (1.0 - 71.0 * fRec35[0]) + 439.0);
			double fTemp112 = std::tan(fConst6 * fTemp111);
			double fTemp113 = fTemp112 * (fTemp112 + fTemp15 / fTemp111) + 1.0;
			double fTemp114 = fTemp112 * (fTemp13 - fRec91[1]) + fRec90[1];
			fRec90[0] = 2.0 * (fTemp114 / fTemp113) - fRec90[1];
			fRec91[0] = fRec91[1] + 2.0 * (fTemp112 * fTemp114 / fTemp113);
			double fTemp115 = 0.20472301000000004 * fRec35[0] + fRec36[0] * (-0.44281840999999994 - 0.40144216000000005 * fRec35[0]) + 0.6674602;
			double fRec92 = fTemp114 * fTemp115 / fTemp113;
			double fTemp116 = fRec37[0] * (fRec35[0] + fRec36[0] * (-1.0 - 122.0 * fRec35[0]) + 659.0);
			...
			double fTemp120 = fRec36[0] * (-0.09119557999999994 - 0.49022327 * fRec35[0]) + (0.62411215 - 0.03461038999999999 * fRec35[0]);
			double fRec95 = fTemp119 * fTemp120 / fTemp118;
			double fTemp121 = 137.0 * fRec35[0];
			double fTemp122 = fRec37[0] * (fRec36[0] * (fTemp121 + -221.0) + (1099.0 - fTemp121));
			double fTemp123 = std::tan(fConst6 * fTemp122);
			double fTemp124 = fTemp123 * (fTemp123 + fTemp15 / fTemp122) + 1.0;
			double fTemp125 = fTemp123 * (fTemp13 - fRec97[1]) + fRec96[1];
			fRec96[0] = 2.0 * (fTemp125 / fTemp124) - fRec96[1];
			fRec97[0] = fRec97[1] + 2.0 * (fTemp123 * fTemp125 / fTemp124);
			double fTemp126 = fRec36[0] * (1.27501065 * fRec35[0] + -0.28731595) + (0.64427134 - 0.63196604 * fRec35[0]);
			double fRec98 = fTemp125 * fTemp126 / fTemp124;
			double fTemp127 = fRec37[0] * (fRec36[0] * (327.0 * fRec35[0] + -529.0) + (1539.0 - fTemp74));
			double fTemp128 = std::tan(fConst6 * fTemp127);
			double fTemp129 = fTemp128 * (fTemp128 + fTemp15 / fTemp127) + 1.0;
			double fTemp130 = fTemp128 * (fTemp13 - fRec100[1]) + fRec99[1];
			fRec99[0] = 2.0 * (fTemp130 / fTemp129) - fRec99[1];
			fRec100[0] = fRec100[1] + 2.0 * (fTemp128 * fTemp130 / fTemp129);
			double fTemp131 = 0.28255792 * fRec35[0] + fRec36[0] * (-0.038845000000000005 - 0.32540112 * fRec35[0]) + 0.08982961;
			double fRec101 = fTemp130 * fTemp131 / fTemp129;
			double fTemp132 = fRec37[0] * (fRec36[0] * (4.5e+02 * fRec35[0] + -742.0) + (1978.0 - 439.0 * fRec35[0]));
			double fTemp133 = std::tan(fConst6 * fTemp132);
			double fTemp134 = fTemp133 * (fTemp133 + fTemp15 / fTemp132) + 1.0;
			double fTemp135 = fTemp133 * (fTemp13 - fRec103[1]) + fRec102[1];
			fRec102[0] = 2.0 * (fTemp135 / fTemp134) - fRec102[1];
			fRec103[0] = fRec103[1] + 2.0 * (fTemp133 * fTemp135 / fTemp134);
			double fTemp136 = 0.14846291 * fRec35[0] + fRec36[0] * (-0.00654018 - 0.17174218 * fRec35[0]) + 0.03442368;
			double fRec104 = fTemp135 * fTemp136 / fTemp134;
			double fTemp137 = fRec37[0] * (fRec36[0] * (924.0 * fRec35[0] + -987.0) + (2418.0 - 658.0 * fRec35[0]));
			double fTemp138 = std::tan(fConst6 * fTemp137);
			double fTemp139 = fTemp138 * (fTemp138 + fTemp15 / fTemp137) + 1.0;
			double fTemp140 = fTemp138 * (fTemp13 - fRec106[1]) + fRec105[1];
			fRec105[0] = 2.0 * (fTemp140 / fTemp139) - fRec105[1];
			fRec106[0] = fRec106[1] + 2.0 * (fTemp138 * fTemp140 / fTemp139);
			double fTemp141 = fRec36[0] * (0.01882346 * fRec35[0] + -0.0027897500000000006) + (0.02409027 - 0.01300287 * fRec35[0]);
			double fRec107 = fTemp140 * fTemp141 / fTemp139;
			double fTemp142 = fRec37[0] * (fRec36[0] * (1108.0 * fRec35[0] + -1324.0) + (2858.0 - fTemp58));
			double fTemp143 = std::tan(fConst6 * fTemp142);
			double fTemp144 = fTemp143 * (fTemp143 + fTemp15 / fTemp142) + 1.0;
			double fTemp145 = fTemp143 * (fTemp13 - fRec109[1]) + fRec108[1];
			fRec108[0] = 2.0 * (fTemp145 / fTemp144) - fRec108[1];
			fRec109[0] = fRec109[1] + 2.0 * (fTemp143 * fTemp145 / fTemp144);
			double fTemp146 = 0.27752175 * fRec35[0] + fRec36[0] * (0.007711639999999999 - 0.31944662 * fRec35[0]) + 0.03888326;
			double fRec110 = fTemp145 * fTemp146 / fTemp144;
			double fTemp147 = 879.0 * fRec35[0];
			double fTemp148 = fRec37[0] * (fRec36[0] * (1189.0 * fRec35[0] + -1321.0) + (3298.0 - fTemp147));
			double fTemp149 = std::tan(fConst6 * fTemp148);
			double fTemp150 = fTemp149 * (fTemp149 + fTemp15 / fTemp148) + 1.0;
			double fTemp151 = fTemp149 * (fTemp13 - fRec112[1]) + fRec111[1];
			fRec111[0] = 2.0 * (fTemp151 / fTemp150) - fRec111[1];
			fRec112[0] = fRec112[1] + 2.0 * (fTemp149 * fTemp151 / fTemp150);
			double fTemp152 = fRec36[0] * (0.1182356 - 0.13861138 * fRec35[0]) + (0.03283333 - 0.005876740000000002 * fRec35[0]);
			double fRec113 = fTemp151 * fTemp152 / fTemp150;
			double fTemp153 = fRec37[0] * (fRec36[0] * (1007.0 * fRec35[0] + -1.32e+03) + (3737.0 - fTemp42));
			double fTemp154 = std::tan(fConst6 * fTemp153);
			double fTemp155 = fTemp154 * (fTemp154 + fTemp15 / fTemp153) + 1.0;
			double fTemp156 = fTemp154 * (fTemp13 - fRec115[1]) + fRec114[1];
			fRec114[0] = 2.0 * (fTemp156 / fTemp155) - fRec114[1];
			fRec115[0] = fRec115[1] + 2.0 * (fTemp154 * fTemp156 / fTemp155);
			double fTemp157 = 0.02271603 * fRec35[0] + fRec36[0] * (0.11568920999999999 - 0.15871534999999998 * fRec35[0]) + 0.02601317;
			double fRec116 = fTemp156 * fTemp157 / fTemp155;
			double fTemp158 = fRec37[0] * (fRec36[0] * (835.0 * fRec35[0] + -1.32e+03) + (4177.0 - fTemp147));
			double fTemp159 = std::tan(fConst6 * fTemp158);
			double fTemp160 = fTemp159 * (fTemp159 + fTemp15 / fTemp158) + 1.0;
			double fTemp161 = fTemp159 * (fTemp13 - fRec118[1]) + fRec117[1];
			fRec117[0] = 2.0 * (fTemp161 / fTemp160) - fRec117[1];
			fRec118[0] = fRec118[1] + 2.0 * (fTemp159 * fTemp161 / fTemp160);
			double fTemp162 = 0.040329569999999995 * fRec35[0] + fRec36[0] * (0.06619388 - 0.11677492999999999 * fRec35[0]) + 0.01776269;
			double fRec119 = fTemp161 * fTemp162 / fTemp160;
			double fTemp163 = fRec37[0] * (fRec36[0] * (1268.0 * fRec35[0] + -1759.0) + (5056.0 - 1318.0 * fRec35[0]));
			double fTemp164 = std::tan(fConst6 * fTemp163);
			double fTemp165 = fTemp164 * (fTemp164 + fTemp15 / fTemp163) + 1.0;
			double fTemp166 = fTemp164 * (fTemp13 - fRec121[1]) + fRec120[1];
			fRec120[0] = 2.0 * (fTemp166 / fTemp165) - fRec120[1];
			fRec121[0] = fRec121[1] + 2.0 * (fTemp164 * fTemp166 / fTemp165);
			double fTemp167 = 0.03387651 * fRec35[0] + fRec36[0] * (0.04723798 - 0.09128072 * fRec35[0]) + 0.01528356;
			double fRec122 = fTemp166 * fTemp167 / fTemp165;
			double fTemp168 = fRec37[0] * (fRec36[0] * (2198.0 * fRec35[0] + -1981.0) + (5717.0 - 1539.0 * fRec35[0]));
			double fTemp169 = std::tan(fConst6 * fTemp168);
			double fTemp170 = fTemp169 * (fTemp169 + fTemp15 / fTemp168) + 1.0;
			double fTemp171 = fTemp169 * (fTemp13 - fRec124[1]) + fRec123[1];
			fRec123[0] = 2.0 * (fTemp171 / fTemp170) - fRec123[1];
			fRec124[0] = fRec124[1] + 2.0 * (fTemp169 * fTemp171 / fTemp170);
			double fTemp172 = 0.0159348 * fRec35[0] + fRec36[0] * (0.02239037 - 0.02813122 * fRec35[0]) + 0.00841917;
			double fRec125 = fTemp171 * fTemp172 / fTemp170;
			double fTemp173 = fRec37[0] * (fRec36[0] * (4811.0 * fRec35[0] + -1537.0) + (7255.0 - fTemp20));
			double fTemp174 = std::tan(fConst6 * fTemp173);
			double fTemp175 = fTemp174 * (fTemp174 + fTemp15 / fTemp173) + 1.0;
			double fTemp176 = fTemp174 * (fTemp13 - fRec127[1]) + fRec126[1];
			fRec126[0] = 2.0 * (fTemp176 / fTemp175) - fRec126[1];
			fRec127[0] = fRec127[1] + 2.0 * (fTemp174 * fTemp176 / fTemp175);
			double fTemp177 = fRec36[0] * (0.01286443 - 0.017049130000000003 * fRec35[0]) + (0.00969712 - 0.0011080199999999995 * fRec35[0]);
			double fRec128 = fTemp176 * fTemp177 / fTemp175;
			double fTemp178 = fRec37[0] * (fRec36[0] * (5481.0 * fRec35[0] + -1973.0) + (9672.0 - 3515.0 * fRec35[0]));
			double fTemp179 = std::tan(fConst6 * fTemp178);
			double fTemp180 = fTemp179 * (fTemp179 + fTemp15 / fTemp178) + 1.0;
			double fTemp181 = fTemp179 * (fTemp13 - fRec130[1]) + fRec129[1];
			fRec129[0] = 2.0 * (fTemp181 / fTemp180) - fRec129[1];
			fRec130[0] = fRec130[1] + 2.0 * (fTemp179 * fTemp181 / fTemp180);
			double fTemp182 = fRec36[0] * (0.028484340000000004 - 0.03413223 * fRec35[0]) + (0.01255551 - 0.0006110500000000001 * fRec35[0]);
			double fRec131 = fTemp181 * fTemp182 / fTemp180;
			fRec132[0] = fSlow13 + fConst3 * fRec132[1];
			double fTemp183 = 0.03125 * fRec132[0] * (fRec131 + fRec128 + fRec125 + fRec122 + fRec119 + fRec116 + fRec113 + fRec110 + fRec107 + fRec104 + fRec101 + fRec98 + fRec95 + fRec92 + fRec89 + fRec86 + fRec83 + fRec80 + fRec77 + fRec74 + fRec71 + fRec68 + fRec65 + fRec62 + fRec59 + fRec56 + fRec53 + fRec50 + fRec47 + fRec44 + fRec41 + fRec34) + fRec31[0] * fTemp13;
			fRec16[0] = std::max<double>(fConst1 * fRec16[1], std::fabs(fTemp183));
			fVbargraph4 = FAUSTFLOAT(fRec16[0]);
			fRec13[0] = fTemp183;
			fVec3[0] = 1.3;
			double fTemp184 = 1.3 - fVec3[1];
			double fTemp185 = fRec21[0] * fRec15[1];
			fRec137[0] = std::max<double>(fConst1 * fRec137[1], std::fabs(fTemp185));
			fVbargraph5 = FAUSTFLOAT(fRec137[0]);
			double fTemp186 = fTemp185;
			fRec138[0] = fSlow14 + fConst3 * fRec138[1];
			double fTemp187 = fRec23[0] * (fTemp3 * (fRec138[0] - fTemp186) - fTemp5);
			double fTemp188 = fTemp8 + fRec26[1];
			double fTemp189 = fTemp188 + fTemp5;
			fVec4[0] = fTemp189 + fTemp187 + fTemp184;
			fRec136[0] = fTemp187 + 0.995 * fRec136[1] + fTemp189 + (1.3 - (fVec3[1] + fVec4[1]));
			fRec135[0] = std::max<double>(fConst1 * fRec135[1], std::fabs(fRec136[0]));
			fVbargraph6 = FAUSTFLOAT(fRec135[0]);
			double fTemp190 = fRec12[0] * tanh(fRec136[0] / fTemp0);
			fRec134[0] = std::max<double>(fConst1 * fRec134[1], std::fabs(fTemp190));
			fVbargraph7 = FAUSTFLOAT(fRec134[0]);
			double fTemp191 = fTemp190;
			double fTemp192 = fTemp16 * (fTemp191 - fRec140[1]) + fRec139[1];
			fRec139[0] = 2.0 * (fTemp192 / fTemp17) - fRec139[1];
			fRec140[0] = fRec140[1] + 2.0 * (fTemp16 * fTemp192 / fTemp17);
			double fRec141 = fTemp19 * fTemp192 / fTemp17;
			double fTemp193 = fTemp22 * (fTemp191 - fRec143[1]) + fRec142[1];
			fRec142[0] = 2.0 * (fTemp193 / fTemp23) - fRec142[1];
			fRec143[0] = fRec143[1] + 2.0 * (fTemp22 * fTemp193 / fTemp23);
			double fRec144 = fTemp25 * fTemp193 / fTemp23;
			double fTemp194 = fTemp27 * (fTemp191 - fRec146[1]) + fRec145[1];
			fRec145[0] = 2.0 * (fTemp194 / fTemp28) - fRec145[1];
			fRec146[0] = fRec146[1] + 2.0 * (fTemp27 * fTemp194 / fTemp28);
			double fRec147 = fTemp30 * fTemp194 / fTemp28;
			double fTemp195 = fTemp33 * (fTemp191 - fRec149[1]) + fRec148[1];
			fRec148[0] = 2.0 * (fTemp195 / fTemp34) - fRec148[1];
			fRec149[0] = fRec149[1] + 2.0 * (fTemp33 * fTemp195 / fTemp34);
			double fRec150 = fTemp36 * fTemp195 / fTemp34;
			double fTemp196 = fTemp38 * (fTemp191 - fRec152[1]) + fRec151[1];
			fRec151[0] = 2.0 * (fTemp196 / fTemp39) - fRec151[1];
			fRec152[0] = fRec152[1] + 2.0 * (fTemp38 * fTemp196 / fTemp39);
			double fRec153 = fTemp41 * fTemp196 / fTemp39;
			double fTemp197 = fTemp44 * (fTemp191 - fRec155[1]) + fRec154[1];
			fRec154[0] = 2.0 * (fTemp197 / fTemp45) - fRec154[1];
			fRec155[0] = fRec155[1] + 2.0 * (fTemp44 * fTemp197 / fTemp45);
			double fRec156 = fTemp47 * fTemp197 / fTemp45;
			double fTemp198 = fTemp49 * (fTemp191 - fRec158[1]) + fRec157[1];
			fRec157[0] = 2.0 * (fTemp198 / fTemp50) - fRec157[1];
			fRec158[0] = fRec158[1] + 2.0 * (fTemp49 * fTemp198 / fTemp50);
			double fRec159 = fTemp52 * fTemp198 / fTemp50;
			double fTemp199 = fTemp54 * (fTemp191 - fRec161[1]) + fRec160[1];
			fRec160[0] = 2.0 * (fTemp199 / fTemp55) - fRec160[1];
			fRec161[0] = fRec161[1] + 2.0 * (fTemp54 * fTemp199 / fTemp55);
			double fRec162 = fTemp57 * fTemp199 / fTemp55;
			double fTemp200 = fTemp60 * (fTemp191 - fRec164[1]) + fRec163[1];
			fRec163[0] = 2.0 * (fTemp200 / fTemp61) - fRec163[1];
			fRec164[0] = fRec164[1] + 2.0 * (fTemp60 * fTemp200 / fTemp61);
			double fRec165 = fTemp63 * fTemp200 / fTemp61;
			double fTemp201 = fTemp65 * (fTemp191 - fRec167[1]) + fRec166[1];
			fRec166[0] = 2.0 * (fTemp201 / fTemp66) - fRec166[1];
			fRec167[0] = fRec167[1] + 2.0 * (fTemp65 * fTemp201 / fTemp66);
			double fRec168 = fTemp68 * fTemp201 / fTemp66;
			double fTemp202 = fTemp70 * (fTemp191 - fRec170[1]) + fRec169[1];
			fRec169[0] = 2.0 * (fTemp202 / fTemp71) - fRec169[1];
			fRec170[0] = fRec170[1] + 2.0 * (fTemp70 * fTemp202 / fTemp71);
			double fRec171 = fTemp73 * fTemp202 / fTemp71;
			double fTemp203 = fTemp76 * (fTemp191 - fRec173[1]) + fRec172[1];
			fRec172[0] = 2.0 * (fTemp203 / fTemp77) - fRec172[1];
			fRec173[0] = fRec173[1] + 2.0 * (fTemp76 * fTemp203 / fTemp77);
			double fRec174 = fTemp79 * fTemp203 / fTemp77;
			double fTemp204 = fTemp81 * (fTemp191 - fRec176[1]) + fRec175[1];
			fRec175[0] = 2.0 * (fTemp204 / fTemp82) - fRec175[1];
			fRec176[0] = fRec176[1] + 2.0 * (fTemp81 * fTemp204 / fTemp82);
			double fRec177 = fTemp84 * fTemp204 / fTemp82;
			double fTemp205 = fTemp86 * (fTemp191 - fRec179[1]) + fRec178[1];
			fRec178[0] = 2.0 * (fTemp205 / fTemp87) - fRec178[1];
			fRec179[0] = fRec179[1] + 2.0 * (fTemp86 * fTemp205 / fTemp87);
			double fRec180 = fTemp89 * fTemp205 / fTemp87;
			double fTemp206 = fTemp91 * (fTemp191 - fRec182[1]) + fRec181[1];
			fRec181[0] = 2.0 * (fTemp206 / fTemp92) - fRec181[1];
			fRec182[0] = fRec182[1] + 2.0 * (fTemp91 * fTemp206 / fTemp92);
			double fRec183 = fTemp94 * fTemp206 / fTemp92;
			double fTemp207 = fTemp96 * (fTemp191 - fRec185[1]) + fRec184[1];
			fRec184[0] = 2.0 * (fTemp207 / fTemp97) - fRec184[1];
			fRec185[0] = fRec185[1] + 2.0 * (fTemp96 * fTemp207 / fTemp97);
			double fRec186 = fTemp99 * fTemp207 / fTemp97;
			double fTemp208 = fTemp102 * (fTemp191 - fRec188[1]) + fRec187[1];
			fRec187[0] = 2.0 * (fTemp208 / fTemp103) - fRec187[1];
			fRec188[0] = fRec188[1] + 2.0 * (fTemp102 * fTemp208 / fTemp103);
			double fRec189 = fTemp105 * fTemp208 / fTemp103;
			double fTemp209 = fTemp107 * (fTemp191 - fRec191[1]) + fRec190[1];
			fRec190[0] = 2.0 * (fTemp209 / fTemp108) - fRec190[1];
			fRec191[0] = fRec191[1] + 2.0 * (fTemp107 * fTemp209 / fTemp108);
			double fRec192 = fTemp110 * fTemp209 / fTemp108;
			double fTemp210 = fTemp112 * (fTemp191 - fRec194[1]) + fRec193[1];
			fRec193[0] = 2.0 * (fTemp210 / fTemp113) - fRec193[1];
			fRec194[0] = fRec194[1] + 2.0 * (fTemp112 * fTemp210 / fTemp113);
			double fRec195 = fTemp115 * fTemp210 / fTemp113;
			double fTemp211 = fTemp117 * (fTemp191 - fRec197[1]) + fRec196[1];
			fRec196[0] = 2.0 * (fTemp211 / fTemp118) - fRec196[1];
			fRec197[0] = fRec197[1] + 2.0 * (fTemp117 * fTemp211 / fTemp118);
			double fRec198 = fTemp120 * fTemp211 / fTemp118;
			double fTemp212 = fTemp123 * (fTemp191 - fRec200[1]) + fRec199[1];
			fRec199[0] = 2.0 * (fTemp212 / fTemp124) - fRec199[1];
			fRec200[0] = fRec200[1] + 2.0 * (fTemp123 * fTemp212 / fTemp124);
			double fRec201 = fTemp126 * fTemp212 / fTemp124;
			double fTemp213 = fTemp128 * (fTemp191 - fRec203[1]) + fRec202[1];
			fRec202[0] = 2.0 * (fTemp213 / fTemp129) - fRec202[1];
			fRec203[0] = fRec203[1] + 2.0 * (fTemp128 * fTemp213 / fTemp129);
			double fRec204 = fTemp131 * fTemp213 / fTemp129;
			double fTemp214 = fTemp133 * (fTemp191 - fRec206[1]) + fRec205[1];
			fRec205[0] = 2.0 * (fTemp214 / fTemp134) - fRec205[1];
			fRec206[0] = fRec206[1] + 2.0 * (fTemp133 * fTemp214 / fTemp134);
			double fRec207 = fTemp136 * fTemp214 / fTemp134;
			double fTemp215 = fTemp138 * (fTemp191 - fRec209[1]) + fRec208[1];
			fRec208[0] = 2.0 * (fTemp215 / fTemp139) - fRec208[1];
			fRec209[0] = fRec209[1] + 2.0 * (fTemp138 * fTemp215 / fTemp139);
			double fRec210 = fTemp141 * fTemp215 / fTemp139;
			double fTemp216 = fTemp143 * (fTemp191 - fRec212[1]) + fRec211[1];
			fRec211[0] = 2.0 * (fTemp216 / fTemp144) - fRec211[1];
			fRec212[0] = fRec212[1] + 2.0 * (fTemp143 * fTemp216 / fTemp144);
			double fRec213 = fTemp146 * fTemp216 / fTemp144;
			double fTemp217 = fTemp149 * (fTemp191 - fRec215[1]) + fRec214[1];
			fRec214[0] = 2.0 * (fTemp217 / fTemp150) - fRec214[1];
			fRec215[0] = fRec215[1] + 2.0 * (fTemp149 * fTemp217 / fTemp150);
			double fRec216 = fTemp152 * fTemp217 / fTemp150;
			double fTemp218 = fTemp154 * (fTemp191 - fRec218[1]) + fRec217[1];
			fRec217[0] = 2.0 * (fTemp218 / fTemp155) - fRec217[1];
			fRec218[0] = fRec218[1] + 2.0 * (fTemp154 * fTemp218 / fTemp155);
			double fRec219 = fTemp157 * fTemp218 / fTemp155;
			double fTemp219 = fTemp159 * (fTemp191 - fRec221[1]) + fRec220[1];
			fRec220[0] = 2.0 * (fTemp219 / fTemp160) - fRec220[1];
			fRec221[0] = fRec221[1] + 2.0 * (fTemp159 * fTemp219 / fTemp160);
			double fRec222 = fTemp162 * fTemp219 / fTemp160;
			double fTemp220 = fTemp164 * (fTemp191 - fRec224[1]) + fRec223[1];
			fRec223[0] = 2.0 * (fTemp220 / fTemp165) - fRec223[1];
			fRec224[0] = fRec224[1] + 2.0 * (fTemp164 * fTemp220 / fTemp165);
			double fRec225 = fTemp167 * fTemp220 / fTemp165;
			double fTemp221 = fTemp169 * (fTemp191 - fRec227[1]) + fRec226[1];
			fRec226[0] = 2.0 * (fTemp221 / fTemp170) - fRec226[1];
			fRec227[0] = fRec227[1] + 2.0 * (fTemp169 * fTemp221 / fTemp170);
			double fRec228 = fTemp172 * fTemp221 / fTemp170;
			double fTemp222 = fTemp174 * (fTemp191 - fRec230[1]) + fRec229[1];
			fRec229[0] = 2.0 * (fTemp222 / fTemp175) - fRec229[1];
			fRec230[0] = fRec230[1] + 2.0 * (fTemp174 * fTemp222 / fTemp175);
			double fRec231 = fTemp177 * fTemp222 / fTemp175;
			double fTemp223 = fTemp179 * (fTemp191 - fRec233[1]) + fRec232[1];
			fRec232[0] = 2.0 * (fTemp223 / fTemp180) - fRec232[1];
			fRec233[0] = fRec233[1] + 2.0 * (fTemp179 * fTemp223 / fTemp180);
			double fRec234 = fTemp182 * fTemp223 / fTemp180;
			double fTemp224 = 0.03125 * fRec132[0] * (fRec234 + fRec231 + fRec228 + fRec225 + fRec222 + fRec219 + fRec216 + fRec213 + fRec210 + fRec207 + fRec204 + fRec201 + fRec198 + fRec195 + fRec192 + fRec189 + fRec186 + fRec183 + fRec180 + fRec177 + fRec174 + fRec171 + fRec168 + fRec165 + fRec162 + fRec159 + fRec156 + fRec153 + fRec150 + fRec147 + fRec144 + fRec141) + fRec31[0] * fTemp191;
			fRec133[0] = std::max<double>(fConst1 * fRec133[1], std::fabs(fTemp224));
			fVbargraph8 = FAUSTFLOAT(fRec133[0]);
			fRec14[0] = fTemp224;
			fVec5[0] = 1.6;
			double fTemp225 = 1.6 - fVec5[1];
			fRec239[0] = fSlow15 + fConst3 * fRec239[1];
			double fTemp226 = fRec23[0] * (fTemp3 * fTemp5 - fRec239[0] * fTemp186);
			double fTemp227 = fTemp188 + fTemp186;
			fVec6[0] = fTemp227 + fTemp226 + fTemp225;
			fRec238[0] = fTemp226 + 0.995 * fRec238[1] + fTemp227 + (1.6 - (fVec5[1] + fVec6[1]));
			fRec237[0] = std::max<double>(fConst1 * fRec237[1], std::fabs(fRec238[0]));
			fVbargraph9 = FAUSTFLOAT(fRec237[0]);
			double fTemp228 = fRec12[0] * tanh(fRec238[0] / fTemp0);
			fRec236[0] = std::max<double>(fConst1 * fRec236[1], std::fabs(fTemp228));
			fVbargraph10 = FAUSTFLOAT(fRec236[0]);
			double fTemp229 = fTemp228;
			double fTemp230 = fTemp16 * (fTemp229 - fRec241[1]) + fRec240[1];
			fRec240[0] = 2.0 * (fTemp230 / fTemp17) - fRec240[1];
			fRec241[0] = fRec241[1] + 2.0 * (fTemp16 * fTemp230 / fTemp17);
			double fRec242 = fTemp19 * fTemp230 / fTemp17;
			double fTemp231 = fTemp22 * (fTemp229 - fRec244[1]) + fRec243[1];
			fRec243[0] = 2.0 * (fTemp231 / fTemp23) - fRec243[1];
			fRec244[0] = fRec244[1] + 2.0 * (fTemp22 * fTemp231 / fTemp23);
			double fRec245 = fTemp25 * fTemp231 / fTemp23;
			double fTemp232 = fTemp27 * (fTemp229 - fRec247[1]) + fRec246[1];
			fRec246[0] = 2.0 * (fTemp232 / fTemp28) - fRec246[1];
			fRec247[0] = fRec247[1] + 2.0 * (fTemp27 * fTemp232 / fTemp28);
			double fRec248 = fTemp30 * fTemp232 / fTemp28;
			double fTemp233 = fTemp33 * (fTemp229 - fRec250[1]) + fRec249[1];
			fRec249[0] = 2.0 * (fTemp233 / fTemp34) - fRec249[1];
			fRec250[0] = fRec250[1] + 2.0 * (fTemp33 * fTemp233 / fTemp34);
			double fRec251 = fTemp36 * fTemp233 / fTemp34;
			double fTemp234 = fTemp38 * (fTemp229 - fRec253[1]) + fRec252[1];
			fRec252[0] = 2.0 * (fTemp234 / fTemp39) - fRec252[1];
			fRec253[0] = fRec253[1] + 2.0 * (fTemp38 * fTemp234 / fTemp39);
			double fRec254 = fTemp41 * fTemp234 / fTemp39;
			double fTemp235 = fTemp44 * (fTemp229 - fRec256[1]) + fRec255[1];
			fRec255[0] = 2.0 * (fTemp235 / fTemp45) - fRec255[1];
			fRec256[0] = fRec256[1] + 2.0 * (fTemp44 * fTemp235 / fTemp45);
			double fRec257 = fTemp47 * fTemp235 / fTemp45;
			double fTemp236 = fTemp49 * (fTemp229 - fRec259[1]) + fRec258[1];
			fRec258[0] = 2.0 * (fTemp236 / fTemp50) - fRec258[1];
			fRec259[0] = fRec259[1] + 2.0 * (fTemp49 * fTemp236 / fTemp50);
			double fRec260 = fTemp52 * fTemp236 / fTemp50;
			double fTemp237 = fTemp54 * (fTemp229 - fRec262[1]) + fRec261[1];
			fRec261[0] = 2.0 * (fTemp237 / fTemp55) - fRec261[1];
			fRec262[0] = fRec262[1] + 2.0 * (fTemp54 * fTemp237 / fTemp55);
			double fRec263 = fTemp57 * fTemp237 / fTemp55;
			double fTemp238 = fTemp60 * (fTemp229 - fRec265[1]) + fRec264[1];
			fRec264[0] = 2.0 * (fTemp238 / fTemp61) - fRec264[1];
			fRec265[0] = fRec265[1] + 2.0 * (fTemp60 * fTemp238 / fTemp61);
			double fRec266 = fTemp63 * fTemp238 / fTemp61;
			double fTemp239 = fTemp65 * (fTemp229 - fRec268[1]) + fRec267[1];
			fRec267[0] = 2.0 * (fTemp239 / fTemp66) - fRec267[1];
			fRec268[0] = fRec268[1] + 2.0 * (fTemp65 * fTemp239 / fTemp66);
			double fRec269 = fTemp68 * fTemp239 / fTemp66;
			double fTemp240 = fTemp70 * (fTemp229 - fRec271[1]) + fRec270[1];
			fRec270[0] = 2.0 * (fTemp240 / fTemp71) - fRec270[1];
			fRec271[0] = fRec271[1] + 2.0 * (fTemp70 * fTemp240 / fTemp71);
			double fRec272 = fTemp73 * fTemp240 / fTemp71;
			double fTemp241 = fTemp76 * (fTemp229 - fRec274[1]) + fRec273[1];
			fRec273[0] = 2.0 * (fTemp241 / fTemp77) - fRec273[1];
			fRec274[0] = fRec274[1] + 2.0 * (fTemp76 * fTemp241 / fTemp77);
			double fRec275 = fTemp79 * fTemp241 / fTemp77;
			double fTemp242 = fTemp81 * (fTemp229 - fRec277[1]) + fRec276[1];
			fRec276[0] = 2.0 * (fTemp242 / fTemp82) - fRec276[1];
			fRec277[0] = fRec277[1] + 2.0 * (fTemp81 * fTemp242 / fTemp82);
			double fRec278 = fTemp84 * fTemp242 / fTemp82;
			double fTemp243 = fTemp86 * (fTemp229 - fRec280[1]) + fRec279[1];
			fRec279[0] = 2.0 * (fTemp243 / fTemp87) - fRec279[1];
			fRec280[0] = fRec280[1] + 2.0 * (fTemp86 * fTemp243 / fTemp87);
			double fRec281 = fTemp89 * fTemp243 / fTemp87;
			double fTemp244 = fTemp91 * (fTemp229 - fRec283[1]) + fRec282[1];
			fRec282[0] = 2.0 * (fTemp244 / fTemp92) - fRec282[1];
			fRec283[0] = fRec283[1] + 2.0 * (fTemp91 * fTemp244 / fTemp92);
			double fRec284 = fTemp94 * fTemp244 / fTemp92;
			double fTemp245 = fTemp96 * (fTemp229 - fRec286[1]) + fRec285[1];
			fRec285[0] = 2.0 * (fTemp245 / fTemp97) - fRec285[1];
			fRec286[0] = fRec286[1] + 2.0 * (fTemp96 * fTemp245 / fTemp97);
			double fRec287 = fTemp99 * fTemp245 / fTemp97;
			double fTemp246 = fTemp102 * (fTemp229 - fRec289[1]) + fRec288[1];
			fRec288[0] = 2.0 * (fTemp246 / fTemp103) - fRec288[1];
			fRec289[0] = fRec289[1] + 2.0 * (fTemp102 * fTemp246 / fTemp103);
			double fRec290 = fTemp105 * fTemp246 / fTemp103;
			double fTemp247 = fTemp107 * (fTemp229 - fRec292[1]) + fRec291[1];
			fRec291[0] = 2.0 * (fTemp247 / fTemp108) - fRec291[1];
			fRec292[0] = fRec292[1] + 2.0 * (fTemp107 * fTemp247 / fTemp108);
			double fRec293 = fTemp110 * fTemp247 / fTemp108;
			double fTemp248 = fTemp112 * (fTemp229 - fRec295[1]) + fRec294[1];
			fRec294[0] = 2.0 * (fTemp248 / fTemp113) - fRec294[1];
			fRec295[0] = fRec295[1] + 2.0 * (fTemp112 * fTemp248 / fTemp113);
			double fRec296 = fTemp115 * fTemp248 / fTemp113;
			double fTemp249 = fTemp117 * (fTemp229 - fRec298[1]) + fRec297[1];
			fRec297[0] = 2.0 * (fTemp249 / fTemp118) - fRec297[1];
			fRec298[0] = fRec298[1] + 2.0 * (fTemp117 * fTemp249 / fTemp118);
			double fRec299 = fTemp120 * fTemp249 / fTemp118;
			double fTemp250 = fTemp123 * (fTemp229 - fRec301[1]) + fRec300[1];
			fRec300[0] = 2.0 * (fTemp250 / fTemp124) - fRec300[1];
			fRec301[0] = fRec301[1] + 2.0 * (fTemp123 * fTemp250 / fTemp124);
			double fRec302 = fTemp126 * fTemp250 / fTemp124;
			double fTemp251 = fTemp128 * (fTemp229 - fRec304[1]) + fRec303[1];
			fRec303[0] = 2.0 * (fTemp251 / fTemp129) - fRec303[1];
			fRec304[0] = fRec304[1] + 2.0 * (fTemp128 * fTemp251 / fTemp129);
			double fRec305 = fTemp131 * fTemp251 / fTemp129;
			double fTemp252 = fTemp133 * (fTemp229 - fRec307[1]) + fRec306[1];
			fRec306[0] = 2.0 * (fTemp252 / fTemp134) - fRec306[1];
			fRec307[0] = fRec307[1] + 2.0 * (fTemp133 * fTemp252 / fTemp134);
			double fRec308 = fTemp136 * fTemp252 / fTemp134;
			double fTemp253 = fTemp138 * (fTemp229 - fRec310[1]) + fRec309[1];
			fRec309[0] = 2.0 * (fTemp253 / fTemp139) - fRec309[1];
			fRec310[0] = fRec310[1] + 2.0 * (fTemp138 * fTemp253 / fTemp139);
			double fRec311 = fTemp141 * fTemp253 / fTemp139;
			double fTemp254 = fTemp143 * (fTemp229 - fRec313[1]) + fRec312[1];
			fRec312[0] = 2.0 * (fTemp254 / fTemp144) - fRec312[1];
			fRec313[0] = fRec313[1] + 2.0 * (fTemp143 * fTemp254 / fTemp144);
			double fRec314 = fTemp146 * fTemp254 / fTemp144;
			double fTemp255 = fTemp149 * (fTemp229 - fRec316[1]) + fRec315[1];
			fRec315[0] = 2.0 * (fTemp255 / fTemp150) - fRec315[1];
			fRec316[0] = fRec316[1] + 2.0 * (fTemp149 * fTemp255 / fTemp150);
			double fRec317 = fTemp152 * fTemp255 / fTemp150;
			double fTemp256 = fTemp154 * (fTemp229 - fRec319[1]) + fRec318[1];
			fRec318[0] = 2.0 * (fTemp256 / fTemp155) - fRec318[1];
			fRec319[0] = fRec319[1] + 2.0 * (fTemp154 * fTemp256 / fTemp155);
			double fRec320 = fTemp157 * fTemp256 / fTemp155;
			double fTemp257 = fTemp159 * (fTemp229 - fRec322[1]) + fRec321[1];
			fRec321[0] = 2.0 * (fTemp257 / fTemp160) - fRec321[1];
			fRec322[0] = fRec322[1] + 2.0 * (fTemp159 * fTemp257 / fTemp160);
			double fRec323 = fTemp162 * fTemp257 / fTemp160;
			double fTemp258 = fTemp164 * (fTemp229 - fRec325[1]) + fRec324[1];
			fRec324[0] = 2.0 * (fTemp258 / fTemp165) - fRec324[1];
			fRec325[0] = fRec325[1] + 2.0 * (fTemp164 * fTemp258 / fTemp165);
			double fRec326 = fTemp167 * fTemp258 / fTemp165;
			double fTemp259 = fTemp169 * (fTemp229 - fRec328[1]) + fRec327[1];
			fRec327[0] = 2.0 * (fTemp259 / fTemp170) - fRec327[1];
			fRec328[0] = fRec328[1] + 2.0 * (fTemp169 * fTemp259 / fTemp170);
			double fRec329 = fTemp172 * fTemp259 / fTemp170;
			double fTemp260 = fTemp174 * (fTemp229 - fRec331[1]) + fRec330[1];
			fRec330[0] = 2.0 * (fTemp260 / fTemp175) - fRec330[1];
			fRec331[0] = fRec331[1] + 2.0 * (fTemp174 * fTemp260 / fTemp175);
			double fRec332 = fTemp177 * fTemp260 / fTemp175;
			double fTemp261 = fTemp179 * (fTemp229 - fRec334[1]) + fRec333[1];
			fRec333[0] = 2.0 * (fTemp261 / fTemp180) - fRec333[1];
			fRec334[0] = fRec334[1] + 2.0 * (fTemp179 * fTemp261 / fTemp180);
			double fRec335 = fTemp182 * fTemp261 / fTemp180;
			double fTemp262 = 0.03125 * fRec132[0] * (fRec335 + fRec332 + fRec329 + fRec326 + fRec323 + fRec320 + fRec317 + fRec314 + fRec311 + fRec308 + fRec305 + fRec302 + fRec299 + fRec296 + fRec293 + fRec290 + fRec287 + fRec284 + fRec281 + fRec278 + fRec275 + fRec272 + fRec269 + fRec266 + fRec263 + fRec260 + fRec257 + fRec254 + fRec251 + fRec248 + fRec245 + fRec242) + fRec31[0] * fTemp229;
			fRec235[0] = std::max<double>(fConst1 * fRec235[1], std::fabs(fTemp262));
			fVbargraph11 = FAUSTFLOAT(fRec235[0]);
			fRec15[0] = fTemp262;
			double fTemp263 = (fRec15[0] + fRec13[0] + fRec14[0]) / fTemp0;
			fVec7[IOTA0 & 4194303] = fTemp263;
			double fTemp264 = ((fRec336[1] != 0.0) ? (((fRec337[1] > 0.0) & (fRec337[1] < 1.0)) ? fRec336[1] : 0.0) : (((fRec337[1] == 0.0) & (fSlow16 != fRec338[1])) ? 0.0009765625 : (((fRec337[1] == 1.0) & (fSlow16 != fRec339[1])) ? -0.0009765625 : 0.0)));
			fRec336[0] = fTemp264;
			fRec337[0] = std::max<double>(0.0, std::min<double>(1.0, fRec337[1] + fTemp264));
			fRec338[0] = (((fRec337[1] >= 1.0) & (fRec339[1] != fSlow16)) ? fSlow16 : fRec338[1]);
			fRec339[0] = (((fRec337[1] <= 0.0) & (fRec338[1] != fSlow16)) ? fSlow16 : fRec339[1]);
			double fTemp265 = fVec7[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec338[0])))) & 4194303];
			fRec11[0] = 0.3333333333333333 * fTemp265 + fRec337[0] * (0.0 - 0.3333333333333333 * (fTemp265 - fVec7[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec339[0])))) & 4194303]));
			double fTemp266 = fRec21[0] * fRec341[1];
			fRec348[0] = std::max<double>(fConst1 * fRec348[1], std::fabs(fTemp266));
			fVbargraph12 = FAUSTFLOAT(fRec348[0]);
			double fTemp267 = fTemp266;
			double fTemp268 = fRec21[0] * fRec342[1];
			fRec349[0] = std::max<double>(fConst1 * fRec349[1], std::fabs(fTemp268));
			fVbargraph13 = FAUSTFLOAT(fRec349[0]);
			double fTemp269 = fTemp268;
			double fTemp270 = fTemp6 * (fTemp269 - fTemp267);
			double fTemp271 = fSlow17 * fRec6[1];
			fVec8[IOTA0 & 4194303] = fTemp271;
			double fTemp272 = ((fRec351[1] != 0.0) ? (((fRec352[1] > 0.0) & (fRec352[1] < 1.0)) ? fRec351[1] : 0.0) : (((fRec352[1] == 0.0) & (fSlow18 != fRec353[1])) ? 0.0009765625 : (((fRec352[1] == 1.0) & (fSlow18 != fRec354[1])) ? -0.0009765625 : 0.0)));
			fRec351[0] = fTemp272;
			fRec352[0] = std::max<double>(0.0, std::min<double>(1.0, fRec352[1] + fTemp272));
			fRec353[0] = (((fRec352[1] >= 1.0) & (fRec354[1] != fSlow18)) ? fSlow18 : fRec353[1]);
			fRec354[0] = (((fRec352[1] <= 0.0) & (fRec353[1] != fSlow18)) ? fSlow18 : fRec354[1]);
			double fTemp273 = fVec8[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec353[0])))) & 4194303];
			fRec350[0] = fTemp273 + fRec352[0] * (fVec8[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec354[0])))) & 4194303] - fTemp273);
			fVec9[0] = fRec350[1] + fTemp8 + fTemp267 + fTemp270 + fTemp1;
			fRec347[0] = fTemp270 + fRec350[1] + fTemp267 + fTemp8 + 0.995 * fRec347[1] + (1.2 - (fVec0[1] + fVec9[1]));
			fRec346[0] = std::max<double>(fConst1 * fRec346[1], std::fabs(fRec347[0]));
			fVbargraph14 = FAUSTFLOAT(fRec346[0]);
			double fTemp274 = fRec12[0] * tanh(fRec347[0] / fTemp0);
			fRec345[0] = std::max<double>(fConst1 * fRec345[1], std::fabs(fTemp274));
			fVbargraph15 = FAUSTFLOAT(fRec345[0]);
			double fTemp275 = fTemp274;
			fRec358[0] = fSlow19 + fConst3 * fRec358[1];
			fRec359[0] = fSlow20 + fConst3 * fRec359[1];
			fRec360[0] = fSlow21 + fConst3 * fRec360[1];
			double fTemp276 = fRec360[0] * (fRec359[0] * (0.0 - 33.0 * (1.0 - fRec358[0])) + 1.3e+02);
			double fTemp277 = std::tan(fConst6 * fTemp276);
			double fTemp278 = fTemp277 * (fTemp277 + fTemp15 / fTemp276) + 1.0;
			double fTemp279 = fTemp277 * (fTemp275 - fRec356[1]) + fRec355[1];
			fRec355[0] = 2.0 * (fTemp279 / fTemp278) - fRec355[1];
			fRec356[0] = fRec356[1] + 2.0 * (fTemp277 * fTemp279 / fTemp278);
			double fTemp280 = 0.003792499999999999 * fRec358[0] + fRec359[0] * (0.10944208 - 0.11432047 * fRec358[0]) + 0.01216278;
			double fRec357 = fTemp279 * fTemp280 / fTemp278;
			double fTemp281 = 2637.0 * fRec358[0];
			double fTemp282 = fRec360[0] * (fRec359[0] * (4164.0 * fRec358[0] + -1314.0) + (8574.0 - fTemp281));
			double fTemp283 = std::tan(fConst6 * fTemp282);
			double fTemp284 = fTemp283 * (fTemp283 + fTemp15 / fTemp282) + 1.0;
			double fTemp285 = fTemp283 * (fTemp275 - fRec362[1]) + fRec361[1];
			fRec361[0] = 2.0 * (fTemp285 / fTemp284) - fRec361[1];
			fRec362[0] = fRec362[1] + 2.0 * (fTemp283 * fTemp285 / fTemp284);
			double fTemp286 = fRec359[0] * (0.01694164 - 0.021432509999999995 * fRec358[0]) + (0.00986048 - 0.0008017400000000004 * fRec358[0]);
			double fRec363 = fTemp285 * fTemp286 / fTemp284;
			double fTemp287 = fRec360[0] * (fRec359[0] * (4608.0 * fRec358[0] + -2856.0) + (7035.0 - fTemp281));
			double fTemp288 = std::tan(fConst6 * fTemp287);
			double fTemp289 = fTemp288 * (fTemp288 + fTemp15 / fTemp287) + 1.0;
			double fTemp290 = fTemp288 * (fTemp275 - fRec365[1]) + fRec364[1];
			fRec364[0] = 2.0 * (fTemp290 / fTemp289) - fRec364[1];
			fRec365[0] = fRec365[1] + 2.0 * (fTemp288 * fTemp290 / fTemp289);
			double fTemp291 = fRec359[0] * (0.002267030000000003 * fRec358[0] + 0.0020714199999999974) + (0.02237106 - 0.014284890000000001 * fRec358[0]);
			double fRec366 = fTemp290 * fTemp291 / fTemp289;
			double fTemp292 = 1538.0 * fRec358[0];
			double fTemp293 = fRec360[0] * (fRec359[0] * (fTemp292 + -1979.0) + (5496.0 - fTemp292));
			double fTemp294 = std::tan(fConst6 * fTemp293);
			double fTemp295 = fTemp294 * (fTemp294 + fTemp15 / fTemp293) + 1.0;
			double fTemp296 = fTemp294 * (fTemp275 - fRec368[1]) + fRec367[1];
			fRec367[0] = 2.0 * (fTemp296 / fTemp295) - fRec367[1];
			fRec368[0] = fRec368[1] + 2.0 * (fTemp294 * fTemp296 / fTemp295);
			double fTemp297 = 0.006774230000000001 * fRec358[0] + fRec359[0] * (0.10261458000000001 - 0.10685212000000001 * fRec358[0]) + 0.01369543;
			double fRec369 = fTemp296 * fTemp297 / fTemp295;
			double fTemp298 = fRec360[0] * (fRec359[0] * (1205.0 * fRec358[0] + -1538.0) + (4617.0 - 1099.0 * fRec358[0]));
			double fTemp299 = std::tan(fConst6 * fTemp298);
			double fTemp300 = fTemp299 * (fTemp299 + fTemp15 / fTemp298) + 1.0;
			double fTemp301 = fTemp299 * (fTemp275 - fRec371[1]) + fRec370[1];
			fRec370[0] = 2.0 * (fTemp301 / fTemp300) - fRec370[1];
			fRec371[0] = fRec371[1] + 2.0 * (fTemp299 * fTemp301 / fTemp300);
			double fTemp302 = 0.02699203 * fRec358[0] + fRec359[0] * (0.04665504 - 0.07662214 * fRec358[0]) + 0.00854136;
			double fRec372 = fTemp301 * fTemp302 / fTemp300;
			double fTemp303 = 878.0 * fRec358[0];
			double fTemp304 = fRec360[0] * (fRec359[0] * (871.0 * fRec358[0] + -1318.0) + (3957.0 - fTemp303));
			double fTemp305 = std::tan(fConst6 * fTemp304);
			double fTemp306 = fTemp305 * (fTemp305 + fTemp15 / fTemp304) + 1.0;
			double fTemp307 = fTemp305 * (fTemp275 - fRec374[1]) + fRec373[1];
			fRec373[0] = 2.0 * (fTemp307 / fTemp306) - fRec373[1];
			fRec374[0] = fRec374[1] + 2.0 * (fTemp305 * fTemp307 / fTemp306);
			double fTemp308 = 0.01252276 * fRec358[0] + fRec359[0] * (0.10869632000000001 - 0.09120969000000001 * fRec358[0]) + 0.01631748;
			double fRec375 = fTemp307 * fTemp308 / fTemp306;
			double fTemp309 = fRec360[0] * (fRec359[0] * (1.06e+03 * fRec358[0] + -1318.0) + (3517.0 - fTemp303));
			double fTemp310 = std::tan(fConst6 * fTemp309);
			double fTemp311 = fTemp310 * (fTemp310 + fTemp15 / fTemp309) + 1.0;
			double fTemp312 = fTemp310 * (fTemp275 - fRec377[1]) + fRec376[1];
			fRec376[0] = 2.0 * (fTemp312 / fTemp311) - fRec376[1];
			fRec377[0] = fRec377[1] + 2.0 * (fTemp310 * fTemp312 / fTemp311);
			double fTemp313 = 0.04926784000000001 * fRec358[0] + fRec359[0] * (0.54408778 - 0.61006677 * fRec358[0]) + 0.02061391;
			double fRec378 = fTemp312 * fTemp313 / fTemp311;
			double fTemp314 = fRec360[0] * (fRec359[0] * (1.08e+03 * fRec358[0] + -1319.0) + (3078.0 - 789.0 * fRec358[0]));
			double fTemp315 = std::tan(fConst6 * fTemp314);
			double fTemp316 = fTemp315 * (fTemp315 + fTemp15 / fTemp314) + 1.0;
			double fTemp317 = fTemp315 * (fTemp275 - fRec380[1]) + fRec379[1];
			fRec379[0] = 2.0 * (fTemp317 / fTemp316) - fRec379[1];
			fRec380[0] = fRec380[1] + 2.0 * (fTemp315 * fTemp317 / fTemp316);
			double fTemp318 = fRec359[0] * (0.07516669000000001 - 0.07834676 * fRec358[0]) + (0.01222045 - 0.0014069800000000004 * fRec358[0]);
			double fRec381 = fTemp317 * fTemp318 / fTemp316;
			double fTemp319 = 659.0 * fRec358[0];
			double fTemp320 = fRec360[0] * (fRec359[0] * (943.0 * fRec358[0] + -1167.0) + (2638.0 - fTemp319));
			double fTemp321 = std::tan(fConst6 * fTemp320);
			double fTemp322 = fTemp321 * (fTemp321 + fTemp15 / fTemp320) + 1.0;
			double fTemp323 = fTemp321 * (fTemp275 - fRec383[1]) + fRec382[1];
			fRec382[0] = 2.0 * (fTemp323 / fTemp322) - fRec382[1];
			fRec383[0] = fRec383[1] + 2.0 * (fTemp321 * fTemp323 / fTemp322);
			double fTemp324 = 0.006005980000000001 * fRec358[0] + fRec359[0] * (0.14227104000000002 * fRec358[0] + -0.017441090000000003) + 0.04759307;
			double fRec384 = fTemp323 * fTemp324 / fTemp322;
			double fTemp325 = fRec360[0] * (fRec359[0] * (744.0 * fRec358[0] + -882.0) + (2198.0 - 588.0 * fRec358[0]));
			double fTemp326 = std::tan(fConst6 * fTemp325);
			double fTemp327 = fTemp326 * (fTemp326 + fTemp15 / fTemp325) + 1.0;
			double fTemp328 = fTemp326 * (fTemp275 - fRec386[1]) + fRec385[1];
			fRec385[0] = 2.0 * (fTemp328 / fTemp327) - fRec385[1];
			fRec386[0] = fRec386[1] + 2.0 * (fTemp326 * fTemp328 / fTemp327);
			double fTemp329 = fRec359[0] * (0.07178015999999998 * fRec358[0] + -0.07126405) + (0.22375855 - 0.21313116 * fRec358[0]);
			double fRec387 = fTemp328 * fTemp329 / fTemp327;
			double fTemp330 = fRec360[0] * (fRec359[0] * (358.0 * fRec358[0] + -661.0) + (1759.0 - 287.0 * fRec358[0]));
			double fTemp331 = std::tan(fConst6 * fTemp330);
			double fTemp332 = fTemp331 * (fTemp331 + fTemp15 / fTemp330) + 1.0;
			double fTemp333 = fTemp331 * (fTemp275 - fRec389[1]) + fRec388[1];
			fRec388[0] = 2.0 * (fTemp333 / fTemp332) - fRec388[1];
			fRec389[0] = fRec389[1] + 2.0 * (fTemp331 * fTemp333 / fTemp332);
			double fTemp334 = fRec359[0] * (0.92661765 - 0.9297246 * fRec358[0]) + (0.07338235 - 0.06490082999999999 * fRec358[0]);
			double fRec390 = fTemp333 * fTemp334 / fTemp332;
			double fTemp335 = 2.2e+02 * fRec358[0];
			double fTemp336 = fRec360[0] * (fRec359[0] * (232.0 * fRec358[0] + -359.0) + (1319.0 - fTemp335));
			double fTemp337 = std::tan(fConst6 * fTemp336);
			double fTemp338 = fTemp337 * (fTemp337 + fTemp15 / fTemp336) + 1.0;
			double fTemp339 = fTemp337 * (fTemp275 - fRec392[1]) + fRec391[1];
			fRec391[0] = 2.0 * (fTemp339 / fTemp338) - fRec391[1];
			fRec392[0] = fRec392[1] + 2.0 * (fTemp337 * fTemp339 / fTemp338);
			double fTemp340 = 0.30503947000000003 * fRec358[0] + fRec359[0] * (-0.22500213 - 0.35131018 * fRec358[0]) + 0.27821024;
			double fRec393 = fTemp339 * fTemp340 / fTemp338;
			double fTemp341 = fRec360[0] * (fRec358[0] + fRec359[0] * (-115.0 - 6e+01 * fRec358[0]) + 879.0);
			double fTemp342 = std::tan(fConst6 * fTemp341);
			double fTemp343 = fTemp342 * (fTemp342 + fTemp15 / fTemp341) + 1.0;
			double fTemp344 = fTemp342 * (fTemp275 - fRec395[1]) + fRec394[1];
			fRec394[0] = 2.0 * (fTemp344 / fTemp343) - fRec394[1];
			fRec395[0] = fRec395[1] + 2.0 * (fTemp342 * fTemp344 / fTemp343);
			double fTemp345 = fRec359[0] * (0.00015622000000001246 * fRec358[0] + -0.36691775000000004) + (0.4053105 - 0.023941270000000014 * fRec358[0]);
			double fRec396 = fTemp344 * fTemp345 / fTemp343;
			double fTemp346 = fRec360[0] * (33.0 * fRec358[0] + fRec359[0] * (3.0 - 117.0 * fRec358[0]) + 538.0);
			double fTemp347 = std::tan(fConst6 * fTemp346);
			double fTemp348 = fTemp347 * (fTemp347 + fTemp15 / fTemp346) + 1.0;
			double fTemp349 = fTemp347 * (fTemp275 - fRec398[1]) + fRec397[1];
			fRec397[0] = 2.0 * (fTemp349 / fTemp348) - fRec397[1];
			fRec398[0] = fRec398[1] + 2.0 * (fTemp347 * fTemp349 / fTemp348);
			double fTemp350 = 0.001517609999999999 * fRec358[0] + fRec359[0] * (0.06630294 - 0.06758767 * fRec358[0]) + 0.00707754;
			double fRec399 = fTemp349 * fTemp350 / fTemp348;
			double fTemp351 = fRec360[0] * (2.0 * fRec358[0] + fRec359[0] * (-3.0 - 56.0 * fRec358[0]) + 368.0);
			double fTemp352 = std::tan(fConst6 * fTemp351);
			double fTemp353 = fTemp352 * (fTemp352 + fTemp15 / fTemp351) + 1.0;
			double fTemp354 = fTemp352 * (fTemp275 - fRec401[1]) + fRec400[1];
			fRec400[0] = 2.0 * (fTemp354 / fTemp353) - fRec400[1];
			fRec401[0] = fRec401[1] + 2.0 * (fTemp352 * fTemp354 / fTemp353);
			double fTemp355 = 0.004375260000000001 * fRec358[0] + fRec359[0] * (0.12435025999999999 - 0.13294609999999998 * fRec358[0]) + 0.01035828;
			double fRec402 = fTemp354 * fTemp355 / fTemp353;
			double fTemp356 = fRec360[0] * (2.2e+02 - 29.0 * fRec359[0]);
			double fTemp357 = std::tan(fConst6 * fTemp356);
			double fTemp358 = fTemp357 * (fTemp357 + fTemp15 / fTemp356) + 1.0;
			double fTemp359 = fTemp357 * (fTemp275 - fRec404[1]) + fRec403[1];
			fRec403[0] = 2.0 * (fTemp359 / fTemp358) - fRec403[1];
			fRec404[0] = fRec404[1] + 2.0 * (fTemp357 * fTemp359 / fTemp358);
			double fTemp360 = fRec359[0] * (-0.62251682 - 0.33358304 * fRec358[0]) + 1.0;
			double fRec405 = fTemp359 * fTemp360 / fTemp358;
			double fTemp361 = fRec359[0] * fRec358[0];
			double fTemp362 = fRec360[0] * (12.0 * fTemp361 + 5e+01);
			double fTemp363 = std::tan(fConst6 * fTemp362);
			double fTemp364 = fTemp363 * (fTemp363 + fTemp15 / fTemp362) + 1.0;
			double fTemp365 = fTemp363 * (fTemp275 - fRec407[1]) + fRec406[1];
			fRec406[0] = 2.0 * (fTemp365 / fTemp364) - fRec406[1];
			fRec407[0] = fRec407[1] + 2.0 * (fTemp363 * fTemp365 / fTemp364);
			double fTemp366 = fRec359[0] * (0.07282898 - 0.03932521 * fRec358[0]) + 0.01835863;
			double fRec408 = fTemp365 * fTemp366 / fTemp364;
			double fTemp367 = fRec360[0] * (fRec359[0] * (0.0 - 48.0 * fRec358[0]) + 309.0);
			double fTemp368 = std::tan(fConst6 * fTemp367);
			double fTemp369 = fTemp368 * (fTemp368 + fTemp15 / fTemp367) + 1.0;
			double fTemp370 = fTemp368 * (fTemp275 - fRec410[1]) + fRec409[1];
			fRec409[0] = 2.0 * (fTemp370 / fTemp369) - fRec409[1];
			fRec410[0] = fRec410[1] + 2.0 * (fTemp368 * fTemp370 / fTemp369);
			double fTemp371 = 0.0026099600000000006 * fTemp361 + 0.00749257;
			double fRec411 = fTemp370 * fTemp371 / fTemp369;
			double fTemp372 = fRec360[0] * (fRec358[0] + fRec359[0] * (1.0 - 71.0 * fRec358[0]) + 439.0);
			double fTemp373 = std::tan(fConst6 * fTemp372);
			double fTemp374 = fTemp373 * (fTemp373 + fTemp15 / fTemp372) + 1.0;
			double fTemp375 = fTemp373 * (fTemp275 - fRec413[1]) + fRec412[1];
			fRec412[0] = 2.0 * (fTemp375 / fTemp374) - fRec412[1];
			fRec413[0] = fRec413[1] + 2.0 * (fTemp373 * fTemp375 / fTemp374);
			double fTemp376 = 0.20472301000000004 * fRec358[0] + fRec359[0] * (-0.44281840999999994 - 0.40144216000000005 * fRec358[0]) + 0.6674602;
			double fRec414 = fTemp375 * fTemp376 / fTemp374;
			double fTemp377 = fRec360[0] * (fRec358[0] + fRec359[0] * (-1.0 - 122.0 * fRec358[0]) + 659.0);
			double fTemp378 = std::tan(fConst6 * fTemp377);
			double fTemp379 = fTemp378 * (fTemp378 + fTemp15 / fTemp377) + 1.0;
			double fTemp380 = fTemp378 * (fTemp275 - fRec416[1]) + fRec415[1];
			fRec415[0] = 2.0 * (fTemp380 / fTemp379) - fRec415[1];
			fRec416[0] = fRec416[1] + 2.0 * (fTemp378 * fTemp380 / fTemp379);
			double fTemp381 = fRec359[0] * (-0.09119557999999994 - 0.49022327 * fRec358[0]) + (0.62411215 - 0.03461038999999999 * fRec358[0]);
			double fRec417 = fTemp380 * fTemp381 / fTemp379;
			double fTemp382 = 137.0 * fRec358[0];
			double fTemp383 = fRec360[0] * (fRec359[0] * (fTemp382 + -221.0) + (1099.0 - fTemp382));
			double fTemp384 = std::tan(fConst6 * fTemp383);
			double fTemp385 = fTemp384 * (fTemp384 + fTemp15 / fTemp383) + 1.0;
			double fTemp386 = fTemp384 * (fTemp275 - fRec419[1]) + fRec418[1];
			fRec418[0] = 2.0 * (fTemp386 / fTemp385) - fRec418[1];
			fRec419[0] = fRec419[1] + 2.0 * (fTemp384 * fTemp386 / fTemp385);
			double fTemp387 = fRec359[0] * (1.27501065 * fRec358[0] + -0.28731595) + (0.64427134 - 0.63196604 * fRec358[0]);
			double fRec420 = fTemp386 * fTemp387 / fTemp385;
			double fTemp388 = fRec360[0] * (fRec359[0] * (327.0 * fRec358[0] + -529.0) + (1539.0 - fTemp335));
			double fTemp389 = std::tan(fConst6 * fTemp388);
			double fTemp390 = fTemp389 * (fTemp389 + fTemp15 / fTemp388) + 1.0;
			double fTemp391 = fTemp389 * (fTemp275 - fRec422[1]) + fRec421[1];
			fRec421[0] = 2.0 * (fTemp391 / fTemp390) - fRec421[1];
			fRec422[0] = fRec422[1] + 2.0 * (fTemp389 * fTemp391 / fTemp390);
			double fTemp392 = 0.28255792 * fRec358[0] + fRec359[0] * (-0.038845000000000005 - 0.32540112 * fRec358[0]) + 0.08982961;
			double fRec423 = fTemp391 * fTemp392 / fTemp390;
			double fTemp393 = fRec360[0] * (fRec359[0] * (4.5e+02 * fRec358[0] + -742.0) + (1978.0 - 439.0 * fRec358[0]));
			double fTemp394 = std::tan(fConst6 * fTemp393);
			double fTemp395 = fTemp394 * (fTemp394 + fTemp15 / fTemp393) + 1.0;
			double fTemp396 = fTemp394 * (fTemp275 - fRec425[1]) + fRec424[1];
			fRec424[0] = 2.0 * (fTemp396 / fTemp395) - fRec424[1];
			fRec425[0] = fRec425[1] + 2.0 * (fTemp394 * fTemp396 / fTemp395);
			double fTemp397 = 0.14846291 * fRec358[0] + fRec359[0] * (-0.00654018 - 0.17174218 * fRec358[0]) + 0.03442368;
			double fRec426 = fTemp396 * fTemp397 / fTemp395;
			double fTemp398 = fRec360[0] * (fRec359[0] * (924.0 * fRec358[0] + -987.0) + (2418.0 - 658.0 * fRec358[0]));
			double fTemp399 = std::tan(fConst6 * fTemp398);
			double fTemp400 = fTemp399 * (fTemp399 + fTemp15 / fTemp398) + 1.0;
			double fTemp401 = fTemp399 * (fTemp275 - fRec428[1]) + fRec427[1];
			fRec427[0] = 2.0 * (fTemp401 / fTemp400) - fRec427[1];
			fRec428[0] = fRec428[1] + 2.0 * (fTemp399 * fTemp401 / fTemp400);
			double fTemp402 = fRec359[0] * (0.01882346 * fRec358[0] + -0.0027897500000000006) + (0.02409027 - 0.01300287 * fRec358[0]);
			double fRec429 = fTemp401 * fTemp402 / fTemp400;
			double fTemp403 = fRec360[0] * (fRec359[0] * (1108.0 * fRec358[0] + -1324.0) + (2858.0 - fTemp319));
			double fTemp404 = std::tan(fConst6 * fTemp403);
			double fTemp405 = fTemp404 * (fTemp404 + fTemp15 / fTemp403) + 1.0;
			double fTemp406 = fTemp404 * (fTemp275 - fRec431[1]) + fRec430[1];
			fRec430[0] = 2.0 * (fTemp406 / fTemp405) - fRec430[1];
			fRec431[0] = fRec431[1] + 2.0 * (fTemp404 * fTemp406 / fTemp405);
			double fTemp407 = 0.27752175 * fRec358[0] + fRec359[0] * (0.007711639999999999 - 0.31944662 * fRec358[0]) + 0.03888326;
			double fRec432 = fTemp406 * fTemp407 / fTemp405;
			double fTemp408 = 879.0 * fRec358[0];
			double fTemp409 = fRec360[0] * (fRec359[0] * (1189.0 * fRec358[0] + -1321.0) + (3298.0 - fTemp408));
			double fTemp410 = std::tan(fConst6 * fTemp409);
			double fTemp411 = fTemp410 * (fTemp410 + fTemp15 / fTemp409) + 1.0;
			double fTemp412 = fTemp410 * (fTemp275 - fRec434[1]) + fRec433[1];
			fRec433[0] = 2.0 * (fTemp412 / fTemp411) - fRec433[1];
			fRec434[0] = fRec434[1] + 2.0 * (fTemp410 * fTemp412 / fTemp411);
			double fTemp413 = fRec359[0] * (0.1182356 - 0.13861138 * fRec358[0]) + (0.03283333 - 0.005876740000000002 * fRec358[0]);
			double fRec435 = fTemp412 * fTemp413 / fTemp411;
			double fTemp414 = fRec360[0] * (fRec359[0] * (1007.0 * fRec358[0] + -1.32e+03) + (3737.0 - fTemp303));
			double fTemp415 = std::tan(fConst6 * fTemp414);
			double fTemp416 = fTemp415 * (fTemp415 + fTemp15 / fTemp414) + 1.0;
			double fTemp417 = fTemp415 * (fTemp275 - fRec437[1]) + fRec436[1];
			fRec436[0] = 2.0 * (fTemp417 / fTemp416) - fRec436[1];
			fRec437[0] = fRec437[1] + 2.0 * (fTemp415 * fTemp417 / fTemp416);
			double fTemp418 = 0.02271603 * fRec358[0] + fRec359[0] * (0.11568920999999999 - 0.15871534999999998 * fRec358[0]) + 0.02601317;
			double fRec438 = fTemp417 * fTemp418 / fTemp416;
			double fTemp419 = fRec360[0] * (fRec359[0] * (835.0 * fRec358[0] + -1.32e+03) + (4177.0 - fTemp408));
			double fTemp420 = std::tan(fConst6 * fTemp419);
			double fTemp421 = fTemp420 * (fTemp420 + fTemp15 / fTemp419) + 1.0;
			double fTemp422 = fTemp420 * (fTemp275 - fRec440[1]) + fRec439[1];
			fRec439[0] = 2.0 * (fTemp422 / fTemp421) - fRec439[1];
			fRec440[0] = fRec440[1] + 2.0 * (fTemp420 * fTemp422 / fTemp421);
			double fTemp423 = 0.040329569999999995 * fRec358[0] + fRec359[0] * (0.06619388 - 0.11677492999999999 * fRec358[0]) + 0.01776269;
			double fRec441 = fTemp422 * fTemp423 / fTemp421;
			double fTemp424 = fRec360[0] * (fRec359[0] * (1268.0 * fRec358[0] + -1759.0) + (5056.0 - 1318.0 * fRec358[0]));
			double fTemp425 = std::tan(fConst6 * fTemp424);
			double fTemp426 = fTemp425 * (fTemp425 + fTemp15 / fTemp424) + 1.0;
			double fTemp427 = fTemp425 * (fTemp275 - fRec443[1]) + fRec442[1];
			fRec442[0] = 2.0 * (fTemp427 / fTemp426) - fRec442[1];
			fRec443[0] = fRec443[1] + 2.0 * (fTemp425 * fTemp427 / fTemp426);
			double fTemp428 = 0.03387651 * fRec358[0] + fRec359[0] * (0.04723798 - 0.09128072 * fRec358[0]) + 0.01528356;
			double fRec444 = fTemp427 * fTemp428 / fTemp426;
			double fTemp429 = fRec360[0] * (fRec359[0] * (2198.0 * fRec358[0] + -1981.0) + (5717.0 - 1539.0 * fRec358[0]));
			double fTemp430 = std::tan(fConst6 * fTemp429);
			double fTemp431 = fTemp430 * (fTemp430 + fTemp15 / fTemp429) + 1.0;
			double fTemp432 = fTemp430 * (fTemp275 - fRec446[1]) + fRec445[1];
			fRec445[0] = 2.0 * (fTemp432 / fTemp431) - fRec445[1];
			fRec446[0] = fRec446[1] + 2.0 * (fTemp430 * fTemp432 / fTemp431);
			double fTemp433 = 0.0159348 * fRec358[0] + fRec359[0] * (0.02239037 - 0.02813122 * fRec358[0]) + 0.00841917;
			double fRec447 = fTemp432 * fTemp433 / fTemp431;
			double fTemp434 = fRec360[0] * (fRec359[0] * (4811.0 * fRec358[0] + -1537.0) + (7255.0 - fTemp281));
			double fTemp435 = std::tan(fConst6 * fTemp434);
			double fTemp436 = fTemp435 * (fTemp435 + fTemp15 / fTemp434) + 1.0;
			double fTemp437 = fTemp435 * (fTemp275 - fRec449[1]) + fRec448[1];
			fRec448[0] = 2.0 * (fTemp437 / fTemp436) - fRec448[1];
			fRec449[0] = fRec449[1] + 2.0 * (fTemp435 * fTemp437 / fTemp436);
			double fTemp438 = fRec359[0] * (0.01286443 - 0.017049130000000003 * fRec358[0]) + (0.00969712 - 0.0011080199999999995 * fRec358[0]);
			double fRec450 = fTemp437 * fTemp438 / fTemp436;
			double fTemp439 = fRec360[0] * (fRec359[0] * (5481.0 * fRec358[0] + -1973.0) + (9672.0 - 3515.0 * fRec358[0]));
			double fTemp440 = std::tan(fConst6 * fTemp439);
			double fTemp441 = fTemp440 * (fTemp440 + fTemp15 / fTemp439) + 1.0;
			double fTemp442 = fTemp440 * (fTemp275 - fRec452[1]) + fRec451[1];
			fRec451[0] = 2.0 * (fTemp442 / fTemp441) - fRec451[1];
			fRec452[0] = fRec452[1] + 2.0 * (fTemp440 * fTemp442 / fTemp441);
			double fTemp443 = fRec359[0] * (0.028484340000000004 - 0.03413223 * fRec358[0]) + (0.01255551 - 0.0006110500000000001 * fRec358[0]);
			double fRec453 = fTemp442 * fTemp443 / fTemp441;
			double fTemp444 = 0.03125 * fRec132[0] * (fRec453 + fRec450 + fRec447 + fRec444 + fRec441 + fRec438 + fRec435 + fRec432 + fRec429 + fRec426 + fRec423 + fRec420 + fRec417 + fRec414 + fRec411 + fRec408 + fRec405 + fRec402 + fRec399 + fRec396 + fRec393 + fRec390 + fRec387 + fRec384 + fRec381 + fRec378 + fRec375 + fRec372 + fRec369 + fRec366 + fRec363 + fRec357) + fRec31[0] * fTemp275;
			fRec344[0] = std::max<double>(fConst1 * fRec344[1], std::fabs(fTemp444));
			fVbargraph16 = FAUSTFLOAT(fRec344[0]);
			fRec341[0] = fTemp444;
			double fTemp445 = fRec21[0] * fRec343[1];
			fRec458[0] = std::max<double>(fConst1 * fRec458[1], std::fabs(fTemp445));
			fVbargraph17 = FAUSTFLOAT(fRec458[0]);
			double fTemp446 = fTemp445;
			double fTemp447 = fRec23[0] * (fTemp267 * (fRec138[0] - fTemp446) - fTemp269);
			double fTemp448 = fTemp8 + fRec350[1];
			double fTemp449 = fTemp448 + fTemp269;
			fVec10[0] = fTemp449 + fTemp447 + fTemp184;
			fRec457[0] = fTemp447 + 0.995 * fRec457[1] + fTemp449 + (1.3 - (fVec3[1] + fVec10[1]));
			fRec456[0] = std::max<double>(fConst1 * fRec456[1], std::fabs(fRec457[0]));
			fVbargraph18 = FAUSTFLOAT(fRec456[0]);
			double fTemp450 = fRec12[0] * tanh(fRec457[0] / fTemp0);
			fRec455[0] = std::max<double>(fConst1 * fRec455[1], std::fabs(fTemp450));
			fVbargraph19 = FAUSTFLOAT(fRec455[0]);
			double fTemp451 = fTemp450;
			double fTemp452 = fTemp277 * (fTemp451 - fRec460[1]) + fRec459[1];
			fRec459[0] = 2.0 * (fTemp452 / fTemp278) - fRec459[1];
			fRec460[0] = fRec460[1] + 2.0 * (fTemp277 * fTemp452 / fTemp278);
			double fRec461 = fTemp280 * fTemp452 / fTemp278;
			double fTemp453 = fTemp283 * (fTemp451 - fRec463[1]) + fRec462[1];
			fRec462[0] = 2.0 * (fTemp453 / fTemp284) - fRec462[1];
			fRec463[0] = fRec463[1] + 2.0 * (fTemp283 * fTemp453 / fTemp284);
			double fRec464 = fTemp286 * fTemp453 / fTemp284;
			double fTemp454 = fTemp288 * (fTemp451 - fRec466[1]) + fRec465[1];
			fRec465[0] = 2.0 * (fTemp454 / fTemp289) - fRec465[1];
			fRec466[0] = fRec466[1] + 2.0 * (fTemp288 * fTemp454 / fTemp289);
			double fRec467 = fTemp291 * fTemp454 / fTemp289;
			double fTemp455 = fTemp294 * (fTemp451 - fRec469[1]) + fRec468[1];
			fRec468[0] = 2.0 * (fTemp455 / fTemp295) - fRec468[1];
			fRec469[0] = fRec469[1] + 2.0 * (fTemp294 * fTemp455 / fTemp295);
			double fRec470 = fTemp297 * fTemp455 / fTemp295;
			double fTemp456 = fTemp299 * (fTemp451 - fRec472[1]) + fRec471[1];
			fRec471[0] = 2.0 * (fTemp456 / fTemp300) - fRec471[1];
			fRec472[0] = fRec472[1] + 2.0 * (fTemp299 * fTemp456 / fTemp300);
			double fRec473 = fTemp302 * fTemp456 / fTemp300;
			double fTemp457 = fTemp305 * (fTemp451 - fRec475[1]) + fRec474[1];
			fRec474[0] = 2.0 * (fTemp457 / fTemp306) - fRec474[1];
			fRec475[0] = fRec475[1] + 2.0 * (fTemp305 * fTemp457 / fTemp306);
			double fRec476 = fTemp308 * fTemp457 / fTemp306;
			double fTemp458 = fTemp310 * (fTemp451 - fRec478[1]) + fRec477[1];
			fRec477[0] = 2.0 * (fTemp458 / fTemp311) - fRec477[1];
			fRec478[0] = fRec478[1] + 2.0 * (fTemp310 * fTemp458 / fTemp311);
			double fRec479 = fTemp313 * fTemp458 / fTemp311;
			double fTemp459 = fTemp315 * (fTemp451 - fRec481[1]) + fRec480[1];
			fRec480[0] = 2.0 * (fTemp459 / fTemp316) - fRec480[1];
			fRec481[0] = fRec481[1] + 2.0 * (fTemp315 * fTemp459 / fTemp316);
			double fRec482 = fTemp318 * fTemp459 / fTemp316;
			double fTemp460 = fTemp321 * (fTemp451 - fRec484[1]) + fRec483[1];
			fRec483[0] = 2.0 * (fTemp460 / fTemp322) - fRec483[1];
			fRec484[0] = fRec484[1] + 2.0 * (fTemp321 * fTemp460 / fTemp322);
			double fRec485 = fTemp324 * fTemp460 / fTemp322;
			double fTemp461 = fTemp326 * (fTemp451 - fRec487[1]) + fRec486[1];
			fRec486[0] = 2.0 * (fTemp461 / fTemp327) - fRec486[1];
			fRec487[0] = fRec487[1] + 2.0 * (fTemp326 * fTemp461 / fTemp327);
			double fRec488 = fTemp329 * fTemp461 / fTemp327;
			double fTemp462 = fTemp331 * (fTemp451 - fRec490[1]) + fRec489[1];
			fRec489[0] = 2.0 * (fTemp462 / fTemp332) - fRec489[1];
			fRec490[0] = fRec490[1] + 2.0 * (fTemp331 * fTemp462 / fTemp332);
			double fRec491 = fTemp334 * fTemp462 / fTemp332;
			double fTemp463 = fTemp337 * (fTemp451 - fRec493[1]) + fRec492[1];
			fRec492[0] = 2.0 * (fTemp463 / fTemp338) - fRec492[1];
			fRec493[0] = fRec493[1] + 2.0 * (fTemp337 * fTemp463 / fTemp338);
			double fRec494 = fTemp340 * fTemp463 / fTemp338;
			double fTemp464 = fTemp342 * (fTemp451 - fRec496[1]) + fRec495[1];
			fRec495[0] = 2.0 * (fTemp464 / fTemp343) - fRec495[1];
			fRec496[0] = fRec496[1] + 2.0 * (fTemp342 * fTemp464 / fTemp343);
			double fRec497 = fTemp345 * fTemp464 / fTemp343;
			double fTemp465 = fTemp347 * (fTemp451 - fRec499[1]) + fRec498[1];
			fRec498[0] = 2.0 * (fTemp465 / fTemp348) - fRec498[1];
			fRec499[0] = fRec499[1] + 2.0 * (fTemp347 * fTemp465 / fTemp348);
			double fRec500 = fTemp350 * fTemp465 / fTemp348;
			double fTemp466 = fTemp352 * (fTemp451 - fRec502[1]) + fRec501[1];
			fRec501[0] = 2.0 * (fTemp466 / fTemp353) - fRec501[1];
			fRec502[0] = fRec502[1] + 2.0 * (fTemp352 * fTemp466 / fTemp353);
			double fRec503 = fTemp355 * fTemp466 / fTemp353;
			double fTemp467 = fTemp357 * (fTemp451 - fRec505[1]) + fRec504[1];
			fRec504[0] = 2.0 * (fTemp467 / fTemp358) - fRec504[1];
			fRec505[0] = fRec505[1] + 2.0 * (fTemp357 * fTemp467 / fTemp358);
			double fRec506 = fTemp360 * fTemp467 / fTemp358;
			double fTemp468 = fTemp363 * (fTemp451 - fRec508[1]) + fRec507[1];
			fRec507[0] = 2.0 * (fTemp468 / fTemp364) - fRec507[1];
			fRec508[0] = fRec508[1] + 2.0 * (fTemp363 * fTemp468 / fTemp364);
			double fRec509 = fTemp366 * fTemp468 / fTemp364;
			double fTemp469 = fTemp368 * (fTemp451 - fRec511[1]) + fRec510[1];
			fRec510[0] = 2.0 * (fTemp469 / fTemp369) - fRec510[1];
			fRec511[0] = fRec511[1] + 2.0 * (fTemp368 * fTemp469 / fTemp369);
			double fRec512 = fTemp371 * fTemp469 / fTemp369;
			double fTemp470 = fTemp373 * (fTemp451 - fRec514[1]) + fRec513[1];
			fRec513[0] = 2.0 * (fTemp470 / fTemp374) - fRec513[1];
			fRec514[0] = fRec514[1] + 2.0 * (fTemp373 * fTemp470 / fTemp374);
			double fRec515 = fTemp376 * fTemp470 / fTemp374;
			double fTemp471 = fTemp378 * (fTemp451 - fRec517[1]) + fRec516[1];
			fRec516[0] = 2.0 * (fTemp471 / fTemp379) - fRec516[1];
			fRec517[0] = fRec517[1] + 2.0 * (fTemp378 * fTemp471 / fTemp379);
			double fRec518 = fTemp381 * fTemp471 / fTemp379;
			double fTemp472 = fTemp384 * (fTemp451 - fRec520[1]) + fRec519[1];
			fRec519[0] = 2.0 * (fTemp472 / fTemp385) - fRec519[1];
			fRec520[0] = fRec520[1] + 2.0 * (fTemp384 * fTemp472 / fTemp385);
			double fRec521 = fTemp387 * fTemp472 / fTemp385;
			double fTemp473 = fTemp389 * (fTemp451 - fRec523[1]) + fRec522[1];
			fRec522[0] = 2.0 * (fTemp473 / fTemp390) - fRec522[1];
			fRec523[0] = fRec523[1] + 2.0 * (fTemp389 * fTemp473 / fTemp390);
			double fRec524 = fTemp392 * fTemp473 / fTemp390;
			double fTemp474 = fTemp394 * (fTemp451 - fRec526[1]) + fRec525[1];
			fRec525[0] = 2.0 * (fTemp474 / fTemp395) - fRec525[1];
			fRec526[0] = fRec526[1] + 2.0 * (fTemp394 * fTemp474 / fTemp395);
			double fRec527 = fTemp397 * fTemp474 / fTemp395;
			double fTemp475 = fTemp399 * (fTemp451 - fRec529[1]) + fRec528[1];
			fRec528[0] = 2.0 * (fTemp475 / fTemp400) - fRec528[1];
			fRec529[0] = fRec529[1] + 2.0 * (fTemp399 * fTemp475 / fTemp400);
			double fRec530 = fTemp402 * fTemp475 / fTemp400;
			double fTemp476 = fTemp404 * (fTemp451 - fRec532[1]) + fRec531[1];
			fRec531[0] = 2.0 * (fTemp476 / fTemp405) - fRec531[1];
			fRec532[0] = fRec532[1] + 2.0 * (fTemp404 * fTemp476 / fTemp405);
			double fRec533 = fTemp407 * fTemp476 / fTemp405;
			double fTemp477 = fTemp410 * (fTemp451 - fRec535[1]) + fRec534[1];
			fRec534[0] = 2.0 * (fTemp477 / fTemp411) - fRec534[1];
			fRec535[0] = fRec535[1] + 2.0 * (fTemp410 * fTemp477 / fTemp411);
			double fRec536 = fTemp413 * fTemp477 / fTemp411;
			double fTemp478 = fTemp415 * (fTemp451 - fRec538[1]) + fRec537[1];
			fRec537[0] = 2.0 * (fTemp478 / fTemp416) - fRec537[1];
			fRec538[0] = fRec538[1] + 2.0 * (fTemp415 * fTemp478 / fTemp416);
			double fRec539 = fTemp418 * fTemp478 / fTemp416;
			double fTemp479 = fTemp420 * (fTemp451 - fRec541[1]) + fRec540[1];
			fRec540[0] = 2.0 * (fTemp479 / fTemp421) - fRec540[1];
			fRec541[0] = fRec541[1] + 2.0 * (fTemp420 * fTemp479 / fTemp421);
			double fRec542 = fTemp423 * fTemp479 / fTemp421;
			double fTemp480 = fTemp425 * (fTemp451 - fRec544[1]) + fRec543[1];
			fRec543[0] = 2.0 * (fTemp480 / fTemp426) - fRec543[1];
			fRec544[0] = fRec544[1] + 2.0 * (fTemp425 * fTemp480 / fTemp426);
			double fRec545 = fTemp428 * fTemp480 / fTemp426;
			double fTemp481 = fTemp430 * (fTemp451 - fRec547[1]) + fRec546[1];
			fRec546[0] = 2.0 * (fTemp481 / fTemp431) - fRec546[1];
			fRec547[0] = fRec547[1] + 2.0 * (fTemp430 * fTemp481 / fTemp431);
			double fRec548 = fTemp433 * fTemp481 / fTemp431;
			double fTemp482 = fTemp435 * (fTemp451 - fRec550[1]) + fRec549[1];
			fRec549[0] = 2.0 * (fTemp482 / fTemp436) - fRec549[1];
			fRec550[0] = fRec550[1] + 2.0 * (fTemp435 * fTemp482 / fTemp436);
			double fRec551 = fTemp438 * fTemp482 / fTemp436;
			double fTemp483 = fTemp440 * (fTemp451 - fRec553[1]) + fRec552[1];
			fRec552[0] = 2.0 * (fTemp483 / fTemp441) - fRec552[1];
			fRec553[0] = fRec553[1] + 2.0 * (fTemp440 * fTemp483 / fTemp441);
			double fRec554 = fTemp443 * fTemp483 / fTemp441;
			double fTemp484 = 0.03125 * fRec132[0] * (fRec554 + fRec551 + fRec548 + fRec545 + fRec542 + fRec539 + fRec536 + fRec533 + fRec530 + fRec527 + fRec524 + fRec521 + fRec518 + fRec515 + fRec512 + fRec509 + fRec506 + fRec503 + fRec500 + fRec497 + fRec494 + fRec491 + fRec488 + fRec485 + fRec482 + fRec479 + fRec476 + fRec473 + fRec470 + fRec467 + fRec464 + fRec461) + fRec31[0] * fTemp451;
			fRec454[0] = std::max<double>(fConst1 * fRec454[1], std::fabs(fTemp484));
			fVbargraph20 = FAUSTFLOAT(fRec454[0]);
			fRec342[0] = fTemp484;
			double fTemp485 = fRec23[0] * (fTemp267 * fTemp269 - fRec239[0] * fTemp446);
			double fTemp486 = fTemp448 + fTemp446;
			fVec11[0] = fTemp486 + fTemp485 + fTemp225;
			fRec558[0] = fTemp485 + 0.995 * fRec558[1] + fTemp486 + (1.6 - (fVec5[1] + fVec11[1]));
			fRec557[0] = std::max<double>(fConst1 * fRec557[1], std::fabs(fRec558[0]));
			fVbargraph21 = FAUSTFLOAT(fRec557[0]);
			double fTemp487 = fRec12[0] * tanh(fRec558[0] / fTemp0);
			fRec556[0] = std::max<double>(fConst1 * fRec556[1], std::fabs(fTemp487));
			fVbargraph22 = FAUSTFLOAT(fRec556[0]);
			double fTemp488 = fTemp487;
			double fTemp489 = fTemp277 * (fTemp488 - fRec560[1]) + fRec559[1];
			fRec559[0] = 2.0 * (fTemp489 / fTemp278) - fRec559[1];
			fRec560[0] = fRec560[1] + 2.0 * (fTemp277 * fTemp489 / fTemp278);
			double fRec561 = fTemp280 * fTemp489 / fTemp278;
			double fTemp490 = fTemp283 * (fTemp488 - fRec563[1]) + fRec562[1];
			fRec562[0] = 2.0 * (fTemp490 / fTemp284) - fRec562[1];
			fRec563[0] = fRec563[1] + 2.0 * (fTemp283 * fTemp490 / fTemp284);
			double fRec564 = fTemp286 * fTemp490 / fTemp284;
			double fTemp491 = fTemp288 * (fTemp488 - fRec566[1]) + fRec565[1];
			fRec565[0] = 2.0 * (fTemp491 / fTemp289) - fRec565[1];
			fRec566[0] = fRec566[1] + 2.0 * (fTemp288 * fTemp491 / fTemp289);
			double fRec567 = fTemp291 * fTemp491 / fTemp289;
			double fTemp492 = fTemp294 * (fTemp488 - fRec569[1]) + fRec568[1];
			fRec568[0] = 2.0 * (fTemp492 / fTemp295) - fRec568[1];
			fRec569[0] = fRec569[1] + 2.0 * (fTemp294 * fTemp492 / fTemp295);
			double fRec570 = fTemp297 * fTemp492 / fTemp295;
			double fTemp493 = fTemp299 * (fTemp488 - fRec572[1]) + fRec571[1];
			fRec571[0] = 2.0 * (fTemp493 / fTemp300) - fRec571[1];
			fRec572[0] = fRec572[1] + 2.0 * (fTemp299 * fTemp493 / fTemp300);
			double fRec573 = fTemp302 * fTemp493 / fTemp300;
			double fTemp494 = fTemp305 * (fTemp488 - fRec575[1]) + fRec574[1];
			fRec574[0] = 2.0 * (fTemp494 / fTemp306) - fRec574[1];
			fRec575[0] = fRec575[1] + 2.0 * (fTemp305 * fTemp494 / fTemp306);
			double fRec576 = fTemp308 * fTemp494 / fTemp306;
			double fTemp495 = fTemp310 * (fTemp488 - fRec578[1]) + fRec577[1];
			fRec577[0] = 2.0 * (fTemp495 / fTemp311) - fRec577[1];
			fRec578[0] = fRec578[1] + 2.0 * (fTemp310 * fTemp495 / fTemp311);
			double fRec579 = fTemp313 * fTemp495 / fTemp311;
			double fTemp496 = fTemp315 * (fTemp488 - fRec581[1]) + fRec580[1];
			fRec580[0] = 2.0 * (fTemp496 / fTemp316) - fRec580[1];
			fRec581[0] = fRec581[1] + 2.0 * (fTemp315 * fTemp496 / fTemp316);
			double fRec582 = fTemp318 * fTemp496 / fTemp316;
			double fTemp497 = fTemp321 * (fTemp488 - fRec584[1]) + fRec583[1];
			fRec583[0] = 2.0 * (fTemp497 / fTemp322) - fRec583[1];
			fRec584[0] = fRec584[1] + 2.0 * (fTemp321 * fTemp497 / fTemp322);
			double fRec585 = fTemp324 * fTemp497 / fTemp322;
			double fTemp498 = fTemp326 * (fTemp488 - fRec587[1]) + fRec586[1];
			fRec586[0] = 2.0 * (fTemp498 / fTemp327) - fRec586[1];
			fRec587[0] = fRec587[1] + 2.0 * (fTemp326 * fTemp498 / fTemp327);
			double fRec588 = fTemp329 * fTemp498 / fTemp327;
			double fTemp499 = fTemp331 * (fTemp488 - fRec590[1]) + fRec589[1];
			fRec589[0] = 2.0 * (fTemp499 / fTemp332) - fRec589[1];
			fRec590[0] = fRec590[1] + 2.0 * (fTemp331 * fTemp499 / fTemp332);
			double fRec591 = fTemp334 * fTemp499 / fTemp332;
			double fTemp500 = fTemp337 * (fTemp488 - fRec593[1]) + fRec592[1];
			fRec592[0] = 2.0 * (fTemp500 / fTemp338) - fRec592[1];
			fRec593[0] = fRec593[1] + 2.0 * (fTemp337 * fTemp500 / fTemp338);
			double fRec594 = fTemp340 * fTemp500 / fTemp338;
			double fTemp501 = fTemp342 * (fTemp488 - fRec596[1]) + fRec595[1];
			fRec595[0] = 2.0 * (fTemp501 / fTemp343) - fRec595[1];
			fRec596[0] = fRec596[1] + 2.0 * (fTemp342 * fTemp501 / fTemp343);
			double fRec597 = fTemp345 * fTemp501 / fTemp343;
			double fTemp502 = fTemp347 * (fTemp488 - fRec599[1]) + fRec598[1];
			fRec598[0] = 2.0 * (fTemp502 / fTemp348) - fRec598[1];
			fRec599[0] = fRec599[1] + 2.0 * (fTemp347 * fTemp502 / fTemp348);
			double fRec600 = fTemp350 * fTemp502 / fTemp348;
			double fTemp503 = fTemp352 * (fTemp488 - fRec602[1]) + fRec601[1];
			fRec601[0] = 2.0 * (fTemp503 / fTemp353) - fRec601[1];
			fRec602[0] = fRec602[1] + 2.0 * (fTemp352 * fTemp503 / fTemp353);
			double fRec603 = fTemp355 * fTemp503 / fTemp353;
			double fTemp504 = fTemp357 * (fTemp488 - fRec605[1]) + fRec604[1];
			fRec604[0] = 2.0 * (fTemp504 / fTemp358) - fRec604[1];
			fRec605[0] = fRec605[1] + 2.0 * (fTemp357 * fTemp504 / fTemp358);
			double fRec606 = fTemp360 * fTemp504 / fTemp358;
			double fTemp505 = fTemp363 * (fTemp488 - fRec608[1]) + fRec607[1];
			fRec607[0] = 2.0 * (fTemp505 / fTemp364) - fRec607[1];
			fRec608[0] = fRec608[1] + 2.0 * (fTemp363 * fTemp505 / fTemp364);
			double fRec609 = fTemp366 * fTemp505 / fTemp364;
			double fTemp506 = fTemp368 * (fTemp488 - fRec611[1]) + fRec610[1];
			fRec610[0] = 2.0 * (fTemp506 / fTemp369) - fRec610[1];
			fRec611[0] = fRec611[1] + 2.0 * (fTemp368 * fTemp506 / fTemp369);
			double fRec612 = fTemp371 * fTemp506 / fTemp369;
			double fTemp507 = fTemp373 * (fTemp488 - fRec614[1]) + fRec613[1];
			fRec613[0] = 2.0 * (fTemp507 / fTemp374) - fRec613[1];
			fRec614[0] = fRec614[1] + 2.0 * (fTemp373 * fTemp507 / fTemp374);
			double fRec615 = fTemp376 * fTemp507 / fTemp374;
			double fTemp508 = fTemp378 * (fTemp488 - fRec617[1]) + fRec616[1];
			fRec616[0] = 2.0 * (fTemp508 / fTemp379) - fRec616[1];
			fRec617[0] = fRec617[1] + 2.0 * (fTemp378 * fTemp508 / fTemp379);
			double fRec618 = fTemp381 * fTemp508 / fTemp379;
			double fTemp509 = fTemp384 * (fTemp488 - fRec620[1]) + fRec619[1];
			fRec619[0] = 2.0 * (fTemp509 / fTemp385) - fRec619[1];
			fRec620[0] = fRec620[1] + 2.0 * (fTemp384 * fTemp509 / fTemp385);
			double fRec621 = fTemp387 * fTemp509 / fTemp385;
			double fTemp510 = fTemp389 * (fTemp488 - fRec623[1]) + fRec622[1];
			fRec622[0] = 2.0 * (fTemp510 / fTemp390) - fRec622[1];
			fRec623[0] = fRec623[1] + 2.0 * (fTemp389 * fTemp510 / fTemp390);
			double fRec624 = fTemp392 * fTemp510 / fTemp390;
			double fTemp511 = fTemp394 * (fTemp488 - fRec626[1]) + fRec625[1];
			fRec625[0] = 2.0 * (fTemp511 / fTemp395) - fRec625[1];
			fRec626[0] = fRec626[1] + 2.0 * (fTemp394 * fTemp511 / fTemp395);
			double fRec627 = fTemp397 * fTemp511 / fTemp395;
			double fTemp512 = fTemp399 * (fTemp488 - fRec629[1]) + fRec628[1];
			fRec628[0] = 2.0 * (fTemp512 / fTemp400) - fRec628[1];
			fRec629[0] = fRec629[1] + 2.0 * (fTemp399 * fTemp512 / fTemp400);
			double fRec630 = fTemp402 * fTemp512 / fTemp400;
			double fTemp513 = fTemp404 * (fTemp488 - fRec632[1]) + fRec631[1];
			fRec631[0] = 2.0 * (fTemp513 / fTemp405) - fRec631[1];
			fRec632[0] = fRec632[1] + 2.0 * (fTemp404 * fTemp513 / fTemp405);
			double fRec633 = fTemp407 * fTemp513 / fTemp405;
			double fTemp514 = fTemp410 * (fTemp488 - fRec635[1]) + fRec634[1];
			fRec634[0] = 2.0 * (fTemp514 / fTemp411) - fRec634[1];
			fRec635[0] = fRec635[1] + 2.0 * (fTemp410 * fTemp514 / fTemp411);
			double fRec636 = fTemp413 * fTemp514 / fTemp411;
			double fTemp515 = fTemp415 * (fTemp488 - fRec638[1]) + fRec637[1];
			fRec637[0] = 2.0 * (fTemp515 / fTemp416) - fRec637[1];
			fRec638[0] = fRec638[1] + 2.0 * (fTemp415 * fTemp515 / fTemp416);
			double fRec639 = fTemp418 * fTemp515 / fTemp416;
			double fTemp516 = fTemp420 * (fTemp488 - fRec641[1]) + fRec640[1];
			fRec640[0] = 2.0 * (fTemp516 / fTemp421) - fRec640[1];
			fRec641[0] = fRec641[1] + 2.0 * (fTemp420 * fTemp516 / fTemp421);
			double fRec642 = fTemp423 * fTemp516 / fTemp421;
			double fTemp517 = fTemp425 * (fTemp488 - fRec644[1]) + fRec643[1];
			fRec643[0] = 2.0 * (fTemp517 / fTemp426) - fRec643[1];
			fRec644[0] = fRec644[1] + 2.0 * (fTemp425 * fTemp517 / fTemp426);
			double fRec645 = fTemp428 * fTemp517 / fTemp426;
			double fTemp518 = fTemp430 * (fTemp488 - fRec647[1]) + fRec646[1];
			fRec646[0] = 2.0 * (fTemp518 / fTemp431) - fRec646[1];
			fRec647[0] = fRec647[1] + 2.0 * (fTemp430 * fTemp518 / fTemp431);
			double fRec648 = fTemp433 * fTemp518 / fTemp431;
			double fTemp519 = fTemp435 * (fTemp488 - fRec650[1]) + fRec649[1];
			fRec649[0] = 2.0 * (fTemp519 / fTemp436) - fRec649[1];
			fRec650[0] = fRec650[1] + 2.0 * (fTemp435 * fTemp519 / fTemp436);
			double fRec651 = fTemp438 * fTemp519 / fTemp436;
			double fTemp520 = fTemp440 * (fTemp488 - fRec653[1]) + fRec652[1];
			fRec652[0] = 2.0 * (fTemp520 / fTemp441) - fRec652[1];
			fRec653[0] = fRec653[1] + 2.0 * (fTemp440 * fTemp520 / fTemp441);
			double fRec654 = fTemp443 * fTemp520 / fTemp441;
			double fTemp521 = 0.03125 * fRec132[0] * (fRec654 + fRec651 + fRec648 + fRec645 + fRec642 + fRec639 + fRec636 + fRec633 + fRec630 + fRec627 + fRec624 + fRec621 + fRec618 + fRec615 + fRec612 + fRec609 + fRec606 + fRec603 + fRec600 + fRec597 + fRec594 + fRec591 + fRec588 + fRec585 + fRec582 + fRec579 + fRec576 + fRec573 + fRec570 + fRec567 + fRec564 + fRec561) + fRec31[0] * fTemp488;
			fRec555[0] = std::max<double>(fConst1 * fRec555[1], std::fabs(fTemp521));
			fVbargraph23 = FAUSTFLOAT(fRec555[0]);
			fRec343[0] = fTemp521;
			double fTemp522 = (fRec343[0] + fRec341[0] + fRec342[0]) / fTemp0;
			fVec12[IOTA0 & 4194303] = fTemp522;
			double fTemp523 = ((fRec655[1] != 0.0) ? (((fRec656[1] > 0.0) & (fRec656[1] < 1.0)) ? fRec655[1] : 0.0) : (((fRec656[1] == 0.0) & (fSlow22 != fRec657[1])) ? 0.0009765625 : (((fRec656[1] == 1.0) & (fSlow22 != fRec658[1])) ? -0.0009765625 : 0.0)));
			fRec655[0] = fTemp523;
			fRec656[0] = std::max<double>(0.0, std::min<double>(1.0, fRec656[1] + fTemp523));
			fRec657[0] = (((fRec656[1] >= 1.0) & (fRec658[1] != fSlow22)) ? fSlow22 : fRec657[1]);
			fRec658[0] = (((fRec656[1] <= 0.0) & (fRec657[1] != fSlow22)) ? fSlow22 : fRec658[1]);
			double fTemp524 = fVec12[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec657[0])))) & 4194303];
			fRec340[0] = 0.3333333333333333 * fTemp524 + fRec656[0] * (0.0 - 0.3333333333333333 * (fTemp524 - fVec12[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec658[0])))) & 4194303]));
			fRec667[0] = fSlow23 + fConst3 * fRec667[1];
			fRec668[0] = fSlow24 + fConst3 * fRec668[1];
			fRec669[0] = fSlow25 + fConst3 * fRec669[1];
			double fTemp525 = fRec669[0] * (fRec668[0] * (0.0 - 33.0 * (1.0 - fRec667[0])) + 1.3e+02);
			double fTemp526 = std::tan(fConst6 * fTemp525);
			double fTemp527 = fTemp526 * (fTemp526 + fTemp15 / fTemp525) + 1.0;
			double fTemp528 = fRec21[0] * fRec660[1];
			fRec673[0] = std::max<double>(fConst1 * fRec673[1], std::fabs(fTemp528));
			fVbargraph24 = FAUSTFLOAT(fRec673[0]);
			double fTemp529 = fTemp528;
			double fTemp530 = fRec21[0] * fRec661[1];
			fRec674[0] = std::max<double>(fConst1 * fRec674[1], std::fabs(fTemp530));
			fVbargraph25 = FAUSTFLOAT(fRec674[0]);
			double fTemp531 = fTemp530;
			double fTemp532 = fTemp6 * (fTemp531 - fTemp529);
			double fTemp533 = fSlow26 * fRec6[1];
			fVec13[IOTA0 & 4194303] = fTemp533;
			double fTemp534 = ((fRec676[1] != 0.0) ? (((fRec677[1] > 0.0) & (fRec677[1] < 1.0)) ? fRec676[1] : 0.0) : (((fRec677[1] == 0.0) & (fSlow27 != fRec678[1])) ? 0.0009765625 : (((fRec677[1] == 1.0) & (fSlow27 != fRec679[1])) ? -0.0009765625 : 0.0)));
			fRec676[0] = fTemp534;
			fRec677[0] = std::max<double>(0.0, std::min<double>(1.0, fRec677[1] + fTemp534));
			fRec678[0] = (((fRec677[1] >= 1.0) & (fRec679[1] != fSlow27)) ? fSlow27 : fRec678[1]);
			fRec679[0] = (((fRec677[1] <= 0.0) & (fRec678[1] != fSlow27)) ? fSlow27 : fRec679[1]);
			double fTemp535 = fVec13[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec678[0])))) & 4194303];
			fRec675[0] = fTemp535 + fRec677[0] * (fVec13[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec679[0])))) & 4194303] - fTemp535);
			fVec14[0] = fTemp8 + fTemp529 + fRec675[1] + fTemp532 + fTemp1;
			fRec672[0] = fTemp532 + fTemp8 + fRec675[1] + 0.995 * fRec672[1] + fTemp529 + (1.2 - (fVec0[1] + fVec14[1]));
			fRec671[0] = std::max<double>(fConst1 * fRec671[1], std::fabs(fRec672[0]));
			fVbargraph26 = FAUSTFLOAT(fRec671[0]);
			double fTemp536 = fRec12[0] * tanh(fRec672[0] / fTemp0);
			fRec670[0] = std::max<double>(fConst1 * fRec670[1], std::fabs(fTemp536));
			fVbargraph27 = FAUSTFLOAT(fRec670[0]);
			double fTemp537 = fTemp536;
			double fTemp538 = fTemp526 * (fTemp537 - fRec665[1]) + fRec664[1];
			fRec664[0] = 2.0 * (fTemp538 / fTemp527) - fRec664[1];
			fRec665[0] = fRec665[1] + 2.0 * (fTemp526 * fTemp538 / fTemp527);
			double fTemp539 = 0.003792499999999999 * fRec667[0] + fRec668[0] * (0.10944208 - 0.11432047 * fRec667[0]) + 0.01216278;
			double fRec666 = fTemp538 * fTemp539 / fTemp527;
			double fTemp540 = 2637.0 * fRec667[0];
			double fTemp541 = fRec669[0] * (fRec668[0] * (4164.0 * fRec667[0] + -1314.0) + (8574.0 - fTemp540));
			double fTemp542 = std::tan(fConst6 * fTemp541);
			double fTemp543 = fTemp542 * (fTemp542 + fTemp15 / fTemp541) + 1.0;
			double fTemp544 = fTemp542 * (fTemp537 - fRec681[1]) + fRec680[1];
			fRec680[0] = 2.0 * (fTemp544 / fTemp543) - fRec680[1];
			fRec681[0] = fRec681[1] + 2.0 * (fTemp542 * fTemp544 / fTemp543);
			double fTemp545 = fRec668[0] * (0.01694164 - 0.021432509999999995 * fRec667[0]) + (0.00986048 - 0.0008017400000000004 * fRec667[0]);
			double fRec682 = fTemp544 * fTemp545 / fTemp543;
			double fTemp546 = fRec669[0] * (fRec668[0] * (4608.0 * fRec667[0] + -2856.0) + (7035.0 - fTemp540));
			double fTemp547 = std::tan(fConst6 * fTemp546);
			double fTemp548 = fTemp547 * (fTemp547 + fTemp15 / fTemp546) + 1.0;
			double fTemp549 = fTemp547 * (fTemp537 - fRec684[1]) + fRec683[1];
			fRec683[0] = 2.0 * (fTemp549 / fTemp548) - fRec683[1];
			fRec684[0] = fRec684[1] + 2.0 * (fTemp547 * fTemp549 / fTemp548);
			double fTemp550 = fRec668[0] * (0.002267030000000003 * fRec667[0] + 0.0020714199999999974) + (0.02237106 - 0.014284890000000001 * fRec667[0]);
			double fRec685 = fTemp549 * fTemp550 / fTemp548;
			double fTemp551 = 1538.0 * fRec667[0];
			double fTemp552 = fRec669[0] * (fRec668[0] * (fTemp551 + -1979.0) + (5496.0 - fTemp551));
			double fTemp553 = std::tan(fConst6 * fTemp552);
			double fTemp554 = fTemp553 * (fTemp553 + fTemp15 / fTemp552) + 1.0;
			double fTemp555 = fTemp553 * (fTemp537 - fRec687[1]) + fRec686[1];
			fRec686[0] = 2.0 * (fTemp555 / fTemp554) - fRec686[1];
			fRec687[0] = fRec687[1] + 2.0 * (fTemp553 * fTemp555 / fTemp554);
			double fTemp556 = 0.006774230000000001 * fRec667[0] + fRec668[0] * (0.10261458000000001 - 0.10685212000000001 * fRec667[0]) + 0.01369543;
			double fRec688 = fTemp555 * fTemp556 / fTemp554;
			double fTemp557 = fRec669[0] * (fRec668[0] * (1205.0 * fRec667[0] + -1538.0) + (4617.0 - 1099.0 * fRec667[0]));
			double fTemp558 = std::tan(fConst6 * fTemp557);
			double fTemp559 = fTemp558 * (fTemp558 + fTemp15 / fTemp557) + 1.0;
			double fTemp560 = fTemp558 * (fTemp537 - fRec690[1]) + fRec689[1];
			fRec689[0] = 2.0 * (fTemp560 / fTemp559) - fRec689[1];
			fRec690[0] = fRec690[1] + 2.0 * (fTemp558 * fTemp560 / fTemp559);
			double fTemp561 = 0.02699203 * fRec667[0] + fRec668[0] * (0.04665504 - 0.07662214 * fRec667[0]) + 0.00854136;
			double fRec691 = fTemp560 * fTemp561 / fTemp559;
			double fTemp562 = 878.0 * fRec667[0];
			double fTemp563 = fRec669[0] * (fRec668[0] * (871.0 * fRec667[0] + -1318.0) + (3957.0 - fTemp562));
			double fTemp564 = std::tan(fConst6 * fTemp563);
			double fTemp565 = fTemp564 * (fTemp564 + fTemp15 / fTemp563) + 1.0;
			double fTemp566 = fTemp564 * (fTemp537 - fRec693[1]) + fRec692[1];
			fRec692[0] = 2.0 * (fTemp566 / fTemp565) - fRec692[1];
			fRec693[0] = fRec693[1] + 2.0 * (fTemp564 * fTemp566 / fTemp565);
			double fTemp567 = 0.01252276 * fRec667[0] + fRec668[0] * (0.10869632000000001 - 0.09120969000000001 * fRec667[0]) + 0.01631748;
			double fRec694 = fTemp566 * fTemp567 / fTemp565;
			double fTemp568 = fRec669[0] * (fRec668[0] * (1.06e+03 * fRec667[0] + -1318.0) + (3517.0 - fTemp562));
			double fTemp569 = std::tan(fConst6 * fTemp568);
			double fTemp570 = fTemp569 * (fTemp569 + fTemp15 / fTemp568) + 1.0;
			double fTemp571 = fTemp569 * (fTemp537 - fRec696[1]) + fRec695[1];
			fRec695[0] = 2.0 * (fTemp571 / fTemp570) - fRec695[1];
			fRec696[0] = fRec696[1] + 2.0 * (fTemp569 * fTemp571 / fTemp570);
			double fTemp572 = 0.04926784000000001 * fRec667[0] + fRec668[0] * (0.54408778 - 0.61006677 * fRec667[0]) + 0.02061391;
			double fRec697 = fTemp571 * fTemp572 / fTemp570;
			double fTemp573 = fRec669[0] * (fRec668[0] * (1.08e+03 * fRec667[0] + -1319.0) + (3078.0 - 789.0 * fRec667[0]));
			double fTemp574 = std::tan(fConst6 * fTemp573);
			double fTemp575 = fTemp574 * (fTemp574 + fTemp15 / fTemp573) + 1.0;
			double fTemp576 = fTemp574 * (fTemp537 - fRec699[1]) + fRec698[1];
			fRec698[0] = 2.0 * (fTemp576 / fTemp575) - fRec698[1];
			fRec699[0] = fRec699[1] + 2.0 * (fTemp574 * fTemp576 / fTemp575);
			double fTemp577 = fRec668[0] * (0.07516669000000001 - 0.07834676 * fRec667[0]) + (0.01222045 - 0.0014069800000000004 * fRec667[0]);
			double fRec700 = fTemp576 * fTemp577 / fTemp575;
			double fTemp578 = 659.0 * fRec667[0];
			double fTemp579 = fRec669[0] * (fRec668[0] * (943.0 * fRec667[0] + -1167.0) + (2638.0 - fTemp578));
			double fTemp580 = std::tan(fConst6 * fTemp579);
			double fTemp581 = fTemp580 * (fTemp580 + fTemp15 / fTemp579) + 1.0;
			double fTemp582 = fTemp580 * (fTemp537 - fRec702[1]) + fRec701[1];
			fRec701[0] = 2.0 * (fTemp582 / fTemp581) - fRec701[1];
			fRec702[0] = fRec702[1] + 2.0 * (fTemp580 * fTemp582 / fTemp581);
			double fTemp583 = 0.006005980000000001 * fRec667[0] + fRec668[0] * (0.14227104000000002 * fRec667[0] + -0.017441090000000003) + 0.04759307;
			double fRec703 = fTemp582 * fTemp583 / fTemp581;
			double fTemp584 = fRec669[0] * (fRec668[0] * (744.0 * fRec667[0] + -882.0) + (2198.0 - 588.0 * fRec667[0]));
			double fTemp585 = std::tan(fConst6 * fTemp584);
			double fTemp586 = fTemp585 * (fTemp585 + fTemp15 / fTemp584) + 1.0;
			double fTemp587 = fTemp585 * (fTemp537 - fRec705[1]) + fRec704[1];
			fRec704[0] = 2.0 * (fTemp587 / fTemp586) - fRec704[1];
			fRec705[0] = fRec705[1] + 2.0 * (fTemp585 * fTemp587 / fTemp586);
			double fTemp588 = fRec668[0] * (0.07178015999999998 * fRec667[0] + -0.07126405) + (0.22375855 - 0.21313116 * fRec667[0]);
			double fRec706 = fTemp587 * fTemp588 / fTemp586;
			double fTemp589 = fRec669[0] * (fRec668[0] * (358.0 * fRec667[0] + -661.0) + (1759.0 - 287.0 * fRec667[0]));
			double fTemp590 = std::tan(fConst6 * fTemp589);
			double fTemp591 = fTemp590 * (fTemp590 + fTemp15 / fTemp589) + 1.0;
			double fTemp592 = fTemp590 * (fTemp537 - fRec708[1]) + fRec707[1];
			fRec707[0] = 2.0 * (fTemp592 / fTemp591) - fRec707[1];
			fRec708[0] = fRec708[1] + 2.0 * (fTemp590 * fTemp592 / fTemp591);
			double fTemp593 = fRec668[0] * (0.92661765 - 0.9297246 * fRec667[0]) + (0.07338235 - 0.06490082999999999 * fRec667[0]);
			double fRec709 = fTemp592 * fTemp593 / fTemp591;
			double fTemp594 = 2.2e+02 * fRec667[0];
			double fTemp595 = fRec669[0] * (fRec668[0] * (232.0 * fRec667[0] + -359.0) + (1319.0 - fTemp594));
			double fTemp596 = std::tan(fConst6 * fTemp595);
			double fTemp597 = fTemp596 * (fTemp596 + fTemp15 / fTemp595) + 1.0;
			double fTemp598 = fTemp596 * (fTemp537 - fRec711[1]) + fRec710[1];
			fRec710[0] = 2.0 * (fTemp598 / fTemp597) - fRec710[1];
			fRec711[0] = fRec711[1] + 2.0 * (fTemp596 * fTemp598 / fTemp597);
			double fTemp599 = 0.30503947000000003 * fRec667[0] + fRec668[0] * (-0.22500213 - 0.35131018 * fRec667[0]) + 0.27821024;
			double fRec712 = fTemp598 * fTemp599 / fTemp597;
			double fTemp600 = fRec669[0] * (fRec667[0] + fRec668[0] * (-115.0 - 6e+01 * fRec667[0]) + 879.0);
			double fTemp601 = std::tan(fConst6 * fTemp600);
			double fTemp602 = fTemp601 * (fTemp601 + fTemp15 / fTemp600) + 1.0;
			double fTemp603 = fTemp601 * (fTemp537 - fRec714[1]) + fRec713[1];
			fRec713[0] = 2.0 * (fTemp603 / fTemp602) - fRec713[1];
			fRec714[0] = fRec714[1] + 2.0 * (fTemp601 * fTemp603 / fTemp602);
			double fTemp604 = fRec668[0] * (0.00015622000000001246 * fRec667[0] + -0.36691775000000004) + (0.4053105 - 0.023941270000000014 * fRec667[0]);
			double fRec715 = fTemp603 * fTemp604 / fTemp602;
			double fTemp605 = fRec669[0] * (33.0 * fRec667[0] + fRec668[0] * (3.0 - 117.0 * fRec667[0]) + 538.0);
			double fTemp606 = std::tan(fConst6 * fTemp605);
			double fTemp607 = fTemp606 * (fTemp606 + fTemp15 / fTemp605) + 1.0;
			double fTemp608 = fTemp606 * (fTemp537 - fRec717[1]) + fRec716[1];
			fRec716[0] = 2.0 * (fTemp608 / fTemp607) - fRec716[1];
			fRec717[0] = fRec717[1] + 2.0 * (fTemp606 * fTemp608 / fTemp607);
			double fTemp609 = 0.001517609999999999 * fRec667[0] + fRec668[0] * (0.06630294 - 0.06758767 * fRec667[0]) + 0.00707754;
			double fRec718 = fTemp608 * fTemp609 / fTemp607;
			double fTemp610 = fRec669[0] * (2.0 * fRec667[0] + fRec668[0] * (-3.0 - 56.0 * fRec667[0]) + 368.0);
			double fTemp611 = std::tan(fConst6 * fTemp610);
			double fTemp612 = fTemp611 * (fTemp611 + fTemp15 / fTemp610) + 1.0;
			double fTemp613 = fTemp611 * (fTemp537 - fRec720[1]) + fRec719[1];
			fRec719[0] = 2.0 * (fTemp613 / fTemp612) - fRec719[1];
			fRec720[0] = fRec720[1] + 2.0 * (fTemp611 * fTemp613 / fTemp612);
			double fTemp614 = 0.004375260000000001 * fRec667[0] + fRec668[0] * (0.12435025999999999 - 0.13294609999999998 * fRec667[0]) + 0.01035828;
			double fRec721 = fTemp613 * fTemp614 / fTemp612;
			double fTemp615 = fRec669[0] * (2.2e+02 - 29.0 * fRec668[0]);
			double fTemp616 = std::tan(fConst6 * fTemp615);
			double fTemp617 = fTemp616 * (fTemp616 + fTemp15 / fTemp615) + 1.0;
			double fTemp618 = fTemp616 * (fTemp537 - fRec723[1]) + fRec722[1];
			fRec722[0] = 2.0 * (fTemp618 / fTemp617) - fRec722[1];
			fRec723[0] = fRec723[1] + 2.0 * (fTemp616 * fTemp618 / fTemp617);
			double fTemp619 = fRec668[0] * (-0.62251682 - 0.33358304 * fRec667[0]) + 1.0;
			double fRec724 = fTemp618 * fTemp619 / fTemp617;
			double fTemp620 = fRec668[0] * fRec667[0];
			double fTemp621 = fRec669[0] * (12.0 * fTemp620 + 5e+01);
			double fTemp622 = std::tan(fConst6 * fTemp621);
			double fTemp623 = fTemp622 * (fTemp622 + fTemp15 / fTemp621) + 1.0;
			double fTemp624 = fTemp622 * (fTemp537 - fRec726[1]) + fRec725[1];
			fRec725[0] = 2.0 * (fTemp624 / fTemp623) - fRec725[1];
			fRec726[0] = fRec726[1] + 2.0 * (fTemp622 * fTemp624 / fTemp623);
			double fTemp625 = fRec668[0] * (0.07282898 - 0.03932521 * fRec667[0]) + 0.01835863;
			double fRec727 = fTemp624 * fTemp625 / fTemp623;
			double fTemp626 = fRec669[0] * (fRec668[0] * (0.0 - 48.0 * fRec667[0]) + 309.0);
			double fTemp627 = std::tan(fConst6 * fTemp626);
			double fTemp628 = fTemp627 * (fTemp627 + fTemp15 / fTemp626) + 1.0;
			double fTemp629 = fTemp627 * (fTemp537 - fRec729[1]) + fRec728[1];
			fRec728[0] = 2.0 * (fTemp629 / fTemp628) - fRec728[1];
			fRec729[0] = fRec729[1] + 2.0 * (fTemp627 * fTemp629 / fTemp628);
			double fTemp630 = 0.0026099600000000006 * fTemp620 + 0.00749257;
			double fRec730 = fTemp629 * fTemp630 / fTemp628;
			double fTemp631 = fRec669[0] * (fRec667[0] + fRec668[0] * (1.0 - 71.0 * fRec667[0]) + 439.0);
			double fTemp632 = std::tan(fConst6 * fTemp631);
			double fTemp633 = fTemp632 * (fTemp632 + fTemp15 / fTemp631) + 1.0;
			double fTemp634 = fTemp632 * (fTemp537 - fRec732[1]) + fRec731[1];
			fRec731[0] = 2.0 * (fTemp634 / fTemp633) - fRec731[1];
			fRec732[0] = fRec732[1] + 2.0 * (fTemp632 * fTemp634 / fTemp633);
			double fTemp635 = 0.20472301000000004 * fRec667[0] + fRec668[0] * (-0.44281840999999994 - 0.40144216000000005 * fRec667[0]) + 0.6674602;
			double fRec733 = fTemp634 * fTemp635 / fTemp633;
			double fTemp636 = fRec669[0] * (fRec667[0] + fRec668[0] * (-1.0 - 122.0 * fRec667[0]) + 659.0);
			double fTemp637 = std::tan(fConst6 * fTemp636);
			double fTemp638 = fTemp637 * (fTemp637 + fTemp15 / fTemp636) + 1.0;
			double fTemp639 = fTemp637 * (fTemp537 - fRec735[1]) + fRec734[1];
			fRec734[0] = 2.0 * (fTemp639 / fTemp638) - fRec734[1];
			fRec735[0] = fRec735[1] + 2.0 * (fTemp637 * fTemp639 / fTemp638);
			double fTemp640 = fRec668[0] * (-0.09119557999999994 - 0.49022327 * fRec667[0]) + (0.62411215 - 0.03461038999999999 * fRec667[0]);
			double fRec736 = fTemp639 * fTemp640 / fTemp638;
			double fTemp641 = 137.0 * fRec667[0];
			double fTemp642 = fRec669[0] * (fRec668[0] * (fTemp641 + -221.0) + (1099.0 - fTemp641));
			double fTemp643 = std::tan(fConst6 * fTemp642);
			double fTemp644 = fTemp643 * (fTemp643 + fTemp15 / fTemp642) + 1.0;
			double fTemp645 = fTemp643 * (fTemp537 - fRec738[1]) + fRec737[1];
			fRec737[0] = 2.0 * (fTemp645 / fTemp644) - fRec737[1];
			fRec738[0] = fRec738[1] + 2.0 * (fTemp643 * fTemp645 / fTemp644);
			double fTemp646 = fRec668[0] * (1.27501065 * fRec667[0] + -0.28731595) + (0.64427134 - 0.63196604 * fRec667[0]);
			double fRec739 = fTemp645 * fTemp646 / fTemp644;
			double fTemp647 = fRec669[0] * (fRec668[0] * (327.0 * fRec667[0] + -529.0) + (1539.0 - fTemp594));
			double fTemp648 = std::tan(fConst6 * fTemp647);
			double fTemp649 = fTemp648 * (fTemp648 + fTemp15 / fTemp647) + 1.0;
			double fTemp650 = fTemp648 * (fTemp537 - fRec741[1]) + fRec740[1];
			fRec740[0] = 2.0 * (fTemp650 / fTemp649) - fRec740[1];
			fRec741[0] = fRec741[1] + 2.0 * (fTemp648 * fTemp650 / fTemp649);
			double fTemp651 = 0.28255792 * fRec667[0] + fRec668[0] * (-0.038845000000000005 - 0.32540112 * fRec667[0]) + 0.08982961;
			double fRec742 = fTemp650 * fTemp651 / fTemp649;
			double fTemp652 = fRec669[0] * (fRec668[0] * (4.5e+02 * fRec667[0] + -742.0) + (1978.0 - 439.0 * fRec667[0]));
			double fTemp653 = std::tan(fConst6 * fTemp652);
			double fTemp654 = fTemp653 * (fTemp653 + fTemp15 / fTemp652) + 1.0;
			double fTemp655 = fTemp653 * (fTemp537 - fRec744[1]) + fRec743[1];
			fRec743[0] = 2.0 * (fTemp655 / fTemp654) - fRec743[1];
			fRec744[0] = fRec744[1] + 2.0 * (fTemp653 * fTemp655 / fTemp654);
			double fTemp656 = 0.14846291 * fRec667[0] + fRec668[0] * (-0.00654018 - 0.17174218 * fRec667[0]) + 0.03442368;
			double fRec745 = fTemp655 * fTemp656 / fTemp654;
			double fTemp657 = fRec669[0] * (fRec668[0] * (924.0 * fRec667[0] + -987.0) + (2418.0 - 658.0 * fRec667[0]));
			double fTemp658 = std::tan(fConst6 * fTemp657);
			double fTemp659 = fTemp658 * (fTemp658 + fTemp15 / fTemp657) + 1.0;
			double fTemp660 = fTemp658 * (fTemp537 - fRec747[1]) + fRec746[1];
			fRec746[0] = 2.0 * (fTemp660 / fTemp659) - fRec746[1];
			fRec747[0] = fRec747[1] + 2.0 * (fTemp658 * fTemp660 / fTemp659);
			double fTemp661 = fRec668[0] * (0.01882346 * fRec667[0] + -0.0027897500000000006) + (0.02409027 - 0.01300287 * fRec667[0]);
			double fRec748 = fTemp660 * fTemp661 / fTemp659;
			double fTemp662 = fRec669[0] * (fRec668[0] * (1108.0 * fRec667[0] + -1324.0) + (2858.0 - fTemp578));
			double fTemp663 = std::tan(fConst6 * fTemp662);
			double fTemp664 = fTemp663 * (fTemp663 + fTemp15 / fTemp662) + 1.0;
			double fTemp665 = fTemp663 * (fTemp537 - fRec750[1]) + fRec749[1];
			fRec749[0] = 2.0 * (fTemp665 / fTemp664) - fRec749[1];
			fRec750[0] = fRec750[1] + 2.0 * (fTemp663 * fTemp665 / fTemp664);
			double fTemp666 = 0.27752175 * fRec667[0] + fRec668[0] * (0.007711639999999999 - 0.31944662 * fRec667[0]) + 0.03888326;
			double fRec751 = fTemp665 * fTemp666 / fTemp664;
			double fTemp667 = 879.0 * fRec667[0];
			double fTemp668 = fRec669[0] * (fRec668[0] * (1189.0 * fRec667[0] + -1321.0) + (3298.0 - fTemp667));
			double fTemp669 = std::tan(fConst6 * fTemp668);
			double fTemp670 = fTemp669 * (fTemp669 + fTemp15 / fTemp668) + 1.0;
			double fTemp671 = fTemp669 * (fTemp537 - fRec753[1]) + fRec752[1];
			fRec752[0] = 2.0 * (fTemp671 / fTemp670) - fRec752[1];
			fRec753[0] = fRec753[1] + 2.0 * (fTemp669 * fTemp671 / fTemp670);
			double fTemp672 = fRec668[0] * (0.1182356 - 0.13861138 * fRec667[0]) + (0.03283333 - 0.005876740000000002 * fRec667[0]);
			double fRec754 = fTemp671 * fTemp672 / fTemp670;
			double fTemp673 = fRec669[0] * (fRec668[0] * (1007.0 * fRec667[0] + -1.32e+03) + (3737.0 - fTemp562));
			double fTemp674 = std::tan(fConst6 * fTemp673);
			double fTemp675 = fTemp674 * (fTemp674 + fTemp15 / fTemp673) + 1.0;
			double fTemp676 = fTemp674 * (fTemp537 - fRec756[1]) + fRec755[1];
			fRec755[0] = 2.0 * (fTemp676 / fTemp675) - fRec755[1];
			fRec756[0] = fRec756[1] + 2.0 * (fTemp674 * fTemp676 / fTemp675);
			double fTemp677 = 0.02271603 * fRec667[0] + fRec668[0] * (0.11568920999999999 - 0.15871534999999998 * fRec667[0]) + 0.02601317;
			double fRec757 = fTemp676 * fTemp677 / fTemp675;
			double fTemp678 = fRec669[0] * (fRec668[0] * (835.0 * fRec667[0] + -1.32e+03) + (4177.0 - fTemp667));
			double fTemp679 = std::tan(fConst6 * fTemp678);
			double fTemp680 = fTemp679 * (fTemp679 + fTemp15 / fTemp678) + 1.0;
			double fTemp681 = fTemp679 * (fTemp537 - fRec759[1]) + fRec758[1];
			fRec758[0] = 2.0 * (fTemp681 / fTemp680) - fRec758[1];
			fRec759[0] = fRec759[1] + 2.0 * (fTemp679 * fTemp681 / fTemp680);
			double fTemp682 = 0.040329569999999995 * fRec667[0] + fRec668[0] * (0.06619388 - 0.11677492999999999 * fRec667[0]) + 0.01776269;
			double fRec760 = fTemp681 * fTemp682 / fTemp680;
			double fTemp683 = fRec669[0] * (fRec668[0] * (1268.0 * fRec667[0] + -1759.0) + (5056.0 - 1318.0 * fRec667[0]));
			double fTemp684 = std::tan(fConst6 * fTemp683);
			double fTemp685 = fTemp684 * (fTemp684 + fTemp15 / fTemp683) + 1.0;
			double fTemp686 = fTemp684 * (fTemp537 - fRec762[1]) + fRec761[1];
			fRec761[0] = 2.0 * (fTemp686 / fTemp685) - fRec761[1];
			fRec762[0] = fRec762[1] + 2.0 * (fTemp684 * fTemp686 / fTemp685);
			double fTemp687 = 0.03387651 * fRec667[0] + fRec668[0] * (0.04723798 - 0.09128072 * fRec667[0]) + 0.01528356;
			double fRec763 = fTemp686 * fTemp687 / fTemp685;
			double fTemp688 = fRec669[0] * (fRec668[0] * (2198.0 * fRec667[0] + -1981.0) + (5717.0 - 1539.0 * fRec667[0]));
			double fTemp689 = std::tan(fConst6 * fTemp688);
			double fTemp690 = fTemp689 * (fTemp689 + fTemp15 / fTemp688) + 1.0;
			double fTemp691 = fTemp689 * (fTemp537 - fRec765[1]) + fRec764[1];
			fRec764[0] = 2.0 * (fTemp691 / fTemp690) - fRec764[1];
			fRec765[0] = fRec765[1] + 2.0 * (fTemp689 * fTemp691 / fTemp690);
			double fTemp692 = 0.0159348 * fRec667[0] + fRec668[0] * (0.02239037 - 0.02813122 * fRec667[0]) + 0.00841917;
			double fRec766 = fTemp691 * fTemp692 / fTemp690;
			double fTemp693 = fRec669[0] * (fRec668[0] * (4811.0 * fRec667[0] + -1537.0) + (7255.0 - fTemp540));
			double fTemp694 = std::tan(fConst6 * fTemp693);
			double fTemp695 = fTemp694 * (fTemp694 + fTemp15 / fTemp693) + 1.0;
			double fTemp696 = fTemp694 * (fTemp537 - fRec768[1]) + fRec767[1];
			fRec767[0] = 2.0 * (fTemp696 / fTemp695) - fRec767[1];
			fRec768[0] = fRec768[1] + 2.0 * (fTemp694 * fTemp696 / fTemp695);
			double fTemp697 = fRec668[0] * (0.01286443 - 0.017049130000000003 * fRec667[0]) + (0.00969712 - 0.0011080199999999995 * fRec667[0]);
			double fRec769 = fTemp696 * fTemp697 / fTemp695;
			double fTemp698 = fRec669[0] * (fRec668[0] * (5481.0 * fRec667[0] + -1973.0) + (9672.0 - 3515.0 * fRec667[0]));
			double fTemp699 = std::tan(fConst6 * fTemp698);
			double fTemp700 = fTemp699 * (fTemp699 + fTemp15 / fTemp698) + 1.0;
			double fTemp701 = fTemp699 * (fTemp537 - fRec771[1]) + fRec770[1];
			fRec770[0] = 2.0 * (fTemp701 / fTemp700) - fRec770[1];
			fRec771[0] = fRec771[1] + 2.0 * (fTemp699 * fTemp701 / fTemp700);
			double fTemp702 = fRec668[0] * (0.028484340000000004 - 0.03413223 * fRec667[0]) + (0.01255551 - 0.0006110500000000001 * fRec667[0]);
			double fRec772 = fTemp701 * fTemp702 / fTemp700;
			double fTemp703 = fTemp537 * fRec31[0] + 0.03125 * fRec132[0] * (fRec772 + fRec769 + fRec766 + fRec763 + fRec760 + fRec757 + fRec754 + fRec751 + fRec748 + fRec745 + fRec742 + fRec739 + fRec736 + fRec733 + fRec730 + fRec727 + fRec724 + fRec721 + fRec718 + fRec715 + fRec712 + fRec709 + fRec706 + fRec703 + fRec700 + fRec697 + fRec694 + fRec691 + fRec688 + fRec685 + fRec682 + fRec666);
			fRec663[0] = std::max<double>(fConst1 * fRec663[1], std::fabs(fTemp703));
			fVbargraph28 = FAUSTFLOAT(fRec663[0]);
			fRec660[0] = fTemp703;
			double fTemp704 = fRec21[0] * fRec662[1];
			fRec777[0] = std::max<double>(fConst1 * fRec777[1], std::fabs(fTemp704));
			fVbargraph29 = FAUSTFLOAT(fRec777[0]);
			double fTemp705 = fTemp704;
			double fTemp706 = fRec23[0] * (fTemp529 * (fRec138[0] - fTemp705) - fTemp531);
			double fTemp707 = fRec675[1] + fTemp8;
			double fTemp708 = fTemp707 + fTemp531;
			fVec15[0] = fTemp708 + fTemp706 + fTemp184;
			fRec776[0] = fTemp706 + 0.995 * fRec776[1] + fTemp708 + (1.3 - (fVec3[1] + fVec15[1]));
			fRec775[0] = std::max<double>(fConst1 * fRec775[1], std::fabs(fRec776[0]));
			fVbargraph30 = FAUSTFLOAT(fRec775[0]);
			double fTemp709 = fRec12[0] * tanh(fRec776[0] / fTemp0);
			fRec774[0] = std::max<double>(fConst1 * fRec774[1], std::fabs(fTemp709));
			fVbargraph31 = FAUSTFLOAT(fRec774[0]);
			double fTemp710 = fTemp709;
			double fTemp711 = fTemp526 * (fTemp710 - fRec779[1]) + fRec778[1];
			fRec778[0] = 2.0 * (fTemp711 / fTemp527) - fRec778[1];
			fRec779[0] = fRec779[1] + 2.0 * (fTemp526 * fTemp711 / fTemp527);
			double fRec780 = fTemp539 * fTemp711 / fTemp527;
			double fTemp712 = fTemp542 * (fTemp710 - fRec782[1]) + fRec781[1];
			fRec781[0] = 2.0 * (fTemp712 / fTemp543) - fRec781[1];
			fRec782[0] = fRec782[1] + 2.0 * (fTemp542 * fTemp712 / fTemp543);
			double fRec783 = fTemp545 * fTemp712 / fTemp543;
			double fTemp713 = fTemp547 * (fTemp710 - fRec785[1]) + fRec784[1];
			fRec784[0] = 2.0 * (fTemp713 / fTemp548) - fRec784[1];
			fRec785[0] = fRec785[1] + 2.0 * (fTemp547 * fTemp713 / fTemp548);
			double fRec786 = fTemp550 * fTemp713 / fTemp548;
			double fTemp714 = fTemp553 * (fTemp710 - fRec788[1]) + fRec787[1];
			fRec787[0] = 2.0 * (fTemp714 / fTemp554) - fRec787[1];
			fRec788[0] = fRec788[1] + 2.0 * (fTemp553 * fTemp714 / fTemp554);
			double fRec789 = fTemp556 * fTemp714 / fTemp554;
			double fTemp715 = fTemp558 * (fTemp710 - fRec791[1]) + fRec790[1];
			fRec790[0] = 2.0 * (fTemp715 / fTemp559) - fRec790[1];
			fRec791[0] = fRec791[1] + 2.0 * (fTemp558 * fTemp715 / fTemp559);
			double fRec792 = fTemp561 * fTemp715 / fTemp559;
			double fTemp716 = fTemp564 * (fTemp710 - fRec794[1]) + fRec793[1];
			fRec793[0] = 2.0 * (fTemp716 / fTemp565) - fRec793[1];
			fRec794[0] = fRec794[1] + 2.0 * (fTemp564 * fTemp716 / fTemp565);
			double fRec795 = fTemp567 * fTemp716 / fTemp565;
			double fTemp717 = fTemp569 * (fTemp710 - fRec797[1]) + fRec796[1];
			fRec796[0] = 2.0 * (fTemp717 / fTemp570) - fRec796[1];
			fRec797[0] = fRec797[1] + 2.0 * (fTemp569 * fTemp717 / fTemp570);
			double fRec798 = fTemp572 * fTemp717 / fTemp570;
			double fTemp718 = fTemp574 * (fTemp710 - fRec800[1]) + fRec799[1];
			fRec799[0] = 2.0 * (fTemp718 / fTemp575) - fRec799[1];
			fRec800[0] = fRec800[1] + 2.0 * (fTemp574 * fTemp718 / fTemp575);
			double fRec801 = fTemp577 * fTemp718 / fTemp575;
			double fTemp719 = fTemp580 * (fTemp710 - fRec803[1]) + fRec802[1];
			fRec802[0] = 2.0 * (fTemp719 / fTemp581) - fRec802[1];
			fRec803[0] = fRec803[1] + 2.0 * (fTemp580 * fTemp719 / fTemp581);
			double fRec804 = fTemp583 * fTemp719 / fTemp581;
			double fTemp720 = fTemp585 * (fTemp710 - fRec806[1]) + fRec805[1];
			fRec805[0] = 2.0 * (fTemp720 / fTemp586) - fRec805[1];
			fRec806[0] = fRec806[1] + 2.0 * (fTemp585 * fTemp720 / fTemp586);
			double fRec807 = fTemp588 * fTemp720 / fTemp586;
			double fTemp721 = fTemp590 * (fTemp710 - fRec809[1]) + fRec808[1];
			fRec808[0] = 2.0 * (fTemp721 / fTemp591) - fRec808[1];
			fRec809[0] = fRec809[1] + 2.0 * (fTemp590 * fTemp721 / fTemp591);
			double fRec810 = fTemp593 * fTemp721 / fTemp591;
			double fTemp722 = fTemp596 * (fTemp710 - fRec812[1]) + fRec811[1];
			fRec811[0] = 2.0 * (fTemp722 / fTemp597) - fRec811[1];
			fRec812[0] = fRec812[1] + 2.0 * (fTemp596 * fTemp722 / fTemp597);
			double fRec813 = fTemp599 * fTemp722 / fTemp597;
			double fTemp723 = fTemp601 * (fTemp710 - fRec815[1]) + fRec814[1];
			fRec814[0] = 2.0 * (fTemp723 / fTemp602) - fRec814[1];
			fRec815[0] = fRec815[1] + 2.0 * (fTemp601 * fTemp723 / fTemp602);
			double fRec816 = fTemp604 * fTemp723 / fTemp602;
			double fTemp724 = fTemp606 * (fTemp710 - fRec818[1]) + fRec817[1];
			fRec817[0] = 2.0 * (fTemp724 / fTemp607) - fRec817[1];
			fRec818[0] = fRec818[1] + 2.0 * (fTemp606 * fTemp724 / fTemp607);
			double fRec819 = fTemp609 * fTemp724 / fTemp607;
			double fTemp725 = fTemp611 * (fTemp710 - fRec821[1]) + fRec820[1];
			fRec820[0] = 2.0 * (fTemp725 / fTemp612) - fRec820[1];
			fRec821[0] = fRec821[1] + 2.0 * (fTemp611 * fTemp725 / fTemp612);
			double fRec822 = fTemp614 * fTemp725 / fTemp612;
			double fTemp726 = fTemp616 * (fTemp710 - fRec824[1]) + fRec823[1];
			fRec823[0] = 2.0 * (fTemp726 / fTemp617) - fRec823[1];
			fRec824[0] = fRec824[1] + 2.0 * (fTemp616 * fTemp726 / fTemp617);
			double fRec825 = fTemp619 * fTemp726 / fTemp617;
			double fTemp727 = fTemp622 * (fTemp710 - fRec827[1]) + fRec826[1];
			fRec826[0] = 2.0 * (fTemp727 / fTemp623) - fRec826[1];
			fRec827[0] = fRec827[1] + 2.0 * (fTemp622 * fTemp727 / fTemp623);
			double fRec828 = fTemp625 * fTemp727 / fTemp623;
			double fTemp728 = fTemp627 * (fTemp710 - fRec830[1]) + fRec829[1];
			fRec829[0] = 2.0 * (fTemp728 / fTemp628) - fRec829[1];
			fRec830[0] = fRec830[1] + 2.0 * (fTemp627 * fTemp728 / fTemp628);
			double fRec831 = fTemp630 * fTemp728 / fTemp628;
			double fTemp729 = fTemp632 * (fTemp710 - fRec833[1]) + fRec832[1];
			fRec832[0] = 2.0 * (fTemp729 / fTemp633) - fRec832[1];
			fRec833[0] = fRec833[1] + 2.0 * (fTemp632 * fTemp729 / fTemp633);
			double fRec834 = fTemp635 * fTemp729 / fTemp633;
			double fTemp730 = fTemp637 * (fTemp710 - fRec836[1]) + fRec835[1];
			fRec835[0] = 2.0 * (fTemp730 / fTemp638) - fRec835[1];
			fRec836[0] = fRec836[1] + 2.0 * (fTemp637 * fTemp730 / fTemp638);
			double fRec837 = fTemp640 * fTemp730 / fTemp638;
			double fTemp731 = fTemp643 * (fTemp710 - fRec839[1]) + fRec838[1];
			fRec838[0] = 2.0 * (fTemp731 / fTemp644) - fRec838[1];
			fRec839[0] = fRec839[1] + 2.0 * (fTemp643 * fTemp731 / fTemp644);
			double fRec840 = fTemp646 * fTemp731 / fTemp644;
			double fTemp732 = fTemp648 * (fTemp710 - fRec842[1]) + fRec841[1];
			fRec841[0] = 2.0 * (fTemp732 / fTemp649) - fRec841[1];
			fRec842[0] = fRec842[1] + 2.0 * (fTemp648 * fTemp732 / fTemp649);
			double fRec843 = fTemp651 * fTemp732 / fTemp649;
			double fTemp733 = fTemp653 * (fTemp710 - fRec845[1]) + fRec844[1];
			fRec844[0] = 2.0 * (fTemp733 / fTemp654) - fRec844[1];
			fRec845[0] = fRec845[1] + 2.0 * (fTemp653 * fTemp733 / fTemp654);
			double fRec846 = fTemp656 * fTemp733 / fTemp654;
			double fTemp734 = fTemp658 * (fTemp710 - fRec848[1]) + fRec847[1];
			fRec847[0] = 2.0 * (fTemp734 / fTemp659) - fRec847[1];
			fRec848[0] = fRec848[1] + 2.0 * (fTemp658 * fTemp734 / fTemp659);
			double fRec849 = fTemp661 * fTemp734 / fTemp659;
			double fTemp735 = fTemp663 * (fTemp710 - fRec851[1]) + fRec850[1];
			fRec850[0] = 2.0 * (fTemp735 / fTemp664) - fRec850[1];
			fRec851[0] = fRec851[1] + 2.0 * (fTemp663 * fTemp735 / fTemp664);
			double fRec852 = fTemp666 * fTemp735 / fTemp664;
			double fTemp736 = fTemp669 * (fTemp710 - fRec854[1]) + fRec853[1];
			fRec853[0] = 2.0 * (fTemp736 / fTemp670) - fRec853[1];
			fRec854[0] = fRec854[1] + 2.0 * (fTemp669 * fTemp736 / fTemp670);
			double fRec855 = fTemp672 * fTemp736 / fTemp670;
			double fTemp737 = fTemp674 * (fTemp710 - fRec857[1]) + fRec856[1];
			fRec856[0] = 2.0 * (fTemp737 / fTemp675) - fRec856[1];
			fRec857[0] = fRec857[1] + 2.0 * (fTemp674 * fTemp737 / fTemp675);
			double fRec858 = fTemp677 * fTemp737 / fTemp675;
			double fTemp738 = fTemp679 * (fTemp710 - fRec860[1]) + fRec859[1];
			fRec859[0] = 2.0 * (fTemp738 / fTemp680) - fRec859[1];
			fRec860[0] = fRec860[1] + 2.0 * (fTemp679 * fTemp738 / fTemp680);
			double fRec861 = fTemp682 * fTemp738 / fTemp680;
			double fTemp739 = fTemp684 * (fTemp710 - fRec863[1]) + fRec862[1];
			fRec862[0] = 2.0 * (fTemp739 / fTemp685) - fRec862[1];
			fRec863[0] = fRec863[1] + 2.0 * (fTemp684 * fTemp739 / fTemp685);
			double fRec864 = fTemp687 * fTemp739 / fTemp685;
			double fTemp740 = fTemp689 * (fTemp710 - fRec866[1]) + fRec865[1];
			fRec865[0] = 2.0 * (fTemp740 / fTemp690) - fRec865[1];
			fRec866[0] = fRec866[1] + 2.0 * (fTemp689 * fTemp740 / fTemp690);
			double fRec867 = fTemp692 * fTemp740 / fTemp690;
			double fTemp741 = fTemp694 * (fTemp710 - fRec869[1]) + fRec868[1];
			fRec868[0] = 2.0 * (fTemp741 / fTemp695) - fRec868[1];
			fRec869[0] = fRec869[1] + 2.0 * (fTemp694 * fTemp741 / fTemp695);
			double fRec870 = fTemp697 * fTemp741 / fTemp695;
			double fTemp742 = fTemp699 * (fTemp710 - fRec872[1]) + fRec871[1];
			fRec871[0] = 2.0 * (fTemp742 / fTemp700) - fRec871[1];
			fRec872[0] = fRec872[1] + 2.0 * (fTemp699 * fTemp742 / fTemp700);
			double fRec873 = fTemp702 * fTemp742 / fTemp700;
			double fTemp743 = 0.03125 * fRec132[0] * (fRec873 + fRec870 + fRec867 + fRec864 + fRec861 + fRec858 + fRec855 + fRec852 + fRec849 + fRec846 + fRec843 + fRec840 + fRec837 + fRec834 + fRec831 + fRec828 + fRec825 + fRec822 + fRec819 + fRec816 + fRec813 + fRec810 + fRec807 + fRec804 + fRec801 + fRec798 + fRec795 + fRec792 + fRec789 + fRec786 + fRec783 + fRec780) + fRec31[0] * fTemp710;
			fRec773[0] = std::max<double>(fConst1 * fRec773[1], std::fabs(fTemp743));
			fVbargraph32 = FAUSTFLOAT(fRec773[0]);
			fRec661[0] = fTemp743;
			double fTemp744 = fRec23[0] * (fTemp529 * fTemp531 - fRec239[0] * fTemp705);
			double fTemp745 = fTemp707 + fTemp705;
			fVec16[0] = fTemp745 + fTemp744 + fTemp225;
			fRec877[0] = fTemp744 + 0.995 * fRec877[1] + fTemp745 + (1.6 - (fVec5[1] + fVec16[1]));
			fRec876[0] = std::max<double>(fConst1 * fRec876[1], std::fabs(fRec877[0]));
			fVbargraph33 = FAUSTFLOAT(fRec876[0]);
			double fTemp746 = fRec12[0] * tanh(fRec877[0] / fTemp0);
			fRec875[0] = std::max<double>(fConst1 * fRec875[1], std::fabs(fTemp746));
			fVbargraph34 = FAUSTFLOAT(fRec875[0]);
			double fTemp747 = fTemp746;
			double fTemp748 = fTemp526 * (fTemp747 - fRec879[1]) + fRec878[1];
			fRec878[0] = 2.0 * (fTemp748 / fTemp527) - fRec878[1];
			fRec879[0] = fRec879[1] + 2.0 * (fTemp526 * fTemp748 / fTemp527);
			double fRec880 = fTemp539 * fTemp748 / fTemp527;
			double fTemp749 = fTemp542 * (fTemp747 - fRec882[1]) + fRec881[1];
			fRec881[0] = 2.0 * (fTemp749 / fTemp543) - fRec881[1];
			fRec882[0] = fRec882[1] + 2.0 * (fTemp542 * fTemp749 / fTemp543);
			double fRec883 = fTemp545 * fTemp749 / fTemp543;
			double fTemp750 = fTemp547 * (fTemp747 - fRec885[1]) + fRec884[1];
			fRec884[0] = 2.0 * (fTemp750 / fTemp548) - fRec884[1];
			fRec885[0] = fRec885[1] + 2.0 * (fTemp547 * fTemp750 / fTemp548);
			double fRec886 = fTemp550 * fTemp750 / fTemp548;
			double fTemp751 = fTemp553 * (fTemp747 - fRec888[1]) + fRec887[1];
			fRec887[0] = 2.0 * (fTemp751 / fTemp554) - fRec887[1];
			fRec888[0] = fRec888[1] + 2.0 * (fTemp553 * fTemp751 / fTemp554);
			double fRec889 = fTemp556 * fTemp751 / fTemp554;
			double fTemp752 = fTemp558 * (fTemp747 - fRec891[1]) + fRec890[1];
			fRec890[0] = 2.0 * (fTemp752 / fTemp559) - fRec890[1];
			fRec891[0] = fRec891[1] + 2.0 * (fTemp558 * fTemp752 / fTemp559);
			double fRec892 = fTemp561 * fTemp752 / fTemp559;
			double fTemp753 = fTemp564 * (fTemp747 - fRec894[1]) + fRec893[1];
			fRec893[0] = 2.0 * (fTemp753 / fTemp565) - fRec893[1];
			fRec894[0] = fRec894[1] + 2.0 * (fTemp564 * fTemp753 / fTemp565);
			double fRec895 = fTemp567 * fTemp753 / fTemp565;
			double fTemp754 = fTemp569 * (fTemp747 - fRec897[1]) + fRec896[1];
			fRec896[0] = 2.0 * (fTemp754 / fTemp570) - fRec896[1];
			fRec897[0] = fRec897[1] + 2.0 * (fTemp569 * fTemp754 / fTemp570);
			double fRec898 = fTemp572 * fTemp754 / fTemp570;
			double fTemp755 = fTemp574 * (fTemp747 - fRec900[1]) + fRec899[1];
			fRec899[0] = 2.0 * (fTemp755 / fTemp575) - fRec899[1];
			fRec900[0] = fRec900[1] + 2.0 * (fTemp574 * fTemp755 / fTemp575);
			double fRec901 = fTemp577 * fTemp755 / fTemp575;
			double fTemp756 = fTemp580 * (fTemp747 - fRec903[1]) + fRec902[1];
			fRec902[0] = 2.0 * (fTemp756 / fTemp581) - fRec902[1];
			fRec903[0] = fRec903[1] + 2.0 * (fTemp580 * fTemp756 / fTemp581);
			double fRec904 = fTemp583 * fTemp756 / fTemp581;
			double fTemp757 = fTemp585 * (fTemp747 - fRec906[1]) + fRec905[1];
			fRec905[0] = 2.0 * (fTemp757 / fTemp586) - fRec905[1];
			fRec906[0] = fRec906[1] + 2.0 * (fTemp585 * fTemp757 / fTemp586);
			double fRec907 = fTemp588 * fTemp757 / fTemp586;
			double fTemp758 = fTemp590 * (fTemp747 - fRec909[1]) + fRec908[1];
			fRec908[0] = 2.0 * (fTemp758 / fTemp591) - fRec908[1];
			fRec909[0] = fRec909[1] + 2.0 * (fTemp590 * fTemp758 / fTemp591);
			double fRec910 = fTemp593 * fTemp758 / fTemp591;
			double fTemp759 = fTemp596 * (fTemp747 - fRec912[1]) + fRec911[1];
			fRec911[0] = 2.0 * (fTemp759 / fTemp597) - fRec911[1];
			fRec912[0] = fRec912[1] + 2.0 * (fTemp596 * fTemp759 / fTemp597);
			double fRec913 = fTemp599 * fTemp759 / fTemp597;
			double fTemp760 = fTemp601 * (fTemp747 - fRec915[1]) + fRec914[1];
			fRec914[0] = 2.0 * (fTemp760 / fTemp602) - fRec914[1];
			fRec915[0] = fRec915[1] + 2.0 * (fTemp601 * fTemp760 / fTemp602);
			double fRec916 = fTemp604 * fTemp760 / fTemp602;
			double fTemp761 = fTemp606 * (fTemp747 - fRec918[1]) + fRec917[1];
			fRec917[0] = 2.0 * (fTemp761 / fTemp607) - fRec917[1];
			fRec918[0] = fRec918[1] + 2.0 * (fTemp606 * fTemp761 / fTemp607);
			double fRec919 = fTemp609 * fTemp761 / fTemp607;
			double fTemp762 = fTemp611 * (fTemp747 - fRec921[1]) + fRec920[1];
			fRec920[0] = 2.0 * (fTemp762 / fTemp612) - fRec920[1];
			fRec921[0] = fRec921[1] + 2.0 * (fTemp611 * fTemp762 / fTemp612);
			double fRec922 = fTemp614 * fTemp762 / fTemp612;
			double fTemp763 = fTemp616 * (fTemp747 - fRec924[1]) + fRec923[1];
			fRec923[0] = 2.0 * (fTemp763 / fTemp617) - fRec923[1];
			fRec924[0] = fRec924[1] + 2.0 * (fTemp616 * fTemp763 / fTemp617);
			double fRec925 = fTemp619 * fTemp763 / fTemp617;
			double fTemp764 = fTemp622 * (fTemp747 - fRec927[1]) + fRec926[1];
			fRec926[0] = 2.0 * (fTemp764 / fTemp623) - fRec926[1];
			fRec927[0] = fRec927[1] + 2.0 * (fTemp622 * fTemp764 / fTemp623);
			double fRec928 = fTemp625 * fTemp764 / fTemp623;
			double fTemp765 = fTemp627 * (fTemp747 - fRec930[1]) + fRec929[1];
			fRec929[0] = 2.0 * (fTemp765 / fTemp628) - fRec929[1];
			fRec930[0] = fRec930[1] + 2.0 * (fTemp627 * fTemp765 / fTemp628);
			double fRec931 = fTemp630 * fTemp765 / fTemp628;
			double fTemp766 = fTemp632 * (fTemp747 - fRec933[1]) + fRec932[1];
			fRec932[0] = 2.0 * (fTemp766 / fTemp633) - fRec932[1];
			fRec933[0] = fRec933[1] + 2.0 * (fTemp632 * fTemp766 / fTemp633);
			double fRec934 = fTemp635 * fTemp766 / fTemp633;
			double fTemp767 = fTemp637 * (fTemp747 - fRec936[1]) + fRec935[1];
			fRec935[0] = 2.0 * (fTemp767 / fTemp638) - fRec935[1];
			fRec936[0] = fRec936[1] + 2.0 * (fTemp637 * fTemp767 / fTemp638);
			double fRec937 = fTemp640 * fTemp767 / fTemp638;
			double fTemp768 = fTemp643 * (fTemp747 - fRec939[1]) + fRec938[1];
			fRec938[0] = 2.0 * (fTemp768 / fTemp644) - fRec938[1];
			fRec939[0] = fRec939[1] + 2.0 * (fTemp643 * fTemp768 / fTemp644);
			double fRec940 = fTemp646 * fTemp768 / fTemp644;
			double fTemp769 = fTemp648 * (fTemp747 - fRec942[1]) + fRec941[1];
			fRec941[0] = 2.0 * (fTemp769 / fTemp649) - fRec941[1];
			fRec942[0] = fRec942[1] + 2.0 * (fTemp648 * fTemp769 / fTemp649);
			double fRec943 = fTemp651 * fTemp769 / fTemp649;
			double fTemp770 = fTemp653 * (fTemp747 - fRec945[1]) + fRec944[1];
			fRec944[0] = 2.0 * (fTemp770 / fTemp654) - fRec944[1];
			fRec945[0] = fRec945[1] + 2.0 * (fTemp653 * fTemp770 / fTemp654);
			double fRec946 = fTemp656 * fTemp770 / fTemp654;
			double fTemp771 = fTemp658 * (fTemp747 - fRec948[1]) + fRec947[1];
			fRec947[0] = 2.0 * (fTemp771 / fTemp659) - fRec947[1];
			fRec948[0] = fRec948[1] + 2.0 * (fTemp658 * fTemp771 / fTemp659);
			double fRec949 = fTemp661 * fTemp771 / fTemp659;
			double fTemp772 = fTemp663 * (fTemp747 - fRec951[1]) + fRec950[1];
			fRec950[0] = 2.0 * (fTemp772 / fTemp664) - fRec950[1];
			fRec951[0] = fRec951[1] + 2.0 * (fTemp663 * fTemp772 / fTemp664);
			double fRec952 = fTemp666 * fTemp772 / fTemp664;
			double fTemp773 = fTemp669 * (fTemp747 - fRec954[1]) + fRec953[1];
			fRec953[0] = 2.0 * (fTemp773 / fTemp670) - fRec953[1];
			fRec954[0] = fRec954[1] + 2.0 * (fTemp669 * fTemp773 / fTemp670);
			double fRec955 = fTemp672 * fTemp773 / fTemp670;
			double fTemp774 = fTemp674 * (fTemp747 - fRec957[1]) + fRec956[1];
			fRec956[0] = 2.0 * (fTemp774 / fTemp675) - fRec956[1];
			fRec957[0] = fRec957[1] + 2.0 * (fTemp674 * fTemp774 / fTemp675);
			double fRec958 = fTemp677 * fTemp774 / fTemp675;
			double fTemp775 = fTemp679 * (fTemp747 - fRec960[1]) + fRec959[1];
			fRec959[0] = 2.0 * (fTemp775 / fTemp680) - fRec959[1];
			fRec960[0] = fRec960[1] + 2.0 * (fTemp679 * fTemp775 / fTemp680);
			double fRec961 = fTemp682 * fTemp775 / fTemp680;
			double fTemp776 = fTemp684 * (fTemp747 - fRec963[1]) + fRec962[1];
			fRec962[0] = 2.0 * (fTemp776 / fTemp685) - fRec962[1];
			fRec963[0] = fRec963[1] + 2.0 * (fTemp684 * fTemp776 / fTemp685);
			double fRec964 = fTemp687 * fTemp776 / fTemp685;
			double fTemp777 = fTemp689 * (fTemp747 - fRec966[1]) + fRec965[1];
			fRec965[0] = 2.0 * (fTemp777 / fTemp690) - fRec965[1];
			fRec966[0] = fRec966[1] + 2.0 * (fTemp689 * fTemp777 / fTemp690);
			double fRec967 = fTemp692 * fTemp777 / fTemp690;
			double fTemp778 = fTemp694 * (fTemp747 - fRec969[1]) + fRec968[1];
			fRec968[0] = 2.0 * (fTemp778 / fTemp695) - fRec968[1];
			fRec969[0] = fRec969[1] + 2.0 * (fTemp694 * fTemp778 / fTemp695);
			double fRec970 = fTemp697 * fTemp778 / fTemp695;
			double fTemp779 = fTemp699 * (fTemp747 - fRec972[1]) + fRec971[1];
			fRec971[0] = 2.0 * (fTemp779 / fTemp700) - fRec971[1];
			fRec972[0] = fRec972[1] + 2.0 * (fTemp699 * fTemp779 / fTemp700);
			double fRec973 = fTemp702 * fTemp779 / fTemp700;
			double fTemp780 = 0.03125 * fRec132[0] * (fRec973 + fRec970 + fRec967 + fRec964 + fRec961 + fRec958 + fRec955 + fRec952 + fRec949 + fRec946 + fRec943 + fRec940 + fRec937 + fRec934 + fRec931 + fRec928 + fRec925 + fRec922 + fRec919 + fRec916 + fRec913 + fRec910 + fRec907 + fRec904 + fRec901 + fRec898 + fRec895 + fRec892 + fRec889 + fRec886 + fRec883 + fRec880) + fRec31[0] * fTemp747;
			fRec874[0] = std::max<double>(fConst1 * fRec874[1], std::fabs(fTemp780));
			fVbargraph35 = FAUSTFLOAT(fRec874[0]);
			fRec662[0] = fTemp780;
			double fTemp781 = (fRec662[0] + fRec660[0] + fRec661[0]) / fTemp0;
			fVec17[IOTA0 & 4194303] = fTemp781;
			double fTemp782 = ((fRec974[1] != 0.0) ? (((fRec975[1] > 0.0) & (fRec975[1] < 1.0)) ? fRec974[1] : 0.0) : (((fRec975[1] == 0.0) & (fSlow28 != fRec976[1])) ? 0.0009765625 : (((fRec975[1] == 1.0) & (fSlow28 != fRec977[1])) ? -0.0009765625 : 0.0)));
			fRec974[0] = fTemp782;
			fRec975[0] = std::max<double>(0.0, std::min<double>(1.0, fRec975[1] + fTemp782));
			fRec976[0] = (((fRec975[1] >= 1.0) & (fRec977[1] != fSlow28)) ? fSlow28 : fRec976[1]);
			fRec977[0] = (((fRec975[1] <= 0.0) & (fRec976[1] != fSlow28)) ? fSlow28 : fRec977[1]);
			double fTemp783 = fVec17[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec976[0])))) & 4194303];
			fRec659[0] = 0.3333333333333333 * fTemp783 + fRec975[0] * (0.0 - 0.3333333333333333 * (fTemp783 - fVec17[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec977[0])))) & 4194303]));
			double fTemp784 = fRec21[0] * fRec979[1];
			fRec986[0] = std::max<double>(fConst1 * fRec986[1], std::fabs(fTemp784));
			fVbargraph36 = FAUSTFLOAT(fRec986[0]);
			double fTemp785 = fTemp784;
			double fTemp786 = fRec21[0] * fRec980[1];
			fRec987[0] = std::max<double>(fConst1 * fRec987[1], std::fabs(fTemp786));
			fVbargraph37 = FAUSTFLOAT(fRec987[0]);
			double fTemp787 = fTemp786;
			double fTemp788 = fTemp6 * (fTemp787 - fTemp785);
			double fTemp789 = fSlow29 * fRec6[1];
			fVec18[IOTA0 & 4194303] = fTemp789;
			double fTemp790 = ((fRec989[1] != 0.0) ? (((fRec990[1] > 0.0) & (fRec990[1] < 1.0)) ? fRec989[1] : 0.0) : (((fRec990[1] == 0.0) & (fSlow30 != fRec991[1])) ? 0.0009765625 : (((fRec990[1] == 1.0) & (fSlow30 != fRec992[1])) ? -0.0009765625 : 0.0)));
			fRec989[0] = fTemp790;
			fRec990[0] = std::max<double>(0.0, std::min<double>(1.0, fRec990[1] + fTemp790));
			fRec991[0] = (((fRec990[1] >= 1.0) & (fRec992[1] != fSlow30)) ? fSlow30 : fRec991[1]);
			fRec992[0] = (((fRec990[1] <= 0.0) & (fRec991[1] != fSlow30)) ? fSlow30 : fRec992[1]);
			double fTemp791 = fVec18[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec991[0])))) & 4194303];
			fRec988[0] = fTemp791 + fRec990[0] * (fVec18[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec992[0])))) & 4194303] - fTemp791);
			fVec19[0] = fRec988[1] + fTemp8 + fTemp785 + fTemp788 + fTemp1;
			fRec985[0] = fTemp788 + fRec988[1] + fTemp785 + fTemp8 + 0.995 * fRec985[1] + (1.2 - (fVec0[1] + fVec19[1]));
			fRec984[0] = std::max<double>(fConst1 * fRec984[1], std::fabs(fRec985[0]));
			fVbargraph38 = FAUSTFLOAT(fRec984[0]);
			double fTemp792 = fRec12[0] * tanh(fRec985[0] / fTemp0);
			fRec983[0] = std::max<double>(fConst1 * fRec983[1], std::fabs(fTemp792));
			fVbargraph39 = FAUSTFLOAT(fRec983[0]);
			double fTemp793 = fTemp792;
			fRec996[0] = fSlow31 + fConst3 * fRec996[1];
			fRec997[0] = fSlow32 + fConst3 * fRec997[1];
			fRec998[0] = fSlow33 + fConst3 * fRec998[1];
			double fTemp794 = fRec998[0] * (fRec997[0] * (0.0 - 33.0 * (1.0 - fRec996[0])) + 1.3e+02);
			double fTemp795 = std::tan(fConst6 * fTemp794);
			double fTemp796 = fTemp795 * (fTemp795 + fTemp15 / fTemp794) + 1.0;
			double fTemp797 = fTemp795 * (fTemp793 - fRec994[1]) + fRec993[1];
			fRec993[0] = 2.0 * (fTemp797 / fTemp796) - fRec993[1];
			fRec994[0] = fRec994[1] + 2.0 * (fTemp795 * fTemp797 / fTemp796);
			double fTemp798 = 0.003792499999999999 * fRec996[0] + fRec997[0] * (0.10944208 - 0.11432047 * fRec996[0]) + 0.01216278;
			double fRec995 = fTemp797 * fTemp798 / fTemp796;
			double fTemp799 = 2637.0 * fRec996[0];
			double fTemp800 = fRec998[0] * (fRec997[0] * (4164.0 * fRec996[0] + -1314.0) + (8574.0 - fTemp799));
			double fTemp801 = std::tan(fConst6 * fTemp800);
			double fTemp802 = fTemp801 * (fTemp801 + fTemp15 / fTemp800) + 1.0;
			double fTemp803 = fTemp801 * (fTemp793 - fRec1000[1]) + fRec999[1];
			fRec999[0] = 2.0 * (fTemp803 / fTemp802) - fRec999[1];
			fRec1000[0] = fRec1000[1] + 2.0 * (fTemp801 * fTemp803 / fTemp802);
			double fTemp804 = fRec997[0] * (0.01694164 - 0.021432509999999995 * fRec996[0]) + (0.00986048 - 0.0008017400000000004 * fRec996[0]);
			double fRec1001 = fTemp803 * fTemp804 / fTemp802;
			double fTemp805 = fRec998[0] * (fRec997[0] * (4608.0 * fRec996[0] + -2856.0) + (7035.0 - fTemp799));
			double fTemp806 = std::tan(fConst6 * fTemp805);
			double fTemp807 = fTemp806 * (fTemp806 + fTemp15 / fTemp805) + 1.0;
			double fTemp808 = fTemp806 * (fTemp793 - fRec1003[1]) + fRec1002[1];
			fRec1002[0] = 2.0 * (fTemp808 / fTemp807) - fRec1002[1];
			fRec1003[0] = fRec1003[1] + 2.0 * (fTemp806 * fTemp808 / fTemp807);
			double fTemp809 = fRec997[0] * (0.002267030000000003 * fRec996[0] + 0.0020714199999999974) + (0.02237106 - 0.014284890000000001 * fRec996[0]);
			double fRec1004 = fTemp808 * fTemp809 / fTemp807;
			double fTemp810 = 1538.0 * fRec996[0];
			double fTemp811 = fRec998[0] * (fRec997[0] * (fTemp810 + -1979.0) + (5496.0 - fTemp810));
			double fTemp812 = std::tan(fConst6 * fTemp811);
			double fTemp813 = fTemp812 * (fTemp812 + fTemp15 / fTemp811) + 1.0;
			double fTemp814 = fTemp812 * (fTemp793 - fRec1006[1]) + fRec1005[1];
			fRec1005[0] = 2.0 * (fTemp814 / fTemp813) - fRec1005[1];
			fRec1006[0] = fRec1006[1] + 2.0 * (fTemp812 * fTemp814 / fTemp813);
			double fTemp815 = 0.006774230000000001 * fRec996[0] + fRec997[0] * (0.10261458000000001 - 0.10685212000000001 * fRec996[0]) + 0.01369543;
			double fRec1007 = fTemp814 * fTemp815 / fTemp813;
			double fTemp816 = fRec998[0] * (fRec997[0] * (1205.0 * fRec996[0] + -1538.0) + (4617.0 - 1099.0 * fRec996[0]));
			double fTemp817 = std::tan(fConst6 * fTemp816);
			double fTemp818 = fTemp817 * (fTemp817 + fTemp15 / fTemp816) + 1.0;
			double fTemp819 = fTemp817 * (fTemp793 - fRec1009[1]) + fRec1008[1];
			fRec1008[0] = 2.0 * (fTemp819 / fTemp818) - fRec1008[1];
			fRec1009[0] = fRec1009[1] + 2.0 * (fTemp817 * fTemp819 / fTemp818);
			double fTemp820 = 0.02699203 * fRec996[0] + fRec997[0] * (0.04665504 - 0.07662214 * fRec996[0]) + 0.00854136;
			double fRec1010 = fTemp819 * fTemp820 / fTemp818;
			double fTemp821 = 878.0 * fRec996[0];
			double fTemp822 = fRec998[0] * (fRec997[0] * (871.0 * fRec996[0] + -1318.0) + (3957.0 - fTemp821));
			double fTemp823 = std::tan(fConst6 * fTemp822);
			double fTemp824 = fTemp823 * (fTemp823 + fTemp15 / fTemp822) + 1.0;
			double fTemp825 = fTemp823 * (fTemp793 - fRec1012[1]) + fRec1011[1];
			fRec1011[0] = 2.0 * (fTemp825 / fTemp824) - fRec1011[1];
			fRec1012[0] = fRec1012[1] + 2.0 * (fTemp823 * fTemp825 / fTemp824);
			double fTemp826 = 0.01252276 * fRec996[0] + fRec997[0] * (0.10869632000000001 - 0.09120969000000001 * fRec996[0]) + 0.01631748;
			double fRec1013 = fTemp825 * fTemp826 / fTemp824;
			double fTemp827 = fRec998[0] * (fRec997[0] * (1.06e+03 * fRec996[0] + -1318.0) + (3517.0 - fTemp821));
			double fTemp828 = std::tan(fConst6 * fTemp827);
			double fTemp829 = fTemp828 * (fTemp828 + fTemp15 / fTemp827) + 1.0;
			double fTemp830 = fTemp828 * (fTemp793 - fRec1015[1]) + fRec1014[1];
			fRec1014[0] = 2.0 * (fTemp830 / fTemp829) - fRec1014[1];
			fRec1015[0] = fRec1015[1] + 2.0 * (fTemp828 * fTemp830 / fTemp829);
			double fTemp831 = 0.04926784000000001 * fRec996[0] + fRec997[0] * (0.54408778 - 0.61006677 * fRec996[0]) + 0.02061391;
			double fRec1016 = fTemp830 * fTemp831 / fTemp829;
			double fTemp832 = fRec998[0] * (fRec997[0] * (1.08e+03 * fRec996[0] + -1319.0) + (3078.0 - 789.0 * fRec996[0]));
			double fTemp833 = std::tan(fConst6 * fTemp832);
			double fTemp834 = fTemp833 * (fTemp833 + fTemp15 / fTemp832) + 1.0;
			double fTemp835 = fTemp833 * (fTemp793 - fRec1018[1]) + fRec1017[1];
			fRec1017[0] = 2.0 * (fTemp835 / fTemp834) - fRec1017[1];
			fRec1018[0] = fRec1018[1] + 2.0 * (fTemp833 * fTemp835 / fTemp834);
			double fTemp836 = fRec997[0] * (0.07516669000000001 - 0.07834676 * fRec996[0]) + (0.01222045 - 0.0014069800000000004 * fRec996[0]);
			double fRec1019 = fTemp835 * fTemp836 / fTemp834;
			double fTemp837 = 659.0 * fRec996[0];
			double fTemp838 = fRec998[0] * (fRec997[0] * (943.0 * fRec996[0] + -1167.0) + (2638.0 - fTemp837));
			double fTemp839 = std::tan(fConst6 * fTemp838);
			double fTemp840 = fTemp839 * (fTemp839 + fTemp15 / fTemp838) + 1.0;
			double fTemp841 = fTemp839 * (fTemp793 - fRec1021[1]) + fRec1020[1];
			fRec1020[0] = 2.0 * (fTemp841 / fTemp840) - fRec1020[1];
			fRec1021[0] = fRec1021[1] + 2.0 * (fTemp839 * fTemp841 / fTemp840);
			double fTemp842 = 0.006005980000000001 * fRec996[0] + fRec997[0] * (0.14227104000000002 * fRec996[0] + -0.017441090000000003) + 0.04759307;
			double fRec1022 = fTemp841 * fTemp842 / fTemp840;
			double fTemp843 = fRec998[0] * (fRec997[0] * (744.0 * fRec996[0] + -882.0) + (2198.0 - 588.0 * fRec996[0]));
			double fTemp844 = std::tan(fConst6 * fTemp843);
			double fTemp845 = fTemp844 * (fTemp844 + fTemp15 / fTemp843) + 1.0;
			double fTemp846 = fTemp844 * (fTemp793 - fRec1024[1]) + fRec1023[1];
			fRec1023[0] = 2.0 * (fTemp846 / fTemp845) - fRec1023[1];
			fRec1024[0] = fRec1024[1] + 2.0 * (fTemp844 * fTemp846 / fTemp845);
			double fTemp847 = fRec997[0] * (0.07178015999999998 * fRec996[0] + -0.07126405) + (0.22375855 - 0.21313116 * fRec996[0]);
			double fRec1025 = fTemp846 * fTemp847 / fTemp845;
			double fTemp848 = fRec998[0] * (fRec997[0] * (358.0 * fRec996[0] + -661.0) + (1759.0 - 287.0 * fRec996[0]));
			double fTemp849 = std::tan(fConst6 * fTemp848);
			double fTemp850 = fTemp849 * (fTemp849 + fTemp15 / fTemp848) + 1.0;
			double fTemp851 = fTemp849 * (fTemp793 - fRec1027[1]) + fRec1026[1];
			fRec1026[0] = 2.0 * (fTemp851 / fTemp850) - fRec1026[1];
			fRec1027[0] = fRec1027[1] + 2.0 * (fTemp849 * fTemp851 / fTemp850);
			double fTemp852 = fRec997[0] * (0.92661765 - 0.9297246 * fRec996[0]) + (0.07338235 - 0.06490082999999999 * fRec996[0]);
			double fRec1028 = fTemp851 * fTemp852 / fTemp850;
			double fTemp853 = 2.2e+02 * fRec996[0];
			double fTemp854 = fRec998[0] * (fRec997[0] * (232.0 * fRec996[0] + -359.0) + (1319.0 - fTemp853));
			double fTemp855 = std::tan(fConst6 * fTemp854);
			double fTemp856 = fTemp855 * (fTemp855 + fTemp15 / fTemp854) + 1.0;
			double fTemp857 = fTemp855 * (fTemp793 - fRec1030[1]) + fRec1029[1];
			fRec1029[0] = 2.0 * (fTemp857 / fTemp856) - fRec1029[1];
			fRec1030[0] = fRec1030[1] + 2.0 * (fTemp855 * fTemp857 / fTemp856);
			double fTemp858 = 0.30503947000000003 * fRec996[0] + fRec997[0] * (-0.22500213 - 0.35131018 * fRec996[0]) + 0.27821024;
			double fRec1031 = fTemp857 * fTemp858 / fTemp856;
			double fTemp859 = fRec998[0] * (fRec996[0] + fRec997[0] * (-115.0 - 6e+01 * fRec996[0]) + 879.0);
			double fTemp860 = std::tan(fConst6 * fTemp859);
			double fTemp861 = fTemp860 * (fTemp860 + fTemp15 / fTemp859) + 1.0;
			double fTemp862 = fTemp860 * (fTemp793 - fRec1033[1]) + fRec1032[1];
			fRec1032[0] = 2.0 * (fTemp862 / fTemp861) - fRec1032[1];
			fRec1033[0] = fRec1033[1] + 2.0 * (fTemp860 * fTemp862 / fTemp861);
			double fTemp863 = fRec997[0] * (0.00015622000000001246 * fRec996[0] + -0.36691775000000004) + (0.4053105 - 0.023941270000000014 * fRec996[0]);
			double fRec1034 = fTemp862 * fTemp863 / fTemp861;
			double fTemp864 = fRec998[0] * (33.0 * fRec996[0] + fRec997[0] * (3.0 - 117.0 * fRec996[0]) + 538.0);
			double fTemp865 = std::tan(fConst6 * fTemp864);
			double fTemp866 = fTemp865 * (fTemp865 + fTemp15 / fTemp864) + 1.0;
			double fTemp867 = fTemp865 * (fTemp793 - fRec1036[1]) + fRec1035[1];
			fRec1035[0] = 2.0 * (fTemp867 / fTemp866) - fRec1035[1];
			fRec1036[0] = fRec1036[1] + 2.0 * (fTemp865 * fTemp867 / fTemp866);
			double fTemp868 = 0.001517609999999999 * fRec996[0] + fRec997[0] * (0.06630294 - 0.06758767 * fRec996[0]) + 0.00707754;
			double fRec1037 = fTemp867 * fTemp868 / fTemp866;
			double fTemp869 = fRec998[0] * (2.0 * fRec996[0] + fRec997[0] * (-3.0 - 56.0 * fRec996[0]) + 368.0);
			double fTemp870 = std::tan(fConst6 * fTemp869);
			double fTemp871 = fTemp870 * (fTemp870 + fTemp15 / fTemp869) + 1.0;
			double fTemp872 = fTemp870 * (fTemp793 - fRec1039[1]) + fRec1038[1];
			fRec1038[0] = 2.0 * (fTemp872 / fTemp871) - fRec1038[1];
			fRec1039[0] = fRec1039[1] + 2.0 * (fTemp870 * fTemp872 / fTemp871);
			double fTemp873 = 0.004375260000000001 * fRec996[0] + fRec997[0] * (0.12435025999999999 - 0.13294609999999998 * fRec996[0]) + 0.01035828;
			double fRec1040 = fTemp872 * fTemp873 / fTemp871;
			double fTemp874 = fRec998[0] * (2.2e+02 - 29.0 * fRec997[0]);
			double fTemp875 = std::tan(fConst6 * fTemp874);
			double fTemp876 = fTemp875 * (fTemp875 + fTemp15 / fTemp874) + 1.0;
			double fTemp877 = fTemp875 * (fTemp793 - fRec1042[1]) + fRec1041[1];
			fRec1041[0] = 2.0 * (fTemp877 / fTemp876) - fRec1041[1];
			fRec1042[0] = fRec1042[1] + 2.0 * (fTemp875 * fTemp877 / fTemp876);
			double fTemp878 = fRec997[0] * (-0.62251682 - 0.33358304 * fRec996[0]) + 1.0;
			double fRec1043 = fTemp877 * fTemp878 / fTemp876;
			double fTemp879 = fRec997[0] * fRec996[0];
			double fTemp880 = fRec998[0] * (12.0 * fTemp879 + 5e+01);
			double fTemp881 = std::tan(fConst6 * fTemp880);
			double fTemp882 = fTemp881 * (fTemp881 + fTemp15 / fTemp880) + 1.0;
			double fTemp883 = fTemp881 * (fTemp793 - fRec1045[1]) + fRec1044[1];
			fRec1044[0] = 2.0 * (fTemp883 / fTemp882) - fRec1044[1];
			fRec1045[0] = fRec1045[1] + 2.0 * (fTemp881 * fTemp883 / fTemp882);
			double fTemp884 = fRec997[0] * (0.07282898 - 0.03932521 * fRec996[0]) + 0.01835863;
			double fRec1046 = fTemp883 * fTemp884 / fTemp882;
			double fTemp885 = fRec998[0] * (fRec997[0] * (0.0 - 48.0 * fRec996[0]) + 309.0);
			double fTemp886 = std::tan(fConst6 * fTemp885);
			double fTemp887 = fTemp886 * (fTemp886 + fTemp15 / fTemp885) + 1.0;
			double fTemp888 = fTemp886 * (fTemp793 - fRec1048[1]) + fRec1047[1];
			fRec1047[0] = 2.0 * (fTemp888 / fTemp887) - fRec1047[1];
			fRec1048[0] = fRec1048[1] + 2.0 * (fTemp886 * fTemp888 / fTemp887);
			double fTemp889 = 0.0026099600000000006 * fTemp879 + 0.00749257;
			double fRec1049 = fTemp888 * fTemp889 / fTemp887;
			double fTemp890 = fRec998[0] * (fRec996[0] + fRec997[0] * (1.0 - 71.0 * fRec996[0]) + 439.0);
			double fTemp891 = std::tan(fConst6 * fTemp890);
			double fTemp892 = fTemp891 * (fTemp891 + fTemp15 / fTemp890) + 1.0;
			double fTemp893 = fTemp891 * (fTemp793 - fRec1051[1]) + fRec1050[1];
			fRec1050[0] = 2.0 * (fTemp893 / fTemp892) - fRec1050[1];
			fRec1051[0] = fRec1051[1] + 2.0 * (fTemp891 * fTemp893 / fTemp892);
			double fTemp894 = 0.20472301000000004 * fRec996[0] + fRec997[0] * (-0.44281840999999994 - 0.40144216000000005 * fRec996[0]) + 0.6674602;
			double fRec1052 = fTemp893 * fTemp894 / fTemp892;
			double fTemp895 = fRec998[0] * (fRec996[0] + fRec997[0] * (-1.0 - 122.0 * fRec996[0]) + 659.0);
			double fTemp896 = std::tan(fConst6 * fTemp895);
			double fTemp897 = fTemp896 * (fTemp896 + fTemp15 / fTemp895) + 1.0;
			double fTemp898 = fTemp896 * (fTemp793 - fRec1054[1]) + fRec1053[1];
			fRec1053[0] = 2.0 * (fTemp898 / fTemp897) - fRec1053[1];
			fRec1054[0] = fRec1054[1] + 2.0 * (fTemp896 * fTemp898 / fTemp897);
			double fTemp899 = fRec997[0] * (-0.09119557999999994 - 0.49022327 * fRec996[0]) + (0.62411215 - 0.03461038999999999 * fRec996[0]);
			double fRec1055 = fTemp898 * fTemp899 / fTemp897;
			double fTemp900 = 137.0 * fRec996[0];
			double fTemp901 = fRec998[0] * (fRec997[0] * (fTemp900 + -221.0) + (1099.0 - fTemp900));
			double fTemp902 = std::tan(fConst6 * fTemp901);
			double fTemp903 = fTemp902 * (fTemp902 + fTemp15 / fTemp901) + 1.0;
			double fTemp904 = fTemp902 * (fTemp793 - fRec1057[1]) + fRec1056[1];
			fRec1056[0] = 2.0 * (fTemp904 / fTemp903) - fRec1056[1];
			fRec1057[0] = fRec1057[1] + 2.0 * (fTemp902 * fTemp904 / fTemp903);
			double fTemp905 = fRec997[0] * (1.27501065 * fRec996[0] + -0.28731595) + (0.64427134 - 0.63196604 * fRec996[0]);
			double fRec1058 = fTemp904 * fTemp905 / fTemp903;
			double fTemp906 = fRec998[0] * (fRec997[0] * (327.0 * fRec996[0] + -529.0) + (1539.0 - fTemp853));
			double fTemp907 = std::tan(fConst6 * fTemp906);
			double fTemp908 = fTemp907 * (fTemp907 + fTemp15 / fTemp906) + 1.0;
			double fTemp909 = fTemp907 * (fTemp793 - fRec1060[1]) + fRec1059[1];
			fRec1059[0] = 2.0 * (fTemp909 / fTemp908) - fRec1059[1];
			fRec1060[0] = fRec1060[1] + 2.0 * (fTemp907 * fTemp909 / fTemp908);
			double fTemp910 = 0.28255792 * fRec996[0] + fRec997[0] * (-0.038845000000000005 - 0.32540112 * fRec996[0]) + 0.08982961;
			double fRec1061 = fTemp909 * fTemp910 / fTemp908;
			double fTemp911 = fRec998[0] * (fRec997[0] * (4.5e+02 * fRec996[0] + -742.0) + (1978.0 - 439.0 * fRec996[0]));
			double fTemp912 = std::tan(fConst6 * fTemp911);
			double fTemp913 = fTemp912 * (fTemp912 + fTemp15 / fTemp911) + 1.0;
			double fTemp914 = fTemp912 * (fTemp793 - fRec1063[1]) + fRec1062[1];
			fRec1062[0] = 2.0 * (fTemp914 / fTemp913) - fRec1062[1];
			fRec1063[0] = fRec1063[1] + 2.0 * (fTemp912 * fTemp914 / fTemp913);
			double fTemp915 = 0.14846291 * fRec996[0] + fRec997[0] * (-0.00654018 - 0.17174218 * fRec996[0]) + 0.03442368;
			double fRec1064 = fTemp914 * fTemp915 / fTemp913;
			double fTemp916 = fRec998[0] * (fRec997[0] * (924.0 * fRec996[0] + -987.0) + (2418.0 - 658.0 * fRec996[0]));
			double fTemp917 = std::tan(fConst6 * fTemp916);
			double fTemp918 = fTemp917 * (fTemp917 + fTemp15 / fTemp916) + 1.0;
			double fTemp919 = fTemp917 * (fTemp793 - fRec1066[1]) + fRec1065[1];
			fRec1065[0] = 2.0 * (fTemp919 / fTemp918) - fRec1065[1];
			fRec1066[0] = fRec1066[1] + 2.0 * (fTemp917 * fTemp919 / fTemp918);
			double fTemp920 = fRec997[0] * (0.01882346 * fRec996[0] + -0.0027897500000000006) + (0.02409027 - 0.01300287 * fRec996[0]);
			double fRec1067 = fTemp919 * fTemp920 / fTemp918;
			double fTemp921 = fRec998[0] * (fRec997[0] * (1108.0 * fRec996[0] + -1324.0) + (2858.0 - fTemp837));
			double fTemp922 = std::tan(fConst6 * fTemp921);
			double fTemp923 = fTemp922 * (fTemp922 + fTemp15 / fTemp921) + 1.0;
			double fTemp924 = fTemp922 * (fTemp793 - fRec1069[1]) + fRec1068[1];
			fRec1068[0] = 2.0 * (fTemp924 / fTemp923) - fRec1068[1];
			fRec1069[0] = fRec1069[1] + 2.0 * (fTemp922 * fTemp924 / fTemp923);
			double fTemp925 = 0.27752175 * fRec996[0] + fRec997[0] * (0.007711639999999999 - 0.31944662 * fRec996[0]) + 0.03888326;
			double fRec1070 = fTemp924 * fTemp925 / fTemp923;
			double fTemp926 = 879.0 * fRec996[0];
			double fTemp927 = fRec998[0] * (fRec997[0] * (1189.0 * fRec996[0] + -1321.0) + (3298.0 - fTemp926));
			double fTemp928 = std::tan(fConst6 * fTemp927);
			double fTemp929 = fTemp928 * (fTemp928 + fTemp15 / fTemp927) + 1.0;
			double fTemp930 = fTemp928 * (fTemp793 - fRec1072[1]) + fRec1071[1];
			fRec1071[0] = 2.0 * (fTemp930 / fTemp929) - fRec1071[1];
			fRec1072[0] = fRec1072[1] + 2.0 * (fTemp928 * fTemp930 / fTemp929);
			double fTemp931 = fRec997[0] * (0.1182356 - 0.13861138 * fRec996[0]) + (0.03283333 - 0.005876740000000002 * fRec996[0]);
			double fRec1073 = fTemp930 * fTemp931 / fTemp929;
			double fTemp932 = fRec998[0] * (fRec997[0] * (1007.0 * fRec996[0] + -1.32e+03) + (3737.0 - fTemp821));
			double fTemp933 = std::tan(fConst6 * fTemp932);
			double fTemp934 = fTemp933 * (fTemp933 + fTemp15 / fTemp932) + 1.0;
			double fTemp935 = fTemp933 * (fTemp793 - fRec1075[1]) + fRec1074[1];
			fRec1074[0] = 2.0 * (fTemp935 / fTemp934) - fRec1074[1];
			fRec1075[0] = fRec1075[1] + 2.0 * (fTemp933 * fTemp935 / fTemp934);
			double fTemp936 = 0.02271603 * fRec996[0] + fRec997[0] * (0.11568920999999999 - 0.15871534999999998 * fRec996[0]) + 0.02601317;
			double fRec1076 = fTemp935 * fTemp936 / fTemp934;
			double fTemp937 = fRec998[0] * (fRec997[0] * (835.0 * fRec996[0] + -1.32e+03) + (4177.0 - fTemp926));
			double fTemp938 = std::tan(fConst6 * fTemp937);
			double fTemp939 = fTemp938 * (fTemp938 + fTemp15 / fTemp937) + 1.0;
			double fTemp940 = fTemp938 * (fTemp793 - fRec1078[1]) + fRec1077[1];
			fRec1077[0] = 2.0 * (fTemp940 / fTemp939) - fRec1077[1];
			fRec1078[0] = fRec1078[1] + 2.0 * (fTemp938 * fTemp940 / fTemp939);
			double fTemp941 = 0.040329569999999995 * fRec996[0] + fRec997[0] * (0.06619388 - 0.11677492999999999 * fRec996[0]) + 0.01776269;
			double fRec1079 = fTemp940 * fTemp941 / fTemp939;
			double fTemp942 = fRec998[0] * (fRec997[0] * (1268.0 * fRec996[0] + -1759.0) + (5056.0 - 1318.0 * fRec996[0]));
			double fTemp943 = std::tan(fConst6 * fTemp942);
			double fTemp944 = fTemp943 * (fTemp943 + fTemp15 / fTemp942) + 1.0;
			double fTemp945 = fTemp943 * (fTemp793 - fRec1081[1]) + fRec1080[1];
			fRec1080[0] = 2.0 * (fTemp945 / fTemp944) - fRec1080[1];
			fRec1081[0] = fRec1081[1] + 2.0 * (fTemp943 * fTemp945 / fTemp944);
			double fTemp946 = 0.03387651 * fRec996[0] + fRec997[0] * (0.04723798 - 0.09128072 * fRec996[0]) + 0.01528356;
			double fRec1082 = fTemp945 * fTemp946 / fTemp944;
			double fTemp947 = fRec998[0] * (fRec997[0] * (2198.0 * fRec996[0] + -1981.0) + (5717.0 - 1539.0 * fRec996[0]));
			double fTemp948 = std::tan(fConst6 * fTemp947);
			double fTemp949 = fTemp948 * (fTemp948 + fTemp15 / fTemp947) + 1.0;
			double fTemp950 = fTemp948 * (fTemp793 - fRec1084[1]) + fRec1083[1];
			fRec1083[0] = 2.0 * (fTemp950 / fTemp949) - fRec1083[1];
			fRec1084[0] = fRec1084[1] + 2.0 * (fTemp948 * fTemp950 / fTemp949);
			double fTemp951 = 0.0159348 * fRec996[0] + fRec997[0] * (0.02239037 - 0.02813122 * fRec996[0]) + 0.00841917;
			double fRec1085 = fTemp950 * fTemp951 / fTemp949;
			double fTemp952 = fRec998[0] * (fRec997[0] * (4811.0 * fRec996[0] + -1537.0) + (7255.0 - fTemp799));
			double fTemp953 = std::tan(fConst6 * fTemp952);
			double fTemp954 = fTemp953 * (fTemp953 + fTemp15 / fTemp952) + 1.0;
			double fTemp955 = fTemp953 * (fTemp793 - fRec1087[1]) + fRec1086[1];
			fRec1086[0] = 2.0 * (fTemp955 / fTemp954) - fRec1086[1];
			fRec1087[0] = fRec1087[1] + 2.0 * (fTemp953 * fTemp955 / fTemp954);
			double fTemp956 = fRec997[0] * (0.01286443 - 0.017049130000000003 * fRec996[0]) + (0.00969712 - 0.0011080199999999995 * fRec996[0]);
			double fRec1088 = fTemp955 * fTemp956 / fTemp954;
			double fTemp957 = fRec998[0] * (fRec997[0] * (5481.0 * fRec996[0] + -1973.0) + (9672.0 - 3515.0 * fRec996[0]));
			double fTemp958 = std::tan(fConst6 * fTemp957);
			double fTemp959 = fTemp958 * (fTemp958 + fTemp15 / fTemp957) + 1.0;
			double fTemp960 = fTemp958 * (fTemp793 - fRec1090[1]) + fRec1089[1];
			fRec1089[0] = 2.0 * (fTemp960 / fTemp959) - fRec1089[1];
			fRec1090[0] = fRec1090[1] + 2.0 * (fTemp958 * fTemp960 / fTemp959);
			double fTemp961 = fRec997[0] * (0.028484340000000004 - 0.03413223 * fRec996[0]) + (0.01255551 - 0.0006110500000000001 * fRec996[0]);
			double fRec1091 = fTemp960 * fTemp961 / fTemp959;
			double fTemp962 = 0.03125 * fRec132[0] * (fRec1091 + fRec1088 + fRec1085 + fRec1082 + fRec1079 + fRec1076 + fRec1073 + fRec1070 + fRec1067 + fRec1064 + fRec1061 + fRec1058 + fRec1055 + fRec1052 + fRec1049 + fRec1046 + fRec1043 + fRec1040 + fRec1037 + fRec1034 + fRec1031 + fRec1028 + fRec1025 + fRec1022 + fRec1019 + fRec1016 + fRec1013 + fRec1010 + fRec1007 + fRec1004 + fRec1001 + fRec995) + fRec31[0] * fTemp793;
			fRec982[0] = std::max<double>(fConst1 * fRec982[1], std::fabs(fTemp962));
			fVbargraph40 = FAUSTFLOAT(fRec982[0]);
			fRec979[0] = fTemp962;
			double fTemp963 = fRec21[0] * fRec981[1];
			fRec1096[0] = std::max<double>(fConst1 * fRec1096[1], std::fabs(fTemp963));
			fVbargraph41 = FAUSTFLOAT(fRec1096[0]);
			double fTemp964 = fTemp963;
			double fTemp965 = fRec23[0] * (fTemp785 * (fRec138[0] - fTemp964) - fTemp787);
			double fTemp966 = fTemp8 + fRec988[1];
			double fTemp967 = fTemp966 + fTemp787;
			fVec20[0] = fTemp967 + fTemp965 + fTemp184;
			fRec1095[0] = fTemp965 + 0.995 * fRec1095[1] + fTemp967 + (1.3 - (fVec3[1] + fVec20[1]));
			fRec1094[0] = std::max<double>(fConst1 * fRec1094[1], std::fabs(fRec1095[0]));
			fVbargraph42 = FAUSTFLOAT(fRec1094[0]);
			double fTemp968 = fRec12[0] * tanh(fRec1095[0] / fTemp0);
			fRec1093[0] = std::max<double>(fConst1 * fRec1093[1], std::fabs(fTemp968));
			fVbargraph43 = FAUSTFLOAT(fRec1093[0]);
			double fTemp969 = fTemp968;
			double fTemp970 = fTemp795 * (fTemp969 - fRec1098[1]) + fRec1097[1];
			fRec1097[0] = 2.0 * (fTemp970 / fTemp796) - fRec1097[1];
			fRec1098[0] = fRec1098[1] + 2.0 * (fTemp795 * fTemp970 / fTemp796);
			double fRec1099 = fTemp798 * fTemp970 / fTemp796;
			double fTemp971 = fTemp801 * (fTemp969 - fRec1101[1]) + fRec1100[1];
			fRec1100[0] = 2.0 * (fTemp971 / fTemp802) - fRec1100[1];
			fRec1101[0] = fRec1101[1] + 2.0 * (fTemp801 * fTemp971 / fTemp802);
			double fRec1102 = fTemp804 * fTemp971 / fTemp802;
			double fTemp972 = fTemp806 * (fTemp969 - fRec1104[1]) + fRec1103[1];
			fRec1103[0] = 2.0 * (fTemp972 / fTemp807) - fRec1103[1];
			fRec1104[0] = fRec1104[1] + 2.0 * (fTemp806 * fTemp972 / fTemp807);
			double fRec1105 = fTemp809 * fTemp972 / fTemp807;
			double fTemp973 = fTemp812 * (fTemp969 - fRec1107[1]) + fRec1106[1];
			fRec1106[0] = 2.0 * (fTemp973 / fTemp813) - fRec1106[1];
			fRec1107[0] = fRec1107[1] + 2.0 * (fTemp812 * fTemp973 / fTemp813);
			double fRec1108 = fTemp815 * fTemp973 / fTemp813;
			double fTemp974 = fTemp817 * (fTemp969 - fRec1110[1]) + fRec1109[1];
			fRec1109[0] = 2.0 * (fTemp974 / fTemp818) - fRec1109[1];
			fRec1110[0] = fRec1110[1] + 2.0 * (fTemp817 * fTemp974 / fTemp818);
			double fRec1111 = fTemp820 * fTemp974 / fTemp818;
			double fTemp975 = fTemp823 * (fTemp969 - fRec1113[1]) + fRec1112[1];
			fRec1112[0] = 2.0 * (fTemp975 / fTemp824) - fRec1112[1];
			fRec1113[0] = fRec1113[1] + 2.0 * (fTemp823 * fTemp975 / fTemp824);
			double fRec1114 = fTemp826 * fTemp975 / fTemp824;
			double fTemp976 = fTemp828 * (fTemp969 - fRec1116[1]) + fRec1115[1];
			fRec1115[0] = 2.0 * (fTemp976 / fTemp829) - fRec1115[1];
			fRec1116[0] = fRec1116[1] + 2.0 * (fTemp828 * fTemp976 / fTemp829);
			double fRec1117 = fTemp831 * fTemp976 / fTemp829;
			double fTemp977 = fTemp833 * (fTemp969 - fRec1119[1]) + fRec1118[1];
			fRec1118[0] = 2.0 * (fTemp977 / fTemp834) - fRec1118[1];
			fRec1119[0] = fRec1119[1] + 2.0 * (fTemp833 * fTemp977 / fTemp834);
			double fRec1120 = fTemp836 * fTemp977 / fTemp834;
			double fTemp978 = fTemp839 * (fTemp969 - fRec1122[1]) + fRec1121[1];
			fRec1121[0] = 2.0 * (fTemp978 / fTemp840) - fRec1121[1];
			fRec1122[0] = fRec1122[1] + 2.0 * (fTemp839 * fTemp978 / fTemp840);
			double fRec1123 = fTemp842 * fTemp978 / fTemp840;
			double fTemp979 = fTemp844 * (fTemp969 - fRec1125[1]) + fRec1124[1];
			fRec1124[0] = 2.0 * (fTemp979 / fTemp845) - fRec1124[1];
			fRec1125[0] = fRec1125[1] + 2.0 * (fTemp844 * fTemp979 / fTemp845);
			double fRec1126 = fTemp847 * fTemp979 / fTemp845;
			double fTemp980 = fTemp849 * (fTemp969 - fRec1128[1]) + fRec1127[1];
			fRec1127[0] = 2.0 * (fTemp980 / fTemp850) - fRec1127[1];
			fRec1128[0] = fRec1128[1] + 2.0 * (fTemp849 * fTemp980 / fTemp850);
			double fRec1129 = fTemp852 * fTemp980 / fTemp850;
			double fTemp981 = fTemp855 * (fTemp969 - fRec1131[1]) + fRec1130[1];
			fRec1130[0] = 2.0 * (fTemp981 / fTemp856) - fRec1130[1];
			fRec1131[0] = fRec1131[1] + 2.0 * (fTemp855 * fTemp981 / fTemp856);
			double fRec1132 = fTemp858 * fTemp981 / fTemp856;
			double fTemp982 = fTemp860 * (fTemp969 - fRec1134[1]) + fRec1133[1];
			fRec1133[0] = 2.0 * (fTemp982 / fTemp861) - fRec1133[1];
			fRec1134[0] = fRec1134[1] + 2.0 * (fTemp860 * fTemp982 / fTemp861);
			double fRec1135 = fTemp863 * fTemp982 / fTemp861;
			double fTemp983 = fTemp865 * (fTemp969 - fRec1137[1]) + fRec1136[1];
			fRec1136[0] = 2.0 * (fTemp983 / fTemp866) - fRec1136[1];
			fRec1137[0] = fRec1137[1] + 2.0 * (fTemp865 * fTemp983 / fTemp866);
			double fRec1138 = fTemp868 * fTemp983 / fTemp866;
			double fTemp984 = fTemp870 * (fTemp969 - fRec1140[1]) + fRec1139[1];
			fRec1139[0] = 2.0 * (fTemp984 / fTemp871) - fRec1139[1];
			fRec1140[0] = fRec1140[1] + 2.0 * (fTemp870 * fTemp984 / fTemp871);
			double fRec1141 = fTemp873 * fTemp984 / fTemp871;
			double fTemp985 = fTemp875 * (fTemp969 - fRec1143[1]) + fRec1142[1];
			fRec1142[0] = 2.0 * (fTemp985 / fTemp876) - fRec1142[1];
			fRec1143[0] = fRec1143[1] + 2.0 * (fTemp875 * fTemp985 / fTemp876);
			double fRec1144 = fTemp878 * fTemp985 / fTemp876;
			double fTemp986 = fTemp881 * (fTemp969 - fRec1146[1]) + fRec1145[1];
			fRec1145[0] = 2.0 * (fTemp986 / fTemp882) - fRec1145[1];
			fRec1146[0] = fRec1146[1] + 2.0 * (fTemp881 * fTemp986 / fTemp882);
			double fRec1147 = fTemp884 * fTemp986 / fTemp882;
			double fTemp987 = fTemp886 * (fTemp969 - fRec1149[1]) + fRec1148[1];
			fRec1148[0] = 2.0 * (fTemp987 / fTemp887) - fRec1148[1];
			fRec1149[0] = fRec1149[1] + 2.0 * (fTemp886 * fTemp987 / fTemp887);
			double fRec1150 = fTemp889 * fTemp987 / fTemp887;
			double fTemp988 = fTemp891 * (fTemp969 - fRec1152[1]) + fRec1151[1];
			fRec1151[0] = 2.0 * (fTemp988 / fTemp892) - fRec1151[1];
			fRec1152[0] = fRec1152[1] + 2.0 * (fTemp891 * fTemp988 / fTemp892);
			double fRec1153 = fTemp894 * fTemp988 / fTemp892;
			double fTemp989 = fTemp896 * (fTemp969 - fRec1155[1]) + fRec1154[1];
			fRec1154[0] = 2.0 * (fTemp989 / fTemp897) - fRec1154[1];
			fRec1155[0] = fRec1155[1] + 2.0 * (fTemp896 * fTemp989 / fTemp897);
			double fRec1156 = fTemp899 * fTemp989 / fTemp897;
			double fTemp990 = fTemp902 * (fTemp969 - fRec1158[1]) + fRec1157[1];
			fRec1157[0] = 2.0 * (fTemp990 / fTemp903) - fRec1157[1];
			fRec1158[0] = fRec1158[1] + 2.0 * (fTemp902 * fTemp990 / fTemp903);
			double fRec1159 = fTemp905 * fTemp990 / fTemp903;
			double fTemp991 = fTemp907 * (fTemp969 - fRec1161[1]) + fRec1160[1];
			fRec1160[0] = 2.0 * (fTemp991 / fTemp908) - fRec1160[1];
			fRec1161[0] = fRec1161[1] + 2.0 * (fTemp907 * fTemp991 / fTemp908);
			double fRec1162 = fTemp910 * fTemp991 / fTemp908;
			double fTemp992 = fTemp912 * (fTemp969 - fRec1164[1]) + fRec1163[1];
			fRec1163[0] = 2.0 * (fTemp992 / fTemp913) - fRec1163[1];
			fRec1164[0] = fRec1164[1] + 2.0 * (fTemp912 * fTemp992 / fTemp913);
			double fRec1165 = fTemp915 * fTemp992 / fTemp913;
			double fTemp993 = fTemp917 * (fTemp969 - fRec1167[1]) + fRec1166[1];
			fRec1166[0] = 2.0 * (fTemp993 / fTemp918) - fRec1166[1];
			fRec1167[0] = fRec1167[1] + 2.0 * (fTemp917 * fTemp993 / fTemp918);
			double fRec1168 = fTemp920 * fTemp993 / fTemp918;
			double fTemp994 = fTemp922 * (fTemp969 - fRec1170[1]) + fRec1169[1];
			fRec1169[0] = 2.0 * (fTemp994 / fTemp923) - fRec1169[1];
			fRec1170[0] = fRec1170[1] + 2.0 * (fTemp922 * fTemp994 / fTemp923);
			double fRec1171 = fTemp925 * fTemp994 / fTemp923;
			double fTemp995 = fTemp928 * (fTemp969 - fRec1173[1]) + fRec1172[1];
			fRec1172[0] = 2.0 * (fTemp995 / fTemp929) - fRec1172[1];
			fRec1173[0] = fRec1173[1] + 2.0 * (fTemp928 * fTemp995 / fTemp929);
			double fRec1174 = fTemp931 * fTemp995 / fTemp929;
			double fTemp996 = fTemp933 * (fTemp969 - fRec1176[1]) + fRec1175[1];
			fRec1175[0] = 2.0 * (fTemp996 / fTemp934) - fRec1175[1];
			fRec1176[0] = fRec1176[1] + 2.0 * (fTemp933 * fTemp996 / fTemp934);
			double fRec1177 = fTemp936 * fTemp996 / fTemp934;
			double fTemp997 = fTemp938 * (fTemp969 - fRec1179[1]) + fRec1178[1];
			fRec1178[0] = 2.0 * (fTemp997 / fTemp939) - fRec1178[1];
			fRec1179[0] = fRec1179[1] + 2.0 * (fTemp938 * fTemp997 / fTemp939);
			double fRec1180 = fTemp941 * fTemp997 / fTemp939;
			double fTemp998 = fTemp943 * (fTemp969 - fRec1182[1]) + fRec1181[1];
			fRec1181[0] = 2.0 * (fTemp998 / fTemp944) - fRec1181[1];
			fRec1182[0] = fRec1182[1] + 2.0 * (fTemp943 * fTemp998 / fTemp944);
			double fRec1183 = fTemp946 * fTemp998 / fTemp944;
			double fTemp999 = fTemp948 * (fTemp969 - fRec1185[1]) + fRec1184[1];
			fRec1184[0] = 2.0 * (fTemp999 / fTemp949) - fRec1184[1];
			fRec1185[0] = fRec1185[1] + 2.0 * (fTemp948 * fTemp999 / fTemp949);
			double fRec1186 = fTemp951 * fTemp999 / fTemp949;
			double fTemp1000 = fTemp953 * (fTemp969 - fRec1188[1]) + fRec1187[1];
			fRec1187[0] = 2.0 * (fTemp1000 / fTemp954) - fRec1187[1];
			fRec1188[0] = fRec1188[1] + 2.0 * (fTemp953 * fTemp1000 / fTemp954);
			double fRec1189 = fTemp956 * fTemp1000 / fTemp954;
			double fTemp1001 = fTemp958 * (fTemp969 - fRec1191[1]) + fRec1190[1];
			fRec1190[0] = 2.0 * (fTemp1001 / fTemp959) - fRec1190[1];
			fRec1191[0] = fRec1191[1] + 2.0 * (fTemp958 * fTemp1001 / fTemp959);
			double fRec1192 = fTemp961 * fTemp1001 / fTemp959;
			double fTemp1002 = 0.03125 * fRec132[0] * (fRec1192 + fRec1189 + fRec1186 + fRec1183 + fRec1180 + fRec1177 + fRec1174 + fRec1171 + fRec1168 + fRec1165 + fRec1162 + fRec1159 + fRec1156 + fRec1153 + fRec1150 + fRec1147 + fRec1144 + fRec1141 + fRec1138 + fRec1135 + fRec1132 + fRec1129 + fRec1126 + fRec1123 + fRec1120 + fRec1117 + fRec1114 + fRec1111 + fRec1108 + fRec1105 + fRec1102 + fRec1099) + fRec31[0] * fTemp969;
			fRec1092[0] = std::max<double>(fConst1 * fRec1092[1], std::fabs(fTemp1002));
			fVbargraph44 = FAUSTFLOAT(fRec1092[0]);
			fRec980[0] = fTemp1002;
			double fTemp1003 = fRec23[0] * (fTemp785 * fTemp787 - fRec239[0] * fTemp964);
			double fTemp1004 = fTemp966 + fTemp964;
			fVec21[0] = fTemp1004 + fTemp1003 + fTemp225;
			fRec1196[0] = fTemp1003 + 0.995 * fRec1196[1] + fTemp1004 + (1.6 - (fVec5[1] + fVec21[1]));
			fRec1195[0] = std::max<double>(fConst1 * fRec1195[1], std::fabs(fRec1196[0]));
			fVbargraph45 = FAUSTFLOAT(fRec1195[0]);
			double fTemp1005 = fRec12[0] * tanh(fRec1196[0] / fTemp0);
			fRec1194[0] = std::max<double>(fConst1 * fRec1194[1], std::fabs(fTemp1005));
			fVbargraph46 = FAUSTFLOAT(fRec1194[0]);
			double fTemp1006 = fTemp1005;
			double fTemp1007 = fTemp795 * (fTemp1006 - fRec1198[1]) + fRec1197[1];
			fRec1197[0] = 2.0 * (fTemp1007 / fTemp796) - fRec1197[1];
			fRec1198[0] = fRec1198[1] + 2.0 * (fTemp795 * fTemp1007 / fTemp796);
			double fRec1199 = fTemp798 * fTemp1007 / fTemp796;
			double fTemp1008 = fTemp801 * (fTemp1006 - fRec1201[1]) + fRec1200[1];
			fRec1200[0] = 2.0 * (fTemp1008 / fTemp802) - fRec1200[1];
			fRec1201[0] = fRec1201[1] + 2.0 * (fTemp801 * fTemp1008 / fTemp802);
			double fRec1202 = fTemp804 * fTemp1008 / fTemp802;
			double fTemp1009 = fTemp806 * (fTemp1006 - fRec1204[1]) + fRec1203[1];
			fRec1203[0] = 2.0 * (fTemp1009 / fTemp807) - fRec1203[1];
			fRec1204[0] = fRec1204[1] + 2.0 * (fTemp806 * fTemp1009 / fTemp807);
			double fRec1205 = fTemp809 * fTemp1009 / fTemp807;
			double fTemp1010 = fTemp812 * (fTemp1006 - fRec1207[1]) + fRec1206[1];
			fRec1206[0] = 2.0 * (fTemp1010 / fTemp813) - fRec1206[1];
			fRec1207[0] = fRec1207[1] + 2.0 * (fTemp812 * fTemp1010 / fTemp813);
			double fRec1208 = fTemp815 * fTemp1010 / fTemp813;
			double fTemp1011 = fTemp817 * (fTemp1006 - fRec1210[1]) + fRec1209[1];
			fRec1209[0] = 2.0 * (fTemp1011 / fTemp818) - fRec1209[1];
			fRec1210[0] = fRec1210[1] + 2.0 * (fTemp817 * fTemp1011 / fTemp818);
			double fRec1211 = fTemp820 * fTemp1011 / fTemp818;
			double fTemp1012 = fTemp823 * (fTemp1006 - fRec1213[1]) + fRec1212[1];
			fRec1212[0] = 2.0 * (fTemp1012 / fTemp824) - fRec1212[1];
			fRec1213[0] = fRec1213[1] + 2.0 * (fTemp823 * fTemp1012 / fTemp824);
			double fRec1214 = fTemp826 * fTemp1012 / fTemp824;
			double fTemp1013 = fTemp828 * (fTemp1006 - fRec1216[1]) + fRec1215[1];
			fRec1215[0] = 2.0 * (fTemp1013 / fTemp829) - fRec1215[1];
			fRec1216[0] = fRec1216[1] + 2.0 * (fTemp828 * fTemp1013 / fTemp829);
			double fRec1217 = fTemp831 * fTemp1013 / fTemp829;
			double fTemp1014 = fTemp833 * (fTemp1006 - fRec1219[1]) + fRec1218[1];
			fRec1218[0] = 2.0 * (fTemp1014 / fTemp834) - fRec1218[1];
			fRec1219[0] = fRec1219[1] + 2.0 * (fTemp833 * fTemp1014 / fTemp834);
			double fRec1220 = fTemp836 * fTemp1014 / fTemp834;
			double fTemp1015 = fTemp839 * (fTemp1006 - fRec1222[1]) + fRec1221[1];
			fRec1221[0] = 2.0 * (fTemp1015 / fTemp840) - fRec1221[1];
			fRec1222[0] = fRec1222[1] + 2.0 * (fTemp839 * fTemp1015 / fTemp840);
			double fRec1223 = fTemp842 * fTemp1015 / fTemp840;
			double fTemp1016 = fTemp844 * (fTemp1006 - fRec1225[1]) + fRec1224[1];
			fRec1224[0] = 2.0 * (fTemp1016 / fTemp845) - fRec1224[1];
			fRec1225[0] = fRec1225[1] + 2.0 * (fTemp844 * fTemp1016 / fTemp845);
			double fRec1226 = fTemp847 * fTemp1016 / fTemp845;
			double fTemp1017 = fTemp849 * (fTemp1006 - fRec1228[1]) + fRec1227[1];
			fRec1227[0] = 2.0 * (fTemp1017 / fTemp850) - fRec1227[1];
			fRec1228[0] = fRec1228[1] + 2.0 * (fTemp849 * fTemp1017 / fTemp850);
			double fRec1229 = fTemp852 * fTemp1017 / fTemp850;
			double fTemp1018 = fTemp855 * (fTemp1006 - fRec1231[1]) + fRec1230[1];
			fRec1230[0] = 2.0 * (fTemp1018 / fTemp856) - fRec1230[1];
			fRec1231[0] = fRec1231[1] + 2.0 * (fTemp855 * fTemp1018 / fTemp856);
			double fRec1232 = fTemp858 * fTemp1018 / fTemp856;
			double fTemp1019 = fTemp860 * (fTemp1006 - fRec1234[1]) + fRec1233[1];
			fRec1233[0] = 2.0 * (fTemp1019 / fTemp861) - fRec1233[1];
			fRec1234[0] = fRec1234[1] + 2.0 * (fTemp860 * fTemp1019 / fTemp861);
			double fRec1235 = fTemp863 * fTemp1019 / fTemp861;
			double fTemp1020 = fTemp865 * (fTemp1006 - fRec1237[1]) + fRec1236[1];
			fRec1236[0] = 2.0 * (fTemp1020 / fTemp866) - fRec1236[1];
			fRec1237[0] = fRec1237[1] + 2.0 * (fTemp865 * fTemp1020 / fTemp866);
			double fRec1238 = fTemp868 * fTemp1020 / fTemp866;
			double fTemp1021 = fTemp870 * (fTemp1006 - fRec1240[1]) + fRec1239[1];
			fRec1239[0] = 2.0 * (fTemp1021 / fTemp871) - fRec1239[1];
			fRec1240[0] = fRec1240[1] + 2.0 * (fTemp870 * fTemp1021 / fTemp871);
			double fRec1241 = fTemp873 * fTemp1021 / fTemp871;
			double fTemp1022 = fTemp875 * (fTemp1006 - fRec1243[1]) + fRec1242[1];
			fRec1242[0] = 2.0 * (fTemp1022 / fTemp876) - fRec1242[1];
			fRec1243[0] = fRec1243[1] + 2.0 * (fTemp875 * fTemp1022 / fTemp876);
			double fRec1244 = fTemp878 * fTemp1022 / fTemp876;
			double fTemp1023 = fTemp881 * (fTemp1006 - fRec1246[1]) + fRec1245[1];
			fRec1245[0] = 2.0 * (fTemp1023 / fTemp882) - fRec1245[1];
			fRec1246[0] = fRec1246[1] + 2.0 * (fTemp881 * fTemp1023 / fTemp882);
			double fRec1247 = fTemp884 * fTemp1023 / fTemp882;
			double fTemp1024 = fTemp886 * (fTemp1006 - fRec1249[1]) + fRec1248[1];
			fRec1248[0] = 2.0 * (fTemp1024 / fTemp887) - fRec1248[1];
			fRec1249[0] = fRec1249[1] + 2.0 * (fTemp886 * fTemp1024 / fTemp887);
			double fRec1250 = fTemp889 * fTemp1024 / fTemp887;
			double fTemp1025 = fTemp891 * (fTemp1006 - fRec1252[1]) + fRec1251[1];
			fRec1251[0] = 2.0 * (fTemp1025 / fTemp892) - fRec1251[1];
			fRec1252[0] = fRec1252[1] + 2.0 * (fTemp891 * fTemp1025 / fTemp892);
			double fRec1253 = fTemp894 * fTemp1025 / fTemp892;
			double fTemp1026 = fTemp896 * (fTemp1006 - fRec1255[1]) + fRec1254[1];
			fRec1254[0] = 2.0 * (fTemp1026 / fTemp897) - fRec1254[1];
			fRec1255[0] = fRec1255[1] + 2.0 * (fTemp896 * fTemp1026 / fTemp897);
			double fRec1256 = fTemp899 * fTemp1026 / fTemp897;
			double fTemp1027 = fTemp902 * (fTemp1006 - fRec1258[1]) + fRec1257[1];
			fRec1257[0] = 2.0 * (fTemp1027 / fTemp903) - fRec1257[1];
			fRec1258[0] = fRec1258[1] + 2.0 * (fTemp902 * fTemp1027 / fTemp903);
			double fRec1259 = fTemp905 * fTemp1027 / fTemp903;
			double fTemp1028 = fTemp907 * (fTemp1006 - fRec1261[1]) + fRec1260[1];
			fRec1260[0] = 2.0 * (fTemp1028 / fTemp908) - fRec1260[1];
			fRec1261[0] = fRec1261[1] + 2.0 * (fTemp907 * fTemp1028 / fTemp908);
			double fRec1262 = fTemp910 * fTemp1028 / fTemp908;
			double fTemp1029 = fTemp912 * (fTemp1006 - fRec1264[1]) + fRec1263[1];
			fRec1263[0] = 2.0 * (fTemp1029 / fTemp913) - fRec1263[1];
			fRec1264[0] = fRec1264[1] + 2.0 * (fTemp912 * fTemp1029 / fTemp913);
			double fRec1265 = fTemp915 * fTemp1029 / fTemp913;
			double fTemp1030 = fTemp917 * (fTemp1006 - fRec1267[1]) + fRec1266[1];
			fRec1266[0] = 2.0 * (fTemp1030 / fTemp918) - fRec1266[1];
			fRec1267[0] = fRec1267[1] + 2.0 * (fTemp917 * fTemp1030 / fTemp918);
			double fRec1268 = fTemp920 * fTemp1030 / fTemp918;
			double fTemp1031 = fTemp922 * (fTemp1006 - fRec1270[1]) + fRec1269[1];
			fRec1269[0] = 2.0 * (fTemp1031 / fTemp923) - fRec1269[1];
			fRec1270[0] = fRec1270[1] + 2.0 * (fTemp922 * fTemp1031 / fTemp923);
			double fRec1271 = fTemp925 * fTemp1031 / fTemp923;
			double fTemp1032 = fTemp928 * (fTemp1006 - fRec1273[1]) + fRec1272[1];
			fRec1272[0] = 2.0 * (fTemp1032 / fTemp929) - fRec1272[1];
			fRec1273[0] = fRec1273[1] + 2.0 * (fTemp928 * fTemp1032 / fTemp929);
			double fRec1274 = fTemp931 * fTemp1032 / fTemp929;
			double fTemp1033 = fTemp933 * (fTemp1006 - fRec1276[1]) + fRec1275[1];
			fRec1275[0] = 2.0 * (fTemp1033 / fTemp934) - fRec1275[1];
			fRec1276[0] = fRec1276[1] + 2.0 * (fTemp933 * fTemp1033 / fTemp934);
			double fRec1277 = fTemp936 * fTemp1033 / fTemp934;
			double fTemp1034 = fTemp938 * (fTemp1006 - fRec1279[1]) + fRec1278[1];
			fRec1278[0] = 2.0 * (fTemp1034 / fTemp939) - fRec1278[1];
			fRec1279[0] = fRec1279[1] + 2.0 * (fTemp938 * fTemp1034 / fTemp939);
			double fRec1280 = fTemp941 * fTemp1034 / fTemp939;
			double fTemp1035 = fTemp943 * (fTemp1006 - fRec1282[1]) + fRec1281[1];
			fRec1281[0] = 2.0 * (fTemp1035 / fTemp944) - fRec1281[1];
			fRec1282[0] = fRec1282[1] + 2.0 * (fTemp943 * fTemp1035 / fTemp944);
			double fRec1283 = fTemp946 * fTemp1035 / fTemp944;
			double fTemp1036 = fTemp948 * (fTemp1006 - fRec1285[1]) + fRec1284[1];
			fRec1284[0] = 2.0 * (fTemp1036 / fTemp949) - fRec1284[1];
			fRec1285[0] = fRec1285[1] + 2.0 * (fTemp948 * fTemp1036 / fTemp949);
			double fRec1286 = fTemp951 * fTemp1036 / fTemp949;
			double fTemp1037 = fTemp953 * (fTemp1006 - fRec1288[1]) + fRec1287[1];
			fRec1287[0] = 2.0 * (fTemp1037 / fTemp954) - fRec1287[1];
			fRec1288[0] = fRec1288[1] + 2.0 * (fTemp953 * fTemp1037 / fTemp954);
			double fRec1289 = fTemp956 * fTemp1037 / fTemp954;
			double fTemp1038 = fTemp958 * (fTemp1006 - fRec1291[1]) + fRec1290[1];
			fRec1290[0] = 2.0 * (fTemp1038 / fTemp959) - fRec1290[1];
			fRec1291[0] = fRec1291[1] + 2.0 * (fTemp958 * fTemp1038 / fTemp959);
			double fRec1292 = fTemp961 * fTemp1038 / fTemp959;
			double fTemp1039 = 0.03125 * fRec132[0] * (fRec1292 + fRec1289 + fRec1286 + fRec1283 + fRec1280 + fRec1277 + fRec1274 + fRec1271 + fRec1268 + fRec1265 + fRec1262 + fRec1259 + fRec1256 + fRec1253 + fRec1250 + fRec1247 + fRec1244 + fRec1241 + fRec1238 + fRec1235 + fRec1232 + fRec1229 + fRec1226 + fRec1223 + fRec1220 + fRec1217 + fRec1214 + fRec1211 + fRec1208 + fRec1205 + fRec1202 + fRec1199) + fRec31[0] * fTemp1006;
			fRec1193[0] = std::max<double>(fConst1 * fRec1193[1], std::fabs(fTemp1039));
			fVbargraph47 = FAUSTFLOAT(fRec1193[0]);
			fRec981[0] = fTemp1039;
			double fTemp1040 = (fRec981[0] + fRec979[0] + fRec980[0]) / fTemp0;
			fVec22[IOTA0 & 4194303] = fTemp1040;
			double fTemp1041 = ((fRec1293[1] != 0.0) ? (((fRec1294[1] > 0.0) & (fRec1294[1] < 1.0)) ? fRec1293[1] : 0.0) : (((fRec1294[1] == 0.0) & (fSlow34 != fRec1295[1])) ? 0.0009765625 : (((fRec1294[1] == 1.0) & (fSlow34 != fRec1296[1])) ? -0.0009765625 : 0.0)));
			fRec1293[0] = fTemp1041;
			fRec1294[0] = std::max<double>(0.0, std::min<double>(1.0, fRec1294[1] + fTemp1041));
			...
			double fTemp1042 = fVec22[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec1295[0])))) & 4194303];
			fRec978[0] = 0.3333333333333333 * fTemp1042 + fRec1294[0] * (0.0 - 0.3333333333333333 * (fTemp1042 - fVec22[(IOTA0 - int(std::min<double>(fConst5, std::max<double>(0.0, fRec1296[0])))) & 4194303]));
			fRec6[0] = 0.25 * (fRec978[1] + fRec659[1] + fRec340[1] + fRec11[1]);
			fRec7[0] = 0.3333333333333333 * fTemp781;
			fRec8[0] = 0.3333333333333333 * fTemp263;
			fRec9[0] = 0.3333333333333333 * fTemp522;
			fRec10[0] = 0.3333333333333333 * fTemp1040;
			fRec5[IOTA0 & 511] = fRec7[0] + 0.995 * fRec5[(IOTA0 - 1) & 511] - fRec7[1];
			double fTemp1043 = std::fabs(fRec5[IOTA0 & 511]);
			int iTemp1044 = (fTemp1043 >= fRec4[1]) | (double(iRec3[1]) >= fConst2);
			iRec3[0] = ((iTemp1044) ? 0 : iRec3[1] + 1);
			fRec4[0] = ((iTemp1044) ? fTemp1043 : fRec4[1]);
			double fTemp1045 = fRec4[0] - fRec1[1];
			fRec1[0] = fRec1[1] + fConst9 * fTemp1045;
			double fTemp1046 = fRec1[1] + fConst8 * fTemp1045;
			double fRec2 = fTemp1046;
			...
			double fTemp1047 = std::fabs(fRec1303[IOTA0 & 511]);
			int iTemp1048 = (fTemp1047 >= fRec1302[1]) | (double(iRec1301[1]) >= fConst2);
			iRec1301[0] = ((iTemp1048) ? 0 : iRec1301[1] + 1);
			fRec1302[0] = ((iTemp1048) ? fTemp1047 : fRec1302[1]);
			double fTemp1049 = fRec1302[0] - fRec1299[1];
			fRec1299[0] = fRec1299[1] + fConst9 * fTemp1049;
			double fTemp1050 = fRec1299[1] + fConst8 * fTemp1049;
			double fRec1300 = fTemp1050;
			...
			double fTemp1051 = std::fabs(fRec1309[IOTA0 & 511]);
			int iTemp1052 = (fTemp1051 >= fRec1308[1]) | (double(iRec1307[1]) >= fConst2);
			iRec1307[0] = ((iTemp1052) ? 0 : iRec1307[1] + 1);
			fRec1308[0] = ((iTemp1052) ? fTemp1051 : fRec1308[1]);
			double fTemp1053 = fRec1308[0] - fRec1305[1];
			fRec1305[0] = fRec1305[1] + fConst9 * fTemp1053;
			double fTemp1054 = fRec1305[1] + fConst8 * fTemp1053;
			double fRec1306 = fTemp1054;
			...
			double fTemp1055 = std::fabs(fRec1315[IOTA0 & 511]);
			int iTemp1056 = (fTemp1055 >= fRec1314[1]) | (double(iRec1313[1]) >= fConst2);
			iRec1313[0] = ((iTemp1056) ? 0 : iRec1313[1] + 1);
			fRec1314[0] = ((iTemp1056) ? fTemp1055 : fRec1314[1]);
			double fTemp1057 = fRec1314[0] - fRec1311[1];
			fRec1311[0] = fRec1311[1] + fConst9 * fTemp1057;
			double fTemp1058 = fRec1311[1] + fConst8 * fTemp1057;
			double fRec1312 = fTemp1058;
	...
	#define FAUST_FILE_NAME "RITI_v1_CelloA3.dsp"

...
Duffing_Semiautonomous_Network(N) = 
    (vgroup("Controls", CntrlSignals(N, 7, 10, 5, 10)) : hgroup("Oscillators", par(i, N, duffing_autOSC(i)))) ~    
    fullyConnectedMXDel(N) : 
        vgroup("Controls", hgroup("Mixer", par(i, N, _ * si.smoo(hslider("Gain %i [style: knob]", 1, 0, 1, .001)))));
process = tgroup("RITI", Duffing_Semiautonomous_Network(8) : dBMeters(8)) :> _/4 , _/4;

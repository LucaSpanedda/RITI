...
class mydsp : public base_dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		fVslider0 = FAUSTFLOAT(2e+04);
		fVslider1 = FAUSTFLOAT(1.0);
		fVslider2 = FAUSTFLOAT(5e+01);
		fVslider3 = FAUSTFLOAT(1.0);
		fVslider4 = FAUSTFLOAT(0.0);
		fVslider5 = FAUSTFLOAT(1e+01);
		fVslider6 = FAUSTFLOAT(-8e+01);
		fVslider7 = FAUSTFLOAT(1.0);
		fVslider8 = FAUSTFLOAT(6.9396);
		...
		fVslider18 = FAUSTFLOAT(1.0);
		fVslider19 = FAUSTFLOAT(4.6264);
		fVslider20 = FAUSTFLOAT(1.0);
		fVslider21 = FAUSTFLOAT(1.0);
		fVslider22 = FAUSTFLOAT(0.0);
		fVslider23 = FAUSTFLOAT(8.613900000000001);
		fVslider24 = FAUSTFLOAT(1.0);
		fVslider25 = FAUSTFLOAT(1.0);
		fVslider26 = FAUSTFLOAT(0.0);
		fVslider27 = FAUSTFLOAT(1.0);
		fVslider28 = FAUSTFLOAT(9.2528);
		fVslider29 = FAUSTFLOAT(2.8713);
		fVslider30 = FAUSTFLOAT(1.0);
		fVslider31 = FAUSTFLOAT(2.3132);
		fVslider32 = FAUSTFLOAT(1.0);
		fVslider33 = FAUSTFLOAT(1.0);
		fVslider34 = FAUSTFLOAT(0.0);
		fVslider35 = FAUSTFLOAT(11.4852);
		fVslider36 = FAUSTFLOAT(-8e+01);
	}
	...
	virtual void instanceClear() {
		...
		IOTA0 = 0;
		for (int l10 = 0; l10 < 4194304; l10 = l10 + 1) {
			fVec1[l10] = 0.0;
		}
		...
		for (int l245 = 0; l245 < 4194304; l245 = l245 + 1) {
			fVec8[l245] = 0.0;
		}
		...
		for (int l465 = 0; l465 < 4194304; l465 = l465 + 1) {
			fVec12[l465] = 0.0;
		}
		...
		for (int l476 = 0; l476 < 4194304; l476 = l476 + 1) {
			fVec13[l476] = 0.0;
		}
		...
		for (int l693 = 0; l693 < 4194304; l693 = l693 + 1) {
			fVec17[l693] = 0.0;
		}
		...
		for (int l701 = 0; l701 < 4194304; l701 = l701 + 1) {
			fVec18[l701] = 0.0;
		}
		...
		for (int l921 = 0; l921 < 4194304; l921 = l921 + 1) {
			fVec22[l921] = 0.0;
		}
		...
		for (int l938 = 0; l938 < 512; l938 = l938 + 1) {
			fRec1309[l938] = 0.0;
		}
		...
		for (int l945 = 0; l945 < 512; l945 = l945 + 1) {
			fRec1318[l945] = 0.0;
		}
		...
		for (int l952 = 0; l952 < 512; l952 = l952 + 1) {
			fRec1327[l952] = 0.0;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("BP Bypass", &fVslider9, FAUSTFLOAT(0.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("BP Signal", &fVslider14, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider13, "unit", "Hz");
		ui_interface->addVerticalSlider("Bandwidth", &fVslider13, FAUSTFLOAT(1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(1e+02), FAUSTFLOAT(0.001));
		ui_interface->openTabBox("Bank Voices");
		ui_interface->openHorizontalBox("Voice_1");
		ui_interface->declare(&fVslider26, "unit", "Hz");
		ui_interface->addVerticalSlider("Frequency", &fVslider26, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations A", &fVslider24, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider25, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Voice_2");
		ui_interface->declare(&fVslider12, "unit", "Hz");
		ui_interface->addVerticalSlider("Frequency", &fVslider12, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations A", &fVslider10, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider11, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Voice_3");
		ui_interface->declare(&fVslider22, "unit", "Hz");
		ui_interface->addVerticalSlider("Frequency", &fVslider22, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations A", &fVslider20, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider21, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Voice_4");
		ui_interface->declare(&fVslider34, "unit", "Hz");
		ui_interface->addVerticalSlider("Frequency", &fVslider34, FAUSTFLOAT(0.0), FAUSTFLOAT(-1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations A", &fVslider32, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Interpolations B", &fVslider33, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Voice_0+1", &fVslider27, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider7, "2", "");
		ui_interface->addVerticalSlider("Voice_1+1", &fVslider7, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider18, "2", "");
		ui_interface->addVerticalSlider("Voice_2+1", &fVslider18, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider30, "2", "");
		ui_interface->addVerticalSlider("Voice_3+1", &fVslider30, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Input Delays");
		ui_interface->declare(&fVslider28, "2", "");
		ui_interface->declare(&fVslider28, "unit", "Sec");
		ui_interface->addVerticalSlider("Voice_0+1", &fVslider28, FAUSTFLOAT(9.2528), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider8, "2", "");
		ui_interface->declare(&fVslider8, "unit", "Sec");
		ui_interface->addVerticalSlider("Voice_1+1", &fVslider8, FAUSTFLOAT(6.9396), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider19, "2", "");
		ui_interface->declare(&fVslider19, "unit", "Sec");
		ui_interface->addVerticalSlider("Voice_2+1", &fVslider19, FAUSTFLOAT(4.6264), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider31, "2", "");
		ui_interface->declare(&fVslider31, "unit", "Sec");
		ui_interface->addVerticalSlider("Voice_3+1", &fVslider31, FAUSTFLOAT(2.3132), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Output Delays");
		ui_interface->declare(&fVslider29, "2", "");
		ui_interface->declare(&fVslider29, "unit", "Sec");
		ui_interface->addVerticalSlider("Voice_0+1", &fVslider29, FAUSTFLOAT(2.8713), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
		...
		ui_interface->addVerticalSlider("Voice_2+1", &fVslider23, FAUSTFLOAT(8.613900000000001), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider35, "2", "");
		ui_interface->declare(&fVslider35, "unit", "Sec");
		ui_interface->addVerticalSlider("Voice_3+1", &fVslider35, FAUSTFLOAT(11.4852), FAUSTFLOAT(0.001), FAUSTFLOAT(12.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->openHorizontalBox("Inputs and Outputs");
		ui_interface->declare(&fVslider6, "unit", "dB");
		ui_interface->addVerticalSlider("Externals", &fVslider6, FAUSTFLOAT(-8e+01), FAUSTFLOAT(-8e+01), FAUSTFLOAT(8e+01), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider1, "unit", "Hz");
		ui_interface->addVerticalSlider("HP frequency", &fVslider1, FAUSTFLOAT(1.0), FAUSTFLOAT(1.0), FAUSTFLOAT(2e+04), FAUSTFLOAT(1.0));
		ui_interface->declare(&fVslider0, "unit", "Hz");
		ui_interface->addVerticalSlider("LP frequency", &fVslider0, FAUSTFLOAT(2e+04), FAUSTFLOAT(1.0), FAUSTFLOAT(2e+04), FAUSTFLOAT(1.0));
		ui_interface->declare(&fVslider36, "unit", "dB");
		ui_interface->addVerticalSlider("Master", &fVslider36, FAUSTFLOAT(-8e+01), FAUSTFLOAT(-8e+01), FAUSTFLOAT(0.0), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Dt", &fVslider4, FAUSTFLOAT(0.0), FAUSTFLOAT(-6e+01), FAUSTFLOAT(6e+01), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Lorenz FB", &fVslider3, FAUSTFLOAT(1.0), FAUSTFLOAT(0.0), FAUSTFLOAT(1.0), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Rho", &fVslider15, FAUSTFLOAT(3.518), FAUSTFLOAT(2.8), FAUSTFLOAT(53.2), FAUSTFLOAT(0.001));
		ui_interface->addVerticalSlider("Sigma", &fVslider5, FAUSTFLOAT(1e+01), FAUSTFLOAT(1.0), FAUSTFLOAT(19.0), FAUSTFLOAT(0.001));
		ui_interface->declare(&fVslider2, "unit", "TanH");
		ui_interface->addVerticalSlider("TanH", &fVslider2, FAUSTFLOAT(5e+01), FAUSTFLOAT(1.0), FAUSTFLOAT(1e+02), FAUSTFLOAT(0.001));
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = fConst4 * double(fVslider2);
		double fSlow3 = fConst4 * double(fVslider3);
		double fSlow4 = fConst4 * std::pow(1e+01, 0.05 * double(fVslider4));
		double fSlow5 = fConst4 * double(fVslider5);
		double fSlow6 = std::pow(1e+01, 0.05 * double(fVslider6));
		double fSlow7 = fConst4 * fSlow6 * double(fSlow6 > 0.0001);
		double fSlow8 = double(fVslider7);
		double fSlow9 = fConst0 * double(fVslider8) + -1.0;
		double fSlow10 = fConst4 * double(fVslider9);
		double fSlow11 = fConst4 * double(fVslider10);
		double fSlow12 = fConst4 * double(fVslider11);
		double fSlow13 = fConst4 * std::pow(16.0, double(fVslider12));
		double fSlow14 = fConst4 * double(fVslider13);
		double fSlow15 = fConst4 * double(fVslider14);
		double fSlow16 = fConst4 * double(fVslider15);
		double fSlow17 = fConst4 * double(fVslider16);
		double fSlow18 = fConst0 * double(fVslider17) + -1.0;
		double fSlow19 = double(fVslider18);
		double fSlow20 = fConst0 * double(fVslider19) + -1.0;
		double fSlow21 = fConst4 * double(fVslider20);
		double fSlow22 = fConst4 * double(fVslider21);
		double fSlow23 = fConst4 * std::pow(16.0, double(fVslider22));
		double fSlow24 = fConst0 * double(fVslider23) + -1.0;
		double fSlow25 = fConst4 * double(fVslider24);
		double fSlow26 = fConst4 * double(fVslider25);
		double fSlow27 = fConst4 * std::pow(16.0, double(fVslider26));
		double fSlow28 = double(fVslider27);
		double fSlow29 = fConst0 * double(fVslider28) + -1.0;
		double fSlow30 = fConst0 * double(fVslider29) + -1.0;
		double fSlow31 = double(fVslider30);
		double fSlow32 = fConst0 * double(fVslider31) + -1.0;
		double fSlow33 = fConst4 * double(fVslider32);
		double fSlow34 = fConst4 * double(fVslider33);
		double fSlow35 = fConst4 * std::pow(16.0, double(fVslider34));
		double fSlow36 = fConst0 * double(fVslider35) + -1.0;
		double fSlow37 = std::pow(1e+01, 0.05 * double(fVslider36));
		double fSlow38 = fConst4 * fSlow37 * double(fSlow37 > 0.0001);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec7[0] = fSlow0 + fConst3 * fRec7[1];
			double fTemp0 = std::tan(fConst5 * fRec7[0]);
			double fTemp1 = fTemp0 + 1.0;
			fRec10[0] = fSlow1 + fConst3 * fRec10[1];
			double fTemp2 = std::tan(fConst5 * fRec10[0]);
			double fTemp3 = fTemp2 + 1.0;
			fRec17[0] = fSlow2 + fConst3 * fRec17[1];
			double fTemp4 = std::max<double>(fRec17[0], 2.220446049250313e-16);
			fVec0[0] = 1.2;
			double fTemp5 = 1.2 - fVec0[1];
			fRec26[0] = fSlow3 + fConst3 * fRec26[1];
			double fTemp6 = fRec26[0] * fRec18[1];
			fRec25[0] = std::max<double>(fConst1 * fRec25[1], std::fabs(fTemp6));
			fVbargraph0 = FAUSTFLOAT(fRec25[0]);
			double fTemp7 = fTemp6;
			double fTemp8 = fRec26[0] * fRec19[1];
			fRec27[0] = std::max<double>(fConst1 * fRec27[1], std::fabs(fTemp8));
			fVbargraph1 = FAUSTFLOAT(fRec27[0]);
			double fTemp9 = fTemp8;
			fRec28[0] = fSlow4 + fConst3 * fRec28[1];
			fRec29[0] = fSlow5 + fConst3 * fRec29[1];
			double fTemp10 = fRec29[0] * fRec28[0];
			double fTemp11 = fTemp10 * (fTemp9 - fTemp7);
			fRec30[0] = fSlow7 + fConst3 * fRec30[1];
			double fTemp12 = 0.25 * fRec30[0] * (double(input7[i0]) + double(input6[i0]) + double(input5[i0]) + double(input4[i0]) + double(input3[i0]) + double(input2[i0]) + double(input0[i0]) + double(input1[i0]));
			double fTemp13 = fSlow8 * fRec11[1];
			fVec1[IOTA0 & 4194303] = fTemp13;
			double fTemp14 = ((fRec32[1] != 0.0) ? (((fRec33[1] > 0.0) & (fRec33[1] < 1.0)) ? fRec32[1] : 0.0) : (((fRec33[1] == 0.0) & (fSlow9 != fRec34[1])) ? 0.0009765625 : (((fRec33[1] == 1.0) & (fSlow9 != fRec35[1])) ? -0.0009765625 : 0.0)));
			fRec32[0] = fTemp14;
			fRec33[0] = std::max<double>(0.0, std::min<double>(1.0, fRec33[1] + fTemp14));
			fRec34[0] = (((fRec33[1] >= 1.0) & (fRec35[1] != fSlow9)) ? fSlow9 : fRec34[1]);
			fRec35[0] = (((fRec33[1] <= 0.0) & (fRec34[1] != fSlow9)) ? fSlow9 : fRec35[1]);
			double fTemp15 = fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec34[0])))) & 4194303];
			fRec31[0] = fTemp15 + fRec33[0] * (fVec1[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec35[0])))) & 4194303] - fTemp15);
			fVec2[0] = fRec31[1] + fTemp12 + fTemp7 + fTemp11 + fTemp5;
			fRec24[0] = fTemp11 + fRec31[1] + fTemp7 + fTemp12 + 0.995 * fRec24[1] + (1.2 - (fVec0[1] + fVec2[1]));
			fRec23[0] = std::max<double>(fConst1 * fRec23[1], std::fabs(fRec24[0]));
			fVbargraph2 = FAUSTFLOAT(fRec23[0]);
			double fTemp16 = fRec17[0] * tanh(fRec24[0] / fTemp4);
			fRec22[0] = std::max<double>(fConst1 * fRec22[1], std::fabs(fTemp16));
			fVbargraph3 = FAUSTFLOAT(fRec22[0]);
			double fTemp17 = fTemp16;
			fRec36[0] = fSlow10 + fConst3 * fRec36[1];
			fRec40[0] = fSlow11 + fConst3 * fRec40[1];
			fRec41[0] = fSlow12 + fConst3 * fRec41[1];
			fRec42[0] = fSlow13 + fConst3 * fRec42[1];
			double fTemp18 = fRec42[0] * (561.0 * fRec40[0] + fRec41[0] * (562.0 - 1097.0 * fRec40[0]) + 221.0);
			fRec43[0] = fSlow14 + fConst3 * fRec43[1];
			double fTemp19 = std::max<double>(2.220446049250313e-16, fRec43[0]);
			double fTemp20 = std::tan(fConst5 * fTemp18);
			double fTemp21 = fTemp20 * (fTemp20 + fTemp19 / fTemp18) + 1.0;
			double fTemp22 = fTemp20 * (fTemp17 - fRec38[1]) + fRec37[1];
			fRec37[0] = 2.0 * (fTemp22 / fTemp21) - fRec37[1];
			fRec38[0] = fRec38[1] + 2.0 * (fTemp20 * fTemp22 / fTemp21);
			double fTemp23 = fRec41[0] * (0.20948251265282836 * fRec40[0] + -0.35882756573771113) + (0.883508750371294 - 0.3295246174054942 * fRec40[0]);
			double fRec39 = fTemp22 * fTemp23 / fTemp21;
			double fTemp24 = fRec42[0] * (1048.0 * fRec40[0] + fRec41[0] * (1.07e+03 * fRec40[0] + -787.0) + 1619.0);
			double fTemp25 = std::tan(fConst5 * fTemp24);
			double fTemp26 = fTemp25 * (fTemp25 + fTemp19 / fTemp24) + 1.0;
			double fTemp27 = fTemp25 * (fTemp17 - fRec45[1]) + fRec44[1];
			fRec44[0] = 2.0 * (fTemp27 / fTemp26) - fRec44[1];
			fRec45[0] = fRec45[1] + 2.0 * (fTemp25 * fTemp27 / fTemp26);
			double fTemp28 = fRec41[0] * (0.0016935641831933154 * fRec40[0] + -0.0070591277129707815) + (0.014962909727368317 - 0.007613896970744654 * fRec40[0]);
			double fRec46 = fTemp27 * fTemp28 / fTemp26;
			double fTemp29 = fRec42[0] * (687.0 * fRec40[0] + fRec41[0] * (311.0 - 2032.0 * fRec40[0]) + 2429.0);
			double fTemp30 = std::tan(fConst5 * fTemp29);
			double fTemp31 = fTemp30 * (fTemp30 + fTemp19 / fTemp29) + 1.0;
			double fTemp32 = fTemp30 * (fTemp17 - fRec48[1]) + fRec47[1];
			fRec47[0] = 2.0 * (fTemp32 / fTemp31) - fRec47[1];
			fRec48[0] = fRec48[1] + 2.0 * (fTemp30 * fTemp32 / fTemp31);
			double fTemp33 = fRec41[0] * (0.005227226473626777 * fRec40[0] + -0.010433410102575844) + (0.01934635943322834 - 0.010538363987102131 * fRec40[0]);
			double fRec49 = fTemp32 * fTemp33 / fTemp31;
			double fTemp34 = fRec42[0] * (1422.0 * fRec40[0] + fRec41[0] * (-4.0 - 526.0 * fRec40[0]) + 1178.0);
			double fTemp35 = std::tan(fConst5 * fTemp34);
			double fTemp36 = fTemp35 * (fTemp35 + fTemp19 / fTemp34) + 1.0;
			double fTemp37 = fTemp35 * (fTemp17 - fRec51[1]) + fRec50[1];
			fRec50[0] = 2.0 * (fTemp37 / fTemp36) - fRec50[1];
			fRec51[0] = fRec51[1] + 2.0 * (fTemp35 * fTemp37 / fTemp36);
			double fTemp38 = fRec41[0] * (0.0015990719330448112 * fRec40[0] + -0.009377259975676547) + (0.020502590513884294 - 0.008575258476103987 * fRec40[0]);
			double fRec52 = fTemp37 * fTemp38 / fTemp36;
			double fTemp39 = fRec42[0] * (1005.0 * fRec40[0] + fRec41[0] * (1538.0 - 1969.0 * fRec40[0]) + 1398.0);
			double fTemp40 = std::tan(fConst5 * fTemp39);
			double fTemp41 = fTemp40 * (fTemp40 + fTemp19 / fTemp39) + 1.0;
			double fTemp42 = fTemp40 * (fTemp17 - fRec54[1]) + fRec53[1];
			fRec53[0] = 2.0 * (fTemp42 / fTemp41) - fRec53[1];
			fRec54[0] = fRec54[1] + 2.0 * (fTemp40 * fTemp42 / fTemp41);
			double fTemp43 = fRec41[0] * (-0.004224308163056342 - 0.007247221109719737 * fRec40[0]) + (0.020955020563014883 - 0.004499122746580129 * fRec40[0]);
			double fRec55 = fTemp42 * fTemp43 / fTemp41;
			double fTemp44 = fRec42[0] * (726.0 * fRec40[0] + fRec41[0] * (507.0 - 2138.0 * fRec40[0]) + 2135.0);
			double fTemp45 = std::tan(fConst5 * fTemp44);
			double fTemp46 = fTemp45 * (fTemp45 + fTemp19 / fTemp44) + 1.0;
			double fTemp47 = fTemp45 * (fTemp17 - fRec57[1]) + fRec56[1];
			fRec56[0] = 2.0 * (fTemp47 / fTemp46) - fRec56[1];
			fRec57[0] = fRec57[1] + 2.0 * (fTemp45 * fTemp47 / fTemp46);
			double fTemp48 = fRec41[0] * (0.0009039247818369497 - 0.013893501673791466 * fRec40[0]) + (0.02359690477324046 - 0.005322076674786635 * fRec40[0]);
			double fRec58 = fTemp47 * fTemp48 / fTemp46;
			double fTemp49 = fRec42[0] * (125.0 * fRec40[0] + fRec41[0] * (9e+01 - 7.0 * fRec40[0]) + 2356.0);
			double fTemp50 = std::tan(fConst5 * fTemp49);
			double fTemp51 = fTemp50 * (fTemp50 + fTemp19 / fTemp49) + 1.0;
			double fTemp52 = fTemp50 * (fTemp17 - fRec60[1]) + fRec59[1];
			fRec59[0] = 2.0 * (fTemp52 / fTemp51) - fRec59[1];
			fRec60[0] = fRec60[1] + 2.0 * (fTemp50 * fTemp52 / fTemp51);
			double fTemp53 = fRec41[0] * (0.00789733404453236 - 0.022269972441420545 * fRec40[0]) + (0.024970356245165314 - 0.004948333836676418 * fRec40[0]);
			double fRec61 = fTemp52 * fTemp53 / fTemp51;
			double fTemp54 = fRec42[0] * (74.0 * fRec40[0] + fRec41[0] * (1147.0 - 837.0 * fRec40[0]) + 1104.0);
			double fTemp55 = std::tan(fConst5 * fTemp54);
			double fTemp56 = fTemp55 * (fTemp55 + fTemp19 / fTemp54) + 1.0;
			double fTemp57 = fTemp55 * (fTemp17 - fRec63[1]) + fRec62[1];
			fRec62[0] = 2.0 * (fTemp57 / fTemp56) - fRec62[1];
			fRec63[0] = fRec63[1] + 2.0 * (fTemp55 * fTemp57 / fTemp56);
			double fTemp58 = fRec41[0] * (0.014369998843206975 - 0.03300092964654322 * fRec40[0]) + (0.025519908386620865 - 0.0011683893550737713 * fRec40[0]);
			double fRec64 = fTemp57 * fTemp58 / fTemp56;
			double fTemp59 = fRec42[0] * (fRec41[0] * (241.0 * fRec40[0] + 6.3e+02) + (1914.0 - 1472.0 * fRec40[0]));
			double fTemp60 = std::tan(fConst5 * fTemp59);
			double fTemp61 = fTemp60 * (fTemp60 + fTemp19 / fTemp59) + 1.0;
			double fTemp62 = fTemp60 * (fTemp17 - fRec66[1]) + fRec65[1];
			fRec65[0] = 2.0 * (fTemp62 / fTemp61) - fRec65[1];
			fRec66[0] = fRec66[1] + 2.0 * (fTemp60 * fTemp62 / fTemp61);
			double fTemp63 = fRec41[0] * (0.012092025104768513 - 0.030118723258832435 * fRec40[0]) + (0.034299901561064564 - 0.009167713045154305 * fRec40[0]);
			double fRec67 = fTemp62 * fTemp63 / fTemp61;
			double fTemp64 = fRec42[0] * (403.0 * fRec40[0] + fRec41[0] * (1123.0 - 898.0 * fRec40[0]) + 1.03e+03);
			double fTemp65 = std::tan(fConst5 * fTemp64);
			double fTemp66 = fTemp65 * (fTemp65 + fTemp19 / fTemp64) + 1.0;
			double fTemp67 = fTemp65 * (fTemp17 - fRec69[1]) + fRec68[1];
			fRec68[0] = 2.0 * (fTemp67 / fTemp66) - fRec68[1];
			fRec69[0] = fRec69[1] + 2.0 * (fTemp65 * fTemp67 / fTemp66);
			double fTemp68 = fRec41[0] * (0.021778225322525664 - 0.04184590502930971 * fRec40[0]) + (0.03695324484801036 - 0.00815043374124962 * fRec40[0]);
			double fRec70 = fTemp67 * fTemp68 / fTemp66;
			double fTemp69 = 6.0 * fRec40[0];
			double fTemp70 = fRec42[0] * (fTemp69 + fRec41[0] * (838.0 * fRec40[0] + -812.0) + 1693.0);
			double fTemp71 = std::tan(fConst5 * fTemp70);
			double fTemp72 = fTemp71 * (fTemp71 + fTemp19 / fTemp70) + 1.0;
			double fTemp73 = fTemp71 * (fTemp17 - fRec72[1]) + fRec71[1];
			fRec71[0] = 2.0 * (fTemp73 / fTemp72) - fRec71[1];
			fRec72[0] = fRec72[1] + 2.0 * (fTemp71 * fTemp73 / fTemp72);
			double fTemp74 = fRec41[0] * (0.01054367849960227 - 0.044428922548055166 * fRec40[0]) + (0.04993743413946004 - 0.006818779501746489 * fRec40[0]);
			double fRec73 = fTemp73 * fTemp74 / fTemp72;
			double fTemp75 = fRec42[0] * (209.0 * fRec40[0] + fRec41[0] * (1515.0 - 1507.0 * fRec40[0]) + 442.0);
			double fTemp76 = std::tan(fConst5 * fTemp75);
			double fTemp77 = fTemp76 * (fTemp76 + fTemp19 / fTemp75) + 1.0;
			double fTemp78 = fTemp76 * (fTemp17 - fRec75[1]) + fRec74[1];
			fRec74[0] = 2.0 * (fTemp78 / fTemp77) - fRec74[1];
			fRec75[0] = fRec75[1] + 2.0 * (fTemp76 * fTemp78 / fTemp77);
			double fTemp79 = fRec41[0] * (-0.00836319425786336 - 0.027213728546822337 * fRec40[0]) + (0.07568694217870818 - 0.01847465835663161 * fRec40[0]);
			double fRec76 = fTemp78 * fTemp79 / fTemp77;
			double fTemp80 = fRec42[0] * (675.0 * fRec40[0] + fRec41[0] * (1172.0 - 1989.0 * fRec40[0]) + 883.0);
			double fTemp81 = std::tan(fConst5 * fTemp80);
			double fTemp82 = fTemp81 * (fTemp81 + fTemp19 / fTemp80) + 1.0;
			double fTemp83 = fTemp81 * (fTemp17 - fRec78[1]) + fRec77[1];
			fRec77[0] = 2.0 * (fTemp83 / fTemp82) - fRec77[1];
			fRec78[0] = fRec78[1] + 2.0 * (fTemp81 * fTemp83 / fTemp82);
			double fTemp84 = fRec41[0] * (0.01667332967615094 * fRec40[0] + -0.0754718266524771) + (0.15388399774271314 - 0.05838064149040649 * fRec40[0]);
			double fRec79 = fTemp83 * fTemp84 / fTemp82;
			double fTemp85 = fRec42[0] * (1.36e+03 * fRec40[0] + fRec41[0] * (-1e+02 - 1025.0 * fRec40[0]) + 589.0);
			double fTemp86 = std::tan(fConst5 * fTemp85);
			double fTemp87 = fTemp86 * (fTemp86 + fTemp19 / fTemp85) + 1.0;
			double fTemp88 = fTemp86 * (fTemp17 - fRec81[1]) + fRec80[1];
			fRec80[0] = 2.0 * (fTemp88 / fTemp87) - fRec80[1];
			fRec81[0] = fRec81[1] + 2.0 * (fTemp86 * fTemp88 / fTemp87);
			double fTemp89 = 0.012026367628721973 * fRec40[0] + fRec41[0] * (-0.03484164734028006 - 0.07088469349182304 * fRec40[0]) + 0.15986608084324763;
			double fRec82 = fTemp88 * fTemp89 / fTemp87;
			double fTemp90 = fRec42[0] * (fRec41[0] * (-51.0 - 11.0 * fRec40[0]) + (736.0 - 345.0 * fRec40[0]));
			double fTemp91 = std::tan(fConst5 * fTemp90);
			double fTemp92 = fTemp91 * (fTemp91 + fTemp19 / fTemp90) + 1.0;
			double fTemp93 = fTemp91 * (fTemp17 - fRec84[1]) + fRec83[1];
			fRec83[0] = 2.0 * (fTemp93 / fTemp92) - fRec83[1];
			fRec84[0] = fRec84[1] + 2.0 * (fTemp91 * fTemp93 / fTemp92);
			double fTemp94 = 0.043418834059638534 * fRec40[0] + fRec41[0] * (0.0003590165583120808 - 0.1653942291667907 * fRec40[0]) + 0.2004373971446242;
			double fRec85 = fTemp93 * fTemp94 / fTemp92;
			double fTemp95 = fRec42[0] * (113.0 * fRec40[0] + fRec41[0] * (147.0 - 325.0 * fRec40[0]) + 147.0);
			double fTemp96 = std::tan(fConst5 * fTemp95);
			double fTemp97 = fTemp96 * (fTemp96 + fTemp19 / fTemp95) + 1.0;
			double fTemp98 = fTemp96 * (fTemp17 - fRec87[1]) + fRec86[1];
			fRec86[0] = 2.0 * (fTemp98 / fTemp97) - fRec86[1];
			fRec87[0] = fRec87[1] + 2.0 * (fTemp96 * fTemp98 / fTemp97);
			double fTemp99 = fRec41[0] * (-0.20926865897501318 - 0.10045148502362689 * fRec40[0]) + (0.6105272358722508 - 0.05775171174785887 * fRec40[0]);
			double fRec88 = fTemp98 * fTemp99 / fTemp97;
			double fTemp100 = fRec42[0] * (fRec41[0] * (306.0 * fRec40[0] + -2.7e+02) + (368.0 - 239.0 * fRec40[0]));
			double fTemp101 = std::tan(fConst5 * fTemp100);
			double fTemp102 = fTemp101 * (fTemp101 + fTemp19 / fTemp100) + 1.0;
			double fTemp103 = fTemp101 * (fTemp17 - fRec90[1]) + fRec89[1];
			double fTemp104 = fTemp103 / fTemp102;
			fRec89[0] = 2.0 * fTemp104 - fRec89[1];
			fRec90[0] = fRec90[1] + 2.0 * (fTemp101 * fTemp103 / fTemp102);
			double fRec91 = fTemp104;
			double fTemp105 = fRec42[0] * (fTemp69 + fRec41[0] * (72.0 - 181.0 * fRec40[0]) + 515.0);
			double fTemp106 = std::tan(fConst5 * fTemp105);
			double fTemp107 = fTemp106 * (fTemp106 + fTemp19 / fTemp105) + 1.0;
			double fTemp108 = fTemp106 * (fTemp17 - fRec93[1]) + fRec92[1];
			fRec92[0] = 2.0 * (fTemp108 / fTemp107) - fRec92[1];
			fRec93[0] = fRec93[1] + 2.0 * (fTemp106 * fTemp108 / fTemp107);
			double fTemp109 = 0.1297691905274158 * fRec40[0] + fRec41[0] * (-0.020679500617239138 - 0.26354737961410307 * fRec40[0]) + 0.25009984168236576;
			double fRec94 = fTemp108 * fTemp109 / fTemp107;
			double fTemp110 = fRec42[0] * (968.0 * fRec40[0] + fRec41[0] * (122.0 - 588.0 * fRec40[0]) + 74.0);
			double fTemp111 = std::tan(fConst5 * fTemp110);
			double fTemp112 = fTemp111 * (fTemp111 + fTemp19 / fTemp110) + 1.0;
			double fTemp113 = fTemp111 * (fTemp17 - fRec96[1]) + fRec95[1];
			fRec95[0] = 2.0 * (fTemp113 / fTemp112) - fRec95[1];
			fRec96[0] = fRec96[1] + 2.0 * (fTemp111 * fTemp113 / fTemp112);
			double fTemp114 = fRec41[0] * (-0.00905548290563929 - 0.10407317928289174 * fRec40[0]) + (0.19782531572463796 - 0.011967933866223551 * fRec40[0]);
			double fRec97 = fTemp113 * fTemp114 / fTemp112;
			double fTemp115 = fRec42[0] * (102.0 * fRec40[0] + fRec41[0] * (756.0 - 762.0 * fRec40[0]) + 8.1e+02);
			double fTemp116 = std::tan(fConst5 * fTemp115);
			double fTemp117 = fTemp116 * (fTemp116 + fTemp19 / fTemp115) + 1.0;
			double fTemp118 = fTemp116 * (fTemp17 - fRec99[1]) + fRec98[1];
			fRec98[0] = 2.0 * (fTemp118 / fTemp117) - fRec98[1];
			fRec99[0] = fRec99[1] + 2.0 * (fTemp116 * fTemp118 / fTemp117);
			double fTemp119 = fRec41[0] * (-0.06073025380607225 - 0.02103357250515689 * fRec40[0]) + (0.15408867955329245 - 0.01859664908410899 * fRec40[0]);
			double fRec100 = fTemp118 * fTemp119 / fTemp117;
			double fTemp120 = fRec42[0] * (1784.0 * fRec40[0] + fRec41[0] * (96.0 - 1681.0 * fRec40[0]) + 295.0);
			double fTemp121 = std::tan(fConst5 * fTemp120);
			double fTemp122 = fTemp121 * (fTemp121 + fTemp19 / fTemp120) + 1.0;
			double fTemp123 = fTemp121 * (fTemp17 - fRec102[1]) + fRec101[1];
			fRec101[0] = 2.0 * (fTemp123 / fTemp122) - fRec101[1];
			fRec102[0] = fRec102[1] + 2.0 * (fTemp121 * fTemp123 / fTemp122);
			double fTemp124 = fRec41[0] * (0.00832579588520789 * fRec40[0] + -0.044200755516049905) + (0.12206611629626225 - 0.05880265929429268 * fRec40[0]);
			double fRec103 = fTemp123 * fTemp124 / fTemp122;
			double fTemp125 = fRec42[0] * (1689.0 * fRec40[0] + fRec41[0] * (806.0 - 1597.0 * fRec40[0]) + 662.0);
			double fTemp126 = std::tan(fConst5 * fTemp125);
			double fTemp127 = fTemp126 * (fTemp126 + fTemp19 / fTemp125) + 1.0;
			double fTemp128 = fTemp126 * (fTemp17 - fRec105[1]) + fRec104[1];
			fRec104[0] = 2.0 * (fTemp128 / fTemp127) - fRec104[1];
			fRec105[0] = fRec105[1] + 2.0 * (fTemp126 * fTemp128 / fTemp127);
			double fTemp129 = fRec41[0] * (-0.010952558243701213 - 0.024561127441574723 * fRec40[0]) + (0.0749419685950924 - 0.028820358890550887 * fRec40[0]);
			double fRec106 = fTemp128 * fTemp129 / fTemp127;
			double fTemp130 = fRec42[0] * (1265.0 * fRec40[0] + fRec41[0] * (1.2e+02 - 1.27e+03 * fRec40[0]) + 956.0);
			double fTemp131 = std::tan(fConst5 * fTemp130);
			double fTemp132 = fTemp131 * (fTemp131 + fTemp19 / fTemp130) + 1.0;
			double fTemp133 = fTemp131 * (fTemp17 - fRec108[1]) + fRec107[1];
			fRec107[0] = 2.0 * (fTemp133 / fTemp132) - fRec107[1];
			fRec108[0] = fRec108[1] + 2.0 * (fTemp131 * fTemp133 / fTemp132);
			double fTemp134 = fRec41[0] * (0.016194260220710646 - 0.04017164138792575 * fRec40[0]) + (0.04296305701601583 - 0.009998228849321458 * fRec40[0]);
			double fRec109 = fTemp133 * fTemp134 / fTemp132;
			double fTemp135 = fRec42[0] * (fRec41[0] * (951.0 * fRec40[0] + -618.0) + (2282.0 - 463.0 * fRec40[0]));
			double fTemp136 = std::tan(fConst5 * fTemp135);
			double fTemp137 = fTemp136 * (fTemp136 + fTemp19 / fTemp135) + 1.0;
			double fTemp138 = fTemp136 * (fTemp17 - fRec111[1]) + fRec110[1];
			fRec110[0] = 2.0 * (fTemp138 / fTemp137) - fRec110[1];
			fRec111[0] = fRec111[1] + 2.0 * (fTemp136 * fTemp138 / fTemp137);
			double fTemp139 = fRec41[0] * (0.015993820877451798 - 0.03561073091810513 * fRec40[0]) + (0.035190168499954565 - 0.007711275872944394 * fRec40[0]);
			double fRec112 = fTemp138 * fTemp139 / fTemp137;
			double fTemp140 = fRec42[0] * (fRec41[0] * (803.0 - 1117.0 * fRec40[0]) + (1546.0 - 238.0 * fRec40[0]));
			double fTemp141 = std::tan(fConst5 * fTemp140);
			double fTemp142 = fTemp141 * (fTemp141 + fTemp19 / fTemp140) + 1.0;
			double fTemp143 = fTemp141 * (fTemp17 - fRec114[1]) + fRec113[1];
			fRec113[0] = 2.0 * (fTemp143 / fTemp142) - fRec113[1];
			fRec114[0] = fRec114[1] + 2.0 * (fTemp141 * fTemp143 / fTemp142);
			double fTemp144 = fRec41[0] * (0.012251807773129418 - 0.030545193317676356 * fRec40[0]) + (0.027814420294695608 - 0.002830824883261286 * fRec40[0]);
			double fRec115 = fTemp143 * fTemp144 / fTemp142;
			double fTemp145 = fRec42[0] * (fRec41[0] * (1.34e+03 * fRec40[0] + -102.0) + (1472.0 - 903.0 * fRec40[0]));
			double fTemp146 = std::tan(fConst5 * fTemp145);
			double fTemp147 = fTemp146 * (fTemp146 + fTemp19 / fTemp145) + 1.0;
			double fTemp148 = fTemp146 * (fTemp17 - fRec117[1]) + fRec116[1];
			fRec116[0] = 2.0 * (fTemp148 / fTemp147) - fRec116[1];
			fRec117[0] = fRec117[1] + 2.0 * (fTemp146 * fTemp148 / fTemp147);
			double fTemp149 = fRec41[0] * (0.008006093262504007 - 0.024671130121872657 * fRec40[0]) + (0.025451275008886335 - 0.003130799157219928 * fRec40[0]);
			double fRec118 = fTemp148 * fTemp149 / fTemp147;
			double fTemp150 = fRec42[0] * (fRec41[0] * (861.0 * fRec40[0] + -1231.0) + (2503.0 - 228.0 * fRec40[0]));
			double fTemp151 = std::tan(fConst5 * fTemp150);
			double fTemp152 = fTemp151 * (fTemp151 + fTemp19 / fTemp150) + 1.0;
			double fTemp153 = fTemp151 * (fTemp17 - fRec120[1]) + fRec119[1];
			fRec119[0] = 2.0 * (fTemp153 / fTemp152) - fRec119[1];
			fRec120[0] = fRec120[1] + 2.0 * (fTemp151 * fTemp153 / fTemp152);
			double fTemp154 = fRec41[0] * (0.002393508230319367 - 0.01643892312610763 * fRec40[0]) + (0.02376619002590769 - 0.004291546045942368 * fRec40[0]);
			double fRec121 = fTemp153 * fTemp154 / fTemp152;
			double fTemp155 = fRec42[0] * (1281.0 * fRec40[0] + fRec41[0] * (37.0 * fRec40[0] + -273.0) + 1251.0);
			double fTemp156 = std::tan(fConst5 * fTemp155);
			double fTemp157 = fTemp156 * (fTemp156 + fTemp19 / fTemp155) + 1.0;
			double fTemp158 = fTemp156 * (fTemp17 - fRec123[1]) + fRec122[1];
			fRec122[0] = 2.0 * (fTemp158 / fTemp157) - fRec122[1];
			fRec123[0] = fRec123[1] + 2.0 * (fTemp156 * fTemp158 / fTemp157);
			double fTemp159 = fRec41[0] * (0.001634210217413834 - 0.013674190403903216 * fRec40[0]) + (0.02108580284017779 - 0.003933981224376031 * fRec40[0]);
			double fRec124 = fTemp158 * fTemp159 / fTemp157;
			double fTemp160 = fRec42[0] * (1666.0 * fRec40[0] + fRec41[0] * (436.0 - 1213.0 * fRec40[0]) + 1325.0);
			double fTemp161 = std::tan(fConst5 * fTemp160);
			double fTemp162 = fTemp161 * (fTemp161 + fTemp19 / fTemp160) + 1.0;
			double fTemp163 = fTemp161 * (fTemp17 - fRec126[1]) + fRec125[1];
			fRec125[0] = 2.0 * (fTemp163 / fTemp162) - fRec125[1];
			fRec126[0] = fRec126[1] + 2.0 * (fTemp161 * fTemp163 / fTemp162);
			double fTemp164 = fRec41[0] * (-0.006947658589813211 - 0.0032192382202462302 * fRec40[0]) + (0.02080994218773682 - 0.006343538597854104 * fRec40[0]);
			double fRec127 = fTemp163 * fTemp164 / fTemp162;
			double fTemp165 = fRec42[0] * (81.0 * fRec40[0] + fRec41[0] * (972.0 - 715.0 * fRec40[0]) + 2061.0);
			double fTemp166 = std::tan(fConst5 * fTemp165);
			double fTemp167 = fTemp166 * (fTemp166 + fTemp19 / fTemp165) + 1.0;
			double fTemp168 = fTemp166 * (fTemp17 - fRec129[1]) + fRec128[1];
			fRec128[0] = 2.0 * (fTemp168 / fTemp167) - fRec128[1];
			fRec129[0] = fRec129[1] + 2.0 * (fTemp166 * fTemp168 / fTemp167);
			double fTemp169 = fRec41[0] * (0.0021589052725694453 * fRec40[0] + -0.008904165411473826) + (0.019359564369447416 - 0.008690192954800124 * fRec40[0]);
			double fRec130 = fTemp168 * fTemp169 / fTemp167;
			double fTemp170 = fRec42[0] * (fRec41[0] * (1.02e+03 - 1.62e+03 * fRec40[0]) + (2209.0 - 456.0 * fRec40[0]));
			double fTemp171 = std::tan(fConst5 * fTemp170);
			double fTemp172 = fTemp171 * (fTemp171 + fTemp19 / fTemp170) + 1.0;
			double fTemp173 = fTemp171 * (fTemp17 - fRec132[1]) + fRec131[1];
			fRec131[0] = 2.0 * (fTemp173 / fTemp172) - fRec131[1];
			fRec132[0] = fRec132[1] + 2.0 * (fTemp171 * fTemp173 / fTemp172);
			double fTemp174 = fRec41[0] * (0.005044160613158476 * fRec40[0] + -0.01013056637869131) + (0.018745547950376563 - 0.011232336533809374 * fRec40[0]);
			double fRec133 = fTemp173 * fTemp174 / fTemp172;
			double fTemp175 = fRec42[0] * (805.0 * fRec40[0] + fRec41[0] * (266.0 - 7.7e+02 * fRec40[0]) + 2572.0);
			double fTemp176 = std::tan(fConst5 * fTemp175);
			double fTemp177 = fTemp176 * (fTemp176 + fTemp19 / fTemp175) + 1.0;
			double fTemp178 = fTemp176 * (fTemp17 - fRec135[1]) + fRec134[1];
			fRec134[0] = 2.0 * (fTemp178 / fTemp177) - fRec134[1];
			fRec135[0] = fRec135[1] + 2.0 * (fTemp176 * fTemp178 / fTemp177);
			double fTemp179 = fRec41[0] * (0.0016378452192321808 * fRec40[0] + -0.004344936518553382) + (0.011249397635411025 - 0.006780823623904783 * fRec40[0]);
			double fRec136 = fTemp178 * fTemp179 / fTemp177;
			fRec137[0] = fSlow15 + fConst3 * fRec137[1];
			double fTemp180 = 0.03125 * fRec137[0] * (fRec136 + fRec133 + fRec130 + fRec127 + fRec124 + fRec121 + fRec118 + fRec115 + fRec112 + fRec109 + fRec106 + fRec103 + fRec100 + fRec97 + fRec94 + fRec91 + fRec88 + fRec85 + fRec82 + fRec79 + fRec76 + fRec73 + fRec70 + fRec67 + fRec64 + fRec61 + fRec58 + fRec55 + fRec52 + fRec49 + fRec46 + fRec39) + fRec36[0] * fTemp17;
			fRec21[0] = std::max<double>(fConst1 * fRec21[1], std::fabs(fTemp180));
			fVbargraph4 = FAUSTFLOAT(fRec21[0]);
			fRec18[0] = fTemp180;
			fVec3[0] = 1.3;
			double fTemp181 = 1.3 - fVec3[1];
			double fTemp182 = fRec26[0] * fRec20[1];
			fRec142[0] = std::max<double>(fConst1 * fRec142[1], std::fabs(fTemp182));
			fVbargraph5 = FAUSTFLOAT(fRec142[0]);
			double fTemp183 = fTemp182;
			fRec143[0] = fSlow16 + fConst3 * fRec143[1];
			double fTemp184 = fRec28[0] * (fTemp7 * (fRec143[0] - fTemp183) - fTemp9);
			double fTemp185 = fTemp12 + fRec31[1];
			double fTemp186 = fTemp185 + fTemp9;
			fVec4[0] = fTemp186 + fTemp184 + fTemp181;
			fRec141[0] = fTemp184 + 0.995 * fRec141[1] + fTemp186 + (1.3 - (fVec3[1] + fVec4[1]));
			fRec140[0] = std::max<double>(fConst1 * fRec140[1], std::fabs(fRec141[0]));
			fVbargraph6 = FAUSTFLOAT(fRec140[0]);
			double fTemp187 = fRec17[0] * tanh(fRec141[0] / fTemp4);
			fRec139[0] = std::max<double>(fConst1 * fRec139[1], std::fabs(fTemp187));
			fVbargraph7 = FAUSTFLOAT(fRec139[0]);
			double fTemp188 = fTemp187;
			double fTemp189 = fTemp20 * (fTemp188 - fRec145[1]) + fRec144[1];
			fRec144[0] = 2.0 * (fTemp189 / fTemp21) - fRec144[1];
			fRec145[0] = fRec145[1] + 2.0 * (fTemp20 * fTemp189 / fTemp21);
			double fRec146 = fTemp23 * fTemp189 / fTemp21;
			double fTemp190 = fTemp25 * (fTemp188 - fRec148[1]) + fRec147[1];
			fRec147[0] = 2.0 * (fTemp190 / fTemp26) - fRec147[1];
			fRec148[0] = fRec148[1] + 2.0 * (fTemp25 * fTemp190 / fTemp26);
			double fRec149 = fTemp28 * fTemp190 / fTemp26;
			double fTemp191 = fTemp30 * (fTemp188 - fRec151[1]) + fRec150[1];
			fRec150[0] = 2.0 * (fTemp191 / fTemp31) - fRec150[1];
			fRec151[0] = fRec151[1] + 2.0 * (fTemp30 * fTemp191 / fTemp31);
			double fRec152 = fTemp33 * fTemp191 / fTemp31;
			double fTemp192 = fTemp35 * (fTemp188 - fRec154[1]) + fRec153[1];
			fRec153[0] = 2.0 * (fTemp192 / fTemp36) - fRec153[1];
			fRec154[0] = fRec154[1] + 2.0 * (fTemp35 * fTemp192 / fTemp36);
			double fRec155 = fTemp38 * fTemp192 / fTemp36;
			double fTemp193 = fTemp40 * (fTemp188 - fRec157[1]) + fRec156[1];
			fRec156[0] = 2.0 * (fTemp193 / fTemp41) - fRec156[1];
			fRec157[0] = fRec157[1] + 2.0 * (fTemp40 * fTemp193 / fTemp41);
			double fRec158 = fTemp43 * fTemp193 / fTemp41;
			double fTemp194 = fTemp45 * (fTemp188 - fRec160[1]) + fRec159[1];
			fRec159[0] = 2.0 * (fTemp194 / fTemp46) - fRec159[1];
			fRec160[0] = fRec160[1] + 2.0 * (fTemp45 * fTemp194 / fTemp46);
			double fRec161 = fTemp48 * fTemp194 / fTemp46;
			double fTemp195 = fTemp50 * (fTemp188 - fRec163[1]) + fRec162[1];
			fRec162[0] = 2.0 * (fTemp195 / fTemp51) - fRec162[1];
			fRec163[0] = fRec163[1] + 2.0 * (fTemp50 * fTemp195 / fTemp51);
			double fRec164 = fTemp53 * fTemp195 / fTemp51;
			double fTemp196 = fTemp55 * (fTemp188 - fRec166[1]) + fRec165[1];
			fRec165[0] = 2.0 * (fTemp196 / fTemp56) - fRec165[1];
			fRec166[0] = fRec166[1] + 2.0 * (fTemp55 * fTemp196 / fTemp56);
			double fRec167 = fTemp58 * fTemp196 / fTemp56;
			double fTemp197 = fTemp60 * (fTemp188 - fRec169[1]) + fRec168[1];
			fRec168[0] = 2.0 * (fTemp197 / fTemp61) - fRec168[1];
			fRec169[0] = fRec169[1] + 2.0 * (fTemp60 * fTemp197 / fTemp61);
			double fRec170 = fTemp63 * fTemp197 / fTemp61;
			double fTemp198 = fTemp65 * (fTemp188 - fRec172[1]) + fRec171[1];
			fRec171[0] = 2.0 * (fTemp198 / fTemp66) - fRec171[1];
			fRec172[0] = fRec172[1] + 2.0 * (fTemp65 * fTemp198 / fTemp66);
			double fRec173 = fTemp68 * fTemp198 / fTemp66;
			double fTemp199 = fTemp71 * (fTemp188 - fRec175[1]) + fRec174[1];
			fRec174[0] = 2.0 * (fTemp199 / fTemp72) - fRec174[1];
			fRec175[0] = fRec175[1] + 2.0 * (fTemp71 * fTemp199 / fTemp72);
			double fRec176 = fTemp74 * fTemp199 / fTemp72;
			double fTemp200 = fTemp76 * (fTemp188 - fRec178[1]) + fRec177[1];
			fRec177[0] = 2.0 * (fTemp200 / fTemp77) - fRec177[1];
			fRec178[0] = fRec178[1] + 2.0 * (fTemp76 * fTemp200 / fTemp77);
			double fRec179 = fTemp79 * fTemp200 / fTemp77;
			double fTemp201 = fTemp81 * (fTemp188 - fRec181[1]) + fRec180[1];
			fRec180[0] = 2.0 * (fTemp201 / fTemp82) - fRec180[1];
			fRec181[0] = fRec181[1] + 2.0 * (fTemp81 * fTemp201 / fTemp82);
			double fRec182 = fTemp84 * fTemp201 / fTemp82;
			double fTemp202 = fTemp86 * (fTemp188 - fRec184[1]) + fRec183[1];
			fRec183[0] = 2.0 * (fTemp202 / fTemp87) - fRec183[1];
			fRec184[0] = fRec184[1] + 2.0 * (fTemp86 * fTemp202 / fTemp87);
			double fRec185 = fTemp89 * fTemp202 / fTemp87;
			double fTemp203 = fTemp91 * (fTemp188 - fRec187[1]) + fRec186[1];
			fRec186[0] = 2.0 * (fTemp203 / fTemp92) - fRec186[1];
			fRec187[0] = fRec187[1] + 2.0 * (fTemp91 * fTemp203 / fTemp92);
			double fRec188 = fTemp94 * fTemp203 / fTemp92;
			double fTemp204 = fTemp96 * (fTemp188 - fRec190[1]) + fRec189[1];
			fRec189[0] = 2.0 * (fTemp204 / fTemp97) - fRec189[1];
			fRec190[0] = fRec190[1] + 2.0 * (fTemp96 * fTemp204 / fTemp97);
			double fRec191 = fTemp99 * fTemp204 / fTemp97;
			double fTemp205 = fTemp101 * (fTemp188 - fRec193[1]) + fRec192[1];
			double fTemp206 = fTemp205 / fTemp102;
			fRec192[0] = 2.0 * fTemp206 - fRec192[1];
			fRec193[0] = fRec193[1] + 2.0 * (fTemp101 * fTemp205 / fTemp102);
			double fRec194 = fTemp206;
			double fTemp207 = fTemp106 * (fTemp188 - fRec196[1]) + fRec195[1];
			fRec195[0] = 2.0 * (fTemp207 / fTemp107) - fRec195[1];
			fRec196[0] = fRec196[1] + 2.0 * (fTemp106 * fTemp207 / fTemp107);
			double fRec197 = fTemp109 * fTemp207 / fTemp107;
			double fTemp208 = fTemp111 * (fTemp188 - fRec199[1]) + fRec198[1];
			fRec198[0] = 2.0 * (fTemp208 / fTemp112) - fRec198[1];
			fRec199[0] = fRec199[1] + 2.0 * (fTemp111 * fTemp208 / fTemp112);
			double fRec200 = fTemp114 * fTemp208 / fTemp112;
			double fTemp209 = fTemp116 * (fTemp188 - fRec202[1]) + fRec201[1];
			fRec201[0] = 2.0 * (fTemp209 / fTemp117) - fRec201[1];
			fRec202[0] = fRec202[1] + 2.0 * (fTemp116 * fTemp209 / fTemp117);
			double fRec203 = fTemp119 * fTemp209 / fTemp117;
			double fTemp210 = fTemp121 * (fTemp188 - fRec205[1]) + fRec204[1];
			fRec204[0] = 2.0 * (fTemp210 / fTemp122) - fRec204[1];
			fRec205[0] = fRec205[1] + 2.0 * (fTemp121 * fTemp210 / fTemp122);
			double fRec206 = fTemp124 * fTemp210 / fTemp122;
			double fTemp211 = fTemp126 * (fTemp188 - fRec208[1]) + fRec207[1];
			fRec207[0] = 2.0 * (fTemp211 / fTemp127) - fRec207[1];
			fRec208[0] = fRec208[1] + 2.0 * (fTemp126 * fTemp211 / fTemp127);
			double fRec209 = fTemp129 * fTemp211 / fTemp127;
			double fTemp212 = fTemp131 * (fTemp188 - fRec211[1]) + fRec210[1];
			fRec210[0] = 2.0 * (fTemp212 / fTemp132) - fRec210[1];
			fRec211[0] = fRec211[1] + 2.0 * (fTemp131 * fTemp212 / fTemp132);
			double fRec212 = fTemp134 * fTemp212 / fTemp132;
			double fTemp213 = fTemp136 * (fTemp188 - fRec214[1]) + fRec213[1];
			fRec213[0] = 2.0 * (fTemp213 / fTemp137) - fRec213[1];
			fRec214[0] = fRec214[1] + 2.0 * (fTemp136 * fTemp213 / fTemp137);
			double fRec215 = fTemp139 * fTemp213 / fTemp137;
			double fTemp214 = fTemp141 * (fTemp188 - fRec217[1]) + fRec216[1];
			fRec216[0] = 2.0 * (fTemp214 / fTemp142) - fRec216[1];
			fRec217[0] = fRec217[1] + 2.0 * (fTemp141 * fTemp214 / fTemp142);
			double fRec218 = fTemp144 * fTemp214 / fTemp142;
			double fTemp215 = fTemp146 * (fTemp188 - fRec220[1]) + fRec219[1];
			fRec219[0] = 2.0 * (fTemp215 / fTemp147) - fRec219[1];
			fRec220[0] = fRec220[1] + 2.0 * (fTemp146 * fTemp215 / fTemp147);
			double fRec221 = fTemp149 * fTemp215 / fTemp147;
			double fTemp216 = fTemp151 * (fTemp188 - fRec223[1]) + fRec222[1];
			fRec222[0] = 2.0 * (fTemp216 / fTemp152) - fRec222[1];
			fRec223[0] = fRec223[1] + 2.0 * (fTemp151 * fTemp216 / fTemp152);
			double fRec224 = fTemp154 * fTemp216 / fTemp152;
			double fTemp217 = fTemp156 * (fTemp188 - fRec226[1]) + fRec225[1];
			fRec225[0] = 2.0 * (fTemp217 / fTemp157) - fRec225[1];
			fRec226[0] = fRec226[1] + 2.0 * (fTemp156 * fTemp217 / fTemp157);
			double fRec227 = fTemp159 * fTemp217 / fTemp157;
			double fTemp218 = fTemp161 * (fTemp188 - fRec229[1]) + fRec228[1];
			fRec228[0] = 2.0 * (fTemp218 / fTemp162) - fRec228[1];
			fRec229[0] = fRec229[1] + 2.0 * (fTemp161 * fTemp218 / fTemp162);
			double fRec230 = fTemp164 * fTemp218 / fTemp162;
			double fTemp219 = fTemp166 * (fTemp188 - fRec232[1]) + fRec231[1];
			fRec231[0] = 2.0 * (fTemp219 / fTemp167) - fRec231[1];
			fRec232[0] = fRec232[1] + 2.0 * (fTemp166 * fTemp219 / fTemp167);
			double fRec233 = fTemp169 * fTemp219 / fTemp167;
			double fTemp220 = fTemp171 * (fTemp188 - fRec235[1]) + fRec234[1];
			fRec234[0] = 2.0 * (fTemp220 / fTemp172) - fRec234[1];
			fRec235[0] = fRec235[1] + 2.0 * (fTemp171 * fTemp220 / fTemp172);
			double fRec236 = fTemp174 * fTemp220 / fTemp172;
			double fTemp221 = fTemp176 * (fTemp188 - fRec238[1]) + fRec237[1];
			fRec237[0] = 2.0 * (fTemp221 / fTemp177) - fRec237[1];
			fRec238[0] = fRec238[1] + 2.0 * (fTemp176 * fTemp221 / fTemp177);
			double fRec239 = fTemp179 * fTemp221 / fTemp177;
			double fTemp222 = 0.03125 * fRec137[0] * (fRec239 + fRec236 + fRec233 + fRec230 + fRec227 + fRec224 + fRec221 + fRec218 + fRec215 + fRec212 + fRec209 + fRec206 + fRec203 + fRec200 + fRec197 + fRec194 + fRec191 + fRec188 + fRec185 + fRec182 + fRec179 + fRec176 + fRec173 + fRec170 + fRec167 + fRec164 + fRec161 + fRec158 + fRec155 + fRec152 + fRec149 + fRec146) + fRec36[0] * fTemp188;
			fRec138[0] = std::max<double>(fConst1 * fRec138[1], std::fabs(fTemp222));
			fVbargraph8 = FAUSTFLOAT(fRec138[0]);
			fRec19[0] = fTemp222;
			fVec5[0] = 1.6;
			double fTemp223 = 1.6 - fVec5[1];
			fRec244[0] = fSlow17 + fConst3 * fRec244[1];
			double fTemp224 = fRec28[0] * (fTemp7 * fTemp9 - fRec244[0] * fTemp183);
			double fTemp225 = fTemp185 + fTemp183;
			fVec6[0] = fTemp225 + fTemp224 + fTemp223;
			fRec243[0] = fTemp224 + 0.995 * fRec243[1] + fTemp225 + (1.6 - (fVec5[1] + fVec6[1]));
			fRec242[0] = std::max<double>(fConst1 * fRec242[1], std::fabs(fRec243[0]));
			fVbargraph9 = FAUSTFLOAT(fRec242[0]);
			double fTemp226 = fRec17[0] * tanh(fRec243[0] / fTemp4);
			fRec241[0] = std::max<double>(fConst1 * fRec241[1], std::fabs(fTemp226));
			fVbargraph10 = FAUSTFLOAT(fRec241[0]);
			double fTemp227 = fTemp226;
			double fTemp228 = fTemp20 * (fTemp227 - fRec246[1]) + fRec245[1];
			fRec245[0] = 2.0 * (fTemp228 / fTemp21) - fRec245[1];
			fRec246[0] = fRec246[1] + 2.0 * (fTemp20 * fTemp228 / fTemp21);
			double fRec247 = fTemp23 * fTemp228 / fTemp21;
			double fTemp229 = fTemp25 * (fTemp227 - fRec249[1]) + fRec248[1];
			fRec248[0] = 2.0 * (fTemp229 / fTemp26) - fRec248[1];
			fRec249[0] = fRec249[1] + 2.0 * (fTemp25 * fTemp229 / fTemp26);
			double fRec250 = fTemp28 * fTemp229 / fTemp26;
			double fTemp230 = fTemp30 * (fTemp227 - fRec252[1]) + fRec251[1];
			fRec251[0] = 2.0 * (fTemp230 / fTemp31) - fRec251[1];
			fRec252[0] = fRec252[1] + 2.0 * (fTemp30 * fTemp230 / fTemp31);
			double fRec253 = fTemp33 * fTemp230 / fTemp31;
			double fTemp231 = fTemp35 * (fTemp227 - fRec255[1]) + fRec254[1];
			fRec254[0] = 2.0 * (fTemp231 / fTemp36) - fRec254[1];
			fRec255[0] = fRec255[1] + 2.0 * (fTemp35 * fTemp231 / fTemp36);
			double fRec256 = fTemp38 * fTemp231 / fTemp36;
			double fTemp232 = fTemp40 * (fTemp227 - fRec258[1]) + fRec257[1];
			fRec257[0] = 2.0 * (fTemp232 / fTemp41) - fRec257[1];
			fRec258[0] = fRec258[1] + 2.0 * (fTemp40 * fTemp232 / fTemp41);
			double fRec259 = fTemp43 * fTemp232 / fTemp41;
			double fTemp233 = fTemp45 * (fTemp227 - fRec261[1]) + fRec260[1];
			fRec260[0] = 2.0 * (fTemp233 / fTemp46) - fRec260[1];
			fRec261[0] = fRec261[1] + 2.0 * (fTemp45 * fTemp233 / fTemp46);
			double fRec262 = fTemp48 * fTemp233 / fTemp46;
			double fTemp234 = fTemp50 * (fTemp227 - fRec264[1]) + fRec263[1];
			fRec263[0] = 2.0 * (fTemp234 / fTemp51) - fRec263[1];
			fRec264[0] = fRec264[1] + 2.0 * (fTemp50 * fTemp234 / fTemp51);
			double fRec265 = fTemp53 * fTemp234 / fTemp51;
			double fTemp235 = fTemp55 * (fTemp227 - fRec267[1]) + fRec266[1];
			fRec266[0] = 2.0 * (fTemp235 / fTemp56) - fRec266[1];
			fRec267[0] = fRec267[1] + 2.0 * (fTemp55 * fTemp235 / fTemp56);
			double fRec268 = fTemp58 * fTemp235 / fTemp56;
			double fTemp236 = fTemp60 * (fTemp227 - fRec270[1]) + fRec269[1];
			fRec269[0] = 2.0 * (fTemp236 / fTemp61) - fRec269[1];
			fRec270[0] = fRec270[1] + 2.0 * (fTemp60 * fTemp236 / fTemp61);
			double fRec271 = fTemp63 * fTemp236 / fTemp61;
			double fTemp237 = fTemp65 * (fTemp227 - fRec273[1]) + fRec272[1];
			fRec272[0] = 2.0 * (fTemp237 / fTemp66) - fRec272[1];
			fRec273[0] = fRec273[1] + 2.0 * (fTemp65 * fTemp237 / fTemp66);
			double fRec274 = fTemp68 * fTemp237 / fTemp66;
			double fTemp238 = fTemp71 * (fTemp227 - fRec276[1]) + fRec275[1];
			fRec275[0] = 2.0 * (fTemp238 / fTemp72) - fRec275[1];
			fRec276[0] = fRec276[1] + 2.0 * (fTemp71 * fTemp238 / fTemp72);
			double fRec277 = fTemp74 * fTemp238 / fTemp72;
			double fTemp239 = fTemp76 * (fTemp227 - fRec279[1]) + fRec278[1];
			fRec278[0] = 2.0 * (fTemp239 / fTemp77) - fRec278[1];
			fRec279[0] = fRec279[1] + 2.0 * (fTemp76 * fTemp239 / fTemp77);
			double fRec280 = fTemp79 * fTemp239 / fTemp77;
			double fTemp240 = fTemp81 * (fTemp227 - fRec282[1]) + fRec281[1];
			fRec281[0] = 2.0 * (fTemp240 / fTemp82) - fRec281[1];
			fRec282[0] = fRec282[1] + 2.0 * (fTemp81 * fTemp240 / fTemp82);
			double fRec283 = fTemp84 * fTemp240 / fTemp82;
			double fTemp241 = fTemp86 * (fTemp227 - fRec285[1]) + fRec284[1];
			fRec284[0] = 2.0 * (fTemp241 / fTemp87) - fRec284[1];
			fRec285[0] = fRec285[1] + 2.0 * (fTemp86 * fTemp241 / fTemp87);
			double fRec286 = fTemp89 * fTemp241 / fTemp87;
			double fTemp242 = fTemp91 * (fTemp227 - fRec288[1]) + fRec287[1];
			fRec287[0] = 2.0 * (fTemp242 / fTemp92) - fRec287[1];
			fRec288[0] = fRec288[1] + 2.0 * (fTemp91 * fTemp242 / fTemp92);
			double fRec289 = fTemp94 * fTemp242 / fTemp92;
			double fTemp243 = fTemp96 * (fTemp227 - fRec291[1]) + fRec290[1];
			fRec290[0] = 2.0 * (fTemp243 / fTemp97) - fRec290[1];
			fRec291[0] = fRec291[1] + 2.0 * (fTemp96 * fTemp243 / fTemp97);
			double fRec292 = fTemp99 * fTemp243 / fTemp97;
			double fTemp244 = fTemp101 * (fTemp227 - fRec294[1]) + fRec293[1];
			double fTemp245 = fTemp244 / fTemp102;
			fRec293[0] = 2.0 * fTemp245 - fRec293[1];
			fRec294[0] = fRec294[1] + 2.0 * (fTemp101 * fTemp244 / fTemp102);
			double fRec295 = fTemp245;
			double fTemp246 = fTemp106 * (fTemp227 - fRec297[1]) + fRec296[1];
			fRec296[0] = 2.0 * (fTemp246 / fTemp107) - fRec296[1];
			fRec297[0] = fRec297[1] + 2.0 * (fTemp106 * fTemp246 / fTemp107);
			double fRec298 = fTemp109 * fTemp246 / fTemp107;
			double fTemp247 = fTemp111 * (fTemp227 - fRec300[1]) + fRec299[1];
			fRec299[0] = 2.0 * (fTemp247 / fTemp112) - fRec299[1];
			fRec300[0] = fRec300[1] + 2.0 * (fTemp111 * fTemp247 / fTemp112);
			double fRec301 = fTemp114 * fTemp247 / fTemp112;
			double fTemp248 = fTemp116 * (fTemp227 - fRec303[1]) + fRec302[1];
			fRec302[0] = 2.0 * (fTemp248 / fTemp117) - fRec302[1];
			fRec303[0] = fRec303[1] + 2.0 * (fTemp116 * fTemp248 / fTemp117);
			double fRec304 = fTemp119 * fTemp248 / fTemp117;
			double fTemp249 = fTemp121 * (fTemp227 - fRec306[1]) + fRec305[1];
			fRec305[0] = 2.0 * (fTemp249 / fTemp122) - fRec305[1];
			fRec306[0] = fRec306[1] + 2.0 * (fTemp121 * fTemp249 / fTemp122);
			double fRec307 = fTemp124 * fTemp249 / fTemp122;
			double fTemp250 = fTemp126 * (fTemp227 - fRec309[1]) + fRec308[1];
			fRec308[0] = 2.0 * (fTemp250 / fTemp127) - fRec308[1];
			fRec309[0] = fRec309[1] + 2.0 * (fTemp126 * fTemp250 / fTemp127);
			double fRec310 = fTemp129 * fTemp250 / fTemp127;
			double fTemp251 = fTemp131 * (fTemp227 - fRec312[1]) + fRec311[1];
			fRec311[0] = 2.0 * (fTemp251 / fTemp132) - fRec311[1];
			fRec312[0] = fRec312[1] + 2.0 * (fTemp131 * fTemp251 / fTemp132);
			double fRec313 = fTemp134 * fTemp251 / fTemp132;
			double fTemp252 = fTemp136 * (fTemp227 - fRec315[1]) + fRec314[1];
			fRec314[0] = 2.0 * (fTemp252 / fTemp137) - fRec314[1];
			fRec315[0] = fRec315[1] + 2.0 * (fTemp136 * fTemp252 / fTemp137);
			double fRec316 = fTemp139 * fTemp252 / fTemp137;
			double fTemp253 = fTemp141 * (fTemp227 - fRec318[1]) + fRec317[1];
			fRec317[0] = 2.0 * (fTemp253 / fTemp142) - fRec317[1];
			fRec318[0] = fRec318[1] + 2.0 * (fTemp141 * fTemp253 / fTemp142);
			double fRec319 = fTemp144 * fTemp253 / fTemp142;
			double fTemp254 = fTemp146 * (fTemp227 - fRec321[1]) + fRec320[1];
			fRec320[0] = 2.0 * (fTemp254 / fTemp147) - fRec320[1];
			fRec321[0] = fRec321[1] + 2.0 * (fTemp146 * fTemp254 / fTemp147);
			double fRec322 = fTemp149 * fTemp254 / fTemp147;
			double fTemp255 = fTemp151 * (fTemp227 - fRec324[1]) + fRec323[1];
			fRec323[0] = 2.0 * (fTemp255 / fTemp152) - fRec323[1];
			fRec324[0] = fRec324[1] + 2.0 * (fTemp151 * fTemp255 / fTemp152);
			double fRec325 = fTemp154 * fTemp255 / fTemp152;
			double fTemp256 = fTemp156 * (fTemp227 - fRec327[1]) + fRec326[1];
			fRec326[0] = 2.0 * (fTemp256 / fTemp157) - fRec326[1];
			fRec327[0] = fRec327[1] + 2.0 * (fTemp156 * fTemp256 / fTemp157);
			double fRec328 = fTemp159 * fTemp256 / fTemp157;
			double fTemp257 = fTemp161 * (fTemp227 - fRec330[1]) + fRec329[1];
			fRec329[0] = 2.0 * (fTemp257 / fTemp162) - fRec329[1];
			fRec330[0] = fRec330[1] + 2.0 * (fTemp161 * fTemp257 / fTemp162);
			double fRec331 = fTemp164 * fTemp257 / fTemp162;
			double fTemp258 = fTemp166 * (fTemp227 - fRec333[1]) + fRec332[1];
			fRec332[0] = 2.0 * (fTemp258 / fTemp167) - fRec332[1];
			fRec333[0] = fRec333[1] + 2.0 * (fTemp166 * fTemp258 / fTemp167);
			double fRec334 = fTemp169 * fTemp258 / fTemp167;
			double fTemp259 = fTemp171 * (fTemp227 - fRec336[1]) + fRec335[1];
			fRec335[0] = 2.0 * (fTemp259 / fTemp172) - fRec335[1];
			fRec336[0] = fRec336[1] + 2.0 * (fTemp171 * fTemp259 / fTemp172);
			double fRec337 = fTemp174 * fTemp259 / fTemp172;
			double fTemp260 = fTemp176 * (fTemp227 - fRec339[1]) + fRec338[1];
			fRec338[0] = 2.0 * (fTemp260 / fTemp177) - fRec338[1];
			fRec339[0] = fRec339[1] + 2.0 * (fTemp176 * fTemp260 / fTemp177);
			double fRec340 = fTemp179 * fTemp260 / fTemp177;
			double fTemp261 = 0.03125 * fRec137[0] * (fRec340 + fRec337 + fRec334 + fRec331 + fRec328 + fRec325 + fRec322 + fRec319 + fRec316 + fRec313 + fRec310 + fRec307 + fRec304 + fRec301 + fRec298 + fRec295 + fRec292 + fRec289 + fRec286 + fRec283 + fRec280 + fRec277 + fRec274 + fRec271 + fRec268 + fRec265 + fRec262 + fRec259 + fRec256 + fRec253 + fRec250 + fRec247) + fRec36[0] * fTemp227;
			fRec240[0] = std::max<double>(fConst1 * fRec240[1], std::fabs(fTemp261));
			fVbargraph11 = FAUSTFLOAT(fRec240[0]);
			fRec20[0] = fTemp261;
			double fTemp262 = (fRec20[0] + fRec18[0] + fRec19[0]) / fTemp4;
			fVec7[IOTA0 & 4194303] = fTemp262;
			double fTemp263 = ((fRec341[1] != 0.0) ? (((fRec342[1] > 0.0) & (fRec342[1] < 1.0)) ? fRec341[1] : 0.0) : (((fRec342[1] == 0.0) & (fSlow18 != fRec343[1])) ? 0.0009765625 : (((fRec342[1] == 1.0) & (fSlow18 != fRec344[1])) ? -0.0009765625 : 0.0)));
			fRec341[0] = fTemp263;
			fRec342[0] = std::max<double>(0.0, std::min<double>(1.0, fRec342[1] + fTemp263));
			fRec343[0] = (((fRec342[1] >= 1.0) & (fRec344[1] != fSlow18)) ? fSlow18 : fRec343[1]);
			fRec344[0] = (((fRec342[1] <= 0.0) & (fRec343[1] != fSlow18)) ? fSlow18 : fRec344[1]);
			double fTemp264 = fVec7[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec343[0])))) & 4194303];
			fRec16[0] = 0.3333333333333333 * fTemp264 + fRec342[0] * (0.0 - 0.3333333333333333 * (fTemp264 - fVec7[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec344[0])))) & 4194303]));
			double fTemp265 = fRec26[0] * fRec346[1];
			fRec353[0] = std::max<double>(fConst1 * fRec353[1], std::fabs(fTemp265));
			fVbargraph12 = FAUSTFLOAT(fRec353[0]);
			double fTemp266 = fTemp265;
			double fTemp267 = fRec26[0] * fRec347[1];
			fRec354[0] = std::max<double>(fConst1 * fRec354[1], std::fabs(fTemp267));
			fVbargraph13 = FAUSTFLOAT(fRec354[0]);
			double fTemp268 = fTemp267;
			double fTemp269 = fTemp10 * (fTemp268 - fTemp266);
			double fTemp270 = fSlow19 * fRec11[1];
			fVec8[IOTA0 & 4194303] = fTemp270;
			double fTemp271 = ((fRec356[1] != 0.0) ? (((fRec357[1] > 0.0) & (fRec357[1] < 1.0)) ? fRec356[1] : 0.0) : (((fRec357[1] == 0.0) & (fSlow20 != fRec358[1])) ? 0.0009765625 : (((fRec357[1] == 1.0) & (fSlow20 != fRec359[1])) ? -0.0009765625 : 0.0)));
			fRec356[0] = fTemp271;
			fRec357[0] = std::max<double>(0.0, std::min<double>(1.0, fRec357[1] + fTemp271));
			fRec358[0] = (((fRec357[1] >= 1.0) & (fRec359[1] != fSlow20)) ? fSlow20 : fRec358[1]);
			fRec359[0] = (((fRec357[1] <= 0.0) & (fRec358[1] != fSlow20)) ? fSlow20 : fRec359[1]);
			double fTemp272 = fVec8[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec358[0])))) & 4194303];
			fRec355[0] = fTemp272 + fRec357[0] * (fVec8[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec359[0])))) & 4194303] - fTemp272);
			fVec9[0] = fRec355[1] + fTemp12 + fTemp266 + fTemp269 + fTemp5;
			fRec352[0] = fTemp269 + fRec355[1] + fTemp266 + fTemp12 + 0.995 * fRec352[1] + (1.2 - (fVec0[1] + fVec9[1]));
			fRec351[0] = std::max<double>(fConst1 * fRec351[1], std::fabs(fRec352[0]));
			fVbargraph14 = FAUSTFLOAT(fRec351[0]);
			double fTemp273 = fRec17[0] * tanh(fRec352[0] / fTemp4);
			fRec350[0] = std::max<double>(fConst1 * fRec350[1], std::fabs(fTemp273));
			fVbargraph15 = FAUSTFLOAT(fRec350[0]);
			double fTemp274 = fTemp273;
			fRec363[0] = fSlow21 + fConst3 * fRec363[1];
			fRec364[0] = fSlow22 + fConst3 * fRec364[1];
			fRec365[0] = fSlow23 + fConst3 * fRec365[1];
			double fTemp275 = fRec365[0] * (561.0 * fRec363[0] + fRec364[0] * (562.0 - 1097.0 * fRec363[0]) + 221.0);
			double fTemp276 = std::tan(fConst5 * fTemp275);
			double fTemp277 = fTemp276 * (fTemp276 + fTemp19 / fTemp275) + 1.0;
			double fTemp278 = fTemp276 * (fTemp274 - fRec361[1]) + fRec360[1];
			fRec360[0] = 2.0 * (fTemp278 / fTemp277) - fRec360[1];
			fRec361[0] = fRec361[1] + 2.0 * (fTemp276 * fTemp278 / fTemp277);
			double fTemp279 = fRec364[0] * (0.20948251265282836 * fRec363[0] + -0.35882756573771113) + (0.883508750371294 - 0.3295246174054942 * fRec363[0]);
			double fRec362 = fTemp278 * fTemp279 / fTemp277;
			double fTemp280 = fRec365[0] * (1048.0 * fRec363[0] + fRec364[0] * (1.07e+03 * fRec363[0] + -787.0) + 1619.0);
			double fTemp281 = std::tan(fConst5 * fTemp280);
			double fTemp282 = fTemp281 * (fTemp281 + fTemp19 / fTemp280) + 1.0;
			double fTemp283 = fTemp281 * (fTemp274 - fRec367[1]) + fRec366[1];
			fRec366[0] = 2.0 * (fTemp283 / fTemp282) - fRec366[1];
			fRec367[0] = fRec367[1] + 2.0 * (fTemp281 * fTemp283 / fTemp282);
			double fTemp284 = fRec364[0] * (0.0016935641831933154 * fRec363[0] + -0.0070591277129707815) + (0.014962909727368317 - 0.007613896970744654 * fRec363[0]);
			double fRec368 = fTemp283 * fTemp284 / fTemp282;
			double fTemp285 = fRec365[0] * (687.0 * fRec363[0] + fRec364[0] * (311.0 - 2032.0 * fRec363[0]) + 2429.0);
			double fTemp286 = std::tan(fConst5 * fTemp285);
			double fTemp287 = fTemp286 * (fTemp286 + fTemp19 / fTemp285) + 1.0;
			double fTemp288 = fTemp286 * (fTemp274 - fRec370[1]) + fRec369[1];
			fRec369[0] = 2.0 * (fTemp288 / fTemp287) - fRec369[1];
			fRec370[0] = fRec370[1] + 2.0 * (fTemp286 * fTemp288 / fTemp287);
			double fTemp289 = fRec364[0] * (0.005227226473626777 * fRec363[0] + -0.010433410102575844) + (0.01934635943322834 - 0.010538363987102131 * fRec363[0]);
			double fRec371 = fTemp288 * fTemp289 / fTemp287;
			double fTemp290 = fRec365[0] * (1422.0 * fRec363[0] + fRec364[0] * (-4.0 - 526.0 * fRec363[0]) + 1178.0);
			double fTemp291 = std::tan(fConst5 * fTemp290);
			double fTemp292 = fTemp291 * (fTemp291 + fTemp19 / fTemp290) + 1.0;
			double fTemp293 = fTemp291 * (fTemp274 - fRec373[1]) + fRec372[1];
			fRec372[0] = 2.0 * (fTemp293 / fTemp292) - fRec372[1];
			fRec373[0] = fRec373[1] + 2.0 * (fTemp291 * fTemp293 / fTemp292);
			double fTemp294 = fRec364[0] * (0.0015990719330448112 * fRec363[0] + -0.009377259975676547) + (0.020502590513884294 - 0.008575258476103987 * fRec363[0]);
			double fRec374 = fTemp293 * fTemp294 / fTemp292;
			double fTemp295 = fRec365[0] * (1005.0 * fRec363[0] + fRec364[0] * (1538.0 - 1969.0 * fRec363[0]) + 1398.0);
			double fTemp296 = std::tan(fConst5 * fTemp295);
			double fTemp297 = fTemp296 * (fTemp296 + fTemp19 / fTemp295) + 1.0;
			double fTemp298 = fTemp296 * (fTemp274 - fRec376[1]) + fRec375[1];
			fRec375[0] = 2.0 * (fTemp298 / fTemp297) - fRec375[1];
			fRec376[0] = fRec376[1] + 2.0 * (fTemp296 * fTemp298 / fTemp297);
			double fTemp299 = fRec364[0] * (-0.004224308163056342 - 0.007247221109719737 * fRec363[0]) + (0.020955020563014883 - 0.004499122746580129 * fRec363[0]);
			double fRec377 = fTemp298 * fTemp299 / fTemp297;
			double fTemp300 = fRec365[0] * (726.0 * fRec363[0] + fRec364[0] * (507.0 - 2138.0 * fRec363[0]) + 2135.0);
			double fTemp301 = std::tan(fConst5 * fTemp300);
			double fTemp302 = fTemp301 * (fTemp301 + fTemp19 / fTemp300) + 1.0;
			double fTemp303 = fTemp301 * (fTemp274 - fRec379[1]) + fRec378[1];
			fRec378[0] = 2.0 * (fTemp303 / fTemp302) - fRec378[1];
			fRec379[0] = fRec379[1] + 2.0 * (fTemp301 * fTemp303 / fTemp302);
			double fTemp304 = fRec364[0] * (0.0009039247818369497 - 0.013893501673791466 * fRec363[0]) + (0.02359690477324046 - 0.005322076674786635 * fRec363[0]);
			double fRec380 = fTemp303 * fTemp304 / fTemp302;
			double fTemp305 = fRec365[0] * (125.0 * fRec363[0] + fRec364[0] * (9e+01 - 7.0 * fRec363[0]) + 2356.0);
			double fTemp306 = std::tan(fConst5 * fTemp305);
			double fTemp307 = fTemp306 * (fTemp306 + fTemp19 / fTemp305) + 1.0;
			double fTemp308 = fTemp306 * (fTemp274 - fRec382[1]) + fRec381[1];
			fRec381[0] = 2.0 * (fTemp308 / fTemp307) - fRec381[1];
			fRec382[0] = fRec382[1] + 2.0 * (fTemp306 * fTemp308 / fTemp307);
			double fTemp309 = fRec364[0] * (0.00789733404453236 - 0.022269972441420545 * fRec363[0]) + (0.024970356245165314 - 0.004948333836676418 * fRec363[0]);
			double fRec383 = fTemp308 * fTemp309 / fTemp307;
			double fTemp310 = fRec365[0] * (74.0 * fRec363[0] + fRec364[0] * (1147.0 - 837.0 * fRec363[0]) + 1104.0);
			double fTemp311 = std::tan(fConst5 * fTemp310);
			double fTemp312 = fTemp311 * (fTemp311 + fTemp19 / fTemp310) + 1.0;
			double fTemp313 = fTemp311 * (fTemp274 - fRec385[1]) + fRec384[1];
			fRec384[0] = 2.0 * (fTemp313 / fTemp312) - fRec384[1];
			fRec385[0] = fRec385[1] + 2.0 * (fTemp311 * fTemp313 / fTemp312);
			double fTemp314 = fRec364[0] * (0.014369998843206975 - 0.03300092964654322 * fRec363[0]) + (0.025519908386620865 - 0.0011683893550737713 * fRec363[0]);
			double fRec386 = fTemp313 * fTemp314 / fTemp312;
			double fTemp315 = fRec365[0] * (fRec364[0] * (241.0 * fRec363[0] + 6.3e+02) + (1914.0 - 1472.0 * fRec363[0]));
			double fTemp316 = std::tan(fConst5 * fTemp315);
			double fTemp317 = fTemp316 * (fTemp316 + fTemp19 / fTemp315) + 1.0;
			double fTemp318 = fTemp316 * (fTemp274 - fRec388[1]) + fRec387[1];
			fRec387[0] = 2.0 * (fTemp318 / fTemp317) - fRec387[1];
			fRec388[0] = fRec388[1] + 2.0 * (fTemp316 * fTemp318 / fTemp317);
			double fTemp319 = fRec364[0] * (0.012092025104768513 - 0.030118723258832435 * fRec363[0]) + (0.034299901561064564 - 0.009167713045154305 * fRec363[0]);
			double fRec389 = fTemp318 * fTemp319 / fTemp317;
			double fTemp320 = fRec365[0] * (403.0 * fRec363[0] + fRec364[0] * (1123.0 - 898.0 * fRec363[0]) + 1.03e+03);
			double fTemp321 = std::tan(fConst5 * fTemp320);
			double fTemp322 = fTemp321 * (fTemp321 + fTemp19 / fTemp320) + 1.0;
			double fTemp323 = fTemp321 * (fTemp274 - fRec391[1]) + fRec390[1];
			fRec390[0] = 2.0 * (fTemp323 / fTemp322) - fRec390[1];
			fRec391[0] = fRec391[1] + 2.0 * (fTemp321 * fTemp323 / fTemp322);
			double fTemp324 = fRec364[0] * (0.021778225322525664 - 0.04184590502930971 * fRec363[0]) + (0.03695324484801036 - 0.00815043374124962 * fRec363[0]);
			double fRec392 = fTemp323 * fTemp324 / fTemp322;
			double fTemp325 = 6.0 * fRec363[0];
			double fTemp326 = fRec365[0] * (fTemp325 + fRec364[0] * (838.0 * fRec363[0] + -812.0) + 1693.0);
			double fTemp327 = std::tan(fConst5 * fTemp326);
			double fTemp328 = fTemp327 * (fTemp327 + fTemp19 / fTemp326) + 1.0;
			double fTemp329 = fTemp327 * (fTemp274 - fRec394[1]) + fRec393[1];
			fRec393[0] = 2.0 * (fTemp329 / fTemp328) - fRec393[1];
			fRec394[0] = fRec394[1] + 2.0 * (fTemp327 * fTemp329 / fTemp328);
			double fTemp330 = fRec364[0] * (0.01054367849960227 - 0.044428922548055166 * fRec363[0]) + (0.04993743413946004 - 0.006818779501746489 * fRec363[0]);
			double fRec395 = fTemp329 * fTemp330 / fTemp328;
			double fTemp331 = fRec365[0] * (209.0 * fRec363[0] + fRec364[0] * (1515.0 - 1507.0 * fRec363[0]) + 442.0);
			double fTemp332 = std::tan(fConst5 * fTemp331);
			double fTemp333 = fTemp332 * (fTemp332 + fTemp19 / fTemp331) + 1.0;
			double fTemp334 = fTemp332 * (fTemp274 - fRec397[1]) + fRec396[1];
			fRec396[0] = 2.0 * (fTemp334 / fTemp333) - fRec396[1];
			fRec397[0] = fRec397[1] + 2.0 * (fTemp332 * fTemp334 / fTemp333);
			double fTemp335 = fRec364[0] * (-0.00836319425786336 - 0.027213728546822337 * fRec363[0]) + (0.07568694217870818 - 0.01847465835663161 * fRec363[0]);
			double fRec398 = fTemp334 * fTemp335 / fTemp333;
			double fTemp336 = fRec365[0] * (675.0 * fRec363[0] + fRec364[0] * (1172.0 - 1989.0 * fRec363[0]) + 883.0);
			double fTemp337 = std::tan(fConst5 * fTemp336);
			double fTemp338 = fTemp337 * (fTemp337 + fTemp19 / fTemp336) + 1.0;
			double fTemp339 = fTemp337 * (fTemp274 - fRec400[1]) + fRec399[1];
			fRec399[0] = 2.0 * (fTemp339 / fTemp338) - fRec399[1];
			fRec400[0] = fRec400[1] + 2.0 * (fTemp337 * fTemp339 / fTemp338);
			double fTemp340 = fRec364[0] * (0.01667332967615094 * fRec363[0] + -0.0754718266524771) + (0.15388399774271314 - 0.05838064149040649 * fRec363[0]);
			double fRec401 = fTemp339 * fTemp340 / fTemp338;
			double fTemp341 = fRec365[0] * (1.36e+03 * fRec363[0] + fRec364[0] * (-1e+02 - 1025.0 * fRec363[0]) + 589.0);
			double fTemp342 = std::tan(fConst5 * fTemp341);
			double fTemp343 = fTemp342 * (fTemp342 + fTemp19 / fTemp341) + 1.0;
			double fTemp344 = fTemp342 * (fTemp274 - fRec403[1]) + fRec402[1];
			fRec402[0] = 2.0 * (fTemp344 / fTemp343) - fRec402[1];
			fRec403[0] = fRec403[1] + 2.0 * (fTemp342 * fTemp344 / fTemp343);
			double fTemp345 = 0.012026367628721973 * fRec363[0] + fRec364[0] * (-0.03484164734028006 - 0.07088469349182304 * fRec363[0]) + 0.15986608084324763;
			double fRec404 = fTemp344 * fTemp345 / fTemp343;
			double fTemp346 = fRec365[0] * (fRec364[0] * (-51.0 - 11.0 * fRec363[0]) + (736.0 - 345.0 * fRec363[0]));
			double fTemp347 = std::tan(fConst5 * fTemp346);
			double fTemp348 = fTemp347 * (fTemp347 + fTemp19 / fTemp346) + 1.0;
			double fTemp349 = fTemp347 * (fTemp274 - fRec406[1]) + fRec405[1];
			fRec405[0] = 2.0 * (fTemp349 / fTemp348) - fRec405[1];
			fRec406[0] = fRec406[1] + 2.0 * (fTemp347 * fTemp349 / fTemp348);
			double fTemp350 = 0.043418834059638534 * fRec363[0] + fRec364[0] * (0.0003590165583120808 - 0.1653942291667907 * fRec363[0]) + 0.2004373971446242;
			double fRec407 = fTemp349 * fTemp350 / fTemp348;
			double fTemp351 = fRec365[0] * (113.0 * fRec363[0] + fRec364[0] * (147.0 - 325.0 * fRec363[0]) + 147.0);
			double fTemp352 = std::tan(fConst5 * fTemp351);
			double fTemp353 = fTemp352 * (fTemp352 + fTemp19 / fTemp351) + 1.0;
			double fTemp354 = fTemp352 * (fTemp274 - fRec409[1]) + fRec408[1];
			fRec408[0] = 2.0 * (fTemp354 / fTemp353) - fRec408[1];
			fRec409[0] = fRec409[1] + 2.0 * (fTemp352 * fTemp354 / fTemp353);
			double fTemp355 = fRec364[0] * (-0.20926865897501318 - 0.10045148502362689 * fRec363[0]) + (0.6105272358722508 - 0.05775171174785887 * fRec363[0]);
			double fRec410 = fTemp354 * fTemp355 / fTemp353;
			double fTemp356 = fRec365[0] * (fRec364[0] * (306.0 * fRec363[0] + -2.7e+02) + (368.0 - 239.0 * fRec363[0]));
			double fTemp357 = std::tan(fConst5 * fTemp356);
			double fTemp358 = fTemp357 * (fTemp357 + fTemp19 / fTemp356) + 1.0;
			double fTemp359 = fTemp357 * (fTemp274 - fRec412[1]) + fRec411[1];
			double fTemp360 = fTemp359 / fTemp358;
			fRec411[0] = 2.0 * fTemp360 - fRec411[1];
			fRec412[0] = fRec412[1] + 2.0 * (fTemp357 * fTemp359 / fTemp358);
			double fRec413 = fTemp360;
			double fTemp361 = fRec365[0] * (fTemp325 + fRec364[0] * (72.0 - 181.0 * fRec363[0]) + 515.0);
			double fTemp362 = std::tan(fConst5 * fTemp361);
			double fTemp363 = fTemp362 * (fTemp362 + fTemp19 / fTemp361) + 1.0;
			double fTemp364 = fTemp362 * (fTemp274 - fRec415[1]) + fRec414[1];
			fRec414[0] = 2.0 * (fTemp364 / fTemp363) - fRec414[1];
			fRec415[0] = fRec415[1] + 2.0 * (fTemp362 * fTemp364 / fTemp363);
			double fTemp365 = 0.1297691905274158 * fRec363[0] + fRec364[0] * (-0.020679500617239138 - 0.26354737961410307 * fRec363[0]) + 0.25009984168236576;
			double fRec416 = fTemp364 * fTemp365 / fTemp363;
			double fTemp366 = fRec365[0] * (968.0 * fRec363[0] + fRec364[0] * (122.0 - 588.0 * fRec363[0]) + 74.0);
			double fTemp367 = std::tan(fConst5 * fTemp366);
			double fTemp368 = fTemp367 * (fTemp367 + fTemp19 / fTemp366) + 1.0;
			double fTemp369 = fTemp367 * (fTemp274 - fRec418[1]) + fRec417[1];
			fRec417[0] = 2.0 * (fTemp369 / fTemp368) - fRec417[1];
			fRec418[0] = fRec418[1] + 2.0 * (fTemp367 * fTemp369 / fTemp368);
			double fTemp370 = fRec364[0] * (-0.00905548290563929 - 0.10407317928289174 * fRec363[0]) + (0.19782531572463796 - 0.011967933866223551 * fRec363[0]);
			double fRec419 = fTemp369 * fTemp370 / fTemp368;
			double fTemp371 = fRec365[0] * (102.0 * fRec363[0] + fRec364[0] * (756.0 - 762.0 * fRec363[0]) + 8.1e+02);
			double fTemp372 = std::tan(fConst5 * fTemp371);
			double fTemp373 = fTemp372 * (fTemp372 + fTemp19 / fTemp371) + 1.0;
			double fTemp374 = fTemp372 * (fTemp274 - fRec421[1]) + fRec420[1];
			fRec420[0] = 2.0 * (fTemp374 / fTemp373) - fRec420[1];
			fRec421[0] = fRec421[1] + 2.0 * (fTemp372 * fTemp374 / fTemp373);
			double fTemp375 = fRec364[0] * (-0.06073025380607225 - 0.02103357250515689 * fRec363[0]) + (0.15408867955329245 - 0.01859664908410899 * fRec363[0]);
			double fRec422 = fTemp374 * fTemp375 / fTemp373;
			double fTemp376 = fRec365[0] * (1784.0 * fRec363[0] + fRec364[0] * (96.0 - 1681.0 * fRec363[0]) + 295.0);
			double fTemp377 = std::tan(fConst5 * fTemp376);
			double fTemp378 = fTemp377 * (fTemp377 + fTemp19 / fTemp376) + 1.0;
			double fTemp379 = fTemp377 * (fTemp274 - fRec424[1]) + fRec423[1];
			fRec423[0] = 2.0 * (fTemp379 / fTemp378) - fRec423[1];
			fRec424[0] = fRec424[1] + 2.0 * (fTemp377 * fTemp379 / fTemp378);
			double fTemp380 = fRec364[0] * (0.00832579588520789 * fRec363[0] + -0.044200755516049905) + (0.12206611629626225 - 0.05880265929429268 * fRec363[0]);
			double fRec425 = fTemp379 * fTemp380 / fTemp378;
			double fTemp381 = fRec365[0] * (1689.0 * fRec363[0] + fRec364[0] * (806.0 - 1597.0 * fRec363[0]) + 662.0);
			double fTemp382 = std::tan(fConst5 * fTemp381);
			double fTemp383 = fTemp382 * (fTemp382 + fTemp19 / fTemp381) + 1.0;
			double fTemp384 = fTemp382 * (fTemp274 - fRec427[1]) + fRec426[1];
			fRec426[0] = 2.0 * (fTemp384 / fTemp383) - fRec426[1];
			fRec427[0] = fRec427[1] + 2.0 * (fTemp382 * fTemp384 / fTemp383);
			double fTemp385 = fRec364[0] * (-0.010952558243701213 - 0.024561127441574723 * fRec363[0]) + (0.0749419685950924 - 0.028820358890550887 * fRec363[0]);
			double fRec428 = fTemp384 * fTemp385 / fTemp383;
			double fTemp386 = fRec365[0] * (1265.0 * fRec363[0] + fRec364[0] * (1.2e+02 - 1.27e+03 * fRec363[0]) + 956.0);
			double fTemp387 = std::tan(fConst5 * fTemp386);
			double fTemp388 = fTemp387 * (fTemp387 + fTemp19 / fTemp386) + 1.0;
			double fTemp389 = fTemp387 * (fTemp274 - fRec430[1]) + fRec429[1];
			fRec429[0] = 2.0 * (fTemp389 / fTemp388) - fRec429[1];
			fRec430[0] = fRec430[1] + 2.0 * (fTemp387 * fTemp389 / fTemp388);
			double fTemp390 = fRec364[0] * (0.016194260220710646 - 0.04017164138792575 * fRec363[0]) + (0.04296305701601583 - 0.009998228849321458 * fRec363[0]);
			double fRec431 = fTemp389 * fTemp390 / fTemp388;
			double fTemp391 = fRec365[0] * (fRec364[0] * (951.0 * fRec363[0] + -618.0) + (2282.0 - 463.0 * fRec363[0]));
			double fTemp392 = std::tan(fConst5 * fTemp391);
			double fTemp393 = fTemp392 * (fTemp392 + fTemp19 / fTemp391) + 1.0;
			double fTemp394 = fTemp392 * (fTemp274 - fRec433[1]) + fRec432[1];
			fRec432[0] = 2.0 * (fTemp394 / fTemp393) - fRec432[1];
			fRec433[0] = fRec433[1] + 2.0 * (fTemp392 * fTemp394 / fTemp393);
			double fTemp395 = fRec364[0] * (0.015993820877451798 - 0.03561073091810513 * fRec363[0]) + (0.035190168499954565 - 0.007711275872944394 * fRec363[0]);
			double fRec434 = fTemp394 * fTemp395 / fTemp393;
			double fTemp396 = fRec365[0] * (fRec364[0] * (803.0 - 1117.0 * fRec363[0]) + (1546.0 - 238.0 * fRec363[0]));
			double fTemp397 = std::tan(fConst5 * fTemp396);
			double fTemp398 = fTemp397 * (fTemp397 + fTemp19 / fTemp396) + 1.0;
			double fTemp399 = fTemp397 * (fTemp274 - fRec436[1]) + fRec435[1];
			fRec435[0] = 2.0 * (fTemp399 / fTemp398) - fRec435[1];
			fRec436[0] = fRec436[1] + 2.0 * (fTemp397 * fTemp399 / fTemp398);
			double fTemp400 = fRec364[0] * (0.012251807773129418 - 0.030545193317676356 * fRec363[0]) + (0.027814420294695608 - 0.002830824883261286 * fRec363[0]);
			double fRec437 = fTemp399 * fTemp400 / fTemp398;
			double fTemp401 = fRec365[0] * (fRec364[0] * (1.34e+03 * fRec363[0] + -102.0) + (1472.0 - 903.0 * fRec363[0]));
			double fTemp402 = std::tan(fConst5 * fTemp401);
			double fTemp403 = fTemp402 * (fTemp402 + fTemp19 / fTemp401) + 1.0;
			double fTemp404 = fTemp402 * (fTemp274 - fRec439[1]) + fRec438[1];
			fRec438[0] = 2.0 * (fTemp404 / fTemp403) - fRec438[1];
			fRec439[0] = fRec439[1] + 2.0 * (fTemp402 * fTemp404 / fTemp403);
			double fTemp405 = fRec364[0] * (0.008006093262504007 - 0.024671130121872657 * fRec363[0]) + (0.025451275008886335 - 0.003130799157219928 * fRec363[0]);
			double fRec440 = fTemp404 * fTemp405 / fTemp403;
			double fTemp406 = fRec365[0] * (fRec364[0] * (861.0 * fRec363[0] + -1231.0) + (2503.0 - 228.0 * fRec363[0]));
			double fTemp407 = std::tan(fConst5 * fTemp406);
			double fTemp408 = fTemp407 * (fTemp407 + fTemp19 / fTemp406) + 1.0;
			double fTemp409 = fTemp407 * (fTemp274 - fRec442[1]) + fRec441[1];
			fRec441[0] = 2.0 * (fTemp409 / fTemp408) - fRec441[1];
			fRec442[0] = fRec442[1] + 2.0 * (fTemp407 * fTemp409 / fTemp408);
			double fTemp410 = fRec364[0] * (0.002393508230319367 - 0.01643892312610763 * fRec363[0]) + (0.02376619002590769 - 0.004291546045942368 * fRec363[0]);
			double fRec443 = fTemp409 * fTemp410 / fTemp408;
			double fTemp411 = fRec365[0] * (1281.0 * fRec363[0] + fRec364[0] * (37.0 * fRec363[0] + -273.0) + 1251.0);
			double fTemp412 = std::tan(fConst5 * fTemp411);
			double fTemp413 = fTemp412 * (fTemp412 + fTemp19 / fTemp411) + 1.0;
			double fTemp414 = fTemp412 * (fTemp274 - fRec445[1]) + fRec444[1];
			fRec444[0] = 2.0 * (fTemp414 / fTemp413) - fRec444[1];
			fRec445[0] = fRec445[1] + 2.0 * (fTemp412 * fTemp414 / fTemp413);
			double fTemp415 = fRec364[0] * (0.001634210217413834 - 0.013674190403903216 * fRec363[0]) + (0.02108580284017779 - 0.003933981224376031 * fRec363[0]);
			double fRec446 = fTemp414 * fTemp415 / fTemp413;
			double fTemp416 = fRec365[0] * (1666.0 * fRec363[0] + fRec364[0] * (436.0 - 1213.0 * fRec363[0]) + 1325.0);
			double fTemp417 = std::tan(fConst5 * fTemp416);
			double fTemp418 = fTemp417 * (fTemp417 + fTemp19 / fTemp416) + 1.0;
			double fTemp419 = fTemp417 * (fTemp274 - fRec448[1]) + fRec447[1];
			fRec447[0] = 2.0 * (fTemp419 / fTemp418) - fRec447[1];
			fRec448[0] = fRec448[1] + 2.0 * (fTemp417 * fTemp419 / fTemp418);
			double fTemp420 = fRec364[0] * (-0.006947658589813211 - 0.0032192382202462302 * fRec363[0]) + (0.02080994218773682 - 0.006343538597854104 * fRec363[0]);
			double fRec449 = fTemp419 * fTemp420 / fTemp418;
			double fTemp421 = fRec365[0] * (81.0 * fRec363[0] + fRec364[0] * (972.0 - 715.0 * fRec363[0]) + 2061.0);
			double fTemp422 = std::tan(fConst5 * fTemp421);
			double fTemp423 = fTemp422 * (fTemp422 + fTemp19 / fTemp421) + 1.0;
			double fTemp424 = fTemp422 * (fTemp274 - fRec451[1]) + fRec450[1];
			fRec450[0] = 2.0 * (fTemp424 / fTemp423) - fRec450[1];
			fRec451[0] = fRec451[1] + 2.0 * (fTemp422 * fTemp424 / fTemp423);
			double fTemp425 = fRec364[0] * (0.0021589052725694453 * fRec363[0] + -0.008904165411473826) + (0.019359564369447416 - 0.008690192954800124 * fRec363[0]);
			double fRec452 = fTemp424 * fTemp425 / fTemp423;
			double fTemp426 = fRec365[0] * (fRec364[0] * (1.02e+03 - 1.62e+03 * fRec363[0]) + (2209.0 - 456.0 * fRec363[0]));
			double fTemp427 = std::tan(fConst5 * fTemp426);
			double fTemp428 = fTemp427 * (fTemp427 + fTemp19 / fTemp426) + 1.0;
			double fTemp429 = fTemp427 * (fTemp274 - fRec454[1]) + fRec453[1];
			fRec453[0] = 2.0 * (fTemp429 / fTemp428) - fRec453[1];
			fRec454[0] = fRec454[1] + 2.0 * (fTemp427 * fTemp429 / fTemp428);
			double fTemp430 = fRec364[0] * (0.005044160613158476 * fRec363[0] + -0.01013056637869131) + (0.018745547950376563 - 0.011232336533809374 * fRec363[0]);
			double fRec455 = fTemp429 * fTemp430 / fTemp428;
			double fTemp431 = fRec365[0] * (805.0 * fRec363[0] + fRec364[0] * (266.0 - 7.7e+02 * fRec363[0]) + 2572.0);
			double fTemp432 = std::tan(fConst5 * fTemp431);
			double fTemp433 = fTemp432 * (fTemp432 + fTemp19 / fTemp431) + 1.0;
			double fTemp434 = fTemp432 * (fTemp274 - fRec457[1]) + fRec456[1];
			fRec456[0] = 2.0 * (fTemp434 / fTemp433) - fRec456[1];
			fRec457[0] = fRec457[1] + 2.0 * (fTemp432 * fTemp434 / fTemp433);
			double fTemp435 = fRec364[0] * (0.0016378452192321808 * fRec363[0] + -0.004344936518553382) + (0.011249397635411025 - 0.006780823623904783 * fRec363[0]);
			double fRec458 = fTemp434 * fTemp435 / fTemp433;
			double fTemp436 = 0.03125 * fRec137[0] * (fRec458 + fRec455 + fRec452 + fRec449 + fRec446 + fRec443 + fRec440 + fRec437 + fRec434 + fRec431 + fRec428 + fRec425 + fRec422 + fRec419 + fRec416 + fRec413 + fRec410 + fRec407 + fRec404 + fRec401 + fRec398 + fRec395 + fRec392 + fRec389 + fRec386 + fRec383 + fRec380 + fRec377 + fRec374 + fRec371 + fRec368 + fRec362) + fRec36[0] * fTemp274;
			fRec349[0] = std::max<double>(fConst1 * fRec349[1], std::fabs(fTemp436));
			fVbargraph16 = FAUSTFLOAT(fRec349[0]);
			fRec346[0] = fTemp436;
			double fTemp437 = fRec26[0] * fRec348[1];
			fRec463[0] = std::max<double>(fConst1 * fRec463[1], std::fabs(fTemp437));
			fVbargraph17 = FAUSTFLOAT(fRec463[0]);
			double fTemp438 = fTemp437;
			double fTemp439 = fRec28[0] * (fTemp266 * (fRec143[0] - fTemp438) - fTemp268);
			double fTemp440 = fTemp12 + fRec355[1];
			double fTemp441 = fTemp440 + fTemp268;
			fVec10[0] = fTemp441 + fTemp439 + fTemp181;
			fRec462[0] = fTemp439 + 0.995 * fRec462[1] + fTemp441 + (1.3 - (fVec3[1] + fVec10[1]));
			fRec461[0] = std::max<double>(fConst1 * fRec461[1], std::fabs(fRec462[0]));
			fVbargraph18 = FAUSTFLOAT(fRec461[0]);
			double fTemp442 = fRec17[0] * tanh(fRec462[0] / fTemp4);
			fRec460[0] = std::max<double>(fConst1 * fRec460[1], std::fabs(fTemp442));
			fVbargraph19 = FAUSTFLOAT(fRec460[0]);
			double fTemp443 = fTemp442;
			double fTemp444 = fTemp276 * (fTemp443 - fRec465[1]) + fRec464[1];
			fRec464[0] = 2.0 * (fTemp444 / fTemp277) - fRec464[1];
			fRec465[0] = fRec465[1] + 2.0 * (fTemp276 * fTemp444 / fTemp277);
			double fRec466 = fTemp279 * fTemp444 / fTemp277;
			double fTemp445 = fTemp281 * (fTemp443 - fRec468[1]) + fRec467[1];
			fRec467[0] = 2.0 * (fTemp445 / fTemp282) - fRec467[1];
			fRec468[0] = fRec468[1] + 2.0 * (fTemp281 * fTemp445 / fTemp282);
			double fRec469 = fTemp284 * fTemp445 / fTemp282;
			double fTemp446 = fTemp286 * (fTemp443 - fRec471[1]) + fRec470[1];
			fRec470[0] = 2.0 * (fTemp446 / fTemp287) - fRec470[1];
			fRec471[0] = fRec471[1] + 2.0 * (fTemp286 * fTemp446 / fTemp287);
			double fRec472 = fTemp289 * fTemp446 / fTemp287;
			double fTemp447 = fTemp291 * (fTemp443 - fRec474[1]) + fRec473[1];
			fRec473[0] = 2.0 * (fTemp447 / fTemp292) - fRec473[1];
			fRec474[0] = fRec474[1] + 2.0 * (fTemp291 * fTemp447 / fTemp292);
			double fRec475 = fTemp294 * fTemp447 / fTemp292;
			double fTemp448 = fTemp296 * (fTemp443 - fRec477[1]) + fRec476[1];
			fRec476[0] = 2.0 * (fTemp448 / fTemp297) - fRec476[1];
			fRec477[0] = fRec477[1] + 2.0 * (fTemp296 * fTemp448 / fTemp297);
			double fRec478 = fTemp299 * fTemp448 / fTemp297;
			double fTemp449 = fTemp301 * (fTemp443 - fRec480[1]) + fRec479[1];
			fRec479[0] = 2.0 * (fTemp449 / fTemp302) - fRec479[1];
			fRec480[0] = fRec480[1] + 2.0 * (fTemp301 * fTemp449 / fTemp302);
			double fRec481 = fTemp304 * fTemp449 / fTemp302;
			double fTemp450 = fTemp306 * (fTemp443 - fRec483[1]) + fRec482[1];
			fRec482[0] = 2.0 * (fTemp450 / fTemp307) - fRec482[1];
			fRec483[0] = fRec483[1] + 2.0 * (fTemp306 * fTemp450 / fTemp307);
			double fRec484 = fTemp309 * fTemp450 / fTemp307;
			double fTemp451 = fTemp311 * (fTemp443 - fRec486[1]) + fRec485[1];
			fRec485[0] = 2.0 * (fTemp451 / fTemp312) - fRec485[1];
			fRec486[0] = fRec486[1] + 2.0 * (fTemp311 * fTemp451 / fTemp312);
			double fRec487 = fTemp314 * fTemp451 / fTemp312;
			double fTemp452 = fTemp316 * (fTemp443 - fRec489[1]) + fRec488[1];
			fRec488[0] = 2.0 * (fTemp452 / fTemp317) - fRec488[1];
			fRec489[0] = fRec489[1] + 2.0 * (fTemp316 * fTemp452 / fTemp317);
			double fRec490 = fTemp319 * fTemp452 / fTemp317;
			double fTemp453 = fTemp321 * (fTemp443 - fRec492[1]) + fRec491[1];
			fRec491[0] = 2.0 * (fTemp453 / fTemp322) - fRec491[1];
			fRec492[0] = fRec492[1] + 2.0 * (fTemp321 * fTemp453 / fTemp322);
			double fRec493 = fTemp324 * fTemp453 / fTemp322;
			double fTemp454 = fTemp327 * (fTemp443 - fRec495[1]) + fRec494[1];
			fRec494[0] = 2.0 * (fTemp454 / fTemp328) - fRec494[1];
			fRec495[0] = fRec495[1] + 2.0 * (fTemp327 * fTemp454 / fTemp328);
			double fRec496 = fTemp330 * fTemp454 / fTemp328;
			double fTemp455 = fTemp332 * (fTemp443 - fRec498[1]) + fRec497[1];
			fRec497[0] = 2.0 * (fTemp455 / fTemp333) - fRec497[1];
			fRec498[0] = fRec498[1] + 2.0 * (fTemp332 * fTemp455 / fTemp333);
			double fRec499 = fTemp335 * fTemp455 / fTemp333;
			double fTemp456 = fTemp337 * (fTemp443 - fRec501[1]) + fRec500[1];
			fRec500[0] = 2.0 * (fTemp456 / fTemp338) - fRec500[1];
			fRec501[0] = fRec501[1] + 2.0 * (fTemp337 * fTemp456 / fTemp338);
			double fRec502 = fTemp340 * fTemp456 / fTemp338;
			double fTemp457 = fTemp342 * (fTemp443 - fRec504[1]) + fRec503[1];
			fRec503[0] = 2.0 * (fTemp457 / fTemp343) - fRec503[1];
			fRec504[0] = fRec504[1] + 2.0 * (fTemp342 * fTemp457 / fTemp343);
			double fRec505 = fTemp345 * fTemp457 / fTemp343;
			double fTemp458 = fTemp347 * (fTemp443 - fRec507[1]) + fRec506[1];
			fRec506[0] = 2.0 * (fTemp458 / fTemp348) - fRec506[1];
			fRec507[0] = fRec507[1] + 2.0 * (fTemp347 * fTemp458 / fTemp348);
			double fRec508 = fTemp350 * fTemp458 / fTemp348;
			double fTemp459 = fTemp352 * (fTemp443 - fRec510[1]) + fRec509[1];
			fRec509[0] = 2.0 * (fTemp459 / fTemp353) - fRec509[1];
			fRec510[0] = fRec510[1] + 2.0 * (fTemp352 * fTemp459 / fTemp353);
			double fRec511 = fTemp355 * fTemp459 / fTemp353;
			double fTemp460 = fTemp357 * (fTemp443 - fRec513[1]) + fRec512[1];
			double fTemp461 = fTemp460 / fTemp358;
			fRec512[0] = 2.0 * fTemp461 - fRec512[1];
			fRec513[0] = fRec513[1] + 2.0 * (fTemp357 * fTemp460 / fTemp358);
			double fRec514 = fTemp461;
			double fTemp462 = fTemp362 * (fTemp443 - fRec516[1]) + fRec515[1];
			fRec515[0] = 2.0 * (fTemp462 / fTemp363) - fRec515[1];
			fRec516[0] = fRec516[1] + 2.0 * (fTemp362 * fTemp462 / fTemp363);
			double fRec517 = fTemp365 * fTemp462 / fTemp363;
			double fTemp463 = fTemp367 * (fTemp443 - fRec519[1]) + fRec518[1];
			fRec518[0] = 2.0 * (fTemp463 / fTemp368) - fRec518[1];
			fRec519[0] = fRec519[1] + 2.0 * (fTemp367 * fTemp463 / fTemp368);
			double fRec520 = fTemp370 * fTemp463 / fTemp368;
			double fTemp464 = fTemp372 * (fTemp443 - fRec522[1]) + fRec521[1];
			fRec521[0] = 2.0 * (fTemp464 / fTemp373) - fRec521[1];
			fRec522[0] = fRec522[1] + 2.0 * (fTemp372 * fTemp464 / fTemp373);
			double fRec523 = fTemp375 * fTemp464 / fTemp373;
			double fTemp465 = fTemp377 * (fTemp443 - fRec525[1]) + fRec524[1];
			fRec524[0] = 2.0 * (fTemp465 / fTemp378) - fRec524[1];
			fRec525[0] = fRec525[1] + 2.0 * (fTemp377 * fTemp465 / fTemp378);
			double fRec526 = fTemp380 * fTemp465 / fTemp378;
			double fTemp466 = fTemp382 * (fTemp443 - fRec528[1]) + fRec527[1];
			fRec527[0] = 2.0 * (fTemp466 / fTemp383) - fRec527[1];
			fRec528[0] = fRec528[1] + 2.0 * (fTemp382 * fTemp466 / fTemp383);
			double fRec529 = fTemp385 * fTemp466 / fTemp383;
			double fTemp467 = fTemp387 * (fTemp443 - fRec531[1]) + fRec530[1];
			fRec530[0] = 2.0 * (fTemp467 / fTemp388) - fRec530[1];
			fRec531[0] = fRec531[1] + 2.0 * (fTemp387 * fTemp467 / fTemp388);
			double fRec532 = fTemp390 * fTemp467 / fTemp388;
			double fTemp468 = fTemp392 * (fTemp443 - fRec534[1]) + fRec533[1];
			fRec533[0] = 2.0 * (fTemp468 / fTemp393) - fRec533[1];
			fRec534[0] = fRec534[1] + 2.0 * (fTemp392 * fTemp468 / fTemp393);
			double fRec535 = fTemp395 * fTemp468 / fTemp393;
			double fTemp469 = fTemp397 * (fTemp443 - fRec537[1]) + fRec536[1];
			fRec536[0] = 2.0 * (fTemp469 / fTemp398) - fRec536[1];
			fRec537[0] = fRec537[1] + 2.0 * (fTemp397 * fTemp469 / fTemp398);
			double fRec538 = fTemp400 * fTemp469 / fTemp398;
			double fTemp470 = fTemp402 * (fTemp443 - fRec540[1]) + fRec539[1];
			fRec539[0] = 2.0 * (fTemp470 / fTemp403) - fRec539[1];
			fRec540[0] = fRec540[1] + 2.0 * (fTemp402 * fTemp470 / fTemp403);
			double fRec541 = fTemp405 * fTemp470 / fTemp403;
			double fTemp471 = fTemp407 * (fTemp443 - fRec543[1]) + fRec542[1];
			fRec542[0] = 2.0 * (fTemp471 / fTemp408) - fRec542[1];
			fRec543[0] = fRec543[1] + 2.0 * (fTemp407 * fTemp471 / fTemp408);
			double fRec544 = fTemp410 * fTemp471 / fTemp408;
			double fTemp472 = fTemp412 * (fTemp443 - fRec546[1]) + fRec545[1];
			fRec545[0] = 2.0 * (fTemp472 / fTemp413) - fRec545[1];
			fRec546[0] = fRec546[1] + 2.0 * (fTemp412 * fTemp472 / fTemp413);
			double fRec547 = fTemp415 * fTemp472 / fTemp413;
			double fTemp473 = fTemp417 * (fTemp443 - fRec549[1]) + fRec548[1];
			fRec548[0] = 2.0 * (fTemp473 / fTemp418) - fRec548[1];
			fRec549[0] = fRec549[1] + 2.0 * (fTemp417 * fTemp473 / fTemp418);
			double fRec550 = fTemp420 * fTemp473 / fTemp418;
			double fTemp474 = fTemp422 * (fTemp443 - fRec552[1]) + fRec551[1];
			fRec551[0] = 2.0 * (fTemp474 / fTemp423) - fRec551[1];
			fRec552[0] = fRec552[1] + 2.0 * (fTemp422 * fTemp474 / fTemp423);
			double fRec553 = fTemp425 * fTemp474 / fTemp423;
			double fTemp475 = fTemp427 * (fTemp443 - fRec555[1]) + fRec554[1];
			fRec554[0] = 2.0 * (fTemp475 / fTemp428) - fRec554[1];
			fRec555[0] = fRec555[1] + 2.0 * (fTemp427 * fTemp475 / fTemp428);
			double fRec556 = fTemp430 * fTemp475 / fTemp428;
			double fTemp476 = fTemp432 * (fTemp443 - fRec558[1]) + fRec557[1];
			fRec557[0] = 2.0 * (fTemp476 / fTemp433) - fRec557[1];
			fRec558[0] = fRec558[1] + 2.0 * (fTemp432 * fTemp476 / fTemp433);
			double fRec559 = fTemp435 * fTemp476 / fTemp433;
			double fTemp477 = 0.03125 * fRec137[0] * (fRec559 + fRec556 + fRec553 + fRec550 + fRec547 + fRec544 + fRec541 + fRec538 + fRec535 + fRec532 + fRec529 + fRec526 + fRec523 + fRec520 + fRec517 + fRec514 + fRec511 + fRec508 + fRec505 + fRec502 + fRec499 + fRec496 + fRec493 + fRec490 + fRec487 + fRec484 + fRec481 + fRec478 + fRec475 + fRec472 + fRec469 + fRec466) + fRec36[0] * fTemp443;
			fRec459[0] = std::max<double>(fConst1 * fRec459[1], std::fabs(fTemp477));
			fVbargraph20 = FAUSTFLOAT(fRec459[0]);
			fRec347[0] = fTemp477;
			double fTemp478 = fRec28[0] * (fTemp266 * fTemp268 - fRec244[0] * fTemp438);
			double fTemp479 = fTemp440 + fTemp438;
			fVec11[0] = fTemp479 + fTemp478 + fTemp223;
			fRec563[0] = fTemp478 + 0.995 * fRec563[1] + fTemp479 + (1.6 - (fVec5[1] + fVec11[1]));
			fRec562[0] = std::max<double>(fConst1 * fRec562[1], std::fabs(fRec563[0]));
			fVbargraph21 = FAUSTFLOAT(fRec562[0]);
			double fTemp480 = fRec17[0] * tanh(fRec563[0] / fTemp4);
			fRec561[0] = std::max<double>(fConst1 * fRec561[1], std::fabs(fTemp480));
			fVbargraph22 = FAUSTFLOAT(fRec561[0]);
			double fTemp481 = fTemp480;
			double fTemp482 = fTemp276 * (fTemp481 - fRec565[1]) + fRec564[1];
			fRec564[0] = 2.0 * (fTemp482 / fTemp277) - fRec564[1];
			fRec565[0] = fRec565[1] + 2.0 * (fTemp276 * fTemp482 / fTemp277);
			double fRec566 = fTemp279 * fTemp482 / fTemp277;
			double fTemp483 = fTemp281 * (fTemp481 - fRec568[1]) + fRec567[1];
			fRec567[0] = 2.0 * (fTemp483 / fTemp282) - fRec567[1];
			fRec568[0] = fRec568[1] + 2.0 * (fTemp281 * fTemp483 / fTemp282);
			double fRec569 = fTemp284 * fTemp483 / fTemp282;
			double fTemp484 = fTemp286 * (fTemp481 - fRec571[1]) + fRec570[1];
			fRec570[0] = 2.0 * (fTemp484 / fTemp287) - fRec570[1];
			fRec571[0] = fRec571[1] + 2.0 * (fTemp286 * fTemp484 / fTemp287);
			double fRec572 = fTemp289 * fTemp484 / fTemp287;
			double fTemp485 = fTemp291 * (fTemp481 - fRec574[1]) + fRec573[1];
			fRec573[0] = 2.0 * (fTemp485 / fTemp292) - fRec573[1];
			fRec574[0] = fRec574[1] + 2.0 * (fTemp291 * fTemp485 / fTemp292);
			double fRec575 = fTemp294 * fTemp485 / fTemp292;
			double fTemp486 = fTemp296 * (fTemp481 - fRec577[1]) + fRec576[1];
			fRec576[0] = 2.0 * (fTemp486 / fTemp297) - fRec576[1];
			fRec577[0] = fRec577[1] + 2.0 * (fTemp296 * fTemp486 / fTemp297);
			double fRec578 = fTemp299 * fTemp486 / fTemp297;
			double fTemp487 = fTemp301 * (fTemp481 - fRec580[1]) + fRec579[1];
			fRec579[0] = 2.0 * (fTemp487 / fTemp302) - fRec579[1];
			fRec580[0] = fRec580[1] + 2.0 * (fTemp301 * fTemp487 / fTemp302);
			double fRec581 = fTemp304 * fTemp487 / fTemp302;
			double fTemp488 = fTemp306 * (fTemp481 - fRec583[1]) + fRec582[1];
			fRec582[0] = 2.0 * (fTemp488 / fTemp307) - fRec582[1];
			fRec583[0] = fRec583[1] + 2.0 * (fTemp306 * fTemp488 / fTemp307);
			double fRec584 = fTemp309 * fTemp488 / fTemp307;
			double fTemp489 = fTemp311 * (fTemp481 - fRec586[1]) + fRec585[1];
			fRec585[0] = 2.0 * (fTemp489 / fTemp312) - fRec585[1];
			fRec586[0] = fRec586[1] + 2.0 * (fTemp311 * fTemp489 / fTemp312);
			double fRec587 = fTemp314 * fTemp489 / fTemp312;
			double fTemp490 = fTemp316 * (fTemp481 - fRec589[1]) + fRec588[1];
			fRec588[0] = 2.0 * (fTemp490 / fTemp317) - fRec588[1];
			fRec589[0] = fRec589[1] + 2.0 * (fTemp316 * fTemp490 / fTemp317);
			double fRec590 = fTemp319 * fTemp490 / fTemp317;
			double fTemp491 = fTemp321 * (fTemp481 - fRec592[1]) + fRec591[1];
			fRec591[0] = 2.0 * (fTemp491 / fTemp322) - fRec591[1];
			fRec592[0] = fRec592[1] + 2.0 * (fTemp321 * fTemp491 / fTemp322);
			double fRec593 = fTemp324 * fTemp491 / fTemp322;
			double fTemp492 = fTemp327 * (fTemp481 - fRec595[1]) + fRec594[1];
			fRec594[0] = 2.0 * (fTemp492 / fTemp328) - fRec594[1];
			fRec595[0] = fRec595[1] + 2.0 * (fTemp327 * fTemp492 / fTemp328);
			double fRec596 = fTemp330 * fTemp492 / fTemp328;
			double fTemp493 = fTemp332 * (fTemp481 - fRec598[1]) + fRec597[1];
			fRec597[0] = 2.0 * (fTemp493 / fTemp333) - fRec597[1];
			fRec598[0] = fRec598[1] + 2.0 * (fTemp332 * fTemp493 / fTemp333);
			double fRec599 = fTemp335 * fTemp493 / fTemp333;
			double fTemp494 = fTemp337 * (fTemp481 - fRec601[1]) + fRec600[1];
			fRec600[0] = 2.0 * (fTemp494 / fTemp338) - fRec600[1];
			fRec601[0] = fRec601[1] + 2.0 * (fTemp337 * fTemp494 / fTemp338);
			double fRec602 = fTemp340 * fTemp494 / fTemp338;
			double fTemp495 = fTemp342 * (fTemp481 - fRec604[1]) + fRec603[1];
			fRec603[0] = 2.0 * (fTemp495 / fTemp343) - fRec603[1];
			fRec604[0] = fRec604[1] + 2.0 * (fTemp342 * fTemp495 / fTemp343);
			double fRec605 = fTemp345 * fTemp495 / fTemp343;
			double fTemp496 = fTemp347 * (fTemp481 - fRec607[1]) + fRec606[1];
			fRec606[0] = 2.0 * (fTemp496 / fTemp348) - fRec606[1];
			fRec607[0] = fRec607[1] + 2.0 * (fTemp347 * fTemp496 / fTemp348);
			double fRec608 = fTemp350 * fTemp496 / fTemp348;
			double fTemp497 = fTemp352 * (fTemp481 - fRec610[1]) + fRec609[1];
			fRec609[0] = 2.0 * (fTemp497 / fTemp353) - fRec609[1];
			fRec610[0] = fRec610[1] + 2.0 * (fTemp352 * fTemp497 / fTemp353);
			double fRec611 = fTemp355 * fTemp497 / fTemp353;
			double fTemp498 = fTemp357 * (fTemp481 - fRec613[1]) + fRec612[1];
			double fTemp499 = fTemp498 / fTemp358;
			fRec612[0] = 2.0 * fTemp499 - fRec612[1];
			fRec613[0] = fRec613[1] + 2.0 * (fTemp357 * fTemp498 / fTemp358);
			double fRec614 = fTemp499;
			double fTemp500 = fTemp362 * (fTemp481 - fRec616[1]) + fRec615[1];
			fRec615[0] = 2.0 * (fTemp500 / fTemp363) - fRec615[1];
			fRec616[0] = fRec616[1] + 2.0 * (fTemp362 * fTemp500 / fTemp363);
			double fRec617 = fTemp365 * fTemp500 / fTemp363;
			double fTemp501 = fTemp367 * (fTemp481 - fRec619[1]) + fRec618[1];
			fRec618[0] = 2.0 * (fTemp501 / fTemp368) - fRec618[1];
			fRec619[0] = fRec619[1] + 2.0 * (fTemp367 * fTemp501 / fTemp368);
			double fRec620 = fTemp370 * fTemp501 / fTemp368;
			double fTemp502 = fTemp372 * (fTemp481 - fRec622[1]) + fRec621[1];
			fRec621[0] = 2.0 * (fTemp502 / fTemp373) - fRec621[1];
			fRec622[0] = fRec622[1] + 2.0 * (fTemp372 * fTemp502 / fTemp373);
			double fRec623 = fTemp375 * fTemp502 / fTemp373;
			double fTemp503 = fTemp377 * (fTemp481 - fRec625[1]) + fRec624[1];
			fRec624[0] = 2.0 * (fTemp503 / fTemp378) - fRec624[1];
			fRec625[0] = fRec625[1] + 2.0 * (fTemp377 * fTemp503 / fTemp378);
			double fRec626 = fTemp380 * fTemp503 / fTemp378;
			double fTemp504 = fTemp382 * (fTemp481 - fRec628[1]) + fRec627[1];
			fRec627[0] = 2.0 * (fTemp504 / fTemp383) - fRec627[1];
			fRec628[0] = fRec628[1] + 2.0 * (fTemp382 * fTemp504 / fTemp383);
			double fRec629 = fTemp385 * fTemp504 / fTemp383;
			double fTemp505 = fTemp387 * (fTemp481 - fRec631[1]) + fRec630[1];
			fRec630[0] = 2.0 * (fTemp505 / fTemp388) - fRec630[1];
			fRec631[0] = fRec631[1] + 2.0 * (fTemp387 * fTemp505 / fTemp388);
			double fRec632 = fTemp390 * fTemp505 / fTemp388;
			double fTemp506 = fTemp392 * (fTemp481 - fRec634[1]) + fRec633[1];
			fRec633[0] = 2.0 * (fTemp506 / fTemp393) - fRec633[1];
			fRec634[0] = fRec634[1] + 2.0 * (fTemp392 * fTemp506 / fTemp393);
			double fRec635 = fTemp395 * fTemp506 / fTemp393;
			double fTemp507 = fTemp397 * (fTemp481 - fRec637[1]) + fRec636[1];
			fRec636[0] = 2.0 * (fTemp507 / fTemp398) - fRec636[1];
			fRec637[0] = fRec637[1] + 2.0 * (fTemp397 * fTemp507 / fTemp398);
			double fRec638 = fTemp400 * fTemp507 / fTemp398;
			double fTemp508 = fTemp402 * (fTemp481 - fRec640[1]) + fRec639[1];
			fRec639[0] = 2.0 * (fTemp508 / fTemp403) - fRec639[1];
			fRec640[0] = fRec640[1] + 2.0 * (fTemp402 * fTemp508 / fTemp403);
			double fRec641 = fTemp405 * fTemp508 / fTemp403;
			double fTemp509 = fTemp407 * (fTemp481 - fRec643[1]) + fRec642[1];
			fRec642[0] = 2.0 * (fTemp509 / fTemp408) - fRec642[1];
			fRec643[0] = fRec643[1] + 2.0 * (fTemp407 * fTemp509 / fTemp408);
			double fRec644 = fTemp410 * fTemp509 / fTemp408;
			double fTemp510 = fTemp412 * (fTemp481 - fRec646[1]) + fRec645[1];
			fRec645[0] = 2.0 * (fTemp510 / fTemp413) - fRec645[1];
			fRec646[0] = fRec646[1] + 2.0 * (fTemp412 * fTemp510 / fTemp413);
			double fRec647 = fTemp415 * fTemp510 / fTemp413;
			double fTemp511 = fTemp417 * (fTemp481 - fRec649[1]) + fRec648[1];
			fRec648[0] = 2.0 * (fTemp511 / fTemp418) - fRec648[1];
			fRec649[0] = fRec649[1] + 2.0 * (fTemp417 * fTemp511 / fTemp418);
			double fRec650 = fTemp420 * fTemp511 / fTemp418;
			double fTemp512 = fTemp422 * (fTemp481 - fRec652[1]) + fRec651[1];
			fRec651[0] = 2.0 * (fTemp512 / fTemp423) - fRec651[1];
			fRec652[0] = fRec652[1] + 2.0 * (fTemp422 * fTemp512 / fTemp423);
			double fRec653 = fTemp425 * fTemp512 / fTemp423;
			double fTemp513 = fTemp427 * (fTemp481 - fRec655[1]) + fRec654[1];
			fRec654[0] = 2.0 * (fTemp513 / fTemp428) - fRec654[1];
			fRec655[0] = fRec655[1] + 2.0 * (fTemp427 * fTemp513 / fTemp428);
			double fRec656 = fTemp430 * fTemp513 / fTemp428;
			double fTemp514 = fTemp432 * (fTemp481 - fRec658[1]) + fRec657[1];
			fRec657[0] = 2.0 * (fTemp514 / fTemp433) - fRec657[1];
			fRec658[0] = fRec658[1] + 2.0 * (fTemp432 * fTemp514 / fTemp433);
			double fRec659 = fTemp435 * fTemp514 / fTemp433;
			double fTemp515 = 0.03125 * fRec137[0] * (fRec659 + fRec656 + fRec653 + fRec650 + fRec647 + fRec644 + fRec641 + fRec638 + fRec635 + fRec632 + fRec629 + fRec626 + fRec623 + fRec620 + fRec617 + fRec614 + fRec611 + fRec608 + fRec605 + fRec602 + fRec599 + fRec596 + fRec593 + fRec590 + fRec587 + fRec584 + fRec581 + fRec578 + fRec575 + fRec572 + fRec569 + fRec566) + fRec36[0] * fTemp481;
			fRec560[0] = std::max<double>(fConst1 * fRec560[1], std::fabs(fTemp515));
			fVbargraph23 = FAUSTFLOAT(fRec560[0]);
			fRec348[0] = fTemp515;
			double fTemp516 = (fRec348[0] + fRec346[0] + fRec347[0]) / fTemp4;
			fVec12[IOTA0 & 4194303] = fTemp516;
			double fTemp517 = ((fRec660[1] != 0.0) ? (((fRec661[1] > 0.0) & (fRec661[1] < 1.0)) ? fRec660[1] : 0.0) : (((fRec661[1] == 0.0) & (fSlow24 != fRec662[1])) ? 0.0009765625 : (((fRec661[1] == 1.0) & (fSlow24 != fRec663[1])) ? -0.0009765625 : 0.0)));
			fRec660[0] = fTemp517;
			fRec661[0] = std::max<double>(0.0, std::min<double>(1.0, fRec661[1] + fTemp517));
			fRec662[0] = (((fRec661[1] >= 1.0) & (fRec663[1] != fSlow24)) ? fSlow24 : fRec662[1]);
			fRec663[0] = (((fRec661[1] <= 0.0) & (fRec662[1] != fSlow24)) ? fSlow24 : fRec663[1]);
			double fTemp518 = fVec12[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec662[0])))) & 4194303];
			fRec345[0] = 0.3333333333333333 * fTemp518 + fRec661[0] * (0.0 - 0.3333333333333333 * (fTemp518 - fVec12[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec663[0])))) & 4194303]));
			fRec672[0] = fSlow25 + fConst3 * fRec672[1];
			fRec673[0] = fSlow26 + fConst3 * fRec673[1];
			fRec674[0] = fSlow27 + fConst3 * fRec674[1];
			double fTemp519 = fRec674[0] * (561.0 * fRec672[0] + fRec673[0] * (562.0 - 1097.0 * fRec672[0]) + 221.0);
			double fTemp520 = std::tan(fConst5 * fTemp519);
			double fTemp521 = fTemp520 * (fTemp520 + fTemp19 / fTemp519) + 1.0;
			double fTemp522 = fRec26[0] * fRec665[1];
			fRec678[0] = std::max<double>(fConst1 * fRec678[1], std::fabs(fTemp522));
			fVbargraph24 = FAUSTFLOAT(fRec678[0]);
			double fTemp523 = fTemp522;
			double fTemp524 = fRec26[0] * fRec666[1];
			fRec679[0] = std::max<double>(fConst1 * fRec679[1], std::fabs(fTemp524));
			fVbargraph25 = FAUSTFLOAT(fRec679[0]);
			double fTemp525 = fTemp524;
			double fTemp526 = fTemp10 * (fTemp525 - fTemp523);
			double fTemp527 = fSlow28 * fRec11[1];
			fVec13[IOTA0 & 4194303] = fTemp527;
			double fTemp528 = ((fRec681[1] != 0.0) ? (((fRec682[1] > 0.0) & (fRec682[1] < 1.0)) ? fRec681[1] : 0.0) : (((fRec682[1] == 0.0) & (fSlow29 != fRec683[1])) ? 0.0009765625 : (((fRec682[1] == 1.0) & (fSlow29 != fRec684[1])) ? -0.0009765625 : 0.0)));
			fRec681[0] = fTemp528;
			fRec682[0] = std::max<double>(0.0, std::min<double>(1.0, fRec682[1] + fTemp528));
			fRec683[0] = (((fRec682[1] >= 1.0) & (fRec684[1] != fSlow29)) ? fSlow29 : fRec683[1]);
			fRec684[0] = (((fRec682[1] <= 0.0) & (fRec683[1] != fSlow29)) ? fSlow29 : fRec684[1]);
			double fTemp529 = fVec13[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec683[0])))) & 4194303];
			fRec680[0] = fTemp529 + fRec682[0] * (fVec13[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec684[0])))) & 4194303] - fTemp529);
			fVec14[0] = fTemp12 + fTemp523 + fRec680[1] + fTemp526 + fTemp5;
			fRec677[0] = fTemp526 + fTemp12 + fRec680[1] + 0.995 * fRec677[1] + fTemp523 + (1.2 - (fVec0[1] + fVec14[1]));
			fRec676[0] = std::max<double>(fConst1 * fRec676[1], std::fabs(fRec677[0]));
			fVbargraph26 = FAUSTFLOAT(fRec676[0]);
			double fTemp530 = fRec17[0] * tanh(fRec677[0] / fTemp4);
			fRec675[0] = std::max<double>(fConst1 * fRec675[1], std::fabs(fTemp530));
			fVbargraph27 = FAUSTFLOAT(fRec675[0]);
			double fTemp531 = fTemp530;
			double fTemp532 = fTemp520 * (fTemp531 - fRec670[1]) + fRec669[1];
			fRec669[0] = 2.0 * (fTemp532 / fTemp521) - fRec669[1];
			fRec670[0] = fRec670[1] + 2.0 * (fTemp520 * fTemp532 / fTemp521);
			double fTemp533 = fRec673[0] * (0.20948251265282836 * fRec672[0] + -0.35882756573771113) + (0.883508750371294 - 0.3295246174054942 * fRec672[0]);
			double fRec671 = fTemp532 * fTemp533 / fTemp521;
			double fTemp534 = fRec674[0] * (1048.0 * fRec672[0] + fRec673[0] * (1.07e+03 * fRec672[0] + -787.0) + 1619.0);
			double fTemp535 = std::tan(fConst5 * fTemp534);
			double fTemp536 = fTemp535 * (fTemp535 + fTemp19 / fTemp534) + 1.0;
			double fTemp537 = fTemp535 * (fTemp531 - fRec686[1]) + fRec685[1];
			fRec685[0] = 2.0 * (fTemp537 / fTemp536) - fRec685[1];
			fRec686[0] = fRec686[1] + 2.0 * (fTemp535 * fTemp537 / fTemp536);
			double fTemp538 = fRec673[0] * (0.0016935641831933154 * fRec672[0] + -0.0070591277129707815) + (0.014962909727368317 - 0.007613896970744654 * fRec672[0]);
			double fRec687 = fTemp537 * fTemp538 / fTemp536;
			double fTemp539 = fRec674[0] * (687.0 * fRec672[0] + fRec673[0] * (311.0 - 2032.0 * fRec672[0]) + 2429.0);
			double fTemp540 = std::tan(fConst5 * fTemp539);
			double fTemp541 = fTemp540 * (fTemp540 + fTemp19 / fTemp539) + 1.0;
			double fTemp542 = fTemp540 * (fTemp531 - fRec689[1]) + fRec688[1];
			fRec688[0] = 2.0 * (fTemp542 / fTemp541) - fRec688[1];
			fRec689[0] = fRec689[1] + 2.0 * (fTemp540 * fTemp542 / fTemp541);
			double fTemp543 = fRec673[0] * (0.005227226473626777 * fRec672[0] + -0.010433410102575844) + (0.01934635943322834 - 0.010538363987102131 * fRec672[0]);
			double fRec690 = fTemp542 * fTemp543 / fTemp541;
			double fTemp544 = fRec674[0] * (1422.0 * fRec672[0] + fRec673[0] * (-4.0 - 526.0 * fRec672[0]) + 1178.0);
			double fTemp545 = std::tan(fConst5 * fTemp544);
			double fTemp546 = fTemp545 * (fTemp545 + fTemp19 / fTemp544) + 1.0;
			double fTemp547 = fTemp545 * (fTemp531 - fRec692[1]) + fRec691[1];
			fRec691[0] = 2.0 * (fTemp547 / fTemp546) - fRec691[1];
			fRec692[0] = fRec692[1] + 2.0 * (fTemp545 * fTemp547 / fTemp546);
			double fTemp548 = fRec673[0] * (0.0015990719330448112 * fRec672[0] + -0.009377259975676547) + (0.020502590513884294 - 0.008575258476103987 * fRec672[0]);
			double fRec693 = fTemp547 * fTemp548 / fTemp546;
			double fTemp549 = fRec674[0] * (1005.0 * fRec672[0] + fRec673[0] * (1538.0 - 1969.0 * fRec672[0]) + 1398.0);
			double fTemp550 = std::tan(fConst5 * fTemp549);
			double fTemp551 = fTemp550 * (fTemp550 + fTemp19 / fTemp549) + 1.0;
			double fTemp552 = fTemp550 * (fTemp531 - fRec695[1]) + fRec694[1];
			fRec694[0] = 2.0 * (fTemp552 / fTemp551) - fRec694[1];
			fRec695[0] = fRec695[1] + 2.0 * (fTemp550 * fTemp552 / fTemp551);
			double fTemp553 = fRec673[0] * (-0.004224308163056342 - 0.007247221109719737 * fRec672[0]) + (0.020955020563014883 - 0.004499122746580129 * fRec672[0]);
			double fRec696 = fTemp552 * fTemp553 / fTemp551;
			double fTemp554 = fRec674[0] * (726.0 * fRec672[0] + fRec673[0] * (507.0 - 2138.0 * fRec672[0]) + 2135.0);
			double fTemp555 = std::tan(fConst5 * fTemp554);
			double fTemp556 = fTemp555 * (fTemp555 + fTemp19 / fTemp554) + 1.0;
			double fTemp557 = fTemp555 * (fTemp531 - fRec698[1]) + fRec697[1];
			fRec697[0] = 2.0 * (fTemp557 / fTemp556) - fRec697[1];
			fRec698[0] = fRec698[1] + 2.0 * (fTemp555 * fTemp557 / fTemp556);
			double fTemp558 = fRec673[0] * (0.0009039247818369497 - 0.013893501673791466 * fRec672[0]) + (0.02359690477324046 - 0.005322076674786635 * fRec672[0]);
			double fRec699 = fTemp557 * fTemp558 / fTemp556;
			double fTemp559 = fRec674[0] * (125.0 * fRec672[0] + fRec673[0] * (9e+01 - 7.0 * fRec672[0]) + 2356.0);
			double fTemp560 = std::tan(fConst5 * fTemp559);
			double fTemp561 = fTemp560 * (fTemp560 + fTemp19 / fTemp559) + 1.0;
			double fTemp562 = fTemp560 * (fTemp531 - fRec701[1]) + fRec700[1];
			fRec700[0] = 2.0 * (fTemp562 / fTemp561) - fRec700[1];
			fRec701[0] = fRec701[1] + 2.0 * (fTemp560 * fTemp562 / fTemp561);
			double fTemp563 = fRec673[0] * (0.00789733404453236 - 0.022269972441420545 * fRec672[0]) + (0.024970356245165314 - 0.004948333836676418 * fRec672[0]);
			double fRec702 = fTemp562 * fTemp563 / fTemp561;
			double fTemp564 = fRec674[0] * (74.0 * fRec672[0] + fRec673[0] * (1147.0 - 837.0 * fRec672[0]) + 1104.0);
			double fTemp565 = std::tan(fConst5 * fTemp564);
			double fTemp566 = fTemp565 * (fTemp565 + fTemp19 / fTemp564) + 1.0;
			double fTemp567 = fTemp565 * (fTemp531 - fRec704[1]) + fRec703[1];
			fRec703[0] = 2.0 * (fTemp567 / fTemp566) - fRec703[1];
			fRec704[0] = fRec704[1] + 2.0 * (fTemp565 * fTemp567 / fTemp566);
			double fTemp568 = fRec673[0] * (0.014369998843206975 - 0.03300092964654322 * fRec672[0]) + (0.025519908386620865 - 0.0011683893550737713 * fRec672[0]);
			double fRec705 = fTemp567 * fTemp568 / fTemp566;
			double fTemp569 = fRec674[0] * (fRec673[0] * (241.0 * fRec672[0] + 6.3e+02) + (1914.0 - 1472.0 * fRec672[0]));
			double fTemp570 = std::tan(fConst5 * fTemp569);
			double fTemp571 = fTemp570 * (fTemp570 + fTemp19 / fTemp569) + 1.0;
			double fTemp572 = fTemp570 * (fTemp531 - fRec707[1]) + fRec706[1];
			fRec706[0] = 2.0 * (fTemp572 / fTemp571) - fRec706[1];
			fRec707[0] = fRec707[1] + 2.0 * (fTemp570 * fTemp572 / fTemp571);
			double fTemp573 = fRec673[0] * (0.012092025104768513 - 0.030118723258832435 * fRec672[0]) + (0.034299901561064564 - 0.009167713045154305 * fRec672[0]);
			double fRec708 = fTemp572 * fTemp573 / fTemp571;
			double fTemp574 = fRec674[0] * (403.0 * fRec672[0] + fRec673[0] * (1123.0 - 898.0 * fRec672[0]) + 1.03e+03);
			double fTemp575 = std::tan(fConst5 * fTemp574);
			double fTemp576 = fTemp575 * (fTemp575 + fTemp19 / fTemp574) + 1.0;
			double fTemp577 = fTemp575 * (fTemp531 - fRec710[1]) + fRec709[1];
			fRec709[0] = 2.0 * (fTemp577 / fTemp576) - fRec709[1];
			fRec710[0] = fRec710[1] + 2.0 * (fTemp575 * fTemp577 / fTemp576);
			double fTemp578 = fRec673[0] * (0.021778225322525664 - 0.04184590502930971 * fRec672[0]) + (0.03695324484801036 - 0.00815043374124962 * fRec672[0]);
			double fRec711 = fTemp577 * fTemp578 / fTemp576;
			double fTemp579 = 6.0 * fRec672[0];
			double fTemp580 = fRec674[0] * (fTemp579 + fRec673[0] * (838.0 * fRec672[0] + -812.0) + 1693.0);
			double fTemp581 = std::tan(fConst5 * fTemp580);
			double fTemp582 = fTemp581 * (fTemp581 + fTemp19 / fTemp580) + 1.0;
			double fTemp583 = fTemp581 * (fTemp531 - fRec713[1]) + fRec712[1];
			fRec712[0] = 2.0 * (fTemp583 / fTemp582) - fRec712[1];
			fRec713[0] = fRec713[1] + 2.0 * (fTemp581 * fTemp583 / fTemp582);
			double fTemp584 = fRec673[0] * (0.01054367849960227 - 0.044428922548055166 * fRec672[0]) + (0.04993743413946004 - 0.006818779501746489 * fRec672[0]);
			double fRec714 = fTemp583 * fTemp584 / fTemp582;
			double fTemp585 = fRec674[0] * (209.0 * fRec672[0] + fRec673[0] * (1515.0 - 1507.0 * fRec672[0]) + 442.0);
			double fTemp586 = std::tan(fConst5 * fTemp585);
			double fTemp587 = fTemp586 * (fTemp586 + fTemp19 / fTemp585) + 1.0;
			double fTemp588 = fTemp586 * (fTemp531 - fRec716[1]) + fRec715[1];
			fRec715[0] = 2.0 * (fTemp588 / fTemp587) - fRec715[1];
			fRec716[0] = fRec716[1] + 2.0 * (fTemp586 * fTemp588 / fTemp587);
			double fTemp589 = fRec673[0] * (-0.00836319425786336 - 0.027213728546822337 * fRec672[0]) + (0.07568694217870818 - 0.01847465835663161 * fRec672[0]);
			double fRec717 = fTemp588 * fTemp589 / fTemp587;
			double fTemp590 = fRec674[0] * (675.0 * fRec672[0] + fRec673[0] * (1172.0 - 1989.0 * fRec672[0]) + 883.0);
			double fTemp591 = std::tan(fConst5 * fTemp590);
			double fTemp592 = fTemp591 * (fTemp591 + fTemp19 / fTemp590) + 1.0;
			double fTemp593 = fTemp591 * (fTemp531 - fRec719[1]) + fRec718[1];
			fRec718[0] = 2.0 * (fTemp593 / fTemp592) - fRec718[1];
			fRec719[0] = fRec719[1] + 2.0 * (fTemp591 * fTemp593 / fTemp592);
			double fTemp594 = fRec673[0] * (0.01667332967615094 * fRec672[0] + -0.0754718266524771) + (0.15388399774271314 - 0.05838064149040649 * fRec672[0]);
			double fRec720 = fTemp593 * fTemp594 / fTemp592;
			double fTemp595 = fRec674[0] * (1.36e+03 * fRec672[0] + fRec673[0] * (-1e+02 - 1025.0 * fRec672[0]) + 589.0);
			double fTemp596 = std::tan(fConst5 * fTemp595);
			double fTemp597 = fTemp596 * (fTemp596 + fTemp19 / fTemp595) + 1.0;
			double fTemp598 = fTemp596 * (fTemp531 - fRec722[1]) + fRec721[1];
			fRec721[0] = 2.0 * (fTemp598 / fTemp597) - fRec721[1];
			fRec722[0] = fRec722[1] + 2.0 * (fTemp596 * fTemp598 / fTemp597);
			double fTemp599 = 0.012026367628721973 * fRec672[0] + fRec673[0] * (-0.03484164734028006 - 0.07088469349182304 * fRec672[0]) + 0.15986608084324763;
			double fRec723 = fTemp598 * fTemp599 / fTemp597;
			double fTemp600 = fRec674[0] * (fRec673[0] * (-51.0 - 11.0 * fRec672[0]) + (736.0 - 345.0 * fRec672[0]));
			double fTemp601 = std::tan(fConst5 * fTemp600);
			double fTemp602 = fTemp601 * (fTemp601 + fTemp19 / fTemp600) + 1.0;
			double fTemp603 = fTemp601 * (fTemp531 - fRec725[1]) + fRec724[1];
			fRec724[0] = 2.0 * (fTemp603 / fTemp602) - fRec724[1];
			fRec725[0] = fRec725[1] + 2.0 * (fTemp601 * fTemp603 / fTemp602);
			double fTemp604 = 0.043418834059638534 * fRec672[0] + fRec673[0] * (0.0003590165583120808 - 0.1653942291667907 * fRec672[0]) + 0.2004373971446242;
			double fRec726 = fTemp603 * fTemp604 / fTemp602;
			double fTemp605 = fRec674[0] * (113.0 * fRec672[0] + fRec673[0] * (147.0 - 325.0 * fRec672[0]) + 147.0);
			double fTemp606 = std::tan(fConst5 * fTemp605);
			double fTemp607 = fTemp606 * (fTemp606 + fTemp19 / fTemp605) + 1.0;
			double fTemp608 = fTemp606 * (fTemp531 - fRec728[1]) + fRec727[1];
			fRec727[0] = 2.0 * (fTemp608 / fTemp607) - fRec727[1];
			fRec728[0] = fRec728[1] + 2.0 * (fTemp606 * fTemp608 / fTemp607);
			double fTemp609 = fRec673[0] * (-0.20926865897501318 - 0.10045148502362689 * fRec672[0]) + (0.6105272358722508 - 0.05775171174785887 * fRec672[0]);
			double fRec729 = fTemp608 * fTemp609 / fTemp607;
			double fTemp610 = fRec674[0] * (fRec673[0] * (306.0 * fRec672[0] + -2.7e+02) + (368.0 - 239.0 * fRec672[0]));
			double fTemp611 = std::tan(fConst5 * fTemp610);
			double fTemp612 = fTemp611 * (fTemp611 + fTemp19 / fTemp610) + 1.0;
			double fTemp613 = fTemp611 * (fTemp531 - fRec731[1]) + fRec730[1];
			double fTemp614 = fTemp613 / fTemp612;
			fRec730[0] = 2.0 * fTemp614 - fRec730[1];
			fRec731[0] = fRec731[1] + 2.0 * (fTemp611 * fTemp613 / fTemp612);
			double fRec732 = fTemp614;
			double fTemp615 = fRec674[0] * (fTemp579 + fRec673[0] * (72.0 - 181.0 * fRec672[0]) + 515.0);
			double fTemp616 = std::tan(fConst5 * fTemp615);
			double fTemp617 = fTemp616 * (fTemp616 + fTemp19 / fTemp615) + 1.0;
			double fTemp618 = fTemp616 * (fTemp531 - fRec734[1]) + fRec733[1];
			fRec733[0] = 2.0 * (fTemp618 / fTemp617) - fRec733[1];
			fRec734[0] = fRec734[1] + 2.0 * (fTemp616 * fTemp618 / fTemp617);
			double fTemp619 = 0.1297691905274158 * fRec672[0] + fRec673[0] * (-0.020679500617239138 - 0.26354737961410307 * fRec672[0]) + 0.25009984168236576;
			double fRec735 = fTemp618 * fTemp619 / fTemp617;
			double fTemp620 = fRec674[0] * (968.0 * fRec672[0] + fRec673[0] * (122.0 - 588.0 * fRec672[0]) + 74.0);
			double fTemp621 = std::tan(fConst5 * fTemp620);
			double fTemp622 = fTemp621 * (fTemp621 + fTemp19 / fTemp620) + 1.0;
			double fTemp623 = fTemp621 * (fTemp531 - fRec737[1]) + fRec736[1];
			fRec736[0] = 2.0 * (fTemp623 / fTemp622) - fRec736[1];
			fRec737[0] = fRec737[1] + 2.0 * (fTemp621 * fTemp623 / fTemp622);
			double fTemp624 = fRec673[0] * (-0.00905548290563929 - 0.10407317928289174 * fRec672[0]) + (0.19782531572463796 - 0.011967933866223551 * fRec672[0]);
			double fRec738 = fTemp623 * fTemp624 / fTemp622;
			double fTemp625 = fRec674[0] * (102.0 * fRec672[0] + fRec673[0] * (756.0 - 762.0 * fRec672[0]) + 8.1e+02);
			double fTemp626 = std::tan(fConst5 * fTemp625);
			double fTemp627 = fTemp626 * (fTemp626 + fTemp19 / fTemp625) + 1.0;
			double fTemp628 = fTemp626 * (fTemp531 - fRec740[1]) + fRec739[1];
			fRec739[0] = 2.0 * (fTemp628 / fTemp627) - fRec739[1];
			fRec740[0] = fRec740[1] + 2.0 * (fTemp626 * fTemp628 / fTemp627);
			double fTemp629 = fRec673[0] * (-0.06073025380607225 - 0.02103357250515689 * fRec672[0]) + (0.15408867955329245 - 0.01859664908410899 * fRec672[0]);
			double fRec741 = fTemp628 * fTemp629 / fTemp627;
			double fTemp630 = fRec674[0] * (1784.0 * fRec672[0] + fRec673[0] * (96.0 - 1681.0 * fRec672[0]) + 295.0);
			double fTemp631 = std::tan(fConst5 * fTemp630);
			double fTemp632 = fTemp631 * (fTemp631 + fTemp19 / fTemp630) + 1.0;
			double fTemp633 = fTemp631 * (fTemp531 - fRec743[1]) + fRec742[1];
			fRec742[0] = 2.0 * (fTemp633 / fTemp632) - fRec742[1];
			fRec743[0] = fRec743[1] + 2.0 * (fTemp631 * fTemp633 / fTemp632);
			double fTemp634 = fRec673[0] * (0.00832579588520789 * fRec672[0] + -0.044200755516049905) + (0.12206611629626225 - 0.05880265929429268 * fRec672[0]);
			double fRec744 = fTemp633 * fTemp634 / fTemp632;
			double fTemp635 = fRec674[0] * (1689.0 * fRec672[0] + fRec673[0] * (806.0 - 1597.0 * fRec672[0]) + 662.0);
			double fTemp636 = std::tan(fConst5 * fTemp635);
			double fTemp637 = fTemp636 * (fTemp636 + fTemp19 / fTemp635) + 1.0;
			double fTemp638 = fTemp636 * (fTemp531 - fRec746[1]) + fRec745[1];
			fRec745[0] = 2.0 * (fTemp638 / fTemp637) - fRec745[1];
			fRec746[0] = fRec746[1] + 2.0 * (fTemp636 * fTemp638 / fTemp637);
			double fTemp639 = fRec673[0] * (-0.010952558243701213 - 0.024561127441574723 * fRec672[0]) + (0.0749419685950924 - 0.028820358890550887 * fRec672[0]);
			double fRec747 = fTemp638 * fTemp639 / fTemp637;
			double fTemp640 = fRec674[0] * (1265.0 * fRec672[0] + fRec673[0] * (1.2e+02 - 1.27e+03 * fRec672[0]) + 956.0);
			double fTemp641 = std::tan(fConst5 * fTemp640);
			double fTemp642 = fTemp641 * (fTemp641 + fTemp19 / fTemp640) + 1.0;
			double fTemp643 = fTemp641 * (fTemp531 - fRec749[1]) + fRec748[1];
			fRec748[0] = 2.0 * (fTemp643 / fTemp642) - fRec748[1];
			fRec749[0] = fRec749[1] + 2.0 * (fTemp641 * fTemp643 / fTemp642);
			double fTemp644 = fRec673[0] * (0.016194260220710646 - 0.04017164138792575 * fRec672[0]) + (0.04296305701601583 - 0.009998228849321458 * fRec672[0]);
			double fRec750 = fTemp643 * fTemp644 / fTemp642;
			double fTemp645 = fRec674[0] * (fRec673[0] * (951.0 * fRec672[0] + -618.0) + (2282.0 - 463.0 * fRec672[0]));
			double fTemp646 = std::tan(fConst5 * fTemp645);
			double fTemp647 = fTemp646 * (fTemp646 + fTemp19 / fTemp645) + 1.0;
			double fTemp648 = fTemp646 * (fTemp531 - fRec752[1]) + fRec751[1];
			fRec751[0] = 2.0 * (fTemp648 / fTemp647) - fRec751[1];
			fRec752[0] = fRec752[1] + 2.0 * (fTemp646 * fTemp648 / fTemp647);
			double fTemp649 = fRec673[0] * (0.015993820877451798 - 0.03561073091810513 * fRec672[0]) + (0.035190168499954565 - 0.007711275872944394 * fRec672[0]);
			double fRec753 = fTemp648 * fTemp649 / fTemp647;
			double fTemp650 = fRec674[0] * (fRec673[0] * (803.0 - 1117.0 * fRec672[0]) + (1546.0 - 238.0 * fRec672[0]));
			double fTemp651 = std::tan(fConst5 * fTemp650);
			double fTemp652 = fTemp651 * (fTemp651 + fTemp19 / fTemp650) + 1.0;
			double fTemp653 = fTemp651 * (fTemp531 - fRec755[1]) + fRec754[1];
			fRec754[0] = 2.0 * (fTemp653 / fTemp652) - fRec754[1];
			fRec755[0] = fRec755[1] + 2.0 * (fTemp651 * fTemp653 / fTemp652);
			double fTemp654 = fRec673[0] * (0.012251807773129418 - 0.030545193317676356 * fRec672[0]) + (0.027814420294695608 - 0.002830824883261286 * fRec672[0]);
			double fRec756 = fTemp653 * fTemp654 / fTemp652;
			double fTemp655 = fRec674[0] * (fRec673[0] * (1.34e+03 * fRec672[0] + -102.0) + (1472.0 - 903.0 * fRec672[0]));
			double fTemp656 = std::tan(fConst5 * fTemp655);
			double fTemp657 = fTemp656 * (fTemp656 + fTemp19 / fTemp655) + 1.0;
			double fTemp658 = fTemp656 * (fTemp531 - fRec758[1]) + fRec757[1];
			fRec757[0] = 2.0 * (fTemp658 / fTemp657) - fRec757[1];
			fRec758[0] = fRec758[1] + 2.0 * (fTemp656 * fTemp658 / fTemp657);
			double fTemp659 = fRec673[0] * (0.008006093262504007 - 0.024671130121872657 * fRec672[0]) + (0.025451275008886335 - 0.003130799157219928 * fRec672[0]);
			double fRec759 = fTemp658 * fTemp659 / fTemp657;
			double fTemp660 = fRec674[0] * (fRec673[0] * (861.0 * fRec672[0] + -1231.0) + (2503.0 - 228.0 * fRec672[0]));
			double fTemp661 = std::tan(fConst5 * fTemp660);
			double fTemp662 = fTemp661 * (fTemp661 + fTemp19 / fTemp660) + 1.0;
			double fTemp663 = fTemp661 * (fTemp531 - fRec761[1]) + fRec760[1];
			fRec760[0] = 2.0 * (fTemp663 / fTemp662) - fRec760[1];
			fRec761[0] = fRec761[1] + 2.0 * (fTemp661 * fTemp663 / fTemp662);
			double fTemp664 = fRec673[0] * (0.002393508230319367 - 0.01643892312610763 * fRec672[0]) + (0.02376619002590769 - 0.004291546045942368 * fRec672[0]);
			double fRec762 = fTemp663 * fTemp664 / fTemp662;
			double fTemp665 = fRec674[0] * (1281.0 * fRec672[0] + fRec673[0] * (37.0 * fRec672[0] + -273.0) + 1251.0);
			double fTemp666 = std::tan(fConst5 * fTemp665);
			double fTemp667 = fTemp666 * (fTemp666 + fTemp19 / fTemp665) + 1.0;
			double fTemp668 = fTemp666 * (fTemp531 - fRec764[1]) + fRec763[1];
			fRec763[0] = 2.0 * (fTemp668 / fTemp667) - fRec763[1];
			fRec764[0] = fRec764[1] + 2.0 * (fTemp666 * fTemp668 / fTemp667);
			double fTemp669 = fRec673[0] * (0.001634210217413834 - 0.013674190403903216 * fRec672[0]) + (0.02108580284017779 - 0.003933981224376031 * fRec672[0]);
			double fRec765 = fTemp668 * fTemp669 / fTemp667;
			double fTemp670 = fRec674[0] * (1666.0 * fRec672[0] + fRec673[0] * (436.0 - 1213.0 * fRec672[0]) + 1325.0);
			double fTemp671 = std::tan(fConst5 * fTemp670);
			double fTemp672 = fTemp671 * (fTemp671 + fTemp19 / fTemp670) + 1.0;
			double fTemp673 = fTemp671 * (fTemp531 - fRec767[1]) + fRec766[1];
			fRec766[0] = 2.0 * (fTemp673 / fTemp672) - fRec766[1];
			fRec767[0] = fRec767[1] + 2.0 * (fTemp671 * fTemp673 / fTemp672);
			double fTemp674 = fRec673[0] * (-0.006947658589813211 - 0.0032192382202462302 * fRec672[0]) + (0.02080994218773682 - 0.006343538597854104 * fRec672[0]);
			double fRec768 = fTemp673 * fTemp674 / fTemp672;
			double fTemp675 = fRec674[0] * (81.0 * fRec672[0] + fRec673[0] * (972.0 - 715.0 * fRec672[0]) + 2061.0);
			double fTemp676 = std::tan(fConst5 * fTemp675);
			double fTemp677 = fTemp676 * (fTemp676 + fTemp19 / fTemp675) + 1.0;
			double fTemp678 = fTemp676 * (fTemp531 - fRec770[1]) + fRec769[1];
			fRec769[0] = 2.0 * (fTemp678 / fTemp677) - fRec769[1];
			fRec770[0] = fRec770[1] + 2.0 * (fTemp676 * fTemp678 / fTemp677);
			double fTemp679 = fRec673[0] * (0.0021589052725694453 * fRec672[0] + -0.008904165411473826) + (0.019359564369447416 - 0.008690192954800124 * fRec672[0]);
			double fRec771 = fTemp678 * fTemp679 / fTemp677;
			double fTemp680 = fRec674[0] * (fRec673[0] * (1.02e+03 - 1.62e+03 * fRec672[0]) + (2209.0 - 456.0 * fRec672[0]));
			double fTemp681 = std::tan(fConst5 * fTemp680);
			double fTemp682 = fTemp681 * (fTemp681 + fTemp19 / fTemp680) + 1.0;
			double fTemp683 = fTemp681 * (fTemp531 - fRec773[1]) + fRec772[1];
			fRec772[0] = 2.0 * (fTemp683 / fTemp682) - fRec772[1];
			fRec773[0] = fRec773[1] + 2.0 * (fTemp681 * fTemp683 / fTemp682);
			double fTemp684 = fRec673[0] * (0.005044160613158476 * fRec672[0] + -0.01013056637869131) + (0.018745547950376563 - 0.011232336533809374 * fRec672[0]);
			double fRec774 = fTemp683 * fTemp684 / fTemp682;
			double fTemp685 = fRec674[0] * (805.0 * fRec672[0] + fRec673[0] * (266.0 - 7.7e+02 * fRec672[0]) + 2572.0);
			double fTemp686 = std::tan(fConst5 * fTemp685);
			double fTemp687 = fTemp686 * (fTemp686 + fTemp19 / fTemp685) + 1.0;
			double fTemp688 = fTemp686 * (fTemp531 - fRec776[1]) + fRec775[1];
			fRec775[0] = 2.0 * (fTemp688 / fTemp687) - fRec775[1];
			fRec776[0] = fRec776[1] + 2.0 * (fTemp686 * fTemp688 / fTemp687);
			double fTemp689 = fRec673[0] * (0.0016378452192321808 * fRec672[0] + -0.004344936518553382) + (0.011249397635411025 - 0.006780823623904783 * fRec672[0]);
			double fRec777 = fTemp688 * fTemp689 / fTemp687;
			double fTemp690 = fTemp531 * fRec36[0] + 0.03125 * fRec137[0] * (fRec777 + fRec774 + fRec771 + fRec768 + fRec765 + fRec762 + fRec759 + fRec756 + fRec753 + fRec750 + fRec747 + fRec744 + fRec741 + fRec738 + fRec735 + fRec732 + fRec729 + fRec726 + fRec723 + fRec720 + fRec717 + fRec714 + fRec711 + fRec708 + fRec705 + fRec702 + fRec699 + fRec696 + fRec693 + fRec690 + fRec687 + fRec671);
			fRec668[0] = std::max<double>(fConst1 * fRec668[1], std::fabs(fTemp690));
			fVbargraph28 = FAUSTFLOAT(fRec668[0]);
			fRec665[0] = fTemp690;
			double fTemp691 = fRec26[0] * fRec667[1];
			fRec782[0] = std::max<double>(fConst1 * fRec782[1], std::fabs(fTemp691));
			fVbargraph29 = FAUSTFLOAT(fRec782[0]);
			double fTemp692 = fTemp691;
			double fTemp693 = fRec28[0] * (fTemp523 * (fRec143[0] - fTemp692) - fTemp525);
			double fTemp694 = fRec680[1] + fTemp12;
			double fTemp695 = fTemp694 + fTemp525;
			fVec15[0] = fTemp695 + fTemp693 + fTemp181;
			fRec781[0] = fTemp693 + 0.995 * fRec781[1] + fTemp695 + (1.3 - (fVec3[1] + fVec15[1]));
			fRec780[0] = std::max<double>(fConst1 * fRec780[1], std::fabs(fRec781[0]));
			fVbargraph30 = FAUSTFLOAT(fRec780[0]);
			double fTemp696 = fRec17[0] * tanh(fRec781[0] / fTemp4);
			fRec779[0] = std::max<double>(fConst1 * fRec779[1], std::fabs(fTemp696));
			fVbargraph31 = FAUSTFLOAT(fRec779[0]);
			double fTemp697 = fTemp696;
			double fTemp698 = fTemp520 * (fTemp697 - fRec784[1]) + fRec783[1];
			fRec783[0] = 2.0 * (fTemp698 / fTemp521) - fRec783[1];
			fRec784[0] = fRec784[1] + 2.0 * (fTemp520 * fTemp698 / fTemp521);
			double fRec785 = fTemp533 * fTemp698 / fTemp521;
			double fTemp699 = fTemp535 * (fTemp697 - fRec787[1]) + fRec786[1];
			fRec786[0] = 2.0 * (fTemp699 / fTemp536) - fRec786[1];
			fRec787[0] = fRec787[1] + 2.0 * (fTemp535 * fTemp699 / fTemp536);
			double fRec788 = fTemp538 * fTemp699 / fTemp536;
			double fTemp700 = fTemp540 * (fTemp697 - fRec790[1]) + fRec789[1];
			fRec789[0] = 2.0 * (fTemp700 / fTemp541) - fRec789[1];
			fRec790[0] = fRec790[1] + 2.0 * (fTemp540 * fTemp700 / fTemp541);
			double fRec791 = fTemp543 * fTemp700 / fTemp541;
			double fTemp701 = fTemp545 * (fTemp697 - fRec793[1]) + fRec792[1];
			fRec792[0] = 2.0 * (fTemp701 / fTemp546) - fRec792[1];
			fRec793[0] = fRec793[1] + 2.0 * (fTemp545 * fTemp701 / fTemp546);
			double fRec794 = fTemp548 * fTemp701 / fTemp546;
			double fTemp702 = fTemp550 * (fTemp697 - fRec796[1]) + fRec795[1];
			fRec795[0] = 2.0 * (fTemp702 / fTemp551) - fRec795[1];
			fRec796[0] = fRec796[1] + 2.0 * (fTemp550 * fTemp702 / fTemp551);
			double fRec797 = fTemp553 * fTemp702 / fTemp551;
			double fTemp703 = fTemp555 * (fTemp697 - fRec799[1]) + fRec798[1];
			fRec798[0] = 2.0 * (fTemp703 / fTemp556) - fRec798[1];
			fRec799[0] = fRec799[1] + 2.0 * (fTemp555 * fTemp703 / fTemp556);
			double fRec800 = fTemp558 * fTemp703 / fTemp556;
			double fTemp704 = fTemp560 * (fTemp697 - fRec802[1]) + fRec801[1];
			fRec801[0] = 2.0 * (fTemp704 / fTemp561) - fRec801[1];
			fRec802[0] = fRec802[1] + 2.0 * (fTemp560 * fTemp704 / fTemp561);
			double fRec803 = fTemp563 * fTemp704 / fTemp561;
			double fTemp705 = fTemp565 * (fTemp697 - fRec805[1]) + fRec804[1];
			fRec804[0] = 2.0 * (fTemp705 / fTemp566) - fRec804[1];
			fRec805[0] = fRec805[1] + 2.0 * (fTemp565 * fTemp705 / fTemp566);
			double fRec806 = fTemp568 * fTemp705 / fTemp566;
			double fTemp706 = fTemp570 * (fTemp697 - fRec808[1]) + fRec807[1];
			fRec807[0] = 2.0 * (fTemp706 / fTemp571) - fRec807[1];
			fRec808[0] = fRec808[1] + 2.0 * (fTemp570 * fTemp706 / fTemp571);
			double fRec809 = fTemp573 * fTemp706 / fTemp571;
			double fTemp707 = fTemp575 * (fTemp697 - fRec811[1]) + fRec810[1];
			fRec810[0] = 2.0 * (fTemp707 / fTemp576) - fRec810[1];
			fRec811[0] = fRec811[1] + 2.0 * (fTemp575 * fTemp707 / fTemp576);
			double fRec812 = fTemp578 * fTemp707 / fTemp576;
			double fTemp708 = fTemp581 * (fTemp697 - fRec814[1]) + fRec813[1];
			fRec813[0] = 2.0 * (fTemp708 / fTemp582) - fRec813[1];
			fRec814[0] = fRec814[1] + 2.0 * (fTemp581 * fTemp708 / fTemp582);
			double fRec815 = fTemp584 * fTemp708 / fTemp582;
			double fTemp709 = fTemp586 * (fTemp697 - fRec817[1]) + fRec816[1];
			fRec816[0] = 2.0 * (fTemp709 / fTemp587) - fRec816[1];
			fRec817[0] = fRec817[1] + 2.0 * (fTemp586 * fTemp709 / fTemp587);
			double fRec818 = fTemp589 * fTemp709 / fTemp587;
			double fTemp710 = fTemp591 * (fTemp697 - fRec820[1]) + fRec819[1];
			fRec819[0] = 2.0 * (fTemp710 / fTemp592) - fRec819[1];
			fRec820[0] = fRec820[1] + 2.0 * (fTemp591 * fTemp710 / fTemp592);
			double fRec821 = fTemp594 * fTemp710 / fTemp592;
			double fTemp711 = fTemp596 * (fTemp697 - fRec823[1]) + fRec822[1];
			fRec822[0] = 2.0 * (fTemp711 / fTemp597) - fRec822[1];
			fRec823[0] = fRec823[1] + 2.0 * (fTemp596 * fTemp711 / fTemp597);
			double fRec824 = fTemp599 * fTemp711 / fTemp597;
			double fTemp712 = fTemp601 * (fTemp697 - fRec826[1]) + fRec825[1];
			fRec825[0] = 2.0 * (fTemp712 / fTemp602) - fRec825[1];
			fRec826[0] = fRec826[1] + 2.0 * (fTemp601 * fTemp712 / fTemp602);
			double fRec827 = fTemp604 * fTemp712 / fTemp602;
			double fTemp713 = fTemp606 * (fTemp697 - fRec829[1]) + fRec828[1];
			fRec828[0] = 2.0 * (fTemp713 / fTemp607) - fRec828[1];
			fRec829[0] = fRec829[1] + 2.0 * (fTemp606 * fTemp713 / fTemp607);
			double fRec830 = fTemp609 * fTemp713 / fTemp607;
			double fTemp714 = fTemp611 * (fTemp697 - fRec832[1]) + fRec831[1];
			double fTemp715 = fTemp714 / fTemp612;
			fRec831[0] = 2.0 * fTemp715 - fRec831[1];
			fRec832[0] = fRec832[1] + 2.0 * (fTemp611 * fTemp714 / fTemp612);
			double fRec833 = fTemp715;
			double fTemp716 = fTemp616 * (fTemp697 - fRec835[1]) + fRec834[1];
			fRec834[0] = 2.0 * (fTemp716 / fTemp617) - fRec834[1];
			fRec835[0] = fRec835[1] + 2.0 * (fTemp616 * fTemp716 / fTemp617);
			double fRec836 = fTemp619 * fTemp716 / fTemp617;
			double fTemp717 = fTemp621 * (fTemp697 - fRec838[1]) + fRec837[1];
			fRec837[0] = 2.0 * (fTemp717 / fTemp622) - fRec837[1];
			fRec838[0] = fRec838[1] + 2.0 * (fTemp621 * fTemp717 / fTemp622);
			double fRec839 = fTemp624 * fTemp717 / fTemp622;
			double fTemp718 = fTemp626 * (fTemp697 - fRec841[1]) + fRec840[1];
			fRec840[0] = 2.0 * (fTemp718 / fTemp627) - fRec840[1];
			fRec841[0] = fRec841[1] + 2.0 * (fTemp626 * fTemp718 / fTemp627);
			double fRec842 = fTemp629 * fTemp718 / fTemp627;
			double fTemp719 = fTemp631 * (fTemp697 - fRec844[1]) + fRec843[1];
			fRec843[0] = 2.0 * (fTemp719 / fTemp632) - fRec843[1];
			fRec844[0] = fRec844[1] + 2.0 * (fTemp631 * fTemp719 / fTemp632);
			double fRec845 = fTemp634 * fTemp719 / fTemp632;
			double fTemp720 = fTemp636 * (fTemp697 - fRec847[1]) + fRec846[1];
			fRec846[0] = 2.0 * (fTemp720 / fTemp637) - fRec846[1];
			fRec847[0] = fRec847[1] + 2.0 * (fTemp636 * fTemp720 / fTemp637);
			double fRec848 = fTemp639 * fTemp720 / fTemp637;
			double fTemp721 = fTemp641 * (fTemp697 - fRec850[1]) + fRec849[1];
			fRec849[0] = 2.0 * (fTemp721 / fTemp642) - fRec849[1];
			fRec850[0] = fRec850[1] + 2.0 * (fTemp641 * fTemp721 / fTemp642);
			double fRec851 = fTemp644 * fTemp721 / fTemp642;
			double fTemp722 = fTemp646 * (fTemp697 - fRec853[1]) + fRec852[1];
			fRec852[0] = 2.0 * (fTemp722 / fTemp647) - fRec852[1];
			fRec853[0] = fRec853[1] + 2.0 * (fTemp646 * fTemp722 / fTemp647);
			double fRec854 = fTemp649 * fTemp722 / fTemp647;
			double fTemp723 = fTemp651 * (fTemp697 - fRec856[1]) + fRec855[1];
			fRec855[0] = 2.0 * (fTemp723 / fTemp652) - fRec855[1];
			fRec856[0] = fRec856[1] + 2.0 * (fTemp651 * fTemp723 / fTemp652);
			double fRec857 = fTemp654 * fTemp723 / fTemp652;
			double fTemp724 = fTemp656 * (fTemp697 - fRec859[1]) + fRec858[1];
			fRec858[0] = 2.0 * (fTemp724 / fTemp657) - fRec858[1];
			fRec859[0] = fRec859[1] + 2.0 * (fTemp656 * fTemp724 / fTemp657);
			double fRec860 = fTemp659 * fTemp724 / fTemp657;
			double fTemp725 = fTemp661 * (fTemp697 - fRec862[1]) + fRec861[1];
			fRec861[0] = 2.0 * (fTemp725 / fTemp662) - fRec861[1];
			fRec862[0] = fRec862[1] + 2.0 * (fTemp661 * fTemp725 / fTemp662);
			double fRec863 = fTemp664 * fTemp725 / fTemp662;
			double fTemp726 = fTemp666 * (fTemp697 - fRec865[1]) + fRec864[1];
			fRec864[0] = 2.0 * (fTemp726 / fTemp667) - fRec864[1];
			fRec865[0] = fRec865[1] + 2.0 * (fTemp666 * fTemp726 / fTemp667);
			double fRec866 = fTemp669 * fTemp726 / fTemp667;
			double fTemp727 = fTemp671 * (fTemp697 - fRec868[1]) + fRec867[1];
			fRec867[0] = 2.0 * (fTemp727 / fTemp672) - fRec867[1];
			fRec868[0] = fRec868[1] + 2.0 * (fTemp671 * fTemp727 / fTemp672);
			double fRec869 = fTemp674 * fTemp727 / fTemp672;
			double fTemp728 = fTemp676 * (fTemp697 - fRec871[1]) + fRec870[1];
			fRec870[0] = 2.0 * (fTemp728 / fTemp677) - fRec870[1];
			fRec871[0] = fRec871[1] + 2.0 * (fTemp676 * fTemp728 / fTemp677);
			double fRec872 = fTemp679 * fTemp728 / fTemp677;
			double fTemp729 = fTemp681 * (fTemp697 - fRec874[1]) + fRec873[1];
			fRec873[0] = 2.0 * (fTemp729 / fTemp682) - fRec873[1];
			fRec874[0] = fRec874[1] + 2.0 * (fTemp681 * fTemp729 / fTemp682);
			double fRec875 = fTemp684 * fTemp729 / fTemp682;
			double fTemp730 = fTemp686 * (fTemp697 - fRec877[1]) + fRec876[1];
			fRec876[0] = 2.0 * (fTemp730 / fTemp687) - fRec876[1];
			fRec877[0] = fRec877[1] + 2.0 * (fTemp686 * fTemp730 / fTemp687);
			double fRec878 = fTemp689 * fTemp730 / fTemp687;
			double fTemp731 = 0.03125 * fRec137[0] * (fRec878 + fRec875 + fRec872 + fRec869 + fRec866 + fRec863 + fRec860 + fRec857 + fRec854 + fRec851 + fRec848 + fRec845 + fRec842 + fRec839 + fRec836 + fRec833 + fRec830 + fRec827 + fRec824 + fRec821 + fRec818 + fRec815 + fRec812 + fRec809 + fRec806 + fRec803 + fRec800 + fRec797 + fRec794 + fRec791 + fRec788 + fRec785) + fRec36[0] * fTemp697;
			fRec778[0] = std::max<double>(fConst1 * fRec778[1], std::fabs(fTemp731));
			fVbargraph32 = FAUSTFLOAT(fRec778[0]);
			fRec666[0] = fTemp731;
			double fTemp732 = fRec28[0] * (fTemp523 * fTemp525 - fRec244[0] * fTemp692);
			double fTemp733 = fTemp694 + fTemp692;
			fVec16[0] = fTemp733 + fTemp732 + fTemp223;
			fRec882[0] = fTemp732 + 0.995 * fRec882[1] + fTemp733 + (1.6 - (fVec5[1] + fVec16[1]));
			fRec881[0] = std::max<double>(fConst1 * fRec881[1], std::fabs(fRec882[0]));
			fVbargraph33 = FAUSTFLOAT(fRec881[0]);
			double fTemp734 = fRec17[0] * tanh(fRec882[0] / fTemp4);
			fRec880[0] = std::max<double>(fConst1 * fRec880[1], std::fabs(fTemp734));
			fVbargraph34 = FAUSTFLOAT(fRec880[0]);
			double fTemp735 = fTemp734;
			double fTemp736 = fTemp520 * (fTemp735 - fRec884[1]) + fRec883[1];
			fRec883[0] = 2.0 * (fTemp736 / fTemp521) - fRec883[1];
			fRec884[0] = fRec884[1] + 2.0 * (fTemp520 * fTemp736 / fTemp521);
			double fRec885 = fTemp533 * fTemp736 / fTemp521;
			double fTemp737 = fTemp535 * (fTemp735 - fRec887[1]) + fRec886[1];
			fRec886[0] = 2.0 * (fTemp737 / fTemp536) - fRec886[1];
			fRec887[0] = fRec887[1] + 2.0 * (fTemp535 * fTemp737 / fTemp536);
			double fRec888 = fTemp538 * fTemp737 / fTemp536;
			double fTemp738 = fTemp540 * (fTemp735 - fRec890[1]) + fRec889[1];
			fRec889[0] = 2.0 * (fTemp738 / fTemp541) - fRec889[1];
			fRec890[0] = fRec890[1] + 2.0 * (fTemp540 * fTemp738 / fTemp541);
			double fRec891 = fTemp543 * fTemp738 / fTemp541;
			double fTemp739 = fTemp545 * (fTemp735 - fRec893[1]) + fRec892[1];
			fRec892[0] = 2.0 * (fTemp739 / fTemp546) - fRec892[1];
			fRec893[0] = fRec893[1] + 2.0 * (fTemp545 * fTemp739 / fTemp546);
			double fRec894 = fTemp548 * fTemp739 / fTemp546;
			double fTemp740 = fTemp550 * (fTemp735 - fRec896[1]) + fRec895[1];
			fRec895[0] = 2.0 * (fTemp740 / fTemp551) - fRec895[1];
			fRec896[0] = fRec896[1] + 2.0 * (fTemp550 * fTemp740 / fTemp551);
			double fRec897 = fTemp553 * fTemp740 / fTemp551;
			double fTemp741 = fTemp555 * (fTemp735 - fRec899[1]) + fRec898[1];
			fRec898[0] = 2.0 * (fTemp741 / fTemp556) - fRec898[1];
			fRec899[0] = fRec899[1] + 2.0 * (fTemp555 * fTemp741 / fTemp556);
			double fRec900 = fTemp558 * fTemp741 / fTemp556;
			double fTemp742 = fTemp560 * (fTemp735 - fRec902[1]) + fRec901[1];
			fRec901[0] = 2.0 * (fTemp742 / fTemp561) - fRec901[1];
			fRec902[0] = fRec902[1] + 2.0 * (fTemp560 * fTemp742 / fTemp561);
			double fRec903 = fTemp563 * fTemp742 / fTemp561;
			double fTemp743 = fTemp565 * (fTemp735 - fRec905[1]) + fRec904[1];
			fRec904[0] = 2.0 * (fTemp743 / fTemp566) - fRec904[1];
			fRec905[0] = fRec905[1] + 2.0 * (fTemp565 * fTemp743 / fTemp566);
			double fRec906 = fTemp568 * fTemp743 / fTemp566;
			double fTemp744 = fTemp570 * (fTemp735 - fRec908[1]) + fRec907[1];
			fRec907[0] = 2.0 * (fTemp744 / fTemp571) - fRec907[1];
			fRec908[0] = fRec908[1] + 2.0 * (fTemp570 * fTemp744 / fTemp571);
			double fRec909 = fTemp573 * fTemp744 / fTemp571;
			double fTemp745 = fTemp575 * (fTemp735 - fRec911[1]) + fRec910[1];
			fRec910[0] = 2.0 * (fTemp745 / fTemp576) - fRec910[1];
			fRec911[0] = fRec911[1] + 2.0 * (fTemp575 * fTemp745 / fTemp576);
			double fRec912 = fTemp578 * fTemp745 / fTemp576;
			double fTemp746 = fTemp581 * (fTemp735 - fRec914[1]) + fRec913[1];
			fRec913[0] = 2.0 * (fTemp746 / fTemp582) - fRec913[1];
			fRec914[0] = fRec914[1] + 2.0 * (fTemp581 * fTemp746 / fTemp582);
			double fRec915 = fTemp584 * fTemp746 / fTemp582;
			double fTemp747 = fTemp586 * (fTemp735 - fRec917[1]) + fRec916[1];
			fRec916[0] = 2.0 * (fTemp747 / fTemp587) - fRec916[1];
			fRec917[0] = fRec917[1] + 2.0 * (fTemp586 * fTemp747 / fTemp587);
			double fRec918 = fTemp589 * fTemp747 / fTemp587;
			double fTemp748 = fTemp591 * (fTemp735 - fRec920[1]) + fRec919[1];
			fRec919[0] = 2.0 * (fTemp748 / fTemp592) - fRec919[1];
			fRec920[0] = fRec920[1] + 2.0 * (fTemp591 * fTemp748 / fTemp592);
			double fRec921 = fTemp594 * fTemp748 / fTemp592;
			double fTemp749 = fTemp596 * (fTemp735 - fRec923[1]) + fRec922[1];
			fRec922[0] = 2.0 * (fTemp749 / fTemp597) - fRec922[1];
			fRec923[0] = fRec923[1] + 2.0 * (fTemp596 * fTemp749 / fTemp597);
			double fRec924 = fTemp599 * fTemp749 / fTemp597;
			double fTemp750 = fTemp601 * (fTemp735 - fRec926[1]) + fRec925[1];
			fRec925[0] = 2.0 * (fTemp750 / fTemp602) - fRec925[1];
			fRec926[0] = fRec926[1] + 2.0 * (fTemp601 * fTemp750 / fTemp602);
			double fRec927 = fTemp604 * fTemp750 / fTemp602;
			double fTemp751 = fTemp606 * (fTemp735 - fRec929[1]) + fRec928[1];
			fRec928[0] = 2.0 * (fTemp751 / fTemp607) - fRec928[1];
			fRec929[0] = fRec929[1] + 2.0 * (fTemp606 * fTemp751 / fTemp607);
			double fRec930 = fTemp609 * fTemp751 / fTemp607;
			double fTemp752 = fTemp611 * (fTemp735 - fRec932[1]) + fRec931[1];
			double fTemp753 = fTemp752 / fTemp612;
			fRec931[0] = 2.0 * fTemp753 - fRec931[1];
			fRec932[0] = fRec932[1] + 2.0 * (fTemp611 * fTemp752 / fTemp612);
			double fRec933 = fTemp753;
			double fTemp754 = fTemp616 * (fTemp735 - fRec935[1]) + fRec934[1];
			fRec934[0] = 2.0 * (fTemp754 / fTemp617) - fRec934[1];
			fRec935[0] = fRec935[1] + 2.0 * (fTemp616 * fTemp754 / fTemp617);
			double fRec936 = fTemp619 * fTemp754 / fTemp617;
			double fTemp755 = fTemp621 * (fTemp735 - fRec938[1]) + fRec937[1];
			fRec937[0] = 2.0 * (fTemp755 / fTemp622) - fRec937[1];
			fRec938[0] = fRec938[1] + 2.0 * (fTemp621 * fTemp755 / fTemp622);
			double fRec939 = fTemp624 * fTemp755 / fTemp622;
			double fTemp756 = fTemp626 * (fTemp735 - fRec941[1]) + fRec940[1];
			fRec940[0] = 2.0 * (fTemp756 / fTemp627) - fRec940[1];
			fRec941[0] = fRec941[1] + 2.0 * (fTemp626 * fTemp756 / fTemp627);
			double fRec942 = fTemp629 * fTemp756 / fTemp627;
			double fTemp757 = fTemp631 * (fTemp735 - fRec944[1]) + fRec943[1];
			fRec943[0] = 2.0 * (fTemp757 / fTemp632) - fRec943[1];
			fRec944[0] = fRec944[1] + 2.0 * (fTemp631 * fTemp757 / fTemp632);
			double fRec945 = fTemp634 * fTemp757 / fTemp632;
			double fTemp758 = fTemp636 * (fTemp735 - fRec947[1]) + fRec946[1];
			fRec946[0] = 2.0 * (fTemp758 / fTemp637) - fRec946[1];
			fRec947[0] = fRec947[1] + 2.0 * (fTemp636 * fTemp758 / fTemp637);
			double fRec948 = fTemp639 * fTemp758 / fTemp637;
			double fTemp759 = fTemp641 * (fTemp735 - fRec950[1]) + fRec949[1];
			fRec949[0] = 2.0 * (fTemp759 / fTemp642) - fRec949[1];
			fRec950[0] = fRec950[1] + 2.0 * (fTemp641 * fTemp759 / fTemp642);
			double fRec951 = fTemp644 * fTemp759 / fTemp642;
			double fTemp760 = fTemp646 * (fTemp735 - fRec953[1]) + fRec952[1];
			fRec952[0] = 2.0 * (fTemp760 / fTemp647) - fRec952[1];
			fRec953[0] = fRec953[1] + 2.0 * (fTemp646 * fTemp760 / fTemp647);
			double fRec954 = fTemp649 * fTemp760 / fTemp647;
			double fTemp761 = fTemp651 * (fTemp735 - fRec956[1]) + fRec955[1];
			fRec955[0] = 2.0 * (fTemp761 / fTemp652) - fRec955[1];
			fRec956[0] = fRec956[1] + 2.0 * (fTemp651 * fTemp761 / fTemp652);
			double fRec957 = fTemp654 * fTemp761 / fTemp652;
			double fTemp762 = fTemp656 * (fTemp735 - fRec959[1]) + fRec958[1];
			fRec958[0] = 2.0 * (fTemp762 / fTemp657) - fRec958[1];
			fRec959[0] = fRec959[1] + 2.0 * (fTemp656 * fTemp762 / fTemp657);
			double fRec960 = fTemp659 * fTemp762 / fTemp657;
			double fTemp763 = fTemp661 * (fTemp735 - fRec962[1]) + fRec961[1];
			fRec961[0] = 2.0 * (fTemp763 / fTemp662) - fRec961[1];
			fRec962[0] = fRec962[1] + 2.0 * (fTemp661 * fTemp763 / fTemp662);
			double fRec963 = fTemp664 * fTemp763 / fTemp662;
			double fTemp764 = fTemp666 * (fTemp735 - fRec965[1]) + fRec964[1];
			fRec964[0] = 2.0 * (fTemp764 / fTemp667) - fRec964[1];
			fRec965[0] = fRec965[1] + 2.0 * (fTemp666 * fTemp764 / fTemp667);
			double fRec966 = fTemp669 * fTemp764 / fTemp667;
			double fTemp765 = fTemp671 * (fTemp735 - fRec968[1]) + fRec967[1];
			fRec967[0] = 2.0 * (fTemp765 / fTemp672) - fRec967[1];
			fRec968[0] = fRec968[1] + 2.0 * (fTemp671 * fTemp765 / fTemp672);
			double fRec969 = fTemp674 * fTemp765 / fTemp672;
			double fTemp766 = fTemp676 * (fTemp735 - fRec971[1]) + fRec970[1];
			fRec970[0] = 2.0 * (fTemp766 / fTemp677) - fRec970[1];
			fRec971[0] = fRec971[1] + 2.0 * (fTemp676 * fTemp766 / fTemp677);
			double fRec972 = fTemp679 * fTemp766 / fTemp677;
			double fTemp767 = fTemp681 * (fTemp735 - fRec974[1]) + fRec973[1];
			fRec973[0] = 2.0 * (fTemp767 / fTemp682) - fRec973[1];
			fRec974[0] = fRec974[1] + 2.0 * (fTemp681 * fTemp767 / fTemp682);
			double fRec975 = fTemp684 * fTemp767 / fTemp682;
			double fTemp768 = fTemp686 * (fTemp735 - fRec977[1]) + fRec976[1];
			fRec976[0] = 2.0 * (fTemp768 / fTemp687) - fRec976[1];
			fRec977[0] = fRec977[1] + 2.0 * (fTemp686 * fTemp768 / fTemp687);
			double fRec978 = fTemp689 * fTemp768 / fTemp687;
			double fTemp769 = 0.03125 * fRec137[0] * (fRec978 + fRec975 + fRec972 + fRec969 + fRec966 + fRec963 + fRec960 + fRec957 + fRec954 + fRec951 + fRec948 + fRec945 + fRec942 + fRec939 + fRec936 + fRec933 + fRec930 + fRec927 + fRec924 + fRec921 + fRec918 + fRec915 + fRec912 + fRec909 + fRec906 + fRec903 + fRec900 + fRec897 + fRec894 + fRec891 + fRec888 + fRec885) + fRec36[0] * fTemp735;
			fRec879[0] = std::max<double>(fConst1 * fRec879[1], std::fabs(fTemp769));
			fVbargraph35 = FAUSTFLOAT(fRec879[0]);
			fRec667[0] = fTemp769;
			double fTemp770 = (fRec667[0] + fRec665[0] + fRec666[0]) / fTemp4;
			fVec17[IOTA0 & 4194303] = fTemp770;
			double fTemp771 = ((fRec979[1] != 0.0) ? (((fRec980[1] > 0.0) & (fRec980[1] < 1.0)) ? fRec979[1] : 0.0) : (((fRec980[1] == 0.0) & (fSlow30 != fRec981[1])) ? 0.0009765625 : (((fRec980[1] == 1.0) & (fSlow30 != fRec982[1])) ? -0.0009765625 : 0.0)));
			fRec979[0] = fTemp771;
			fRec980[0] = std::max<double>(0.0, std::min<double>(1.0, fRec980[1] + fTemp771));
			fRec981[0] = (((fRec980[1] >= 1.0) & (fRec982[1] != fSlow30)) ? fSlow30 : fRec981[1]);
			fRec982[0] = (((fRec980[1] <= 0.0) & (fRec981[1] != fSlow30)) ? fSlow30 : fRec982[1]);
			double fTemp772 = fVec17[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec981[0])))) & 4194303];
			fRec664[0] = 0.3333333333333333 * fTemp772 + fRec980[0] * (0.0 - 0.3333333333333333 * (fTemp772 - fVec17[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec982[0])))) & 4194303]));
			double fTemp773 = fRec26[0] * fRec984[1];
			fRec991[0] = std::max<double>(fConst1 * fRec991[1], std::fabs(fTemp773));
			fVbargraph36 = FAUSTFLOAT(fRec991[0]);
			double fTemp774 = fTemp773;
			double fTemp775 = fRec26[0] * fRec985[1];
			fRec992[0] = std::max<double>(fConst1 * fRec992[1], std::fabs(fTemp775));
			fVbargraph37 = FAUSTFLOAT(fRec992[0]);
			double fTemp776 = fTemp775;
			double fTemp777 = fTemp10 * (fTemp776 - fTemp774);
			double fTemp778 = fSlow31 * fRec11[1];
			fVec18[IOTA0 & 4194303] = fTemp778;
			double fTemp779 = ((fRec994[1] != 0.0) ? (((fRec995[1] > 0.0) & (fRec995[1] < 1.0)) ? fRec994[1] : 0.0) : (((fRec995[1] == 0.0) & (fSlow32 != fRec996[1])) ? 0.0009765625 : (((fRec995[1] == 1.0) & (fSlow32 != fRec997[1])) ? -0.0009765625 : 0.0)));
			fRec994[0] = fTemp779;
			fRec995[0] = std::max<double>(0.0, std::min<double>(1.0, fRec995[1] + fTemp779));
			fRec996[0] = (((fRec995[1] >= 1.0) & (fRec997[1] != fSlow32)) ? fSlow32 : fRec996[1]);
			fRec997[0] = (((fRec995[1] <= 0.0) & (fRec996[1] != fSlow32)) ? fSlow32 : fRec997[1]);
			double fTemp780 = fVec18[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec996[0])))) & 4194303];
			fRec993[0] = fTemp780 + fRec995[0] * (fVec18[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec997[0])))) & 4194303] - fTemp780);
			fVec19[0] = fRec993[1] + fTemp12 + fTemp774 + fTemp777 + fTemp5;
			fRec990[0] = fTemp777 + fRec993[1] + fTemp774 + fTemp12 + 0.995 * fRec990[1] + (1.2 - (fVec0[1] + fVec19[1]));
			fRec989[0] = std::max<double>(fConst1 * fRec989[1], std::fabs(fRec990[0]));
			fVbargraph38 = FAUSTFLOAT(fRec989[0]);
			double fTemp781 = fRec17[0] * tanh(fRec990[0] / fTemp4);
			fRec988[0] = std::max<double>(fConst1 * fRec988[1], std::fabs(fTemp781));
			fVbargraph39 = FAUSTFLOAT(fRec988[0]);
			double fTemp782 = fTemp781;
			fRec1001[0] = fSlow33 + fConst3 * fRec1001[1];
			fRec1002[0] = fSlow34 + fConst3 * fRec1002[1];
			fRec1003[0] = fSlow35 + fConst3 * fRec1003[1];
			double fTemp783 = fRec1003[0] * (561.0 * fRec1001[0] + fRec1002[0] * (562.0 - 1097.0 * fRec1001[0]) + 221.0);
			double fTemp784 = std::tan(fConst5 * fTemp783);
			double fTemp785 = fTemp784 * (fTemp784 + fTemp19 / fTemp783) + 1.0;
			double fTemp786 = fTemp784 * (fTemp782 - fRec999[1]) + fRec998[1];
			fRec998[0] = 2.0 * (fTemp786 / fTemp785) - fRec998[1];
			fRec999[0] = fRec999[1] + 2.0 * (fTemp784 * fTemp786 / fTemp785);
			double fTemp787 = fRec1002[0] * (0.20948251265282836 * fRec1001[0] + -0.35882756573771113) + (0.883508750371294 - 0.3295246174054942 * fRec1001[0]);
			double fRec1000 = fTemp786 * fTemp787 / fTemp785;
			double fTemp788 = fRec1003[0] * (1048.0 * fRec1001[0] + fRec1002[0] * (1.07e+03 * fRec1001[0] + -787.0) + 1619.0);
			double fTemp789 = std::tan(fConst5 * fTemp788);
			double fTemp790 = fTemp789 * (fTemp789 + fTemp19 / fTemp788) + 1.0;
			double fTemp791 = fTemp789 * (fTemp782 - fRec1005[1]) + fRec1004[1];
			fRec1004[0] = 2.0 * (fTemp791 / fTemp790) - fRec1004[1];
			fRec1005[0] = fRec1005[1] + 2.0 * (fTemp789 * fTemp791 / fTemp790);
			double fTemp792 = fRec1002[0] * (0.0016935641831933154 * fRec1001[0] + -0.0070591277129707815) + (0.014962909727368317 - 0.007613896970744654 * fRec1001[0]);
			double fRec1006 = fTemp791 * fTemp792 / fTemp790;
			double fTemp793 = fRec1003[0] * (687.0 * fRec1001[0] + fRec1002[0] * (311.0 - 2032.0 * fRec1001[0]) + 2429.0);
			double fTemp794 = std::tan(fConst5 * fTemp793);
			double fTemp795 = fTemp794 * (fTemp794 + fTemp19 / fTemp793) + 1.0;
			double fTemp796 = fTemp794 * (fTemp782 - fRec1008[1]) + fRec1007[1];
			fRec1007[0] = 2.0 * (fTemp796 / fTemp795) - fRec1007[1];
			fRec1008[0] = fRec1008[1] + 2.0 * (fTemp794 * fTemp796 / fTemp795);
			double fTemp797 = fRec1002[0] * (0.005227226473626777 * fRec1001[0] + -0.010433410102575844) + (0.01934635943322834 - 0.010538363987102131 * fRec1001[0]);
			double fRec1009 = fTemp796 * fTemp797 / fTemp795;
			double fTemp798 = fRec1003[0] * (1422.0 * fRec1001[0] + fRec1002[0] * (-4.0 - 526.0 * fRec1001[0]) + 1178.0);
			double fTemp799 = std::tan(fConst5 * fTemp798);
			double fTemp800 = fTemp799 * (fTemp799 + fTemp19 / fTemp798) + 1.0;
			double fTemp801 = fTemp799 * (fTemp782 - fRec1011[1]) + fRec1010[1];
			fRec1010[0] = 2.0 * (fTemp801 / fTemp800) - fRec1010[1];
			fRec1011[0] = fRec1011[1] + 2.0 * (fTemp799 * fTemp801 / fTemp800);
			double fTemp802 = fRec1002[0] * (0.0015990719330448112 * fRec1001[0] + -0.009377259975676547) + (0.020502590513884294 - 0.008575258476103987 * fRec1001[0]);
			double fRec1012 = fTemp801 * fTemp802 / fTemp800;
			double fTemp803 = fRec1003[0] * (1005.0 * fRec1001[0] + fRec1002[0] * (1538.0 - 1969.0 * fRec1001[0]) + 1398.0);
			double fTemp804 = std::tan(fConst5 * fTemp803);
			double fTemp805 = fTemp804 * (fTemp804 + fTemp19 / fTemp803) + 1.0;
			double fTemp806 = fTemp804 * (fTemp782 - fRec1014[1]) + fRec1013[1];
			fRec1013[0] = 2.0 * (fTemp806 / fTemp805) - fRec1013[1];
			fRec1014[0] = fRec1014[1] + 2.0 * (fTemp804 * fTemp806 / fTemp805);
			double fTemp807 = fRec1002[0] * (-0.004224308163056342 - 0.007247221109719737 * fRec1001[0]) + (0.020955020563014883 - 0.004499122746580129 * fRec1001[0]);
			double fRec1015 = fTemp806 * fTemp807 / fTemp805;
			double fTemp808 = fRec1003[0] * (726.0 * fRec1001[0] + fRec1002[0] * (507.0 - 2138.0 * fRec1001[0]) + 2135.0);
			double fTemp809 = std::tan(fConst5 * fTemp808);
			double fTemp810 = fTemp809 * (fTemp809 + fTemp19 / fTemp808) + 1.0;
			double fTemp811 = fTemp809 * (fTemp782 - fRec1017[1]) + fRec1016[1];
			fRec1016[0] = 2.0 * (fTemp811 / fTemp810) - fRec1016[1];
			fRec1017[0] = fRec1017[1] + 2.0 * (fTemp809 * fTemp811 / fTemp810);
			double fTemp812 = fRec1002[0] * (0.0009039247818369497 - 0.013893501673791466 * fRec1001[0]) + (0.02359690477324046 - 0.005322076674786635 * fRec1001[0]);
			double fRec1018 = fTemp811 * fTemp812 / fTemp810;
			double fTemp813 = fRec1003[0] * (125.0 * fRec1001[0] + fRec1002[0] * (9e+01 - 7.0 * fRec1001[0]) + 2356.0);
			double fTemp814 = std::tan(fConst5 * fTemp813);
			double fTemp815 = fTemp814 * (fTemp814 + fTemp19 / fTemp813) + 1.0;
			double fTemp816 = fTemp814 * (fTemp782 - fRec1020[1]) + fRec1019[1];
			fRec1019[0] = 2.0 * (fTemp816 / fTemp815) - fRec1019[1];
			fRec1020[0] = fRec1020[1] + 2.0 * (fTemp814 * fTemp816 / fTemp815);
			double fTemp817 = fRec1002[0] * (0.00789733404453236 - 0.022269972441420545 * fRec1001[0]) + (0.024970356245165314 - 0.004948333836676418 * fRec1001[0]);
			double fRec1021 = fTemp816 * fTemp817 / fTemp815;
			double fTemp818 = fRec1003[0] * (74.0 * fRec1001[0] + fRec1002[0] * (1147.0 - 837.0 * fRec1001[0]) + 1104.0);
			double fTemp819 = std::tan(fConst5 * fTemp818);
			double fTemp820 = fTemp819 * (fTemp819 + fTemp19 / fTemp818) + 1.0;
			double fTemp821 = fTemp819 * (fTemp782 - fRec1023[1]) + fRec1022[1];
			fRec1022[0] = 2.0 * (fTemp821 / fTemp820) - fRec1022[1];
			fRec1023[0] = fRec1023[1] + 2.0 * (fTemp819 * fTemp821 / fTemp820);
			double fTemp822 = fRec1002[0] * (0.014369998843206975 - 0.03300092964654322 * fRec1001[0]) + (0.025519908386620865 - 0.0011683893550737713 * fRec1001[0]);
			double fRec1024 = fTemp821 * fTemp822 / fTemp820;
			double fTemp823 = fRec1003[0] * (fRec1002[0] * (241.0 * fRec1001[0] + 6.3e+02) + (1914.0 - 1472.0 * fRec1001[0]));
			double fTemp824 = std::tan(fConst5 * fTemp823);
			double fTemp825 = fTemp824 * (fTemp824 + fTemp19 / fTemp823) + 1.0;
			double fTemp826 = fTemp824 * (fTemp782 - fRec1026[1]) + fRec1025[1];
			fRec1025[0] = 2.0 * (fTemp826 / fTemp825) - fRec1025[1];
			fRec1026[0] = fRec1026[1] + 2.0 * (fTemp824 * fTemp826 / fTemp825);
			double fTemp827 = fRec1002[0] * (0.012092025104768513 - 0.030118723258832435 * fRec1001[0]) + (0.034299901561064564 - 0.009167713045154305 * fRec1001[0]);
			double fRec1027 = fTemp826 * fTemp827 / fTemp825;
			double fTemp828 = fRec1003[0] * (403.0 * fRec1001[0] + fRec1002[0] * (1123.0 - 898.0 * fRec1001[0]) + 1.03e+03);
			double fTemp829 = std::tan(fConst5 * fTemp828);
			double fTemp830 = fTemp829 * (fTemp829 + fTemp19 / fTemp828) + 1.0;
			double fTemp831 = fTemp829 * (fTemp782 - fRec1029[1]) + fRec1028[1];
			fRec1028[0] = 2.0 * (fTemp831 / fTemp830) - fRec1028[1];
			fRec1029[0] = fRec1029[1] + 2.0 * (fTemp829 * fTemp831 / fTemp830);
			double fTemp832 = fRec1002[0] * (0.021778225322525664 - 0.04184590502930971 * fRec1001[0]) + (0.03695324484801036 - 0.00815043374124962 * fRec1001[0]);
			double fRec1030 = fTemp831 * fTemp832 / fTemp830;
			double fTemp833 = 6.0 * fRec1001[0];
			double fTemp834 = fRec1003[0] * (fTemp833 + fRec1002[0] * (838.0 * fRec1001[0] + -812.0) + 1693.0);
			double fTemp835 = std::tan(fConst5 * fTemp834);
			double fTemp836 = fTemp835 * (fTemp835 + fTemp19 / fTemp834) + 1.0;
			double fTemp837 = fTemp835 * (fTemp782 - fRec1032[1]) + fRec1031[1];
			fRec1031[0] = 2.0 * (fTemp837 / fTemp836) - fRec1031[1];
			fRec1032[0] = fRec1032[1] + 2.0 * (fTemp835 * fTemp837 / fTemp836);
			double fTemp838 = fRec1002[0] * (0.01054367849960227 - 0.044428922548055166 * fRec1001[0]) + (0.04993743413946004 - 0.006818779501746489 * fRec1001[0]);
			double fRec1033 = fTemp837 * fTemp838 / fTemp836;
			double fTemp839 = fRec1003[0] * (209.0 * fRec1001[0] + fRec1002[0] * (1515.0 - 1507.0 * fRec1001[0]) + 442.0);
			double fTemp840 = std::tan(fConst5 * fTemp839);
			double fTemp841 = fTemp840 * (fTemp840 + fTemp19 / fTemp839) + 1.0;
			double fTemp842 = fTemp840 * (fTemp782 - fRec1035[1]) + fRec1034[1];
			fRec1034[0] = 2.0 * (fTemp842 / fTemp841) - fRec1034[1];
			fRec1035[0] = fRec1035[1] + 2.0 * (fTemp840 * fTemp842 / fTemp841);
			double fTemp843 = fRec1002[0] * (-0.00836319425786336 - 0.027213728546822337 * fRec1001[0]) + (0.07568694217870818 - 0.01847465835663161 * fRec1001[0]);
			double fRec1036 = fTemp842 * fTemp843 / fTemp841;
			double fTemp844 = fRec1003[0] * (675.0 * fRec1001[0] + fRec1002[0] * (1172.0 - 1989.0 * fRec1001[0]) + 883.0);
			double fTemp845 = std::tan(fConst5 * fTemp844);
			double fTemp846 = fTemp845 * (fTemp845 + fTemp19 / fTemp844) + 1.0;
			double fTemp847 = fTemp845 * (fTemp782 - fRec1038[1]) + fRec1037[1];
			fRec1037[0] = 2.0 * (fTemp847 / fTemp846) - fRec1037[1];
			fRec1038[0] = fRec1038[1] + 2.0 * (fTemp845 * fTemp847 / fTemp846);
			double fTemp848 = fRec1002[0] * (0.01667332967615094 * fRec1001[0] + -0.0754718266524771) + (0.15388399774271314 - 0.05838064149040649 * fRec1001[0]);
			double fRec1039 = fTemp847 * fTemp848 / fTemp846;
			double fTemp849 = fRec1003[0] * (1.36e+03 * fRec1001[0] + fRec1002[0] * (-1e+02 - 1025.0 * fRec1001[0]) + 589.0);
			double fTemp850 = std::tan(fConst5 * fTemp849);
			double fTemp851 = fTemp850 * (fTemp850 + fTemp19 / fTemp849) + 1.0;
			double fTemp852 = fTemp850 * (fTemp782 - fRec1041[1]) + fRec1040[1];
			fRec1040[0] = 2.0 * (fTemp852 / fTemp851) - fRec1040[1];
			fRec1041[0] = fRec1041[1] + 2.0 * (fTemp850 * fTemp852 / fTemp851);
			double fTemp853 = 0.012026367628721973 * fRec1001[0] + fRec1002[0] * (-0.03484164734028006 - 0.07088469349182304 * fRec1001[0]) + 0.15986608084324763;
			double fRec1042 = fTemp852 * fTemp853 / fTemp851;
			double fTemp854 = fRec1003[0] * (fRec1002[0] * (-51.0 - 11.0 * fRec1001[0]) + (736.0 - 345.0 * fRec1001[0]));
			double fTemp855 = std::tan(fConst5 * fTemp854);
			double fTemp856 = fTemp855 * (fTemp855 + fTemp19 / fTemp854) + 1.0;
			double fTemp857 = fTemp855 * (fTemp782 - fRec1044[1]) + fRec1043[1];
			fRec1043[0] = 2.0 * (fTemp857 / fTemp856) - fRec1043[1];
			fRec1044[0] = fRec1044[1] + 2.0 * (fTemp855 * fTemp857 / fTemp856);
			double fTemp858 = 0.043418834059638534 * fRec1001[0] + fRec1002[0] * (0.0003590165583120808 - 0.1653942291667907 * fRec1001[0]) + 0.2004373971446242;
			double fRec1045 = fTemp857 * fTemp858 / fTemp856;
			double fTemp859 = fRec1003[0] * (113.0 * fRec1001[0] + fRec1002[0] * (147.0 - 325.0 * fRec1001[0]) + 147.0);
			double fTemp860 = std::tan(fConst5 * fTemp859);
			double fTemp861 = fTemp860 * (fTemp860 + fTemp19 / fTemp859) + 1.0;
			double fTemp862 = fTemp860 * (fTemp782 - fRec1047[1]) + fRec1046[1];
			fRec1046[0] = 2.0 * (fTemp862 / fTemp861) - fRec1046[1];
			fRec1047[0] = fRec1047[1] + 2.0 * (fTemp860 * fTemp862 / fTemp861);
			double fTemp863 = fRec1002[0] * (-0.20926865897501318 - 0.10045148502362689 * fRec1001[0]) + (0.6105272358722508 - 0.05775171174785887 * fRec1001[0]);
			double fRec1048 = fTemp862 * fTemp863 / fTemp861;
			double fTemp864 = fRec1003[0] * (fRec1002[0] * (306.0 * fRec1001[0] + -2.7e+02) + (368.0 - 239.0 * fRec1001[0]));
			double fTemp865 = std::tan(fConst5 * fTemp864);
			double fTemp866 = fTemp865 * (fTemp865 + fTemp19 / fTemp864) + 1.0;
			double fTemp867 = fTemp865 * (fTemp782 - fRec1050[1]) + fRec1049[1];
			double fTemp868 = fTemp867 / fTemp866;
			fRec1049[0] = 2.0 * fTemp868 - fRec1049[1];
			fRec1050[0] = fRec1050[1] + 2.0 * (fTemp865 * fTemp867 / fTemp866);
			double fRec1051 = fTemp868;
			double fTemp869 = fRec1003[0] * (fTemp833 + fRec1002[0] * (72.0 - 181.0 * fRec1001[0]) + 515.0);
			double fTemp870 = std::tan(fConst5 * fTemp869);
			double fTemp871 = fTemp870 * (fTemp870 + fTemp19 / fTemp869) + 1.0;
			double fTemp872 = fTemp870 * (fTemp782 - fRec1053[1]) + fRec1052[1];
			fRec1052[0] = 2.0 * (fTemp872 / fTemp871) - fRec1052[1];
			fRec1053[0] = fRec1053[1] + 2.0 * (fTemp870 * fTemp872 / fTemp871);
			double fTemp873 = 0.1297691905274158 * fRec1001[0] + fRec1002[0] * (-0.020679500617239138 - 0.26354737961410307 * fRec1001[0]) + 0.25009984168236576;
			double fRec1054 = fTemp872 * fTemp873 / fTemp871;
			double fTemp874 = fRec1003[0] * (968.0 * fRec1001[0] + fRec1002[0] * (122.0 - 588.0 * fRec1001[0]) + 74.0);
			double fTemp875 = std::tan(fConst5 * fTemp874);
			double fTemp876 = fTemp875 * (fTemp875 + fTemp19 / fTemp874) + 1.0;
			double fTemp877 = fTemp875 * (fTemp782 - fRec1056[1]) + fRec1055[1];
			fRec1055[0] = 2.0 * (fTemp877 / fTemp876) - fRec1055[1];
			fRec1056[0] = fRec1056[1] + 2.0 * (fTemp875 * fTemp877 / fTemp876);
			double fTemp878 = fRec1002[0] * (-0.00905548290563929 - 0.10407317928289174 * fRec1001[0]) + (0.19782531572463796 - 0.011967933866223551 * fRec1001[0]);
			double fRec1057 = fTemp877 * fTemp878 / fTemp876;
			double fTemp879 = fRec1003[0] * (102.0 * fRec1001[0] + fRec1002[0] * (756.0 - 762.0 * fRec1001[0]) + 8.1e+02);
			double fTemp880 = std::tan(fConst5 * fTemp879);
			double fTemp881 = fTemp880 * (fTemp880 + fTemp19 / fTemp879) + 1.0;
			double fTemp882 = fTemp880 * (fTemp782 - fRec1059[1]) + fRec1058[1];
			fRec1058[0] = 2.0 * (fTemp882 / fTemp881) - fRec1058[1];
			fRec1059[0] = fRec1059[1] + 2.0 * (fTemp880 * fTemp882 / fTemp881);
			double fTemp883 = fRec1002[0] * (-0.06073025380607225 - 0.02103357250515689 * fRec1001[0]) + (0.15408867955329245 - 0.01859664908410899 * fRec1001[0]);
			double fRec1060 = fTemp882 * fTemp883 / fTemp881;
			double fTemp884 = fRec1003[0] * (1784.0 * fRec1001[0] + fRec1002[0] * (96.0 - 1681.0 * fRec1001[0]) + 295.0);
			double fTemp885 = std::tan(fConst5 * fTemp884);
			double fTemp886 = fTemp885 * (fTemp885 + fTemp19 / fTemp884) + 1.0;
			double fTemp887 = fTemp885 * (fTemp782 - fRec1062[1]) + fRec1061[1];
			fRec1061[0] = 2.0 * (fTemp887 / fTemp886) - fRec1061[1];
			fRec1062[0] = fRec1062[1] + 2.0 * (fTemp885 * fTemp887 / fTemp886);
			double fTemp888 = fRec1002[0] * (0.00832579588520789 * fRec1001[0] + -0.044200755516049905) + (0.12206611629626225 - 0.05880265929429268 * fRec1001[0]);
			double fRec1063 = fTemp887 * fTemp888 / fTemp886;
			double fTemp889 = fRec1003[0] * (1689.0 * fRec1001[0] + fRec1002[0] * (806.0 - 1597.0 * fRec1001[0]) + 662.0);
			double fTemp890 = std::tan(fConst5 * fTemp889);
			double fTemp891 = fTemp890 * (fTemp890 + fTemp19 / fTemp889) + 1.0;
			double fTemp892 = fTemp890 * (fTemp782 - fRec1065[1]) + fRec1064[1];
			fRec1064[0] = 2.0 * (fTemp892 / fTemp891) - fRec1064[1];
			fRec1065[0] = fRec1065[1] + 2.0 * (fTemp890 * fTemp892 / fTemp891);
			double fTemp893 = fRec1002[0] * (-0.010952558243701213 - 0.024561127441574723 * fRec1001[0]) + (0.0749419685950924 - 0.028820358890550887 * fRec1001[0]);
			double fRec1066 = fTemp892 * fTemp893 / fTemp891;
			double fTemp894 = fRec1003[0] * (1265.0 * fRec1001[0] + fRec1002[0] * (1.2e+02 - 1.27e+03 * fRec1001[0]) + 956.0);
			double fTemp895 = std::tan(fConst5 * fTemp894);
			double fTemp896 = fTemp895 * (fTemp895 + fTemp19 / fTemp894) + 1.0;
			double fTemp897 = fTemp895 * (fTemp782 - fRec1068[1]) + fRec1067[1];
			fRec1067[0] = 2.0 * (fTemp897 / fTemp896) - fRec1067[1];
			fRec1068[0] = fRec1068[1] + 2.0 * (fTemp895 * fTemp897 / fTemp896);
			double fTemp898 = fRec1002[0] * (0.016194260220710646 - 0.04017164138792575 * fRec1001[0]) + (0.04296305701601583 - 0.009998228849321458 * fRec1001[0]);
			double fRec1069 = fTemp897 * fTemp898 / fTemp896;
			double fTemp899 = fRec1003[0] * (fRec1002[0] * (951.0 * fRec1001[0] + -618.0) + (2282.0 - 463.0 * fRec1001[0]));
			double fTemp900 = std::tan(fConst5 * fTemp899);
			double fTemp901 = fTemp900 * (fTemp900 + fTemp19 / fTemp899) + 1.0;
			double fTemp902 = fTemp900 * (fTemp782 - fRec1071[1]) + fRec1070[1];
			fRec1070[0] = 2.0 * (fTemp902 / fTemp901) - fRec1070[1];
			fRec1071[0] = fRec1071[1] + 2.0 * (fTemp900 * fTemp902 / fTemp901);
			double fTemp903 = fRec1002[0] * (0.015993820877451798 - 0.03561073091810513 * fRec1001[0]) + (0.035190168499954565 - 0.007711275872944394 * fRec1001[0]);
			double fRec1072 = fTemp902 * fTemp903 / fTemp901;
			double fTemp904 = fRec1003[0] * (fRec1002[0] * (803.0 - 1117.0 * fRec1001[0]) + (1546.0 - 238.0 * fRec1001[0]));
			double fTemp905 = std::tan(fConst5 * fTemp904);
			double fTemp906 = fTemp905 * (fTemp905 + fTemp19 / fTemp904) + 1.0;
			double fTemp907 = fTemp905 * (fTemp782 - fRec1074[1]) + fRec1073[1];
			fRec1073[0] = 2.0 * (fTemp907 / fTemp906) - fRec1073[1];
			fRec1074[0] = fRec1074[1] + 2.0 * (fTemp905 * fTemp907 / fTemp906);
			double fTemp908 = fRec1002[0] * (0.012251807773129418 - 0.030545193317676356 * fRec1001[0]) + (0.027814420294695608 - 0.002830824883261286 * fRec1001[0]);
			double fRec1075 = fTemp907 * fTemp908 / fTemp906;
			double fTemp909 = fRec1003[0] * (fRec1002[0] * (1.34e+03 * fRec1001[0] + -102.0) + (1472.0 - 903.0 * fRec1001[0]));
			double fTemp910 = std::tan(fConst5 * fTemp909);
			double fTemp911 = fTemp910 * (fTemp910 + fTemp19 / fTemp909) + 1.0;
			double fTemp912 = fTemp910 * (fTemp782 - fRec1077[1]) + fRec1076[1];
			fRec1076[0] = 2.0 * (fTemp912 / fTemp911) - fRec1076[1];
			fRec1077[0] = fRec1077[1] + 2.0 * (fTemp910 * fTemp912 / fTemp911);
			double fTemp913 = fRec1002[0] * (0.008006093262504007 - 0.024671130121872657 * fRec1001[0]) + (0.025451275008886335 - 0.003130799157219928 * fRec1001[0]);
			double fRec1078 = fTemp912 * fTemp913 / fTemp911;
			double fTemp914 = fRec1003[0] * (fRec1002[0] * (861.0 * fRec1001[0] + -1231.0) + (2503.0 - 228.0 * fRec1001[0]));
			double fTemp915 = std::tan(fConst5 * fTemp914);
			double fTemp916 = fTemp915 * (fTemp915 + fTemp19 / fTemp914) + 1.0;
			double fTemp917 = fTemp915 * (fTemp782 - fRec1080[1]) + fRec1079[1];
			fRec1079[0] = 2.0 * (fTemp917 / fTemp916) - fRec1079[1];
			fRec1080[0] = fRec1080[1] + 2.0 * (fTemp915 * fTemp917 / fTemp916);
			double fTemp918 = fRec1002[0] * (0.002393508230319367 - 0.01643892312610763 * fRec1001[0]) + (0.02376619002590769 - 0.004291546045942368 * fRec1001[0]);
			double fRec1081 = fTemp917 * fTemp918 / fTemp916;
			double fTemp919 = fRec1003[0] * (1281.0 * fRec1001[0] + fRec1002[0] * (37.0 * fRec1001[0] + -273.0) + 1251.0);
			double fTemp920 = std::tan(fConst5 * fTemp919);
			double fTemp921 = fTemp920 * (fTemp920 + fTemp19 / fTemp919) + 1.0;
			double fTemp922 = fTemp920 * (fTemp782 - fRec1083[1]) + fRec1082[1];
			fRec1082[0] = 2.0 * (fTemp922 / fTemp921) - fRec1082[1];
			fRec1083[0] = fRec1083[1] + 2.0 * (fTemp920 * fTemp922 / fTemp921);
			double fTemp923 = fRec1002[0] * (0.001634210217413834 - 0.013674190403903216 * fRec1001[0]) + (0.02108580284017779 - 0.003933981224376031 * fRec1001[0]);
			double fRec1084 = fTemp922 * fTemp923 / fTemp921;
			double fTemp924 = fRec1003[0] * (1666.0 * fRec1001[0] + fRec1002[0] * (436.0 - 1213.0 * fRec1001[0]) + 1325.0);
			double fTemp925 = std::tan(fConst5 * fTemp924);
			double fTemp926 = fTemp925 * (fTemp925 + fTemp19 / fTemp924) + 1.0;
			double fTemp927 = fTemp925 * (fTemp782 - fRec1086[1]) + fRec1085[1];
			fRec1085[0] = 2.0 * (fTemp927 / fTemp926) - fRec1085[1];
			fRec1086[0] = fRec1086[1] + 2.0 * (fTemp925 * fTemp927 / fTemp926);
			double fTemp928 = fRec1002[0] * (-0.006947658589813211 - 0.0032192382202462302 * fRec1001[0]) + (0.02080994218773682 - 0.006343538597854104 * fRec1001[0]);
			double fRec1087 = fTemp927 * fTemp928 / fTemp926;
			double fTemp929 = fRec1003[0] * (81.0 * fRec1001[0] + fRec1002[0] * (972.0 - 715.0 * fRec1001[0]) + 2061.0);
			double fTemp930 = std::tan(fConst5 * fTemp929);
			double fTemp931 = fTemp930 * (fTemp930 + fTemp19 / fTemp929) + 1.0;
			double fTemp932 = fTemp930 * (fTemp782 - fRec1089[1]) + fRec1088[1];
			fRec1088[0] = 2.0 * (fTemp932 / fTemp931) - fRec1088[1];
			fRec1089[0] = fRec1089[1] + 2.0 * (fTemp930 * fTemp932 / fTemp931);
			double fTemp933 = fRec1002[0] * (0.0021589052725694453 * fRec1001[0] + -0.008904165411473826) + (0.019359564369447416 - 0.008690192954800124 * fRec1001[0]);
			double fRec1090 = fTemp932 * fTemp933 / fTemp931;
			double fTemp934 = fRec1003[0] * (fRec1002[0] * (1.02e+03 - 1.62e+03 * fRec1001[0]) + (2209.0 - 456.0 * fRec1001[0]));
			double fTemp935 = std::tan(fConst5 * fTemp934);
			double fTemp936 = fTemp935 * (fTemp935 + fTemp19 / fTemp934) + 1.0;
			double fTemp937 = fTemp935 * (fTemp782 - fRec1092[1]) + fRec1091[1];
			fRec1091[0] = 2.0 * (fTemp937 / fTemp936) - fRec1091[1];
			fRec1092[0] = fRec1092[1] + 2.0 * (fTemp935 * fTemp937 / fTemp936);
			double fTemp938 = fRec1002[0] * (0.005044160613158476 * fRec1001[0] + -0.01013056637869131) + (0.018745547950376563 - 0.011232336533809374 * fRec1001[0]);
			double fRec1093 = fTemp937 * fTemp938 / fTemp936;
			double fTemp939 = fRec1003[0] * (805.0 * fRec1001[0] + fRec1002[0] * (266.0 - 7.7e+02 * fRec1001[0]) + 2572.0);
			double fTemp940 = std::tan(fConst5 * fTemp939);
			double fTemp941 = fTemp940 * (fTemp940 + fTemp19 / fTemp939) + 1.0;
			double fTemp942 = fTemp940 * (fTemp782 - fRec1095[1]) + fRec1094[1];
			fRec1094[0] = 2.0 * (fTemp942 / fTemp941) - fRec1094[1];
			fRec1095[0] = fRec1095[1] + 2.0 * (fTemp940 * fTemp942 / fTemp941);
			double fTemp943 = fRec1002[0] * (0.0016378452192321808 * fRec1001[0] + -0.004344936518553382) + (0.011249397635411025 - 0.006780823623904783 * fRec1001[0]);
			double fRec1096 = fTemp942 * fTemp943 / fTemp941;
			double fTemp944 = 0.03125 * fRec137[0] * (fRec1096 + fRec1093 + fRec1090 + fRec1087 + fRec1084 + fRec1081 + fRec1078 + fRec1075 + fRec1072 + fRec1069 + fRec1066 + fRec1063 + fRec1060 + fRec1057 + fRec1054 + fRec1051 + fRec1048 + fRec1045 + fRec1042 + fRec1039 + fRec1036 + fRec1033 + fRec1030 + fRec1027 + fRec1024 + fRec1021 + fRec1018 + fRec1015 + fRec1012 + fRec1009 + fRec1006 + fRec1000) + fRec36[0] * fTemp782;
			fRec987[0] = std::max<double>(fConst1 * fRec987[1], std::fabs(fTemp944));
			fVbargraph40 = FAUSTFLOAT(fRec987[0]);
			fRec984[0] = fTemp944;
			double fTemp945 = fRec26[0] * fRec986[1];
			fRec1101[0] = std::max<double>(fConst1 * fRec1101[1], std::fabs(fTemp945));
			fVbargraph41 = FAUSTFLOAT(fRec1101[0]);
			double fTemp946 = fTemp945;
			double fTemp947 = fRec28[0] * (fTemp774 * (fRec143[0] - fTemp946) - fTemp776);
			double fTemp948 = fTemp12 + fRec993[1];
			double fTemp949 = fTemp948 + fTemp776;
			fVec20[0] = fTemp949 + fTemp947 + fTemp181;
			fRec1100[0] = fTemp947 + 0.995 * fRec1100[1] + fTemp949 + (1.3 - (fVec3[1] + fVec20[1]));
			fRec1099[0] = std::max<double>(fConst1 * fRec1099[1], std::fabs(fRec1100[0]));
			fVbargraph42 = FAUSTFLOAT(fRec1099[0]);
			double fTemp950 = fRec17[0] * tanh(fRec1100[0] / fTemp4);
			fRec1098[0] = std::max<double>(fConst1 * fRec1098[1], std::fabs(fTemp950));
			fVbargraph43 = FAUSTFLOAT(fRec1098[0]);
			double fTemp951 = fTemp950;
			double fTemp952 = fTemp784 * (fTemp951 - fRec1103[1]) + fRec1102[1];
			fRec1102[0] = 2.0 * (fTemp952 / fTemp785) - fRec1102[1];
			fRec1103[0] = fRec1103[1] + 2.0 * (fTemp784 * fTemp952 / fTemp785);
			double fRec1104 = fTemp787 * fTemp952 / fTemp785;
			double fTemp953 = fTemp789 * (fTemp951 - fRec1106[1]) + fRec1105[1];
			fRec1105[0] = 2.0 * (fTemp953 / fTemp790) - fRec1105[1];
			fRec1106[0] = fRec1106[1] + 2.0 * (fTemp789 * fTemp953 / fTemp790);
			double fRec1107 = fTemp792 * fTemp953 / fTemp790;
			double fTemp954 = fTemp794 * (fTemp951 - fRec1109[1]) + fRec1108[1];
			fRec1108[0] = 2.0 * (fTemp954 / fTemp795) - fRec1108[1];
			fRec1109[0] = fRec1109[1] + 2.0 * (fTemp794 * fTemp954 / fTemp795);
			double fRec1110 = fTemp797 * fTemp954 / fTemp795;
			double fTemp955 = fTemp799 * (fTemp951 - fRec1112[1]) + fRec1111[1];
			fRec1111[0] = 2.0 * (fTemp955 / fTemp800) - fRec1111[1];
			fRec1112[0] = fRec1112[1] + 2.0 * (fTemp799 * fTemp955 / fTemp800);
			double fRec1113 = fTemp802 * fTemp955 / fTemp800;
			double fTemp956 = fTemp804 * (fTemp951 - fRec1115[1]) + fRec1114[1];
			fRec1114[0] = 2.0 * (fTemp956 / fTemp805) - fRec1114[1];
			fRec1115[0] = fRec1115[1] + 2.0 * (fTemp804 * fTemp956 / fTemp805);
			double fRec1116 = fTemp807 * fTemp956 / fTemp805;
			double fTemp957 = fTemp809 * (fTemp951 - fRec1118[1]) + fRec1117[1];
			fRec1117[0] = 2.0 * (fTemp957 / fTemp810) - fRec1117[1];
			fRec1118[0] = fRec1118[1] + 2.0 * (fTemp809 * fTemp957 / fTemp810);
			double fRec1119 = fTemp812 * fTemp957 / fTemp810;
			double fTemp958 = fTemp814 * (fTemp951 - fRec1121[1]) + fRec1120[1];
			fRec1120[0] = 2.0 * (fTemp958 / fTemp815) - fRec1120[1];
			fRec1121[0] = fRec1121[1] + 2.0 * (fTemp814 * fTemp958 / fTemp815);
			double fRec1122 = fTemp817 * fTemp958 / fTemp815;
			double fTemp959 = fTemp819 * (fTemp951 - fRec1124[1]) + fRec1123[1];
			fRec1123[0] = 2.0 * (fTemp959 / fTemp820) - fRec1123[1];
			fRec1124[0] = fRec1124[1] + 2.0 * (fTemp819 * fTemp959 / fTemp820);
			double fRec1125 = fTemp822 * fTemp959 / fTemp820;
			double fTemp960 = fTemp824 * (fTemp951 - fRec1127[1]) + fRec1126[1];
			fRec1126[0] = 2.0 * (fTemp960 / fTemp825) - fRec1126[1];
			fRec1127[0] = fRec1127[1] + 2.0 * (fTemp824 * fTemp960 / fTemp825);
			double fRec1128 = fTemp827 * fTemp960 / fTemp825;
			double fTemp961 = fTemp829 * (fTemp951 - fRec1130[1]) + fRec1129[1];
			fRec1129[0] = 2.0 * (fTemp961 / fTemp830) - fRec1129[1];
			fRec1130[0] = fRec1130[1] + 2.0 * (fTemp829 * fTemp961 / fTemp830);
			double fRec1131 = fTemp832 * fTemp961 / fTemp830;
			double fTemp962 = fTemp835 * (fTemp951 - fRec1133[1]) + fRec1132[1];
			fRec1132[0] = 2.0 * (fTemp962 / fTemp836) - fRec1132[1];
			fRec1133[0] = fRec1133[1] + 2.0 * (fTemp835 * fTemp962 / fTemp836);
			double fRec1134 = fTemp838 * fTemp962 / fTemp836;
			double fTemp963 = fTemp840 * (fTemp951 - fRec1136[1]) + fRec1135[1];
			fRec1135[0] = 2.0 * (fTemp963 / fTemp841) - fRec1135[1];
			fRec1136[0] = fRec1136[1] + 2.0 * (fTemp840 * fTemp963 / fTemp841);
			double fRec1137 = fTemp843 * fTemp963 / fTemp841;
			double fTemp964 = fTemp845 * (fTemp951 - fRec1139[1]) + fRec1138[1];
			fRec1138[0] = 2.0 * (fTemp964 / fTemp846) - fRec1138[1];
			fRec1139[0] = fRec1139[1] + 2.0 * (fTemp845 * fTemp964 / fTemp846);
			double fRec1140 = fTemp848 * fTemp964 / fTemp846;
			double fTemp965 = fTemp850 * (fTemp951 - fRec1142[1]) + fRec1141[1];
			fRec1141[0] = 2.0 * (fTemp965 / fTemp851) - fRec1141[1];
			fRec1142[0] = fRec1142[1] + 2.0 * (fTemp850 * fTemp965 / fTemp851);
			double fRec1143 = fTemp853 * fTemp965 / fTemp851;
			double fTemp966 = fTemp855 * (fTemp951 - fRec1145[1]) + fRec1144[1];
			fRec1144[0] = 2.0 * (fTemp966 / fTemp856) - fRec1144[1];
			fRec1145[0] = fRec1145[1] + 2.0 * (fTemp855 * fTemp966 / fTemp856);
			double fRec1146 = fTemp858 * fTemp966 / fTemp856;
			double fTemp967 = fTemp860 * (fTemp951 - fRec1148[1]) + fRec1147[1];
			fRec1147[0] = 2.0 * (fTemp967 / fTemp861) - fRec1147[1];
			fRec1148[0] = fRec1148[1] + 2.0 * (fTemp860 * fTemp967 / fTemp861);
			double fRec1149 = fTemp863 * fTemp967 / fTemp861;
			double fTemp968 = fTemp865 * (fTemp951 - fRec1151[1]) + fRec1150[1];
			double fTemp969 = fTemp968 / fTemp866;
			fRec1150[0] = 2.0 * fTemp969 - fRec1150[1];
			fRec1151[0] = fRec1151[1] + 2.0 * (fTemp865 * fTemp968 / fTemp866);
			double fRec1152 = fTemp969;
			double fTemp970 = fTemp870 * (fTemp951 - fRec1154[1]) + fRec1153[1];
			fRec1153[0] = 2.0 * (fTemp970 / fTemp871) - fRec1153[1];
			fRec1154[0] = fRec1154[1] + 2.0 * (fTemp870 * fTemp970 / fTemp871);
			double fRec1155 = fTemp873 * fTemp970 / fTemp871;
			double fTemp971 = fTemp875 * (fTemp951 - fRec1157[1]) + fRec1156[1];
			fRec1156[0] = 2.0 * (fTemp971 / fTemp876) - fRec1156[1];
			fRec1157[0] = fRec1157[1] + 2.0 * (fTemp875 * fTemp971 / fTemp876);
			double fRec1158 = fTemp878 * fTemp971 / fTemp876;
			double fTemp972 = fTemp880 * (fTemp951 - fRec1160[1]) + fRec1159[1];
			fRec1159[0] = 2.0 * (fTemp972 / fTemp881) - fRec1159[1];
			fRec1160[0] = fRec1160[1] + 2.0 * (fTemp880 * fTemp972 / fTemp881);
			double fRec1161 = fTemp883 * fTemp972 / fTemp881;
			double fTemp973 = fTemp885 * (fTemp951 - fRec1163[1]) + fRec1162[1];
			fRec1162[0] = 2.0 * (fTemp973 / fTemp886) - fRec1162[1];
			fRec1163[0] = fRec1163[1] + 2.0 * (fTemp885 * fTemp973 / fTemp886);
			double fRec1164 = fTemp888 * fTemp973 / fTemp886;
			double fTemp974 = fTemp890 * (fTemp951 - fRec1166[1]) + fRec1165[1];
			fRec1165[0] = 2.0 * (fTemp974 / fTemp891) - fRec1165[1];
			fRec1166[0] = fRec1166[1] + 2.0 * (fTemp890 * fTemp974 / fTemp891);
			double fRec1167 = fTemp893 * fTemp974 / fTemp891;
			double fTemp975 = fTemp895 * (fTemp951 - fRec1169[1]) + fRec1168[1];
			fRec1168[0] = 2.0 * (fTemp975 / fTemp896) - fRec1168[1];
			fRec1169[0] = fRec1169[1] + 2.0 * (fTemp895 * fTemp975 / fTemp896);
			double fRec1170 = fTemp898 * fTemp975 / fTemp896;
			double fTemp976 = fTemp900 * (fTemp951 - fRec1172[1]) + fRec1171[1];
			fRec1171[0] = 2.0 * (fTemp976 / fTemp901) - fRec1171[1];
			fRec1172[0] = fRec1172[1] + 2.0 * (fTemp900 * fTemp976 / fTemp901);
			double fRec1173 = fTemp903 * fTemp976 / fTemp901;
			double fTemp977 = fTemp905 * (fTemp951 - fRec1175[1]) + fRec1174[1];
			fRec1174[0] = 2.0 * (fTemp977 / fTemp906) - fRec1174[1];
			fRec1175[0] = fRec1175[1] + 2.0 * (fTemp905 * fTemp977 / fTemp906);
			double fRec1176 = fTemp908 * fTemp977 / fTemp906;
			double fTemp978 = fTemp910 * (fTemp951 - fRec1178[1]) + fRec1177[1];
			fRec1177[0] = 2.0 * (fTemp978 / fTemp911) - fRec1177[1];
			fRec1178[0] = fRec1178[1] + 2.0 * (fTemp910 * fTemp978 / fTemp911);
			double fRec1179 = fTemp913 * fTemp978 / fTemp911;
			double fTemp979 = fTemp915 * (fTemp951 - fRec1181[1]) + fRec1180[1];
			fRec1180[0] = 2.0 * (fTemp979 / fTemp916) - fRec1180[1];
			fRec1181[0] = fRec1181[1] + 2.0 * (fTemp915 * fTemp979 / fTemp916);
			double fRec1182 = fTemp918 * fTemp979 / fTemp916;
			double fTemp980 = fTemp920 * (fTemp951 - fRec1184[1]) + fRec1183[1];
			fRec1183[0] = 2.0 * (fTemp980 / fTemp921) - fRec1183[1];
			fRec1184[0] = fRec1184[1] + 2.0 * (fTemp920 * fTemp980 / fTemp921);
			double fRec1185 = fTemp923 * fTemp980 / fTemp921;
			double fTemp981 = fTemp925 * (fTemp951 - fRec1187[1]) + fRec1186[1];
			fRec1186[0] = 2.0 * (fTemp981 / fTemp926) - fRec1186[1];
			fRec1187[0] = fRec1187[1] + 2.0 * (fTemp925 * fTemp981 / fTemp926);
			double fRec1188 = fTemp928 * fTemp981 / fTemp926;
			double fTemp982 = fTemp930 * (fTemp951 - fRec1190[1]) + fRec1189[1];
			fRec1189[0] = 2.0 * (fTemp982 / fTemp931) - fRec1189[1];
			fRec1190[0] = fRec1190[1] + 2.0 * (fTemp930 * fTemp982 / fTemp931);
			double fRec1191 = fTemp933 * fTemp982 / fTemp931;
			double fTemp983 = fTemp935 * (fTemp951 - fRec1193[1]) + fRec1192[1];
			fRec1192[0] = 2.0 * (fTemp983 / fTemp936) - fRec1192[1];
			fRec1193[0] = fRec1193[1] + 2.0 * (fTemp935 * fTemp983 / fTemp936);
			double fRec1194 = fTemp938 * fTemp983 / fTemp936;
			double fTemp984 = fTemp940 * (fTemp951 - fRec1196[1]) + fRec1195[1];
			fRec1195[0] = 2.0 * (fTemp984 / fTemp941) - fRec1195[1];
			fRec1196[0] = fRec1196[1] + 2.0 * (fTemp940 * fTemp984 / fTemp941);
			double fRec1197 = fTemp943 * fTemp984 / fTemp941;
			double fTemp985 = 0.03125 * fRec137[0] * (fRec1197 + fRec1194 + fRec1191 + fRec1188 + fRec1185 + fRec1182 + fRec1179 + fRec1176 + fRec1173 + fRec1170 + fRec1167 + fRec1164 + fRec1161 + fRec1158 + fRec1155 + fRec1152 + fRec1149 + fRec1146 + fRec1143 + fRec1140 + fRec1137 + fRec1134 + fRec1131 + fRec1128 + fRec1125 + fRec1122 + fRec1119 + fRec1116 + fRec1113 + fRec1110 + fRec1107 + fRec1104) + fRec36[0] * fTemp951;
			fRec1097[0] = std::max<double>(fConst1 * fRec1097[1], std::fabs(fTemp985));
			fVbargraph44 = FAUSTFLOAT(fRec1097[0]);
			fRec985[0] = fTemp985;
			double fTemp986 = fRec28[0] * (fTemp774 * fTemp776 - fRec244[0] * fTemp946);
			double fTemp987 = fTemp948 + fTemp946;
			fVec21[0] = fTemp987 + fTemp986 + fTemp223;
			fRec1201[0] = fTemp986 + 0.995 * fRec1201[1] + fTemp987 + (1.6 - (fVec5[1] + fVec21[1]));
			fRec1200[0] = std::max<double>(fConst1 * fRec1200[1], std::fabs(fRec1201[0]));
			fVbargraph45 = FAUSTFLOAT(fRec1200[0]);
			double fTemp988 = fRec17[0] * tanh(fRec1201[0] / fTemp4);
			fRec1199[0] = std::max<double>(fConst1 * fRec1199[1], std::fabs(fTemp988));
			fVbargraph46 = FAUSTFLOAT(fRec1199[0]);
			double fTemp989 = fTemp988;
			double fTemp990 = fTemp784 * (fTemp989 - fRec1203[1]) + fRec1202[1];
			fRec1202[0] = 2.0 * (fTemp990 / fTemp785) - fRec1202[1];
			fRec1203[0] = fRec1203[1] + 2.0 * (fTemp784 * fTemp990 / fTemp785);
			double fRec1204 = fTemp787 * fTemp990 / fTemp785;
			double fTemp991 = fTemp789 * (fTemp989 - fRec1206[1]) + fRec1205[1];
			fRec1205[0] = 2.0 * (fTemp991 / fTemp790) - fRec1205[1];
			fRec1206[0] = fRec1206[1] + 2.0 * (fTemp789 * fTemp991 / fTemp790);
			double fRec1207 = fTemp792 * fTemp991 / fTemp790;
			double fTemp992 = fTemp794 * (fTemp989 - fRec1209[1]) + fRec1208[1];
			fRec1208[0] = 2.0 * (fTemp992 / fTemp795) - fRec1208[1];
			fRec1209[0] = fRec1209[1] + 2.0 * (fTemp794 * fTemp992 / fTemp795);
			double fRec1210 = fTemp797 * fTemp992 / fTemp795;
			double fTemp993 = fTemp799 * (fTemp989 - fRec1212[1]) + fRec1211[1];
			fRec1211[0] = 2.0 * (fTemp993 / fTemp800) - fRec1211[1];
			fRec1212[0] = fRec1212[1] + 2.0 * (fTemp799 * fTemp993 / fTemp800);
			double fRec1213 = fTemp802 * fTemp993 / fTemp800;
			double fTemp994 = fTemp804 * (fTemp989 - fRec1215[1]) + fRec1214[1];
			fRec1214[0] = 2.0 * (fTemp994 / fTemp805) - fRec1214[1];
			fRec1215[0] = fRec1215[1] + 2.0 * (fTemp804 * fTemp994 / fTemp805);
			double fRec1216 = fTemp807 * fTemp994 / fTemp805;
			double fTemp995 = fTemp809 * (fTemp989 - fRec1218[1]) + fRec1217[1];
			fRec1217[0] = 2.0 * (fTemp995 / fTemp810) - fRec1217[1];
			fRec1218[0] = fRec1218[1] + 2.0 * (fTemp809 * fTemp995 / fTemp810);
			double fRec1219 = fTemp812 * fTemp995 / fTemp810;
			double fTemp996 = fTemp814 * (fTemp989 - fRec1221[1]) + fRec1220[1];
			fRec1220[0] = 2.0 * (fTemp996 / fTemp815) - fRec1220[1];
			fRec1221[0] = fRec1221[1] + 2.0 * (fTemp814 * fTemp996 / fTemp815);
			double fRec1222 = fTemp817 * fTemp996 / fTemp815;
			double fTemp997 = fTemp819 * (fTemp989 - fRec1224[1]) + fRec1223[1];
			fRec1223[0] = 2.0 * (fTemp997 / fTemp820) - fRec1223[1];
			fRec1224[0] = fRec1224[1] + 2.0 * (fTemp819 * fTemp997 / fTemp820);
			double fRec1225 = fTemp822 * fTemp997 / fTemp820;
			double fTemp998 = fTemp824 * (fTemp989 - fRec1227[1]) + fRec1226[1];
			fRec1226[0] = 2.0 * (fTemp998 / fTemp825) - fRec1226[1];
			fRec1227[0] = fRec1227[1] + 2.0 * (fTemp824 * fTemp998 / fTemp825);
			double fRec1228 = fTemp827 * fTemp998 / fTemp825;
			double fTemp999 = fTemp829 * (fTemp989 - fRec1230[1]) + fRec1229[1];
			fRec1229[0] = 2.0 * (fTemp999 / fTemp830) - fRec1229[1];
			fRec1230[0] = fRec1230[1] + 2.0 * (fTemp829 * fTemp999 / fTemp830);
			double fRec1231 = fTemp832 * fTemp999 / fTemp830;
			double fTemp1000 = fTemp835 * (fTemp989 - fRec1233[1]) + fRec1232[1];
			fRec1232[0] = 2.0 * (fTemp1000 / fTemp836) - fRec1232[1];
			fRec1233[0] = fRec1233[1] + 2.0 * (fTemp835 * fTemp1000 / fTemp836);
			double fRec1234 = fTemp838 * fTemp1000 / fTemp836;
			double fTemp1001 = fTemp840 * (fTemp989 - fRec1236[1]) + fRec1235[1];
			fRec1235[0] = 2.0 * (fTemp1001 / fTemp841) - fRec1235[1];
			fRec1236[0] = fRec1236[1] + 2.0 * (fTemp840 * fTemp1001 / fTemp841);
			double fRec1237 = fTemp843 * fTemp1001 / fTemp841;
			double fTemp1002 = fTemp845 * (fTemp989 - fRec1239[1]) + fRec1238[1];
			fRec1238[0] = 2.0 * (fTemp1002 / fTemp846) - fRec1238[1];
			fRec1239[0] = fRec1239[1] + 2.0 * (fTemp845 * fTemp1002 / fTemp846);
			double fRec1240 = fTemp848 * fTemp1002 / fTemp846;
			double fTemp1003 = fTemp850 * (fTemp989 - fRec1242[1]) + fRec1241[1];
			fRec1241[0] = 2.0 * (fTemp1003 / fTemp851) - fRec1241[1];
			fRec1242[0] = fRec1242[1] + 2.0 * (fTemp850 * fTemp1003 / fTemp851);
			double fRec1243 = fTemp853 * fTemp1003 / fTemp851;
			double fTemp1004 = fTemp855 * (fTemp989 - fRec1245[1]) + fRec1244[1];
			fRec1244[0] = 2.0 * (fTemp1004 / fTemp856) - fRec1244[1];
			fRec1245[0] = fRec1245[1] + 2.0 * (fTemp855 * fTemp1004 / fTemp856);
			double fRec1246 = fTemp858 * fTemp1004 / fTemp856;
			double fTemp1005 = fTemp860 * (fTemp989 - fRec1248[1]) + fRec1247[1];
			fRec1247[0] = 2.0 * (fTemp1005 / fTemp861) - fRec1247[1];
			fRec1248[0] = fRec1248[1] + 2.0 * (fTemp860 * fTemp1005 / fTemp861);
			double fRec1249 = fTemp863 * fTemp1005 / fTemp861;
			double fTemp1006 = fTemp865 * (fTemp989 - fRec1251[1]) + fRec1250[1];
			double fTemp1007 = fTemp1006 / fTemp866;
			fRec1250[0] = 2.0 * fTemp1007 - fRec1250[1];
			fRec1251[0] = fRec1251[1] + 2.0 * (fTemp865 * fTemp1006 / fTemp866);
			double fRec1252 = fTemp1007;
			double fTemp1008 = fTemp870 * (fTemp989 - fRec1254[1]) + fRec1253[1];
			fRec1253[0] = 2.0 * (fTemp1008 / fTemp871) - fRec1253[1];
			fRec1254[0] = fRec1254[1] + 2.0 * (fTemp870 * fTemp1008 / fTemp871);
			double fRec1255 = fTemp873 * fTemp1008 / fTemp871;
			double fTemp1009 = fTemp875 * (fTemp989 - fRec1257[1]) + fRec1256[1];
			fRec1256[0] = 2.0 * (fTemp1009 / fTemp876) - fRec1256[1];
			fRec1257[0] = fRec1257[1] + 2.0 * (fTemp875 * fTemp1009 / fTemp876);
			double fRec1258 = fTemp878 * fTemp1009 / fTemp876;
			double fTemp1010 = fTemp880 * (fTemp989 - fRec1260[1]) + fRec1259[1];
			fRec1259[0] = 2.0 * (fTemp1010 / fTemp881) - fRec1259[1];
			fRec1260[0] = fRec1260[1] + 2.0 * (fTemp880 * fTemp1010 / fTemp881);
			double fRec1261 = fTemp883 * fTemp1010 / fTemp881;
			double fTemp1011 = fTemp885 * (fTemp989 - fRec1263[1]) + fRec1262[1];
			fRec1262[0] = 2.0 * (fTemp1011 / fTemp886) - fRec1262[1];
			fRec1263[0] = fRec1263[1] + 2.0 * (fTemp885 * fTemp1011 / fTemp886);
			double fRec1264 = fTemp888 * fTemp1011 / fTemp886;
			double fTemp1012 = fTemp890 * (fTemp989 - fRec1266[1]) + fRec1265[1];
			fRec1265[0] = 2.0 * (fTemp1012 / fTemp891) - fRec1265[1];
			fRec1266[0] = fRec1266[1] + 2.0 * (fTemp890 * fTemp1012 / fTemp891);
			double fRec1267 = fTemp893 * fTemp1012 / fTemp891;
			double fTemp1013 = fTemp895 * (fTemp989 - fRec1269[1]) + fRec1268[1];
			fRec1268[0] = 2.0 * (fTemp1013 / fTemp896) - fRec1268[1];
			fRec1269[0] = fRec1269[1] + 2.0 * (fTemp895 * fTemp1013 / fTemp896);
			double fRec1270 = fTemp898 * fTemp1013 / fTemp896;
			double fTemp1014 = fTemp900 * (fTemp989 - fRec1272[1]) + fRec1271[1];
			fRec1271[0] = 2.0 * (fTemp1014 / fTemp901) - fRec1271[1];
			fRec1272[0] = fRec1272[1] + 2.0 * (fTemp900 * fTemp1014 / fTemp901);
			double fRec1273 = fTemp903 * fTemp1014 / fTemp901;
			double fTemp1015 = fTemp905 * (fTemp989 - fRec1275[1]) + fRec1274[1];
			fRec1274[0] = 2.0 * (fTemp1015 / fTemp906) - fRec1274[1];
			fRec1275[0] = fRec1275[1] + 2.0 * (fTemp905 * fTemp1015 / fTemp906);
			double fRec1276 = fTemp908 * fTemp1015 / fTemp906;
			double fTemp1016 = fTemp910 * (fTemp989 - fRec1278[1]) + fRec1277[1];
			fRec1277[0] = 2.0 * (fTemp1016 / fTemp911) - fRec1277[1];
			fRec1278[0] = fRec1278[1] + 2.0 * (fTemp910 * fTemp1016 / fTemp911);
			double fRec1279 = fTemp913 * fTemp1016 / fTemp911;
			double fTemp1017 = fTemp915 * (fTemp989 - fRec1281[1]) + fRec1280[1];
			fRec1280[0] = 2.0 * (fTemp1017 / fTemp916) - fRec1280[1];
			fRec1281[0] = fRec1281[1] + 2.0 * (fTemp915 * fTemp1017 / fTemp916);
			double fRec1282 = fTemp918 * fTemp1017 / fTemp916;
			double fTemp1018 = fTemp920 * (fTemp989 - fRec1284[1]) + fRec1283[1];
			fRec1283[0] = 2.0 * (fTemp1018 / fTemp921) - fRec1283[1];
			fRec1284[0] = fRec1284[1] + 2.0 * (fTemp920 * fTemp1018 / fTemp921);
			double fRec1285 = fTemp923 * fTemp1018 / fTemp921;
			double fTemp1019 = fTemp925 * (fTemp989 - fRec1287[1]) + fRec1286[1];
			fRec1286[0] = 2.0 * (fTemp1019 / fTemp926) - fRec1286[1];
			fRec1287[0] = fRec1287[1] + 2.0 * (fTemp925 * fTemp1019 / fTemp926);
			double fRec1288 = fTemp928 * fTemp1019 / fTemp926;
			double fTemp1020 = fTemp930 * (fTemp989 - fRec1290[1]) + fRec1289[1];
			fRec1289[0] = 2.0 * (fTemp1020 / fTemp931) - fRec1289[1];
			fRec1290[0] = fRec1290[1] + 2.0 * (fTemp930 * fTemp1020 / fTemp931);
			double fRec1291 = fTemp933 * fTemp1020 / fTemp931;
			double fTemp1021 = fTemp935 * (fTemp989 - fRec1293[1]) + fRec1292[1];
			fRec1292[0] = 2.0 * (fTemp1021 / fTemp936) - fRec1292[1];
			fRec1293[0] = fRec1293[1] + 2.0 * (fTemp935 * fTemp1021 / fTemp936);
			double fRec1294 = fTemp938 * fTemp1021 / fTemp936;
			double fTemp1022 = fTemp940 * (fTemp989 - fRec1296[1]) + fRec1295[1];
			fRec1295[0] = 2.0 * (fTemp1022 / fTemp941) - fRec1295[1];
			fRec1296[0] = fRec1296[1] + 2.0 * (fTemp940 * fTemp1022 / fTemp941);
			double fRec1297 = fTemp943 * fTemp1022 / fTemp941;
			double fTemp1023 = 0.03125 * fRec137[0] * (fRec1297 + fRec1294 + fRec1291 + fRec1288 + fRec1285 + fRec1282 + fRec1279 + fRec1276 + fRec1273 + fRec1270 + fRec1267 + fRec1264 + fRec1261 + fRec1258 + fRec1255 + fRec1252 + fRec1249 + fRec1246 + fRec1243 + fRec1240 + fRec1237 + fRec1234 + fRec1231 + fRec1228 + fRec1225 + fRec1222 + fRec1219 + fRec1216 + fRec1213 + fRec1210 + fRec1207 + fRec1204) + fRec36[0] * fTemp989;
			fRec1198[0] = std::max<double>(fConst1 * fRec1198[1], std::fabs(fTemp1023));
			fVbargraph47 = FAUSTFLOAT(fRec1198[0]);
			fRec986[0] = fTemp1023;
			double fTemp1024 = (fRec986[0] + fRec984[0] + fRec985[0]) / fTemp4;
			fVec22[IOTA0 & 4194303] = fTemp1024;
			double fTemp1025 = ((fRec1298[1] != 0.0) ? (((fRec1299[1] > 0.0) & (fRec1299[1] < 1.0)) ? fRec1298[1] : 0.0) : (((fRec1299[1] == 0.0) & (fSlow36 != fRec1300[1])) ? 0.0009765625 : (((fRec1299[1] == 1.0) & (fSlow36 != fRec1301[1])) ? -0.0009765625 : 0.0)));
			fRec1298[0] = fTemp1025;
			fRec1299[0] = std::max<double>(0.0, std::min<double>(1.0, fRec1299[1] + fTemp1025));
			fRec1300[0] = (((fRec1299[1] >= 1.0) & (fRec1301[1] != fSlow36)) ? fSlow36 : fRec1300[1]);
			fRec1301[0] = (((fRec1299[1] <= 0.0) & (fRec1300[1] != fSlow36)) ? fSlow36 : fRec1301[1]);
			double fTemp1026 = fVec22[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec1300[0])))) & 4194303];
			fRec983[0] = 0.3333333333333333 * fTemp1026 + fRec1299[0] * (0.0 - 0.3333333333333333 * (fTemp1026 - fVec22[(IOTA0 - int(std::min<double>(fConst6, std::max<double>(0.0, fRec1301[0])))) & 4194303]));
			fRec11[0] = 0.25 * (fRec983[1] + fRec664[1] + fRec345[1] + fRec16[1]);
			double fRec12 = 0.3333333333333333 * fTemp770;
			double fRec13 = 0.3333333333333333 * fTemp262;
			double fRec14 = 0.3333333333333333 * fTemp516;
			double fRec15 = 0.3333333333333333 * fTemp1024;
			double fTemp1027 = (fRec12 - fRec8[1]) * fTemp2 / fTemp3;
			fRec8[0] = fRec8[1] + 2.0 * fTemp1027;
			double fTemp1028 = fRec8[1] + fTemp1027;
			double fRec9 = fRec12 - fTemp1028;
			double fTemp1029 = (fRec9 - fRec5[1]) * fTemp0 / fTemp1;
			fRec5[0] = fRec5[1] + 2.0 * fTemp1029;
			double fTemp1030 = fRec5[1] + fTemp1029;
			fRec6[IOTA0 & 511] = fTemp1030;
			double fTemp1031 = std::fabs(fRec6[IOTA0 & 511]);
			int iTemp1032 = (fTemp1031 >= fRec4[1]) | (double(iRec3[1]) >= fConst2);
			iRec3[0] = ((iTemp1032) ? 0 : iRec3[1] + 1);
			fRec4[0] = ((iTemp1032) ? fTemp1031 : fRec4[1]);
			double fTemp1033 = fRec4[0] - fRec1[1];
			fRec1[0] = fRec1[1] + fConst9 * fTemp1033;
			double fTemp1034 = fRec1[1] + fConst8 * fTemp1033;
			double fRec2 = fTemp1034;
			fRec0[0] = std::max<double>(fConst1 * fRec0[1], std::fabs(fRec2));
			fRec1302[0] = fSlow38 + fConst3 * fRec1302[1];
			output0[i0] = FAUSTFLOAT(fRec1302[0] * fRec6[(IOTA0 - iConst10) & 511] / fRec0[0]);
			double fTemp1035 = fTemp2 * (fRec13 - fRec1310[1]) / fTemp3;
			fRec1310[0] = fRec1310[1] + 2.0 * fTemp1035;
			double fTemp1036 = fRec1310[1] + fTemp1035;
			double fRec1311 = fRec13 - fTemp1036;
			double fTemp1037 = fTemp0 * (fRec1311 - fRec1308[1]) / fTemp1;
			fRec1308[0] = fRec1308[1] + 2.0 * fTemp1037;
			double fTemp1038 = fRec1308[1] + fTemp1037;
			fRec1309[IOTA0 & 511] = fTemp1038;
			double fTemp1039 = std::fabs(fRec1309[IOTA0 & 511]);
			int iTemp1040 = (fTemp1039 >= fRec1307[1]) | (double(iRec1306[1]) >= fConst2);
			iRec1306[0] = ((iTemp1040) ? 0 : iRec1306[1] + 1);
			fRec1307[0] = ((iTemp1040) ? fTemp1039 : fRec1307[1]);
			double fTemp1041 = fRec1307[0] - fRec1304[1];
			fRec1304[0] = fRec1304[1] + fConst9 * fTemp1041;
			double fTemp1042 = fRec1304[1] + fConst8 * fTemp1041;
			double fRec1305 = fTemp1042;
			fRec1303[0] = std::max<double>(fConst1 * fRec1303[1], std::fabs(fRec1305));
			output1[i0] = FAUSTFLOAT(fRec1302[0] * fRec1309[(IOTA0 - iConst10) & 511] / fRec1303[0]);
			double fTemp1043 = fTemp2 * (fRec14 - fRec1319[1]) / fTemp3;
			fRec1319[0] = fRec1319[1] + 2.0 * fTemp1043;
			double fTemp1044 = fRec1319[1] + fTemp1043;
			double fRec1320 = fRec14 - fTemp1044;
			double fTemp1045 = fTemp0 * (fRec1320 - fRec1317[1]) / fTemp1;
			fRec1317[0] = fRec1317[1] + 2.0 * fTemp1045;
			double fTemp1046 = fRec1317[1] + fTemp1045;
			fRec1318[IOTA0 & 511] = fTemp1046;
			double fTemp1047 = std::fabs(fRec1318[IOTA0 & 511]);
			int iTemp1048 = (fTemp1047 >= fRec1316[1]) | (double(iRec1315[1]) >= fConst2);
			iRec1315[0] = ((iTemp1048) ? 0 : iRec1315[1] + 1);
			fRec1316[0] = ((iTemp1048) ? fTemp1047 : fRec1316[1]);
			double fTemp1049 = fRec1316[0] - fRec1313[1];
			fRec1313[0] = fRec1313[1] + fConst9 * fTemp1049;
			double fTemp1050 = fRec1313[1] + fConst8 * fTemp1049;
			double fRec1314 = fTemp1050;
			fRec1312[0] = std::max<double>(fConst1 * fRec1312[1], std::fabs(fRec1314));
			output2[i0] = FAUSTFLOAT(fRec1302[0] * fRec1318[(IOTA0 - iConst10) & 511] / fRec1312[0]);
			double fTemp1051 = fTemp2 * (fRec15 - fRec1328[1]) / fTemp3;
			fRec1328[0] = fRec1328[1] + 2.0 * fTemp1051;
			double fTemp1052 = fRec1328[1] + fTemp1051;
			double fRec1329 = fRec15 - fTemp1052;
			double fTemp1053 = fTemp0 * (fRec1329 - fRec1326[1]) / fTemp1;
			fRec1326[0] = fRec1326[1] + 2.0 * fTemp1053;
			double fTemp1054 = fRec1326[1] + fTemp1053;
			fRec1327[IOTA0 & 511] = fTemp1054;
			double fTemp1055 = std::fabs(fRec1327[IOTA0 & 511]);
			int iTemp1056 = (fTemp1055 >= fRec1325[1]) | (double(iRec1324[1]) >= fConst2);
			iRec1324[0] = ((iTemp1056) ? 0 : iRec1324[1] + 1);
			fRec1325[0] = ((iTemp1056) ? fTemp1055 : fRec1325[1]);
			double fTemp1057 = fRec1325[0] - fRec1322[1];
			fRec1322[0] = fRec1322[1] + fConst9 * fTemp1057;
			double fTemp1058 = fRec1322[1] + fConst8 * fTemp1057;
			double fRec1323 = fTemp1058;
			fRec1321[0] = std::max<double>(fConst1 * fRec1321[1], std::fabs(fRec1323));
			output3[i0] = FAUSTFLOAT(fRec1302[0] * fRec1327[(IOTA0 - iConst10) & 511] / fRec1321[0]);
			fRec7[1] = fRec7[0];
			fRec10[1] = fRec10[0];
			fRec17[1] = fRec17[0];
			fVec0[1] = fVec0[0];
	...
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/BP Bypass", fVslider9, 0.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/BP Signal", fVslider14, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bandwidth", fVslider13, 1.0, 1.0, 1e+02, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Frequency", fVslider26, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations A", fVslider24, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations B", fVslider25, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Frequency", fVslider12, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations A", fVslider10, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations B", fVslider11, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Frequency", fVslider22, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations A", fVslider20, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations B", fVslider21, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Frequency", fVslider34, 0.0, -1.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations A", fVslider32, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations B", fVslider33, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_0+1", fVslider27, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_1+1", fVslider7, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_2+1", fVslider18, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_3+1", fVslider30, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_0+1", fVslider28, 9.2528, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_1+1", fVslider8, 6.9396, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_2+1", fVslider19, 4.6264, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_3+1", fVslider31, 2.3132, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_0+1", fVslider29, 2.8713, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_1+1", fVslider17, 5.7426, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_2+1", fVslider23, 8.613900000000001, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_3+1", fVslider35, 11.4852, 0.001, 12.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Inputs and Outputs/Externals", fVslider6, -8e+01, -8e+01, 8e+01, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Inputs and Outputs/HP frequency", fVslider1, 1.0, 1.0, 2e+04, 1.0);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Inputs and Outputs/LP frequency", fVslider0, 2e+04, 1.0, 2e+04, 1.0);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Inputs and Outputs/Master", fVslider36, -8e+01, -8e+01, 0.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Lorenz Equation Parameters/Beta", fVslider16, 1.073, 0.2666, 5.066, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Lorenz Equation Parameters/Dt", fVslider4, 0.0, -6e+01, 6e+01, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Lorenz Equation Parameters/Lorenz FB", fVslider3, 1.0, 0.0, 1.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Lorenz Equation Parameters/Rho", fVslider15, 3.518, 2.8, 53.2, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Lorenz Equation Parameters/Sigma", fVslider5, 1e+01, 1.0, 19.0, 0.001);
	FAUST_ADDVERTICALSLIDER("Main/Mixer/Lorenz Equation Parameters/TanH", fVslider2, 5e+01, 1.0, 1e+02, 0.001);

	#define FAUST_LIST_ACTIVES(p) \
		p(VERTICALSLIDER, BP_Bypass, "Main/Mixer/Bandpass Filters Bank/BP Bypass", fVslider9, 0.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, BP_Signal, "Main/Mixer/Bandpass Filters Bank/BP Signal", fVslider14, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Bandwidth, "Main/Mixer/Bandpass Filters Bank/Bandwidth", fVslider13, 1.0, 1.0, 1e+02, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Frequency", fVslider26, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations A", fVslider24, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_1/Interpolations B", fVslider25, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Frequency", fVslider12, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations A", fVslider10, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_2/Interpolations B", fVslider11, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Frequency", fVslider22, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations A", fVslider20, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_3/Interpolations B", fVslider21, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Frequency, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Frequency", fVslider34, 0.0, -1.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_A, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations A", fVslider32, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Interpolations_B, "Main/Mixer/Bandpass Filters Bank/Bank Voices/Voice_4/Interpolations B", fVslider33, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Voice_0+1, "Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_0+1", fVslider27, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Voice_1+1, "Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_1+1", fVslider7, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Voice_2+1, "Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_2+1", fVslider18, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Voice_3+1, "Main/Mixer/Feedback Delay Network/Delay Times/Gains Network/Voice_3+1", fVslider30, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Voice_0+1, "Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_0+1", fVslider28, 9.2528, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Voice_1+1, "Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_1+1", fVslider8, 6.9396, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Voice_2+1, "Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_2+1", fVslider19, 4.6264, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Voice_3+1, "Main/Mixer/Feedback Delay Network/Delay Times/Input Delays/Voice_3+1", fVslider31, 2.3132, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Voice_0+1, "Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_0+1", fVslider29, 2.8713, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Voice_1+1, "Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_1+1", fVslider17, 5.7426, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Voice_2+1, "Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_2+1", fVslider23, 8.613900000000001, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Voice_3+1, "Main/Mixer/Feedback Delay Network/Delay Times/Output Delays/Voice_3+1", fVslider35, 11.4852, 0.001, 12.0, 0.001) \
		p(VERTICALSLIDER, Externals, "Main/Mixer/Inputs and Outputs/Externals", fVslider6, -8e+01, -8e+01, 8e+01, 0.001) \
		p(VERTICALSLIDER, HP_frequency, "Main/Mixer/Inputs and Outputs/HP frequency", fVslider1, 1.0, 1.0, 2e+04, 1.0) \
		p(VERTICALSLIDER, LP_frequency, "Main/Mixer/Inputs and Outputs/LP frequency", fVslider0, 2e+04, 1.0, 2e+04, 1.0) \
		p(VERTICALSLIDER, Master, "Main/Mixer/Inputs and Outputs/Master", fVslider36, -8e+01, -8e+01, 0.0, 0.001) \
		p(VERTICALSLIDER, Beta, "Main/Mixer/Lorenz Equation Parameters/Beta", fVslider16, 1.073, 0.2666, 5.066, 0.001) \
		p(VERTICALSLIDER, Dt, "Main/Mixer/Lorenz Equation Parameters/Dt", fVslider4, 0.0, -6e+01, 6e+01, 0.001) \
		p(VERTICALSLIDER, Lorenz_FB, "Main/Mixer/Lorenz Equation Parameters/Lorenz FB", fVslider3, 1.0, 0.0, 1.0, 0.001) \
		p(VERTICALSLIDER, Rho, "Main/Mixer/Lorenz Equation Parameters/Rho", fVslider15, 3.518, 2.8, 53.2, 0.001) \
		p(VERTICALSLIDER, Sigma, "Main/Mixer/Lorenz Equation Parameters/Sigma", fVslider5, 1e+01, 1.0, 19.0, 0.001) \
		p(VERTICALSLIDER, TanH, "Main/Mixer/Lorenz Equation Parameters/TanH", fVslider2, 5e+01, 1.0, 1e+02, 0.001) \
